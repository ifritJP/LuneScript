...
build = {
   ...
   modules = {
      ...
      [ "lune.base.runtime8" ] = "src/lune/base/runtime8.lua",
      ...
      [ "lune.base.AsyncTokenizer" ] = "src/lune/base/AsyncTokenizer.lua",
      [ "lune.base.Tokenizer" ] = "src/lune/base/Tokenizer.lua",
      ...
      [ "lune.base.NodeIndexer" ] = "src/lune/base/NodeIndexer.lua",
      [ "lune.base.Macro" ] = "src/lune/base/Macro.lua",
      [ "lune.base.TransUnitIF" ] = "src/lune/base/TransUnitIF.lua",
      [ "lune.base.BuiltinTransUnit" ] = "src/lune/base/BuiltinTransUnit.lua",
      [ "lune.base.Builtin" ] = "src/lune/base/Builtin.lua",
      [ "lune.base.AstInfo" ] = "src/lune/base/AstInfo.lua",
      ...
      [ "lune.base.convPython" ] = "src/lune/base/convPython.lua",
      ...
      [ "lune.base.Converter" ] = "src/lune/base/Converter.lua",
