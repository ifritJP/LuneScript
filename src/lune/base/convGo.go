...
// for 2497
func convGo_convExp2_7368(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6413
...
// 1013: decl @lune.@base.@convGo.needConvCast
...
// 1217: decl @lune.@base.@convGo.getExpListKind
...
// 1521: decl @lune.@base.@convGo.isRetGenerics
...
// 4314: decl @lune.@base.@convGo.getLnsItemKind
...
// 6035: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
...
// 6705: decl @lune.@base.@convGo.createFilter
...
// 890: decl @lune.@base.@convGo.convFilter.tuple2gotype
...
// 910: decl @lune.@base.@convGo.convFilter.outputAny2Type
...
// 917: decl @lune.@base.@convGo.convFilter.outputStem2Type
...
// 980: decl @lune.@base.@convGo.convFilter.needConvFormFunc
...
// 1074: decl @lune.@base.@convGo.convFilter.outputImplicitCast
...
// 1290: decl @lune.@base.@convGo.convFilter.getConvExpName
...
// 1295: decl @lune.@base.@convGo.convFilter.processConvExp
func (self *convGo_convFilter) processConvExp(_env *LnsEnv, node *Nodes_Node,dstTypeList *LnsList2_[*Ast_TypeInfo],argListNode LnsAny,hasRetEnv bool) {
    ...
    if mRetIndex != nil{
        mRetIndex_402 := mRetIndex.(LnsInt)
        ...
        for _index, _retType := range( retTypeList.Items ) {
            ...
            if index >= mRetIndex_402{
                var valTxt string
                valTxt = _env.GetVM().String_format("Lns_getFromMulti( arg%d, %d )", Lns_2DDD(mRetIndex_402, index - mRetIndex_402))
                var wrote bool
                wrote = false
        ...
        if restIndex != nil{
            restIndex_423 := restIndex.(LnsInt)
            self.FP.WriteRaw(_env, "Lns_2DDD( ")
            for _index, _ := range( expList.Items ) {
                index := _index + 1
                if index >= restIndex_423{
                    if index < expList.Len(){
                        self.FP.WriteRaw(_env, _env.GetVM().String_format("arg%d", Lns_2DDD(index)))
                    } else { 
                        self.FP.WriteRaw(_env, _env.GetVM().String_format("arg%d[%d:]", Lns_2DDD(mRetIndex_402, index - mRetIndex_402)))
                        break
                    }
                }
            }
...
// 1491: decl @lune.@base.@convGo.convFilter.outputNilAccCall
...
// 1532: decl @lune.@base.@convGo.convFilter.processGenericsCall
...
// 1570: decl @lune.@base.@convGo.convFilter.outputRetType
...
// 1610: decl @lune.@base.@convGo.convFilter.outputDeclFunc
...
// 1744: decl @lune.@base.@convGo.convFilter.outputConvToFormFunc
...
// 1828: decl @lune.@base.@convGo.convFilter.outputConvToForm
...
// 1917: decl @lune.@base.@convGo.convFilter.processConvStat
...
// 1923: decl @lune.@base.@convGo.convFilter.outputTopScopeVar
...
// 1932: decl @lune.@base.@convGo.convFilter.outputConvExt
...
// 1959: decl @lune.@base.@convGo.convFilter.outputModule
...
// 1975: decl @lune.@base.@convGo.convFilter.outputModuleImport
...
// 1997: decl @lune.@base.@convGo.convFilter.outputImport
...
// 2025: decl @lune.@base.@convGo.convFilter.setup
...
// 2152: decl @lune.@base.@convGo.convFilter.processMethodAsync
...
// 2220: decl @lune.@base.@convGo.convFilter.outputExpExpandTupleNode
...
// 2249: decl @lune.@base.@convGo.convFilter.processExpExpandTuple
...
// 2258: decl @lune.@base.@convGo.convFilter.processRoot
func (self *convGo_convFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    var modulePath string
    modulePath = convGo_convExp2_7368(Lns_2DDD(_env.GetVM().String_gsub(node.FP.Get_moduleTypeInfo(_env).FP.GetFullName(_env, self.FP.Get_typeNameCtrl(_env), self.FP.Get_moduleInfoManager(_env), nil),"@", "")))
...
// 2560: decl @lune.@base.@convGo.convFilter.processSubfile
func (self *convGo_convFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}
// 2566: decl @lune.@base.@convGo.convFilter.processRequest
...
// 2614: decl @lune.@base.@convGo.convFilter.processAsyncLock
...
// 2632: decl @lune.@base.@convGo.convFilter.processBlockSub
...
// 2658: decl @lune.@base.@convGo.convFilter.expList2Slice
...
// 2732: decl @lune.@base.@convGo.convFilter.getSliceUpcastName
...
// 2750: decl @lune.@base.@convGo.convFilter.processSetFromExpList
...
// 2859: decl @lune.@base.@convGo.convFilter.expList2SliceRaw
func (self *convGo_convFilter) expList2SliceRaw(_env *LnsEnv, itemType *Ast_TypeInfo,node *Nodes_Node,expList LnsAny) {
    ...
    if expList != nil{
        expList_84 := expList.(*Nodes_ExpListNode)
        if Lns_isCondTrue( expList_84.FP.GetDDD(_env)){
            self.FP.WriteRaw(_env, self.FP.getSliceUpcastName(_env, itemType))
            self.FP.WriteRaw(_env, "( Lns_2DDD(")
            convGo_filter_7_(_env, &expList_84.Nodes_Node, self, node)
            self.FP.WriteRaw(_env, "))")
        } else { 
            self.FP.WriteRaw(_env, _env.GetVM().String_format("Lns_2DDDGen[%s](", Lns_2DDD(itemTypeTxt)))
            self.FP.processSetFromExpList(_env, self.FP.getConvExpName(_env, node, expList_84), expList_84.FP.Get_expTypeList(_env), expList_84, false)
            self.FP.WriteRaw(_env, ")")
        }
    } else {
...
// 2883: decl @lune.@base.@convGo.convFilter.processCondRet
...
// 2889: decl @lune.@base.@convGo.convFilter.outputCondRetNode
...
// 2937: decl @lune.@base.@convGo.convFilter.processCondRetList
func (self *convGo_convFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convGo_filter_7_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 2943: decl @lune.@base.@convGo.convFilter.outputCondRetInfo
...
// 2949: decl @lune.@base.@convGo.convFilter.processStmtExp
...
// 2960: decl @lune.@base.@convGo.convFilter.processDeclAlge
...
// 2982: decl @lune.@base.@convGo.convFilter.processNewAlgeVal
...
// 3001: decl @lune.@base.@convGo.convFilter.processDeclMember
...
// 3010: decl @lune.@base.@convGo.convFilter.processExpMacroExp
...
// 3020: decl @lune.@base.@convGo.convFilter.processDeclMacro
func (self *convGo_convFilter) ProcessDeclMacro(_env *LnsEnv, node *Nodes_DeclMacroNode,_opt LnsAny) {
}
// 3026: decl @lune.@base.@convGo.convFilter.processExpMacroStat
...
// 3032: decl @lune.@base.@convGo.convFilter.outputDeclFuncArg
...
// 3043: decl @lune.@base.@convGo.convFilter.isImplementedRunner
...
// 3055: decl @lune.@base.@convGo.convFilter.output_to_decl__func__sym
func (self *convGo_convFilter) output_to_decl__func__sym(_env *LnsEnv, declInfo *Nodes_DeclFuncInfo,funcType *Ast_TypeInfo) {
    if declInfo.FP.Get_has__func__Symbol(_env){
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, "__func__")})/* 3066:29 */)).(*Ast_SymbolInfo)
        self.FP.Writeln(_env, _env.GetVM().String_format("%s := \"%s.%s\"", Lns_2DDD(self.FP.getSymbolSym(_env, funcSym_), nameSpace, funcName)))
    }
}
// 3071: decl @lune.@base.@convGo.convFilter.processDeclConstr
...
// 3106: decl @lune.@base.@convGo.convFilter.processDeclDestr
...
// 3112: decl @lune.@base.@convGo.convFilter.processExpCallSuperCtor
...
// 3126: decl @lune.@base.@convGo.convFilter.processExpCallSuper
...
// 3141: decl @lune.@base.@convGo.convFilter.outputDummyReturn
...
// 3175: decl @lune.@base.@convGo.convFilter.outputDeclFuncInfo
...
// 3254: decl @lune.@base.@convGo.convFilter.processDeclMethod
...
// 3260: decl @lune.@base.@convGo.convFilter.processProtoMethod
func (self *convGo_convFilter) ProcessProtoMethod(_env *LnsEnv, node *Nodes_ProtoMethodNode,_opt LnsAny) {
}
// 3266: decl @lune.@base.@convGo.convFilter.getEnumGetTxtSym
...
// 3274: decl @lune.@base.@convGo.convFilter.processDeclEnum
...
// 3356: decl @lune.@base.@convGo.convFilter.processUnwrapSet
...
// 3362: decl @lune.@base.@convGo.convFilter.processIfUnwrap
...
// 3466: decl @lune.@base.@convGo.convFilter.outputLetVar
...
// 3605: decl @lune.@base.@convGo.convFilter.processDeclVar
...
// 3686: decl @lune.@base.@convGo.convFilter.processWhen
...
// 3723: decl @lune.@base.@convGo.convFilter.processDeclArg
...
// 3730: decl @lune.@base.@convGo.convFilter.processDeclArgDDD
...
// 3736: decl @lune.@base.@convGo.convFilter.processExpSubDDD
...
// 3743: decl @lune.@base.@convGo.convFilter.processDeclForm
...
// 3752: decl @lune.@base.@convGo.convFilter.processDeclFunc
...
// 3785: decl @lune.@base.@convGo.convFilter.processRefType
...
// 3807: decl @lune.@base.@convGo.convFilter.processCond
...
// 3818: decl @lune.@base.@convGo.convFilter.processIf
...
// 3847: decl @lune.@base.@convGo.convFilter.processSwitch
...
// 3882: decl @lune.@base.@convGo.convFilter.processMatch
...
// 3933: decl @lune.@base.@convGo.convFilter.processWhile
...
// 3947: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 3965: decl @lune.@base.@convGo.convFilter.processFor
...
// 4031: decl @lune.@base.@convGo.convFilter.processApply
...
// 4107: decl @lune.@base.@convGo.convFilter.outputForeachLua
...
// 4200: decl @lune.@base.@convGo.convFilter.processForeach
...
// 4322: decl @lune.@base.@convGo.convFilter.processForsort
func (self *convGo_convFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    if keySym != nil{
        ...
        key = _env.GetVM().String_format("%s", Lns_2DDD(self.FP.getSymbolSym(_env, keySym_196)))
    }
    ...
    if valSym != nil{
        ...
        if Lns_isCondTrue( valSym_198.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := %s.Items[ _%s ]", Lns_2DDD(self.FP.getSymbolSym(_env, valSym_198), collSym, key)))
...
// 4411: decl @lune.@base.@convGo.convFilter.processExpUnwrap
...
// 4427: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 4439: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 4467: decl @lune.@base.@convGo.convFilter.outputIFMethods
...
// 4509: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 4519: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 4542: decl @lune.@base.@convGo.convFilter.outputClassType
...
// 4580: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 4600: decl @lune.@base.@convGo.convFilter.outputSliceUpcast
...
// 4632: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 4658: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 4673: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 4698: decl @lune.@base.@convGo.convFilter.outputConstructor
...
// 4794: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 4808:33 */)).(*Ast_SymbolInfo)
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 4849:33 */)).(*Ast_SymbolInfo)
...
// 4858: decl @lune.@base.@convGo.convFilter.outputStaticMember
...
// 4890: decl @lune.@base.@convGo.convFilter.getFromStemName
...
// 4932: decl @lune.@base.@convGo.convFilter.outputConvItemType
func (self *convGo_convFilter) outputConvItemType(_env *LnsEnv, typeInfo *Ast_TypeInfo,alt2type LnsAny) {
    ...
    if typeInfo.FP.Get_srcTypeInfo(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Alternate{
        if alt2type != nil{
            alt2type_1143 := alt2type.(*LnsMap2_[*Ast_TypeInfo,*Ast_TypeInfo])
            {
                _alt := alt2type_1143.Get(workTypeInfo)
                if !Lns_IsNil( _alt ) {
...
// 4957: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 4977: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 4996: decl @lune.@base.@convGo.convFilter.outputAsyncItem
func (self *convGo_convFilter) outputAsyncItem(_env *LnsEnv, node *Nodes_DeclClassNode) {
}
// 5007: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 5135: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 5147: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
...
// 5180: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 5229: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(_env *LnsEnv, node *Nodes_ProtoClassNode,_opt LnsAny) {
}
// 5234: decl @lune.@base.@convGo.convFilter.processDeclClass
...
// 5336: decl @lune.@base.@convGo.convFilter.outputCallPrefix
func (self *convGo_convFilter) OutputCallPrefix(_env *LnsEnv, callId string,node *Nodes_Node,prefixNode LnsAny,funcSymbol *Ast_SymbolInfo)(bool, LnsAny) {
    ...
    if prefixNode != nil{
        prefixNode_1248 := prefixNode.(*Nodes_Node)
        extCallFlag = prefixNode_1248.FP.Get_expType(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext
    } else {
        extCallFlag = false
    }
    if extCallFlag{
    ...
    closeParen = false
    if prefixNode != nil{
        prefixNode_1273 := prefixNode.(*Nodes_Node)
        ...
        var prefixType *Ast_TypeInfo
        prefixType = prefixNode_1273.FP.Get_expType(_env).FP.Get_nonnilableType(_env)
        if prefixType == Ast_builtinTypeString{
            ...
            }
            {
                ...
                if !Lns_IsNil( _runtime ) {
                    ...
                    callKind = &convGo_CallKind__RuntimeCall{prefixNode_1273}
            ...
            if _env.PopVal( _env.IncStack() ||
                ...
                if node.FP.HasNilAccess(_env){
                    if Lns_op_not(prefixNode_1273.FP.HasNilAccess(_env)){
                        ...
                        convGo_filter_7_(_env, prefixNode_1273, self, node)
                        self.FP.Writeln(_env, ") && ")
                    } else { 
                        convGo_filter_7_(_env, prefixNode_1273, self, node)
                        self.FP.Writeln(_env, "&&")
            ...
            convGo_processNilAcc(_env, prefixNode_1273)
...
// 5530: decl @lune.@base.@convGo.convFilter.processExpCall
func (self *convGo_convFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if closeTxt != nil{
        closeTxt_1381 := closeTxt.(string)
        self.FP.WriteRaw(_env, closeTxt_1381)
    }
    self.FP.WriteRaw(_env, ")")
    if _env.PopVal( _env.IncStack() ||
...
// 5812: decl @lune.@base.@convGo.convFilter.processExpMRet
...
// 5819: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(_env *LnsEnv, node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}
// 5827: decl @lune.@base.@convGo.convFilter.processExpList
...
// 5851: decl @lune.@base.@convGo.convFilter.processExpOp1
...
// 5899: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 5911: decl @lune.@base.@convGo.convFilter.processExpCast
...
// 5971: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 5989: decl @lune.@base.@convGo.convFilter.processExpSetVal
...
// 6010: decl @lune.@base.@convGo.convFilter.processExpSetItem
...
// 6032: decl @lune.@base.@convGo.convFilter.processAndOr
...
// 6093: decl @lune.@base.@convGo.convFilter.processExpOp2
...
// 6138: decl @lune.@base.@convGo.convFilter.processExpRef
...
// 6198: decl @lune.@base.@convGo.convFilter.processExpRefItem
...
// 6297: decl @lune.@base.@convGo.convFilter.processRefField
...
// 6385: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 6391: decl @lune.@base.@convGo.convFilter.processGetField
...
// 6440: decl @lune.@base.@convGo.convFilter.processReturn
...
// 6450: decl @lune.@base.@convGo.convFilter.processTestCase
...
// 6465: decl @lune.@base.@convGo.convFilter.processTestBlock
...
// 6477: decl @lune.@base.@convGo.convFilter.processProvide
...
// 6483: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(_env *LnsEnv, node *Nodes_AliasNode,_opt LnsAny) {
}
// 6488: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 6494: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 6500: decl @lune.@base.@convGo.convFilter.processTupleConst
...
// 6512: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 6532: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 6553: decl @lune.@base.@convGo.convFilter.processLiteralMap
...
// 6588: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 6602: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
// 6608: decl @lune.@base.@convGo.convFilter.processLiteralInt
...
// 6614: decl @lune.@base.@convGo.convFilter.processLiteralReal
func (self *convGo_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 6620: decl @lune.@base.@convGo.convFilter.processLiteralString
...
// 6661: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 6699: decl @lune.@base.@convGo.convFilter.processAbbr
...
// 2131: decl @lune.@base.@convGo.ConvRunner.run
...
// 2143: decl @lune.@base.@convGo.ConvRunner.getResult
