...
// for 5376
func convGo_convExp0_5955(arg1 []LnsAny) (bool, LnsAny) {
...
// for 2360
func convGo_convExp2_6146(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6177
func convGo_convExp0_10211(arg1 []LnsAny) bool {
...
// 290: decl @lune.@base.@convGo.getAddEnvArg
...
// 301: decl @lune.@base.@convGo.filter
...
// 307: decl @lune.@base.@convGo.isAnyType
...
// 331: decl @lune.@base.@convGo.isClosure
...
// 366: decl @lune.@base.@convGo.concatGLSym
...
// 383: decl @lune.@base.@convGo.outputGoMain
...
// 456: decl @lune.@base.@convGo.isInnerDeclType
...
// 539: decl @lune.@base.@convGo.normalizeSym
...
// 768: decl @lune.@base.@convGo.str2gostr
...
// 783: decl @lune.@base.@convGo.getOrgTypeInfo
...
// 977: decl @lune.@base.@convGo.needConvCast
...
// 1154: decl @lune.@base.@convGo.getExpListKind
...
// 1451: decl @lune.@base.@convGo.isRetGenerics
...
// 4132: decl @lune.@base.@convGo.getLnsItemKind
...
// 5787: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
...
// 6444: decl @lune.@base.@convGo.createFilter
...
// 279: decl @lune.@base.@convGo.convFilter.getEnvArgDecl
...
// 469: decl @lune.@base.@convGo.convFilter.isInheritAbsImmut
...
// 473: decl @lune.@base.@convGo.convFilter.getCanonicalName
...
// 480: decl @lune.@base.@convGo.convFilter.getModuleName
...
// 493: decl @lune.@base.@convGo.convFilter.concatSymWithType
...
// 504: decl @lune.@base.@convGo.convFilter.isSamePackageExtModule
...
// 516: decl @lune.@base.@convGo.convFilter.isSameModDir
...
// 525: decl @lune.@base.@convGo.convFilter.isSamePackage
...
// 532: decl @lune.@base.@convGo.convFilter.needPrefix
...
// 546: decl @lune.@base.@convGo.convFilter.getSymbol
...
// 674: decl @lune.@base.@convGo.convFilter.getTypeSymbol
...
// 684: decl @lune.@base.@convGo.convFilter.getTypeSymbolWithPrefix
...
// 690: decl @lune.@base.@convGo.convFilter.getConstrSymbol
...
// 694: decl @lune.@base.@convGo.convFilter.getFuncSymbol
...
// 703: decl @lune.@base.@convGo.convFilter.getAlgeSymbol
...
// 707: decl @lune.@base.@convGo.convFilter.getSymbolSym
...
// 738: decl @lune.@base.@convGo.convFilter.getAccessorSym
...
// 742: decl @lune.@base.@convGo.convFilter.outputSymbol
...
// 746: decl @lune.@base.@convGo.convFilter.getConv2formName
...
// 750: decl @lune.@base.@convGo.convFilter.getConvGenericsName
...
// 755: decl @lune.@base.@convGo.convFilter.getModuleSym
...
// 796: decl @lune.@base.@convGo.convFilter.type2gotypeOrg
func (self *convGo_convFilter) type2gotypeOrg(_env *LnsEnv, typeInfo *Ast_TypeInfo,mode LnsInt) string {
    ...
    if _switch0 := orgType.FP.Get_kind(_env); _switch0 == Ast_TypeInfoKind__Ext {
        ...
        return "*Lns_luaValue"
    } else if _switch0 == Ast_TypeInfoKind__List || _switch0 == Ast_TypeInfoKind__Array || _switch0 == Ast_TypeInfoKind__Tuple {
        return "*LnsList"
...
// 860: decl @lune.@base.@convGo.convFilter.type2gotype
...
// 874: decl @lune.@base.@convGo.convFilter.outputAny2Type
...
// 881: decl @lune.@base.@convGo.convFilter.outputStem2Type
...
// 944: decl @lune.@base.@convGo.convFilter.needConvFormFunc
...
// 1038: decl @lune.@base.@convGo.convFilter.outputImplicitCast
...
// 1227: decl @lune.@base.@convGo.convFilter.getConvExpName
...
// 1233: decl @lune.@base.@convGo.convFilter.processConvExp
func (self *convGo_convFilter) processConvExp(_env *LnsEnv, node *Nodes_Node,dstTypeList *LnsList,argListNode LnsAny,hasRetEnv bool) {
    ...
    if mRetIndex != nil{
        mRetIndex_378 := mRetIndex.(LnsInt)
        ...
        for _index, _retType := range( retTypeList.Items ) {
            ...
            if index >= mRetIndex_378{
                var valTxt string
                valTxt = _env.GetVM().String_format("Lns_getFromMulti( arg%d, %d )", []LnsAny{mRetIndex_378, index - mRetIndex_378})
                var wrote bool
                wrote = false
        ...
        if restIndex != nil{
            restIndex_399 := restIndex.(LnsInt)
            self.FP.WriteRaw(_env, "Lns_2DDD( ")
            for _index, _ := range( expList.Items ) {
                index := _index + 1
                if index >= restIndex_399{
                    if index < expList.Len(){
                        self.FP.WriteRaw(_env, _env.GetVM().String_format("arg%d", []LnsAny{index}))
                    } else { 
                        self.FP.WriteRaw(_env, _env.GetVM().String_format("arg%d[%d:]", []LnsAny{mRetIndex_378, index - mRetIndex_378}))
                        break
                    }
                }
            }
...
// 1420: decl @lune.@base.@convGo.convFilter.outputNilAccCall
...
// 1462: decl @lune.@base.@convGo.convFilter.processGenericsCall
...
// 1500: decl @lune.@base.@convGo.convFilter.outputRetType
...
// 1540: decl @lune.@base.@convGo.convFilter.outputDeclFunc
...
// 1674: decl @lune.@base.@convGo.convFilter.outputConvToFormFunc
...
// 1758: decl @lune.@base.@convGo.convFilter.outputConvToForm
...
// 1847: decl @lune.@base.@convGo.convFilter.processConvStat
...
// 1853: decl @lune.@base.@convGo.convFilter.outputTopScopeVar
...
// 1862: decl @lune.@base.@convGo.convFilter.outputConvExt
...
// 1889: decl @lune.@base.@convGo.convFilter.outputModule
...
// 1905: decl @lune.@base.@convGo.convFilter.outputModuleImport
...
// 1927: decl @lune.@base.@convGo.convFilter.outputImport
...
// 1955: decl @lune.@base.@convGo.convFilter.setup
...
// 2081: decl @lune.@base.@convGo.convFilter.processMethodAsync
...
// 2149: decl @lune.@base.@convGo.convFilter.processRoot
func (self *convGo_convFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    var modulePath string
    modulePath = convGo_convExp2_6146(Lns_2DDD(_env.GetVM().String_gsub(node.FP.Get_moduleTypeInfo(_env).FP.GetFullName(_env, self.FP.Get_typeNameCtrl(_env), self.FP.Get_moduleInfoManager(_env), nil),"@", "")))
...
// 2423: decl @lune.@base.@convGo.convFilter.processSubfile
func (self *convGo_convFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}
// 2429: decl @lune.@base.@convGo.convFilter.processRequest
...
// 2477: decl @lune.@base.@convGo.convFilter.processAsyncLock
...
// 2495: decl @lune.@base.@convGo.convFilter.processBlockSub
...
// 2521: decl @lune.@base.@convGo.convFilter.expList2Slice
...
// 2584: decl @lune.@base.@convGo.convFilter.processSetFromExpList
...
// 2693: decl @lune.@base.@convGo.convFilter.processCondRet
...
// 2699: decl @lune.@base.@convGo.convFilter.outputCondRetNode
func (self *convGo_convFilter) outputCondRetNode(_env *LnsEnv, node *Nodes_CondRetNode) {
    ...
    if node.FP.Get_exp(_env).FP.Get_expType(_env).FP.Get_nilable(_env){
...
// 2730: decl @lune.@base.@convGo.convFilter.processCondRetList
func (self *convGo_convFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convGo_filter_7_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 2736: decl @lune.@base.@convGo.convFilter.outputCondRetInfo
...
// 2742: decl @lune.@base.@convGo.convFilter.processStmtExp
...
// 2753: decl @lune.@base.@convGo.convFilter.processDeclAlge
...
// 2775: decl @lune.@base.@convGo.convFilter.processNewAlgeVal
...
// 2794: decl @lune.@base.@convGo.convFilter.processDeclMember
...
// 2803: decl @lune.@base.@convGo.convFilter.processExpMacroExp
...
// 2813: decl @lune.@base.@convGo.convFilter.processDeclMacro
func (self *convGo_convFilter) ProcessDeclMacro(_env *LnsEnv, node *Nodes_DeclMacroNode,_opt LnsAny) {
}
// 2819: decl @lune.@base.@convGo.convFilter.processExpMacroStat
...
// 2825: decl @lune.@base.@convGo.convFilter.outputDeclFuncArg
...
// 2836: decl @lune.@base.@convGo.convFilter.isImplementedRunner
...
// 2848: decl @lune.@base.@convGo.convFilter.output_to_decl__func__sym
func (self *convGo_convFilter) output_to_decl__func__sym(_env *LnsEnv, declInfo *Nodes_DeclFuncInfo,funcType *Ast_TypeInfo) {
    if declInfo.FP.Get_has__func__Symbol(_env){
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, "__func__")})/* 2859:29 */)).(*Ast_SymbolInfo)
        self.FP.Writeln(_env, _env.GetVM().String_format("%s := \"%s.%s\"", []LnsAny{self.FP.getSymbolSym(_env, funcSym_), nameSpace, funcName}))
    }
}
// 2864: decl @lune.@base.@convGo.convFilter.processDeclConstr
...
// 2899: decl @lune.@base.@convGo.convFilter.processDeclDestr
...
// 2905: decl @lune.@base.@convGo.convFilter.processExpCallSuperCtor
...
// 2919: decl @lune.@base.@convGo.convFilter.processExpCallSuper
...
// 2934: decl @lune.@base.@convGo.convFilter.outputDummyReturn
...
// 2968: decl @lune.@base.@convGo.convFilter.outputDeclFuncInfo
...
// 3047: decl @lune.@base.@convGo.convFilter.processDeclMethod
...
// 3053: decl @lune.@base.@convGo.convFilter.processProtoMethod
func (self *convGo_convFilter) ProcessProtoMethod(_env *LnsEnv, node *Nodes_ProtoMethodNode,_opt LnsAny) {
}
// 3059: decl @lune.@base.@convGo.convFilter.getEnumGetTxtSym
...
// 3063: decl @lune.@base.@convGo.convFilter.processDeclEnum
...
// 3145: decl @lune.@base.@convGo.convFilter.processUnwrapSet
...
// 3151: decl @lune.@base.@convGo.convFilter.processIfUnwrap
...
// 3255: decl @lune.@base.@convGo.convFilter.outputLetVar
...
// 3394: decl @lune.@base.@convGo.convFilter.processExpandTuple
func (self *convGo_convFilter) ProcessExpandTuple(_env *LnsEnv, node *Nodes_ExpandTupleNode,_opt LnsAny) {
    ...
    self.FP.Writeln(_env, "{")
    self.FP.PushIndent(_env, nil)
    self.FP.Write(_env, "__tuple := ")
    convGo_filter_7_(_env, &node.FP.Get_expList(_env).Nodes_Node, self, &node.Nodes_Node)
    self.FP.Writeln(_env, ".Unpack()")
    for _index, __var := range( node.FP.Get_symbolInfoList(_env).Items ) {
        index := _index + 1
        _var := __var.(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
        if _var.FP.Get_name(_env) != "_"{
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s = __tuple[%d]", []LnsAny{_var.FP.Get_name(_env), index - 1}))
            self.FP.outputAny2Type(_env, _var.FP.Get_typeInfo(_env))
            self.FP.Writeln(_env, "")
        }
    }
    self.FP.PopIndent(_env)
...
// 3424: decl @lune.@base.@convGo.convFilter.processDeclVar
...
// 3508: decl @lune.@base.@convGo.convFilter.processWhen
...
// 3545: decl @lune.@base.@convGo.convFilter.processDeclArg
...
// 3552: decl @lune.@base.@convGo.convFilter.processDeclArgDDD
...
// 3558: decl @lune.@base.@convGo.convFilter.processExpSubDDD
...
// 3565: decl @lune.@base.@convGo.convFilter.processDeclForm
...
// 3574: decl @lune.@base.@convGo.convFilter.processDeclFunc
...
// 3607: decl @lune.@base.@convGo.convFilter.processRefType
...
// 3629: decl @lune.@base.@convGo.convFilter.processCond
...
// 3640: decl @lune.@base.@convGo.convFilter.processIf
...
// 3669: decl @lune.@base.@convGo.convFilter.processSwitch
...
// 3704: decl @lune.@base.@convGo.convFilter.processMatch
...
// 3755: decl @lune.@base.@convGo.convFilter.processWhile
...
// 3769: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 3787: decl @lune.@base.@convGo.convFilter.processFor
...
// 3853: decl @lune.@base.@convGo.convFilter.processApply
...
// 3929: decl @lune.@base.@convGo.convFilter.outputForeachLua
...
// 4022: decl @lune.@base.@convGo.convFilter.processForeach
...
// 4140: decl @lune.@base.@convGo.convFilter.processForsort
func (self *convGo_convFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    if keySym != nil{
        keySym_164 := keySym.(*Ast_SymbolInfo)
        key = _env.GetVM().String_format("%s", []LnsAny{self.FP.getSymbolSym(_env, keySym_164)})
    }
    ...
    self.FP.PushIndent(_env, nil)
    if valSym != nil{
        valSym_166 := valSym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( valSym_166.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := %s.Items[ _%s ]", []LnsAny{self.FP.getSymbolSym(_env, valSym_166), collSym, key}))
            self.FP.outputStem2Type(_env, valSym_166.FP.Get_typeInfo(_env))
            self.FP.Writeln(_env, "")
        }
    }
    if keySym != nil{
        keySym_169 := keySym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( keySym_169.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := _%s", []LnsAny{key, key}))
            self.FP.outputStem2Type(_env, keySym_169.FP.Get_typeInfo(_env))
            self.FP.Writeln(_env, "")
        }
    }
    self.FP.PopIndent(_env)
...
// 4225: decl @lune.@base.@convGo.convFilter.processExpUnwrap
...
// 4241: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 4253: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 4281: decl @lune.@base.@convGo.convFilter.outputIFMethods
...
// 4323: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 4333: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 4356: decl @lune.@base.@convGo.convFilter.outputClassType
...
// 4394: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 4412: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 4438: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 4453: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 4478: decl @lune.@base.@convGo.convFilter.outputConstructor
...
// 4574: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 4588:33 */)).(*Ast_SymbolInfo)
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 4629:33 */)).(*Ast_SymbolInfo)
...
// 4638: decl @lune.@base.@convGo.convFilter.outputStaticMember
...
// 4670: decl @lune.@base.@convGo.convFilter.getFromStemName
...
// 4697: decl @lune.@base.@convGo.convFilter.outputConvItemType
func (self *convGo_convFilter) outputConvItemType(_env *LnsEnv, typeInfo *Ast_TypeInfo,alt2type LnsAny) {
    ...
    if typeInfo.FP.Get_srcTypeInfo(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Alternate{
        if alt2type != nil{
            alt2type_318 := alt2type.(*LnsMap)
            {
                _alt := alt2type_318.Get(workTypeInfo)
                if !Lns_IsNil( _alt ) {
...
// 4722: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 4742: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 4761: decl @lune.@base.@convGo.convFilter.outputAsyncItem
func (self *convGo_convFilter) outputAsyncItem(_env *LnsEnv, node *Nodes_DeclClassNode) {
}
// 4772: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 4900: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 4912: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
...
// 4945: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 4994: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(_env *LnsEnv, node *Nodes_ProtoClassNode,_opt LnsAny) {
}
// 4999: decl @lune.@base.@convGo.convFilter.processDeclClass
...
// 5097: decl @lune.@base.@convGo.convFilter.outputCallPrefix
func (self *convGo_convFilter) OutputCallPrefix(_env *LnsEnv, callId string,node *Nodes_Node,prefixNode LnsAny,funcSymbol *Ast_SymbolInfo)(bool, LnsAny) {
    ...
    if prefixNode != nil{
        prefixNode_1195 := prefixNode.(*Nodes_Node)
        extCallFlag = prefixNode_1195.FP.Get_expType(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext
    } else {
        extCallFlag = false
    }
    if extCallFlag{
    ...
    closeParen = false
    if prefixNode != nil{
        prefixNode_1220 := prefixNode.(*Nodes_Node)
        ...
        var prefixType *Ast_TypeInfo
        prefixType = prefixNode_1220.FP.Get_expType(_env).FP.Get_nonnilableType(_env)
        if prefixType == Ast_builtinTypeString{
            ...
            }
            {
                ...
                if !Lns_IsNil( _runtime ) {
                    ...
                    callKind = &convGo_CallKind__RuntimeCall{prefixNode_1220}
            ...
            if _env.PopVal( _env.IncStack() ||
                ...
                if node.FP.HasNilAccess(_env){
                    if Lns_op_not(prefixNode_1220.FP.HasNilAccess(_env)){
                        ...
                        convGo_filter_7_(_env, prefixNode_1220, self, node)
                        self.FP.Writeln(_env, ") && ")
                    } else { 
                        convGo_filter_7_(_env, prefixNode_1220, self, node)
                        self.FP.Writeln(_env, "&&")
            ...
            convGo_processNilAcc(_env, prefixNode_1220)
...
// 5291: decl @lune.@base.@convGo.convFilter.processExpCall
func (self *convGo_convFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if closeTxt != nil{
        closeTxt_1328 := closeTxt.(string)
        self.FP.WriteRaw(_env, closeTxt_1328)
    }
    self.FP.WriteRaw(_env, ")")
    if _env.PopVal( _env.IncStack() ||
...
// 5573: decl @lune.@base.@convGo.convFilter.processExpMRet
...
// 5580: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(_env *LnsEnv, node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}
// 5588: decl @lune.@base.@convGo.convFilter.processExpList
...
// 5612: decl @lune.@base.@convGo.convFilter.processExpOp1
...
// 5660: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 5672: decl @lune.@base.@convGo.convFilter.processExpCast
...
// 5732: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 5749: decl @lune.@base.@convGo.convFilter.processExpSetVal
...
// 5766: decl @lune.@base.@convGo.convFilter.processExpSetItem
...
// 5784: decl @lune.@base.@convGo.convFilter.processAndOr
...
// 5845: decl @lune.@base.@convGo.convFilter.processExpOp2
...
// 5890: decl @lune.@base.@convGo.convFilter.processExpRef
...
// 5950: decl @lune.@base.@convGo.convFilter.processExpRefItem
...
// 6061: decl @lune.@base.@convGo.convFilter.processRefField
...
// 6149: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 6155: decl @lune.@base.@convGo.convFilter.processGetField
    ...
    opt := _opt.(*ConvGo_Opt)
    {
        ...
        if !Lns_IsNil( _symbolInfo ) {
            ...
            if symbolInfo.FP.Get_staticFlag(_env){
                ...
                var closeParen bool
                closeParen = convGo_convExp0_10211(Lns_2DDD(self.FP.OutputCallPrefix(_env, node.FP.GetIdTxt(_env), &node.Nodes_Node, node.FP.Get_prefix(_env), symbolInfo)))
                self.FP.WriteRaw(_env, _env.GetVM().String_format("(%s)", []LnsAny{convGo_getAddEnvArg_6_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
                var retType *Ast_TypeInfo
...
// 6204: decl @lune.@base.@convGo.convFilter.processReturn
...
// 6214: decl @lune.@base.@convGo.convFilter.processTestCase
...
// 6229: decl @lune.@base.@convGo.convFilter.processTestBlock
...
// 6241: decl @lune.@base.@convGo.convFilter.processProvide
...
// 6247: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(_env *LnsEnv, node *Nodes_AliasNode,_opt LnsAny) {
}
// 6252: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 6258: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 6264: decl @lune.@base.@convGo.convFilter.processTupleConst
func (self *convGo_convFilter) ProcessTupleConst(_env *LnsEnv, node *Nodes_TupleConstNode,_opt LnsAny) {
    ...
    self.FP.expList2Slice(_env, node.FP.Get_expList(_env), true)
    self.FP.WriteRaw(_env, ")")
}
// 6272: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 6285: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 6299: decl @lune.@base.@convGo.convFilter.processLiteralMap
...
// 6327: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 6341: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
// 6347: decl @lune.@base.@convGo.convFilter.processLiteralInt
...
// 6353: decl @lune.@base.@convGo.convFilter.processLiteralReal
func (self *convGo_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 6359: decl @lune.@base.@convGo.convFilter.processLiteralString
...
// 6400: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 6436: decl @lune.@base.@convGo.convFilter.processAbbr
...
// 2060: decl @lune.@base.@convGo.ConvRunner.run
...
// 2072: decl @lune.@base.@convGo.ConvRunner.getResult
