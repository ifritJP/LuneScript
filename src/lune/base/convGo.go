...
// for 5481
func convGo_convExp0_6224(arg1 []LnsAny) (bool, LnsAny) {
...
// for 6276
func convGo_convExp0_10858(arg1 []LnsAny) bool {
...
// 1180: decl @lune.@base.@convGo.getExpListKind
...
// 1475: decl @lune.@base.@convGo.isRetGenerics
...
// 4238: decl @lune.@base.@convGo.getLnsItemKind
...
// 5900: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
...
// 6557: decl @lune.@base.@convGo.createFilter
...
// 1253: decl @lune.@base.@convGo.convFilter.getConvExpName
...
// 1258: decl @lune.@base.@convGo.convFilter.processConvExp
func (self *convGo_convFilter) processConvExp(_env *LnsEnv, node *Nodes_Node,dstTypeList *LnsList,argListNode LnsAny,hasRetEnv bool) {
    ...
    if mRetIndex != nil{
        mRetIndex_388 := mRetIndex.(LnsInt)
        ...
        for _index, _retType := range( retTypeList.Items ) {
            ...
            if index >= mRetIndex_388{
                var valTxt string
                valTxt = _env.GetVM().String_format("Lns_getFromMulti( arg%d, %d )", []LnsAny{mRetIndex_388, index - mRetIndex_388})
                var wrote bool
                wrote = false
        ...
        if restIndex != nil{
            restIndex_409 := restIndex.(LnsInt)
            self.FP.WriteRaw(_env, "Lns_2DDD( ")
            for _index, _ := range( expList.Items ) {
                index := _index + 1
                if index >= restIndex_409{
                    if index < expList.Len(){
                        self.FP.WriteRaw(_env, _env.GetVM().String_format("arg%d", []LnsAny{index}))
                    } else { 
                        self.FP.WriteRaw(_env, _env.GetVM().String_format("arg%d[%d:]", []LnsAny{mRetIndex_388, index - mRetIndex_388}))
                        break
                    }
                }
            }
...
// 1445: decl @lune.@base.@convGo.convFilter.outputNilAccCall
...
// 1486: decl @lune.@base.@convGo.convFilter.processGenericsCall
...
// 1524: decl @lune.@base.@convGo.convFilter.outputRetType
...
// 1564: decl @lune.@base.@convGo.convFilter.outputDeclFunc
...
// 1698: decl @lune.@base.@convGo.convFilter.outputConvToFormFunc
...
// 1782: decl @lune.@base.@convGo.convFilter.outputConvToForm
...
// 1871: decl @lune.@base.@convGo.convFilter.processConvStat
...
// 1877: decl @lune.@base.@convGo.convFilter.outputTopScopeVar
...
// 1886: decl @lune.@base.@convGo.convFilter.outputConvExt
...
// 1913: decl @lune.@base.@convGo.convFilter.outputModule
...
// 1929: decl @lune.@base.@convGo.convFilter.outputModuleImport
...
// 1951: decl @lune.@base.@convGo.convFilter.outputImport
...
// 1979: decl @lune.@base.@convGo.convFilter.setup
...
// 2106: decl @lune.@base.@convGo.convFilter.processMethodAsync
...
// 2174: decl @lune.@base.@convGo.convFilter.outputExpExpandTupleNode
...
// 2203: decl @lune.@base.@convGo.convFilter.processExpExpandTuple
...
// 2212: decl @lune.@base.@convGo.convFilter.processRoot
...
// 2490: decl @lune.@base.@convGo.convFilter.processSubfile
func (self *convGo_convFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}
// 2496: decl @lune.@base.@convGo.convFilter.processRequest
...
// 2544: decl @lune.@base.@convGo.convFilter.processAsyncLock
...
// 2562: decl @lune.@base.@convGo.convFilter.processBlockSub
...
// 2588: decl @lune.@base.@convGo.convFilter.expList2Slice
...
// 2647: decl @lune.@base.@convGo.convFilter.expList2SliceRaw
...
// 2701: decl @lune.@base.@convGo.convFilter.processSetFromExpList
...
// 2810: decl @lune.@base.@convGo.convFilter.processCondRet
...
// 2816: decl @lune.@base.@convGo.convFilter.outputCondRetNode
...
// 2864: decl @lune.@base.@convGo.convFilter.processCondRetList
func (self *convGo_convFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convGo_filter_7_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 2870: decl @lune.@base.@convGo.convFilter.outputCondRetInfo
...
// 2876: decl @lune.@base.@convGo.convFilter.processStmtExp
...
// 2887: decl @lune.@base.@convGo.convFilter.processDeclAlge
...
// 2909: decl @lune.@base.@convGo.convFilter.processNewAlgeVal
...
// 2928: decl @lune.@base.@convGo.convFilter.processDeclMember
...
// 2937: decl @lune.@base.@convGo.convFilter.processExpMacroExp
...
// 2947: decl @lune.@base.@convGo.convFilter.processDeclMacro
func (self *convGo_convFilter) ProcessDeclMacro(_env *LnsEnv, node *Nodes_DeclMacroNode,_opt LnsAny) {
}
// 2953: decl @lune.@base.@convGo.convFilter.processExpMacroStat
...
// 2959: decl @lune.@base.@convGo.convFilter.outputDeclFuncArg
...
// 2970: decl @lune.@base.@convGo.convFilter.isImplementedRunner
...
// 2982: decl @lune.@base.@convGo.convFilter.output_to_decl__func__sym
func (self *convGo_convFilter) output_to_decl__func__sym(_env *LnsEnv, declInfo *Nodes_DeclFuncInfo,funcType *Ast_TypeInfo) {
    if declInfo.FP.Get_has__func__Symbol(_env){
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, "__func__")})/* 2993:29 */)).(*Ast_SymbolInfo)
        self.FP.Writeln(_env, _env.GetVM().String_format("%s := \"%s.%s\"", []LnsAny{self.FP.getSymbolSym(_env, funcSym_), nameSpace, funcName}))
    }
}
// 2998: decl @lune.@base.@convGo.convFilter.processDeclConstr
...
// 3033: decl @lune.@base.@convGo.convFilter.processDeclDestr
...
// 3039: decl @lune.@base.@convGo.convFilter.processExpCallSuperCtor
...
// 3053: decl @lune.@base.@convGo.convFilter.processExpCallSuper
...
// 3068: decl @lune.@base.@convGo.convFilter.outputDummyReturn
...
// 3102: decl @lune.@base.@convGo.convFilter.outputDeclFuncInfo
...
// 3181: decl @lune.@base.@convGo.convFilter.processDeclMethod
...
// 3187: decl @lune.@base.@convGo.convFilter.processProtoMethod
func (self *convGo_convFilter) ProcessProtoMethod(_env *LnsEnv, node *Nodes_ProtoMethodNode,_opt LnsAny) {
}
// 3193: decl @lune.@base.@convGo.convFilter.getEnumGetTxtSym
...
// 3197: decl @lune.@base.@convGo.convFilter.processDeclEnum
...
// 3279: decl @lune.@base.@convGo.convFilter.processUnwrapSet
...
// 3285: decl @lune.@base.@convGo.convFilter.processIfUnwrap
...
// 3389: decl @lune.@base.@convGo.convFilter.outputLetVar
...
// 3528: decl @lune.@base.@convGo.convFilter.processDeclVar
...
// 3612: decl @lune.@base.@convGo.convFilter.processWhen
...
// 3649: decl @lune.@base.@convGo.convFilter.processDeclArg
...
// 3656: decl @lune.@base.@convGo.convFilter.processDeclArgDDD
...
// 3662: decl @lune.@base.@convGo.convFilter.processExpSubDDD
...
// 3669: decl @lune.@base.@convGo.convFilter.processDeclForm
...
// 3678: decl @lune.@base.@convGo.convFilter.processDeclFunc
...
// 3711: decl @lune.@base.@convGo.convFilter.processRefType
...
// 3733: decl @lune.@base.@convGo.convFilter.processCond
...
// 3744: decl @lune.@base.@convGo.convFilter.processIf
...
// 3773: decl @lune.@base.@convGo.convFilter.processSwitch
...
// 3808: decl @lune.@base.@convGo.convFilter.processMatch
...
// 3859: decl @lune.@base.@convGo.convFilter.processWhile
...
// 3873: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 3891: decl @lune.@base.@convGo.convFilter.processFor
...
// 3957: decl @lune.@base.@convGo.convFilter.processApply
...
// 4033: decl @lune.@base.@convGo.convFilter.outputForeachLua
...
// 4126: decl @lune.@base.@convGo.convFilter.processForeach
...
// 4246: decl @lune.@base.@convGo.convFilter.processForsort
func (self *convGo_convFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    if keySym != nil{
        keySym_194 := keySym.(*Ast_SymbolInfo)
        key = _env.GetVM().String_format("%s", []LnsAny{self.FP.getSymbolSym(_env, keySym_194)})
    }
    ...
    self.FP.PushIndent(_env, nil)
    if valSym != nil{
        valSym_196 := valSym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( valSym_196.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := %s.Items[ _%s ]", []LnsAny{self.FP.getSymbolSym(_env, valSym_196), collSym, key}))
            self.FP.outputStem2Type(_env, valSym_196.FP.Get_typeInfo(_env))
            self.FP.Writeln(_env, "")
        }
    }
    if keySym != nil{
        keySym_199 := keySym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( keySym_199.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := _%s", []LnsAny{key, key}))
            self.FP.outputStem2Type(_env, keySym_199.FP.Get_typeInfo(_env))
            self.FP.Writeln(_env, "")
        }
    }
    self.FP.PopIndent(_env)
...
// 4331: decl @lune.@base.@convGo.convFilter.processExpUnwrap
...
// 4347: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 4359: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 4387: decl @lune.@base.@convGo.convFilter.outputIFMethods
...
// 4429: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 4439: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 4462: decl @lune.@base.@convGo.convFilter.outputClassType
...
// 4500: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 4518: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 4544: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 4559: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 4584: decl @lune.@base.@convGo.convFilter.outputConstructor
...
// 4680: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 4694:33 */)).(*Ast_SymbolInfo)
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 4735:33 */)).(*Ast_SymbolInfo)
...
// 4744: decl @lune.@base.@convGo.convFilter.outputStaticMember
...
// 4776: decl @lune.@base.@convGo.convFilter.getFromStemName
...
// 4803: decl @lune.@base.@convGo.convFilter.outputConvItemType
func (self *convGo_convFilter) outputConvItemType(_env *LnsEnv, typeInfo *Ast_TypeInfo,alt2type LnsAny) {
    ...
    if typeInfo.FP.Get_srcTypeInfo(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Alternate{
        if alt2type != nil{
            alt2type_1126 := alt2type.(*LnsMap)
            {
                _alt := alt2type_1126.Get(workTypeInfo)
                if !Lns_IsNil( _alt ) {
...
// 4828: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 4848: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 4867: decl @lune.@base.@convGo.convFilter.outputAsyncItem
func (self *convGo_convFilter) outputAsyncItem(_env *LnsEnv, node *Nodes_DeclClassNode) {
}
// 4878: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 5006: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 5018: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
...
// 5051: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 5100: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(_env *LnsEnv, node *Nodes_ProtoClassNode,_opt LnsAny) {
}
// 5105: decl @lune.@base.@convGo.convFilter.processDeclClass
...
// 5203: decl @lune.@base.@convGo.convFilter.outputCallPrefix
func (self *convGo_convFilter) OutputCallPrefix(_env *LnsEnv, callId string,node *Nodes_Node,prefixNode LnsAny,funcSymbol *Ast_SymbolInfo)(bool, LnsAny) {
    ...
    if prefixNode != nil{
        ...
        extCallFlag = prefixNode_1231.FP.Get_expType(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext
    } else {
        extCallFlag = false
    }
    if extCallFlag{
    ...
    closeParen = false
    if prefixNode != nil{
        prefixNode_1256 := prefixNode.(*Nodes_Node)
        ...
        var prefixType *Ast_TypeInfo
        prefixType = prefixNode_1256.FP.Get_expType(_env).FP.Get_nonnilableType(_env)
        if prefixType == Ast_builtinTypeString{
            ...
            }
            {
                ...
                if !Lns_IsNil( _runtime ) {
                    ...
                    callKind = &convGo_CallKind__RuntimeCall{prefixNode_1256}
            ...
            if _env.PopVal( _env.IncStack() ||
                ...
                if node.FP.HasNilAccess(_env){
                    if Lns_op_not(prefixNode_1256.FP.HasNilAccess(_env)){
                        ...
                        convGo_filter_7_(_env, prefixNode_1256, self, node)
                        self.FP.Writeln(_env, ") && ")
                    } else { 
                        convGo_filter_7_(_env, prefixNode_1256, self, node)
                        self.FP.Writeln(_env, "&&")
            ...
            convGo_processNilAcc(_env, prefixNode_1256)
...
// 5396: decl @lune.@base.@convGo.convFilter.processExpCall
func (self *convGo_convFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if closeTxt != nil{
        closeTxt_1364 := closeTxt.(string)
        self.FP.WriteRaw(_env, closeTxt_1364)
    }
    self.FP.WriteRaw(_env, ")")
    if _env.PopVal( _env.IncStack() ||
...
// 5678: decl @lune.@base.@convGo.convFilter.processExpMRet
...
// 5685: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(_env *LnsEnv, node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}
// 5693: decl @lune.@base.@convGo.convFilter.processExpList
...
// 5717: decl @lune.@base.@convGo.convFilter.processExpOp1
...
// 5765: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 5777: decl @lune.@base.@convGo.convFilter.processExpCast
...
// 5837: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 5854: decl @lune.@base.@convGo.convFilter.processExpSetVal
...
// 5875: decl @lune.@base.@convGo.convFilter.processExpSetItem
...
// 5897: decl @lune.@base.@convGo.convFilter.processAndOr
...
// 5958: decl @lune.@base.@convGo.convFilter.processExpOp2
...
// 6003: decl @lune.@base.@convGo.convFilter.processExpRef
...
// 6063: decl @lune.@base.@convGo.convFilter.processExpRefItem
func (self *convGo_convFilter) ProcessExpRefItem(_env *LnsEnv, node *Nodes_ExpRefItemNode,_opt LnsAny) {
    ...
    if _switch0 := prefixType.FP.Get_kind(_env); _switch0 == Ast_TypeInfoKind__Ext {
        ...
        if node.FP.Get_nilAccess(_env){
            ...
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s.NilAccPush( %s.NilAccPop().(%s)", []LnsAny{getEnvTxt, getEnvTxt, "*LnsList"}))
        } else { 
            convGo_filter_7_(_env, node.FP.Get_val(_env), self, &node.Nodes_Node)
            if prefixType.FP.Get_kind(_env) == Ast_TypeInfoKind__Stem{
                self.FP.WriteRaw(_env, _env.GetVM().String_format(".(%s)", []LnsAny{"*LnsList"}))
            }
        }
        {
            self.FP.WriteRaw(_env, ".GetAt(")
...
// 6160: decl @lune.@base.@convGo.convFilter.processRefField
...
// 6248: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 6254: decl @lune.@base.@convGo.convFilter.processGetField
    ...
    opt := _opt.(*ConvGo_Opt)
    {
        ...
        if !Lns_IsNil( _symbolInfo ) {
            ...
            if symbolInfo.FP.Get_staticFlag(_env){
                ...
                var closeParen bool
                closeParen = convGo_convExp0_10858(Lns_2DDD(self.FP.OutputCallPrefix(_env, node.FP.GetIdTxt(_env), &node.Nodes_Node, node.FP.Get_prefix(_env), symbolInfo)))
                self.FP.WriteRaw(_env, _env.GetVM().String_format("(%s)", []LnsAny{convGo_getAddEnvArg_6_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
                var retType *Ast_TypeInfo
...
// 6303: decl @lune.@base.@convGo.convFilter.processReturn
...
// 6313: decl @lune.@base.@convGo.convFilter.processTestCase
...
// 6328: decl @lune.@base.@convGo.convFilter.processTestBlock
...
// 6340: decl @lune.@base.@convGo.convFilter.processProvide
...
// 6346: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(_env *LnsEnv, node *Nodes_AliasNode,_opt LnsAny) {
}
// 6351: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 6357: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 6363: decl @lune.@base.@convGo.convFilter.processTupleConst
...
// 6375: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 6400: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 6414: decl @lune.@base.@convGo.convFilter.processLiteralMap
...
// 6442: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 6456: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
// 6462: decl @lune.@base.@convGo.convFilter.processLiteralInt
...
// 6468: decl @lune.@base.@convGo.convFilter.processLiteralReal
func (self *convGo_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 6474: decl @lune.@base.@convGo.convFilter.processLiteralString
...
// 6515: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 6551: decl @lune.@base.@convGo.convFilter.processAbbr
...
// 2085: decl @lune.@base.@convGo.ConvRunner.run
...
// 2097: decl @lune.@base.@convGo.ConvRunner.getResult
