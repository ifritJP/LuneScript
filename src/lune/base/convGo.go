...
func convGo_ProcessMode_get__allList_1021_(_env *LnsEnv) *LnsList{
...
func convGo_ProcessMode__from_1016_(_env *LnsEnv, arg1 LnsInt) LnsAny{
...
func convGo_ExpListKind_get__allList_1250_(_env *LnsEnv) *LnsList{
...
func convGo_ExpListKind__from_1245_(_env *LnsEnv, arg1 LnsInt) LnsAny{
...
type convFilter_processRoot__ProcNode_1352_ func (_env *LnsEnv, arg1 *Nodes_Node)
// for 158
...
// for 4671
func convGo_convExp26513(arg1 []LnsAny) (bool, LnsAny) {
...
// for 1749
func convGo_convExp8680(arg1 []LnsAny) (string, LnsInt) {
...
func convGo_isMain_1045_(_env *LnsEnv, funcType *Ast_TypeInfo) bool {
...
func convGo_getAddEnvArg_1132_(_env *LnsEnv, argLen LnsInt,addEnvArg bool) string {
    if addEnvArg{
        var txt string
        txt = "_env"
        if argLen > 0{
...
func convGo_filter_1137_(_env *LnsEnv, node *Nodes_Node,filter *convGo_convFilter,parent *Nodes_Node) {
...
func convGo_isAnyType_1139_(_env *LnsEnv, typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch1081 := typeInfo.FP.Get_kind(_env); _switch1081 == Ast_TypeInfoKind__Stem || _switch1081 == Ast_TypeInfoKind__Alge {
        return true
    } else if _switch1081 == Ast_TypeInfoKind__Alternate {
        if typeInfo.FP.HasBase(_env){
            return convGo_isAnyType_1139_(_env, typeInfo.FP.Get_baseTypeInfo(_env))
        }
        return true
...
func convGo_isClosure_1141_(_env *LnsEnv, typeInfo *Ast_TypeInfo) bool {
    var scope *Ast_Scope
    ...
    return scope.FP.Get_closureSymList(_env).Len() > 0
}

// 310: decl @lune.@base.@convGo.concatGLSym
func convGo_concatGLSym_1151_(_env *LnsEnv, name string,external bool) string {
    if external{
...
func ConvGo_outputGoMain(_env *LnsEnv, appName string,mod string,testing bool,path LnsAny,opt *Option_RuntimeOpt) LnsAny {
    ...
    if testing{
        ...
        code = convGo_convExp1532(Lns_2DDD(_env.LuaVM.String_gsub(code,"Lns_init%(%)", _env.LuaVM.String_format("Lns_RunMain( %s___main )", []LnsAny{convGo_concatGLSym_1151_(_env, mainMod, true)}))))
...
func convGo_isInnerDeclType_1156_(_env *LnsEnv, typeInfo *Ast_TypeInfo) bool {
...
func convGo_normalizeSym_1174_(_env *LnsEnv, name string) string {
...
func convGo_str2gostr_1204_(_env *LnsEnv, txt string) string {
    var work string
    work = txt
...
func convGo_getOrgTypeInfo_1206_(_env *LnsEnv, typeInfo *Ast_TypeInfo) *Ast_TypeInfo {
    {
...
func convGo_needConvCast_1237_(_env *LnsEnv, dstType *Ast_TypeInfo,srcType *Ast_TypeInfo) bool {
    if _switch4410 := dstType.FP.Get_kind(_env); _switch4410 == Ast_TypeInfoKind__Nilable {
        return convGo_needConvCast_1237_(_env, dstType.FP.Get_nonnilableType(_env), srcType)
        ...
        if Lns_op_not(dstType.FP.HasBase(_env)){
            ...
            return convGo_needConvCast_1237_(_env, dstType.FP.Get_baseTypeInfo(_env), srcType)
        }
...
func convGo_getExpListKind_1255_(_env *LnsEnv, dstTypeList *LnsList,node *Nodes_ExpListNode,addEnvArg bool) LnsInt {
    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
        ...
        for _, _exp := range( node.FP.Get_expList(_env).Items ) {
            exp := _exp.(Nodes_NodeDownCast).ToNodes_Node()
            {
                ...
                if !Lns_IsNil( _castNode ) {
                    ...
                    if convGo_needConvCast_1237_(_env, castNode.FP.Get_castType(_env), castNode.FP.Get_exp(_env).FP.Get_expType(_env)){
                        return convGo_ExpListKind__Conv
                    }
                }
            }
...
func convGo_isRetGenerics_1284_(_env *LnsEnv, node *Nodes_ExpCallNode) bool {
    ...
    for _index, _retType := range( funcType.FP.Get_retTypeInfoList(_env).Items ) {
        ...
        if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
            ...
            _env.SetStackVal( Lns_op_not(convGo_isAnyType_1139_(_env, node.FP.Get_expTypeList(_env).GetAt(index).(Ast_TypeInfoDownCast).ToAst_TypeInfo()))) ).(bool)){
            return true
        }
    }
    return false
...
func convGo_getLnsItemKind_1643_(_env *LnsEnv, typeInfo *Ast_TypeInfo) string {
    {
...
func convFilter_processAndOr__isAndOr_1785_(_env *LnsEnv, exp *Nodes_Node) bool {
    {
        _parentNode := Nodes_ExpOp2NodeDownCastF(exp.FP)
        if !Lns_IsNil( _parentNode ) {
            parentNode := _parentNode.(*Nodes_ExpOp2Node)
            if _switch28557 := parentNode.FP.Get_op(_env).Txt; _switch28557 == "and" || _switch28557 == "or" {
                return true
            }
        }
    }
...
func convGo_Ast2Code_1879_(_env *LnsEnv, streamName string,ast *TransUnit_ASTInfo) string {
    ...
    conv = ConvGo_createFilter(_env, false, streamName, stream.FP, ast, NewConvGo_Option(_env, "lns", "lnsgo", "", false))
...
func NewConvGo_Option(_env *LnsEnv, arg1 string, arg2 string, arg3 string, arg4 bool) *ConvGo_Option {
    obj := &ConvGo_Option{}
    obj.FP = obj
    obj.InitConvGo_Option(_env, arg1, arg2, arg3, arg4)
    return obj
}
func (self *ConvGo_Option) InitConvGo_Option(_env *LnsEnv, arg1 string, arg2 string, arg3 string, arg4 bool) {
...
func (self *convGo_convFilter) InitconvGo_convFilter(_env *LnsEnv, enableTest bool,streamName string,stream Lns_oStream,ast *TransUnit_ASTInfo,option *ConvGo_Option) {
    ...
    self.processInfo = ast.FP.Get_exportInfo(_env).FP.Get_processInfo(_env)
    ...
    self.modDir = convGo_convExp557(Lns_2DDD(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(modDir,"@", "")).(string),"%.$", "")))
...
func (self *convGo_convFilter) IsPubType(_env *LnsEnv, typeInfo *Ast_TypeInfo) bool {
    if Ast_isPubToExternal(_env, typeInfo.FP.Get_accessMode(_env)){
        if typeInfo.FP.Get_kind(_env) == Ast_TypeInfoKind__Func{
            if _switch728 := typeInfo.FP.Get_parentInfo(_env).FP.Get_kind(_env); _switch728 == Ast_TypeInfoKind__Class || _switch728 == Ast_TypeInfoKind__Enum {
...
func (self *convGo_convFilter) concatSymWithType(_env *LnsEnv, name string,typeInfo *Ast_TypeInfo) string {
    ...
    return convGo_concatGLSym_1151_(_env, typeName, self.FP.IsPubType(_env, typeInfo))
}
...
func (self *convGo_convFilter) getSymbol(_env *LnsEnv, kind LnsAny,name string) string {
    ...
    symbolName = convGo_normalizeSym_1174_(_env, name)
    ...
    symbolInfo := _exp2827.Val1
        ...
        if Lns_op_not(symbolInfo.FP.GetModule(_env).FP.Equals(_env, self.processInfo, self.moduleTypeInfo, nil, nil)){
            ...
            symbolName = convGo_concatGLSym_1151_(_env, _env.LuaVM.String_format("%s_", []LnsAny{modName}) + symbolName, Ast_isPubToExternal(_env, symbolInfo.FP.Get_accessMode(_env)))
    ...
    external := _exp2827.Val1
        symbolName = convGo_concatGLSym_1151_(_env, symbolName, external)
    ...
    typeInfo := _exp2827.Val1
        if typeInfo.FP.Get_kind(_env) == Ast_TypeInfoKind__Method{
            if _switch2339 := symbolName; _switch2339 == "_toMap" {
                ...
                symbolName = convGo_concatGLSym_1151_(_env, symbolName, Ast_isPubToExternal(_env, typeInfo.FP.Get_accessMode(_env)))
            ...
            if _switch2614 := typeInfo.FP.Get_parentInfo(_env).FP.Get_kind(_env); _switch2614 == Ast_TypeInfoKind__Module || _switch2614 == Ast_TypeInfoKind__Func || _switch2614 == Ast_TypeInfoKind__Method {
                if convGo_isInnerDeclType_1156_(_env, typeInfo){
                    if Lns_op_not(convGo_isClosure_1141_(_env, typeInfo)){
                ...
                symbolName = convGo_concatGLSym_1151_(_env, symbolName, true)
            ...
            if prefix != nil{
                ...
                symbolName = _env.LuaVM.String_format("%s.%s", []LnsAny{prefix_354, symbolName})
    ...
    needPrefix := _exp2827.Val2
        ...
        var workName string
        if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
            _env.SetStackVal( convGo_isInnerDeclType_1156_(_env, typeInfo)) &&
...
func (self *convGo_convFilter) type2gotypeOrg(_env *LnsEnv, typeInfo *Ast_TypeInfo,addClassAster bool) string {
    ...
    if convGo_isAnyType_1139_(_env, typeInfo){
        return "LnsAny"
    }
    var orgType *Ast_TypeInfo
    orgType = convGo_getOrgTypeInfo_1206_(_env, typeInfo)
    {
    ...
    if _switch3674 := orgType.FP.Get_kind(_env); _switch3674 == Ast_TypeInfoKind__Ext {
...
func (self *convGo_convFilter) outputAny2Type(_env *LnsEnv, dstType *Ast_TypeInfo) {
    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
        _env.SetStackVal( Lns_op_not(convGo_isAnyType_1139_(_env, dstType))) &&
...
func (self *convGo_convFilter) outputImplicitCast(_env *LnsEnv, castType *Ast_TypeInfo,node *Nodes_Node,parent *Nodes_ExpCastNode) {
    if _switch5075 := castType.FP.Get_kind(_env); _switch5075 == Ast_TypeInfoKind__Nilable {
        ...
        if _env.PopVal( _env.IncStack() ||
            ...
            convGo_filter_1137_(_env, node, self, &parent.Nodes_Node)
        } else { 
            if convGo_isAnyType_1139_(_env, node.FP.Get_expType(_env)){
...
func (self *convGo_convFilter) processConvExp(_env *LnsEnv, nodeId LnsInt,dstTypeList *LnsList,argListNode LnsAny,hasRetEnv bool) {
    ...
    if convGo_getExpListKind_1255_(_env, dstTypeList, argList, self.option.FP.Get_addEnvArg(_env)) != convGo_ExpListKind__Conv{
        return 
    }
    var expList *LnsList
    ...
    if needRetEnv{
        self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, retTypeList.Len(), self.option.FP.Get_addEnvArg(_env)))
    }
    if mRetIndex != nil{
        ...
        for _index, _retType := range( retTypeList.Items ) {
            ...
            if index >= mRetIndex_718{
                var valTxt string
                valTxt = _env.LuaVM.String_format("Lns_getFromMulti( arg%d, %d )", []LnsAny{mRetIndex_718, index - mRetIndex_718})
                var wrote bool
                wrote = false
            ...
            for _index, _ := range( expList.Items ) {
                ...
                if index >= restIndex_739{
                    if index < expList.Len(){
                        ...
                        self.FP.Write(_env, _env.LuaVM.String_format("arg%d[%d:]", []LnsAny{mRetIndex_718, index - mRetIndex_718}))
                        break
                    }
                }
            }
...
func (self *convGo_convFilter) outputNilAccCall(_env *LnsEnv, node *Nodes_ExpCallNode) {
    ...
    if node.FP.Get_expTypeList(_env).Len() > convGo_MaxNilAccNum{
        ...
        lists = "list[0]"
        {
            ...
            var _to6468 LnsInt = node.FP.Get_expTypeList(_env).Len()
...
func (self *convGo_convFilter) processGenericsCall(_env *LnsEnv, node *Nodes_ExpCallNode) {
    if _env.PopVal( _env.IncStack() ||
        _env.SetStackVal( Lns_op_not(convGo_isRetGenerics_1284_(_env, node))) ||
...
func (self *convGo_convFilter) OutputDeclFunc(_env *LnsEnv, addEnvArg bool,funcInfo LnsAny) *convGo_FuncConv {
    ...
    if convGo_isClosure_1141_(_env, typeInfo){
        ...
        if typeInfo.FP.Get_extedType(_env).FP.Get_kind(_env) != Ast_TypeInfoKind__FormFunc{
            if name != nil{
                ...
                self.FP.outputSymbol(_env, &convGo_SymbolKind__Func{typeInfo}, name_854)
            }
        }
    }
    self.FP.Write(_env, "(")
            ...
            if argType.FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Alternate{
                {
                    ...
                    if !Lns_IsNil( _argNode ) {
                        ...
                        convGo_filter_1137_(_env, arg, self, node)
                    }
                }
            } else { 
                convGo_filter_1137_(_env, arg, self, node)
...
func (self *convGo_convFilter) outputConvToForm(_env *LnsEnv, node *Nodes_ExpCastNode) {
    ...
    self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, funcType.FP.Get_argTypeInfoList(_env).Len(), self.option.FP.Get_addEnvArg(_env)))
    for _index, _argType := range( funcType.FP.Get_argTypeInfoList(_env).Items ) {
        index := _index + 1
        argType := _argType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
        if index > 1{
...
func (self *convGo_convFilter) outputModuleImport(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    var mod string
    mod = convGo_convExp8458(Lns_2DDD(_env.LuaVM.String_gsub(normalType.FP.Get_requirePath(_env),"%.[^%.]+$", "")))
    if Lns_isCondTrue( Lns_car(_env.LuaVM.String_find(mod,"^go/", nil, nil))){
        var workMod string
        workMod = convGo_convExp8497(Lns_2DDD(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(mod,"^go/", "")).(string),"%.", "/")).(string),":", ".")))
        self.FP.Writeln(_env, _env.LuaVM.String_format("\"%s\"", []LnsAny{workMod}))
    } else { 
        var path string
        path = convGo_convExp8535(Lns_2DDD(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(normalType.FP.Get_requirePath(_env),"%.", "/")).(string),":", ".")))
...
func (self *convGo_convFilter) outputImport(_env *LnsEnv, node *Nodes_ImportNode) {
    ...
    if Lns_isCondTrue( Lns_car(_env.LuaVM.String_find(node.FP.Get_modulePath(_env),"^go/", nil, nil))){
        var workMod string
        workMod = convGo_convExp8639(Lns_2DDD(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(node.FP.Get_modulePath(_env),"^go/", "")).(string),"%.", "/")).(string),":", ".")))
        ...
        if count == 0{
            ...
            var modDir string
            modDir = convGo_convExp8718(Lns_2DDD(_env.LuaVM.String_gsub(modulePath,"/", "")))
...
func (self *convGo_convFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    self.FP.Writeln(_env, _env.LuaVM.String_format("var %s string", []LnsAny{self.FP.getSymbolSym(_env, modSym)}))
    {
        ...
        procNode = func(_env *LnsEnv, workNode *Nodes_Node) {
            convGo_filter_1137_(_env, workNode, self, &node.Nodes_Node)
        }
    ...
    
    {
        ...
        procNode = func(_env *LnsEnv, workNode *Nodes_IfUnwrapNode) {
            ...
            symTypeList = NewLnsList([]LnsAny{})
            {
                ...
                var _to10329 LnsInt = workNode.FP.Get_varSymList(_env).Len()
    ...
    var modulePath string
    modulePath = convGo_convExp11362(Lns_2DDD(_env.LuaVM.String_gsub(node.FP.Get_moduleTypeInfo(_env).FP.GetFullName(_env, self.FP.Get_typeNameCtrl(_env), self.FP.Get_moduleInfoManager(_env), nil),"@", "")))
    ...
    for _, _child := range( node.FP.Get_children(_env).Items ) {
        ...
        if Lns_op_not(convGo_ignoreNodeInInnerBlockSet.Has(child.FP.Get_kind(_env))){
            convGo_filter_1137_(_env, child, self, &node.Nodes_Node)
        }
    }
    self.FP.PopIndent(_env)
    self.FP.Writeln(_env, "}")
    if self.option.mainModule == Lns_car(_env.LuaVM.String_gsub(self.FP.getCanonicalName(_env, self.moduleTypeInfo, false),"@", "")).(string){
        ...
        for _, _workNode := range( node.FP.Get_nodeManager(_env).FP.GetDeclFuncNodeList(_env).Items ) {
            ...
            if convGo_isMain_1045_(_env, workNode.FP.Get_expType(_env)){
                hasMain = true
        ...
        if Lns_op_not(hasMain){
            ...
            self.FP.Writeln(_env, _env.LuaVM.String_format("func %s___main( %sargs *LnsList ) LnsInt {", []LnsAny{convGo_concatGLSym_1151_(_env, moduleSym, true), self.FP.getEnvArgDecl(_env, 1)}))
...
func (self *convGo_convFilter) ProcessEnv(_env *LnsEnv, node *Nodes_EnvNode,_opt LnsAny) {
    ...
    convGo_filter_1137_(_env, &node.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
...
func (self *convGo_convFilter) ProcessBlockSub(_env *LnsEnv, node *Nodes_BlockNode,_opt LnsAny) {
    if _switch11802 := node.FP.Get_blockKind(_env); _switch11802 == Nodes_BlockKind__Block {
        self.FP.Writeln(_env, "{")
    }
    ...
    self.FP.PopIndent(_env)
    self.FP.popProcessMode(_env)
    if _switch11877 := node.FP.Get_blockKind(_env); _switch11877 == Nodes_BlockKind__Block {
        self.FP.Writeln(_env, "}")
    }
}
...
func (self *convGo_convFilter) expList2Slice(_env *LnsEnv, subList *Nodes_ExpListNode,toStem bool) {
    ...
    processExp = func(_env *LnsEnv, exp *Nodes_Node) {
        if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
            ...
            convGo_filter_1137_(_env, Nodes_getCastUnwraped(_env, exp), self, &subList.Nodes_Node)
            self.FP.Write(_env, ")")
        } else { 
            convGo_filter_1137_(_env, exp, self, &subList.Nodes_Node)
        }
    }
    var mRetIndex LnsAny
...
func (self *convGo_convFilter) processSetFromExpList(_env *LnsEnv, convArgFuncName string,dstTypeList *LnsList,expListNode *Nodes_ExpListNode,addEnvArg bool) {
    if _switch12742 := convGo_getExpListKind_1255_(_env, dstTypeList, expListNode, addEnvArg); _switch12742 == convGo_ExpListKind__Conv {
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Nodes_MRetExp).FP.Get_index(_env)}))
        self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, expListNode.FP.Get_expList(_env).Len(), addEnvArg))
        for _index, _exp := range( expListNode.FP.Get_expList(_env).Items ) {
            ...
            if mRetIndex == index{
                self.FP.Write(_env, "Lns_2DDD(")
                convGo_filter_1137_(_env, Nodes_getCastUnwraped(_env, exp), self, &expListNode.Nodes_Node)
                self.FP.Write(_env, ")")
                break
            }
            convGo_filter_1137_(_env, exp, self, &expListNode.Nodes_Node)
        ...
        self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, dstTypeList.Len(), addEnvArg))
                ...
                argExp = expListNode.FP.Get_expList(_env).GetAt(index).(Nodes_NodeDownCast).ToNodes_Node()
                {
                    ...
                    if !Lns_IsNil( _exp2ddd ) {
                        ...
                        if argExp.FP.Get_expType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Abbr{
                            ...
                            convGo_filter_1137_(_env, argExp, self, &expListNode.Nodes_Node)
                        }
                    }
                }
            } else { 
...
func (self *convGo_convFilter) ProcessStmtExp(_env *LnsEnv, node *Nodes_StmtExpNode,_opt LnsAny) {
    convGo_filter_1137_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
    self.FP.Writeln(_env, "")
}
...
func (self *convGo_convFilter) ProcessDeclAlge(_env *LnsEnv, node *Nodes_DeclAlgeNode,_opt LnsAny) {
    ...
    {
        __collection12957 := node.FP.Get_algeType(_env).FP.Get_valInfoMap(_env)
...
func (self *convGo_convFilter) ProcessNewAlgeVal(_env *LnsEnv, node *Nodes_NewAlgeValNode,_opt LnsAny) {
    ...
    if node.FP.Get_valInfo(_env).FP.Get_typeList(_env).Len() == 0{
        ...
        for _index, _param := range( node.FP.Get_paramList(_env).Items ) {
            ...
            convGo_filter_1137_(_env, param, self, &node.Nodes_Node)
        }
        self.FP.Write(_env, "}")
    }
}
...
func (self *convGo_convFilter) ProcessExpMacroExp(_env *LnsEnv, node *Nodes_ExpMacroExpNode,_opt LnsAny) {
    for _, _stmt := range( node.FP.Get_stmtList(_env).Items ) {
        ...
        if Lns_op_not(convGo_ignoreNodeInInnerBlockSet.Has(stmt.FP.Get_kind(_env))){
            convGo_filter_1137_(_env, stmt, self, &node.Nodes_Node)
        }
    }
}
...
func (self *convGo_convFilter) ProcessDeclConstr(_env *LnsEnv, node *Nodes_DeclConstrNode,_opt LnsAny) {
    ...
    for _index, _arg := range( node.FP.Get_declInfo(_env).FP.Get_argList(_env).Items ) {
        ...
        convGo_filter_1137_(_env, arg, self, &node.Nodes_Node)
    }
    self.FP.Writeln(_env, ") {")
    convGo_filter_1137_(_env, &Lns_unwrap( node.FP.Get_declInfo(_env).FP.Get_body(_env)).(*Nodes_BlockNode).Nodes_Node, self, &node.Nodes_Node)
    self.FP.Writeln(_env, "}")
}
...
func (self *convGo_convFilter) ProcessExpCallSuperCtor(_env *LnsEnv, node *Nodes_ExpCallSuperCtorNode,_opt LnsAny) {
    self.FP.Write(_env, _env.LuaVM.String_format("self.%s(", []LnsAny{self.FP.getConstrSymbol(_env, node.FP.Get_superType(_env))}))
    {
        ...
        if !Lns_IsNil( _argList ) {
            ...
            self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, 0, self.option.FP.Get_addEnvArg(_env)))
        }
    }
    self.FP.Writeln(_env, ")")
}
...
func (self *convGo_convFilter) outputDummyReturn(_env *LnsEnv, retTypeInfoList *LnsList) {
    ...
    for _index, _retType := range( retTypeInfoList.Items ) {
        ...
        if convGo_isAnyType_1139_(_env, retType){
            self.FP.Write(_env, "nil")
        } else { 
            if _switch13770 := convGo_getOrgTypeInfo_1206_(_env, retType); _switch13770 == Ast_builtinTypeInt {
...
func (self *convGo_convFilter) OutputDeclFuncInfo(_env *LnsEnv, node *Nodes_Node,declInfo *Nodes_DeclFuncInfo) {
    ...
    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
        ...
        _env.SetStackVal( Lns_op_not(convGo_isClosure_1141_(_env, funcType))) )){
    ...
    self.FP.Writeln(_env, " {")
    self.FP.PushIndent(_env, nil)
    if convGo_isMain_1045_(_env, funcType){
        self.FP.Writeln(_env, _env.LuaVM.String_format("Lns_%s_init( %s )", []LnsAny{self.FP.getModuleName(_env, self.moduleTypeInfo, false), convGo_getAddEnvArg_1132_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
    }
    if declInfo.FP.Get_has__func__Symbol(_env){
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, "__func__")})/* 2500:29 */)).(*Ast_SymbolInfo)
    ...
    self.FP.PopIndent(_env)
    {
        ...
        if !Lns_IsNil( _body ) {
            ...
            convGo_filter_1137_(_env, &body.Nodes_Node, self, node)
            ...
            if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                ...
                needReturn = false
                {
                    var _from14148 LnsInt = body.FP.Get_stmtList(_env).Len()
                    ...
                    for {
                        ...
                        if _switch14146 := statment.FP.Get_kind(_env); _switch14146 == Nodes_NodeKind_get_BlankLine(_env) {
                        } else if _switch14146 == Nodes_NodeKind_get_Return(_env) {
                            break
                        } else {
                            needReturn = true
...
func (self *convGo_convFilter) ProcessDeclEnum(_env *LnsEnv, node *Nodes_DeclEnumNode,_opt LnsAny) {
    if _switch14805 := self.processMode; _switch14805 == convGo_ProcessMode__DeclTopScopeVar {
        ...
        {
            __collection14417 := node.FP.Get_enumType(_env).FP.Get_name2EnumValInfo(_env)
            ...
            for _, ___key14417 := range( __sorted14417.Items ) {
                ...
                switch _exp14407 := valInfo.FP.Get_val(_env).(type) {
                ...
                val := _exp14407.Val1
                    self.FP.Write(_env, convGo_str2gostr_1204_(_env, _env.LuaVM.String_format("\"%s\"", []LnsAny{val})))
                }
                self.FP.Writeln(_env, "")
            }
        }
        ...
        {
            __collection14647 := node.FP.Get_enumType(_env).FP.Get_name2EnumValInfo(_env)
...
func (self *convGo_convFilter) ProcessIfUnwrap(_env *LnsEnv, node *Nodes_IfUnwrapNode,_opt LnsAny) {
    ...
    if convGo_getExpListKind_1255_(_env, tempTypeList, node.FP.Get_expList(_env), self.option.FP.Get_addEnvArg(_env)) == convGo_ExpListKind__Direct{
        {
            var _from14974 LnsInt = node.FP.Get_varSymList(_env).Len() + 1
            var _to14974 LnsInt = node.FP.Get_expList(_env).FP.Get_expTypeList(_env).Len()
    ...
    convGo_filter_1137_(_env, &node.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
    {
        ...
        if !Lns_IsNil( _nilBlock ) {
            ...
            convGo_filter_1137_(_env, &nilBlock.Nodes_Node, self, &node.Nodes_Node)
            self.FP.Writeln(_env, "}")
        } else {
            self.FP.Writeln(_env, "}")
        }
    ...
    if node.FP.Get_unwrapFlag(_env){
        {
            ...
            if !Lns_IsNil( _expList ) && !Lns_IsNil( _unwrapBlock ) {
                ...
                for _index, _varInfo := range( node.FP.Get_varList(_env).Items ) {
                    ...
                    self.FP.Write(_env, _env.LuaVM.String_format("_%s", []LnsAny{convGo_normalizeSym_1174_(_env, varInfo.FP.Get_name(_env).Txt)}))
                }
                ...
                if convGo_getExpListKind_1255_(_env, tmpVarTypeList, expList, self.option.FP.Get_addEnvArg(_env)) == convGo_ExpListKind__Direct{
                    {
                        var _from15481 LnsInt = tmpVarTypeList.Len() + 1
                        var _to15481 LnsInt = expList.FP.Get_expTypeList(_env).Len()
                ...
                for _index, _varInfo := range( node.FP.Get_varList(_env).Items ) {
                    ...
                    if expList.FP.GetExpTypeNoDDDAt(_env, index).FP.Get_nilable(_env){
                        ...
                        self.FP.Write(_env, _env.LuaVM.String_format("_%s == nil", []LnsAny{convGo_normalizeSym_1174_(_env, varInfo.FP.Get_name(_env).Txt)}))
                        hasCond = true
                        
                    }
                }
                self.FP.Writeln(_env, "{")
                convGo_filter_1137_(_env, &unwrapBlock.Nodes_Node, self, &node.Nodes_Node)
                {
                    ...
                    if !Lns_IsNil( _thenBlock ) {
                        ...
                        for _index, _varInfo := range( node.FP.Get_symbolInfoList(_env).Items ) {
                            ...
                            self.FP.Write(_env, _env.LuaVM.String_format("%s = _%s", []LnsAny{self.FP.getSymbolSym(_env, varInfo), convGo_normalizeSym_1174_(_env, varInfo.FP.Get_name(_env))}))
                            if expList.FP.GetExpTypeNoDDDAt(_env, index).FP.Get_nilable(_env){
                        ...
                        self.FP.PopIndent(_env)
                        convGo_filter_1137_(_env, &thenBlock.Nodes_Node, self, &node.Nodes_Node)
                        self.FP.Writeln(_env, "}")
                    } else {
                        self.FP.Writeln(_env, "} else {")
                        self.FP.PushIndent(_env, nil)
        ...
        declVar(_env)
        {
            ...
            if !Lns_IsNil( _expList ) {
                ...
                if convGo_getExpListKind_1255_(_env, varTypeList, expList, self.option.FP.Get_addEnvArg(_env)) == convGo_ExpListKind__Direct{
                    {
                        var _from15955 LnsInt = varTypeList.Len() + 1
                        var _to15955 LnsInt = expList.FP.Get_expTypeList(_env).Len()
...
func (self *convGo_convFilter) ProcessDeclVar(_env *LnsEnv, node *Nodes_DeclVarNode,_opt LnsAny) {
    ...
    if _switch16458 := node.FP.Get_mode(_env); _switch16458 == Nodes_DeclVarMode__Let {
        ...
        if convGo_getExpListKind_1255_(_env, typeList, expList, self.option.FP.Get_addEnvArg(_env)) == convGo_ExpListKind__Direct{
            {
                var _from16235 LnsInt = node.FP.Get_symbolInfoList(_env).Len() + 1
                var _to16235 LnsInt = expList.FP.Get_expTypeList(_env).Len()
        ...
        self.FP.Writeln(_env, " {")
        convGo_filter_1137_(_env, &Lns_unwrap( node.FP.Get_unwrapBlock(_env)).(*Nodes_BlockNode).Nodes_Node, self, &node.Nodes_Node)
        {
            _thenBlock := node.FP.Get_thenBlock(_env)
            if !Lns_IsNil( _thenBlock ) {
                thenBlock := _thenBlock.(*Nodes_BlockNode)
...
func (self *convGo_convFilter) ProcessWhen(_env *LnsEnv, node *Nodes_WhenNode,_opt LnsAny) {
    ...
    convGo_filter_1137_(_env, &node.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
    {
        ...
        if !Lns_IsNil( _elseBlock ) {
            ...
            self.FP.Writeln(_env, "} else {")
            convGo_filter_1137_(_env, &elseBlock.Nodes_Node, self, &node.Nodes_Node)
            self.FP.Write(_env, "}")
        } else {
            self.FP.Write(_env, "}")
        }
...
func (self *convGo_convFilter) ProcessDeclArg(_env *LnsEnv, node *Nodes_DeclArgNode,_opt LnsAny) {
    ...
    convGo_filter_1137_(_env, &Lns_unwrap( node.FP.Get_argType(_env)).(*Nodes_RefTypeNode).Nodes_Node, self, &node.Nodes_Node)
}
...
func (self *convGo_convFilter) ProcessDeclFunc(_env *LnsEnv, node *Nodes_DeclFuncNode,_opt LnsAny) {
    ...
    var funcType *Ast_TypeInfo
    funcType = node.FP.Get_expType(_env)
    if (self.processMode == convGo_ProcessMode__NonClosureFuncDecl) == convGo_isClosure_1141_(_env, node.FP.Get_expType(_env)){
        if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
    ...
    if convGo_isClosure_1141_(_env, funcType){
        {
            _funcSym := node.FP.Get_declInfo(_env).FP.Get_symbol(_env)
            if !Lns_IsNil( _funcSym ) {
                funcSym := _funcSym.(*Ast_SymbolInfo)
...
func (self *convGo_convFilter) processCond(_env *LnsEnv, node *Nodes_Node,parent *Nodes_Node) {
    if node.FP.Get_expType(_env) != Ast_builtinTypeBool{
        ...
        convGo_filter_1137_(_env, node, self, parent)
        self.FP.Write(_env, ")")
    } else { 
        convGo_filter_1137_(_env, node, self, parent)
    }
...
func (self *convGo_convFilter) ProcessIf(_env *LnsEnv, node *Nodes_IfNode,_opt LnsAny) {
    for _, _stmt := range( node.FP.Get_stmtList(_env).Items ) {
        ...
        if _switch17249 := stmt.FP.Get_kind(_env); _switch17249 == Nodes_IfKind__If {
            self.FP.Write(_env, "if ")
            self.FP.processCond(_env, stmt.FP.Get_exp(_env), &node.Nodes_Node)
            self.FP.Writeln(_env, "{")
            convGo_filter_1137_(_env, &stmt.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
...
func (self *convGo_convFilter) ProcessSwitch(_env *LnsEnv, node *Nodes_SwitchNode,_opt LnsAny) {
    ...
    for _caseIndex, _caseNode := range( node.FP.Get_caseList(_env).Items ) {
        ...
        for _index, _exp := range( caseNode.FP.Get_expList(_env).FP.Get_expList(_env).Items ) {
            ...
            convGo_filter_1137_(_env, exp, self, &caseNode.FP.Get_expList(_env).Nodes_Node)
        }
        self.FP.Writeln(_env, " {")
        convGo_filter_1137_(_env, &caseNode.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
    }
    {
        ...
        if !Lns_IsNil( _defaultBlock ) {
            ...
            self.FP.Writeln(_env, "} else {")
            convGo_filter_1137_(_env, &defaultBlock.Nodes_Node, self, &node.Nodes_Node)
        }
    }
    self.FP.Writeln(_env, "}")
}
...
func (self *convGo_convFilter) ProcessMatch(_env *LnsEnv, node *Nodes_MatchNode,_opt LnsAny) {
    ...
    convGo_filter_1137_(_env, node.FP.Get_val(_env), self, &node.Nodes_Node)
    ...
    for _, _caseInfo := range( node.FP.Get_caseList(_env).Items ) {
        ...
        convGo_filter_1137_(_env, &caseInfo.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
    }
    {
        ...
        if !Lns_IsNil( _defaultBlock ) {
            ...
            convGo_filter_1137_(_env, defaultBlock, self, &node.Nodes_Node)
        }
    }
    self.FP.Writeln(_env, "}")
}
...
func (self *convGo_convFilter) ProcessFor(_env *LnsEnv, node *Nodes_ForNode,_opt LnsAny) {
    ...
    convGo_filter_1137_(_env, node.FP.Get_init(_env), self, &node.Nodes_Node)
    self.FP.Writeln(_env, "")
    self.FP.Write(_env, _env.LuaVM.String_format("var %s %s = ", []LnsAny{toSym, valType}))
    convGo_filter_1137_(_env, node.FP.Get_to(_env), self, &node.Nodes_Node)
    self.FP.Writeln(_env, "")
    {
        ...
        if !Lns_IsNil( _delta ) {
            ...
            convGo_filter_1137_(_env, delta, self, &node.Nodes_Node)
            self.FP.Writeln(_env, "")
            self.FP.Writeln(_env, "for {")
            self.FP.PushIndent(_env, nil)
...
func (self *convGo_convFilter) ProcessApply(_env *LnsEnv, node *Nodes_ApplyNode,_opt LnsAny) {
    ...
    if Lns_isCondTrue( node.FP.Get_expList(_env).FP.Get_mRetExp(_env)){
        ...
        convGo_filter_1137_(_env, &node.FP.Get_expList(_env).Nodes_Node, self, &node.Nodes_Node)
        self.FP.Writeln(_env, "")
    } else { 
        self.FP.Write(_env, _env.LuaVM.String_format("%s, %s, %s := ", []LnsAny{formSym, paramSym, prevSym}))
        convGo_filter_1137_(_env, node.FP.Get_expList(_env).FP.Get_expList(_env).GetAt(1).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.FP.Get_expList(_env).Nodes_Node)
        self.FP.Write(_env, ",")
        convGo_filter_1137_(_env, node.FP.Get_expList(_env).FP.Get_expList(_env).GetAt(2).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.FP.Get_expList(_env).Nodes_Node)
        self.FP.Write(_env, ", LnsAny(")
        convGo_filter_1137_(_env, node.FP.Get_expList(_env).FP.Get_expList(_env).GetAt(3).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.FP.Get_expList(_env).Nodes_Node)
        self.FP.Writeln(_env, ")")
    }
    self.FP.Writeln(_env, "for {")
    self.FP.PushIndent(_env, nil)
    ...
    setTxt = prevSym
    {
        ...
        var _to18571 LnsInt = node.FP.Get_varList(_env).Len()
    ...
    if node.FP.Get_expList(_env).FP.Get_expType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext{
        ...
        self.FP.Writeln(_env, _env.LuaVM.String_format("%s = %s( %s %s, %s )", []LnsAny{setTxt, formSym, convGo_getAddEnvArg_1132_(_env, 2, self.option.FP.Get_addEnvArg(_env)), paramSym, prevSym}))
    }
...
func (self *convGo_convFilter) outputForeachLua(_env *LnsEnv, node *Nodes_Node,sortFlag bool,exp *Nodes_Node,val *Ast_SymbolInfo,key LnsAny,block *Nodes_BlockNode) {
    ...
    if _switch19352 := exp.FP.Get_expType(_env).FP.Get_extedType(_env).FP.Get_kind(_env); _switch19352 == Ast_TypeInfoKind__List || _switch19352 == Ast_TypeInfoKind__Map {
        self.FP.Writeln(_env, "{")
        self.FP.PushIndent(_env, nil)
        var tmpExp string
        ...
        convGo_filter_1137_(_env, exp, self, node)
        self.FP.Writeln(_env, "")
        ...
        self.FP.PopIndent(_env)
        convGo_filter_1137_(_env, &block.Nodes_Node, self, node)
        self.FP.PushIndent(_env, nil)
...
func (self *convGo_convFilter) ProcessForeach(_env *LnsEnv, node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    if _switch20236 := loopExpType.FP.Get_kind(_env); _switch20236 == Ast_TypeInfoKind__List || _switch20236 == Ast_TypeInfoKind__Array {
        var valName string
...
func (self *convGo_convFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    self.FP.Writeln(_env, _env.LuaVM.String_format("%s.Sort( %s, nil )", []LnsAny{sortSym, convGo_getLnsItemKind_1643_(_env, keyTypeInfo)}))
...
func (self *convGo_convFilter) ProcessExpUnwrap(_env *LnsEnv, node *Nodes_ExpUnwrapNode,_opt LnsAny) {
    {
        ...
        if !Lns_IsNil( _def ) {
            ...
            convGo_filter_1137_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
            self.FP.Write(_env, ", ")
            convGo_filter_1137_(_env, def, self, &node.Nodes_Node)
        } else {
            ...
            if !Lns_IsNil( _refTypeNode ) {
                refTypeNode := _refTypeNode.(*Nodes_RefTypeNode)
                {
                    ...
                    if !Lns_IsNil( _refNode ) {
                        ...
                        convGo_filter_1137_(_env, refNode.FP.Get_prefix(_env), self, &node.Nodes_Node)
                        self.FP.Write(_env, ".")
                    }
                }
            }
...
func (self *convGo_convFilter) outputClassType(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        convGo_filter_1137_(_env, &memberNode.Nodes_Node, self, &node.Nodes_Node)
    }
    self.FP.Write(_env, "FP ")
    self.FP.Write(_env, self.FP.getTypeSymbol(_env, node.FP.Get_expType(_env)))
...
func (self *convGo_convFilter) outputConstructor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    if Lns_op_not(node.FP.Get_expType(_env).FP.Get_abstractFlag(_env)){
        ...
        self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, initFuncType.FP.Get_argTypeInfoList(_env).Len(), self.option.FP.Get_addEnvArg(_env)))
    ...
    if Lns_op_not(node.FP.HasUserInit(_env)){
        ...
        if node.FP.Get_expType(_env).FP.HasBase(_env){
            ...
            self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, baseInitFuncType.FP.Get_argTypeInfoList(_env).Len(), self.option.FP.Get_addEnvArg(_env)))
            {
                var _from22610 LnsInt = 1
                var _to22610 LnsInt = baseInitFuncType.FP.Get_argTypeInfoList(_env).Len()
...
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 3950:33 */)).(*Ast_SymbolInfo)
            ...
            if retType.FP.Get_srcTypeInfo(_env) != memberSym.FP.Get_typeInfo(_env).FP.Get_srcTypeInfo(_env){
                if retType.FP.Get_kind(_env) == Ast_TypeInfoKind__IF{
                    ...
                    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                        _env.SetStackVal( convGo_isAnyType_1139_(_env, retType)) &&
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 3991:33 */)).(*Ast_SymbolInfo)
    ...
    if self.processMode == convGo_ProcessMode__DeclClass{
        ...
        }
        {
            ...
            if !Lns_IsNil( _initBlock ) {
                ...
                convGo_filter_1137_(_env, &initBlock.Nodes_Node, self, &node.Nodes_Node)
                self.FP.Writeln(_env, "")
            }
        }
    } else { 
        {
            ...
            if !Lns_IsNil( _initBlock ) {
                initBlock := _initBlock.(*Nodes_DeclMethodNode)
                self.FP.Writeln(_env, _env.LuaVM.String_format("%s(%s)", []LnsAny{self.FP.getFuncSymbol(_env, initBlock.FP.Get_expType(_env)), convGo_getAddEnvArg_1132_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
            }
        }
    }
}
...
func (self *convGo_convFilter) getFromStemName(_env *LnsEnv, typeInfo *Ast_TypeInfo) string {
    ...
    workTypeInfo = convGo_getOrgTypeInfo_1206_(_env, typeInfo)
    {
    ...
    if _switch23408 := workTypeInfo.FP.Get_kind(_env); _switch23408 == Ast_TypeInfoKind__List || _switch23408 == Ast_TypeInfoKind__Array {
        return "Lns_ToList"
...
func (self *convGo_convFilter) outputMapping(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    if Lns_op_not(classType.FP.Get_abstractFlag(_env)){
        var envStr string
        envStr = convGo_getAddEnvArg_1132_(_env, 1, self.option.FP.Get_addEnvArg(_env))
        {
...
func (self *convGo_convFilter) ProcessDeclClass(_env *LnsEnv, node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    if self.processMode == convGo_ProcessMode__DeclClass{
        if _switch25337 := node.FP.Get_expType(_env).FP.Get_kind(_env); _switch25337 == Ast_TypeInfoKind__Class {
            ...
            for _, _fieldNode := range( node.FP.Get_fieldList(_env).Items ) {
                ...
                if Lns_isCondTrue( Nodes_DeclMemberNodeDownCastF(fieldNode.FP)){
                    ...
                    convGo_filter_1137_(_env, fieldNode, self, &node.Nodes_Node)
                    self.FP.Writeln(_env, "")
                }
            }
        ...
        if prefixType == Ast_builtinTypeString{
            ...
            if _env.PopVal( _env.IncStack() ||
                ...
                if node.FP.HasNilAccess(_env){
                    if Lns_op_not(prefixNode_2384.FP.HasNilAccess(_env)){
                        ...
                        convGo_filter_1137_(_env, prefixNode_2384, self, node)
                        self.FP.Writeln(_env, ") && ")
                    } else { 
                        convGo_filter_1137_(_env, prefixNode_2384, self, node)
                        self.FP.Writeln(_env, "&&")
            ...
            if prefixType.FP.Get_kind(_env) == Ast_TypeInfoKind__Ext{
                ...
                if Ast_isBuiltin(_env, funcType.FP.Get_typeId(_env).Id){
                    ...
                    if _switch26228 := funcType.FP.Get_kind(_env); _switch26228 == Ast_TypeInfoKind__Method {
...
func (self *convGo_convFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
        ...
        convGo_filter_1137_(_env, fieldNode.FP.Get_prefix(_env), self, &node.Nodes_Node)
        self.FP.Write(_env, ")")
        return 
    }
    ...
    if opt.Parent.FP.Get_kind(_env) == Nodes_NodeKind_get_StmtExp(_env){
        ...
        retGenerics = convGo_isRetGenerics_1284_(_env, node)
    ...
    var withPrefix bool
    {
        ...
        if !Lns_IsNil( _fieldNode ) {
            fieldNode := _fieldNode.(*Nodes_RefFieldNode)
            if _switch26472 := fieldNode.FP.Get_prefix(_env).FP.Get_expType(_env).FP.Get_kind(_env); _switch26472 == Ast_TypeInfoKind__List || _switch26472 == Ast_TypeInfoKind__Map || _switch26472 == Ast_TypeInfoKind__Set || _switch26472 == Ast_TypeInfoKind__Array {
                addEnvArg = false
            ...
            if Ast_isBuiltin(_env, funcType.FP.Get_typeId(_env).Id){
                {
                    ...
                    if !Lns_IsNil( _runtime ) {
                        ...
                        if _switch26615 := funcType.FP.Get_srcTypeInfo(_env); _switch26615 == Ast_builtinTypeForm {
                            convGo_filter_1137_(_env, node.FP.Get_func(_env), self, &node.Nodes_Node)
    ...
    prefixNode := _exp26967.Val1
        convGo_filter_1137_(_env, prefixNode, self, node.FP.Get_func(_env))
    ...
    case *convGo_CallKind__FormCall:
        self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, 1, addEnvArg))
        self.FP.Write(_env, "Lns_2DDD(")
        addEnvArg = false
    ...
    typeInfo := _exp26967.Val1
        self.FP.Write(_env, _env.LuaVM.String_format("%s, ", []LnsAny{convGo_getLnsItemKind_1643_(_env, typeInfo)}))
        {
            _argList := node.FP.Get_argList(_env)
            if !Lns_IsNil( _argList ) {
                argList := _argList.(*Nodes_ExpListNode)
    ...
    if Lns_op_not(skipArg){
        {
            ...
            if !Lns_IsNil( _argList ) {
                ...
                self.FP.Write(_env, convGo_getAddEnvArg_1132_(_env, 0, addEnvArg))
            }
        }
    }
    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
    ...
    if closeTxt != nil{
        ...
        self.FP.Write(_env, closeTxt_2482)
    }
    self.FP.Write(_env, ")")
    if _env.PopVal( _env.IncStack() ||
    ...
    if retGenerics{
        if funcType.FP.Get_retTypeInfoList(_env).Len() == 1{
            ...
            if convGo_isAnyType_1139_(_env, retType){
                if Lns_op_not(convGo_isAnyType_1139_(_env, node.FP.Get_expType(_env))){
                    self.FP.outputAny2Type(_env, node.FP.Get_expType(_env))
                }
...
func (self *convGo_convFilter) ProcessExpMRet(_env *LnsEnv, node *Nodes_ExpMRetNode,_opt LnsAny) {
    convGo_filter_1137_(_env, node.FP.Get_mRet(_env), self, &node.Nodes_Node)
}
            ...
            if !Lns_IsNil( _mRetExp ) {
                ...
                if mRetExp.FP.Get_index(_env) == index{
                    if _env.PopVal( _env.IncStack() ||
                        ...
                        convGo_filter_1137_(_env, exp, self, &node.Nodes_Node)
                    } else { 
                        self.FP.Write(_env, "Lns_2DDD(")
                        convGo_filter_1137_(_env, exp, self, &node.Nodes_Node)
                        self.FP.Write(_env, ")")
...
func (self *convGo_convFilter) ProcessExpOp1(_env *LnsEnv, node *Nodes_ExpOp1Node,_opt LnsAny) {
    ...
    if _switch27803 := node.FP.Get_op(_env).Txt; _switch27803 == "~" {
        self.FP.Write(_env, "^")
        convGo_filter_1137_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
        ...
        if _switch27782 := node.FP.Get_exp(_env).FP.Get_expType(_env).FP.Get_kind(_env); _switch27782 == Ast_TypeInfoKind__List {
            convGo_filter_1137_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
            self.FP.Write(_env, ".Len()")
        } else if _switch27782 == Ast_TypeInfoKind__Ext {
            if _switch27749 := node.FP.Get_exp(_env).FP.Get_expType(_env).FP.Get_extedType(_env).FP.Get_kind(_env); _switch27749 == Ast_TypeInfoKind__List {
                convGo_filter_1137_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
                self.FP.Write(_env, ".Len()")
            } else {
...
func (self *convGo_convFilter) ProcessExpCast(_env *LnsEnv, node *Nodes_ExpCastNode,_opt LnsAny) {
    if _switch28210 := node.FP.Get_castKind(_env); _switch28210 == Nodes_CastKind__Force {
        if convGo_isAnyType_1139_(_env, node.FP.Get_exp(_env).FP.Get_expType(_env)){
            if _switch27976 := node.FP.Get_castType(_env); _switch27976 == Ast_builtinTypeInt {
...
func (self *convGo_convFilter) ProcessExpSetVal(_env *LnsEnv, node *Nodes_ExpSetValNode,_opt LnsAny) {
    convGo_filter_1137_(_env, node.FP.Get_exp1(_env), self, &node.Nodes_Node)
    if convGo_getExpListKind_1255_(_env, node.FP.Get_exp1(_env).FP.Get_expTypeList(_env), node.FP.Get_exp2(_env), self.option.FP.Get_addEnvArg(_env)) == convGo_ExpListKind__Direct{
        {
            var _from28371 LnsInt = node.FP.Get_exp1(_env).FP.Get_expTypeList(_env).Len() + 1
            var _to28371 LnsInt = node.FP.Get_exp2(_env).FP.Get_expTypeList(_env).Len()
...
func (self *convGo_convFilter) ProcessExpSetItem(_env *LnsEnv, node *Nodes_ExpSetItemNode,_opt LnsAny) {
    ...
    switch _exp28483 := node.FP.Get_index(_env).(type) {
    case *Nodes_IndexVal__NodeIdx:
    index := _exp28483.Val1
        convGo_filter_1137_(_env, index, self, &node.Nodes_Node)
    case *Nodes_IndexVal__SymIdx:
    index := _exp28483.Val1
        self.FP.Write(_env, _env.LuaVM.String_format("\"%s\"", []LnsAny{index}))
    }
    self.FP.Write(_env, ",")
    convGo_filter_1137_(_env, node.FP.Get_exp2(_env), self, &node.Nodes_Node)
    self.FP.Write(_env, ")")
}
...
func (self *convGo_convFilter) processAndOr(_env *LnsEnv, node *Nodes_ExpOp2Node,opTxt string,parent *Nodes_Node) {
    ...
    var firstFlag bool
    firstFlag = Lns_op_not(convFilter_processAndOr__isAndOr_1785_(_env, parent))
    if firstFlag{
    ...
    if convFilter_processAndOr__isAndOr_1785_(_env, node.FP.Get_exp1(_env)){
        convGo_filter_1137_(_env, node.FP.Get_exp1(_env), self, &node.Nodes_Node)
    } else { 
    ...
    if convFilter_processAndOr__isAndOr_1785_(_env, node.FP.Get_exp2(_env)){
        convGo_filter_1137_(_env, node.FP.Get_exp2(_env), self, &node.Nodes_Node)
    } else { 
        self.FP.Write(_env, _env.LuaVM.String_format("%s.SetStackVal( ", []LnsAny{getEnvTxt}))
        convGo_filter_1137_(_env, node.FP.Get_exp2(_env), self, &node.Nodes_Node)
...
func (self *convGo_convFilter) ProcessExpRef(_env *LnsEnv, node *Nodes_ExpRefNode,_opt LnsAny) {
    ...
    if node.FP.Get_expType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__DDD{
        ...
        if Lns_isCondTrue( node.FP.Get_symbolInfo(_env).FP.Get_convModuleParam(_env)){
            ...
            if _switch29249 := node.FP.Get_symbolInfo(_env).FP.Get_kind(_env); _switch29249 == Ast_SymbolKind__Var || _switch29249 == Ast_SymbolKind__Arg {
                ...
                if Ast_isBuiltin(_env, node.FP.Get_expType(_env).FP.Get_typeId(_env).Id){
                    ...
                    if _switch29171 := node.FP.Get_expType(_env); _switch29171 == builtinFunc.Lns_print {
...
func (self *convGo_convFilter) ProcessExpRefItem(_env *LnsEnv, node *Nodes_ExpRefItemNode,_opt LnsAny) {
    ...
    if _switch30046 := prefixType.FP.Get_kind(_env); _switch30046 == Ast_TypeInfoKind__Ext {
        ...
        self.FP.Write(_env, ".GetAt(")
        {
            ...
            if !Lns_IsNil( _index ) {
                ...
                self.FP.Write(_env, _env.LuaVM.String_format("\"%s\"", []LnsAny{convGo_str2gostr_1204_(_env, Lns_unwrap( node.FP.Get_symbol(_env)).(string))}))
            }
        }
        self.FP.Write(_env, ")")
        self.FP.outputStem2Type(_env, node.FP.Get_expType(_env))
        ...
        if node.FP.Get_nilAccess(_env){
            ...
            self.FP.Write(_env, ".GetAt(")
            convGo_filter_1137_(_env, Lns_unwrap( node.FP.Get_index(_env)).(*Nodes_Node), self, &node.Nodes_Node)
            self.FP.Write(_env, ")")
            self.FP.outputStem2Type(_env, node.FP.Get_expType(_env))
            self.FP.Write(_env, "))")
        } else { 
...
func (self *convGo_convFilter) ProcessRefField(_env *LnsEnv, node *Nodes_RefFieldNode,_opt LnsAny) {
    ...
    if Lns_op_not(node.FP.HasNilAccess(_env)){
        ...
        if Lns_op_not(node.FP.Get_prefix(_env).FP.HasNilAccess(_env)){
            convGo_filter_1137_(_env, node.FP.Get_prefix(_env), self, &node.Nodes_Node)
        } else { 
        ...
        if !Lns_IsNil( _symbol ) {
            ...
            if node.FP.Get_prefix(_env).FP.Get_expType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext{
                ...
                if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                    ...
                    _env.SetStackVal( convGo_isAnyType_1139_(_env, orgSym.FP.Get_typeInfo(_env))) ).(bool)){
                    self.FP.outputAny2Type(_env, node.FP.Get_expType(_env))
                }
            }
        } else {
    ...
    opt := _opt.(*ConvGo_Opt)
    {
        ...
        if !Lns_IsNil( _symbolInfo ) {
            ...
            if symbolInfo.FP.Get_staticFlag(_env){
                ...
                self.FP.Write(_env, _env.LuaVM.String_format("(%s)", []LnsAny{convGo_getAddEnvArg_1132_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
            } else { 
                var closeParen bool
                closeParen = convGo_convExp30767(Lns_2DDD(self.FP.OutputCallPrefix(_env, node.FP.IsThreading(_env), node.FP.Get_id(_env), &node.Nodes_Node, node.FP.Get_prefix(_env), symbolInfo)))
                self.FP.Write(_env, _env.LuaVM.String_format("(%s)", []LnsAny{convGo_getAddEnvArg_1132_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
                var retType *Ast_TypeInfo
...
func (self *convGo_convFilter) ProcessReturn(_env *LnsEnv, node *Nodes_ReturnNode,_opt LnsAny) {
    self.FP.Write(_env, "return ")
    {
        ...
        if !Lns_IsNil( _expList ) {
            expList := _expList.(*Nodes_ExpListNode)
            convGo_filter_1137_(_env, &expList.Nodes_Node, self, &node.Nodes_Node)
        }
    }
    self.FP.Writeln(_env, "")
}
...
func (self *convGo_convFilter) ProcessTestBlock(_env *LnsEnv, node *Nodes_TestBlockNode,_opt LnsAny) {
    ...
    for _, _statement := range( stmtList.Items ) {
        ...
        if Lns_op_not(convGo_ignoreNodeInInnerBlockSet.Has(statement.FP.Get_kind(_env))){
            convGo_filter_1137_(_env, statement, self, &node.Nodes_Node)
        }
    }
}
...
func (self *convGo_convFilter) ProcessLiteralMap(_env *LnsEnv, node *Nodes_LiteralMapNode,_opt LnsAny) {
    ...
    for _, _pair := range( node.FP.Get_pairList(_env).Items ) {
        ...
        if _env.PopVal( _env.IncStack() ||
            ...
            convGo_filter_1137_(_env, pair.FP.Get_key(_env), self, &node.Nodes_Node)
            self.FP.Write(_env, ":")
            convGo_filter_1137_(_env, pair.FP.Get_val(_env), self, &node.Nodes_Node)
            self.FP.Write(_env, ",")
        }
    }
    self.FP.Write(_env, "})")
...
func (self *convGo_convFilter) ProcessLiteralString(_env *LnsEnv, node *Nodes_LiteralStringNode,_opt LnsAny) {
    ...
    txt = node.FP.Get_token(_env).Txt
    {
        ...
        if !Lns_IsNil( _expList ) {
            expList := _expList.(*Nodes_ExpListNode)
            self.FP.Write(_env, _env.LuaVM.String_format("%s.String_format(%s, ", []LnsAny{self.env.FP.getLuavm(_env, node.FP.IsThreading(_env)), convGo_str2gostr_1204_(_env, txt)}))
            ...
            self.FP.Write(_env, _env.LuaVM.String_format("%s", []LnsAny{convGo_str2gostr_1204_(_env, txt)}))
        }
    }
}
