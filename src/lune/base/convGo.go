...
// for 5520
func convGo_convExp0_6351(arg1 []LnsAny) (bool, LnsAny) {
...
// for 1960
func convGo_convExp2_2262(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1962
func convGo_convExp2_2301(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1965
func convGo_convExp2_2339(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1983
func convGo_convExp2_2441(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1986
func convGo_convExp2_2482(arg1 []LnsAny) (string, LnsInt) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(LnsInt)
}
// for 1990
func convGo_convExp2_2520(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 2447
func convGo_convExp2_6781(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6317
func convGo_convExp0_11009(arg1 []LnsAny) bool {
...
// 4257: decl @lune.@base.@convGo.getLnsItemKind
...
// 5939: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
...
// 6617: decl @lune.@base.@convGo.createFilter
...
func (self *convGo_convFilter) OutputDeclFunc(_env *LnsEnv, addEnvArg bool,funcInfo LnsAny) *convGo_FuncConv {
    ...
    if convGo_isClosure_9_(_env, typeInfo){
        ...
        if typeInfo.FP.Get_extedType(_env).FP.Get_kind(_env) != Ast_TypeInfoKind__FormFunc{
            if name != nil{
                name_52 := name.(string)
                self.FP.outputSymbol(_env, &convGo_SymbolKind__Func{typeInfo}, name_52)
            }
        }
    }
    self.FP.WriteRaw(_env, "(")
...
func (self *convGo_convFilter) outputModuleImport(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    var mod string
    mod = convGo_convExp2_2262(Lns_2DDD(_env.GetVM().String_gsub(normalType.FP.Get_requirePath(_env),"%.[^%.]+$", "")))
    if Lns_isCondTrue( Lns_car(_env.GetVM().String_find(mod,"^go/", nil, nil))){
        var workMod string
        workMod = convGo_convExp2_2301(Lns_2DDD(_env.GetVM().String_gsub(Lns_car(_env.GetVM().String_gsub(Lns_car(_env.GetVM().String_gsub(mod,"^go/", "")).(string),"%.", "/")).(string),":", ".")))
        self.FP.Writeln(_env, _env.GetVM().String_format("\"%s\"", []LnsAny{workMod}))
    } else { 
        var path string
        path = convGo_convExp2_2339(Lns_2DDD(_env.GetVM().String_gsub(Lns_car(_env.GetVM().String_gsub(normalType.FP.Get_requirePath(_env),"%.", "/")).(string),":", ".")))
...
func (self *convGo_convFilter) outputImport(_env *LnsEnv, node *Nodes_ImportNode) {
    ...
    if Lns_isCondTrue( Lns_car(_env.GetVM().String_find(info.FP.Get_modulePath(_env),"^go/", nil, nil))){
        var workMod string
        workMod = convGo_convExp2_2441(Lns_2DDD(_env.GetVM().String_gsub(Lns_car(_env.GetVM().String_gsub(Lns_car(_env.GetVM().String_gsub(info.FP.Get_modulePath(_env),"^go/", "")).(string),"%.", "/")).(string),":", ".")))
        ...
        if count == 0{
            ...
            var modDir string
            modDir = convGo_convExp2_2520(Lns_2DDD(_env.GetVM().String_gsub(modulePath,"/", "")))
...
func (self *convGo_convFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    var modulePath string
    modulePath = convGo_convExp2_6781(Lns_2DDD(_env.GetVM().String_gsub(node.FP.Get_moduleTypeInfo(_env).FP.GetFullName(_env, self.FP.Get_typeNameCtrl(_env), self.FP.Get_moduleInfoManager(_env), nil),"@", "")))
...
// 2667: decl @lune.@base.@convGo.convFilter.expList2SliceRaw
...
// 2721: decl @lune.@base.@convGo.convFilter.processSetFromExpList
...
// 2830: decl @lune.@base.@convGo.convFilter.processCondRet
...
// 2836: decl @lune.@base.@convGo.convFilter.outputCondRetNode
...
// 2884: decl @lune.@base.@convGo.convFilter.processCondRetList
func (self *convGo_convFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convGo_filter_7_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 2890: decl @lune.@base.@convGo.convFilter.outputCondRetInfo
...
// 2896: decl @lune.@base.@convGo.convFilter.processStmtExp
...
// 2907: decl @lune.@base.@convGo.convFilter.processDeclAlge
...
// 2929: decl @lune.@base.@convGo.convFilter.processNewAlgeVal
...
// 2948: decl @lune.@base.@convGo.convFilter.processDeclMember
...
// 2957: decl @lune.@base.@convGo.convFilter.processExpMacroExp
...
// 2967: decl @lune.@base.@convGo.convFilter.processDeclMacro
func (self *convGo_convFilter) ProcessDeclMacro(_env *LnsEnv, node *Nodes_DeclMacroNode,_opt LnsAny) {
}
// 2973: decl @lune.@base.@convGo.convFilter.processExpMacroStat
...
// 2979: decl @lune.@base.@convGo.convFilter.outputDeclFuncArg
...
// 2990: decl @lune.@base.@convGo.convFilter.isImplementedRunner
...
// 3002: decl @lune.@base.@convGo.convFilter.output_to_decl__func__sym
func (self *convGo_convFilter) output_to_decl__func__sym(_env *LnsEnv, declInfo *Nodes_DeclFuncInfo,funcType *Ast_TypeInfo) {
    if declInfo.FP.Get_has__func__Symbol(_env){
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, "__func__")})/* 3013:29 */)).(*Ast_SymbolInfo)
        self.FP.Writeln(_env, _env.GetVM().String_format("%s := \"%s.%s\"", []LnsAny{self.FP.getSymbolSym(_env, funcSym_), nameSpace, funcName}))
    }
}
// 3018: decl @lune.@base.@convGo.convFilter.processDeclConstr
...
// 3053: decl @lune.@base.@convGo.convFilter.processDeclDestr
...
// 3059: decl @lune.@base.@convGo.convFilter.processExpCallSuperCtor
...
// 3073: decl @lune.@base.@convGo.convFilter.processExpCallSuper
...
// 3088: decl @lune.@base.@convGo.convFilter.outputDummyReturn
...
// 3122: decl @lune.@base.@convGo.convFilter.outputDeclFuncInfo
...
// 3201: decl @lune.@base.@convGo.convFilter.processDeclMethod
...
// 3207: decl @lune.@base.@convGo.convFilter.processProtoMethod
func (self *convGo_convFilter) ProcessProtoMethod(_env *LnsEnv, node *Nodes_ProtoMethodNode,_opt LnsAny) {
}
// 3213: decl @lune.@base.@convGo.convFilter.getEnumGetTxtSym
...
// 3217: decl @lune.@base.@convGo.convFilter.processDeclEnum
...
// 3299: decl @lune.@base.@convGo.convFilter.processUnwrapSet
...
// 3305: decl @lune.@base.@convGo.convFilter.processIfUnwrap
...
// 3409: decl @lune.@base.@convGo.convFilter.outputLetVar
...
// 3548: decl @lune.@base.@convGo.convFilter.processDeclVar
...
// 3629: decl @lune.@base.@convGo.convFilter.processWhen
...
// 3666: decl @lune.@base.@convGo.convFilter.processDeclArg
...
// 3673: decl @lune.@base.@convGo.convFilter.processDeclArgDDD
...
// 3679: decl @lune.@base.@convGo.convFilter.processExpSubDDD
...
// 3686: decl @lune.@base.@convGo.convFilter.processDeclForm
...
// 3695: decl @lune.@base.@convGo.convFilter.processDeclFunc
...
// 3728: decl @lune.@base.@convGo.convFilter.processRefType
...
// 3750: decl @lune.@base.@convGo.convFilter.processCond
...
// 3761: decl @lune.@base.@convGo.convFilter.processIf
...
// 3790: decl @lune.@base.@convGo.convFilter.processSwitch
...
// 3825: decl @lune.@base.@convGo.convFilter.processMatch
...
// 3876: decl @lune.@base.@convGo.convFilter.processWhile
...
// 3890: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 3908: decl @lune.@base.@convGo.convFilter.processFor
...
// 3974: decl @lune.@base.@convGo.convFilter.processApply
...
// 4050: decl @lune.@base.@convGo.convFilter.outputForeachLua
...
// 4143: decl @lune.@base.@convGo.convFilter.processForeach
...
// 4265: decl @lune.@base.@convGo.convFilter.processForsort
func (self *convGo_convFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    if keySym != nil{
        keySym_196 := keySym.(*Ast_SymbolInfo)
        key = _env.GetVM().String_format("%s", []LnsAny{self.FP.getSymbolSym(_env, keySym_196)})
    }
    ...
    self.FP.PushIndent(_env, nil)
    if valSym != nil{
        valSym_198 := valSym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( valSym_198.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := %s.Items[ _%s ]", []LnsAny{self.FP.getSymbolSym(_env, valSym_198), collSym, key}))
            if node.FP.Get_exp(_env).FP.Get_expType(_env).FP.Get_srcTypeInfo(_env).FP.Get_canDealGenInherit(_env){
                self.FP.outputStem2Type(_env, valSym_198.FP.Get_typeInfo(_env))
            }
            self.FP.Writeln(_env, "")
        }
    }
    if keySym != nil{
        keySym_202 := keySym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( keySym_202.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := _%s", []LnsAny{key, key}))
            if node.FP.Get_exp(_env).FP.Get_expType(_env).FP.Get_srcTypeInfo(_env).FP.Get_canDealGenInherit(_env){
                self.FP.outputStem2Type(_env, keySym_202.FP.Get_typeInfo(_env))
            }
            self.FP.Writeln(_env, "")
        }
    }
...
// 4354: decl @lune.@base.@convGo.convFilter.processExpUnwrap
...
// 4370: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 4382: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 4410: decl @lune.@base.@convGo.convFilter.outputIFMethods
...
// 4452: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 4462: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 4485: decl @lune.@base.@convGo.convFilter.outputClassType
...
// 4523: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 4541: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 4567: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 4582: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 4607: decl @lune.@base.@convGo.convFilter.outputConstructor
...
// 4703: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 4717:33 */)).(*Ast_SymbolInfo)
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 4758:33 */)).(*Ast_SymbolInfo)
...
// 4767: decl @lune.@base.@convGo.convFilter.outputStaticMember
...
// 4799: decl @lune.@base.@convGo.convFilter.getFromStemName
...
// 4841: decl @lune.@base.@convGo.convFilter.outputConvItemType
func (self *convGo_convFilter) outputConvItemType(_env *LnsEnv, typeInfo *Ast_TypeInfo,alt2type LnsAny) {
    ...
    if typeInfo.FP.Get_srcTypeInfo(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Alternate{
        if alt2type != nil{
            alt2type_1134 := alt2type.(*LnsMap)
            {
                _alt := alt2type_1134.Get(workTypeInfo)
                if !Lns_IsNil( _alt ) {
...
// 4866: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 4886: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 4905: decl @lune.@base.@convGo.convFilter.outputAsyncItem
func (self *convGo_convFilter) outputAsyncItem(_env *LnsEnv, node *Nodes_DeclClassNode) {
}
// 4916: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 5044: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 5056: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
...
// 5089: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 5138: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(_env *LnsEnv, node *Nodes_ProtoClassNode,_opt LnsAny) {
}
// 5143: decl @lune.@base.@convGo.convFilter.processDeclClass
...
// 5241: decl @lune.@base.@convGo.convFilter.outputCallPrefix
func (self *convGo_convFilter) OutputCallPrefix(_env *LnsEnv, callId string,node *Nodes_Node,prefixNode LnsAny,funcSymbol *Ast_SymbolInfo)(bool, LnsAny) {
    ...
    if prefixNode != nil{
        prefixNode_1239 := prefixNode.(*Nodes_Node)
        extCallFlag = prefixNode_1239.FP.Get_expType(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext
    } else {
        extCallFlag = false
    }
    if extCallFlag{
    ...
    closeParen = false
    if prefixNode != nil{
        prefixNode_1264 := prefixNode.(*Nodes_Node)
        ...
        var prefixType *Ast_TypeInfo
        prefixType = prefixNode_1264.FP.Get_expType(_env).FP.Get_nonnilableType(_env)
        if prefixType == Ast_builtinTypeString{
            ...
            }
            {
                ...
                if !Lns_IsNil( _runtime ) {
                    ...
                    callKind = &convGo_CallKind__RuntimeCall{prefixNode_1264}
            ...
            if _env.PopVal( _env.IncStack() ||
                ...
                if node.FP.HasNilAccess(_env){
                    if Lns_op_not(prefixNode_1264.FP.HasNilAccess(_env)){
                        ...
                        convGo_filter_7_(_env, prefixNode_1264, self, node)
                        self.FP.Writeln(_env, ") && ")
                    } else { 
                        convGo_filter_7_(_env, prefixNode_1264, self, node)
                        self.FP.Writeln(_env, "&&")
            ...
            convGo_processNilAcc(_env, prefixNode_1264)
...
// 5435: decl @lune.@base.@convGo.convFilter.processExpCall
func (self *convGo_convFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if closeTxt != nil{
        closeTxt_1372 := closeTxt.(string)
        self.FP.WriteRaw(_env, closeTxt_1372)
    }
    self.FP.WriteRaw(_env, ")")
    if _env.PopVal( _env.IncStack() ||
...
// 5717: decl @lune.@base.@convGo.convFilter.processExpMRet
...
// 5724: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(_env *LnsEnv, node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}
// 5732: decl @lune.@base.@convGo.convFilter.processExpList
...
// 5756: decl @lune.@base.@convGo.convFilter.processExpOp1
...
// 5804: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 5816: decl @lune.@base.@convGo.convFilter.processExpCast
...
// 5876: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 5893: decl @lune.@base.@convGo.convFilter.processExpSetVal
...
// 5914: decl @lune.@base.@convGo.convFilter.processExpSetItem
...
// 5936: decl @lune.@base.@convGo.convFilter.processAndOr
...
// 5997: decl @lune.@base.@convGo.convFilter.processExpOp2
...
// 6042: decl @lune.@base.@convGo.convFilter.processExpRef
...
// 6102: decl @lune.@base.@convGo.convFilter.processExpRefItem
...
// 6201: decl @lune.@base.@convGo.convFilter.processRefField
...
// 6289: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 6295: decl @lune.@base.@convGo.convFilter.processGetField
    ...
    opt := _opt.(*ConvGo_Opt)
    {
        ...
        if !Lns_IsNil( _symbolInfo ) {
            ...
            if symbolInfo.FP.Get_staticFlag(_env){
                ...
                var closeParen bool
                closeParen = convGo_convExp0_11009(Lns_2DDD(self.FP.OutputCallPrefix(_env, node.FP.GetIdTxt(_env), &node.Nodes_Node, node.FP.Get_prefix(_env), symbolInfo)))
                self.FP.WriteRaw(_env, _env.GetVM().String_format("(%s)", []LnsAny{convGo_getAddEnvArg_6_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
                var retType *Ast_TypeInfo
...
// 6344: decl @lune.@base.@convGo.convFilter.processReturn
...
// 6354: decl @lune.@base.@convGo.convFilter.processTestCase
...
// 6369: decl @lune.@base.@convGo.convFilter.processTestBlock
...
// 6381: decl @lune.@base.@convGo.convFilter.processProvide
...
// 6387: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(_env *LnsEnv, node *Nodes_AliasNode,_opt LnsAny) {
}
// 6392: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 6398: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 6404: decl @lune.@base.@convGo.convFilter.processTupleConst
...
// 6416: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 6441: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 6467: decl @lune.@base.@convGo.convFilter.processLiteralMap
...
// 6502: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 6516: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
// 6522: decl @lune.@base.@convGo.convFilter.processLiteralInt
...
// 6528: decl @lune.@base.@convGo.convFilter.processLiteralReal
func (self *convGo_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 6534: decl @lune.@base.@convGo.convFilter.processLiteralString
...
// 6575: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 6611: decl @lune.@base.@convGo.convFilter.processAbbr
