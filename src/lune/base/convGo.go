...
func convGo_ExpListKind_get__allList_1261_() *LnsList{
...
func convGo_ExpListKind__from_1254_(arg1 LnsInt) LnsAny{
...
type convFilter_processRoot__ProcNode_1394_ func (arg1 *Nodes_Node)
// for 112
func convGo_convExp354(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 470
func convGo_convExp2116(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 474
func convGo_convExp2161(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 302
func convGo_convExp1151(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1414
func convGo_convExp6798(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1436
func convGo_convExp6924(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1679
func convGo_convExp9534(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 4914
func convGo_convExp27847(arg1 []LnsAny) bool {
...
// 177: decl @lune.@base.@convGo.filter
func convGo_filter_1141_(node *Nodes_Node,filter *convGo_convFilter,parent *Nodes_Node) {
    node.FP.ProcessFilter(&filter.Nodes_Filter, ConvGo_Opt2Stem(NewConvGo_Opt(parent)))
}

// 183: decl @lune.@base.@convGo.isAnyType
func convGo_isAnyType_1144_(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch761 := typeInfo.FP.Get_kind(); _switch761 == Ast_TypeInfoKind__Stem || _switch761 == Ast_TypeInfoKind__Alge {
        return true
    } else if _switch761 == Ast_TypeInfoKind__Alternate {
        if typeInfo.FP.HasBase(){
            return convGo_isAnyType_1144_(typeInfo.FP.Get_baseTypeInfo())
        }
        return true
    } else if _switch761 == Ast_TypeInfoKind__Ext {
...
// 207: decl @lune.@base.@convGo.isClosure
func convGo_isClosure_1147_(typeInfo *Ast_TypeInfo) bool {
    var scope *Ast_Scope
...
// 242: decl @lune.@base.@convGo.concatGLSym
func convGo_concatGLSym_1159_(name string,external bool) string {
    if external{
...
// 253: decl @lune.@base.@convGo.isInnerDeclType
func convGo_isInnerDeclType_1162_(typeInfo *Ast_TypeInfo) bool {
...
// 273: decl @lune.@base.@convGo.getModuleName
func convGo_getModuleName_1168_(typeInfo *Ast_TypeInfo) string {
    return Lns_car(Lns_getVM().String_gsub(typeInfo.FP.GetModule().FP.Get_rawTxt(),"@", "")).(string)
}

// 467: decl @lune.@base.@convGo.str2gostr
func convGo_str2gostr_1204_(txt string) string {
    var work string
    work = txt
    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(work, "^```", nil, nil))){
        work = convGo_convExp2116(Lns_2DDD(Lns_getVM().String_gsub(Lns_getVM().String_sub(work,4, -4),"^\n", "")))
        
        work = Parser_quoteStr(work)
        
    } else if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(work, "^'", nil, nil))){
        work = convGo_convExp2161(Lns_2DDD(Lns_getVM().String_gsub(Parser_convFromRawToStr(work),"\"", "\\\"")))
...
// 482: decl @lune.@base.@convGo.getOrgTypeInfo
func convGo_getOrgTypeInfo_1207_(typeInfo *Ast_TypeInfo) *Ast_TypeInfo {
    {
...
// 602: decl @lune.@base.@convGo.needConvFormFunc
func convGo_needConvFormFunc_1240_(node *Nodes_ExpCastNode) bool {
...
// 633: decl @lune.@base.@convGo.needConvCast
func convGo_needConvCast_1243_(dstType *Ast_TypeInfo,srcType *Ast_TypeInfo) bool {
    if _switch3019 := dstType.FP.Get_kind(); _switch3019 == Ast_TypeInfoKind__Nilable {
        return convGo_needConvCast_1243_(dstType.FP.Get_nonnilableType(), srcType)
    } else if _switch3019 == Ast_TypeInfoKind__Class {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    } else if _switch3019 == Ast_TypeInfoKind__IF {
        return false
    } else if _switch3019 == Ast_TypeInfoKind__FormFunc {
        return true
    } else if _switch3019 == Ast_TypeInfoKind__Alternate {
        if Lns_op_not(dstType.FP.HasBase()){
            return false
        } else { 
            return convGo_needConvCast_1243_(dstType.FP.Get_baseTypeInfo(), srcType)
        }
    } else if _switch3019 == Ast_TypeInfoKind__Form {
        return true
    } else if _switch3019 == Ast_TypeInfoKind__Prim {
        if Lns_op_not(dstType.FP.Get_nilable()){
            if _switch2983 := dstType; _switch2983 == Ast_builtinTypeInt {
                return true
            } else if _switch2983 == Ast_builtinTypeReal {
                return true
            } else {
                return false
            }
...
// 807: decl @lune.@base.@convGo.getExpListKind
func convGo_getExpListKind_1268_(dstTypeList *LnsList,node *Nodes_ExpListNode) LnsInt {
        ...
        for _, _exp := range( node.FP.Get_expList().Items ) {
            exp := _exp.(Nodes_NodeDownCast).ToNodes_Node()
            {
                ...
                if _castNode != nil {
                    ...
                    if convGo_needConvCast_1243_(castNode.FP.Get_castType(), castNode.FP.Get_exp().FP.Get_expType()){
                        return convGo_ExpListKind__Conv
                    }
                }
            }
...
// 1075: decl @lune.@base.@convGo.isRetGenerics
func convGo_isRetGenerics_1305_(node *Nodes_ExpCallNode) bool {
    var funcType *Ast_TypeInfo
    ...
    for _index, _retType := range( funcType.FP.Get_retTypeInfoList().Items ) {
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            Lns_GetEnv().SetStackVal( Lns_op_not(convGo_isAnyType_1144_(node.FP.Get_expTypeList().GetAt(index).(Ast_TypeInfoDownCast).ToAst_TypeInfo()))) ).(bool)){
            return true
        }
    }
    return false
...
// 3103: decl @lune.@base.@convGo.getLnsItemKind
func convGo_getLnsItemKind_1760_(typeInfo *Ast_TypeInfo) string {
    {
...
// 4550: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
func convFilter_processAndOr__isAndOr_1944_(exp *Nodes_Node) bool {
    {
        _parentNode := Nodes_ExpOp2NodeDownCastF(exp.FP)
        if _parentNode != nil {
            parentNode := _parentNode.(*Nodes_ExpOp2Node)
            if _switch25699 := parentNode.FP.Get_op().Txt; _switch25699 == "and" || _switch25699 == "or" {
                return true
            }
        }
    }
...
// 5169: decl @lune.@base.@convGo.Ast2Code
func convGo_Ast2Code_2043_(streamName string,ast *TransUnit_ASTInfo) string {
...
func (self *convGo_convFilter) InitconvGo_convFilter(enableTest bool,streamName string,stream Lns_oStream,ast *TransUnit_ASTInfo,option *ConvGo_Option) {
    ...
    self.modDir = convGo_convExp354(Lns_2DDD(Lns_getVM().String_gsub(Lns_car(Lns_getVM().String_gsub(modDir,"@", "")).(string),"%.$", "")))
...
// 119: decl @lune.@base.@convGo.convFilter.getVM
...
// 126: decl @lune.@base.@convGo.convFilter.pushProcessMode
...
// 130: decl @lune.@base.@convGo.convFilter.popProcessMode
...
// 135: decl @lune.@base.@convGo.convFilter.isPubType
func (self *convGo_convFilter) IsPubType(typeInfo *Ast_TypeInfo) bool {
    if Ast_isPubToExternal(typeInfo.FP.Get_accessMode()){
        if typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Func{
            if _switch523 := typeInfo.FP.Get_parentInfo().FP.Get_kind(); _switch523 == Ast_TypeInfoKind__Class || _switch523 == Ast_TypeInfoKind__Enum {
...
// 148: decl @lune.@base.@convGo.convFilter.isPubSym
...
// 155: decl @lune.@base.@convGo.convFilter.isExtType
func (self *convGo_convFilter) IsExtType(typeInfo *Ast_TypeInfo) bool {
    return typeInfo.FP.GetModule() != self.moduleTypeInfo
}

// 158: decl @lune.@base.@convGo.convFilter.isExtSymbol
func (self *convGo_convFilter) IsExtSymbol(symbol *Ast_SymbolInfo) bool {
    return symbol.FP.GetModule() != self.moduleTypeInfo
}

// 266: decl @lune.@base.@convGo.convFilter.getCanonicalName
...
// 277: decl @lune.@base.@convGo.convFilter.concatSymWithType
func (self *convGo_convFilter) concatSymWithType(name string,typeInfo *Ast_TypeInfo) string {
    var modName string
    modName = convGo_getModuleName_1168_(typeInfo.FP.GetModule())
    var typeName string
    if modName == ""{
        typeName = name
    ...
    return convGo_concatGLSym_1159_(typeName, self.FP.IsPubType(typeInfo))
}

// 288: decl @lune.@base.@convGo.convFilter.getSymbol
func (self *convGo_convFilter) getSymbol(kind LnsAny,name string) string {
    ...
    switch _exp1652 := kind.(type) {
    case *convGo_SymbolKind__Arg:
        return symbolName
    case *convGo_SymbolKind__Var:
    symbolInfo := _exp1652.Val1
        var modName string
        modName = convGo_convExp1151(Lns_2DDD(Lns_getVM().String_gsub(self.moduleTypeInfo.FP.Get_rawTxt(),"@", "")))
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            symbolName = Lns_getVM().String_format("%s_%s", []LnsAny{convGo_getModuleName_1168_(symbolInfo.FP.GetModule()), symbolInfo.FP.Get_name()})
            ...
            symbolName = convGo_concatGLSym_1159_(Lns_getVM().String_format("%s_", []LnsAny{modName}) + symbolName, Ast_isPubToExternal(symbolInfo.FP.Get_accessMode()))
    ...
    external := _exp1652.Val1
        symbolName = convGo_concatGLSym_1159_(symbolName, external)
        
    case *convGo_SymbolKind__Func:
    typeInfo := _exp1652.Val1
        if typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Method{
            if _switch1314 := symbolName; _switch1314 == "_toMap" {
                return "ToMap"
            } else {
                symbolName = convGo_concatGLSym_1159_(symbolName, Ast_isPubToExternal(typeInfo.FP.Get_accessMode()))
                
            }
        } else { 
            if _switch1534 := typeInfo.FP.Get_parentInfo().FP.Get_kind(); _switch1534 == Ast_TypeInfoKind__Module || _switch1534 == Ast_TypeInfoKind__Func || _switch1534 == Ast_TypeInfoKind__Method {
                if convGo_isInnerDeclType_1162_(typeInfo){
                    if Lns_op_not(convGo_isClosure_1147_(typeInfo)){
            ...
            } else if _switch1534 == Ast_TypeInfoKind__Enum || _switch1534 == Ast_TypeInfoKind__Class {
    ...
    typeInfo := _exp1652.Val1
        ...
        var workName string
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            Lns_GetEnv().SetStackVal( convGo_isInnerDeclType_1162_(typeInfo)) &&
...
// 394: decl @lune.@base.@convGo.convFilter.getTypeSymbol
...
// 399: decl @lune.@base.@convGo.convFilter.getConstrSymbol
...
// 403: decl @lune.@base.@convGo.convFilter.getFuncSymbol
...
// 412: decl @lune.@base.@convGo.convFilter.getAlgeSymbol
...
func (self *convGo_convFilter) getSymbolSym(symbolInfo *Ast_SymbolInfo) string {
    ...
    } else if _switch1971 == Ast_SymbolKind__Typ {
...
// 447: decl @lune.@base.@convGo.convFilter.getAccessorSym
...
// 459: decl @lune.@base.@convGo.convFilter.getConvGenericsName
...
// 489: decl @lune.@base.@convGo.convFilter.type2gotype
func (self *convGo_convFilter) type2gotype(typeInfo *Ast_TypeInfo) string {
    if typeInfo.FP.Get_kind() == Ast_TypeInfoKind__DDD{
        return "[]LnsAny"
    }
    if convGo_isAnyType_1144_(typeInfo){
        return "LnsAny"
    }
    var orgType *Ast_TypeInfo
    orgType = convGo_getOrgTypeInfo_1207_(typeInfo)
    {
    ...
    if _switch2402 := orgType.FP.Get_kind(); _switch2402 == Ast_TypeInfoKind__Ext {
        if orgType.FP.Get_extedType().FP.Get_kind() == Ast_TypeInfoKind__Stem{
            return "LnsAny"
        }
        return "*Lns_luaValue"
    } else if _switch2402 == Ast_TypeInfoKind__List || _switch2402 == Ast_TypeInfoKind__Array {
        return "*LnsList"
    } else if _switch2402 == Ast_TypeInfoKind__Set {
        return "*LnsSet"
    } else if _switch2402 == Ast_TypeInfoKind__Map {
        return "*LnsMap"
    } else if _switch2402 == Ast_TypeInfoKind__Form {
        return "LnsForm"
    } else if _switch2402 == Ast_TypeInfoKind__FormFunc {
        return self.FP.getFuncSymbol(typeInfo)
    } else if _switch2402 == Ast_TypeInfoKind__Class {
        if typeInfo.FP.Get_genSrcTypeInfo() == TransUnit_getBuiltinFunc().__pipe_{
            return "*Lns__pipe"
        }
        return "*" + self.FP.getTypeSymbol(typeInfo)
    } else if _switch2402 == Ast_TypeInfoKind__IF {
        return self.FP.getTypeSymbol(typeInfo)
    } else if _switch2402 == Ast_TypeInfoKind__Alternate {
...
// 551: decl @lune.@base.@convGo.convFilter.outputAny2Type
func (self *convGo_convFilter) outputAny2Type(dstType *Ast_TypeInfo) {
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(convGo_isAnyType_1144_(dstType))) &&
...
// 558: decl @lune.@base.@convGo.convFilter.outputStem2Type
...
func (self *convGo_convFilter) ProcessImport(node *Nodes_ImportNode,_opt LnsAny) {
    ...
    self.FP.Writeln(Lns_getVM().String_format("Lns_%s_init()", []LnsAny{convGo_getModuleName_1168_(node.FP.Get_moduleTypeInfo())}))
}

// 694: decl @lune.@base.@convGo.convFilter.outputImplicitCast
func (self *convGo_convFilter) outputImplicitCast(castType *Ast_TypeInfo,node *Nodes_Node,parent *Nodes_ExpCastNode) {
    if _switch3683 := castType.FP.Get_kind(); _switch3683 == Ast_TypeInfoKind__Nilable {
        self.FP.outputImplicitCast(castType.FP.Get_nonnilableType(), node, parent)
    } else if _switch3683 == Ast_TypeInfoKind__Class {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            convGo_filter_1141_(node, self, &parent.Nodes_Node)
        } else { 
            if convGo_isAnyType_1144_(node.FP.Get_expType()){
    ...
    } else if _switch3683 == Ast_TypeInfoKind__IF {
        convGo_filter_1141_(node, self, &parent.Nodes_Node)
        if Ast_isClass(node.FP.Get_expType()){
            self.FP.Write(".FP")
        }
    } else if _switch3683 == Ast_TypeInfoKind__FormFunc {
        _ = node.FP.Get_expType()
        if convGo_needConvFormFunc_1240_(parent){
    ...
    } else if _switch3683 == Ast_TypeInfoKind__Alternate {
    ...
    } else if _switch3683 == Ast_TypeInfoKind__Form {
        self.FP.Write(Lns_getVM().String_format("%s(", []LnsAny{self.FP.getConv2formName(&parent.Nodes_Node)}))
        convGo_filter_1141_(node, self, &parent.Nodes_Node)
        self.FP.Write(")")
    } else if _switch3683 == Ast_TypeInfoKind__Prim {
        if Lns_op_not(node.FP.Get_expType().FP.Get_nilable()){
            if _switch3565 := castType; _switch3565 == Ast_builtinTypeInt {
                self.FP.Write("LnsInt(")
                convGo_filter_1141_(node, self, &parent.Nodes_Node)
                self.FP.Write(")")
            } else if _switch3565 == Ast_builtinTypeReal {
...
// 875: decl @lune.@base.@convGo.convFilter.getConvExpName
...
// 880: decl @lune.@base.@convGo.convFilter.processConvExp
func (self *convGo_convFilter) processConvExp(nodeId LnsInt,dstTypeList *LnsList,argListNode LnsAny) {
    ...
    if convGo_getExpListKind_1268_(dstTypeList, argList) != convGo_ExpListKind__Conv{
        return 
    }
    var expList *LnsList
    ...
    if mRetIndex != nil{
        mRetIndex_5989 := mRetIndex.(LnsInt)
        ...
        for _index, _retType := range( retTypeList.Items ) {
            ...
            if index >= mRetIndex_5989{
                ...
                if Lns_op_not(wrote){
                    self.FP.Write(Lns_getVM().String_format("Lns_getFromMulti( arg%d, %d )", []LnsAny{mRetIndex_5989, index - mRetIndex_5989}))
        ...
        if restIndex != nil{
            restIndex_6006 := restIndex.(LnsInt)
            self.FP.Write("Lns_2DDD( ")
            for _index, _ := range( expList.Items ) {
                index := _index + 1
                if index >= restIndex_6006{
                    if index < expList.Len(){
                        self.FP.Write(Lns_getVM().String_format("arg%d", []LnsAny{index}))
                    } else { 
                        self.FP.Write(Lns_getVM().String_format("arg%d[%d:]", []LnsAny{mRetIndex_5989, index - mRetIndex_5989}))
                        break
                    }
                }
            }
...
// 1045: decl @lune.@base.@convGo.convFilter.outputNilAccCall
func (self *convGo_convFilter) outputNilAccCall(node *Nodes_ExpCallNode) {
    ...
    if node.FP.Get_expTypeList().Len() > convGo_MaxNilAccNum{
        ...
        lists = "list[0]"
        {
            var _from4944 LnsInt = 2
            var _to4944 LnsInt = node.FP.Get_expTypeList().Len()
            for _work4944 := _from4944; _work4944 <= _to4944; _work4944++ {
                count := _work4944
...
// 1086: decl @lune.@base.@convGo.convFilter.processGenericsCall
func (self *convGo_convFilter) processGenericsCall(node *Nodes_ExpCallNode) {
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(convGo_isRetGenerics_1305_(node))) ||
    ...
    {
        var _from5152 LnsInt = 2
        var _to5152 LnsInt = srcTypeList.Len()
        for _work5152 := _from5152; _work5152 <= _to5152; _work5152++ {
            index := _work5152
    ...
    {
        var _from5184 LnsInt = 2
        var _to5184 LnsInt = dstTypeList.Len()
        for _work5184 := _from5184; _work5184 <= _to5184; _work5184++ {
            index := _work5184
...
// 1130: decl @lune.@base.@convGo.convFilter.outputRetType
func (self *convGo_convFilter) outputRetType(retTypeList *LnsList) {
    if _switch5448 := retTypeList.Len(); _switch5448 == 0 {
        self.FP.Write("")
    } else if _switch5448 == 1 {
...
func (self *convGo_convFilter) OutputDeclFunc(funcInfo LnsAny) *convGo_FuncConv {
    ...
    classType := _exp5637.Val1
    methodType := _exp5637.Val2
        extFlag = false
    ...
    if convGo_isClosure_1147_(typeInfo){
        self.FP.Write("func")
    } else { 
        if typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Method{
            self.FP.Write("func ")
        ...
        if typeInfo.FP.Get_extedType().FP.Get_kind() != Ast_TypeInfoKind__FormFunc{
            if name != nil{
                name_6120 := name.(string)
                self.FP.outputSymbol(&convGo_SymbolKind__Func{typeInfo}, name_6120)
            }
        }
    }
    self.FP.Write("(")
    ...
    switch _exp6021 := funcInfo.(type) {
    case *convGo_FuncInfo__DeclInfo:
    node := _exp6021.Val1
    declInfo := _exp6021.Val2
            ...
            if argType.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Alternate{
                {
                    ...
                    if _argNode != nil {
                        ...
                        convGo_filter_1141_(arg, self, node)
                    }
                }
            } else { 
                convGo_filter_1141_(arg, self, node)
...
// 1280: decl @lune.@base.@convGo.convFilter.outputConvToForm
...
// 1353: decl @lune.@base.@convGo.convFilter.processConvStat
func (self *convGo_convFilter) ProcessConvStat(node *Nodes_ConvStatNode,_opt LnsAny) {
    self.FP.Write(node.FP.Get_txt())
}

// 1359: decl @lune.@base.@convGo.convFilter.outputTopScopeVar
...
// 1368: decl @lune.@base.@convGo.convFilter.outputConvExt
...
// 1395: decl @lune.@base.@convGo.convFilter.isSameModDir
...
// 1401: decl @lune.@base.@convGo.convFilter.outputModule
...
// 1421: decl @lune.@base.@convGo.convFilter.outputImport
func (self *convGo_convFilter) outputImport(node *Nodes_ImportNode) {
    ...
    if count == 0{
        ...
        var modDir string
        modDir = convGo_convExp6924(Lns_2DDD(Lns_getVM().String_gsub(modulePath,"/", "")))
...
// 1445: decl @lune.@base.@convGo.convFilter.processRoot
func (self *convGo_convFilter) ProcessRoot(node *Nodes_RootNode,_opt LnsAny) {
    for _pragma := range( node.FP.Get_luneHelperInfo().PragmaSet.Items ) {
        pragma := _pragma
        switch _exp7053 := pragma.(type) {
        case *LuneControl_Pragma__limit_conv_code:
        codeSet := _exp7053.Val1
    ...
    initModVar = Lns_getVM().String_format("init_%s", []LnsAny{convGo_getModuleName_1168_(node.FP.Get_moduleTypeInfo())})
    ...
    self.FP.Writeln(Lns_getVM().String_format("var %s string", []LnsAny{self.FP.getSymbolSym(modSym)}))
    {
        ...
        procNode = func(workNode *Nodes_Node) {
            convGo_filter_1141_(workNode, self, &node.Nodes_Node)
        }
    ...
    
    {
        ...
        procNode = func(workNode *Nodes_IfUnwrapNode) {
            ...
            {
                var _from8522 LnsInt = 1
                var _to8522 LnsInt = workNode.FP.Get_varSymList().Len()
                for _work8522 := _from8522; _work8522 <= _to8522; _work8522++ {
    ...
    self.FP.popProcessMode()
    self.FP.Writeln(Lns_getVM().String_format("func Lns_%s_init() {", []LnsAny{convGo_getModuleName_1168_(node.FP.Get_moduleTypeInfo())}))
    self.FP.PushIndent(nil)
    ...
    var modulePath string
    modulePath = convGo_convExp9534(Lns_2DDD(Lns_getVM().String_gsub(node.FP.Get_moduleTypeInfo().FP.GetFullName(self.FP.Get_typeNameCtrl(), self.FP.Get_moduleInfoManager(), nil),"@", "")))
    var moduleName string
    moduleName = convGo_getModuleName_1168_(node.FP.Get_moduleTypeInfo())
    if self.enableTest{
    ...
    for _, _child := range( node.FP.Get_children().Items ) {
        ...
        if Lns_op_not(convGo_ignoreNodeInInnerBlockSet.Has(child.FP.Get_kind())){
            convGo_filter_1141_(child, self, &node.Nodes_Node)
        }
    }
    self.FP.PopIndent()
    self.FP.Writeln("}")
...
// 1708: decl @lune.@base.@convGo.convFilter.processSubfile
func (self *convGo_convFilter) ProcessSubfile(node *Nodes_SubfileNode,_opt LnsAny) {
}

// 1714: decl @lune.@base.@convGo.convFilter.processBlockSub
...
// 1736: decl @lune.@base.@convGo.convFilter.expList2Slice
func (self *convGo_convFilter) expList2Slice(subList *Nodes_ExpListNode,toStem bool) {
    ...
    processExp = func(exp *Nodes_Node) {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            convGo_filter_1141_(Nodes_getCastUnwraped(exp), self, &subList.Nodes_Node)
            self.FP.Write(")")
        } else { 
            convGo_filter_1141_(exp, self, &subList.Nodes_Node)
        }
    }
    var mRetIndex LnsAny
...
// 1799: decl @lune.@base.@convGo.convFilter.processSetFromExpList
func (self *convGo_convFilter) processSetFromExpList(convArgFuncName string,dstTypeList *LnsList,expListNode *Nodes_ExpListNode) {
    if _switch10595 := convGo_getExpListKind_1268_(dstTypeList, expListNode); _switch10595 == convGo_ExpListKind__Conv {
        ...
        for _index, _exp := range( expListNode.FP.Get_expList().Items ) {
            ...
            if mRetIndex == index{
                self.FP.Write("Lns_2DDD(")
                convGo_filter_1141_(Nodes_getCastUnwraped(exp), self, &expListNode.Nodes_Node)
                self.FP.Write(")")
                break
            }
            convGo_filter_1141_(exp, self, &expListNode.Nodes_Node)
        ...
        self.FP.Write(")")
    } else if _switch10595 == convGo_ExpListKind__Slice {
                ...
                argExp = expListNode.FP.Get_expList().GetAt(index).(Nodes_NodeDownCast).ToNodes_Node()
                {
                    ...
                    if _exp2ddd != nil {
                        ...
                        if argExp.FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__Abbr{
                            ...
                            convGo_filter_1141_(argExp, self, &expListNode.Nodes_Node)
                        }
                    }
                }
            } else { 
    ...
    } else if _switch10595 == convGo_ExpListKind__Direct {
        var mRetIndex LnsAny
        mRetIndex = Lns_GetEnv().NilAccFin(Lns_GetEnv().NilAccPush(expListNode.FP.Get_mRetExp()) && 
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Nodes_MRetExp).FP.Get_index()}))
        for _index, _dstType := range( dstTypeList.Items ) {
...
// 1901: decl @lune.@base.@convGo.convFilter.processStmtExp
func (self *convGo_convFilter) ProcessStmtExp(node *Nodes_StmtExpNode,_opt LnsAny) {
    convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
    self.FP.Writeln("")
}

// 1908: decl @lune.@base.@convGo.convFilter.processDeclAlge
func (self *convGo_convFilter) ProcessDeclAlge(node *Nodes_DeclAlgeNode,_opt LnsAny) {
    {
        __collection10768 := node.FP.Get_algeType().FP.Get_valInfoMap()
        __sorted10768 := __collection10768.CreateKeyListStr()
        __sorted10768.Sort( LnsItemKindStr, nil )
        for _, ___key10768 := range( __sorted10768.Items ) {
            valInfo := __collection10768.Items[ ___key10768 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            var algeSym string
...
// 1927: decl @lune.@base.@convGo.convFilter.processNewAlgeVal
func (self *convGo_convFilter) ProcessNewAlgeVal(node *Nodes_NewAlgeValNode,_opt LnsAny) {
    ...
    if node.FP.Get_valInfo().FP.Get_typeList().Len() == 0{
        ...
        for _index, _param := range( node.FP.Get_paramList().Items ) {
            ...
            convGo_filter_1141_(param, self, &node.Nodes_Node)
        }
        self.FP.Write("}")
    }
}

// 1946: decl @lune.@base.@convGo.convFilter.processDeclMember
...
// 1955: decl @lune.@base.@convGo.convFilter.processExpMacroExp
func (self *convGo_convFilter) ProcessExpMacroExp(node *Nodes_ExpMacroExpNode,_opt LnsAny) {
    for _, _stmt := range( node.FP.Get_stmtList().Items ) {
        ...
        if Lns_op_not(convGo_ignoreNodeInInnerBlockSet.Has(stmt.FP.Get_kind())){
            convGo_filter_1141_(stmt, self, &node.Nodes_Node)
        }
    }
}

// 1965: decl @lune.@base.@convGo.convFilter.processDeclMacro
func (self *convGo_convFilter) ProcessDeclMacro(node *Nodes_DeclMacroNode,_opt LnsAny) {
}

// 1971: decl @lune.@base.@convGo.convFilter.processExpMacroStat
...
// 1977: decl @lune.@base.@convGo.convFilter.outputDeclFuncArg
...
// 1988: decl @lune.@base.@convGo.convFilter.processDeclConstr
func (self *convGo_convFilter) ProcessDeclConstr(node *Nodes_DeclConstrNode,_opt LnsAny) {
    ...
    for _index, _arg := range( node.FP.Get_declInfo().FP.Get_argList().Items ) {
        ...
        convGo_filter_1141_(arg, self, &node.Nodes_Node)
    }
    self.FP.Writeln(") {")
    convGo_filter_1141_(&Lns_unwrap( node.FP.Get_declInfo().FP.Get_body()).(*Nodes_BlockNode).Nodes_Node, self, &node.Nodes_Node)
    self.FP.Writeln("}")
}

// 2008: decl @lune.@base.@convGo.convFilter.processDeclDestr
...
// 2014: decl @lune.@base.@convGo.convFilter.processExpCallSuperCtor
...
// 2025: decl @lune.@base.@convGo.convFilter.processExpCallSuper
...
// 2037: decl @lune.@base.@convGo.convFilter.outputDummyReturn
func (self *convGo_convFilter) outputDummyReturn(retTypeInfoList *LnsList) {
    ...
    for _index, _retType := range( retTypeInfoList.Items ) {
        ...
        if convGo_isAnyType_1144_(retType){
            self.FP.Write("nil")
        } else { 
            if _switch11503 := convGo_getOrgTypeInfo_1207_(retType); _switch11503 == Ast_builtinTypeInt {
                self.FP.Write("0")
            } else if _switch11503 == Ast_builtinTypeReal {
                self.FP.Write("0.0")
            } else if _switch11503 == Ast_builtinTypeBool {
                self.FP.Write("false")
            } else if _switch11503 == Ast_builtinTypeString {
                self.FP.Write("\"\"")
            } else {
                self.FP.Write("nil")
            }
...
// 2069: decl @lune.@base.@convGo.convFilter.outputDeclFuncInfo
func (self *convGo_convFilter) OutputDeclFuncInfo(node *Nodes_Node,declInfo *Nodes_DeclFuncInfo) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( Lns_op_not(convGo_isClosure_1147_(funcType))) )){
    ...
    if declInfo.FP.Get_has__func__Symbol(){
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild("__func__")})/* 2094:29 */)).(*Ast_SymbolInfo)
    ...
    self.FP.PopIndent()
    {
        ...
        if _body != nil {
            ...
            convGo_filter_1141_(&body.Nodes_Node, self, node)
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                needReturn = false
                {
                    var _from11836 LnsInt = body.FP.Get_stmtList().Len()
                    var _to11836 LnsInt = 1
                    _work11836 := _from11836
                    _delta11836 := -1
                    for {
                        if _delta11836 > 0 {
                           if _work11836 > _to11836 { break }
                        } else {
                           if _work11836 < _to11836 { break }
                        }
                        index := _work11836
                        ...
                        if _switch11834 := statment.FP.Get_kind(); _switch11834 == Nodes_NodeKind_get_BlankLine() {
                        } else if _switch11834 == Nodes_NodeKind_get_Return() {
                            break
                        } else {
                            needReturn = true
...
// 2147: decl @lune.@base.@convGo.convFilter.processDeclMethod
...
// 2153: decl @lune.@base.@convGo.convFilter.processProtoMethod
func (self *convGo_convFilter) ProcessProtoMethod(node *Nodes_ProtoMethodNode,_opt LnsAny) {
}

// 2159: decl @lune.@base.@convGo.convFilter.getEnumGetTxtSym
...
// 2163: decl @lune.@base.@convGo.convFilter.processDeclEnum
func (self *convGo_convFilter) ProcessDeclEnum(node *Nodes_DeclEnumNode,_opt LnsAny) {
    if _switch12449 := self.processMode; _switch12449 == convGo_ProcessMode__DeclTopScopeVar {
        self.FP.Writeln(Lns_getVM().String_format("// decl enum -- %s ", []LnsAny{node.FP.Get_enumType().FP.GetTxt(nil, nil, nil)}))
        {
            __collection12070 := node.FP.Get_enumType().FP.Get_name2EnumValInfo()
            __sorted12070 := __collection12070.CreateKeyListStr()
            __sorted12070.Sort( LnsItemKindStr, nil )
            for _, ___key12070 := range( __sorted12070.Items ) {
                valInfo := __collection12070.Items[ ___key12070 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
                ...
                switch _exp12060 := valInfo.FP.Get_val().(type) {
                ...
                val := _exp12060.Val1
                    self.FP.Write(convGo_str2gostr_1204_(Lns_getVM().String_format("\"%s\"", []LnsAny{val})))
                }
                self.FP.Writeln("")
            }
        }
        ...
        {
            __collection12295 := node.FP.Get_enumType().FP.Get_name2EnumValInfo()
            __sorted12295 := __collection12295.CreateKeyListStr()
            __sorted12295.Sort( LnsItemKindStr, nil )
            for _, ___key12295 := range( __sorted12295.Items ) {
                valInfo := __collection12295.Items[ ___key12295 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
...
// 2239: decl @lune.@base.@convGo.convFilter.processUnwrapSet
...
// 2245: decl @lune.@base.@convGo.convFilter.processIfUnwrap
func (self *convGo_convFilter) ProcessIfUnwrap(node *Nodes_IfUnwrapNode,_opt LnsAny) {
    ...
    if convGo_getExpListKind_1268_(tempTypeList, node.FP.Get_expList()) == convGo_ExpListKind__Direct{
        {
            var _from12614 LnsInt = node.FP.Get_varSymList().Len() + 1
            var _to12614 LnsInt = node.FP.Get_expList().FP.Get_expTypeList().Len()
            for _work12614 := _from12614; _work12614 <= _to12614; _work12614++ {
                self.FP.Write(", _")
            }
        }
    }
    ...
    self.FP.PopIndent()
    convGo_filter_1141_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    {
        _nilBlock := node.FP.Get_nilBlock()
        if _nilBlock != nil {
            nilBlock := _nilBlock.(*Nodes_BlockNode)
            self.FP.Writeln("} else {")
            convGo_filter_1141_(&nilBlock.Nodes_Node, self, &node.Nodes_Node)
            self.FP.Writeln("}")
        } else {
            self.FP.Writeln("}")
        }
...
// 2323: decl @lune.@base.@convGo.convFilter.outputLetVar
    ...
    if node.FP.Get_unwrapFlag(){
        {
            ...
            if _expList != nil && _unwrapBlock != nil {
                ...
                if convGo_getExpListKind_1268_(tmpVarTypeList, expList) == convGo_ExpListKind__Direct{
                    {
                        var _from13111 LnsInt = tmpVarTypeList.Len() + 1
                        var _to13111 LnsInt = expList.FP.Get_expTypeList().Len()
                        for _work13111 := _from13111; _work13111 <= _to13111; _work13111++ {
                            self.FP.Write(", _")
                        }
                    }
                }
                ...
                self.FP.Writeln("{")
                convGo_filter_1141_(&unwrapBlock.Nodes_Node, self, &node.Nodes_Node)
                {
                    ...
                    if _thenBlock != nil {
                        ...
                        self.FP.PopIndent()
                        convGo_filter_1141_(&thenBlock.Nodes_Node, self, &node.Nodes_Node)
                        self.FP.Writeln("}")
                    } else {
                        self.FP.Writeln("} else {")
                        self.FP.PushIndent(nil)
        ...
        declVar()
        {
            ...
            if _expList != nil {
                ...
                if convGo_getExpListKind_1268_(varTypeList, expList) == convGo_ExpListKind__Direct{
                    {
                        var _from13567 LnsInt = varTypeList.Len() + 1
                        var _to13567 LnsInt = expList.FP.Get_expTypeList().Len()
                        for _work13567 := _from13567; _work13567 <= _to13567; _work13567++ {
                            self.FP.Write(", _")
                        }
                    }
                }
...
// 2452: decl @lune.@base.@convGo.convFilter.processDeclVar
func (self *convGo_convFilter) ProcessDeclVar(node *Nodes_DeclVarNode,_opt LnsAny) {
    ...
    if _switch14062 := node.FP.Get_mode(); _switch14062 == Nodes_DeclVarMode__Let {
        self.FP.outputLetVar(node)
    } else if _switch14062 == Nodes_DeclVarMode__Unwrap {
        self.FP.Writeln("{")
        self.FP.PushIndent(nil)
        ...
        if convGo_getExpListKind_1268_(typeList, expList) == convGo_ExpListKind__Direct{
            {
                var _from13841 LnsInt = node.FP.Get_symbolInfoList().Len() + 1
                var _to13841 LnsInt = expList.FP.Get_expTypeList().Len()
                for _work13841 := _from13841; _work13841 <= _to13841; _work13841++ {
                    self.FP.Write(",_")
                }
            }
        }
        ...
        self.FP.Writeln(" {")
        convGo_filter_1141_(&Lns_unwrap( node.FP.Get_unwrapBlock()).(*Nodes_BlockNode).Nodes_Node, self, &node.Nodes_Node)
        {
            _thenBlock := node.FP.Get_thenBlock()
            if _thenBlock != nil {
                thenBlock := _thenBlock.(*Nodes_BlockNode)
...
// 2532: decl @lune.@base.@convGo.convFilter.processWhen
func (self *convGo_convFilter) ProcessWhen(node *Nodes_WhenNode,_opt LnsAny) {
    ...
    convGo_filter_1141_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    {
        ...
        if _elseBlock != nil {
            ...
            self.FP.Writeln("} else {")
            convGo_filter_1141_(&elseBlock.Nodes_Node, self, &node.Nodes_Node)
            self.FP.Write("}")
        } else {
            self.FP.Write("}")
        }
...
// 2569: decl @lune.@base.@convGo.convFilter.processDeclArg
func (self *convGo_convFilter) ProcessDeclArg(node *Nodes_DeclArgNode,_opt LnsAny) {
    ...
    convGo_filter_1141_(&Lns_unwrap( node.FP.Get_argType()).(*Nodes_RefTypeNode).Nodes_Node, self, &node.Nodes_Node)
}

// 2576: decl @lune.@base.@convGo.convFilter.processDeclArgDDD
func (self *convGo_convFilter) ProcessDeclArgDDD(node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.Write("ddd []LnsAny")
}

// 2582: decl @lune.@base.@convGo.convFilter.processExpSubDDD
...
// 2589: decl @lune.@base.@convGo.convFilter.processDeclForm
...
// 2598: decl @lune.@base.@convGo.convFilter.processDeclFunc
func (self *convGo_convFilter) ProcessDeclFunc(node *Nodes_DeclFuncNode,_opt LnsAny) {
    ...
    var funcType *Ast_TypeInfo
    funcType = node.FP.Get_expType()
    if (self.processMode == convGo_ProcessMode__NonClosureFuncDecl) == convGo_isClosure_1147_(node.FP.Get_expType()){
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    if convGo_isClosure_1147_(funcType){
        {
            _funcSym := node.FP.Get_declInfo().FP.Get_symbol()
            if _funcSym != nil {
                funcSym := _funcSym.(*Ast_SymbolInfo)
...
// 2630: decl @lune.@base.@convGo.convFilter.processRefType
...
// 2636: decl @lune.@base.@convGo.convFilter.processCond
func (self *convGo_convFilter) processCond(node *Nodes_Node,parent *Nodes_Node) {
    if node.FP.Get_expType() != Ast_builtinTypeBool{
        ...
        convGo_filter_1141_(node, self, parent)
        self.FP.Write(")")
    } else { 
        convGo_filter_1141_(node, self, parent)
    }
...
// 2647: decl @lune.@base.@convGo.convFilter.processIf
func (self *convGo_convFilter) ProcessIf(node *Nodes_IfNode,_opt LnsAny) {
    for _, _stmt := range( node.FP.Get_stmtList().Items ) {
        ...
        if _switch14844 := stmt.FP.Get_kind(); _switch14844 == Nodes_IfKind__If {
            self.FP.Write("if ")
            self.FP.processCond(stmt.FP.Get_exp(), &node.Nodes_Node)
            self.FP.Writeln("{")
            convGo_filter_1141_(&stmt.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
        } else if _switch14844 == Nodes_IfKind__ElseIf {
            self.FP.Write("} else if ")
            self.FP.processCond(stmt.FP.Get_exp(), &node.Nodes_Node)
            self.FP.Writeln("{")
            convGo_filter_1141_(&stmt.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
        } else if _switch14844 == Nodes_IfKind__Else {
            self.FP.Writeln("} else { ")
            convGo_filter_1141_(&stmt.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
        }
    }
...
// 2673: decl @lune.@base.@convGo.convFilter.processSwitch
func (self *convGo_convFilter) ProcessSwitch(node *Nodes_SwitchNode,_opt LnsAny) {
    ...
    for _caseIndex, _caseNode := range( node.FP.Get_caseList().Items ) {
        ...
        for _index, _exp := range( caseNode.FP.Get_expList().FP.Get_expList().Items ) {
            ...
            convGo_filter_1141_(exp, self, &caseNode.FP.Get_expList().Nodes_Node)
        }
        self.FP.Writeln(" {")
        convGo_filter_1141_(&caseNode.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    }
    {
        ...
        if _defaultBlock != nil {
            ...
            self.FP.Writeln("} else {")
            convGo_filter_1141_(&defaultBlock.Nodes_Node, self, &node.Nodes_Node)
        }
    }
    self.FP.Writeln("}")
}

// 2706: decl @lune.@base.@convGo.convFilter.processMatch
func (self *convGo_convFilter) ProcessMatch(node *Nodes_MatchNode,_opt LnsAny) {
    ...
    convGo_filter_1141_(node.FP.Get_val(), self, &node.Nodes_Node)
    ...
    for _, _caseInfo := range( node.FP.Get_caseList().Items ) {
        ...
        convGo_filter_1141_(&caseInfo.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    }
    {
        ...
        if _defaultBlock != nil {
            ...
            convGo_filter_1141_(defaultBlock, self, &node.Nodes_Node)
        }
    }
    self.FP.Writeln("}")
}

// 2746: decl @lune.@base.@convGo.convFilter.processWhile
...
// 2760: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 2778: decl @lune.@base.@convGo.convFilter.processFor
func (self *convGo_convFilter) ProcessFor(node *Nodes_ForNode,_opt LnsAny) {
    ...
    convGo_filter_1141_(node.FP.Get_init(), self, &node.Nodes_Node)
    self.FP.Writeln("")
    self.FP.Write(Lns_getVM().String_format("var %s %s = ", []LnsAny{toSym, valType}))
    convGo_filter_1141_(node.FP.Get_to(), self, &node.Nodes_Node)
    self.FP.Writeln("")
    {
        ...
        if _delta != nil {
            ...
            convGo_filter_1141_(delta, self, &node.Nodes_Node)
            self.FP.Writeln("")
            self.FP.Writeln("for {")
            self.FP.PushIndent(nil)
...
// 2842: decl @lune.@base.@convGo.convFilter.processApply
func (self *convGo_convFilter) ProcessApply(node *Nodes_ApplyNode,_opt LnsAny) {
    ...
    if Lns_isCondTrue( node.FP.Get_expList().FP.Get_mRetExp()){
        ...
        convGo_filter_1141_(&node.FP.Get_expList().Nodes_Node, self, &node.Nodes_Node)
        self.FP.Writeln("")
    } else { 
        self.FP.Write(Lns_getVM().String_format("%s, %s, %s := ", []LnsAny{formSym, paramSym, prevSym}))
        convGo_filter_1141_(node.FP.Get_expList().FP.Get_expList().GetAt(1).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.FP.Get_expList().Nodes_Node)
        self.FP.Write(",")
        convGo_filter_1141_(node.FP.Get_expList().FP.Get_expList().GetAt(2).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.FP.Get_expList().Nodes_Node)
        self.FP.Write(", LnsAny(")
        convGo_filter_1141_(node.FP.Get_expList().FP.Get_expList().GetAt(3).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.FP.Get_expList().Nodes_Node)
        self.FP.Writeln(")")
    }
    self.FP.Writeln("for {")
    self.FP.PushIndent(nil)
    ...
    setTxt = prevSym
    {
        var _from16166 LnsInt = 2
        var _to16166 LnsInt = node.FP.Get_varList().Len()
...
// 2913: decl @lune.@base.@convGo.convFilter.outputForeachLua
func (self *convGo_convFilter) outputForeachLua(node *Nodes_Node,sortFlag bool,exp *Nodes_Node,val *Ast_SymbolInfo,key LnsAny,block *Nodes_BlockNode) {
    ...
    if _switch16935 := exp.FP.Get_expType().FP.Get_extedType().FP.Get_kind(); _switch16935 == Ast_TypeInfoKind__List || _switch16935 == Ast_TypeInfoKind__Map {
        self.FP.Writeln("{")
        self.FP.PushIndent(nil)
        var tmpExp string
        ...
        convGo_filter_1141_(exp, self, node)
        self.FP.Writeln("")
        ...
        self.FP.PopIndent()
        convGo_filter_1141_(&block.Nodes_Node, self, node)
        self.FP.PushIndent(nil)
...
// 2993: decl @lune.@base.@convGo.convFilter.processForeach
func (self *convGo_convFilter) ProcessForeach(node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    if _switch17828 := loopExpType.FP.Get_kind(); _switch17828 == Ast_TypeInfoKind__List || _switch17828 == Ast_TypeInfoKind__Array {
        var valName string
        ...
        self.FP.PopIndent()
    } else if _switch17828 == Ast_TypeInfoKind__Map {
        var valName string
        valName = self.FP.getSymbolSym(node.FP.Get_val())
        var itemType *Ast_TypeInfo
        ...
        self.FP.PopIndent()
    } else if _switch17828 == Ast_TypeInfoKind__Set {
...
// 3111: decl @lune.@base.@convGo.convFilter.processForsort
func (self *convGo_convFilter) ProcessForsort(node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    if _switch18158 := keyTypeInfo; _switch18158 == Ast_builtinTypeInt {
        self.FP.Writeln("CreateKeyListInt()")
    } else if _switch18158 == Ast_builtinTypeReal {
        self.FP.Writeln("CreateKeyListReal()")
    } else if _switch18158 == Ast_builtinTypeString {
        self.FP.Writeln("CreateKeyListStr()")
    } else {
        self.FP.Writeln("CreateKeyListStem()")
    }
    self.FP.Writeln(Lns_getVM().String_format("%s.Sort( %s, nil )", []LnsAny{sortSym, convGo_getLnsItemKind_1760_(keyTypeInfo)}))
    self.FP.Write("for _, ")
    var key string
    key = Lns_getVM().String_format("__key%d", []LnsAny{node.FP.Get_id()})
    if keySym != nil{
        keySym_7217 := keySym.(*Ast_SymbolInfo)
        key = Lns_getVM().String_format("%s", []LnsAny{self.FP.getSymbolSym(keySym_7217)})
    ...
    self.FP.PushIndent(nil)
    if valSym != nil{
        valSym_7219 := valSym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( valSym_7219.FP.Get_posForModToRef()){
            self.FP.Write(Lns_getVM().String_format("%s := %s.Items[ _%s ]", []LnsAny{self.FP.getSymbolSym(valSym_7219), collSym, key}))
            self.FP.outputStem2Type(valSym_7219.FP.Get_typeInfo())
            self.FP.Writeln("")
        }
    }
    if keySym != nil{
        keySym_7222 := keySym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( keySym_7222.FP.Get_posForModToRef()){
            self.FP.Write(Lns_getVM().String_format("%s := _%s", []LnsAny{key, key}))
            self.FP.outputStem2Type(keySym_7222.FP.Get_typeInfo())
            self.FP.Writeln("")
        }
    }
    self.FP.PopIndent()
...
// 3189: decl @lune.@base.@convGo.convFilter.processExpUnwrap
func (self *convGo_convFilter) ProcessExpUnwrap(node *Nodes_ExpUnwrapNode,_opt LnsAny) {
    {
        ...
        if _def != nil {
            ...
            convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
            self.FP.Write(", ")
            convGo_filter_1141_(def, self, &node.Nodes_Node)
        } else {
...
// 3205: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 3217: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 3233: decl @lune.@base.@convGo.convFilter.outputIFMethods
func (self *convGo_convFilter) outputIFMethods(node *Nodes_DeclClassNode) {
    ...
    {
        __collection18847 := name2MtdType
        __sorted18847 := __collection18847.CreateKeyListStr()
        __sorted18847.Sort( LnsItemKindStr, nil )
        for _, _name := range( __sorted18847.Items ) {
            typeInfo := __collection18847.Items[ _name ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            name := _name.(string)
...
// 3263: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 3273: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 3298: decl @lune.@base.@convGo.convFilter.outputClassType
func (self *convGo_convFilter) outputClassType(node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList().Items ) {
        ...
        convGo_filter_1141_(&memberNode.Nodes_Node, self, &node.Nodes_Node)
    }
    self.FP.Write("FP ")
    self.FP.Write(self.FP.getTypeSymbol(node.FP.Get_expType()))
    self.FP.Writeln("Mtd")
...
// 3327: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 3340: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 3365: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 3379: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 3396: decl @lune.@base.@convGo.convFilter.outputConstructor
func (self *convGo_convFilter) outputConstructor(node *Nodes_DeclClassNode) {
    ...
    if Lns_op_not(node.FP.HasUserInit()){
        ...
        if node.FP.Get_expType().FP.HasBase(){
            ...
            {
                var _from20056 LnsInt = 1
                var _to20056 LnsInt = baseInitFuncType.FP.Get_argTypeInfoList().Len()
                for _work20056 := _from20056; _work20056 <= _to20056; _work20056++ {
                    index := _work20056
                    if index != 1{
                        self.FP.Write(",")
                    }
...
// 3483: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList().Items ) {
        ...
        if memberNode.FP.Get_getterMode() != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(getterName)})/* 3497:33 */)).(*Ast_SymbolInfo)
            ...
            if retType.FP.Get_srcTypeInfo() != memberSym.FP.Get_typeInfo().FP.Get_srcTypeInfo(){
                if retType.FP.Get_kind() == Ast_TypeInfoKind__IF{
                    ...
                    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        Lns_GetEnv().SetStackVal( convGo_isAnyType_1144_(retType)) &&
        ...
        if memberNode.FP.Get_setterMode() != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(setterName)})/* 3537:33 */)).(*Ast_SymbolInfo)
...
// 3545: decl @lune.@base.@convGo.convFilter.outputStaticMember
    ...
    if self.processMode == convGo_ProcessMode__DeclClass{
        ...
        }
        {
            ...
            if _initBlock != nil {
                ...
                convGo_filter_1141_(&initBlock.Nodes_Node, self, &node.Nodes_Node)
                self.FP.Writeln("")
            }
        }
    } else { 
...
// 3574: decl @lune.@base.@convGo.convFilter.getFromStemName
func (self *convGo_convFilter) getFromStemName(typeInfo *Ast_TypeInfo) string {
    ...
    workTypeInfo = convGo_getOrgTypeInfo_1207_(typeInfo)
    {
    ...
    if _switch20836 := workTypeInfo.FP.Get_kind(); _switch20836 == Ast_TypeInfoKind__List || _switch20836 == Ast_TypeInfoKind__Array {
        return "Lns_ToList"
    } else if _switch20836 == Ast_TypeInfoKind__Set {
        return "Lns_ToSet"
    } else if _switch20836 == Ast_TypeInfoKind__Map {
        return "Lns_ToLnsMap"
    } else if _switch20836 == Ast_TypeInfoKind__Class {
...
// 3601: decl @lune.@base.@convGo.convFilter.outputConvItemType
func (self *convGo_convFilter) outputConvItemType(typeInfo *Ast_TypeInfo,alt2type LnsAny) {
    ...
    if typeInfo.FP.Get_srcTypeInfo().FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Alternate{
        if alt2type != nil{
            alt2type_7425 := alt2type.(*LnsMap)
            {
                _alt := alt2type_7425.Items[workTypeInfo]
                if _alt != nil {
...
// 3626: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 3646: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 3665: decl @lune.@base.@convGo.convFilter.outputAsyncItem
...
// 3675: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 3801: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 3812: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
func (self *convGo_convFilter) outputDummyAbstractMethodOfClass(classType *Ast_TypeInfo) {
    ...
    {
        __collection22172 := name2typeMap
        __sorted22172 := __collection22172.CreateKeyListStr()
        __sorted22172.Sort( LnsItemKindStr, nil )
        for _, ___key22172 := range( __sorted22172.Items ) {
            methodType := __collection22172.Items[ ___key22172 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            self.FP.outputDummyAbstractMethod(classType, methodType)
        }
    }
}

// 3842: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 3883: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(node *Nodes_ProtoClassNode,_opt LnsAny) {
}

// 3888: decl @lune.@base.@convGo.convFilter.processDeclClass
func (self *convGo_convFilter) ProcessDeclClass(node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    if self.processMode == convGo_ProcessMode__DeclClass{
        if _switch22695 := node.FP.Get_expType().FP.Get_kind(); _switch22695 == Ast_TypeInfoKind__Class {
            ...
            for _, _fieldNode := range( node.FP.Get_fieldList().Items ) {
                ...
                if Lns_isCondTrue( Nodes_DeclMemberNodeDownCastF(fieldNode.FP)){
                    ...
                    convGo_filter_1141_(fieldNode, self, &node.Nodes_Node)
                    self.FP.Writeln("")
                }
            }
        } else if _switch22695 == Ast_TypeInfoKind__IF {
...
// 3972: decl @lune.@base.@convGo.convFilter.outputCallPrefix
func (self *convGo_convFilter) OutputCallPrefix(threading bool,callId LnsInt,node *Nodes_Node,prefixNode LnsAny,funcSymbol *Ast_SymbolInfo)(bool, LnsAny) {
    ...
    if prefixNode != nil{
        prefixNode_7585 := prefixNode.(*Nodes_Node)
        extCallFlag = prefixNode_7585.FP.Get_expType().FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext
    ...
    processNilAcc = func(workPrefixNode *Nodes_Node) {
        ...
        if _switch22980 := retNum; _switch22980 == 0 {
            ...
            if retNum <= convGo_MaxNilAccNum{
                ...
                anys = "LnsAny"
                {
                    var _from22915 LnsInt = 2
                    var _to22915 LnsInt = retNum
                    for _work22915 := _from22915; _work22915 <= _to22915; _work22915++ {
                        anys = Lns_getVM().String_format("%s,LnsAny", []LnsAny{anys})
                ...
                args = "LnsAny"
                {
                    var _from22958 LnsInt = 2
                    var _to22958 LnsInt = retNum
                    for _work22958 := _from22958; _work22958 <= _to22958; _work22958++ {
    ...
    closeParen = false
    if prefixNode != nil{
        prefixNode_7610 := prefixNode.(*Nodes_Node)
        ...
        var prefixType *Ast_TypeInfo
        prefixType = prefixNode_7610.FP.Get_expType().FP.Get_nonnilableType()
        if prefixType == Ast_builtinTypeString{
            ...
            }
            {
                ...
                if _runtime != nil {
                    ...
                    callKind = &convGo_CallKind__RuntimeCall{prefixNode_7610}
            ...
            if Lns_op_not(funcType.FP.Get_staticFlag()){
                if node.FP.HasNilAccess(){
                    if Lns_op_not(prefixNode_7610.FP.HasNilAccess()){
                        ...
                        convGo_filter_1141_(prefixNode_7610, self, node)
                        self.FP.Writeln(") && ")
                    } else { 
                        convGo_filter_1141_(prefixNode_7610, self, node)
                        self.FP.Writeln("&&")
            ...
            if prefixType.FP.Get_kind() == Ast_TypeInfoKind__Ext{
                ...
                if Ast_isBuiltin(funcType.FP.Get_typeId()){
                    if _switch23483 := prefixKind; _switch23483 == Ast_TypeInfoKind__Class {
                        ...
                        builtinFuncs = TransUnit_getBuiltinFunc()
                        {
                            ...
                            if _runtime != nil {
                                ...
                                if _switch23460 := funcType; _switch23460 == builtinFuncs.List_sort || _switch23460 == builtinFuncs.Array_sort {
                    ...
                    if _switch23553 := funcType.FP.Get_kind(); _switch23553 == Ast_TypeInfoKind__Method {
                        if _switch23537 := prefixKind; _switch23537 == Ast_TypeInfoKind__Class {
                            self.FP.Write(Lns_getVM().String_format(".FP.%s", []LnsAny{self.FP.getSymbolSym(funcSymbol)}))
                        } else {
                            self.FP.Write(Lns_getVM().String_format(".%s", []LnsAny{self.FP.getSymbolSym(funcSymbol)}))
                        }
...
// 4145: decl @lune.@base.@convGo.convFilter.processExpCall
func (self *convGo_convFilter) ProcessExpCall(node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        convGo_filter_1141_(fieldNode.FP.Get_prefix(), self, &node.Nodes_Node)
        self.FP.Write(")")
        return 
    }
    ...
    if opt.Parent.FP.Get_kind() == Nodes_NodeKind_get_StmtExp(){
        ...
        retGenerics = convGo_isRetGenerics_1305_(node)
            ...
            if Ast_isBuiltin(funcType.FP.Get_typeId()){
                _ = TransUnit_getBuiltinFunc()
                {
                    ...
                    if _runtime != nil {
                        ...
                        if _switch23907 := funcType.FP.Get_srcTypeInfo(); _switch23907 == Ast_builtinTypeForm {
                            convGo_filter_1141_(node.FP.Get_func(), self, &node.Nodes_Node)
    ...
    var closeTxt LnsAny
    closeTxt = nil
    switch _exp24140 := callKind.(type) {
    case *convGo_CallKind__RuntimeCall:
    prefixNode := _exp24140.Val1
        convGo_filter_1141_(prefixNode, self, node.FP.Get_func())
    ...
    typeInfo := _exp24140.Val1
        self.FP.Write(Lns_getVM().String_format("%s, ", []LnsAny{convGo_getLnsItemKind_1760_(typeInfo)}))
    case *convGo_CallKind__BuiltinCall:
    packName := _exp24140.Val1
    funcname := _exp24140.Val2
        closeTxt = "}"
    ...
    if closeTxt != nil{
        closeTxt_7701 := closeTxt.(string)
        self.FP.Write(closeTxt_7701)
    }
    self.FP.Write(")")
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    if retGenerics{
        if funcType.FP.Get_retTypeInfoList().Len() == 1{
            ...
            if convGo_isAnyType_1144_(retType){
                if Lns_op_not(convGo_isAnyType_1144_(node.FP.Get_expType())){
                    self.FP.outputAny2Type(node.FP.Get_expType())
                }
...
// 4338: decl @lune.@base.@convGo.convFilter.processExpMRet
func (self *convGo_convFilter) ProcessExpMRet(node *Nodes_ExpMRetNode,_opt LnsAny) {
    convGo_filter_1141_(node.FP.Get_mRet(), self, &node.Nodes_Node)
}

// 4345: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}

// 4353: decl @lune.@base.@convGo.convFilter.processExpList
            ...
            if _mRetExp != nil {
                ...
                if mRetExp.FP.Get_index() == index{
                    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        ...
                        convGo_filter_1141_(exp, self, &node.Nodes_Node)
                    } else { 
                        self.FP.Write("Lns_2DDD(")
                        convGo_filter_1141_(exp, self, &node.Nodes_Node)
                        self.FP.Write(")")
...
// 4377: decl @lune.@base.@convGo.convFilter.processExpOp1
func (self *convGo_convFilter) ProcessExpOp1(node *Nodes_ExpOp1Node,_opt LnsAny) {
    ...
    if _switch24953 := node.FP.Get_op().Txt; _switch24953 == "~" {
        self.FP.Write("^")
        convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
    } else if _switch24953 == "+" || _switch24953 == "-" {
        self.FP.Write(node.FP.Get_op().Txt)
        convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
    } else if _switch24953 == "not" {
        self.FP.Write("Lns_op_not(")
        convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
        self.FP.Write(")")
    } else if _switch24953 == "#" {
        if _switch24932 := node.FP.Get_exp().FP.Get_expType().FP.Get_kind(); _switch24932 == Ast_TypeInfoKind__List {
            convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
            self.FP.Write(".Len()")
        } else if _switch24932 == Ast_TypeInfoKind__Ext {
            if _switch24899 := node.FP.Get_exp().FP.Get_expType().FP.Get_extedType().FP.Get_kind(); _switch24899 == Ast_TypeInfoKind__List {
                convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
                self.FP.Write(".Len()")
            } else {
...
// 4425: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 4437: decl @lune.@base.@convGo.convFilter.processExpCast
func (self *convGo_convFilter) ProcessExpCast(node *Nodes_ExpCastNode,_opt LnsAny) {
    if _switch25360 := node.FP.Get_castKind(); _switch25360 == Nodes_CastKind__Force {
        if convGo_isAnyType_1144_(node.FP.Get_exp().FP.Get_expType()){
            if _switch25126 := node.FP.Get_castType(); _switch25126 == Ast_builtinTypeInt {
                self.FP.Write("Lns_forceCastInt(")
                convGo_filter_1141_(node.FP.Get_exp(), self, &node.Nodes_Node)
                self.FP.Write(")")
            } else if _switch25126 == Ast_builtinTypeReal {
...
// 4497: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 4514: decl @lune.@base.@convGo.convFilter.processExpSetVal
func (self *convGo_convFilter) ProcessExpSetVal(node *Nodes_ExpSetValNode,_opt LnsAny) {
    convGo_filter_1141_(node.FP.Get_exp1(), self, &node.Nodes_Node)
    if convGo_getExpListKind_1268_(node.FP.Get_exp1().FP.Get_expTypeList(), node.FP.Get_exp2()) == convGo_ExpListKind__Direct{
        {
            var _from25517 LnsInt = node.FP.Get_exp1().FP.Get_expTypeList().Len() + 1
            var _to25517 LnsInt = node.FP.Get_exp2().FP.Get_expTypeList().Len()
            for _work25517 := _from25517; _work25517 <= _to25517; _work25517++ {
                self.FP.Write(",_")
            }
        }
    }
...
// 4529: decl @lune.@base.@convGo.convFilter.processExpSetItem
func (self *convGo_convFilter) ProcessExpSetItem(node *Nodes_ExpSetItemNode,_opt LnsAny) {
    convGo_filter_1141_(node.FP.Get_val(), self, &node.Nodes_Node)
    self.FP.Write(".Set(")
    switch _exp25625 := node.FP.Get_index().(type) {
    case *Nodes_IndexVal__NodeIdx:
    index := _exp25625.Val1
        convGo_filter_1141_(index, self, &node.Nodes_Node)
    case *Nodes_IndexVal__SymIdx:
    index := _exp25625.Val1
        self.FP.Write(Lns_getVM().String_format("\"%s\"", []LnsAny{index}))
    }
    self.FP.Write(",")
    convGo_filter_1141_(node.FP.Get_exp2(), self, &node.Nodes_Node)
    self.FP.Write(")")
}

// 4547: decl @lune.@base.@convGo.convFilter.processAndOr
func (self *convGo_convFilter) processAndOr(node *Nodes_ExpOp2Node,opTxt string,parent *Nodes_Node) {
    ...
    var firstFlag bool
    firstFlag = Lns_op_not(convFilter_processAndOr__isAndOr_1944_(parent))
    if firstFlag{
    ...
    if convFilter_processAndOr__isAndOr_1944_(node.FP.Get_exp1()){
        convGo_filter_1141_(node.FP.Get_exp1(), self, &node.Nodes_Node)
    } else { 
    ...
    if convFilter_processAndOr__isAndOr_1944_(node.FP.Get_exp2()){
        convGo_filter_1141_(node.FP.Get_exp2(), self, &node.Nodes_Node)
    } else { 
        self.FP.Write(Lns_getVM().String_format("%s.SetStackVal( ", []LnsAny{getEnvTxt}))
        convGo_filter_1141_(node.FP.Get_exp2(), self, &node.Nodes_Node)
...
func (self *convGo_convFilter) ProcessExpOp2(node *Nodes_ExpOp2Node,_opt LnsAny) {
    ...
    if _switch26177 := opTxt; _switch26177 == "and" || _switch26177 == "or" {
    ...
    } else {
        {
            ...
            if __exp != nil {
                _exp := __exp.(LnsInt)
                if _switch26064 := _exp; _switch26064 == Ast_BitOpKind__LShift {
                    opTxt = "<<"
                    
                } else if _switch26064 == Ast_BitOpKind__RShift {
                    opTxt = ">>"
...
// 4653: decl @lune.@base.@convGo.convFilter.processExpRef
func (self *convGo_convFilter) ProcessExpRef(node *Nodes_ExpRefNode,_opt LnsAny) {
    ...
    if node.FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__DDD{
        ...
        if Lns_isCondTrue( node.FP.Get_symbolInfo().FP.Get_convModuleParam()){
            ...
            if _switch26366 := node.FP.Get_symbolInfo().FP.Get_kind(); _switch26366 == Ast_SymbolKind__Var || _switch26366 == Ast_SymbolKind__Arg {
                self.FP.Write(self.FP.getSymbolSym(node.FP.Get_symbolInfo()))
            } else if _switch26366 == Ast_SymbolKind__Fun {
                if Ast_isBuiltin(node.FP.Get_expType().FP.Get_typeId()){
                    ...
                    if _switch26310 := node.FP.Get_expType(); _switch26310 == builtinFunc.Lns_print {
            ...
            } else if _switch26366 == Ast_SymbolKind__Typ {
                self.FP.Write(self.FP.getTypeSymbol(node.FP.Get_expType()))
            } else {
...
// 4696: decl @lune.@base.@convGo.convFilter.processExpRefItem
func (self *convGo_convFilter) ProcessExpRefItem(node *Nodes_ExpRefItemNode,_opt LnsAny) {
    ...
    if _switch27161 := prefixType.FP.Get_kind(); _switch27161 == Ast_TypeInfoKind__Ext {
        ...
        self.FP.Write(".GetAt(")
        {
            ...
            if _index != nil {
                ...
                self.FP.Write(Lns_getVM().String_format("\"%s\"", []LnsAny{convGo_str2gostr_1204_(Lns_unwrap( node.FP.Get_symbol()).(string))}))
            }
        }
        self.FP.Write(")")
        self.FP.outputStem2Type(node.FP.Get_expType())
    } else if _switch27161 == Ast_TypeInfoKind__List || _switch27161 == Ast_TypeInfoKind__Array {
        if node.FP.Get_nilAccess(){
            ...
            self.FP.Write(".GetAt(")
            convGo_filter_1141_(Lns_unwrap( node.FP.Get_index()).(*Nodes_Node), self, &node.Nodes_Node)
            self.FP.Write(")")
            self.FP.outputStem2Type(node.FP.Get_expType())
            self.FP.Write("))")
        } else { 
    ...
    } else if _switch27161 == Ast_TypeInfoKind__Map {
        if node.FP.Get_nilAccess(){
            if Lns_op_not(node.FP.Get_val().FP.HasNilAccess()){
                self.FP.Writeln(Lns_getVM().String_format("%s.NilAccFin( %s.NilAccPush(", []LnsAny{getEnvTxt, getEnvTxt}))
                convGo_filter_1141_(node.FP.Get_val(), self, &node.Nodes_Node)
    ...
    } else if _switch27161 == Ast_TypeInfoKind__Stem {
...
// 4807: decl @lune.@base.@convGo.convFilter.processRefField
func (self *convGo_convFilter) ProcessRefField(node *Nodes_RefFieldNode,_opt LnsAny) {
    ...
    if Lns_op_not(node.FP.HasNilAccess()){
        ...
        if Lns_op_not(node.FP.Get_prefix().FP.HasNilAccess()){
            convGo_filter_1141_(node.FP.Get_prefix(), self, &node.Nodes_Node)
        } else { 
        ...
        if _symbol != nil {
            ...
            if node.FP.Get_prefix().FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
                ...
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    ...
                    Lns_GetEnv().SetStackVal( convGo_isAnyType_1144_(orgSym.FP.Get_typeInfo())) ).(bool)){
                    self.FP.outputAny2Type(node.FP.Get_expType())
                }
            }
        } else {
    ...
    {
        var _from27648 LnsInt = 1
        var _to27648 LnsInt = openParenNum
        for _work27648 := _from27648; _work27648 <= _to27648; _work27648++ {
            self.FP.Write(")")
        }
    }
}

// 4886: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 4892: decl @lune.@base.@convGo.convFilter.processGetField
    ...
    opt := _opt.(*ConvGo_Opt)
    {
        ...
        if _symbolInfo != nil {
            ...
            if symbolInfo.FP.Get_staticFlag(){
                ...
                var closeParen bool
                closeParen = convGo_convExp27847(Lns_2DDD(self.FP.OutputCallPrefix(node.FP.IsThreading(), node.FP.Get_id(), &node.Nodes_Node, node.FP.Get_prefix(), symbolInfo)))
                self.FP.Write("()")
                var retType *Ast_TypeInfo
...
// 4941: decl @lune.@base.@convGo.convFilter.processReturn
func (self *convGo_convFilter) ProcessReturn(node *Nodes_ReturnNode,_opt LnsAny) {
    self.FP.Write("return ")
    {
        ...
        if _expList != nil {
            expList := _expList.(*Nodes_ExpListNode)
            convGo_filter_1141_(&expList.Nodes_Node, self, &node.Nodes_Node)
        }
    }
    self.FP.Writeln("")
}

// 4951: decl @lune.@base.@convGo.convFilter.processTestCase
func (self *convGo_convFilter) ProcessTestCase(node *Nodes_TestCaseNode,_opt LnsAny) {
    if Lns_op_not(self.enableTest){
        return 
    }
    self.FP.Writeln(Lns_getVM().String_format("func lns_test_%s_%s( %s *Testing_Ctrl ) {", []LnsAny{convGo_getModuleName_1168_(self.moduleTypeInfo), node.FP.Get_name().Txt, node.FP.Get_ctrlName()}))
    convGo_filter_1141_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    self.FP.Writeln("}")
}

// 4965: decl @lune.@base.@convGo.convFilter.processTestBlock
func (self *convGo_convFilter) ProcessTestBlock(node *Nodes_TestBlockNode,_opt LnsAny) {
    ...
    for _, _statement := range( stmtList.Items ) {
        ...
        if Lns_op_not(convGo_ignoreNodeInInnerBlockSet.Has(statement.FP.Get_kind())){
            convGo_filter_1141_(statement, self, &node.Nodes_Node)
        }
    }
}

// 4977: decl @lune.@base.@convGo.convFilter.processProvide
...
// 4983: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(node *Nodes_AliasNode,_opt LnsAny) {
}

// 4988: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 4994: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 5000: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 5013: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 5027: decl @lune.@base.@convGo.convFilter.processLiteralMap
func (self *convGo_convFilter) ProcessLiteralMap(node *Nodes_LiteralMapNode,_opt LnsAny) {
    ...
    for _, _pair := range( node.FP.Get_pairList().Items ) {
        ...
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            convGo_filter_1141_(pair.FP.Get_key(), self, &node.Nodes_Node)
            self.FP.Write(":")
            convGo_filter_1141_(pair.FP.Get_val(), self, &node.Nodes_Node)
            self.FP.Write(",")
        }
    }
    self.FP.Write("})")
...
// 5055: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 5069: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
func (self *convGo_convFilter) ProcessLiteralString(node *Nodes_LiteralStringNode,_opt LnsAny) {
    ...
    txt = node.FP.Get_token().Txt
    {
        ...
        if _expList != nil {
            expList := _expList.(*Nodes_ExpListNode)
            self.FP.Write(Lns_getVM().String_format("%s.String_format(%s, ", []LnsAny{convGo_getLuavm_1032_(node.FP.IsThreading()), convGo_str2gostr_1204_(txt)}))
            ...
            self.FP.Write(Lns_getVM().String_format("%s", []LnsAny{convGo_str2gostr_1204_(txt)}))
        }
    }
}

// 5102: decl @lune.@base.@convGo.convFilter.processLiteralBool
func (self *convGo_convFilter) ProcessLiteralBool(node *Nodes_LiteralBoolNode,_opt LnsAny) {
    self.FP.Write(node.FP.Get_token().Txt)
}

// 5108: decl @lune.@base.@convGo.convFilter.processLiteralNil
func (self *convGo_convFilter) ProcessLiteralNil(node *Nodes_LiteralNilNode,_opt LnsAny) {
    self.FP.Write("nil")
}

// 5114: decl @lune.@base.@convGo.convFilter.processBreak
func (self *convGo_convFilter) ProcessBreak(node *Nodes_BreakNode,_opt LnsAny) {
    self.FP.Write("break")
    self.FP.Writeln("")
}

// 5121: decl @lune.@base.@convGo.convFilter.processLiteralSymbol
...
// 5127: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 5151: decl @lune.@base.@convGo.convFilter.processAbbr
