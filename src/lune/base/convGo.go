...
// for 211
func convGo_convExp0_584(arg1 []LnsAny) string {
...
// for 772
func convGo_convExp1_2512(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 5412
func convGo_convExp0_6192(arg1 []LnsAny) (bool, LnsAny) {
...
// for 2375
func convGo_convExp2_6423(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6213
func convGo_convExp0_10448(arg1 []LnsAny) bool {
...
// 291: decl @lune.@base.@convGo.getAddEnvArg
...
// 302: decl @lune.@base.@convGo.filter
...
// 308: decl @lune.@base.@convGo.isAnyType
...
// 332: decl @lune.@base.@convGo.isClosure
...
// 367: decl @lune.@base.@convGo.concatGLSym
...
// 384: decl @lune.@base.@convGo.outputGoMain
...
// 457: decl @lune.@base.@convGo.isInnerDeclType
...
// 540: decl @lune.@base.@convGo.normalizeSym
...
// 769: decl @lune.@base.@convGo.str2gostr
func convGo_str2gostr_15_(_env *LnsEnv, txt string) string {
    var work string
    work = txt
    if Lns_isCondTrue( Lns_car(_env.GetVM().String_find(work, "^```", nil, nil))){
        work = convGo_convExp1_2512(Lns_2DDD(_env.GetVM().String_gsub(_env.GetVM().String_sub(work,4, -4),"^\n", "")))
...
// 784: decl @lune.@base.@convGo.getOrgTypeInfo
...
// 991: decl @lune.@base.@convGo.needConvCast
...
// 1168: decl @lune.@base.@convGo.getExpListKind
...
// 1465: decl @lune.@base.@convGo.isRetGenerics
...
// 4168: decl @lune.@base.@convGo.getLnsItemKind
...
// 5823: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
...
// 6482: decl @lune.@base.@convGo.createFilter
...
func (self *convGo_convFilter) InitconvGo_convFilter(_env *LnsEnv, enableTest bool,streamName string,stream Lns_oStream,ast *AstInfo_ASTInfo,option *ConvGo_Option) {
    ...
    self.modDir = convGo_convExp0_584(Lns_2DDD(_env.GetVM().String_gsub(Str_replace(_env, modDir, "@", ""),"%.$", "")))
...
// 227: decl @lune.@base.@convGo.convFilter.getVM
...
// 240: decl @lune.@base.@convGo.convFilter.pushProcessMode
...
// 244: decl @lune.@base.@convGo.convFilter.popProcessMode
...
// 249: decl @lune.@base.@convGo.convFilter.isPubType
...
// 262: decl @lune.@base.@convGo.convFilter.isPubSym
...
// 470: decl @lune.@base.@convGo.convFilter.isInheritAbsImmut
...
// 474: decl @lune.@base.@convGo.convFilter.getCanonicalName
...
// 481: decl @lune.@base.@convGo.convFilter.getModuleName
...
// 494: decl @lune.@base.@convGo.convFilter.concatSymWithType
...
// 505: decl @lune.@base.@convGo.convFilter.isSamePackageExtModule
...
// 517: decl @lune.@base.@convGo.convFilter.isSameModDir
...
// 526: decl @lune.@base.@convGo.convFilter.isSamePackage
...
// 533: decl @lune.@base.@convGo.convFilter.needPrefix
...
// 547: decl @lune.@base.@convGo.convFilter.getSymbol
...
// 675: decl @lune.@base.@convGo.convFilter.getTypeSymbol
...
// 685: decl @lune.@base.@convGo.convFilter.getTypeSymbolWithPrefix
...
// 691: decl @lune.@base.@convGo.convFilter.getConstrSymbol
...
// 695: decl @lune.@base.@convGo.convFilter.getFuncSymbol
...
// 704: decl @lune.@base.@convGo.convFilter.getAlgeSymbol
...
// 708: decl @lune.@base.@convGo.convFilter.getSymbolSym
...
// 739: decl @lune.@base.@convGo.convFilter.getAccessorSym
...
// 743: decl @lune.@base.@convGo.convFilter.outputSymbol
...
// 747: decl @lune.@base.@convGo.convFilter.getConv2formName
...
// 751: decl @lune.@base.@convGo.convFilter.getConvGenericsName
...
// 756: decl @lune.@base.@convGo.convFilter.getModuleSym
...
// 797: decl @lune.@base.@convGo.convFilter.type2gotypeOrg
...
// 864: decl @lune.@base.@convGo.convFilter.type2gotype
...
// 868: decl @lune.@base.@convGo.convFilter.tuple2gotype
...
// 888: decl @lune.@base.@convGo.convFilter.outputAny2Type
...
// 895: decl @lune.@base.@convGo.convFilter.outputStem2Type
...
// 958: decl @lune.@base.@convGo.convFilter.needConvFormFunc
...
// 1052: decl @lune.@base.@convGo.convFilter.outputImplicitCast
...
// 1241: decl @lune.@base.@convGo.convFilter.getConvExpName
...
// 1247: decl @lune.@base.@convGo.convFilter.processConvExp
...
// 1434: decl @lune.@base.@convGo.convFilter.outputNilAccCall
...
// 1476: decl @lune.@base.@convGo.convFilter.processGenericsCall
...
// 1514: decl @lune.@base.@convGo.convFilter.outputRetType
...
// 1554: decl @lune.@base.@convGo.convFilter.outputDeclFunc
...
// 1688: decl @lune.@base.@convGo.convFilter.outputConvToFormFunc
...
// 1772: decl @lune.@base.@convGo.convFilter.outputConvToForm
...
// 1861: decl @lune.@base.@convGo.convFilter.processConvStat
...
// 1867: decl @lune.@base.@convGo.convFilter.outputTopScopeVar
...
// 1876: decl @lune.@base.@convGo.convFilter.outputConvExt
...
// 1903: decl @lune.@base.@convGo.convFilter.outputModule
...
// 1919: decl @lune.@base.@convGo.convFilter.outputModuleImport
...
// 1941: decl @lune.@base.@convGo.convFilter.outputImport
...
// 1969: decl @lune.@base.@convGo.convFilter.setup
...
// 2096: decl @lune.@base.@convGo.convFilter.processMethodAsync
...
// 2164: decl @lune.@base.@convGo.convFilter.processRoot
func (self *convGo_convFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    var modulePath string
    modulePath = convGo_convExp2_6423(Lns_2DDD(_env.GetVM().String_gsub(node.FP.Get_moduleTypeInfo(_env).FP.GetFullName(_env, self.FP.Get_typeNameCtrl(_env), self.FP.Get_moduleInfoManager(_env), nil),"@", "")))
...
// 2438: decl @lune.@base.@convGo.convFilter.processSubfile
func (self *convGo_convFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}
// 2444: decl @lune.@base.@convGo.convFilter.processRequest
...
// 2492: decl @lune.@base.@convGo.convFilter.processAsyncLock
...
// 2510: decl @lune.@base.@convGo.convFilter.processBlockSub
...
// 2536: decl @lune.@base.@convGo.convFilter.expList2Slice
...
// 2599: decl @lune.@base.@convGo.convFilter.processSetFromExpList
...
// 2708: decl @lune.@base.@convGo.convFilter.processCondRet
...
// 2714: decl @lune.@base.@convGo.convFilter.outputCondRetNode
...
// 2762: decl @lune.@base.@convGo.convFilter.processCondRetList
func (self *convGo_convFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convGo_filter_7_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 2768: decl @lune.@base.@convGo.convFilter.outputCondRetInfo
...
// 2774: decl @lune.@base.@convGo.convFilter.processStmtExp
...
// 2785: decl @lune.@base.@convGo.convFilter.processDeclAlge
...
// 2807: decl @lune.@base.@convGo.convFilter.processNewAlgeVal
...
// 2826: decl @lune.@base.@convGo.convFilter.processDeclMember
...
// 2835: decl @lune.@base.@convGo.convFilter.processExpMacroExp
...
// 2845: decl @lune.@base.@convGo.convFilter.processDeclMacro
func (self *convGo_convFilter) ProcessDeclMacro(_env *LnsEnv, node *Nodes_DeclMacroNode,_opt LnsAny) {
}
// 2851: decl @lune.@base.@convGo.convFilter.processExpMacroStat
...
// 2857: decl @lune.@base.@convGo.convFilter.outputDeclFuncArg
...
// 2868: decl @lune.@base.@convGo.convFilter.isImplementedRunner
...
// 2880: decl @lune.@base.@convGo.convFilter.output_to_decl__func__sym
func (self *convGo_convFilter) output_to_decl__func__sym(_env *LnsEnv, declInfo *Nodes_DeclFuncInfo,funcType *Ast_TypeInfo) {
    if declInfo.FP.Get_has__func__Symbol(_env){
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, "__func__")})/* 2891:29 */)).(*Ast_SymbolInfo)
        self.FP.Writeln(_env, _env.GetVM().String_format("%s := \"%s.%s\"", []LnsAny{self.FP.getSymbolSym(_env, funcSym_), nameSpace, funcName}))
    }
}
// 2896: decl @lune.@base.@convGo.convFilter.processDeclConstr
...
// 2931: decl @lune.@base.@convGo.convFilter.processDeclDestr
...
// 2937: decl @lune.@base.@convGo.convFilter.processExpCallSuperCtor
...
// 2951: decl @lune.@base.@convGo.convFilter.processExpCallSuper
...
// 2966: decl @lune.@base.@convGo.convFilter.outputDummyReturn
...
// 3000: decl @lune.@base.@convGo.convFilter.outputDeclFuncInfo
...
// 3079: decl @lune.@base.@convGo.convFilter.processDeclMethod
...
// 3085: decl @lune.@base.@convGo.convFilter.processProtoMethod
func (self *convGo_convFilter) ProcessProtoMethod(_env *LnsEnv, node *Nodes_ProtoMethodNode,_opt LnsAny) {
}
// 3091: decl @lune.@base.@convGo.convFilter.getEnumGetTxtSym
...
// 3095: decl @lune.@base.@convGo.convFilter.processDeclEnum
...
// 3177: decl @lune.@base.@convGo.convFilter.processUnwrapSet
...
// 3183: decl @lune.@base.@convGo.convFilter.processIfUnwrap
...
// 3287: decl @lune.@base.@convGo.convFilter.outputLetVar
...
// 3426: decl @lune.@base.@convGo.convFilter.processExpandTuple
func (self *convGo_convFilter) ProcessExpandTuple(_env *LnsEnv, node *Nodes_ExpandTupleNode,_opt LnsAny) {
    {
        _condRetInfo := node.FP.Get_condRetInfo(_env)
        if !Lns_IsNil( _condRetInfo ) {
            condRetInfo := _condRetInfo.(*Nodes_CondRetInfo)
...
// 3460: decl @lune.@base.@convGo.convFilter.processDeclVar
...
// 3544: decl @lune.@base.@convGo.convFilter.processWhen
...
// 3581: decl @lune.@base.@convGo.convFilter.processDeclArg
...
// 3588: decl @lune.@base.@convGo.convFilter.processDeclArgDDD
...
// 3594: decl @lune.@base.@convGo.convFilter.processExpSubDDD
...
// 3601: decl @lune.@base.@convGo.convFilter.processDeclForm
...
// 3610: decl @lune.@base.@convGo.convFilter.processDeclFunc
...
// 3643: decl @lune.@base.@convGo.convFilter.processRefType
...
// 3665: decl @lune.@base.@convGo.convFilter.processCond
...
// 3676: decl @lune.@base.@convGo.convFilter.processIf
...
// 3705: decl @lune.@base.@convGo.convFilter.processSwitch
...
// 3740: decl @lune.@base.@convGo.convFilter.processMatch
...
// 3791: decl @lune.@base.@convGo.convFilter.processWhile
...
// 3805: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 3823: decl @lune.@base.@convGo.convFilter.processFor
...
// 3889: decl @lune.@base.@convGo.convFilter.processApply
...
// 3965: decl @lune.@base.@convGo.convFilter.outputForeachLua
...
// 4058: decl @lune.@base.@convGo.convFilter.processForeach
...
// 4176: decl @lune.@base.@convGo.convFilter.processForsort
func (self *convGo_convFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    if keySym != nil{
        ...
        key = _env.GetVM().String_format("%s", []LnsAny{self.FP.getSymbolSym(_env, keySym_192)})
    }
    ...
    self.FP.PushIndent(_env, nil)
    if valSym != nil{
        valSym_194 := valSym.(*Ast_SymbolInfo)
        if Lns_isCondTrue( valSym_194.FP.Get_posForModToRef(_env)){
            self.FP.WriteRaw(_env, _env.GetVM().String_format("%s := %s.Items[ _%s ]", []LnsAny{self.FP.getSymbolSym(_env, valSym_194), collSym, key}))
            self.FP.outputStem2Type(_env, valSym_194.FP.Get_typeInfo(_env))
            self.FP.Writeln(_env, "")
        }
    }
    if keySym != nil{
...
// 4261: decl @lune.@base.@convGo.convFilter.processExpUnwrap
...
// 4277: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 4289: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 4317: decl @lune.@base.@convGo.convFilter.outputIFMethods
...
// 4359: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 4369: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 4392: decl @lune.@base.@convGo.convFilter.outputClassType
...
// 4430: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 4448: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 4474: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 4489: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 4514: decl @lune.@base.@convGo.convFilter.outputConstructor
...
// 4610: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 4624:33 */)).(*Ast_SymbolInfo)
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 4665:33 */)).(*Ast_SymbolInfo)
...
// 4674: decl @lune.@base.@convGo.convFilter.outputStaticMember
...
// 4706: decl @lune.@base.@convGo.convFilter.getFromStemName
...
// 4733: decl @lune.@base.@convGo.convFilter.outputConvItemType
func (self *convGo_convFilter) outputConvItemType(_env *LnsEnv, typeInfo *Ast_TypeInfo,alt2type LnsAny) {
    ...
    if typeInfo.FP.Get_srcTypeInfo(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Alternate{
        if alt2type != nil{
            alt2type_1116 := alt2type.(*LnsMap)
            {
                _alt := alt2type_1116.Get(workTypeInfo)
                if !Lns_IsNil( _alt ) {
...
// 4758: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 4778: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 4797: decl @lune.@base.@convGo.convFilter.outputAsyncItem
func (self *convGo_convFilter) outputAsyncItem(_env *LnsEnv, node *Nodes_DeclClassNode) {
}
// 4808: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 4936: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 4948: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
...
// 4981: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 5030: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(_env *LnsEnv, node *Nodes_ProtoClassNode,_opt LnsAny) {
}
// 5035: decl @lune.@base.@convGo.convFilter.processDeclClass
...
// 5133: decl @lune.@base.@convGo.convFilter.outputCallPrefix
func (self *convGo_convFilter) OutputCallPrefix(_env *LnsEnv, callId string,node *Nodes_Node,prefixNode LnsAny,funcSymbol *Ast_SymbolInfo)(bool, LnsAny) {
    ...
    if prefixNode != nil{
        prefixNode_1221 := prefixNode.(*Nodes_Node)
        extCallFlag = prefixNode_1221.FP.Get_expType(_env).FP.Get_nonnilableType(_env).FP.Get_kind(_env) == Ast_TypeInfoKind__Ext
    } else {
        extCallFlag = false
    }
    if extCallFlag{
    ...
    closeParen = false
    if prefixNode != nil{
        prefixNode_1246 := prefixNode.(*Nodes_Node)
        ...
        var prefixType *Ast_TypeInfo
        prefixType = prefixNode_1246.FP.Get_expType(_env).FP.Get_nonnilableType(_env)
        if prefixType == Ast_builtinTypeString{
            ...
            }
            {
                ...
                if !Lns_IsNil( _runtime ) {
                    ...
                    callKind = &convGo_CallKind__RuntimeCall{prefixNode_1246}
            ...
            if _env.PopVal( _env.IncStack() ||
                ...
                if node.FP.HasNilAccess(_env){
                    if Lns_op_not(prefixNode_1246.FP.HasNilAccess(_env)){
                        ...
                        convGo_filter_7_(_env, prefixNode_1246, self, node)
                        self.FP.Writeln(_env, ") && ")
                    } else { 
                        convGo_filter_7_(_env, prefixNode_1246, self, node)
                        self.FP.Writeln(_env, "&&")
            ...
            convGo_processNilAcc(_env, prefixNode_1246)
...
// 5327: decl @lune.@base.@convGo.convFilter.processExpCall
func (self *convGo_convFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    if closeTxt != nil{
        closeTxt_1354 := closeTxt.(string)
        self.FP.WriteRaw(_env, closeTxt_1354)
    }
    self.FP.WriteRaw(_env, ")")
    if _env.PopVal( _env.IncStack() ||
...
// 5609: decl @lune.@base.@convGo.convFilter.processExpMRet
...
// 5616: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(_env *LnsEnv, node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}
// 5624: decl @lune.@base.@convGo.convFilter.processExpList
...
// 5648: decl @lune.@base.@convGo.convFilter.processExpOp1
...
// 5696: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 5708: decl @lune.@base.@convGo.convFilter.processExpCast
...
// 5768: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 5785: decl @lune.@base.@convGo.convFilter.processExpSetVal
...
// 5802: decl @lune.@base.@convGo.convFilter.processExpSetItem
...
// 5820: decl @lune.@base.@convGo.convFilter.processAndOr
...
// 5881: decl @lune.@base.@convGo.convFilter.processExpOp2
...
// 5926: decl @lune.@base.@convGo.convFilter.processExpRef
...
// 5986: decl @lune.@base.@convGo.convFilter.processExpRefItem
...
// 6097: decl @lune.@base.@convGo.convFilter.processRefField
...
// 6185: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 6191: decl @lune.@base.@convGo.convFilter.processGetField
    ...
    opt := _opt.(*ConvGo_Opt)
    {
        ...
        if !Lns_IsNil( _symbolInfo ) {
            ...
            if symbolInfo.FP.Get_staticFlag(_env){
                ...
                var closeParen bool
                closeParen = convGo_convExp0_10448(Lns_2DDD(self.FP.OutputCallPrefix(_env, node.FP.GetIdTxt(_env), &node.Nodes_Node, node.FP.Get_prefix(_env), symbolInfo)))
                self.FP.WriteRaw(_env, _env.GetVM().String_format("(%s)", []LnsAny{convGo_getAddEnvArg_6_(_env, 0, self.option.FP.Get_addEnvArg(_env))}))
                var retType *Ast_TypeInfo
...
// 6240: decl @lune.@base.@convGo.convFilter.processReturn
...
// 6250: decl @lune.@base.@convGo.convFilter.processTestCase
...
// 6265: decl @lune.@base.@convGo.convFilter.processTestBlock
...
// 6277: decl @lune.@base.@convGo.convFilter.processProvide
...
// 6283: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(_env *LnsEnv, node *Nodes_AliasNode,_opt LnsAny) {
}
// 6288: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 6294: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 6300: decl @lune.@base.@convGo.convFilter.processTupleConst
...
// 6312: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 6325: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 6339: decl @lune.@base.@convGo.convFilter.processLiteralMap
...
// 6367: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 6381: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
// 6387: decl @lune.@base.@convGo.convFilter.processLiteralInt
...
// 6393: decl @lune.@base.@convGo.convFilter.processLiteralReal
func (self *convGo_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 6399: decl @lune.@base.@convGo.convFilter.processLiteralString
...
// 6440: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 6476: decl @lune.@base.@convGo.convFilter.processAbbr
...
// 2075: decl @lune.@base.@convGo.ConvRunner.run
...
// 2087: decl @lune.@base.@convGo.ConvRunner.getResult
