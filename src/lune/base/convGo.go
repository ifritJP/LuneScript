...
// for 2234
func convGo_convExp2_5673(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
...
// 3904: decl @lune.@base.@convGo.getLnsItemKind
...
// 6170: decl @lune.@base.@convGo.createFilter
...
// 5528: decl @lune.@base.@convGo.convFilter.processAndOr.isAndOr
...
func (self *convGo_convFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    var modulePath string
    modulePath = convGo_convExp2_5673(Lns_2DDD(_env.GetVM().String_gsub(node.FP.Get_moduleTypeInfo(_env).FP.GetFullName(_env, self.FP.Get_typeNameCtrl(_env), self.FP.Get_moduleInfoManager(_env), nil),"@", "")))
...
// 3527: decl @lune.@base.@convGo.convFilter.processWhile
...
// 3541: decl @lune.@base.@convGo.convFilter.processRepeat
...
// 3559: decl @lune.@base.@convGo.convFilter.processFor
...
// 3625: decl @lune.@base.@convGo.convFilter.processApply
...
// 3701: decl @lune.@base.@convGo.convFilter.outputForeachLua
...
// 3794: decl @lune.@base.@convGo.convFilter.processForeach
...
// 3912: decl @lune.@base.@convGo.convFilter.processForsort
...
// 3997: decl @lune.@base.@convGo.convFilter.processExpUnwrap
...
// 4013: decl @lune.@base.@convGo.convFilter.processExpToDDD
...
// 4025: decl @lune.@base.@convGo.convFilter.processExpNew
...
// 4053: decl @lune.@base.@convGo.convFilter.outputIFMethods
...
// 4095: decl @lune.@base.@convGo.convFilter.outputMethodIF
...
// 4105: decl @lune.@base.@convGo.convFilter.outputInterfaceType
...
// 4128: decl @lune.@base.@convGo.convFilter.outputClassType
...
// 4166: decl @lune.@base.@convGo.convFilter.outputToStem
...
// 4184: decl @lune.@base.@convGo.convFilter.outputDownCast
...
// 4210: decl @lune.@base.@convGo.convFilter.outputCastReceiver
...
// 4225: decl @lune.@base.@convGo.convFilter.outputNewSetup
...
// 4250: decl @lune.@base.@convGo.convFilter.outputConstructor
...
// 4346: decl @lune.@base.@convGo.convFilter.outputAccessor
func (self *convGo_convFilter) OutputAccessor(_env *LnsEnv, node *Nodes_DeclClassNode) {
    ...
    for _, _memberNode := range( node.FP.Get_memberList(_env).Items ) {
        ...
        if memberNode.FP.Get_getterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, getterName)})/* 4360:33 */)).(*Ast_SymbolInfo)
        ...
        if memberNode.FP.Get_setterMode(_env) != Ast_AccessMode__None{
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, setterName)})/* 4401:33 */)).(*Ast_SymbolInfo)
...
// 4410: decl @lune.@base.@convGo.convFilter.outputStaticMember
...
// 4442: decl @lune.@base.@convGo.convFilter.getFromStemName
...
// 4469: decl @lune.@base.@convGo.convFilter.outputConvItemType
...
// 4494: decl @lune.@base.@convGo.convFilter.outputConvItemTypeList
...
// 4514: decl @lune.@base.@convGo.convFilter.outputAlter2MapFunc
...
// 4533: decl @lune.@base.@convGo.convFilter.outputAsyncItem
...
// 4544: decl @lune.@base.@convGo.convFilter.outputMapping
...
// 4672: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethod
...
// 4684: decl @lune.@base.@convGo.convFilter.outputDummyAbstractMethodOfClass
...
// 4717: decl @lune.@base.@convGo.convFilter.outputAdvertise
...
// 4766: decl @lune.@base.@convGo.convFilter.processProtoClass
func (self *convGo_convFilter) ProcessProtoClass(_env *LnsEnv, node *Nodes_ProtoClassNode,_opt LnsAny) {
}
// 4771: decl @lune.@base.@convGo.convFilter.processDeclClass
...
// 4869: decl @lune.@base.@convGo.convFilter.outputCallPrefix
...
// 5063: decl @lune.@base.@convGo.convFilter.processExpCall
...
// 5314: decl @lune.@base.@convGo.convFilter.processExpMRet
...
// 5321: decl @lune.@base.@convGo.convFilter.processExpAccessMRet
func (self *convGo_convFilter) ProcessExpAccessMRet(_env *LnsEnv, node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
}
// 5329: decl @lune.@base.@convGo.convFilter.processExpList
...
// 5353: decl @lune.@base.@convGo.convFilter.processExpOp1
...
// 5401: decl @lune.@base.@convGo.convFilter.processExpMultiTo1
...
// 5413: decl @lune.@base.@convGo.convFilter.processExpCast
...
// 5473: decl @lune.@base.@convGo.convFilter.processExpParen
...
// 5490: decl @lune.@base.@convGo.convFilter.processExpSetVal
...
// 5507: decl @lune.@base.@convGo.convFilter.processExpSetItem
...
// 5525: decl @lune.@base.@convGo.convFilter.processAndOr
...
// 5586: decl @lune.@base.@convGo.convFilter.processExpOp2
...
// 5631: decl @lune.@base.@convGo.convFilter.processExpRef
...
// 5684: decl @lune.@base.@convGo.convFilter.processExpRefItem
...
// 5795: decl @lune.@base.@convGo.convFilter.processRefField
...
// 5883: decl @lune.@base.@convGo.convFilter.processExpOmitEnum
...
// 5889: decl @lune.@base.@convGo.convFilter.processGetField
...
// 5938: decl @lune.@base.@convGo.convFilter.processReturn
...
// 5948: decl @lune.@base.@convGo.convFilter.processTestCase
...
// 5963: decl @lune.@base.@convGo.convFilter.processTestBlock
...
// 5975: decl @lune.@base.@convGo.convFilter.processProvide
...
// 5981: decl @lune.@base.@convGo.convFilter.processAlias
func (self *convGo_convFilter) ProcessAlias(_env *LnsEnv, node *Nodes_AliasNode,_opt LnsAny) {
}
// 5986: decl @lune.@base.@convGo.convFilter.processBoxing
...
// 5992: decl @lune.@base.@convGo.convFilter.processUnboxing
...
// 5998: decl @lune.@base.@convGo.convFilter.processLiteralList
...
// 6011: decl @lune.@base.@convGo.convFilter.processLiteralSet
...
// 6025: decl @lune.@base.@convGo.convFilter.processLiteralMap
...
// 6053: decl @lune.@base.@convGo.convFilter.processLiteralArray
...
// 6067: decl @lune.@base.@convGo.convFilter.processLiteralChar
...
// 6073: decl @lune.@base.@convGo.convFilter.processLiteralInt
...
// 6079: decl @lune.@base.@convGo.convFilter.processLiteralReal
func (self *convGo_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 6085: decl @lune.@base.@convGo.convFilter.processLiteralString
...
// 6126: decl @lune.@base.@convGo.convFilter.processLuneControl
...
// 6162: decl @lune.@base.@convGo.convFilter.processAbbr
