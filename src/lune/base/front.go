...
// for 1212: ExpCast
func conv2Form6399( src func (_env *LnsEnv)) LnsForm {
...
// for 1864: ExpCast
func conv2Form9731( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 1983: ExpCast
func conv2Form10128( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 474
func front_convExp2009(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 545
func front_convExp2419(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 564
func front_convExp2513(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 862
func front_convExp4039(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 871
func front_convExp4068(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1395
func front_convExp7342(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1404
func front_convExp7413(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1962
func front_convExp10068(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1982
func front_convExp10148(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 563
func front_convExp2492(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 593
func front_convExp2678(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 594
func front_convExp2697(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 635
func front_convExp2889(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 817
func front_convExp3740(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 855
func front_convExp3971(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1002
func front_convExp4994(arg1 []LnsAny) (string, LnsAny, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 484
func front_convExp2046(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 338
func front_convExp1372(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 359
func front_convExp1505(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 405
func front_convExp1645(arg1 []LnsAny) *AstInfo_ASTInfo {
    return Lns_getFromMulti( arg1, 0 ).(*AstInfo_ASTInfo)
}
// for 422
func front_convExp1730(arg1 []LnsAny) (*AstInfo_ASTInfo, *FrontInterface_ModuleInfo) {
    return Lns_getFromMulti( arg1, 0 ).(*AstInfo_ASTInfo), Lns_getFromMulti( arg1, 1 ).(*FrontInterface_ModuleInfo)
}
// for 488
func front_convExp2071(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 524
func front_convExp2290(arg1 []LnsAny) (string, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 549
func front_convExp2409(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 715
func front_convExp3181(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 742
func front_convExp3334(arg1 []LnsAny) (LnsAny, string, string) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 781
func front_convExp3542(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 786
func front_convExp3587(arg1 []LnsAny) (string, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 808
...
// for 843
func front_convExp3849(arg1 []LnsAny) (string, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 911
func front_convExp4323(arg1 []LnsAny) (*FrontInterface_ModuleMeta, string) {
    return Lns_getFromMulti( arg1, 0 ).(*FrontInterface_ModuleMeta), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 972
func front_convExp4741(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1016
func front_convExp5090(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1025
func front_convExp5150(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1047
func front_convExp5268(arg1 []LnsAny) (*FrontInterface_ModuleMeta, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(*FrontInterface_ModuleMeta), Lns_getFromMulti( arg1, 1 )
}
// for 1084
func front_convExp5519(arg1 []LnsAny) (*AstInfo_ASTInfo, *FrontInterface_ModuleInfo) {
    return Lns_getFromMulti( arg1, 0 ).(*AstInfo_ASTInfo), Lns_getFromMulti( arg1, 1 ).(*FrontInterface_ModuleInfo)
}
// for 1115
func front_convExp5693(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1142
func front_convExp5799(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1168
func front_convExp6108(arg1 []LnsAny) (*FrontInterface_ModuleMeta, string) {
    return Lns_getFromMulti( arg1, 0 ).(*FrontInterface_ModuleMeta), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 1178
func front_convExp6184(arg1 []LnsAny) (*FrontInterface_ModuleMeta, string) {
    return Lns_getFromMulti( arg1, 0 ).(*FrontInterface_ModuleMeta), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 1209
func front_convExp6306(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1229
func front_convExp6420(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1245
func front_convExp6509(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1253
func front_convExp6573(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1261
func front_convExp6634(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1272
func front_convExp6695(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1285
func front_convExp6807(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1344
func front_convExp7055(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1345
func front_convExp7068(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1400
func front_convExp7366(arg1 []LnsAny) (bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(bool), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 1521
func front_convExp7972(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1556
func front_convExp8140(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1563
func front_convExp8200(arg1 []LnsAny) (string, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 1591
func front_convExp8333(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1637
func front_convExp8550(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1661
func front_convExp8625(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1663
func front_convExp8640(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1667
func front_convExp8654(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1668
func front_convExp8670(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1677
func front_convExp8699(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1707
func front_convExp8806(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1708
func front_convExp8820(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1709
func front_convExp8833(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1711
func front_convExp8850(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1831
func front_convExp9311(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1832
func front_convExp9324(arg1 []LnsAny) (*FrontInterface_ModuleId, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(*FrontInterface_ModuleId), Lns_getFromMulti( arg1, 1 )
}
// for 1837
func front_convExp9362(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1969
func front_convExp10092(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1980
func front_convExp10111(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 1997
func front_convExp10209(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
...
// 346: decl @lune.@base.@front.createPaser
...
// 369: decl @lune.@base.@front.getAstFromResult
...
func front_loadFromChunk_14_(_env *LnsEnv, chunk LnsAny,err LnsAny) LnsAny {
    if err != nil{
        err_349 := err.(string)
        Util_errorLog(_env, err_349)
    }
    if chunk != nil{
        chunk_351 := chunk.(*Lns_luaValue)
        {
            _work := front_convExp2009(Lns_2DDD(_env.CommonLuaVM.RunLoadedfunc(chunk_351,Lns_2DDD([]LnsAny{}))[0]))
            if !Lns_IsNil( _work ) {
                work := _work
                return work
            }
...
func Front_loadFromLuaTxt(_env *LnsEnv, txt string) LnsAny {
    return front_loadFromChunk_14_(front_convExp2046(_env, Lns_2DDD(_env.CommonLuaVM.Load(txt, nil))))
}
...
func front_byteCompileFromLuaTxt_16_(_env *LnsEnv, txt string,stripDebugInfo bool) string {
    ...
    if chunk != nil{
        chunk_366 := chunk.(*Lns_luaValue)
        return _env.CommonLuaVM.String_dump(chunk_366, stripDebugInfo)
    }
...
func front_getMetaInfo_19_(_env *LnsEnv, lnsPath string,mod string,outdir LnsAny)(LnsAny, string, string) {
    ...
    if outdir != nil{
        outdir_426 := outdir.(string)
        moduleMetaPath = _env.LuaVM.String_format("%s/%s", []LnsAny{outdir_426, Lns_car(_env.LuaVM.String_gsub(mod,"%.", "/")).(string)})
        
    }
    moduleMetaPath = front_convExp2492(Lns_2DDD(_env.LuaVM.String_gsub(moduleMetaPath,"%.lns$", ".meta")))
...
// 627: decl @lune.@base.@front.getModuleId
func front_getModuleId_20_(_env *LnsEnv, lnsPath string,mod string,outdir LnsAny,metaInfo LnsAny) *FrontInterface_ModuleId {
    ...
    if Lns_op_not(metaInfo){
        metaInfo = front_convExp2889(Lns_2DDD(front_getMetaInfo_19_(_env, lnsPath, mod, outdir)))
        
    }
    if metaInfo != nil{
        metaInfo_474 := metaInfo.(*front_MetaForBuildId)
        var buildId *FrontInterface_ModuleId
        buildId = metaInfo_474.FP.CreateModuleId(_env)
...
// 1284: decl @lune.@base.@front.closeStreams.txt2ModuleId
func closeStreams__txt2ModuleId_0_(_env *LnsEnv, txt string) *FrontInterface_ModuleId {
    var buildIdTxt string
    buildIdTxt = front_convExp6807(Lns_2DDD(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(txt,"^_moduleObj.__buildId = ", "")).(string),"\"", "")))
...
// 1281: decl @lune.@base.@front.closeStreams
func front_closeStreams_22_(_env *LnsEnv, stream LnsAny,metaStream LnsAny,dependStream LnsAny,metaPath string,saveMetaFlag bool) {
    ...
    checkDiff = func(_env *LnsEnv, oldStream *Util_TxtStream,newStream *Util_TxtStream)(bool, string) {
        ...
        for  {
            ...
            if oldLine != nil{
                oldLine_897 := oldLine.(string)
                if len(oldBuildIdLine) == 0{
                    if Lns_isCondTrue( Lns_car(_env.LuaVM.String_find(oldLine_897,"^_moduleObj.__buildId", nil, nil))){
                        oldBuildIdLine = oldLine_897
            ...
            if newLine != nil{
                newLine_901 := newLine.(string)
                if len(newBuildIdLine) == 0{
                    if Lns_isCondTrue( Lns_car(_env.LuaVM.String_find(newLine_901,"^_moduleObj.__buildId", nil, nil))){
                        newBuildIdLine = newLine_901
            ...
            if newLine != oldLine{
                ...
                if newLine != nil && oldLine != nil{
                    newLine_907 := newLine.(string)
                    oldLine_908 := oldLine.(string)
                    if Lns_isCondTrue( Lns_car(_env.LuaVM.String_find(oldLine_908,"^_moduleObj.__buildId", nil, nil))){
                        if Lns_isCondTrue( Lns_car(_env.LuaVM.String_find(newLine_907,"^_moduleObj.__buildId", nil, nil))){
                        ...
                        _env.SetStackVal( Lns_car(_env.LuaVM.String_find(oldLine_908,"^__dependModuleMap.*buildId =", nil, nil))) &&
                        _env.SetStackVal( Lns_car(_env.LuaVM.String_find(newLine_907,"^__dependModuleMap.*buildId =", nil, nil))) )){
                        var oldSub string
                        oldSub = front_convExp7055(Lns_2DDD(_env.LuaVM.String_gsub(oldLine_908,"buildId =.*", "")))
                        var newSub string
                        newSub = front_convExp7068(Lns_2DDD(_env.LuaVM.String_gsub(newLine_907,"buildId =.*", "")))
                        if oldSub == newSub{
                            cont = true
                ...
                if Lns_op_not(cont){
                    Log_log(_env, Log_Level__Debug, __func__, 1352, Log_CreateMessage(func(_env *LnsEnv) string {
    ...
    if stream != nil{
        stream_928 := stream.(Lns_oStream)
        stream_928.Close(_env)
    }
    if dependStream != nil{
        dependStream_930 := dependStream.(Lns_oStream)
        dependStream_930.Close(_env)
    }
    if metaStream != nil{
        metaStream_932 := metaStream.(*Util_memStream)
        if saveMetaFlag{
            var newMetaTxt string
            newMetaTxt = metaStream_932.FP.Get_txt(_env)
            var oldMetaTxt string
            oldMetaTxt = ""
            {
                _oldFileObj := front_convExp7342(Lns_2DDD(Lns_io_open(metaPath, nil)))
            ...
            saveMeta = func(_env *LnsEnv, meta string) {
                {
                    _fileObj := front_convExp7413(Lns_2DDD(Lns_io_open(metaPath, "w")))
...
func front_outputDependInfo_24_(_env *LnsEnv, stream LnsAny,metaInfo *front_MetaForBuildId,mod string) {
    if stream != nil{
        ...
        dependInfo.FP.Output(_env, stream_1019)
    }
}



// 1809: decl @lune.@base.@front.convertLnsCode2LuaCode
...
// 1909: decl @lune.@base.@front.build
...
// 2027: decl @lune.@base.@front.exec
...
// 2046: decl @lune.@base.@front.setFront
...
// 2051: decl @lune.@base.@front.__main
...
func (self *front_AstCreater) Initfront_AstCreater(_env *LnsEnv, importModuleInfo *FrontInterface_ImportModuleInfo,parserSrc LnsAny,mod string,baseDir LnsAny,moduleId *FrontInterface_ModuleId,analyzeModule LnsAny,analyzeMode LnsInt,pos LnsAny,builtinFunc *Builtin_BuiltinFuncType,option *Option_Option) {
    ...
    self.converter = front_ConverterFunc_6_(func(_env *LnsEnv) {
        ...
        Log_log(_env, Log_Level__Log, __func__, 212, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 220: decl @lune.@base.@front.AstCreater.runMain
func (self *front_AstCreater) RunMain(_env *LnsEnv) {
    self.converter(_env)
}

// 225: decl @lune.@base.@front.AstCreater.getAst
...
func (self *front_Front) Initfront_Front(_env *LnsEnv, option *Option_Option,bindModuleList LnsAny) {
    ...
    if bindModuleList != nil{
        bindModuleList_178 := bindModuleList.(*LnsList)
        for _, _mod := range( bindModuleList_178.Items ) {
            mod := _mod.(string)
...
// 305: decl @lune.@base.@front.Front.getLoadInfo
...
// 312: decl @lune.@base.@front.Front.setLoadInfo
...
// 331: decl @lune.@base.@front.Front.error
...
// 337: decl @lune.@base.@front.Front.loadLua
func (self *front_Front) loadLua(_env *LnsEnv, path string) LnsAny {
    var chunk LnsAny
    var err LnsAny
    chunk,err = _env.CommonLuaVM.Loadfile(path)
    if chunk != nil{
        chunk_243 := chunk.(*Lns_luaValue)
        return Lns_unwrap( Lns_car(_env.CommonLuaVM.RunLoadedfunc(chunk_243,Lns_2DDD([]LnsAny{}))[0]))
    }
    Util_errorLog(_env, Lns_unwrapDefault( err, _env.LuaVM.String_format("load error -- %s.", []LnsAny{path})).(string))
    return nil
}

// 352: decl @lune.@base.@front.Front.scriptPath2Module
...
func (self *front_Front) createAstSub(_env *LnsEnv, importModuleInfo *FrontInterface_ImportModuleInfo,parserSrc LnsAny,baseDir LnsAny,mod string,moduleId *FrontInterface_ModuleId,analyzeModule LnsAny,analyzeMode LnsInt,pos LnsAny) LnsAny {
    ...
    }
    {
        ...
        if !Lns_IsNil( _creater ) {
            ...
            var ast *AstInfo_ASTInfo
            ast = front_convExp1645(Lns_2DDD(creater.FP.getAst(_env)))
            return &front_CreateAstResult__Ast{ast}
        }
    }
...
// 416: decl @lune.@base.@front.Front.applyAstResult
...
// 432: decl @lune.@base.@front.Front.createAst
...
func (self *front_Front) searchModuleFile(_env *LnsEnv, mod string,suffix string,baseDir LnsAny,outputDir LnsAny) LnsAny {
    ...
    if outputDir != nil{
        outputDir_444 := outputDir.(string)
        lnsSearchPath = _env.LuaVM.String_format("%s/?%s;%s", []LnsAny{outputDir_444, suffix, Lns_package_path})
        
    }
    if baseDir != nil{
        baseDir_446 := baseDir.(string)
        lnsSearchPath = _env.LuaVM.String_format("%s/?%s;%s", []LnsAny{baseDir_446, suffix, Lns_package_path})
    ...
    lnsSearchPath = front_convExp2678(Lns_2DDD(_env.LuaVM.String_gsub(lnsSearchPath,"%.lua$", suffix)))
    
    lnsSearchPath = front_convExp2697(Lns_2DDD(_env.LuaVM.String_gsub(lnsSearchPath,"%.lua;", suffix + ";")))
        ...
        if _foundPath == nil{
            ...
            latestProjSearchPath = Util_pathJoin(_env, latestProjRoot, "?" + suffix)
            {
                ...
                if !Lns_IsNil( __exp ) {
                    ...
                    Log_log(_env, Log_Level__Err, __func__, 606, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 667: decl @lune.@base.@front.Front.getModuleIdAndCheckUptodate
func (self *front_Front) getModuleIdAndCheckUptodate(_env *LnsEnv, lnsPath string,mod string)(*FrontInterface_ModuleId, LnsAny) {
    ...
    checkDependUptodate = func(_env *LnsEnv, metaTime LnsReal,metaInfo *front_MetaForBuildId,metaCode string) LnsAny {
        ...
        for _depMod, _dependItem := range( metaInfo.G__dependModuleMap.Items ) {
            ...
            
            {
                ...
                if _modMetaPath == nil{
                    Log_log(_env, Log_Level__Debug, __func__, 703, Log_CreateMessage(Front_getModuleIdAndCheckUptodate_checkDependUptodate___anonymous_0_))
            ...
            
            {
                ...
                if _time == nil{
                    Log_log(_env, Log_Level__Debug, __func__, 708, Log_CreateMessage(Front_getModuleIdAndCheckUptodate_checkDependUptodate___anonymous_1_))
            ...
            if time > metaTime{
                ...
                {
                    _dependMeta := front_convExp3181(Lns_2DDD(front_MetaForBuildId_LoadFromMeta_5_(_env, modMetaPath)))
                    if _dependMeta == nil{
                        Log_log(_env, Log_Level__Debug, __func__, 716, Log_CreateMessage(Front_getModuleIdAndCheckUptodate_checkDependUptodate___anonymous_2_))
                ...
                if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                    ...
                    Log_log(_env, Log_Level__Debug, __func__, 726, Log_CreateMessage(func(_env *LnsEnv) string {
    ...
    if metaInfo != nil{
        metaInfo_529 := metaInfo.(*front_MetaForBuildId)
        if metaInfo_529.G__enableTest == self.option.Testing{
            var buildId *FrontInterface_ModuleId
            buildId = FrontInterface_ModuleId_createIdFromTxt(_env, metaInfo_529.G__buildId)
            if buildId != FrontInterface_ModuleId__tempId{
                ...
                if lnsTime != nil && metaTime != nil{
                    lnsTime_536 := lnsTime.(LnsReal)
                    metaTime_537 := metaTime.(LnsReal)
                    if lnsTime_536 == buildId.FP.Get_modTime(_env){
                        uptodate = checkDependUptodate(_env, metaTime_537, metaInfo_529, metaCode)
        ...
        Log_log(_env, Log_Level__Debug, __func__, 764, Log_CreateMessage(Front_getModuleIdAndCheckUptodate___anonymous_1_))
...
// 777: decl @lune.@base.@front.Front.convertLns2LuaCode
func (self *front_Front) ConvertLns2LuaCode(_env *LnsEnv, importModuleInfo *FrontInterface_ImportModuleInfo,parserSrc LnsAny,baseDir LnsAny,stream Lns_iStream,streamName string) string {
    var mod string
    mod = front_convExp3542(Lns_2DDD(self.FP.scriptPath2Module(_env, streamName)))
    var ast *AstInfo_ASTInfo
...
// 791: decl @lune.@base.@front.Front.getGoAppName
...
// 798: decl @lune.@base.@front.Front.createGoOption
    ...
    var packageName string
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            if Lns_op_not(Lns_car(_env.LuaVM.String_find(scriptPath,"/", nil, nil))){
                ...
                parentPath = front_convExp3683(Lns_2DDD(_env.LuaVM.String_gsub(Lns_car(_env.LuaVM.String_gsub(scriptPath,"/[^/]+$", "")).(string),".*/", "")))
                if len(parentPath) == 0{
                    packageName = "main"
                    ...
                    packageName = front_convExp3740(Lns_2DDD(_env.LuaVM.String_gsub(parentPath,"[^%w]", "")))
...
// 833: decl @lune.@base.@front.Front.loadParserToLuaCode
func (self *front_Front) loadParserToLuaCode(_env *LnsEnv, importModuleInfo *FrontInterface_ImportModuleInfo,parserSrc LnsAny,path string,mod string,baseDir LnsAny)(*FrontInterface_ModuleMeta, string) {
    ...
    Log_log(_env, Log_Level__Trace, __func__, 844, Log_CreateMessage(func(_env *LnsEnv) string {
        ...
        saveFile = func(_env *LnsEnv, suffix string,txt string,byteCompile bool,stripDebugInfo bool,checkUpdate bool) {
            ...
            newpath = ""
            {
                ...
                if !Lns_IsNil( _dir ) {
                    ...
                    newpath = front_convExp3971(Lns_2DDD(_env.LuaVM.String_gsub(path,".lns$", suffix)))
            ...
            if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                ...
                {
                    _fileObj := front_convExp4039(Lns_2DDD(Lns_io_open(newpath, nil)))
                    if !Lns_IsNil( _fileObj ) {
                        fileObj := _fileObj.(Lns_luaStream)
                        var oldTxt LnsAny
            ...
            {
                _fileObj := front_convExp4068(Lns_2DDD(Lns_io_open(newpath, "w")))
                if !Lns_IsNil( _fileObj ) {
                    fileObj := _fileObj.(Lns_luaStream)
...
// 905: decl @lune.@base.@front.Front.loadFile
func (self *front_Front) loadFile(_env *LnsEnv, importModuleInfo *FrontInterface_ImportModuleInfo,baseDir LnsAny,path string,mod string)(*FrontInterface_ModuleMeta, LnsAny) {
    ...
    Log_log(_env, Log_Level__Info, __func__, 909, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 922: decl @lune.@base.@front.Front.searchModule
...
// 926: decl @lune.@base.@front.Front.searchLuaFile
...
// 938: decl @lune.@base.@front.Front.checkUptodateMeta
func (self *front_Front) checkUptodateMeta(_env *LnsEnv, lnsPath string,metaPath string,baseDir LnsAny,addSearchPath LnsAny) LnsAny {
    ...
    
    {
        ...
        if _metaObj == nil{
            Log_log(_env, Log_Level__Warn, __func__, 943, Log_CreateMessage(func(_env *LnsEnv) string {
                    ...
                    moduleLnsPath := _moduleLnsPath.(string)
                    {
                        ...
                        if !Lns_IsNil( _moduleLuaPath ) {
                            ...
                            if Lns_op_not(Util_getReadyCode(_env, moduleLnsPath, metaPath)){
                                Log_log(_env, Log_Level__Warn, __func__, 968, Log_CreateMessage(func(_env *LnsEnv) string {
                            ...
                            var moduleMetaPath string
                            moduleMetaPath = front_convExp4741(Lns_2DDD(_env.LuaVM.String_gsub(moduleLuaPath,"%.lua$", ".meta")))
                            if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                            ...
                            Log_log(_env, Log_Level__Warn, __func__, 981, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 999: decl @lune.@base.@front.Front.loadModule
            ...
            if !Lns_IsNil( _luaTxt ) {
            ...
            } else {
                {
                    ...
                    if !Lns_IsNil( _lnsPath ) {
                        ...
                        var luaPath LnsAny
                        luaPath = front_convExp5090(Lns_2DDD(_env.LuaVM.String_gsub(lnsPath, "%.lns$", ".lua")))
                        {
                            _dir := self.option.OutputDir
                            if !Lns_IsNil( _dir ) {
                                dir := _dir.(string)
                        ...
                        loadVal = nil
                        if luaPath != nil{
                            luaPath_712 := luaPath.(string)
                            if Util_getReadyCode(_env, lnsPath, luaPath_712){
                                var metaPath string
                                metaPath = front_convExp5150(Lns_2DDD(_env.LuaVM.String_gsub(luaPath_712, "%.lua$", ".meta")))
                                if Util_getReadyCode(_env, lnsPath, metaPath){
                                    {
                                        ...
                                        if !Lns_IsNil( _preLoadInfo ) {
                                            ...
                                            loadVal = self.FP.loadLua(_env, luaPath_712)
...
// 1075: decl @lune.@base.@front.Front.getLuaModulePath
...
// 1079: decl @lune.@base.@front.Front.loadMeta
            ...
            } else {
                {
                    ...
                    if !Lns_IsNil( _lnsPath ) {
                        ...
                        if Lns_op_not(self.targetSet.Has(orgMod)){
                            var luaPath LnsAny
                            luaPath = front_convExp5693(Lns_2DDD(_env.LuaVM.String_gsub(lnsPath, "%.lns$", ".lua")))
                            ...
                            if luaPath != nil{
                                ...
                                if Lns_op_not(forceFlag){
                                    if Util_getReadyCode(_env, lnsPath, luaPath_773){
                                        var metaPath string
                                        metaPath = front_convExp5799(Lns_2DDD(_env.LuaVM.String_gsub(luaPath_773, "%.lua$", ".meta")))
                                        if Util_getReadyCode(_env, lnsPath, metaPath){
                                            meta = self.FP.checkUptodateMeta(_env, lnsPath, metaPath, baseDir, self.option.OutputDir)
                                            
                                        } else { 
                                            Log_log(_env, Log_Level__Warn, __func__, 1147, Log_CreateMessage(func(_env *LnsEnv) string {
                                                return _env.LuaVM.String_format("%s not ready meta %s, %s", []LnsAny{orgMod, lnsPath, metaPath})
                                            }))
                                            
                                        }
                                    } else { 
                                        Log_log(_env, Log_Level__Warn, __func__, 1151, Log_CreateMessage(func(_env *LnsEnv) string {
                                            return _env.LuaVM.String_format("%s not ready lua %s, %s", []LnsAny{orgMod, lnsPath, luaPath_773})
                                        }))
                        ...
                        if meta != nil{
                            meta_797 := meta.(*FrontInterface_ModuleMeta)
                            self.moduleMgr.FP.AddMeta(_env, orgMod, meta_797)
                        } else {
...
// 1194: decl @lune.@base.@front.Front.dumpTokenize
...
// 1226: decl @lune.@base.@front.Front.format
...
// 1242: decl @lune.@base.@front.Front.checkDiag
...
// 1252: decl @lune.@base.@front.Front.complete
...
// 1260: decl @lune.@base.@front.Front.inquire
...
// 1269: decl @lune.@base.@front.Front.createGlue
...
// 1552: decl @lune.@base.@front.Front.convertToLua
...
// 1651: decl @lune.@base.@front.Front.saveToGo
...
// 1660: decl @lune.@base.@front.Front.saveToC
func (self *front_Front) SaveToC(_env *LnsEnv, scriptPath string,ast *AstInfo_ASTInfo) {
    var cPath string
    cPath = front_convExp8625(Lns_2DDD(_env.LuaVM.String_gsub(scriptPath,"%.lns$", ".c")))
    var file Lns_luaStream
    
    {
        _file := front_convExp8640(Lns_2DDD(Lns_io_open(cPath, "w")))
        if _file == nil{
            return 
        } else {
    ...
    var hPath string
    hPath = front_convExp8654(Lns_2DDD(_env.LuaVM.String_gsub(scriptPath,"%.lns$", ".h")))
    var hFile Lns_luaStream
    
    {
        _hFile := front_convExp8670(Lns_2DDD(Lns_io_open(hPath, "w")))
        if _hFile == nil{
            return 
        } else {
...
// 1676: decl @lune.@base.@front.Front.outputBuiltin
...
// 1698: decl @lune.@base.@front.Front.saveToLua
func (self *front_Front) saveToLua(_env *LnsEnv, updateInfo *front_UpdateInfo) LnsAny {
    ...
    mod,baseDir = self.FP.scriptPath2Module(_env, scriptPath)
    var luaPath string
    luaPath = front_convExp8820(Lns_2DDD(_env.LuaVM.String_gsub(scriptPath,"%.lns$", ".lua")))
    var metaPath string
    metaPath = front_convExp8833(Lns_2DDD(_env.LuaVM.String_gsub(scriptPath,"%.lns$", ".meta")))
    if Lns_isCondTrue( self.option.OutputDir){
        var filename string
        filename = front_convExp8850(Lns_2DDD(_env.LuaVM.String_gsub(mod,"%.", "/")))
    ...
    case *front_ModuleUptodate__NeedUpdate:
        ...
        return front_ConverterFunc_6_(func(_env *LnsEnv) {
            ...
            Lns_NilAccCall0( _env, func () {_env.NilAccPop().(*front_GoConverter).FP.saveGo(_env)})/* 1761:13 */)
        })
...
// 1791: decl @lune.@base.@front.Front.outputBootC
func (self *front_Front) outputBootC(_env *LnsEnv, scriptPath string) {
}

// 1829: decl @lune.@base.@front.Front.build
func (self *front_Front) Build(_env *LnsEnv, buildMode LnsAny,astCallback LnsAny) {
    ...
    createUpdateInfo = func(_env *LnsEnv, scriptPath string,dependsPath LnsAny) *front_UpdateInfo {
        var mod string
        mod = front_convExp9311(Lns_2DDD(self.FP.scriptPath2Module(_env, scriptPath)))
        var moduleId *FrontInterface_ModuleId
        var uptodate LnsAny
    ...
    Depend_profile(_env, self.option.ValidProf, conv2Form9731(func(_env *LnsEnv) {
        ...
        if astCallback != nil{
            astCallback_1225 := astCallback.(Front_AstCallback)
...
// 1914: decl @lune.@base.@front.Front.exec
func (self *front_Front) Exec(_env *LnsEnv) {
    __func__ := "@lune.@base.@front.Front.exec"
    Log_log(_env, Log_Level__Trace, __func__, 1916, Log_CreateMessage(func(_env *LnsEnv) string {
    ...
    if _switch1 := self.option.Mode; _switch1 == Option_ModeKind__Token {
        ...
        {
            _modObj := front_convExp10068(Lns_2DDD(self.FP.LoadModule(_env, Lns_car(self.FP.scriptPath2Module(_env, self.option.ScriptPath)).(string))))
        ...
        _ = front_convExp10092(Lns_2DDD(self.FP.LoadModule(_env, Lns_car(self.FP.scriptPath2Module(_env, self.option.ScriptPath)).(string))))
        if self.option.Testing{
            var code string
            ...
            if loaded != nil{
                loaded_1269 := loaded.(*Lns_luaValue)
                {
                    _mod := front_convExp10148(Lns_2DDD(_env.CommonLuaVM.RunLoadedfunc(loaded_1269,Lns_2DDD([]LnsAny{}))[0]))
                    if !Lns_IsNil( _mod ) {
                        mod := _mod
        ...
        var mod string
        mod = front_convExp10209(Lns_2DDD(self.FP.scriptPath2Module(_env, self.option.ScriptPath)))
        {
...
func front_MetaForBuildId_LoadFromMeta_5_(_env *LnsEnv, metaPath string)(LnsAny, LnsAny) {
    {
        _fileObj := front_convExp2419(Lns_2DDD(Lns_io_open(metaPath, nil)))
        if !Lns_IsNil( _fileObj ) {
            fileObj := _fileObj.(Lns_luaStream)
            var luaCode LnsAny
            ...
            fileObj.Close(_env)
            if luaCode != nil{
                luaCode_416 := luaCode.(string)
                var meta LnsAny
                meta = front_convExp2409(Lns_2DDD(front_MetaForBuildId__fromStem_4_(_env, _env.CommonLuaVM.ExpandLuavalMap(Front_loadFromLuaTxt(_env, luaCode_416)),nil)))
                return meta, luaCode_416
            }
        }
    }
    return nil, nil
...
// 1490: decl @lune.@base.@front.LuaConverter.runMain
func (self *front_LuaConverter) RunMain(_env *LnsEnv) {
    self.converterFunc(_env)
}

// 1494: decl @lune.@base.@front.LuaConverter.saveLua
func (self *front_LuaConverter) SaveLua(_env *LnsEnv) {
    ...
    {
        _streamDst := front_convExp7972(Lns_2DDD(Lns_io_open(self.luaPath, "w")))
        if _streamDst == nil{
    ...
    if dependsStreamDst != nil{
        dependsStreamDst_1011 := dependsStreamDst.(Lns_oStream)
        dependsStreamDst_1011.Write(_env, Lns_unwrap( dependTxt).(string))
    }
...
func (self *front_GoConverter) Initfront_GoConverter(_env *LnsEnv, scriptPath string,astResult LnsAny,option *Option_Option,goOpt *ConvGo_Option) {
    ...
    var path string
    path = front_convExp8333(Lns_2DDD(_env.LuaVM.String_gsub(scriptPath,"%.lns$", ".go")))
    {
...
// 1625: decl @lune.@base.@front.GoConverter.runMain
func (self *front_GoConverter) RunMain(_env *LnsEnv) {
    self.converter(_env)
}

// 1629: decl @lune.@base.@front.GoConverter.saveGo
func (self *front_GoConverter) saveGo(_env *LnsEnv) {
    ...
    {
        _file := front_convExp8550(Lns_2DDD(Lns_io_open(self.path, "w")))
        if _file == nil{
            return 
        } else {
            file = _file.(Lns_luaStream)
