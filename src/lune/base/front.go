...
// for 1484: ExpCast
func conv2Form7682( src func ()) LnsForm {
    return func (argList []LnsAny) []LnsAny {
        src()
        return []LnsAny{}
    }
...
// for 1529: ExpCast
func conv2Form7787( src func ()) LnsForm {
    return func (argList []LnsAny) []LnsAny {
        src()
        return []LnsAny{}
    }
...
// for 1259
func front_convExp6496(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1305
func front_convExp6691(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1319
...
// for 1509
func front_convExp7730(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1528
func front_convExp7804(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 280
...
// for 1419
func front_convExp7193(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1423
...
// for 1424
func front_convExp7235(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1425
func front_convExp7251(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 266
...
// for 1026
func front_convExp5301(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1031
func front_convExp5339(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1058
func front_convExp5466(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1060
func front_convExp5481(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1064
func front_convExp5495(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1065
func front_convExp5511(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1108
func front_convExp5717(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1167
func front_convExp5968(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1168
...
// for 1209
func front_convExp6218(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1210
func front_convExp6231(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1212
...
// for 1244
func front_convExp6406(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1355
func front_convExp6889(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1356
func front_convExp6920(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1391
func front_convExp7108(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1413
func front_convExp7126(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1414
func front_convExp7146(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1418
func front_convExp7172(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1516
func front_convExp7751(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
func front_loadFromChunk_1114_(chunk LnsAny,err LnsAny) LnsAny {
    if err != nil{
        err_5831 := err.(string)
        Util_errorLog(err_5831)
    }
    if chunk != nil{
        chunk_5833 := chunk.(*Lns_luaValue)
        {
            _work := front_convExp773(Lns_2DDD(Lns_getVM().RunLoadedfunc(chunk_5833,Lns_2DDD([]LnsAny{}))[0]))
            if _work != nil {
                work := _work
                return work
            }
...
func front_byteCompileFromLuaTxt_1120_(txt string,stripDebugInfo bool) string {
    ...
    if chunk != nil{
        chunk_5848 := chunk.(*Lns_luaValue)
        return Lns_getVM().String_dump(chunk_5848, stripDebugInfo)
    }
...
func front_getMetaInfo_1186_(lnsPath string,mod string,outdir LnsAny)(LnsAny, string, string) {
    ...
    if outdir != nil{
        outdir_5909 := outdir.(string)
        moduleMetaPath = Lns_getVM().String_format("%s/%s", []LnsAny{outdir_5909, Lns_car(Lns_getVM().String_gsub(mod,"%.", "/")).(string)})
...
func front_getModuleId_1192_(lnsPath string,mod string,outdir LnsAny,metaInfo LnsAny) *FrontInterface_ModuleId {
    ...
    if metaInfo != nil{
        metaInfo_5939 := metaInfo.(*front_MetaForBuildId)
        var buildId *FrontInterface_ModuleId
        buildId = metaInfo_5939.FP.CreateModuleId()
...
func Front_convertToLua___anonymous_1346_(stream LnsAny,metaStream LnsAny,dependStream LnsAny) {
    if dependStream != nil{
        dependStream_6357 := dependStream.(Lns_oStream)
        dependStream_6357.Close()
    }
}
// 1107: decl @lune.@base.@front.Front.saveToLua.txt2ModuleId
func Front_saveToLua__txt2ModuleId_1387_(txt string) *FrontInterface_ModuleId {
    var buildIdTxt string
    buildIdTxt = front_convExp5717(Lns_2DDD(Lns_getVM().String_gsub(Lns_car(Lns_getVM().String_gsub(txt,"^_moduleObj.__buildId = ", "")).(string),"\"", "")))
...
// 1369: decl @lune.@base.@front.convertLnsCode2LuaCode
...
// 1382: decl @lune.@base.@front.outputGoMain
func front_outputGoMain_1416_(scriptPath string,testing bool,path LnsAny) LnsAny {
    ...
    {
        _fileObj := front_convExp7108(Lns_2DDD(Lns_io_open(lune_path, "w")))
        if _fileObj == nil{
    ...
    var mainMod string
    mainMod = front_convExp7126(Lns_2DDD(Lns_getVM().String_gsub(mod,".*%.", "")))
    var code string
    code = front_convExp7146(Lns_2DDD(Lns_getVM().String_gsub(base_mainCode,"Lns_init", Lns_getVM().String_format("Lns_%s_init", []LnsAny{mainMod}))))
    if mod != mainMod{
        var importPath string
        importPath = front_convExp7172(Lns_2DDD(Lns_getVM().String_gsub(Lns_car(Lns_getVM().String_gsub(mod,"%.[^%.]+$", "")).(string),"%.", "/")))
        code = front_convExp7193(Lns_2DDD(Lns_getVM().String_gsub(code,"//IMPORT_MAIN:", Lns_getVM().String_format("import . \"%s\"", []LnsAny{importPath}))))
        
    }
    if testing{
        code = front_convExp7213(Lns_2DDD(Lns_getVM().String_gsub(code,"//TEST:", "")))
        
        code = front_convExp7235(Lns_2DDD(Lns_getVM().String_gsub(code,"run%( \"\" %)", Lns_getVM().String_format("run( \"lune.base.%s\" )", []LnsAny{mainMod}))))
        
        code = front_convExp7251(Lns_2DDD(Lns_getVM().String_gsub(code,"//IMPORT:", "import . \"github.com/ifritJP/LuneScript/src/lune/base\"")))
...
// 1555: decl @lune.@base.@front.exec
...
func (self *front_Front) loadLua(path string) LnsAny {
    ...
    if chunk != nil{
        chunk_5783 := chunk.(*Lns_luaValue)
        return Lns_unwrap( Lns_car(Lns_getVM().RunLoadedfunc(chunk_5783,Lns_2DDD([]LnsAny{}))[0]))
    }
...
func (self *front_Front) createAst(importModuleInfo *FrontInterface_ImportModuleInfo,parser *Parser_Parser,mod string,moduleId *FrontInterface_ModuleId,analyzeModule LnsAny,analyzeMode TransUnit_AnalyzeMode,pos LnsAny) *TransUnit_ASTInfo {
...
func (self *front_Front) convert(ast *TransUnit_ASTInfo,streamName string,stream Lns_oStream,metaStream Lns_oStream,convMode ConvLua_ConvMode,inMacro bool) {
...
func (self *front_Front) convertFromAst(ast *TransUnit_ASTInfo,streamName string,mode ConvLua_ConvMode)(string, string) {
...
func (self *front_Front) searchModuleFile(mod string,suffix string,addPath LnsAny) LnsAny {
    ...
    if addPath != nil{
        addPath_5922 := addPath.(string)
        lnsSearchPath = Lns_getVM().String_format("%s/?%s;%s", []LnsAny{addPath_5922, suffix, Lns_package_path})
...
func (self *front_Front) getModuleIdAndCheckUptodate(lnsPath string,mod string)(*FrontInterface_ModuleId, LnsAny) {
    ...
    if metaInfo != nil{
        metaInfo_5989 := metaInfo.(*front_MetaForBuildId)
        if metaInfo_5989.G__enableTest == self.option.Testing{
            var buildId *FrontInterface_ModuleId
            buildId = FrontInterface_ModuleId_createIdFromTxt(metaInfo_5989.G__buildId)
            if buildId != FrontInterface_ModuleId__tempId{
                ...
                if lnsTime != nil && metaTime != nil{
                    lnsTime_5996 := lnsTime.(LnsReal)
                    metaTime_5997 := metaTime.(LnsReal)
                    if lnsTime_5996 == buildId.FP.Get_modTime(){
                        uptodate = checkDependUptodate(metaTime_5997, metaInfo_5989, metaCode)
...
// 621: decl @lune.@base.@front.Front.loadModule
            ...
            if _luaTxt != nil {
            ...
            } else {
                {
                    ...
                    if _lnsPath != nil {
                        ...
                        loadVal = nil
                        if luaPath != nil{
                            luaPath_6131 := luaPath.(string)
                            if Util_getReadyCode(lnsPath, luaPath_6131){
                                var metaPath string
                                metaPath = front_convExp3258(Lns_2DDD(Lns_getVM().String_gsub(luaPath_6131, "%.lua$", ".meta")))
                                if Util_getReadyCode(lnsPath, metaPath){
                                    {
                                        ...
                                        if _preLoadInfo != nil {
                                            ...
                                            loadVal = self.FP.loadLua(luaPath_6131)
...
// 680: decl @lune.@base.@front.Front.loadMeta
            ...
            if __exp != nil {
            ...
            } else {
                {
                    ...
                    if _lnsPath != nil {
                        ...
                        meta = nil
                        if luaPath != nil{
                            luaPath_6165 := luaPath.(string)
                            if Util_getReadyCode(lnsPath, luaPath_6165){
                                var metaPath string
                                metaPath = front_convExp3556(Lns_2DDD(Lns_getVM().String_gsub(luaPath_6165, "%.lua$", ".meta")))
                                if Util_getReadyCode(lnsPath, metaPath){
                                    meta = self.FP.checkUptodateMeta(metaPath, self.option.OutputDir)
                                    
                                    if meta != nil{
                                        meta_6170 := meta
                                        self.loadedMetaMap.Set(mod,meta_6170)
                                    }
                                } else { 
                                ...
                                Log_log(Log_Level__Warn, __func__, 710, Log_CreateMessage(func() string {
                                    return Lns_getVM().String_format("%s not ready lua %s, %s", []LnsAny{mod, lnsPath, luaPath_6165})
                                }))
...
// 729: decl @lune.@base.@front.Front.dumpTokenize
...
// 741: decl @lune.@base.@front.Front.dumpAst
...
// 758: decl @lune.@base.@front.Front.format
...
// 771: decl @lune.@base.@front.Front.checkDiag
...
// 781: decl @lune.@base.@front.Front.complete
...
// 789: decl @lune.@base.@front.Front.inquire
...
// 798: decl @lune.@base.@front.Front.createGlue
...
// 831: decl @lune.@base.@front.Front.convertLuaToStreamFromScript
func (self *front_Front) ConvertLuaToStreamFromScript(parser LnsAny,moduleId *FrontInterface_ModuleId,uptodate LnsAny,convMode ConvLua_ConvMode,path string,mod string,byteCompile bool,stripDebugInfo bool,openOStream front_OpenOStreamForConvert_1317_,closeOStream LnsAny) LnsAny {
    var outputDependInfo func(stream LnsAny,metaInfo LnsAny)
    outputDependInfo = func(stream LnsAny,metaInfo LnsAny) {
        if stream != nil{
            stream_6261 := stream.(Lns_oStream)
            if metaInfo != nil{
                metaInfo_6263 := metaInfo.(*front_MetaForBuildId)
                var dependInfo *OutputDepend_DependInfo
                dependInfo = NewOutputDepend_DependInfo(mod)
                for _dependMod, _ := range( metaInfo_6263.G__dependModuleMap.Items ) {
                    dependMod := _dependMod.(string)
                    dependInfo.FP.AddImpotModule(dependMod)
                }
                for _, _subMod := range( metaInfo_6263.G__subModuleMap.Items ) {
                    subMod := _subMod.(string)
                    dependInfo.FP.AddSubMod(subMod)
                }
                dependInfo.FP.Output(stream_6261)
            } else {
    ...
    case *front_ModuleUptodate__NeedUpdate:
        if stream != nil && metaStream != nil{
            stream_6287 := stream.(Lns_oStream)
            metaStream_6288 := metaStream.(Lns_oStream)
            var ast *TransUnit_ASTInfo
            ...
            if dependsStream != nil{
                dependsStream_6291 := dependsStream.(Lns_oStream)
                ast.FP.Get_node().FP.ProcessFilter(OutputDepend_createFilter(dependsStream_6291), 1)
            }
            var outStream Lns_oStream
            outStream = stream_6287
            var oMetaStream Lns_oStream
            oMetaStream = metaStream_6288
            ...
            if byteCompile{
                stream_6287.Write(front_byteCompileFromLuaTxt_1120_(byteStream.FP.Get_txt(), stripDebugInfo))
                if metaStream_6288 != stream_6287{
                    metaStream_6288.Write(front_byteCompileFromLuaTxt_1120_(byteMetaStream.FP.Get_txt(), true))
                }
            }
        } else {
    ...
    metaInfo := _exp4820.Val2
        ...
        if self.option.Mode == Option_ModeKind__SaveMeta{
            if metaStream != nil{
                metaStream_6305 := metaStream.(Lns_oStream)
                metaStream_6305.Write(metaCode)
            } else {
    ...
    if Str_isValidStrBuilder(){
        if streamDst != nil{
            streamDst_6316 := streamDst.(Lns_oStream)
            streamDst_6316.Write(streamMem.FP.Get_txt())
        }
        
        if metaStreamDst != nil{
            metaStreamDst_6318 := metaStreamDst.(Lns_oStream)
            metaStreamDst_6318.Write(metaStreamMem.FP.Get_txt())
        }
        
        if dependsStreamDst != nil{
            dependsStreamDst_6320 := dependsStreamDst.(Lns_oStream)
            dependsStreamDst_6320.Write(dependsStreamMem.FP.Get_txt())
        }
        
    }
    if closeOStream != nil{
        closeOStream_6322 := closeOStream.(front_CloseOStreamForConvert_1320_)
        closeOStream_6322(stream, metaStream, dependsStream)
    }
    return retAst
}

// 960: decl @lune.@base.@front.Front.createGoOption
...
// 986: decl @lune.@base.@front.Front.convertToLua
func (self *front_Front) convertToLua(scriptPath string) {
    ...
    if ast != nil{
        ast_6360 := ast.(*TransUnit_ASTInfo)
        if _switch5274 := self.option.ConvTo; _switch5274 == Types_Lang__Go {
            var conv *Nodes_Filter
            conv = ConvGo_createFilter(self.option.Testing, "stdout", Lns_io_stdout, ast_6360, self.FP.createGoOption(scriptPath))
            ast_6360.FP.Get_node().FP.ProcessFilter(conv, ConvGo_Opt2Stem(NewConvGo_Opt(ast_6360.FP.Get_node())))
        }
    }
}

// 1025: decl @lune.@base.@front.Front.saveToGo
func (self *front_Front) SaveToGo(scriptPath string,ast *TransUnit_ASTInfo) {
    var path string
    path = front_convExp5301(Lns_2DDD(Lns_getVM().String_gsub(scriptPath,"%.lns$", ".go")))
    {
        _dir := self.option.OutputDir
        if _dir != nil {
            dir := _dir.(string)
    ...
    {
        _file := front_convExp5339(Lns_2DDD(Lns_io_open(path, "w")))
        if _file == nil{
            return 
        } else {
...
// 1057: decl @lune.@base.@front.Front.saveToC
func (self *front_Front) SaveToC(scriptPath string,ast *TransUnit_ASTInfo) {
    var cPath string
    cPath = front_convExp5466(Lns_2DDD(Lns_getVM().String_gsub(scriptPath,"%.lns$", ".c")))
    var file Lns_luaStream
    
    {
        _file := front_convExp5481(Lns_2DDD(Lns_io_open(cPath, "w")))
        if _file == nil{
            return 
        } else {
            file = _file.(Lns_luaStream)
    ...
    var hPath string
    hPath = front_convExp5495(Lns_2DDD(Lns_getVM().String_gsub(scriptPath,"%.lns$", ".h")))
    var hFile Lns_luaStream
    
    {
        _hFile := front_convExp5511(Lns_2DDD(Lns_io_open(hPath, "w")))
        if _hFile == nil{
            return 
        } else {
...
// 1077: decl @lune.@base.@front.Front.outputBuiltin
...
// 1099: decl @lune.@base.@front.Front.saveToLua
func (self *front_Front) SaveToLua(updateInfo *front_UpdateInfo) bool {
    ...
    checkDiff = func(oldStream *Parser_TxtStream,newStream *Parser_TxtStream)(bool, string) {
        ...
        for  {
            ...
            if oldLine != nil{
                oldLine_6447 := oldLine.(string)
                if len(oldBuildIdLine) == 0{
                    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(oldLine_6447,"^_moduleObj.__buildId", nil, nil))){
                        oldBuildIdLine = oldLine_6447
            ...
            if newLine != nil{
                newLine_6451 := newLine.(string)
                if len(newBuildIdLine) == 0{
                    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(newLine_6451,"^_moduleObj.__buildId", nil, nil))){
                        newBuildIdLine = newLine_6451
            ...
            if newLine != oldLine{
                ...
                if newLine != nil && oldLine != nil{
                    newLine_6457 := newLine.(string)
                    oldLine_6458 := oldLine.(string)
                    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(oldLine_6458,"^_moduleObj.__buildId", nil, nil))){
                        if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(newLine_6457,"^_moduleObj.__buildId", nil, nil))){
                        ...
                        Lns_GetEnv().SetStackVal( Lns_car(Lns_getVM().String_find(oldLine_6458,"^__dependModuleMap.*buildId =", nil, nil))) &&
                        Lns_GetEnv().SetStackVal( Lns_car(Lns_getVM().String_find(newLine_6457,"^__dependModuleMap.*buildId =", nil, nil))) )){
                        var oldSub string
                        oldSub = front_convExp5968(Lns_2DDD(Lns_getVM().String_gsub(oldLine_6458,"buildId =.*", "")))
                        var newSub string
                        newSub = front_convExp5981(Lns_2DDD(Lns_getVM().String_gsub(newLine_6457,"buildId =.*", "")))
                        if oldSub == newSub{
                            cont = true
                ...
                if Lns_op_not(cont){
                    Log_log(Log_Level__Debug, __func__, 1175, Log_CreateMessage(func() string {
    ...
    mod = Front_scriptPath2Module(scriptPath)
    var luaPath string
    luaPath = front_convExp6218(Lns_2DDD(Lns_getVM().String_gsub(scriptPath,"%.lns$", ".lua")))
    var metaPath string
    metaPath = front_convExp6231(Lns_2DDD(Lns_getVM().String_gsub(scriptPath,"%.lns$", ".meta")))
    if Lns_isCondTrue( self.option.OutputDir){
        var filename string
        filename = front_convExp6248(Lns_2DDD(Lns_getVM().String_gsub(mod,"%.", "/")))
    ...
    if luaPath == scriptPath{
        ...
        ast = self.FP.ConvertLuaToStreamFromScript(parser, moduleId, uptodate, convMode, scriptPath, mod, self.option.ByteCompile, self.option.StripDebugInfo, front_OpenOStreamForConvert_1317_(func(mode LnsAny)(LnsAny, LnsAny, LnsAny) {
            ...
            openLuaStream = func() LnsAny {
                ...
                {
                    _fileObj := front_convExp6406(Lns_2DDD(Lns_io_open(luaPath, "w")))
                    if _fileObj == nil{
            ...
            openStreams = func(luaFlag bool)(LnsAny, LnsAny) {
                ...
                if self.option.Mode == Option_ModeKind__SaveMeta{
                    {
                        __exp := front_convExp6496(Lns_2DDD(Lns_io_open(tempMetaPath, "w+")))
                        if __exp != nil {
            ...
            if dependStream != nil{
                dependStream_6526 := dependStream.(Lns_oStream)
                dependStream_6526.Close()
            }
            if metaFileObj != nil{
                metaFileObj_6528 := metaFileObj.(Lns_luaStream)
                metaFileObj_6528.Flush()
                metaFileObj_6528.Seek("set", 0)
                var newMetaTxt string
                
                {
                    _newMetaTxt := metaFileObj_6528.Read("*a")
                    if _newMetaTxt == nil{
                ...
                metaFileObj_6528.Close()
                var oldMetaTxt string
                oldMetaTxt = ""
                {
                    _oldFileObj := front_convExp6691(Lns_2DDD(Lns_io_open(metaPath, nil)))
                    if _oldFileObj != nil {
                ...
                if Lns_op_not(sameFlag){
                    ...
                    if txt != ""{
                        {
                            _fileObj := front_convExp6772(Lns_2DDD(Lns_io_open(metaPath, "w")))
                            if _fileObj != nil {
                                fileObj := _fileObj.(Lns_luaStream)
                                fileObj.Write(txt)
                                fileObj.Close()
    ...
    if ast != nil{
        ast_6545 := ast.(*TransUnit_ASTInfo)
        if _switch6853 := self.option.ConvTo; _switch6853 == Types_Lang__C {
            self.FP.SaveToC(scriptPath, ast_6545)
        } else if _switch6853 == Types_Lang__Go {
            self.FP.SaveToGo(scriptPath, ast_6545)
        }
    }
    return updateFlag
}

// 1351: decl @lune.@base.@front.Front.outputBootC
func (self *front_Front) outputBootC(scriptPath string) {
    var stream Lns_oStream
    {
        ...
        if _path != nil {
            path := _path.(string)
            var cPath string
            cPath = front_convExp6889(Lns_2DDD(Lns_getVM().String_gsub(path,"%.lns$", ".c")))
            var file Lns_luaStream
            
            {
                _file := front_convExp6920(Lns_2DDD(Lns_io_open(cPath, "w")))
                if _file == nil{
...
// 1434: decl @lune.@base.@front.Front.exec
func (self *front_Front) Exec() {
    __func__ := "@lune.@base.@front.Front.exec"
    Log_log(Log_Level__Trace, __func__, 1436, Log_CreateMessage(func() string {
        return Option_ModeKind_getTxt( self.option.Mode)
    }))
    
    if _switch7892 := self.option.Mode; _switch7892 == Option_ModeKind__Token {
        self.FP.DumpTokenize(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Ast {
        self.FP.DumpAst(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Format {
        self.FP.Format(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Diag {
        self.FP.CheckDiag(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Complete {
        self.FP.Complete(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Inquire {
        self.FP.Inquire(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Glue {
        self.FP.CreateGlue(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Lua || _switch7892 == Option_ModeKind__LuaMeta {
        self.FP.convertToLua(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Save || _switch7892 == Option_ModeKind__SaveMeta {
        ...
        Depend_profile(self.option.ValidProf, conv2Form7682(func() {
    ...
    } else if _switch7892 == Option_ModeKind__Shebang {
        {
            _modObj := front_convExp7730(Lns_2DDD(self.FP.LoadModule(Front_scriptPath2Module(self.option.ScriptPath))))
            if _modObj != nil {
                modObj := _modObj
                var code LnsInt
    ...
    } else if _switch7892 == Option_ModeKind__Exec {
        _ = front_convExp7751(Lns_2DDD(self.FP.LoadModule(Front_scriptPath2Module(self.option.ScriptPath))))
        if self.option.Testing{
            var code string
            ...
            if loaded != nil{
                loaded_6643 := loaded.(*Lns_luaValue)
                {
                    _mod := front_convExp7804(Lns_2DDD(Lns_getVM().RunLoadedfunc(loaded_6643,Lns_2DDD([]LnsAny{}))[0]))
                    if _mod != nil {
                        mod := _mod
    ...
    } else if _switch7892 == Option_ModeKind__BootC {
        self.FP.outputBootC(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__Builtin {
        self.FP.OutputBuiltin(self.option.ScriptPath)
    } else if _switch7892 == Option_ModeKind__MkMain {
        {
...
func front_MetaForBuildId_LoadFromMeta_1183_(metaPath string)(LnsAny, LnsAny) {
    {
        ...
        if _fileObj != nil {
            ...
            fileObj.Close()
            if luaCode != nil{
                luaCode_5899 := luaCode.(string)
                var meta LnsAny
                meta = front_convExp1155(Lns_2DDD(front_MetaForBuildId__fromStem_1179_(Lns_getVM().ExpandLuavalMap(front_loadFromLuaTxt_1117_(luaCode_5899)),nil)))
                return meta, luaCode_5899
            }
        }
    }
    return nil, nil
