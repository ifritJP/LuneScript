...
// for 1765: ExpCast
func conv2Form0_2320( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 29: ExpCast
func conv2Form0_2395( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 29: ExpCast
func conv2Form0_2470( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 1804: ExpCast
func conv2Form0_2665( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 1803
func front_convExp0_2676(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 419
...
// for 1820
func front_convExp0_2770(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, string, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1823
func front_convExp0_2796(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, string, *FrontInterface_ModuleId, LnsAny) {
...
// for 1827
func front_convExp0_2822(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, string, *FrontInterface_ModuleId, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string), Lns_getFromMulti( arg1, 2 ).(*FrontInterface_ModuleId), Lns_getFromMulti( arg1, 3 )
}
// for 1831
func front_convExp0_2848(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, string, *FrontInterface_ModuleId, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string), Lns_getFromMulti( arg1, 2 ).(*FrontInterface_ModuleId), Lns_getFromMulti( arg1, 3 )
}
// for 1835
func front_convExp0_2874(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, string, *FrontInterface_ModuleId, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string), Lns_getFromMulti( arg1, 2 ).(*FrontInterface_ModuleId), Lns_getFromMulti( arg1, 3 )
}
// for 1839
func front_convExp0_2900(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, string, *FrontInterface_ModuleId, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string), Lns_getFromMulti( arg1, 2 ).(*FrontInterface_ModuleId), Lns_getFromMulti( arg1, 3 )
}
// for 1843
func front_convExp0_2926(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, LnsAny, string, *FrontInterface_ModuleId, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string), Lns_getFromMulti( arg1, 2 ).(*FrontInterface_ModuleId), Lns_getFromMulti( arg1, 3 )
}
// for 1872
func front_convExp0_3074(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, string, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1899
func front_convExp0_3156(_env *LnsEnv, arg1 []LnsAny) (*LnsEnv, string, LnsAny) {
    return _env, Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 278
...
// for 1687
func front_convExp0_2089(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1759
func front_convExp0_2296(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1762
func front_convExp0_2314(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1778
func front_convExp0_2550(arg1 []LnsAny) (*FrontInterface_ModuleMeta, string) {
    return Lns_getFromMulti( arg1, 0 ).(*FrontInterface_ModuleMeta), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 1790
func front_convExp0_2629(arg1 []LnsAny) (LnsAny, string) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 1801
func front_convExp0_2648(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 1854
func front_convExp0_2978(arg1 []LnsAny) (string, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 )
}
// for 1871
func front_convExp0_3087(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1908
func front_convExp0_3206(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 23
func front_convExp0_2371(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 26
func front_convExp0_2389(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 23
func front_convExp0_2446(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 26
func front_convExp0_2464(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
// 1938: decl @lune.@base.@front.exec
...
func (self *Front_Front) Build(_env *LnsEnv, buildMode LnsAny,astCallback LnsAny) {
    ...
    Depend_profile(_env, self.option.ValidProf, conv2Form0_2221(func(_env *LnsEnv) {
            ...
            for _, _mod := range( self.moduleMgr.FP.GetModList(_env).Items ) {
                mod := _mod.(string)
                {
                    ...
                    if !Lns_IsNil( __exp ) {
                        ...
                        Log_log(_env, Log_Level__Err, __func__, 1700, Log_CreateMessage(func(_env *LnsEnv) string {
        ...
        LnsLog(_env, "end profile")
    }), self.option.ScriptPath + ".profi")
}
// 1723: decl @lune.@base.@front.Front.setupPreloadWithImportedModules
    ...
    if asyncFlag{
            {
                ...
                {
                    _loaded := front_convExp0_2371(Lns_2DDD(_env.GetVM().Load(subModPreLoad, nil)))
                    if _loaded == nil{
                ...
                {
                    _preloadFunc := front_convExp0_2389(Lns_2DDD(_env.GetVM().RunLoadedfunc(loaded,Lns_2DDD([]LnsAny{}))))
                    if _preloadFunc == nil{
        ...
        Lns_LockEnvSync( _env, 1731, func () {
            {
                var subModPreLoad string
                subModPreLoad = "return function( submod2Code, dumpCode )\n   local preloadFunc = function( mod )\n      code = submod2Code[ mod ]\n      local loadFunc = loadstring or load -- lua5.1 and lua5.2\n      local loaded, mess = loadFunc( code )\n      if not loaded then\n         error( mess )\n      end\n      return loaded()\n   end\n   for mod, code in pairs( submod2Code ) do\n      if dumpCode then\n         print( string.format( \"mod: %s %s\", mod, code ) )\n      end\n      package.preload[ mod ] = preloadFunc\n   end\nend\n"
                var loaded *Lns_luaValue
                ...
                {
                    _loaded := front_convExp0_2446(Lns_2DDD(_env.GetVM().Load(subModPreLoad, nil)))
                    if _loaded == nil{
                        Util_err(_env, "failed to subModPreLoad")
                    } else {
                        loaded = _loaded.(*Lns_luaValue)
                ...
                {
                    _preloadFunc := front_convExp0_2464(Lns_2DDD(_env.GetVM().RunLoadedfunc(loaded,Lns_2DDD([]LnsAny{}))))
                    if _preloadFunc == nil{
                        Util_err(_env, "failed to preloadFunc")
                    } else {
                        preloadFunc = _preloadFunc
...
// 1769: decl @lune.@base.@front.Front.executeLns
func (self *Front_Front) executeLns(_env *LnsEnv, path string,baseDir LnsAny)(LnsAny, string) {
    ...
    Log_log(_env, Log_Level__Debug, __func__, 1780, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 1789: decl @lune.@base.@front.Front.executeLnsAndTest
func (self *Front_Front) executeLnsAndTest(_env *LnsEnv, path string,baseDir LnsAny) {
    ...
    if self.option.Testing{
        ...
        Lns_LockEnvSync( _env, 1800, func () {
            var loaded LnsAny
            var mess LnsAny
            ...
            if loaded != nil{
                ...
                {
                    _testFunc := front_convExp0_2676(Lns_2DDD(_env.GetVM().RunLoadedfunc(loaded_657,Lns_2DDD([]LnsAny{}))))
...
// 1813: decl @lune.@base.@front.Front.exec
func (self *Front_Front) Exec(_env *LnsEnv) {
    __func__ := "@lune.@base.@front.Front.exec"
    Log_log(_env, Log_Level__Trace, __func__, 1815, Log_CreateMessage(func(_env *LnsEnv) string {
        return Option_ModeKind_getTxt( self.option.Mode)
    }))
    
    if _switch0 := self.option.Mode; _switch0 == Option_ModeKind__Token {
        self.FP.DumpTokenize(front_convExp0_2770(_env, Lns_2DDD(front_getBaseDir_18_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
    } else if _switch0 == Option_ModeKind__Ast {
        self.FP.DumpAst(front_convExp0_2796(_env, Lns_2DDD(front_getParseSrcAndBaseDir_19_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
    } else if _switch0 == Option_ModeKind__Format {
        self.FP.Format(front_convExp0_2822(_env, Lns_2DDD(front_getParseSrcAndBaseDir_19_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
    } else if _switch0 == Option_ModeKind__Diag {
        self.FP.CheckDiag(front_convExp0_2848(_env, Lns_2DDD(front_getParseSrcAndBaseDir_19_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
    } else if _switch0 == Option_ModeKind__Complete {
        self.FP.complete(front_convExp0_2874(_env, Lns_2DDD(front_getParseSrcAndBaseDir_19_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
    } else if _switch0 == Option_ModeKind__Inquire {
        self.FP.Inquire(front_convExp0_2900(_env, Lns_2DDD(front_getParseSrcAndBaseDir_19_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
    } else if _switch0 == Option_ModeKind__Glue {
        self.FP.CreateGlue(front_convExp0_2926(_env, Lns_2DDD(front_getParseSrcAndBaseDir_19_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
        ...
        Lns_LockEnvSync( _env, 1870, func () {
            var modObj LnsAny
            
            {
                _modObj := front_convExp0_3087(Lns_2DDD(self.FP.executeLns(front_convExp0_3074(_env, Lns_2DDD(front_getBaseDir_18_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))))
                if _modObj == nil{
                    _env.GetVM().OS_exit(1)
                } else {
                    modObj = _modObj
        ...
        self.FP.executeLnsAndTest(front_convExp0_3156(_env, Lns_2DDD(front_getBaseDir_18_(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env)))))
        ...
        var mod string
        mod = front_convExp0_3206(Lns_2DDD(self.FP.scriptPath2Module(_env, self.option.ScriptPath, self.option.FP.Get_projDir(_env))))
        {
