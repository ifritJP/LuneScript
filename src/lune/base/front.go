...
// for 740: ExpCast
func conv2Form3987( src func ()) LnsForm {
...
// for 1123: ExpCast
func conv2Form6377( src func ()) LnsForm {
    return func (argList []LnsAny) []LnsAny {
        src()
        return []LnsAny{}
    }
...
// for 1175
func front_convExp6063(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1221
func front_convExp6255(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1235
func front_convExp6336(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 279
...
// for 961
func front_convExp4962(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 966
func front_convExp5000(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 982
func front_convExp5069(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 984
func front_convExp5084(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 988
func front_convExp5100(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 989
func front_convExp5116(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1020
func front_convExp5270(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1079
func front_convExp5520(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1080
...
// for 1160
func front_convExp5973(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1272
func front_convExp6462(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1273
...
func front_loadFromChunk_1114_(chunk LnsAny,err LnsAny) LnsAny {
    if err != nil{
        err_5641 := err.(string)
        Util_errorLog(err_5641)
    }
    if chunk != nil{
        chunk_5643 := chunk.(*Lns_luaValue)
        {
            _work := front_convExp773(Lns_2DDD(Lns_getVM().RunLoadedfunc(chunk_5643,Lns_2DDD([]LnsAny{}))[0]))
            if _work != nil {
                work := _work
                return work
            }
...
func front_byteCompileFromLuaTxt_1120_(txt string,stripDebugInfo bool) string {
    ...
    if chunk != nil{
        chunk_5658 := chunk.(*Lns_luaValue)
        return Lns_getVM().String_dump(chunk_5658, stripDebugInfo)
    }
...
func front_getMetaInfo_1186_(lnsPath string,mod string,outdir LnsAny)(LnsAny, string, string) {
    ...
    if outdir != nil{
        outdir_5719 := outdir.(string)
        moduleMetaPath = Lns_getVM().String_format("%s/%s", []LnsAny{outdir_5719, Lns_car(Lns_getVM().String_gsub(mod,"%.", "/")).(string)})
...
func front_getModuleId_1192_(lnsPath string,mod string,outdir LnsAny,metaInfo LnsAny) *FrontInterface_ModuleId {
    ...
    if metaInfo != nil{
        metaInfo_5749 := metaInfo.(*front_MetaForBuildId)
        var buildId *FrontInterface_ModuleId
        buildId = metaInfo_5749.FP.CreateModuleId()
...
func Front_convertToLua___anonymous_1335_(stream LnsAny,metaStream LnsAny,dependStream LnsAny) {
    if dependStream != nil{
        dependStream_6122 := dependStream.(Lns_oStream)
        dependStream_6122.Close()
    }
}
...
func Front_saveToLua__txt2ModuleId_1350_(txt string) *FrontInterface_ModuleId {
    ...
    buildIdTxt = front_convExp5270(Lns_2DDD(Lns_getVM().String_gsub(Lns_car(Lns_getVM().String_gsub(txt,"^_moduleObj.__buildId = ", "")).(string),"\"", "")))
...
func (self *front_Front) Initfront_Front(option *Option_Option) {
    ...
    {
        _exp241 := Depend_getLoadedMod()
        _key241, _val241 := _exp241.Get1stFromMap()
        for _key241 != nil {
            mod := _key241.(string)
            modval := _val241
            ...
            _key241, _val241 = _exp241.NextFromMap( _key241 )
        }
    }
...
func (self *front_Front) loadLua(path string) LnsAny {
    ...
    if chunk != nil{
        chunk_5594 := chunk.(*Lns_luaValue)
        return Lns_unwrap( Lns_car(Lns_getVM().RunLoadedfunc(chunk_5594,Lns_2DDD([]LnsAny{}))[0]))
    }
...
func (self *front_Front) searchModuleFile(mod string,suffix string,addPath LnsAny) LnsAny {
    ...
    if addPath != nil{
        addPath_5732 := addPath.(string)
        lnsSearchPath = Lns_getVM().String_format("%s/?%s;%s", []LnsAny{addPath_5732, suffix, Lns_package_path})
...
func (self *front_Front) getModuleIdAndCheckUptodate(lnsPath string,mod string)(*FrontInterface_ModuleId, LnsAny) {
    ...
    if metaInfo != nil{
        metaInfo_5799 := metaInfo.(*front_MetaForBuildId)
        if metaInfo_5799.__enableTest == self.option.Testing{
            var buildId *FrontInterface_ModuleId
            buildId = FrontInterface_ModuleId_createIdFromTxt(metaInfo_5799.__buildId)
            if buildId != FrontInterface_ModuleId__tempId{
                ...
                if lnsTime != nil && metaTime != nil{
                    lnsTime_5806 := lnsTime.(LnsReal)
                    metaTime_5807 := metaTime.(LnsReal)
                    if lnsTime_5806 == buildId.FP.Get_modTime(){
                        uptodate = checkDependUptodate(metaTime_5807, metaInfo_5799, metaCode)
            ...
            if _luaTxt != nil {
            ...
            } else {
                {
                    ...
                    if _lnsPath != nil {
                        ...
                        loadVal = nil
                        if luaPath != nil{
                            luaPath_5941 := luaPath.(string)
                            if Util_getReadyCode(lnsPath, luaPath_5941){
                                var metaPath string
                                metaPath = front_convExp3258(Lns_2DDD(Lns_getVM().String_gsub(luaPath_5941, "%.lua$", ".meta")))
                                if Util_getReadyCode(lnsPath, metaPath){
                                    {
                                        ...
                                        if _preLoadInfo != nil {
                                            ...
                                            loadVal = self.FP.loadLua(luaPath_5941)
            ...
            if __exp != nil {
            ...
            } else {
                {
                    ...
                    if _lnsPath != nil {
                        ...
                        meta = nil
                        if luaPath != nil{
                            luaPath_5975 := luaPath.(string)
                            if Util_getReadyCode(lnsPath, luaPath_5975){
                                var metaPath string
                                metaPath = front_convExp3556(Lns_2DDD(Lns_getVM().String_gsub(luaPath_5975, "%.lua$", ".meta")))
                                if Util_getReadyCode(lnsPath, metaPath){
                                    meta = self.FP.checkUptodateMeta(metaPath, self.option.OutputDir)
                                    
                                    if meta != nil{
                                        meta_5980 := meta
                                        self.loadedMetaMap.Set(mod,meta_5980)
                                    }
                                } else { 
                                ...
                                Log_log(Log_Level__Warn, __func__, 703, Log_CreateMessage(func() string {
                                    return Lns_getVM().String_format("%s not ready lua %s, %s", []LnsAny{mod, lnsPath, luaPath_5975})
                                }))
...
func (self *front_Front) DumpAst() {
    var mod string
    mod = Front_scriptPath2Module(self.option.ScriptPath)
    Depend_profile(self.option.ValidProf, conv2Form3987(func() {
        var ast *TransUnit_ASTInfo
...
func (self *front_Front) ConvertLuaToStreamFromScript(checkUptodate bool,convMode LnsInt,path string,mod string,byteCompile bool,stripDebugInfo bool,openOStream front_OpenOStreamForConvert_1317_,closeOStream LnsAny) LnsAny {
    ...
    outputDependInfo = func(stream LnsAny,metaInfo LnsAny) {
        if stream != nil{
            stream_6062 := stream.(Lns_oStream)
            if metaInfo != nil{
                metaInfo_6064 := metaInfo.(*front_MetaForBuildId)
                var dependInfo *OutputDepend_DependInfo
                dependInfo = NewOutputDepend_DependInfo(mod)
                for _dependMod, _ := range( metaInfo_6064.__dependModuleMap.Items ) {
                    dependMod := _dependMod.(string)
                    dependInfo.FP.AddImpotModule(dependMod)
                }
                for _, _subMod := range( metaInfo_6064.__subModuleMap.Items ) {
                    subMod := _subMod.(string)
                    dependInfo.FP.AddSubMod(subMod)
                }
                dependInfo.FP.Output(stream_6062)
            } else {
    ...
    switch _exp4749 := uptodate.(type) {
    case *front_ModuleUptodate__Uptodate:
    metaInfo := _exp4749.Val1
    ...
    case *front_ModuleUptodate__NeedUpdate:
        if stream != nil && metaStream != nil{
            stream_6084 := stream.(Lns_oStream)
            metaStream_6085 := metaStream.(Lns_oStream)
            var ast *TransUnit_ASTInfo
            ...
            if dependsStream != nil{
                dependsStream_6088 := dependsStream.(Lns_oStream)
                ast.FP.Get_node().FP.ProcessFilter(OutputDepend_createFilter(dependsStream_6088), 1)
            }
            var outStream Lns_oStream
            outStream = stream_6084
            var oMetaStream Lns_oStream
            oMetaStream = metaStream_6085
            ...
            if byteCompile{
                stream_6084.Write(front_byteCompileFromLuaTxt_1120_(byteStream.FP.Get_txt(), stripDebugInfo))
                if metaStream_6085 != stream_6084{
                    metaStream_6085.Write(front_byteCompileFromLuaTxt_1120_(byteMetaStream.FP.Get_txt(), true))
                }
            }
        } else {
    ...
    metaCode := _exp4749.Val1
    metaInfo := _exp4749.Val2
        Util_errorLog("touch -- " + path)
        if self.option.Mode == Option_ModeKind__SaveMeta{
            if metaStream != nil{
                metaStream_6102 := metaStream.(Lns_oStream)
                metaStream_6102.Write(metaCode)
            } else {
    ...
    if closeOStream != nil{
        closeOStream_6105 := closeOStream.(front_CloseOStreamForConvert_1320_)
        closeOStream_6105(stream, metaStream, dependsStream)
    }
    return retAst
}
...
func (self *front_Front) convertToLua() {
    ...
    if ast != nil{
        ast_6125 := ast.(*TransUnit_ASTInfo)
        if _switch4936 := self.option.ConvTo; _switch4936 == Types_Conv__Go {
            var conv *Nodes_Filter
            conv = ConvGo_createFilter(self.option.Testing, "stdout", Lns_io_stdout, ast_6125)
            ast_6125.FP.Get_node().FP.ProcessFilter(conv, ConvGo_Opt2Stem(NewConvGo_Opt(ast_6125.FP.Get_node())))
        }
    }
}
...
func (self *front_Front) SaveToGo(ast *TransUnit_ASTInfo) {
    var path string
    path = front_convExp4962(Lns_2DDD(Lns_getVM().String_gsub(self.option.ScriptPath,"%.lns$", ".go")))
    {
        _dir := self.option.OutputDir
        if _dir != nil {
            dir := _dir.(string)
    ...
    {
        _file := front_convExp5000(Lns_2DDD(Lns_io_open(path, "w")))
        if _file == nil{
            return 
        } else {
...
func (self *front_Front) SaveToC(ast *TransUnit_ASTInfo) {
    var cPath string
    cPath = front_convExp5069(Lns_2DDD(Lns_getVM().String_gsub(self.option.ScriptPath,"%.lns$", ".c")))
    var file Lns_luaStream
    
    {
        _file := front_convExp5084(Lns_2DDD(Lns_io_open(cPath, "w")))
        if _file == nil{
            return 
        } else {
            file = _file.(Lns_luaStream)
    ...
    var hPath string
    hPath = front_convExp5100(Lns_2DDD(Lns_getVM().String_gsub(self.option.ScriptPath,"%.lns$", ".h")))
    var hFile Lns_luaStream
    
    {
        _hFile := front_convExp5116(Lns_2DDD(Lns_io_open(hPath, "w")))
        if _hFile == nil{
            return 
        } else {
...
func (self *front_Front) SaveToLua() bool {
    ...
    checkDiff = func(oldStream *Parser_TxtStream,newStream *Parser_TxtStream)(bool, string) {
        ...
        for  {
            ...
            if oldLine != nil{
                oldLine_6186 := oldLine.(string)
                if len(oldBuildIdLine) == 0{
                    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(oldLine_6186,"^_moduleObj.__buildId", nil, nil))){
                        oldBuildIdLine = oldLine_6186
            ...
            if newLine != nil{
                newLine_6190 := newLine.(string)
                if len(newBuildIdLine) == 0{
                    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(newLine_6190,"^_moduleObj.__buildId", nil, nil))){
                        newBuildIdLine = newLine_6190
            ...
            if newLine != oldLine{
                ...
                if newLine != nil && oldLine != nil{
                    newLine_6196 := newLine.(string)
                    oldLine_6197 := oldLine.(string)
                    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(oldLine_6197,"^_moduleObj.__buildId", nil, nil))){
                        if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(newLine_6196,"^_moduleObj.__buildId", nil, nil))){
                        ...
                        Lns_GetEnv().SetStackVal( Lns_car(Lns_getVM().String_find(oldLine_6197,"^__dependModuleMap.*buildId =", nil, nil))) &&
                        Lns_GetEnv().SetStackVal( Lns_car(Lns_getVM().String_find(newLine_6196,"^__dependModuleMap.*buildId =", nil, nil))) )){
                        var oldSub string
                        oldSub = front_convExp5520(Lns_2DDD(Lns_getVM().String_gsub(oldLine_6197,"buildId =.*", "")))
                        var newSub string
                        newSub = front_convExp5533(Lns_2DDD(Lns_getVM().String_gsub(newLine_6196,"buildId =.*", "")))
                        if oldSub == newSub{
                            cont = true
    ...
    var mod string
    mod = Front_scriptPath2Module(self.option.ScriptPath)
    Depend_profile(self.option.ValidProf, conv2Form6377(func() {
        var luaPath string
        luaPath = front_convExp5783(Lns_2DDD(Lns_getVM().String_gsub(self.option.ScriptPath,"%.lns$", ".lua")))
        var metaPath string
        metaPath = front_convExp5798(Lns_2DDD(Lns_getVM().String_gsub(self.option.ScriptPath,"%.lns$", ".meta")))
        if Lns_isCondTrue( self.option.OutputDir){
            var filename string
            filename = front_convExp5815(Lns_2DDD(Lns_getVM().String_gsub(mod,"%.", "/")))
        ...
        if luaPath == self.option.ScriptPath{
            ...
            ast = self.FP.ConvertLuaToStreamFromScript(true, convMode, self.option.ScriptPath, mod, self.option.ByteCompile, self.option.StripDebugInfo, front_OpenOStreamForConvert_1317_(func(mode LnsAny)(LnsAny, LnsAny, LnsAny) {
                ...
                openLuaStream = func() LnsAny {
                    ...
                    {
                        _fileObj := front_convExp5973(Lns_2DDD(Lns_io_open(luaPath, "w")))
                        if _fileObj == nil{
                ...
                openStreams = func(luaFlag bool)(LnsAny, LnsAny) {
                    ...
                    if self.option.Mode == Option_ModeKind__SaveMeta{
                        {
                            __exp := front_convExp6063(Lns_2DDD(Lns_io_open(tempMetaPath, "w+")))
                            if __exp != nil {
                ...
                if stream != nil{
                    stream_6265 := stream.(Lns_oStream)
                    stream_6265.Close()
                }
                if dependStream != nil{
                    dependStream_6267 := dependStream.(Lns_oStream)
                    dependStream_6267.Close()
                }
                if metaFileObj != nil{
                    metaFileObj_6269 := metaFileObj.(Lns_luaStream)
                    metaFileObj_6269.Flush()
                    metaFileObj_6269.Seek("set", 0)
                    var newMetaTxt string
                    
                    {
                        _newMetaTxt := metaFileObj_6269.Read("*a")
                        if _newMetaTxt == nil{
                    ...
                    metaFileObj_6269.Close()
                    var oldMetaTxt string
                    oldMetaTxt = ""
                    {
                        _oldFileObj := front_convExp6255(Lns_2DDD(Lns_io_open(metaPath, nil)))
                        if _oldFileObj != nil {
                    ...
                    if Lns_op_not(sameFlag){
                        ...
                        if txt != ""{
                            {
                                _fileObj := front_convExp6336(Lns_2DDD(Lns_io_open(metaPath, "w")))
                                if _fileObj != nil {
                                    fileObj := _fileObj.(Lns_luaStream)
                                    fileObj.Write(txt)
                                    fileObj.Close()
    ...
    if ast != nil{
        ast_6286 := ast.(*TransUnit_ASTInfo)
        if _switch6429 := self.option.ConvTo; _switch6429 == Types_Conv__C {
            self.FP.SaveToC(ast_6286)
        } else if _switch6429 == Types_Conv__Go {
            self.FP.SaveToGo(ast_6286)
        }
    }
    return updateFlag
}
...
func (self *front_Front) outputBootC() {
    var stream Lns_oStream
    {
        ...
        if _path != nil {
            path := _path.(string)
            var cPath string
            cPath = front_convExp6462(Lns_2DDD(Lns_getVM().String_gsub(path,"%.lns$", ".c")))
            var file Lns_luaStream
            
            {
                _file := front_convExp6493(Lns_2DDD(Lns_io_open(cPath, "w")))
                if _file == nil{
...
func (self *front_Front) Exec() {
    ...
    if _switch6835 := self.option.Mode; _switch6835 == Option_ModeKind__Token {
        self.FP.DumpTokenize()
    } else if _switch6835 == Option_ModeKind__Ast {
        self.FP.DumpAst()
    } else if _switch6835 == Option_ModeKind__Format {
        self.FP.Format()
    } else if _switch6835 == Option_ModeKind__Diag {
        self.FP.CheckDiag()
    } else if _switch6835 == Option_ModeKind__Complete {
        self.FP.Complete()
    } else if _switch6835 == Option_ModeKind__Inquire {
        self.FP.Inquire()
    } else if _switch6835 == Option_ModeKind__Glue {
        self.FP.CreateGlue()
    } else if _switch6835 == Option_ModeKind__Lua || _switch6835 == Option_ModeKind__LuaMeta {
        self.FP.convertToLua()
    } else if _switch6835 == Option_ModeKind__Save || _switch6835 == Option_ModeKind__SaveMeta {
        self.FP.SaveToLua()
    } else if _switch6835 == Option_ModeKind__Exec {
        _ = front_convExp6773(Lns_2DDD(self.FP.LoadModule(Front_scriptPath2Module(self.option.ScriptPath))))
        if self.option.Testing{
            Testing_run(Front_scriptPath2Module(self.option.ScriptPath))
            Testing_outputAllResult(Lns_io_stdout)
        }
    } else if _switch6835 == Option_ModeKind__BootC {
        self.FP.outputBootC()
    } else if _switch6835 == Option_ModeKind__Builtin {
...
func front_MetaForBuildId_LoadFromMeta_1183_(metaPath string)(LnsAny, LnsAny) {
    {
        ...
        if _fileObj != nil {
            ...
            fileObj.Close()
            if luaCode != nil{
                luaCode_5709 := luaCode.(string)
                var meta LnsAny
                meta = front_convExp1155(Lns_2DDD(front_MetaForBuildId__fromStem_1179_(Lns_getVM().ExpandLuavalMap(front_loadFromLuaTxt_1117_(luaCode_5709)),nil)))
                return meta, luaCode_5709
            }
        }
    }
    return nil, nil
