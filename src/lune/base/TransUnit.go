...
// for 3819
func TransUnit_convExp28335(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3998
func TransUnit_convExp29283(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 348
func TransUnit_convExp33401(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 389
func TransUnit_convExp53353(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 1186
func TransUnit_convExp57051(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 1182
func TransUnit_convExp57053(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 1344
func TransUnit_convExp57722(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2575
func TransUnit_convExp64072(arg1 []LnsAny) (LnsAny, LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ), Lns_getFromMulti( arg1, 2 )
}
// for 3185
func TransUnit_convExp67173(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 53
func TransUnit_convExp72501(arg1 []LnsAny) (LnsAny, LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ), Lns_getFromMulti( arg1, 2 )
}
// for 2230
...
// for 3740
func TransUnit_convExp27790(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 827
func TransUnit_convExp55269(arg1 []LnsAny) (LnsInt, *LnsMap, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt), Lns_getFromMulti( arg1, 1 ).(*LnsMap), Lns_getFromMulti( arg1, 2 )
}
// for 896
func TransUnit_convExp55614(arg1 []LnsAny) (LnsInt, *LnsMap, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt), Lns_getFromMulti( arg1, 1 ).(*LnsMap), Lns_getFromMulti( arg1, 2 )
}
// for 2110
func TransUnit_convExp61637(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 2112
func TransUnit_convExp61667(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 2116
func TransUnit_convExp61707(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 3601
func TransUnit_convExp69495(arg1 []LnsAny) (LnsInt, *LnsMap, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt), Lns_getFromMulti( arg1, 1 ).(*LnsMap), Lns_getFromMulti( arg1, 2 )
}
...
func TransUnit_setupBuiltinTypeInfo_3426_(name string,fieldName string,symInfo *Ast_SymbolInfo) {
    ...
    var process_ func()
    process_ = func() {
        if _switch14608 := fieldName; _switch14608 == "_fcall" {
    ...
    process_Nilable = func() {
        if _switch17006 := fieldName; _switch17006 == "val" {
    ...
    if _switch17157 := name; _switch17157 == "" {
        process_()
    } else if _switch17157 == "iStream" {
        process_iStream()
    } else if _switch17157 == "oStream" {
        process_oStream()
    } else if _switch17157 == "luaStream" {
        process_luaStream()
    } else if _switch17157 == "Mapping" {
        process_Mapping()
    } else if _switch17157 == "__pipe" {
        process___pipe()
    } else if _switch17157 == "LnsThread" {
        process_LnsThread()
    } else if _switch17157 == "io" {
        process_io()
    } else if _switch17157 == "package" {
        process_package()
    } else if _switch17157 == "os" {
        process_os()
    } else if _switch17157 == "string" {
        process_string()
    } else if _switch17157 == "str" {
        process_str()
    } else if _switch17157 == "List" {
        process_List()
    } else if _switch17157 == "Array" {
        process_Array()
    } else if _switch17157 == "Set" {
        process_Set()
    } else if _switch17157 == "math" {
        process_math()
    } else if _switch17157 == "debug" {
        process_debug()
    } else if _switch17157 == "Nilable" {
        process_Nilable()
    }
}
...
func TransUnit_findForm(format string) *LnsList {
    ...
    for  {
        ...
        pos,endPos = nil, nil
        {
            _index, _endIndex := TransUnit_convExp57053(Lns_2DDD(Lns_getVM().String_find(remain,"^%%[%d]*%a", nil, nil)))
            if _index != nil && _endIndex != nil {
                ...
                {
                    _index, _endIndex := TransUnit_convExp57051(Lns_2DDD(Lns_getVM().String_find(remain,"[^%%]%%[%d]*%a", nil, nil)))
                    if _index != nil && _endIndex != nil {
                        index := _index.(LnsInt)
                        endIndex := _endIndex.(LnsInt)
        ...
        if pos != nil && endPos != nil{
            pos_10005 := pos.(LnsInt)
            endPos_10006 := endPos.(LnsInt)
            var op string
            op = Lns_getVM().String_sub(remain,pos_10005, endPos_10006)
            opList.Insert(op)
            remain = Lns_getVM().String_sub(remain,endPos_10006 + 1, nil)
...
func TransUnit_isMatchStringFormatType(opKind string,argType *Ast_TypeInfo,luaVer *LuaVer_LuaVerInfo)(LnsInt, *Ast_TypeInfo) {
    ...
    if _switch57259 := LnsInt(opKind[len(opKind)-1]); _switch57259 == 115 {
    ...
    } else if _switch57259 == 113 {
        if argType.FP.Get_srcTypeInfo() != Ast_builtinTypeString{
            return TransUnit_FormType__Unmatch, Ast_builtinTypeString
        }
    } else if _switch57259 == 65 || _switch57259 == 97 || _switch57259 == 69 || _switch57259 == 101 || _switch57259 == 102 || _switch57259 == 71 || _switch57259 == 103 {
...
func TransUnit_analyzeExpOpSet__process_6511_(lValNode *Nodes_Node) LnsAny {
    ...
    if _switch65099 := refItemNode.FP.Get_val().FP.Get_expType().FP.Get_kind(); _switch65099 == Ast_TypeInfoKind__List || _switch65099 == Ast_TypeInfoKind__Map {
        return refItemNode
    }
    return nil
}
...
func (self *TransUnit_TentativeSymbol) InitTransUnit_TentativeSymbol(parent LnsAny,scope *Ast_Scope,moduleScope *Ast_Scope,loopFlag bool,refAccessSymPosList LnsAny) {
    ...
    if refAccessSymPosList != nil{
        refAccessSymPosList_5440 := refAccessSymPosList.(*LnsList)
        list = refAccessSymPosList_5440
...
type TransUnit_TransUnitMtd interface {
    ...
    analyzeImportFor(arg1 *Types_Position, arg2 string, arg3 string, arg4 LnsInt) *Nodes_Node
    ...
    analyzePushClass(arg1 LnsInt, arg2 bool, arg3 *Types_Token, arg4 *Types_Token, arg5 bool, arg6 LnsInt, arg7 *LnsList)(*Types_Token, *Ast_TypeInfo)
    ...
    checkComp(arg1 *Types_Token, arg2 TransUnit_checkCompForm_6409_)
...
func (self *TransUnit_TransUnit) pushModule(externalFlag bool,name string,mutable bool) *Ast_TypeInfo {
    ...
    }
    {
        ...
        if __exp != nil {
            ...
            if existSym != nil{
                existSym_5840 := existSym.(*Ast_SymbolInfo)
                self.FP.addErrMess(self.parser.FP.GetLastPos(), Lns_getVM().String_format("module symbols exist -- %s.%s -- %s.%s", []LnsAny{existSym_5840.FP.Get_namespaceTypeInfo().FP.GetFullName(self.typeNameCtrl, parentScope.FP, false), existSym_5840.FP.Get_name(), parentInfo.FP.GetFullName(self.typeNameCtrl, parentScope.FP, false), modName}))
            }
        }
    }
...
func (self *TransUnit_TransUnit) pushClass(errPos *Types_Position,mode LnsInt,abstractFlag bool,baseInfo LnsAny,interfaceList LnsAny,genTypeList LnsAny,externalFlag bool,name string,allowMultiple bool,accessMode LnsInt,defNamespace LnsAny) *Ast_TypeInfo {
    ...
    if typeInfo != Ast_headTypeInfo{
        ...
        if baseInfo != nil{
            baseInfo_5883 := baseInfo.(*Ast_TypeInfo)
            if typeInfo.FP.Get_baseTypeInfo() != baseInfo_5883{
                self.FP.addErrMess(errPos, Lns_getVM().String_format("mismatch class(%s) base class(%s) for prototpye base class(%s)", []LnsAny{typeInfo.FP.GetTxt(self.typeNameCtrl, nil, nil), baseInfo_5883.FP.GetTxt(nil, nil, nil), typeInfo.FP.Get_baseTypeInfo().FP.GetTxt(nil, nil, nil)}))
            }
        } else {
        ...
        if _switch3778 := (typeInfo.FP.Get_kind()); _switch3778 == Ast_TypeInfoKind__Class {
        ...
        } else if _switch3778 == Ast_TypeInfoKind__IF {
            if mode != TransUnit_DeclClassMode__Interface{
        ...
        if genTypeList != nil{
            genTypeList_5909 := genTypeList.(*LnsList)
            workGenTypeList = genTypeList_5909
    ...
    if genTypeList != nil{
        genTypeList_5912 := genTypeList.(*LnsList)
        for _, _genType := range( genTypeList_5912.Items ) {
...
// 1067: decl @lune.@base.@TransUnit.TransUnit.popClass
...
// 1116: decl @lune.@base.@TransUnit.TransUnit.isTargetTokenPos
...
// 1144: decl @lune.@base.@TransUnit.TransUnit.errorShadowing
func (self *TransUnit_TransUnit) errorShadowing(pos *Types_Position,symbolInfo LnsAny) {
    if symbolInfo != nil{
        symbolInfo_6040 := symbolInfo.(*Ast_SymbolInfo)
        var symPos LnsAny
        symPos = symbolInfo_6040.FP.Get_pos()
        if symPos != nil{
            symPos_6043 := symPos.(*Types_Position)
            var mess string
            mess = Lns_getVM().String_format("This symbol is shadowed from %d:%d -- %s", []LnsAny{pos.LineNo, pos.Column, symbolInfo_6040.FP.Get_name()})
            self.FP.addWarnErrMess(symPos_6043, Lns_op_not(self.ctrl_info.WarningShadowing), mess)
        }
        var mess string
        mess = Lns_getVM().String_format("shadowing symbol of %s -- %s", []LnsAny{Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            Lns_GetEnv().SetStackVal( "external") ).(string), symbolInfo_6040.FP.Get_name()})
        self.FP.addWarnErrMess(pos, Lns_op_not(self.ctrl_info.WarningShadowing), mess)
    }
}

// 1161: decl @lune.@base.@TransUnit.TransUnit.checkShadowing
...
// 1175: decl @lune.@base.@TransUnit.TransUnit.addLocalVar
...
// 1266: decl @lune.@base.@TransUnit.TransUnit.createExtType
func (self *TransUnit_TransUnit) createExtType(pos *Types_Position,typeInfo *Ast_TypeInfo) *Ast_TypeInfo {
    switch _exp5265 := self.processInfo.FP.CreateLuaval(typeInfo, true).(type) {
...
// 2130: decl @lune.@base.@TransUnit.TransUnit.checkThreading
...
// 2147: decl @lune.@base.@TransUnit.TransUnit.registBuiltInScope
func (self *TransUnit_TransUnit) registBuiltInScope() {
    ...
    getTypeInfo = func(typeName string) *Ast_TypeInfo {
        ...
        getTypeInfoFromScope = func(scope *Ast_Scope,symbol string,genTypeList *LnsList) LnsAny {
            ...
            if validGenType{
                if _switch19960 := typeInfo.FP.Get_kind(); _switch19960 == Ast_TypeInfoKind__Map {
                ...
                } else if _switch19960 == Ast_TypeInfoKind__Ext {
                    if genTypeList.Len() != 1{
                        Util_err(Lns_getVM().String_format("illegal param -- %d", []LnsAny{genTypeList.Len()}))
                    }
                    switch _exp19890 := self.processInfo.FP.CreateLuaval(genTypeList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                    case *Ast_LuavalResult__OK:
                    workType := _exp19890.Val1
                ...
                } else if _switch19960 == Ast_TypeInfoKind__DDD {
                    if genTypeList.Len() != 1{
                        Util_err(Lns_getVM().String_format("illegal map param -- %d", []LnsAny{genTypeList.Len()}))
                    }
        ...
        if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(typeName,"^&", nil, nil))){
            ...
            typeName = TransUnit_convExp20006(Lns_2DDD(Lns_getVM().String_gsub(typeName,"^&", "")))
            
        }
        var genTypeList *LnsList
        genTypeList = NewLnsList([]LnsAny{})
        var endIndex LnsAny
        _,endIndex = TransUnit_convExp20031(Lns_2DDD(Lns_getVM().String_find(typeName,"[%w%.]+<", nil, nil)))
        var suffix string
        suffix = ""
        if endIndex != nil{
            endIndex_7001 := endIndex.(LnsInt)
            var genTypeName string
            genTypeName = Lns_getVM().String_sub(typeName,endIndex_7001 + 1, nil)
            for  {
                {
                    _tailIndex := TransUnit_convExp20124(Lns_2DDD(Lns_getVM().String_find(genTypeName,"[,>]", nil, nil)))
                    if _tailIndex != nil {
            ...
            typeName = Lns_getVM().String_sub(typeName,1, endIndex_7001 - 1) + suffix
        ...
        if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(typeName,"!$", nil, nil))){
            ...
            orgTypeName = TransUnit_convExp20179(Lns_2DDD(Lns_getVM().String_gsub(typeName,"!$", "")))
            {
    ...
    processField = func(name string,fieldName string,info *LnsMap,parentInfo *Ast_TypeInfo) {
        if self.targetLuaVer.FP.IsSupport(Lns_getVM().String_format("%s.%s", []LnsAny{name, fieldName})){
            ...
            Lns_GetEnv().NilAccPush( Lns_GetEnv().NilAccPop().(*LnsList).GetAt(1))) == "var"{
                ...
                TransUnit_setupBuiltinTypeInfo_3426_(name, fieldName, symbol)
            } else { 
                ...
                if _switch20733 := funcType; _switch20733 == "method" || _switch20733 == "mut" {
                    staticFlag = false
                ...
                TransUnit_setupBuiltinTypeInfo_3426_(name, fieldName, symInfo)
            }
        }
    }
    ...
    for _, _builtinClassInfo := range( builtInInfo.Items ) {
        ...
        for _className, _name2FieldInfo := range( builtinClassInfo.Items ) {
            ...
            var genTypeList *LnsList
            genTypeList = NewLnsList([]LnsAny{})
            if _switch21233 := className; _switch21233 == "List<T>" {
                name = "List"
                
                TransUnit_registBuiltInScope__processCopyAlterList_4621_(genTypeList, Ast_builtinTypeList.FP.Get_itemTypeInfoList())
            } else if _switch21233 == "Array<T>" {
                name = "Array"
                
                TransUnit_registBuiltInScope__processCopyAlterList_4621_(genTypeList, Ast_builtinTypeArray.FP.Get_itemTypeInfoList())
            } else if _switch21233 == "Set<T>" {
                name = "Set"
                
                TransUnit_registBuiltInScope__processCopyAlterList_4621_(genTypeList, Ast_builtinTypeSet.FP.Get_itemTypeInfoList())
            } else if _switch21233 == "Nilable<_T>" {
                name = "Nilable"
                
                TransUnit_registBuiltInScope__processCopyAlterList_4621_(genTypeList, Ast_builtinTypeBox.FP.Get_itemTypeInfoList())
            } else {
                if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(className,"<", nil, nil))){
                    name = ""
                    
                    {
                        _form21229, _param21229, _prev21229 := Lns_getVM().String_gmatch(className,"[^<>,%s]+")
                        for {
                            _work21229 := _form21229.(*Lns_luaValue).Call( Lns_2DDD( _param21229, _prev21229 ) )
                            _prev21229 = Lns_getFromMulti(_work21229,0)
                            if Lns_IsNil( _prev21229 ) { break }
                            token := _prev21229.(string)
                            if len(name) == 0{
                                name = token
            ...
            if name != ""{
                ...
                classKind = TransUnit_DeclClassMode__Class
                {
                    ...
                    if _types != nil {
                        ...
                        if types.Len() > 0{
                            if _switch21292 := types.GetAt(1).(string); _switch21292 == "interface" {
                                classKind = TransUnit_DeclClassMode__Interface
                                
                            } else if _switch21292 == "module" {
                ...
                if _switch21468 := classKind; _switch21468 == TransUnit_DeclClassMode__Class || _switch21468 == TransUnit_DeclClassMode__Interface {
                    var declMode LnsInt
                ...
                } else if _switch21468 == TransUnit_DeclClassMode__Module {
            ...
            if Lns_op_not(builtinModuleName2Scope.Items[name]){
                ...
                {
                    __collection21547 := name2FieldInfo
                    __sorted21547 := __collection21547.CreateKeyListStr()
                    __sorted21547.Sort( LnsItemKindStr, nil )
                    for _, _fieldName := range( __sorted21547.Items ) {
                        info := __collection21547.Items[ _fieldName ].(*LnsMap)
                        fieldName := _fieldName.(string)
                        if _switch21545 := fieldName; _switch21545 == "__attrib" {
                        } else {
...
// 2560: decl @lune.@base.@TransUnit.TransUnit.createNoneNode
...
// 2618: decl @lune.@base.@TransUnit.TransUnit.getToken
...
// 2660: decl @lune.@base.@TransUnit.TransUnit.checkSymbol
...
// 2724: decl @lune.@base.@TransUnit.TransUnit.analyzeStatementList
func (self *TransUnit_TransUnit) analyzeStatementList(stmtList *LnsList,termTxt LnsAny)(LnsAny, LnsInt) {
    ...
    setTailComment = func(statement LnsAny) LnsInt {
        ...
        if commentList.Len() > 0{
            if lastStatement != nil{
                lastStatement_7255 := lastStatement.(*Nodes_Node)
                var tailComment LnsAny
                tailComment = nil
                for _, _comment := range( commentList.Items ) {
                    comment := _comment.(Types_TokenDownCast).ToTypes_Token()
                    if comment.Pos.LineNo == lastStatement_7255.FP.Get_pos().LineNo{
                        if Lns_op_not(tailComment){
                            lastStatement_7255.FP.Set_tailComment(comment)
                            tailComment = comment
        ...
        if commentList.Len() > 0{
            ...
            if statement != nil{
                statement_7266 := statement.(*Nodes_Node)
                blank = statement_7266.FP.Get_pos().LineNo - lastLineNo
    ...
    for  {
        ...
        if statement != nil{
            statement_7271 := statement.(*Nodes_Node)
            if breakKind != Nodes_BreakKind__None{
                if statement_7271.FP.Get_kind() != Nodes_NodeKind_get_BlankLine(){
                    self.FP.addErrMess(statement_7271.FP.Get_pos(), Lns_getVM().String_format("This statement is not reached -- %s", []LnsAny{Nodes_BreakKind_getTxt( breakKind)}))
                }
            }
            var blank LnsInt
            blank = setTailComment(statement_7271)
            if blank > 1{
            ...
            stmtList.Insert(Nodes_Node2Stem(statement_7271))
            lastStatement = statement_7271
            
            if statement_7271.FP.Get_kind() != Nodes_NodeKind_get_BlankLine(){
                breakKind = statement_7271.FP.GetBreakKind(Nodes_CheckBreakMode__Normal)
                
            }
            statement_7271.FP.AddComment(self.commentCtrl.FP.Get_commentList())
...
// 2834: decl @lune.@base.@TransUnit.TransUnit.analyzeStatementListSubfile
...
// 2849: decl @lune.@base.@TransUnit.TransUnit.analyzeLuneControl
func (self *TransUnit_TransUnit) analyzeLuneControl(firstToken *Types_Token) LnsAny {
    ...
    if _switch23416 := (nextToken.Txt); _switch23416 == "disable_mut_control" {
    ...
    } else if _switch23416 == "use_async" {
        pragma = LuneControl_Pragma__use_async_Obj
        
    } else if _switch23416 == "run_async_pipe" {
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            Lns_GetEnv().SetStackVal( Ast_isClass(nowClass)) ).(bool)){
            {
                ...
                Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_Scope).FP.GetTypeInfoChild("loop")})/* 2897:34 */)
                if _loopMethod != nil {
...
// 2943: decl @lune.@base.@TransUnit.TransUnit.analyzeBlock
func (self *TransUnit_TransUnit) analyzeBlock(blockKind LnsInt,tentativeMode LnsInt,scope LnsAny,refAccessSymPosList LnsAny) *Nodes_BlockNode {
    ...
    if scope != nil{
        scope_7341 := scope.(*Ast_Scope)
        self.scope = scope_7341
    ...
    if _switch23606 := tentativeMode; _switch23606 == TransUnit_TentativeMode__Loop {
        self.FP.prepareTentativeSymbol(self.scope, true, refAccessSymPosList)
    } else if _switch23606 == TransUnit_TentativeMode__Simple || _switch23606 == TransUnit_TentativeMode__Start || _switch23606 == TransUnit_TentativeMode__Ignore {
        self.FP.prepareTentativeSymbol(self.scope, false, nil)
    } else if _switch23606 == TransUnit_TentativeMode__Merge || _switch23606 == TransUnit_TentativeMode__Finish {
        self.FP.mergeTentativeSymbol(self.scope)
    }
    var loopFlag bool
    loopFlag = false
    if _switch23646 := blockKind; _switch23646 == Nodes_BlockKind__For || _switch23646 == Nodes_BlockKind__Apply || _switch23646 == Nodes_BlockKind__While || _switch23646 == Nodes_BlockKind__Repeat || _switch23646 == Nodes_BlockKind__Foreach {
        loopFlag = true
    ...
    if blockKind != Nodes_BlockKind__Repeat{
        if _switch23797 := tentativeMode; _switch23797 == TransUnit_TentativeMode__Simple || _switch23797 == TransUnit_TentativeMode__Finish {
            self.FP.finishTentativeSymbol(true)
        } else if _switch23797 == TransUnit_TentativeMode__Ignore || _switch23797 == TransUnit_TentativeMode__Loop {
...
// 3040: decl @lune.@base.@TransUnit.TransUnit.processImport
func (self *TransUnit_TransUnit) processImport(modulePath string,depth LnsInt)(*Lns_luaValue, *LnsMap, *Nodes_ModuleInfo) {
    ...
    Log_log(Log_Level__Info, __func__, 3043, Log_CreateMessage(func() string {
        ...
        if _moduleInfo != nil {
            moduleInfo := _moduleInfo.(*Nodes_ModuleInfo)
            {
                ...
                if _metaInfoStem != nil {
                    ...
                    Log_log(Log_Level__Info, __func__, 3055, Log_CreateMessage(func() string {
    ...
    {
        _form24126, _param24126, _prev24126 := Lns_getVM().String_gmatch(modulePath, "[^%.]+")
        for {
            _work24126 := _form24126.(*Lns_luaValue).Call( Lns_2DDD( _param24126, _prev24126 ) )
            _prev24126 = Lns_getFromMulti(_work24126,0)
            if Lns_IsNil( _prev24126 ) { break }
            txt := _prev24126.(string)
            nameList.Insert(txt)
        }
    }
    ...
    var metaInfo *Lns_luaValue
    metaInfo = metaInfoStem.(*Lns_luaValue)
    Log_log(Log_Level__Debug, __func__, 3079, Log_CreateMessage(func() string {
    ...
    {
        _exp24276 := metaInfo.GetAt( "__dependModuleMap" ).(*Lns_luaValue)
        _sorted24276 := Lns_getVM().SortMapKeyList( _exp24276 )
        _index24276, _key24276 := _sorted24276.Get1stFromMap()
        for _index24276 != nil {
            dependName := _key24276.(string)
            dependInfo := _exp24276.GetAt( _key24276 ).(*Lns_luaValue)
            if Lns_isCondTrue( dependInfo.GetAt("use")){
                var metaTypeId2TypeInfoMap *LnsMap
                _,metaTypeId2TypeInfoMap = TransUnit_convExp24243(Lns_2DDD(self.FP.processImport(dependName, depth + 1)))
                var typeId LnsInt
            ...
            _index24276, _key24276 = _sorted24276.NextFromMap( _index24276 )
        }
    }
    var typeId2TypeInfo *LnsMap
    ...
    {
        _exp24417 := metaInfo.GetAt( "__dependIdMap" ).(*Lns_luaValue)
        _key24417, _val24417 := _exp24417.Get1stFromMap()
        for _key24417 != nil {
            typeId := _key24417.(LnsInt)
            dependIdInfo := _val24417.(*Lns_luaValue)
            ...
            _key24417, _val24417 = _exp24417.NextFromMap( _key24417 )
        }
    }
    ...
    {
        _exp25014 := metaInfo.GetAt( "__typeInfoList" ).(*Lns_luaValue)
        _key25014, _val25014 := _exp25014.Get1stFromMap()
        for _key25014 != nil {
            atomInfoLua := _val25014.(*Lns_luaValue)
            ...
            atomInfo = workAtomInfo.(*LnsMap)
            {
                ...
                if _skind != nil {
                    ...
                    if _switch24935 := kind; _switch24935 == Ast_SerializeKind__Enum {
                        actInfo, mess = TransUnit_convExp24647(Lns_2DDD(TransUnit__TypeInfoEnum__fromMap_2184_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Alge {
                        actInfo, mess = TransUnit_convExp24670(Lns_2DDD(TransUnit__TypeInfoAlge__fromMap_2243_(atomInfo,nil)))
                        
                        self.helperInfo.UseAlge = true
                        
                    } else if _switch24935 == Ast_SerializeKind__Module {
                        actInfo, mess = TransUnit_convExp24702(Lns_2DDD(TransUnit__TypeInfoModule__fromMap_2067_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Normal {
                        var workInfo LnsAny
                        workInfo, mess = TransUnit__TypeInfoNormal__fromMap_2153_(atomInfo,nil)
                        
                        if workInfo != nil{
                            workInfo_7447 := workInfo.(*TransUnit__TypeInfoNormal)
                            _typeInfoNormalList.Insert(TransUnit__TypeInfoNormal2Stem(workInfo_7447))
                        }
                        actInfo = TransUnit__TypeInfoDownCastF(workInfo)
                        
                    } else if _switch24935 == Ast_SerializeKind__Nilable {
                        actInfo, mess = TransUnit_convExp24771(Lns_2DDD(TransUnit__TypeInfoNilable__fromMap_1852_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Alias {
                        actInfo, mess = TransUnit_convExp24794(Lns_2DDD(TransUnit__TypeInfoAlias__fromMap_1876_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__DDD {
                        actInfo, mess = TransUnit_convExp24817(Lns_2DDD(TransUnit__TypeInfoDDD__fromMap_1900_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Alternate {
                        actInfo, mess = TransUnit_convExp24840(Lns_2DDD(TransUnit__TypeInfoAlternate__fromMap_1934_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Generic {
                        actInfo, mess = TransUnit_convExp24863(Lns_2DDD(TransUnit__TypeInfoGeneric__fromMap_1968_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Modifier {
                        actInfo, mess = TransUnit_convExp24886(Lns_2DDD(TransUnit__TypeInfoModifier__fromMap_2040_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Box {
                        actInfo, mess = TransUnit_convExp24909(Lns_2DDD(TransUnit__TypeInfoBox__fromMap_1992_(atomInfo,nil)))
                        
                    } else if _switch24935 == Ast_SerializeKind__Ext {
                        actInfo, mess = TransUnit_convExp24932(Lns_2DDD(TransUnit__TypeInfoExt__fromMap_2016_(atomInfo,nil)))
                        
                    }
                    if actInfo != nil{
                        actInfo_7457 := actInfo.(*TransUnit__TypeInfo)
                        _typeInfoList.Insert(TransUnit__TypeInfo2Stem(actInfo_7457))
                        id2atomMap.Set(actInfo_7457.TypeId,actInfo_7457)
                    } else {
                        ...
                        if mess != nil{
                            mess_7463 := mess.(string)
                            Util_errorLog(mess_7463)
                        }
    ...
    {
        _exp25054 := metaInfo.GetAt( "__lazyModuleList" ).(*Lns_luaValue)
        _key25054, _val25054 := _exp25054.Get1stFromMap()
        for _key25054 != nil {
            typeId := _val25054.(LnsInt)
            lazyModuleSet.Add(typeId)
            _key25054, _val25054 = _exp25054.NextFromMap( _key25054 )
        }
    }
    ...
    for _, _atomInfo := range( _typeInfoList.Items ) {
        ...
        if newTypeInfo != nil{
            newTypeInfo_7476 := newTypeInfo.(*Ast_TypeInfo)
            if newTypeInfo_7476.FP.Get_kind() == Ast_TypeInfoKind__Macro{
                orgId2MacroTypeInfo.Set(atomInfo.TypeId,newTypeInfo_7476)
            }
            if newTypeInfo_7476.FP.Get_kind() == Ast_TypeInfoKind__Set{
                self.helperInfo.UseSet = true
                
            }
            if newTypeInfo_7476.FP.Get_accessMode() == Ast_AccessMode__Global{
                if _switch25287 := newTypeInfo_7476.FP.Get_kind(); _switch25287 == Ast_TypeInfoKind__IF || _switch25287 == Ast_TypeInfoKind__Class {
                    self.globalScope.FP.AddClass(self.processInfo, newTypeInfo_7476.FP.Get_rawTxt(), nil, newTypeInfo_7476)
                } else if _switch25287 == Ast_TypeInfoKind__Func {
                    self.globalScope.FP.AddFunc(self.processInfo, nil, newTypeInfo_7476, Ast_AccessMode__Global, newTypeInfo_7476.FP.Get_staticFlag(), Ast_TypeInfo_isMut(newTypeInfo_7476))
                } else if _switch25287 == Ast_TypeInfoKind__Enum {
                    self.globalScope.FP.AddEnum(self.processInfo, Ast_AccessMode__Global, newTypeInfo_7476.FP.Get_rawTxt(), nil, newTypeInfo_7476)
                } else if _switch25287 == Ast_TypeInfoKind__Nilable {
                } else {
                    Util_err(Lns_getVM().String_format("%s: not support kind -- %s", []LnsAny{__func__, Ast_TypeInfoKind_getTxt( newTypeInfo_7476.FP.Get_kind())}))
                }
            }
        }
    }
    for _, _atomInfo := range( _typeInfoNormalList.Items ) {
        ...
        if atomInfo.Children.Len() > 0{
            ...
            for _, _childId := range( atomInfo.Children.Items ) {
                ...
                var addFlag bool
                addFlag = true
                if _switch25419 := typeInfo.FP.Get_kind(); _switch25419 == Ast_TypeInfoKind__Func {
                    symbolKind = Ast_SymbolKind__Fun
                    
                } else if _switch25419 == Ast_TypeInfoKind__Form || _switch25419 == Ast_TypeInfoKind__FormFunc {
                    symbolKind = Ast_SymbolKind__Typ
                    
                } else if _switch25419 == Ast_TypeInfoKind__Method {
                    symbolKind = Ast_SymbolKind__Mtd
                    
                } else if _switch25419 == Ast_TypeInfoKind__Class || _switch25419 == Ast_TypeInfoKind__Module {
                    symbolKind = Ast_SymbolKind__Typ
                    
                } else if _switch25419 == Ast_TypeInfoKind__Enum {
                    addFlag = false
    ...
    registMember = func(classTypeId LnsInt) {
        ...
        if _switch25856 := (classTypeInfo.FP.Get_kind()); _switch25856 == Ast_TypeInfoKind__Class {
                    ...
                    for _fieldName, _fieldInfo := range( classInfo.(*LnsMap).Items ) {
                        ...
                        fieldInfo := _fieldInfo.(*LnsMap)
                        {
                            ...
                            if _typeId != nil {
                                ...
                                _ = TransUnit_convExp25650(Lns_2DDD(self.scope.FP.AddMember(self.processInfo, fieldName, nil, fieldTypeInfo, Lns_unwrap( Ast_AccessMode__from(Lns_forceCastInt((Lns_unwrap( fieldInfo.Items["accessMode"]))))).(LnsInt), Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        } else if _switch25856 == Ast_TypeInfoKind__Module {
            self.FP.pushModule(true, classTypeInfo.FP.GetTxt(nil, nil, nil), Ast_TypeInfo_isMut(classTypeInfo))
            Log_log(Log_Level__Debug, __func__, 3352, Log_CreateMessage(func() string {
    ...
    {
        _exp26093 := metaInfo.GetAt( "__varName2InfoMap" ).(*Lns_luaValue)
        _key26093, _val26093 := _exp26093.Get1stFromMap()
        for _key26093 != nil {
            varName := _key26093.(string)
            varInfo := _val26093.(*Lns_luaValue)
            {
            ...
            _key26093, _val26093 = _exp26093.NextFromMap( _key26093 )
        }
    }
    {
        _exp26125 := metaInfo.GetAt( "__macroName2InfoMap" ).(*Lns_luaValue)
        _key26125, _val26125 := _exp26125.Get1stFromMap()
        for _key26125 != nil {
            orgTypeId := _key26125.(LnsInt)
            macroInfoStem := _val26125
            ...
            _key26125, _val26125 = _exp26125.NextFromMap( _key26125 )
        }
    }
    for range( nameList.Items ) {
        self.FP.popModule()
    ...
    self.importModuleInfo.FP.Remove()
    Log_log(Log_Level__Info, __func__, 3449, Log_CreateMessage(func() string {
...
// 3455: decl @lune.@base.@TransUnit.TransUnit.analyzeImportFor
func (self *TransUnit_TransUnit) analyzeImportFor(pos *Types_Position,modulePath string,assignName string,lazyLoad LnsInt) *Nodes_Node {
    ...
    if moduleSymbolInfo != nil{
        moduleSymbolInfo_7585 := moduleSymbolInfo.(*Ast_SymbolInfo)
        return &Nodes_ImportNode_create(self.nodeManager, pos, self.macroCtrl.FP.IsInAnalyzeArgMode(), NewLnsList([]LnsAny{Ast_TypeInfo2Stem(moduleTypeInfo)}), modulePath, lazyLoad, assignName, moduleSymbolInfo_7585, moduleTypeInfo).Nodes_Node
    }
    self.FP.errorShadowing(pos, shadowing)
    return self.FP.createNoneNode(pos)
}

// 3506: decl @lune.@base.@TransUnit.TransUnit.analyzeImport
func (self *TransUnit_TransUnit) analyzeImport(opeToken *Types_Token) *Nodes_Node {
    ...
    if self.FP.getToken(nil).Txt == "."{
        ...
        if _switch26597 := modeToken.Txt; _switch26597 == "l" {
            lazyLoad = Nodes_LazyLoad__On
            
        } else if _switch26597 == "d" {
    ...
    var node *Nodes_Node
    node = self.FP.analyzeImportFor(opeToken.Pos, modulePath, assignName.Txt, lazyLoad)
    self.importModuleSet.Add(Ast_TypeInfo2Stem(node.FP.Get_expType()))
    return node
}

// 3565: decl @lune.@base.@TransUnit.TransUnit.analyzeTestCase
func (self *TransUnit_TransUnit) analyzeTestCase(firstToken *Types_Token) *Nodes_TestCaseNode {
    ...
    importNode = self.FP.analyzeImportFor(firstToken.Pos, "lune.base.Testing", "__t", Nodes_LazyLoad__Off)
    ...
    
    {
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_Scope).FP.GetTypeInfoChild("Ctrl")})/* 3581:20 */)
        if _ctrlType == nil{
...
// 3601: decl @lune.@base.@TransUnit.TransUnit.analyzeTest
...
// 3620: decl @lune.@base.@TransUnit.TransUnit.analyzeSubfile
...
// 3673: decl @lune.@base.@TransUnit.TransUnit.analyzeIf
func (self *TransUnit_TransUnit) analyzeIf(token *Types_Token) *Nodes_Node {
    ...
    checkCond = func(condExp *Nodes_Node) {
        if _switch27566 := condExp.FP.Get_expType().FP.Get_kind(); _switch27566 == Ast_TypeInfoKind__Nilable || _switch27566 == Ast_TypeInfoKind__Stem {
        } else if _switch27566 == Ast_TypeInfoKind__Prim {
...
// 3735: decl @lune.@base.@TransUnit.TransUnit.processCaseDefault
func (self *TransUnit_TransUnit) processCaseDefault(firstToken *Types_Token,caseKind LnsInt,nextToken *Types_Token,hasCase bool)(LnsAny, bool) {
    var keyword string
    keyword = TransUnit_convExp27790(Lns_2DDD(Lns_getVM().String_gsub(firstToken.Txt,"_", "")))
...
// 3787: decl @lune.@base.@TransUnit.TransUnit.analyzeSwitch
func (self *TransUnit_TransUnit) analyzeSwitch(firstToken *Types_Token) *Nodes_SwitchNode {
    ...
    for (nextToken.Txt == "case") {
        ...
        for _, _condExp := range( condexpList.FP.Get_expList().Items ) {
            ...
            {
                _condLiteral := TransUnit_convExp28335(Lns_2DDD(condExp.FP.GetLiteral()))
                if _condLiteral != nil {
                    condLiteral := _condLiteral
                    var literalObj LnsAny
                    literalObj = Nodes_getLiteralObj(condLiteral)
                    if literalObj != nil{
                        literalObj_7724 := literalObj
                        if condObjSet.Has(literalObj_7724){
                            self.FP.addErrMess(condExp.FP.Get_pos(), Lns_getVM().String_format("multiple case exp -- %s", []LnsAny{literalObj_7724}))
                        } else { 
                            condObjSet.Add(literalObj_7724)
                        }
                    }
                } else {
                    {
...
// 3896: decl @lune.@base.@TransUnit.TransUnit.analyzeMatch
...
// 3991: decl @lune.@base.@TransUnit.TransUnit.analyzeWhile
func (self *TransUnit_TransUnit) analyzeWhile(token *Types_Token) *Nodes_WhileNode {
    ...
    if cond.FP.Get_expType() == Ast_builtinTypeBool{
        {
            _literal := TransUnit_convExp29283(Lns_2DDD(cond.FP.GetLiteral()))
            if _literal != nil {
                literal := _literal
                switch _exp29281 := literal.(type) {
...
// 4015: decl @lune.@base.@TransUnit.TransUnit.analyzeRepeat
...
// 4034: decl @lune.@base.@TransUnit.TransUnit.analyzeFor
...
// 4094: decl @lune.@base.@TransUnit.TransUnit.analyzeApply
func (self *TransUnit_TransUnit) analyzeApply(token *Types_Token) *Nodes_ApplyNode {
    ...
    if Lns_op_not(readyFlag){
        if _switch30143 := itFunc.FP.Get_kind(); _switch30143 == Ast_TypeInfoKind__Func || _switch30143 == Ast_TypeInfoKind__FormFunc || _switch30143 == Ast_TypeInfoKind__Form {
        } else {
...
// 4204: decl @lune.@base.@TransUnit.TransUnit.convToExtTypeList
...
// 4220: decl @lune.@base.@TransUnit.TransUnit.analyzeForeach
func (self *TransUnit_TransUnit) analyzeForeach(token *Types_Token,sortFlag bool) *Nodes_Node {
    ...
    nextToken = Parser_getEofToken()
    {
        var _from30638 LnsInt = 1
        var _to30638 LnsInt = 2
        for _work30638 := _from30638; _work30638 <= _to30638; _work30638++ {
            index := _work30638
    ...
    if _switch30912 := expType.FP.Get_kind(); _switch30912 == Ast_TypeInfoKind__Map {
    ...
    } else if _switch30912 == Ast_TypeInfoKind__Set {
        if subSymToken != nil{
            subSymToken_7919 := subSymToken.(*Types_Token)
            self.FP.addErrMess(subSymToken_7919.Pos, "Set can't use index")
        }
    ...
    } else if _switch30912 == Ast_TypeInfoKind__List || _switch30912 == Ast_TypeInfoKind__Array {
        if sortFlag{
    ...
    if seqSym != nil{
        seqSym_7932 := seqSym.(string)
        scope.FP.Remove(seqSym_7932)
    }
    self.FP.popScope()
    var threading bool
...
// 4341: decl @lune.@base.@TransUnit.TransUnit.analyzeProvide
...
func (self *TransUnit_TransUnit) analyzeScope(firstToken *Types_Token) *Nodes_ScopeNode {
    ...
    if nextToken.Txt == "("{
        ...
        for nextToken.Txt != ")" {
            ...
            if _switch31481 := nextToken.Txt; _switch31481 == ")" {
            } else if _switch31481 == "," {
                nextToken = self.FP.getToken(nil)
...
func (self *TransUnit_TransUnit) analyzeRefTypeWithSymbol(accessMode LnsInt,allowDDD bool,refFlag bool,mutFlag bool,symbolNode *Nodes_Node,parentPub bool) *Nodes_RefTypeNode {
    ...
    for  {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if _switch32814 := typeInfo.FP.Get_kind(); _switch32814 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch32814 == Ast_TypeInfoKind__List {
...
func (self *TransUnit_TransUnit) analyzeDeclArgList(accessMode LnsInt,scope *Ast_Scope,argList *LnsList,parentPub bool) *Types_Token {
    ...
    for {
        ...
        if argName.Txt == "..."{
            ...
            {
                _symbolInfo := TransUnit_convExp33401(Lns_2DDD(scope.FP.AddLocalVar(self.processInfo, true, true, argName.Txt, argName.Pos, refType.FP.Get_expType(), mutable)))
                if _symbolInfo != nil {
                    symbolInfo := _symbolInfo.(*Ast_SymbolInfo)
...
func (self *TransUnit_TransUnit) checkOverrideMethod(overrideType *Ast_TypeInfo,typeInfo *Ast_TypeInfo) *LnsList {
    ...
    if Lns_op_not(matchFlag){
        if err != nil{
            err_8126 := err.(string)
            addErr(Lns_getVM().String_format("mismatch method type -- %s", []LnsAny{err_8126}))
        } else {
...
func (self *TransUnit_TransUnit) checkOverriededMethodOfAllClass() {
    ...
    {
        __collection34142 := typeId2DeclClassNode
        __sorted34142 := __collection34142.CreateKeyListInt()
        __sorted34142.Sort( LnsItemKindInt, nil )
        for _, ___key34142 := range( __sorted34142.Items ) {
            classNode := __collection34142.Items[ ___key34142 ].(Nodes_DeclClassNodeDownCast).ToNodes_DeclClassNode()
            var classTypeInfo *Ast_TypeInfo
...
func (self *TransUnit_TransUnit) CreateAST(parser *Parser_Parser,macroFlag bool,moduleName LnsAny) *TransUnit_ASTInfo {
    ...
    if moduleName != nil{
        moduleName_8196 := moduleName.(string)
        {
            _form34268, _param34268, _prev34268 := Lns_getVM().String_gmatch(moduleName_8196, "[^%.]+")
            for {
                _work34268 := _form34268.(*Lns_luaValue).Call( Lns_2DDD( _param34268, _prev34268 ) )
                _prev34268 = Lns_getFromMulti(_work34268,0)
                if Lns_IsNil( _prev34268 ) { break }
                txt := _prev34268.(string)
    ...
    if moduleName != nil{
        moduleName_8223 := moduleName.(string)
        {
            _form34840, _param34840, _prev34840 := Lns_getVM().String_gmatch(moduleName_8223, "[^%.]+")
            for {
                _work34840 := _form34840.(*Lns_luaValue).Call( Lns_2DDD( _param34840, _prev34840 ) )
                _prev34840 = Lns_getFromMulti(_work34840,0)
                if Lns_IsNil( _prev34840 ) { break }
                self.FP.popModule()
            }
        }
    }
    {
        __collection34932 := TransUnit_createAST__createId2proto_5286_(self.protoFuncMap)
        __sorted34932 := __collection34932.CreateKeyListInt()
        __sorted34932.Sort( LnsItemKindInt, nil )
        for _, ___key34932 := range( __sorted34932.Items ) {
            protoType := __collection34932.Items[ ___key34932 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
    ...
    {
        __collection34970 := TransUnit_createAST__createId2proto_5286_(self.protoClassMap)
        __sorted34970 := __collection34970.CreateKeyListInt()
        __sorted34970.Sort( LnsItemKindInt, nil )
        for _, ___key34970 := range( __sorted34970.Items ) {
            protoType := __collection34970.Items[ ___key34970 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
    ...
    if _switch35058 := self.analyzeMode; _switch35058 == TransUnit_AnalyzeMode__Diag || _switch35058 == TransUnit_AnalyzeMode__Complete || _switch35058 == TransUnit_AnalyzeMode__Inquire {
        Lns_getVM().OS_exit(0)
    }
...
func (self *TransUnit_TransUnit) analyzeDeclMacroSub(accessMode LnsInt,firstToken *Types_Token,nameToken *Types_Token,macroScope *Ast_Scope,parentType *Ast_TypeInfo,workArgList *LnsList) *Nodes_DeclMacroNode {
    ...
    var pubFlag bool
    pubFlag = false
    if _switch35159 := accessMode; _switch35159 == Ast_AccessMode__Pub {
        pubFlag = true
        
    } else if _switch35159 == Ast_AccessMode__Local || _switch35159 == Ast_AccessMode__None {
    } else {
...
func (self *TransUnit_TransUnit) analyzeExtend(accessMode LnsInt,firstPos *Types_Position)(*Types_Token, LnsAny, *LnsList, *LnsMap) {
    ...
    baseTypeInfo = nil
    if baseRef != nil{
        baseRef_8343 := baseRef.(*Nodes_Node)
        baseTypeInfo = baseRef_8343.FP.Get_expType()
...
func (self *TransUnit_TransUnit) analyzePushClass(mode LnsInt,abstractFlag bool,firstToken *Types_Token,name *Types_Token,allowMultiple bool,accessMode LnsInt,altTypeList *LnsList)(*Types_Token, *Ast_TypeInfo) {
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Ast_isPubToExternal(accessMode)) &&
    ...
    if nextToken.Txt == "extend"{
        nextToken, baseTypeInfo, interfaceList = TransUnit_convExp36679(Lns_2DDD(self.FP.analyzeExtend(accessMode, firstToken.Pos)))
        
        if baseTypeInfo != nil{
            baseTypeInfo_8364 := baseTypeInfo.(*Ast_TypeInfo)
            {
                _initTypeInfo := Lns_GetEnv().NilAccFin(Lns_GetEnv().NilAccPush(baseTypeInfo_8364.FP.Get_scope()) && 
                Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_Scope).FP.GetTypeInfoChild("__init")})/* 1004:33 */)
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( baseTypeInfo_8364.FP.IsInheritFrom(self.processInfo, TransUnit_builtinFunc.Lnsthread_, nil)) &&
...
func (self *TransUnit_TransUnit) analyzeDeclAlternateType(belongClassFlag bool,token *Types_Token,accessMode LnsInt)(*Types_Token, *LnsList) {
    ...
    for  {
        ...
        interfaceList = NewLnsList([]LnsAny{})
        if workToken.Txt == ":"{
            workToken, baseTypeInfo, interfaceList = TransUnit_convExp37046(Lns_2DDD(self.FP.analyzeExtend(accessMode, token.Pos)))
...
func (self *TransUnit_TransUnit) analyzeDeclProto(accessMode LnsInt,firstToken *Types_Token) *Nodes_Node {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        var classTypeInfo *Ast_TypeInfo
        nextToken, classTypeInfo = self.FP.analyzePushClass(declMode, abstractFlag, firstToken, name, false, accessMode, altTypeList)
...
// 1135: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclEnum
func (self *TransUnit_TransUnit) analyzeDeclEnum(accessMode LnsInt,firstToken *Types_Token) *Nodes_DeclEnumNode {
    ...
    for nextToken.Txt != "}" {
        ...
        if _switch37568 := (prevValTypeInfo); _switch37568 == Ast_builtinTypeReal {
        } else if _switch37568 == Ast_builtinTypeInt || _switch37568 == Ast_headTypeInfo {
        ...
        if nextToken.Txt == "="{
            ...
            if literal != nil{
                literal_8438 := literal
                switch _exp37690 := literal_8438.(type) {
                ...
                default:
                    self.FP.Error(Lns_getVM().String_format("illegal enum val -- %s", []LnsAny{literal_8438.(LnsAlgeVal).GetTxt()}))
                }
            } else {
            ...
            if _switch37778 := (prevValTypeInfo); _switch37778 == Ast_headTypeInfo {
                valTypeInfo = Ast_builtinTypeInt
                
            } else if _switch37778 == Ast_builtinTypeInt || _switch37778 == Ast_builtinTypeReal {
        ...
        if workEnumTypeInfo != nil{
            workEnumTypeInfo_8454 := workEnumTypeInfo.(*Ast_EnumTypeInfo)
            scope.FP.AddEnumVal(self.processInfo, valName.Txt, valName.Pos, &workEnumTypeInfo_8454.Ast_TypeInfo)
            ...
            workEnumTypeInfo_8454.FP.AddEnumValInfo(enumValInfo)
        }
        if nextToken.Txt == "}"{
            break
        }
...
// 1265: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclAlge
...
// 1341: decl @lune.@base.@TransUnit.TransUnit.analyzeAlias
func (self *TransUnit_TransUnit) analyzeAlias(accessMode LnsInt,firstToken *Types_Token) *Nodes_AliasNode {
    ...
    if symbolInfoList.Len() >= 1{
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if _switch38827 := symbolInfo.FP.Get_kind(); _switch38827 == Ast_SymbolKind__Typ || _switch38827 == Ast_SymbolKind__Fun {
                ...
                if aliasSymbolInfo != nil{
                    aliasSymbolInfo_8510 := aliasSymbolInfo.(*Ast_SymbolInfo)
                    newTypeInfo = aliasSymbolInfo_8510.FP.Get_typeInfo()
                    
                    newSymbolInfo = aliasSymbolInfo_8510
...
// 1405: decl @lune.@base.@TransUnit.TransUnit.analyzeRetTypeList
...
// 1438: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclForm
...
// 1489: decl @lune.@base.@TransUnit.TransUnit.analyzeDecl
...
// 1567: decl @lune.@base.@TransUnit.TransUnit.checkPublic
...
// 1589: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclMember
func (self *TransUnit_TransUnit) analyzeDeclMember(classTypeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,firstToken *Types_Token) *Nodes_DeclMemberNode {
    ...
    if _switch40014 := nextToken.Txt; _switch40014 == "mut" {
        mutMode = Ast_MutMode__Mut
        
        nextToken = self.FP.getToken(nil)
        
    } else if _switch40014 == "allmut" {
    ...
    if token.Txt == "{"{
        ...
        analyzeAccessorMode = func()(LnsInt, *Ast_TypeInfo, *Types_Token) {
            ...
            var workToken *Types_Token
            workToken = self.FP.getToken(nil)
            if _switch40272 := workToken.Txt; _switch40272 == "pub" || _switch40272 == "pri" || _switch40272 == "pro" || _switch40272 == "local" {
        ...
        if nextToken.Txt == ","{
            ...
            Log_log(Log_Level__Debug, __func__, 1675, Log_CreateMessage(func() string {
    ...
    if shadowing != nil{
        shadowing_8643 := shadowing.(*Ast_SymbolInfo)
        self.FP.errorShadowing(varName.Pos, shadowing_8643)
    }
...
// 1719: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclMethod
...
// 1740: decl @lune.@base.@TransUnit.TransUnit.addDefaultConstructor
...
// 1816: decl @lune.@base.@TransUnit.TransUnit.analyzeFuncBlock
func (self *TransUnit_TransUnit) analyzeFuncBlock(analyzingState LnsInt,firstToken *Types_Token,classTypeInfo LnsAny,funcTypeInfo *Ast_TypeInfo,funcName string,funcBodyScope *Ast_Scope,retTypeInfoList *LnsList) *Nodes_BlockNode {
    ...
    if retTypeInfoList.Len() != 0{
        ...
        if retTypeInfoList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo() != Ast_builtinTypeNeverRet{
            if _switch41313 := breakKind; _switch41313 == Nodes_BreakKind__Return || _switch41313 == Nodes_BreakKind__NeverRet {
            } else {
...
// 1879: decl @lune.@base.@TransUnit.TransUnit.analyzeClassBody
func (self *TransUnit_TransUnit) analyzeClassBody(hasProto bool,classAccessMode LnsInt,firstToken *Types_Token,mode LnsInt,gluePrefix LnsAny,classTypeInfo *Ast_TypeInfo,name *Types_Token,moduleName LnsAny,lazyLoad LnsInt,nextToken *Types_Token)(*Nodes_DeclClassNode, *Types_Token, *LnsSet) {
    ...
    processLuneControl = func() {
        ...
        var pragma LnsAny
        if _switch42712 := nextToken.Txt; _switch42712 == "default__init" {
        ...
        } else if _switch42712 == "default__init_old" {
    ...
    if _switch43246 := mode; _switch43246 == TransUnit_DeclClassMode__Module || _switch43246 == TransUnit_DeclClassMode__LazyModule {
    } else {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
func (self *TransUnit_TransUnit) analyzeDeclClass(classAbstructFlag bool,classAccessMode LnsInt,firstToken *Types_Token,mode LnsInt) *Nodes_DeclClassNode {
    if mode == TransUnit_DeclClassMode__Module{
        if self.FP.getToken(nil).Txt == "."{
            if _switch43324 := self.FP.getToken(nil).Txt; _switch43324 == "l" {
                mode = TransUnit_DeclClassMode__LazyModule
                
            } else if _switch43324 == "d" {
    ...
    if _switch43426 := mode; _switch43426 == TransUnit_DeclClassMode__Module || _switch43426 == TransUnit_DeclClassMode__LazyModule {
    } else {
        if _switch43424 := self.FP.getCurrentNamespaceTypeInfo().FP.Get_kind(); _switch43424 == Ast_TypeInfoKind__IF || _switch43424 == Ast_TypeInfoKind__Class || _switch43424 == Ast_TypeInfoKind__Module {
        } else if _switch43424 == Ast_TypeInfoKind__Func || _switch43424 == Ast_TypeInfoKind__Method {
            if _switch43410 := classAccessMode; _switch43410 == Ast_AccessMode__Pub || _switch43410 == Ast_AccessMode__Global {
    ...
    var nextToken *Types_Token
    var classTypeInfo *Ast_TypeInfo
    nextToken,classTypeInfo = self.FP.analyzePushClass(mode, classAbstructFlag, firstToken, name, true, classAccessMode, altTypeList)
    var hasProto bool
    ...
    var lazyLoad LnsInt
    if _switch43949 := mode; _switch43949 == TransUnit_DeclClassMode__LazyModule {
        lazyLoad = Nodes_LazyLoad__On
        
    } else if _switch43949 == TransUnit_DeclClassMode__Module || _switch43949 == TransUnit_DeclClassMode__Class || _switch43949 == TransUnit_DeclClassMode__Interface {
        lazyLoad = Nodes_LazyLoad__Off
    ...
    for _, _advertiseInfo := range( node.FP.Get_advertiseList().Items ) {
        ...
        if _switch44542 := memberType.FP.Get_kind(); _switch44542 == Ast_TypeInfoKind__Class || _switch44542 == Ast_TypeInfoKind__IF {
...
// 2565: decl @lune.@base.@TransUnit.TransUnit.addMethod
...
// 2574: decl @lune.@base.@TransUnit.TransUnit.processAddFunc
...
// 2671: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclFunc
func (self *TransUnit_TransUnit) analyzeDeclFunc(declFuncMode LnsInt,abstractFlag bool,overrideFlag bool,accessMode LnsInt,staticFlag bool,classTypeInfo LnsAny,firstToken *Types_Token,name LnsAny) *Nodes_Node {
    ...
    if token.Txt == "."{
        ...
        if name != nil{
            name_9052 := name.(*Types_Token)
            var className string
            className = name_9052.Txt
            classTypeInfo = self.scope.FP.GetTypeInfoChild(className)
            
            if classTypeInfo != nil{
                classTypeInfo_9055 := classTypeInfo.(*Ast_TypeInfo)
                self.FP.pushClassScope(name_9052.Pos, classTypeInfo_9055)
            } else {
    ...
    if classTypeInfo != nil{
        ...
        if _switch45858 := (Lns_unwrap( name).(*Types_Token)).Txt; _switch45858 == "__init" {
            isCtorFlag = true
    ...
    var parentPub bool
    if classTypeInfo != nil{
        classTypeInfo_9084 := classTypeInfo.(*Ast_TypeInfo)
        parentPub = Ast_isPubToExternal(classTypeInfo_9084.FP.Get_accessMode())
    ...
    if classTypeInfo != nil{
        classTypeInfo_9095 := classTypeInfo.(*Ast_TypeInfo)
        alt2typeMap = classTypeInfo_9095.FP.CreateAlt2typeMap(false)
    ...
    funcName = ""
    if name != nil{
        name_9107 := name.(*Types_Token)
        funcName = name_9107.Txt
        
        if kind == Nodes_NodeKind_get_DeclFunc(){
            if _switch46445 := accessMode; _switch46445 == Ast_AccessMode__Pub || _switch46445 == Ast_AccessMode__Global {
    ...
    var funcSym LnsAny
    {
        ...
        if name != nil{
            name_9116 := name.(*Types_Token)
            var workSym *Ast_SymbolInfo
            workSym = self.FP.processAddFunc(kind == Nodes_NodeKind_get_DeclFunc(), funcBodyScope.FP.Get_parent(), name_9116, workTypeInfo, alt2typeMap)
    ...
    if overrideFlag{
        ...
        if name != nil{
            name_9129 := name.(*Types_Token)
            if Lns_op_not(TransUnit_CantOverrideMethods.Has(name_9129.Txt)){
                if Lns_isCondTrue( self.scope.FP.Get_parent().FP.GetTypeInfoField(name_9129.Txt, false, funcBodyScope, Ast_ScopeAccess__Full)){
                    self.FP.addErrMess(firstToken.Pos, "mismatch override --" + funcName)
                } else { 
                    {
                        _ifFunc := self.scope.FP.Get_parent().FP.GetSymbolInfoIfField(name_9129.Txt, funcBodyScope, Ast_ScopeAccess__Full)
                        if _ifFunc != nil {
    ...
    if token.Txt == ";"{
        ...
        if isCtorFlag{
            if classTypeInfo != nil{
                classTypeInfo_9154 := classTypeInfo.(*Ast_TypeInfo)
                if classTypeInfo_9154.FP.Get_baseTypeInfo() != Ast_headTypeInfo{
                    var needCall bool
                    needCall = true
                    for _, _stmt := range( workBody.FP.Get_stmtList().Items ) {
                        stmt := _stmt.(Nodes_NodeDownCast).ToNodes_Node()
                        if _switch47014 := stmt.FP.Get_kind(); _switch47014 == Nodes_nodeKindEnum__ExpCallSuperCtor {
                            needCall = false
                            
                        } else if _switch47014 == Nodes_nodeKindEnum__BlankLine {
                        } else {
                            break
                        }
                    }
    ...
    createDeclFuncInfo = func(funcKind LnsInt) *Nodes_DeclFuncInfo {
        ...
        if classTypeInfo != nil{
            classTypeInfo_9169 := classTypeInfo.(*Ast_TypeInfo)
            classDeclNode = self.typeInfo2ClassNode.Items[classTypeInfo_9169]
    ...
    if _switch47366 := (kind); _switch47366 == Nodes_NodeKind_get_DeclConstr() {
        var info *Nodes_DeclFuncInfo
    ...
    } else if _switch47366 == Nodes_NodeKind_get_DeclDestr() {
        var info *Nodes_DeclFuncInfo
    ...
    } else if _switch47366 == Nodes_NodeKind_get_DeclMethod() {
        var info *Nodes_DeclFuncInfo
    ...
    } else if _switch47366 == Nodes_NodeKind_get_ProtoMethod() {
        var info *Nodes_DeclFuncInfo
        info = createDeclFuncInfo(Nodes_FuncKind__Mtd)
    ...
    } else if _switch47366 == Nodes_NodeKind_get_DeclFunc() {
        var info *Nodes_DeclFuncInfo
...
// 3087: decl @lune.@base.@TransUnit.TransUnit.createExpListNode
...
// 3121: decl @lune.@base.@TransUnit.TransUnit.checkLiteralEmptyCollection
...
// 3136: decl @lune.@base.@TransUnit.TransUnit.accessSymbol
...
// 3174: decl @lune.@base.@TransUnit.TransUnit.analyzeInitExp
func (self *TransUnit_TransUnit) analyzeInitExp(firstPos *Types_Position,accessMode LnsInt,unwrapFlag bool,letVarList *LnsList,typeInfoList *LnsList)(*LnsList, *LnsList, *LnsList, LnsAny) {
    ...
    if expList != nil{
        expList_9242 := expList.(*Nodes_ExpListNode)
        if unwrapFlag{
            var hasNilable bool
            hasNilable = false
            for _index, _ := range( letVarList.Items ) {
                index := _index + 1
                if expList_9242.FP.GetExpTypeAt(index).FP.Get_nilable(){
                    hasNilable = true
        ...
        for _index, _expType := range( workList.FP.Get_expTypeList().Items ) {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                {
                    var _from48185 LnsInt = index
                    var _to48185 LnsInt = letVarList.Len()
                    for _work48185 := _from48185; _work48185 <= _to48185; _work48185++ {
                        subIndex := _work48185
                        var argType *Ast_TypeInfo
        ...
        }
        {
            ...
            alt2typeMap = Ast_CanEvalCtrlTypeInfo_createDefaultAlt2typeMap(false)
            {
                __exp := self.FP.checkImplicitCast(alt2typeMap, true, typeInfoList, workList, TransUnit_checkImplicitCastCallback_1263_(TransUnit_analyzeInitExp___anonymous_5868_))
                if __exp != nil {
        ...
        for _index, _typeInfo := range( expTypeList.Items ) {
            ...
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                if _switch49003 := workType.FP.Get_kind(); _switch49003 == Ast_TypeInfoKind__Func {
                    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                } else if _switch49003 == Ast_TypeInfoKind__List || _switch49003 == Ast_TypeInfoKind__Array || _switch49003 == Ast_TypeInfoKind__Set || _switch49003 == Ast_TypeInfoKind__Map {
...
// 3435: decl @lune.@base.@TransUnit.TransUnit.analyzeLetAndInitExp
func (self *TransUnit_TransUnit) analyzeLetAndInitExp(firstPos *Types_Position,letFlag bool,initMutable LnsInt,accessMode LnsInt,unwrapFlag bool)(*LnsList, *LnsList, *LnsList, LnsAny) {
    ...
    if letFlag{
        ...
        for  {
            ...
            if verSym != nil{
                verSym_9349 := verSym.(*Ast_SymbolInfo)
                letVarList.Insert(TransUnit_LetVarInfo2Stem(NewTransUnit_LetVarInfo(verSym_9349.FP.Get_mutMode(), symbolToken, nil)))
                typeInfoList.Insert(Ast_TypeInfo2Stem(verSym_9349.FP.Get_typeInfo()))
            } else {
...
// 3510: decl @lune.@base.@TransUnit.TransUnit.analyzeDeclVar
func (self *TransUnit_TransUnit) analyzeDeclVar(mode LnsInt,accessMode LnsInt,firstToken *Types_Token) *Nodes_Node {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if expList != nil{
            expList_9375 := expList.(*Nodes_ExpListNode)
            var typeInfo *Ast_TypeInfo
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( expList_9375.FP.Get_expList().Len() == 1) &&
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Func) ).(bool)){
                var valExp *Nodes_Node
                valExp = expList_9375.FP.Get_expList().GetAt(1).(Nodes_NodeDownCast).ToNodes_Node()
                {
    ...
    if unwrapFlag{
        ...
        self.FP.popScope()
        if unwrapBlock != nil{
            unwrapBlock_9424 := unwrapBlock.(*Nodes_BlockNode)
            if _switch50517 := mode; _switch50517 == Nodes_DeclVarMode__Let || _switch50517 == Nodes_DeclVarMode__Sync {
                var breakKind LnsInt
                breakKind = unwrapBlock_9424.FP.GetBreakKind(Nodes_CheckBreakMode__Normal)
                for _, _symbolInfo := range( symbolInfoList.Items ) {
                    ...
                    if breakKind != Nodes_BreakKind__None{
                        ...
                        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                            ...
                            if Lns_op_not(symbolInfo.FP.Get_hasValueFlag()){
                                self.FP.addErrMess(unwrapBlock_9424.FP.Get_pos(), "This variable isn't set -- " + (symbolInfo.FP.Get_name()))
                            }
                        }
                    }
                }
            } else if _switch50517 == Nodes_DeclVarMode__Unwrap {
                for _, _symbolInfo := range( symbolInfoList.Items ) {
                    symbolInfo := _symbolInfo.(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 3739: decl @lune.@base.@TransUnit.TransUnit.analyzeIfUnwrap
func (self *TransUnit_TransUnit) analyzeIfUnwrap(firstToken *Types_Token) *Nodes_IfUnwrapNode {
    ...
    if workExpList != nil{
        workExpList_9459 := workExpList.(*Nodes_ExpListNode)
        expList = workExpList_9459
...
// 3832: decl @lune.@base.@TransUnit.TransUnit.analyzeWhen
...
func (self *TransUnit_TransUnit) analyzeExpOneRVal(allowNoneType bool,skipOp2Flag bool,opLevel LnsAny,expectType LnsAny) *Nodes_Node {
    ...
    if expectType != nil{
        expectType_9530 := expectType.(*Ast_TypeInfo)
        if _switch51760 := expectType_9530.FP.Get_kind(); _switch51760 == Ast_TypeInfoKind__IF || _switch51760 == Ast_TypeInfoKind__Class {
            ...
            exceptOrgType = expectType_9530.FP.Get_nonnilableType().FP.Get_srcTypeInfo()
            if expOrgType.FP.IsInheritFrom(self.processInfo, exceptOrgType, nil){
                exp = &Nodes_ExpCastNode_create(self.nodeManager, exp.FP.Get_pos(), self.macroCtrl.FP.IsInAnalyzeArgMode(), NewLnsList([]LnsAny{Ast_TypeInfo2Stem(expectType_9530)}), exp, expectType_9530, Nodes_CastKind__Implicit).Nodes_Node
...
func (self *TransUnit_TransUnit) createExpList(pos *Types_Position,expTypeList *LnsList,expList *LnsList,followOn bool,abbrNode LnsAny) *Nodes_ExpListNode {
    ...
    if abbrNode != nil{
        abbrNode_9568 := abbrNode.(*Nodes_AbbrNode)
        workList.Insert(Nodes_AbbrNode2Stem(abbrNode_9568))
    }
...
func (self *TransUnit_TransUnit) analyzeExpList(allowNoneType bool,skipOp2Flag bool,canLeftExp bool,expNode LnsAny,expectTypeList LnsAny,contExpect LnsAny) *Nodes_ExpListNode {
    ...
    expTypeList = NewLnsList([]LnsAny{})
    if expNode != nil{
        expNode_9583 := expNode.(*Nodes_Node)
        pos = expNode_9583.FP.Get_pos()
        
        expList.Insert(Nodes_Node2Stem(expNode_9583))
        expTypeList.Insert(Ast_TypeInfo2Stem(expNode_9583.FP.Get_expType()))
    }
    var index LnsInt
    index = 1
    var abbrNode LnsAny
    ...
    for {
        ...
        if expectTypeList != nil{
            expectTypeList_9590 := expectTypeList.(*LnsList)
            if expectTypeList_9590.Len() > 0{
                var checkIndex LnsInt
                checkIndex = index
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( index > expectTypeList_9590.Len()) &&
                    Lns_GetEnv().SetStackVal( contExpect) )){
                    checkIndex = expectTypeList_9590.Len()
                    
                }
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( checkIndex <= expectTypeList_9590.Len()) &&
                    Lns_GetEnv().SetStackVal( expectTypeList_9590.GetAt(checkIndex).(Ast_TypeInfoDownCast).ToAst_TypeInfo() != Ast_builtinTypeNone) ).(bool)){
                    expectType = expectTypeList_9590.GetAt(checkIndex).(Ast_TypeInfoDownCast).ToAst_TypeInfo()
...
func (self *TransUnit_TransUnit) analyzeExpRefItem(token *Types_Token,exp *Nodes_Node,nilAccess bool) *Nodes_Node {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( expType.FP.Get_kind() == Ast_TypeInfoKind__List) ).(bool){
        {
            _indexLit := TransUnit_convExp53353(Lns_2DDD(indexExp.FP.GetLiteral()))
            if _indexLit != nil {
                indexLit := _indexLit
                switch _exp53351 := indexLit.(type) {
                case *Nodes_Literal__Int:
                val := _exp53351.Val1
                    if val <= 0{
                ...
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    ...
                    if expNode.FP.Get_kind() != Nodes_NodeKind_get_Abbr(){
                        ...
                        if dstType.FP.Get_kind() == Ast_TypeInfoKind__DDD{
                            ...
                            argTypeList = NewLnsList([]LnsAny{})
                            {
                                var _from53702 LnsInt = index
                                var _to53702 LnsInt = expNodeList.Len()
                                for _work53702 := _from53702; _work53702 <= _to53702; _work53702++ {
                                    workIndex := _work53702
    ...
    for _index, _expNode := range( expNodeList.Items ) {
        ...
        if dstTypeList.Len() >= index{
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                {
                    var _from54033 LnsInt = index
                    var _to54033 LnsInt = dstTypeList.Len()
                    for _work54033 := _from54033; _work54033 <= _to54033; _work54033++ {
                        dstIndex := _work54033
                        workNode = expNode
...
func (self *TransUnit_TransUnit) checkMatchType(message string,pos *Types_Position,dstTypeList *LnsList,expListNode LnsAny,allowDstShort bool,warnForFollow bool,workAlt2typeMap LnsAny)(LnsInt, *LnsMap, LnsAny, *LnsList) {
    ...
    if workAlt2typeMap != nil{
        workAlt2typeMap_9764 := workAlt2typeMap.(*LnsMap)
        alt2typeMap = workAlt2typeMap_9764
    ...
    if _switch54618 := result; _switch54618 == Ast_MatchType__Error {
        self.FP.addErrMess(pos, Lns_getVM().String_format("%s: %s", []LnsAny{message, mess}))
    } else if _switch54618 == Ast_MatchType__Warn {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    if expListNode != nil{
        expListNode_9773 := expListNode.(*Nodes_ExpListNode)
        ...
        if result != Ast_MatchType__Error{
            {
                _workList := self.FP.checkImplicitCast(alt2typeMap, false, dstTypeList, expListNode_9773, TransUnit_checkImplicitCastCallback_1263_(func(dstType *Ast_TypeInfo,expNode *Nodes_Node) LnsAny {
...
func (self *TransUnit_TransUnit) checkMatchValType(pos *Types_Position,funcTypeInfo *Ast_TypeInfo,expList LnsAny,genericTypeList *LnsList,genericsClass LnsAny)(LnsInt, *LnsMap, LnsAny) {
    ...
    if funcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Ext{
        ...
        if extTypeList != nil{
            extTypeList_9806 := extTypeList.(*LnsList)
            argTypeList = extTypeList_9806
            
        } else {
            self.FP.addErrMess(pos, Lns_getVM().String_format("not support argType on Luaval -- %s", []LnsAny{mess}))
        }
    }
    if _switch55078 := funcTypeInfo; _switch55078 == TransUnit_builtinFunc.List_insert || _switch55078 == TransUnit_builtinFunc.Set_add || _switch55078 == TransUnit_builtinFunc.Set_del {
    } else if _switch55078 == TransUnit_builtinFunc.List_sort {
    ...
    } else if _switch55078 == TransUnit_builtinFunc.List_remove {
    }
    var warnForFollow bool
    warnForFollow = true
    if expList != nil{
        expList_9815 := expList.(*Nodes_ExpListNode)
        if expList_9815.FP.Get_followOn(){
            warnForFollow = false
    ...
    if funcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Method{
        if genericsClass != nil{
            genericsClass_9820 := genericsClass.(*Ast_TypeInfo)
            if funcTypeInfo.FP.Get_rawTxt() == "__init"{
                alt2typeMap = genericsClass_9820.FP.CreateAlt2typeMap(true)
                
            } else { 
                if funcTypeInfo.FP.Get_itemTypeInfoList().Len() == 0{
                    alt2typeMap = genericsClass_9820.FP.CreateAlt2typeMap(false)
                    
                } else { 
                    alt2typeMap = genericsClass_9820.FP.CreateAlt2typeMap(true)
                    
                    for _, _itemType := range( genericsClass_9820.FP.Get_itemTypeInfoList().Items ) {
                        itemType := _itemType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    matchResult,_,newExpNodeList = TransUnit_convExp55269(Lns_2DDD(self.FP.checkMatchType(funcTypeInfo.FP.GetTxt(nil, nil, nil), pos, argTypeList, expList, false, warnForFollow, alt2typeMap)))
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
func (self *TransUnit_TransUnit) analyzeListItems(firstPos *Types_Position,nextToken *Types_Token,termTxt string,expectTypeList LnsAny)(LnsAny, *Ast_TypeInfo) {
    ...
    switch _exp55461 := itemCommonType.(type) {
    ...
    if Lns_op_not(expectTypeList){
        ...
        expTypeList = NewLnsList([]LnsAny{})
        if expList != nil{
            expList_9859 := expList.(*Nodes_ExpListNode)
            for _index, _expNode := range( expList_9859.FP.Get_expList().Items ) {
                index := _index + 1
                expNode := _expNode.(Nodes_NodeDownCast).ToNodes_Node()
                if index == expList_9859.FP.Get_expList().Len(){
                    if expNode.FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__DDD{
                        expTypeList.Insert(Ast_TypeInfo2Stem(expNode.FP.Get_expType()))
                    } else { 
                        {
                            var _from55569 LnsInt = 1
                            var _to55569 LnsInt = expNode.FP.Get_expTypeList().Len()
                            for _work55569 := _from55569; _work55569 <= _to55569; _work55569++ {
        ...
        var workExpList LnsAny
        _,_,workExpList = TransUnit_convExp55614(Lns_2DDD(self.FP.checkMatchType("List constructor", firstPos, expTypeList, expList, false, false, nil)))
        if workExpList != nil{
            workExpList_9873 := workExpList.(*Nodes_ExpListNode)
            expList = workExpList_9873
...
func (self *TransUnit_TransUnit) analyzeSetConst(token *Types_Token,expectType LnsAny) *Nodes_Node {
    ...
    if itemTypeInfo.FP.Get_nilable(){
        if expList != nil{
            expList_9905 := expList.(*Nodes_ExpListNode)
            for _, _exp := range( expList_9905.FP.Get_expList().Items ) {
                exp := _exp.(Nodes_NodeDownCast).ToNodes_Node()
                var expType *Ast_TypeInfo
                expType = exp.FP.Get_expType()
...
func (self *TransUnit_TransUnit) evalMacroOp(firstToken *Types_Token,macroTypeInfo *Ast_TypeInfo,expList LnsAny,evalMacroCallback Macro_EvalMacroCallback) {
    ...
    if parser != nil{
        parser_9955 := parser.(*Parser_Parser)
        self.parser = NewParser_DefaultPushbackParser(parser_9955)
...
func (self *TransUnit_TransUnit) prepareExpCall(position *Types_Position,funcTypeInfo *Ast_TypeInfo,genericTypeList *LnsList,genericsClass *Ast_TypeInfo)(*LnsMap, LnsAny) {
    ...
    if work.Txt != ")"{
        ...
        self.FP.checkNextToken(")")
        if argList != nil{
            argList_10063 := argList.(*Nodes_ExpListNode)
            for _, _argNode := range( argList_10063.FP.Get_expList().Items ) {
                argNode := _argNode.(Nodes_NodeDownCast).ToNodes_Node()
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
func (self *TransUnit_TransUnit) checkArgForStringForm(firstToken *Types_Token,argList *Nodes_ExpListNode) {
    ...
    if argList.FP.Get_expList().Len() > 0{
        ...
        {
            _literal := TransUnit_convExp57722(Lns_2DDD(argNode.FP.GetLiteral()))
            if _literal != nil {
                literal := _literal
                switch _exp57720 := literal.(type) {
                case *Nodes_Literal__Str:
                val := _exp57720.Val1
                    formatTxt = val
...
func (self *TransUnit_TransUnit) processFunc(firstToken *Types_Token,nextToken *Types_Token,refFieldNode LnsAny,funcExp *Nodes_Node,funcType *Ast_TypeInfo,alt2typeMap *LnsMap,genericTypeList *LnsList,genericsClass *Ast_TypeInfo,argList LnsAny) *Nodes_Node {
    ...
    if _switch58308 := (funcTypeInfo.FP.Get_kind()); _switch58308 == Ast_TypeInfoKind__Method || _switch58308 == Ast_TypeInfoKind__Func || _switch58308 == Ast_TypeInfoKind__Form || _switch58308 == Ast_TypeInfoKind__FormFunc {
    } else {
        {
            _extType := Ast_ExtTypeInfoDownCastF(funcTypeInfo.FP)
            if _extType != nil {
                extType := _extType.(*Ast_ExtTypeInfo)
                if _switch58280 := (extType.FP.Get_extedType().FP.Get_kind()); _switch58280 == Ast_TypeInfoKind__Method || _switch58280 == Ast_TypeInfoKind__Func || _switch58280 == Ast_TypeInfoKind__Form || _switch58280 == Ast_TypeInfoKind__FormFunc {
                } else {
    ...
    if refFieldNode != nil{
        refFieldNode_10155 := refFieldNode.(*Nodes_RefFieldNode)
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            prefixType = refFieldNode_10155.FP.Get_prefix().FP.Get_expType()
    ...
    if argList != nil{
        argList_10171 := argList.(*Nodes_ExpListNode)
        if _switch58680 := funcTypeInfo; _switch58680 == TransUnit_builtinFunc.String_format {
            self.FP.checkArgForStringForm(firstToken, argList_10171)
        } else if _switch58680 == TransUnit_builtinFunc.List_sort || _switch58680 == TransUnit_builtinFunc.Array_sort {
            self.FP.checkArgForSort(firstToken, genericTypeList, argList_10171)
        }
    }
    ...
    if funcSymbol != nil{
        funcSymbol_10179 := funcSymbol.(*Ast_SymbolInfo)
        if funcSymbol_10179.FP.Get_name() == "super"{
            return &Nodes_ExpCallSuperNode_create(self.nodeManager, firstToken.Pos, self.macroCtrl.FP.IsInAnalyzeArgMode(), retTypeInfoList, funcSymbol_10179.FP.Get_typeInfo().FP.Get_parentInfo(), funcSymbol_10179.FP.Get_typeInfo(), argList).Nodes_Node
        }
    }
    if funcType.FP.Get_kind() == Ast_TypeInfoKind__Ext{
        ...
        if work != nil{
            work_10185 := work.(*LnsList)
            retTypeInfoList = work_10185
...
func (self *TransUnit_TransUnit) analyzeExpCall(firstToken *Types_Token,funcExp *Nodes_Node,nextToken *Types_Token)(*Nodes_Node, *Types_Token) {
    ...
    if funcTypeInfo.FP.Equals(self.processInfo, TransUnit_builtinFunc.List_insert, nil, nil){
        if argList != nil{
            ...
            if argList_10210.FP.Get_expType().FP.Get_nilable(){
                self.FP.addErrMess(argList_10210.FP.Get_pos(), "list can't insert nilable")
            }
        }
    }
    if funcTypeInfo.FP.Equals(self.processInfo, TransUnit_builtinFunc.Set_add, nil, nil){
        if argList != nil{
            argList_10214 := argList.(*Nodes_ExpListNode)
            if argList_10214.FP.Get_expType().FP.Get_nilable(){
                self.FP.addErrMess(argList_10214.FP.Get_pos(), "set can't add nilable")
            }
        }
...
func (self *TransUnit_TransUnit) analyzeExpCast(firstToken *Types_Token,opTxt string,exp *Nodes_Node) *Nodes_Node {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if _switch59547 := castType.FP.Get_kind(); _switch59547 == Ast_TypeInfoKind__IF || _switch59547 == Ast_TypeInfoKind__Class || _switch59547 == Ast_TypeInfoKind__Prim {
        } else {
            if opTxt != "@@="{
...
func (self *TransUnit_TransUnit) analyzeExpCont(firstToken *Types_Token,exp *Nodes_Node,skipFlag bool,canLeftExp bool) *Nodes_Node {
    ...
    if Lns_op_not(skipFlag){
        ...
        if _switch60230 := nextToken.Txt; _switch60230 == "@@" || _switch60230 == "@@@" || _switch60230 == "@@=" {
...
func (self *TransUnit_TransUnit) analyzeAccessClassField(classTypeInfo *Ast_TypeInfo,mode LnsInt,token *Types_Token)(*Ast_TypeInfo, LnsAny, bool) {
    if _switch60425 := classTypeInfo.FP.Get_kind(); _switch60425 == Ast_TypeInfoKind__List {
        classTypeInfo = Ast_builtinTypeList
        
    } else if _switch60425 == Ast_TypeInfoKind__Array {
        classTypeInfo = Ast_builtinTypeArray
        
    } else if _switch60425 == Ast_TypeInfoKind__Set {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if fieldSymbolInfo != nil{
            fieldSymbolInfo_10297 := fieldSymbolInfo.(*Ast_SymbolInfo)
            if (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( fieldSymbolInfo_10297.FP.Get_kind() == Ast_SymbolKind__Mtd) ||
                Lns_GetEnv().SetStackVal( fieldSymbolInfo_10297.FP.Get_kind() == Ast_SymbolKind__Fun) ).(bool)){
                var retTypeList *LnsList
                retTypeList = fieldSymbolInfo_10297.FP.Get_typeInfo().FP.Get_retTypeInfoList()
                symbolInfo = fieldSymbolInfo_10297
                ...
                if fieldSymbolInfo_10297.FP.Get_typeInfo().FP.Get_argTypeInfoList().Len() > 0{
                    self.FP.addErrMess(token.Pos, Lns_getVM().String_format("can't use '$' with -- %s", []LnsAny{fieldSymbolInfo_10297.FP.Get_typeInfo().FP.GetTxt(nil, nil, nil)}))
                }
                getterFlag = true
    ...
    if Lns_op_not(symbolInfo){
        ...
        if symbolInfo != nil{
            symbolInfo_10308 := symbolInfo.(*Ast_SymbolInfo)
            fieldTypeInfo = symbolInfo_10308.FP.Get_typeInfo()
    ...
    if symbolInfo != nil{
        symbolInfo_10315 := symbolInfo.(*Ast_SymbolInfo)
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            errorMess = nil
            if Lns_isCondTrue( self.protoFuncMap.Items[symbolInfo_10315.FP.Get_typeInfo()]){
                errorMess = Lns_getVM().String_format("It can't call prototype function from static -- %s", []LnsAny{symbolInfo_10315.FP.Get_name()})
                
            }
            if errorMess != nil{
                errorMess_10320 := errorMess.(string)
                self.FP.addErrMess(token.Pos, errorMess_10320)
            }
            ...
            if Lns_isCondTrue( self.protoFuncMap.Items[symbolInfo_10315.FP.Get_typeInfo()]){
                ...
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( symbolInfo_10315.FP.Get_typeInfo().FP.Get_kind() == Ast_TypeInfoKind__Method) &&
                    Lns_GetEnv().SetStackVal( symbolInfo_10315.FP.Get_scope() == classScope) ).(bool)){
                    for _, _val := range( classScope.FP.Get_symbol2SymbolInfoMap().Items ) {
                        ...
                        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                            ...
                            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                                ...
                                errorMess = Lns_getVM().String_format("Set member(%s) before to access the method-- %s", []LnsAny{val.FP.Get_name(), symbolInfo_10315.FP.Get_name()})
            ...
            if errorMess != nil{
                errorMess_10331 := errorMess.(string)
                self.FP.addErrMess(token.Pos, errorMess_10331)
            }
        }
    }
...
func (self *TransUnit_TransUnit) dumpComp(writer Writer_Writer,pattern string,symbolInfo *Ast_SymbolInfo,getterFlag bool) bool {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if getterFlag{
            ...
            if _switch61101 := (symbolInfo.FP.Get_kind()); _switch61101 == Ast_SymbolKind__Mtd || _switch61101 == Ast_SymbolKind__Fun || _switch61101 == Ast_SymbolKind__Mac {
            ...
            } else if _switch61101 == Ast_SymbolKind__Mbr {
            ...
            typeInfo = symbolInfo.FP.Get_typeInfo()
            writer.Write("type", Lns_getVM().String_format("%s", []LnsAny{Ast_SymbolKind_getTxt( symbolInfo.FP.Get_kind())}))
            if _switch61323 := (symbolInfo.FP.Get_kind()); _switch61323 == Ast_SymbolKind__Fun || _switch61323 == Ast_SymbolKind__Mtd || _switch61323 == Ast_SymbolKind__Mac {
                writer.Write("displayTxt", typeInfo.FP.Get_display_stirng_with(symbolInfo.FP.Get_name(), nil))
            } else if _switch61323 == Ast_SymbolKind__Mbr || _switch61323 == Ast_SymbolKind__Var || _switch61323 == Ast_SymbolKind__Arg {
                var name string
            ...
            } else if _switch61323 == Ast_SymbolKind__Typ {
    ...
    scope.FP.FilterTypeInfoField(true, self.scope, self.scopeAccess, Ast_filterForm(func(symbolInfo *Ast_SymbolInfo) bool {
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if getterPattern != nil{
                getterPattern_10383 := getterPattern.(string)
                if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    ...
                    if retList.Len() == 1{
                        return self.FP.dumpComp(writer, getterPattern_10383, symbolInfo, true)
                    }
                }
                return true
            }
...
func (self *TransUnit_TransUnit) checkComp(token *Types_Token,callback TransUnit_checkCompForm_6409_) {
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        currentModule = TransUnit_convExp61637(Lns_2DDD(Lns_getVM().String_gsub(self.parser.FP.GetStreamName(),"%.lns", "")))
        currentModule = TransUnit_convExp61652(Lns_2DDD(Lns_getVM().String_gsub(currentModule,".*/", "")))
        
        var target string
        target = TransUnit_convExp61667(Lns_2DDD(Lns_getVM().String_gsub(self.analyzeModule,"[^%.]+%.", "")))
        if currentModule == target{
            ...
            var prefix string
            prefix = TransUnit_convExp61707(Lns_2DDD(Lns_getVM().String_gsub(token.Txt,"lune$", "")))
...
func (self *TransUnit_TransUnit) checkFieldComp(getterFlag bool,token *Types_Token,prefixExp *Nodes_Node) {
    ...
    self.FP.checkComp(token, TransUnit_checkCompForm_6409_(func(jsonWriter *Writer_JSON,prefix string) {
...
func (self *TransUnit_TransUnit) analyzeExpField(firstToken *Types_Token,fieldToken *Types_Token,mode LnsInt,prefixExp *Nodes_Node) *Nodes_Node {
    ...
    if accessNil{
        ...
        if _switch62534 := prefixExpType.FP.Get_kind(); _switch62534 == Ast_TypeInfoKind__Set || _switch62534 == Ast_TypeInfoKind__Enum || _switch62534 == Ast_TypeInfoKind__Alge {
    ...
    var symbolInfo LnsAny
    symbolInfo = nil
    if _switch63232 := prefixExpType.FP.Get_kind(); _switch63232 == Ast_TypeInfoKind__Class || _switch63232 == Ast_TypeInfoKind__Module || _switch63232 == Ast_TypeInfoKind__IF || _switch63232 == Ast_TypeInfoKind__List || _switch63232 == Ast_TypeInfoKind__Array || _switch63232 == Ast_TypeInfoKind__Set || _switch63232 == Ast_TypeInfoKind__Box || _switch63232 == Ast_TypeInfoKind__Alternate {
        var getterFlag bool
        getterFlag = false
    ...
    } else if _switch63232 == Ast_TypeInfoKind__Enum || _switch63232 == Ast_TypeInfoKind__Alge {
        var scope *Ast_Scope
    ...
    } else if _switch63232 == Ast_TypeInfoKind__Map {
    ...
    if symbolInfo != nil{
        symbolInfo_10545 := symbolInfo.(*Ast_SymbolInfo)
        if prefixSymbolInfoList.Len() == 1{
            var prefixSymbolInfo *Ast_SymbolInfo
            prefixSymbolInfo = prefixSymbolInfoList.GetAt(1).(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
            if prefixSymbolInfo.FP.Get_kind() == Ast_SymbolKind__Typ{
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( Lns_op_not(symbolInfo_10545.FP.Get_staticFlag())) &&
                    Lns_GetEnv().SetStackVal( symbolInfo_10545.FP.Get_kind() != Ast_SymbolKind__Typ) ).(bool)){
                    self.FP.addErrMess(fieldToken.Pos, Lns_getVM().String_format("Type can't access this symbol. -- %s", []LnsAny{symbolInfo_10545.FP.Get_name()}))
                }
            } else if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( symbolInfo_10545.FP.Get_staticFlag()) &&
                Lns_GetEnv().SetStackVal( symbolInfo_10545.FP.Get_typeInfo().FP.Get_kind() != Ast_TypeInfoKind__Method) ).(bool)){
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            Lns_GetEnv().SetStackVal( Lns_op_not(symbolInfo_10545.FP.Get_staticFlag())) &&
            Lns_GetEnv().SetStackVal( symbolInfo_10545.FP.Get_kind() == Ast_SymbolKind__Mtd) &&
            Lns_GetEnv().SetStackVal( symbolInfo_10545.FP.Get_mutable()) ).(bool)){
    ...
    if symbolInfo != nil{
        symbolInfo_10555 := symbolInfo.(*Ast_SymbolInfo)
        var workSymInfo *Ast_AccessSymbolInfo
        workSymInfo = NewAst_AccessSymbolInfo(symbolInfo_10555, &Ast_OverrideMut__Prefix{prefixExpType}, Lns_op_not(accessNil))
        ...
        if _switch63491 := mode; _switch63491 == TransUnit_ExpSymbolMode__Field || _switch63491 == TransUnit_ExpSymbolMode__FieldNil {
            symbolMutMode = symbolInfo_10555.FP.Get_mutMode()
...
func (self *TransUnit_TransUnit) analyzeNewAlge(firstToken *Types_Token,algeTypeInfo *Ast_AlgeTypeInfo,prefix LnsAny) *Nodes_NewAlgeValNode {
    ...
    self.FP.checkAlgeComp(symbolToken, algeTypeInfo)
    {
        ...
        if _valInfo != nil {
            ...
            {
                _, _, _newExpNodeList := TransUnit_convExp64072(Lns_2DDD(self.FP.checkMatchType("call", symbolToken.Pos, valInfo.FP.Get_typeList(), argListNode, false, true, nil)))
...
func (self *TransUnit_TransUnit) analyzeExpSymbol(firstToken *Types_Token,symbolToken *Types_Token,mode LnsInt,prefixExp LnsAny,skipFlag bool,canLeftExp bool) *Nodes_Node {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( mode == TransUnit_ExpSymbolMode__GetNil) ).(bool){
        if prefixExp != nil{
            prefixExp_10619 := prefixExp.(*Nodes_Node)
            exp = self.FP.analyzeExpField(firstToken, symbolToken, mode, prefixExp_10619)
            
            var expType *Ast_TypeInfo
            expType = exp.FP.Get_expType()
            if prefixExp_10619.FP.Get_expType().FP.IsModule(){
                {
        ...
        if self.macroCtrl.FP.Get_analyzeInfo().FP.IsAnalyzingSymArg(){
            ...
            
            {
                ...
                if _symbolInfo == nil{
                    if self.analyzeMode != TransUnit_AnalyzeMode__Diag{
                        ...
                        self.scope.FP.FilterSymbolTypeInfo(self.scope, self.moduleScope, self.scopeAccess, Ast_filterForm(TransUnit_analyzeExpSymbol___anonymous_6497_))
                    }
            ...
            var typeInfo *Ast_TypeInfo
            typeInfo = symbolInfo.FP.Get_typeInfo()
            if _switch64694 := symbolInfo.FP.Get_kind(); _switch64694 == Ast_SymbolKind__Typ {
                {
            ...
            } else if _switch64694 == Ast_SymbolKind__Var {
...
func (self *TransUnit_TransUnit) analyzeExpOpSet(exp *Nodes_Node,opeToken *Types_Token,expectTypeList *LnsList) *Nodes_Node {
    ...
    listRefItemNode = nil
    {
        ...
        if _symNodeList != nil {
            ...
            for _, _symNode := range( symNodeList.FP.Get_expList().Items ) {
                ...
                {
                    _refItemNode := TransUnit_analyzeExpOpSet__process_6511_(symNode)
                    if _refItemNode != nil {
                        refItemNode := _refItemNode.(*Nodes_ExpRefItemNode)
            ...
            listRefItemNode = TransUnit_analyzeExpOpSet__process_6511_(exp)
    ...
    if workList != nil{
        workList_10698 := workList.(*Nodes_ExpListNode)
        expList = workList_10698
    ...
    for _index, _symbolInfo := range( exp.FP.GetSymbolInfo().Items ) {
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if _switch65541 := symbolInfo.FP.Get_kind(); _switch65541 == Ast_SymbolKind__Var {
                if symbolInfo.FP.Get_typeInfo() == Ast_builtinTypeEmpty{
                    var expType *Ast_TypeInfo
                    expType = expTypeList.GetAt(index).(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                    if _switch65472 := expType.FP.Get_kind(); _switch65472 == Ast_TypeInfoKind__DDD {
                        if expType.FP.Get_itemTypeInfoList().Len() > 0{
                            expType = expType.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo().FP.Get_nilableTypeInfo()
                            
                        }
                    } else if _switch65472 == Ast_TypeInfoKind__List || _switch65472 == Ast_TypeInfoKind__Array || _switch65472 == Ast_TypeInfoKind__Set || _switch65472 == Ast_TypeInfoKind__Map {
                        var workPos *Types_Position
                        if index <= expList.FP.Get_expList().Len(){
            ...
            } else if _switch65541 == Ast_SymbolKind__Mbr {
                initSymSet.Add(Ast_SymbolInfo2Stem(symbolInfo))
            }
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    if listRefItemNode != nil{
        listRefItemNode_10720 := listRefItemNode.(*Nodes_ExpRefItemNode)
        var index LnsAny
        {
            _indexNode := listRefItemNode_10720.FP.Get_index()
            if _indexNode != nil {
                indexNode := _indexNode.(*Nodes_Node)
                index = &Nodes_IndexVal__NodeIdx{indexNode}
                
            } else {
                index = &Nodes_IndexVal__SymIdx{Lns_unwrap( listRefItemNode_10720.FP.Get_symbol()).(string)}
                
            }
        }
        return &Nodes_ExpSetItemNode_create(self.nodeManager, exp.FP.Get_pos(), self.macroCtrl.FP.IsInAnalyzeArgMode(), NewLnsList([]LnsAny{Ast_TypeInfo2Stem(Ast_builtinTypeNone)}), listRefItemNode_10720.FP.Get_val(), index, &expList.Nodes_Node).Nodes_Node
    }
...
func (self *TransUnit_TransUnit) analyzeExpOpEquals(pos *Types_Position,opToken *Types_Token,exp1 *Nodes_Node,exp2 *Nodes_Node)(*Nodes_Node, *Nodes_Node) {
    ...
    nonNilType1 = TransUnit_analyzeExpOpEquals__getType_6541_(exp1Type)
    var nonNilType2 *Ast_TypeInfo
    nonNilType2 = TransUnit_analyzeExpOpEquals__getType_6541_(exp2Type)
    ...
    for  {
        ...
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if Parser_isOp2(opTxt){
                ...
                if _switch68046 := opTxt; _switch68046 == "or" {
                    var is3op bool
                    {
                    ...
                    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        ...
                        {
                            _literal := TransUnit_convExp67173(Lns_2DDD(exp2.FP.GetLiteral()))
                            if _literal != nil {
                                literal := _literal
                ...
                } else if _switch68046 == "<" || _switch68046 == ">" || _switch68046 == "<=" || _switch68046 == ">=" {
                    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                } else if _switch68046 == "~=" || _switch68046 == "==" {
                    exp, exp2 = self.FP.analyzeExpOpEquals(firstToken.Pos, opToken, exp, exp2)
                    
                    retType = Ast_builtinTypeBool
                    
                } else if _switch68046 == "^" || _switch68046 == "|" || _switch68046 == "~" || _switch68046 == "&" || _switch68046 == "|<<" || _switch68046 == "|>>" {
                ...
                } else if _switch68046 == "+" || _switch68046 == "-" || _switch68046 == "*" || _switch68046 == "/" || _switch68046 == "%" {
                    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        Lns_GetEnv().SetStackVal( (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                var threading bool
                if _switch68079 := opTxt; _switch68079 == "and" || _switch68079 == "or" {
                    threading = self.FP.checkThreading(firstToken.Pos)
...
func (self *TransUnit_TransUnit) analyzeExpUnwrap(firstToken *Types_Token) *Nodes_Node {
    ...
    if insNode != nil{
        insNode_10942 := insNode.(*Nodes_Node)
        var insType *Ast_TypeInfo
        insType = insNode_10942.FP.Get_expType()
        if insType.FP.Get_nilable(){
            self.FP.addErrMess(insNode_10942.FP.Get_pos(), Lns_getVM().String_format("default can't use nilable -- %s", []LnsAny{insType.FP.GetTxt(nil, nil, nil)}))
        }
        var alt2type *LnsMap
    ...
    if Ast_isExtType(expType.FP.Get_nonnilableType()){
        switch _exp69361 := self.processInfo.FP.CreateLuaval(unwrapType, false).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp69361.Val1
            unwrapType = work
...
func (self *TransUnit_TransUnit) analyzeStrConst(firstToken *Types_Token,token *Types_Token) *Nodes_Node {
    ...
    if nextToken.Kind != Types_TokenKind__Eof{
        ...
        if nextToken.Txt == "("{
            ...
            var workExpList LnsAny
            _,_,workExpList = TransUnit_convExp69495(Lns_2DDD(self.FP.checkMatchType("str constructor", firstToken.Pos, NewLnsList([]LnsAny{Ast_TypeInfo2Stem(Ast_builtinTypeDDD)}), argNodeList, false, false, nil)))
            if workExpList != nil{
                workExpList_10972 := workExpList.(*Nodes_ExpListNode)
                dddParam = workExpList_10972
            ...
            if param != nil{
                param_10975 := param.(*Nodes_ExpListNode)
                self.FP.checkStringFormat(token.Pos, token.Txt, param_10975.FP.Get_expTypeList())
            }
        } else { 
            param = nil
...
func (self *TransUnit_TransUnit) analyzeExp(allowNoneType bool,skipOp2Flag bool,canLeftExp bool,prevOpLevel LnsAny,expectType LnsAny) *Nodes_Node {
            ...
            if _enumTyepInfo != nil {
                ...
                self.FP.checkEnumComp(nextToken, enumTyepInfo)
                {
                    ...
                    if _valInfo != nil {
                        ...
                        if aliasType != nil{
                            aliasType_11008 := aliasType.(*Ast_AliasTypeInfo)
                            expType = &aliasType_11008.Ast_TypeInfo
    ...
    processsNewExp = func(token *Types_Token) *Nodes_Node {
        ...
        if _switch70161 := classTypeInfo.FP.Get_kind(); _switch70161 == Ast_TypeInfoKind__Class || _switch70161 == Ast_TypeInfoKind__IF {
        ...
        if classTypeInfo.FP.Get_externalFlag(){
            if _switch70193 := classTypeInfo.FP.Get_accessMode(); _switch70193 == Ast_AccessMode__Pri || _switch70193 == Ast_AccessMode__Local {
    ...
    processOp1 = func(token *Types_Token)(*Nodes_Node, bool) {
        ...
        if _switch71080 := (token.Txt); _switch71080 == "-" {
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    if token.Kind == Types_TokenKind__Dlmt{
        if token.Txt == "."{
            if expectType != nil{
                expectType_11085 := expectType.(*Ast_TypeInfo)
                var orgExpectType *Ast_TypeInfo
                orgExpectType = expectType_11085
...
func (self *TransUnit_TransUnit) analyzeReturn(token *Types_Token) *Nodes_ReturnNode {
    ...
    }
    {
        ...
        if _workList != nil {
            workList := _workList.(*Nodes_ExpListNode)
            {
                _, _, _newExpNodeList := TransUnit_convExp72501(Lns_2DDD(self.FP.checkMatchType("return", token.Pos, retTypeList, workList, false, Lns_op_not(workList.FP.Get_followOn()), nil)))
                if _newExpNodeList != nil {
                    newExpNodeList := _newExpNodeList.(*Nodes_ExpListNode)
...
func (self *TransUnit_TransUnit) analyzeStatement(termTxt LnsAny) LnsAny {
    ...
    if statement != nil{
        statement_11207 := statement.(*Nodes_Node)
        if Lns_op_not(statement_11207.FP.CanBeStatement()){
            self.FP.addErrMess(statement_11207.FP.Get_pos(), Lns_getVM().String_format("This node can't be statement. -- %s", []LnsAny{Nodes_getNodeKindName(statement_11207.FP.Get_kind())}))
        }
    }
    self.commentCtrl.FP.Pop()
    return statement
...
func (self *TransUnit_ImportParam) GetTypeInfo(typeId LnsInt)(LnsAny, LnsAny) {
    ...
    }
    {
        ...
        if _atom != nil {
            ...
            if typeInfo != nil{
                typeInfo_6164 := typeInfo.(*Ast_TypeInfo)
                self.TypeId2TypeInfo.Set(typeId,typeInfo_6164)
            }
...
func (self *TransUnit__TypeInfo) CreateTypeInfoCache(param *TransUnit_ImportParam)(LnsAny, LnsAny) {
    ...
    if typeInfo != nil{
        typeInfo_6149 := typeInfo.(*Ast_TypeInfo)
        param.TypeId2TypeInfo.Set(self.TypeId,typeInfo_6149)
    }
    return typeInfo, mess
}
...
func (self *TransUnit__TypeInfoExt) CreateTypeInfo(param *TransUnit_ImportParam)(LnsAny, LnsAny) {
    ...
    var newTypeInfo *Ast_TypeInfo
    switch _exp6172 := param.ProcessInfo.FP.CreateLuaval(extedType, true).(type) {
    case *Ast_LuavalResult__OK:
    extType := _exp6172.Val1
        newTypeInfo = extType
...
func (self *TransUnit__TypeInfoModifier) CreateTypeInfo(param *TransUnit_ImportParam)(LnsAny, LnsAny) {
    ...
    {
        _srcTypeInfo := TransUnit_convExp6238(Lns_2DDD(param.FP.GetTypeInfo(self.SrcTypeId)))
        if _srcTypeInfo == nil{
...
func (self *TransUnit__TypeInfoModule) CreateTypeInfo(param *TransUnit_ImportParam)(LnsAny, LnsAny) {
    ...
    if self.ParentId != Ast_rootTypeId{
        ...
        {
            _workTypeInfo := TransUnit_convExp6336(Lns_2DDD(param.FP.GetTypeInfo(self.ParentId)))
    ...
    newTypeInfo = parentScope.FP.GetTypeInfoChild(self.Txt)
    {
        ...
        if __exp != nil {
            ...
            Log_log(Log_Level__Info, __func__, 1537, Log_CreateMessage(func() string {
...
func (self *TransUnit__TypeInfoNormal) CreateTypeInfo(param *TransUnit_ImportParam)(LnsAny, LnsAny) {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if self.ParentId != Ast_rootTypeId{
            ...
            {
                _workTypeInfo := TransUnit_convExp6834(Lns_2DDD(param.FP.GetTypeInfo(self.ParentId)))
                if _workTypeInfo == nil{
        ...
        for _index, _typeId := range( self.ArgTypeId.Items ) {
            ...
            if argType != nil{
                argType_6366 := argType.(*Ast_TypeInfo)
                argTypeInfo.Insert(Ast_TypeInfo2Stem(argType_6366))
            } else {
                var errmess string
        ...
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( self.Kind == Ast_TypeInfoKind__Class) ||
                Lns_GetEnv().SetStackVal( self.Kind == Ast_TypeInfoKind__IF) ).(bool){
                Log_log(Log_Level__Debug, __func__, 1641, Log_CreateMessage(func() string {
                ...
                param.TypeId2TypeInfo.Set(self.TypeId,workTypeInfo)
                if _switch7749 := self.Kind; _switch7749 == Ast_TypeInfoKind__Func || _switch7749 == Ast_TypeInfoKind__Method || _switch7749 == Ast_TypeInfoKind__Macro || _switch7749 == Ast_TypeInfoKind__Form || _switch7749 == Ast_TypeInfoKind__FormFunc {
                    var symbolKind LnsInt
                    symbolKind = Ast_SymbolKind__Fun
                    if _switch7687 := self.Kind; _switch7687 == Ast_TypeInfoKind__Method {
                        symbolKind = Ast_SymbolKind__Mtd
                        
                    } else if _switch7687 == Ast_TypeInfoKind__Macro {
                        symbolKind = Ast_SymbolKind__Mac
                        
                    } else if _switch7687 == Ast_TypeInfoKind__Form || _switch7687 == Ast_TypeInfoKind__FormFunc {
                        symbolKind = Ast_SymbolKind__Typ
...
func (self *TransUnit__TypeInfoEnum) CreateTypeInfo(param *TransUnit_ImportParam)(LnsAny, LnsAny) {
    ...
    getEnumLiteral = func(val LnsAny) LnsAny {
        if _switch8046 := valTypeInfo; _switch8046 == Ast_builtinTypeInt {
            return &Ast_EnumLiteral__Int{Lns_forceCastInt(val)}
        } else if _switch8046 == Ast_builtinTypeReal {
            return &Ast_EnumLiteral__Real{Lns_forceCastReal(val)}
        } else if _switch8046 == Ast_builtinTypeString {
...
func (self *TransUnit_BuiltinFuncType) RegisterClass(classInfo *Ast_TypeInfo) {
    ...
    if _switch14232 := classInfo.FP.Get_rawTxt(); _switch14232 == "" {
        self.Lns_ = classInfo
        
    } else if _switch14232 == "iStream" {
        self.Istream_ = classInfo
        
    } else if _switch14232 == "oStream" {
        self.Ostream_ = classInfo
        
    } else if _switch14232 == "luaStream" {
        self.Luastream_ = classInfo
        
    } else if _switch14232 == "Mapping" {
        self.Mapping_ = classInfo
        
    } else if _switch14232 == "__pipe" {
        self.__pipe_ = classInfo
        
    } else if _switch14232 == "LnsThread" {
        self.Lnsthread_ = classInfo
        
    } else if _switch14232 == "io" {
        self.Io_ = classInfo
        
    } else if _switch14232 == "package" {
        self.Package_ = classInfo
        
    } else if _switch14232 == "os" {
        self.Os_ = classInfo
        
    } else if _switch14232 == "string" {
        self.String_ = classInfo
        
    } else if _switch14232 == "str" {
        self.Str_ = classInfo
        
    } else if _switch14232 == "List" {
        self.List_ = classInfo
        
    } else if _switch14232 == "Array" {
        self.Array_ = classInfo
        
    } else if _switch14232 == "Set" {
        self.Set_ = classInfo
        
    } else if _switch14232 == "math" {
        self.Math_ = classInfo
        
    } else if _switch14232 == "debug" {
        self.Debug_ = classInfo
        
    } else if _switch14232 == "Nilable" {
