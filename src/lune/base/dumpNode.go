...
// 91: decl @lune.@base.@dumpNode.createFilter
...
// 98: decl @lune.@base.@dumpNode.filter
...
// 528: decl @lune.@base.@dumpNode.getTypeListTxt
...
// 853: decl @lune.@base.@dumpNode.Ast2Dump
...
func (self *dumpNode_dumpFilter) dump(opt *DumpNode_Opt,node *Nodes_Node,txt string) {
    ...
    self.FP.writeln(opt, Lns_getVM().String_format(": %s:%d %s %s %s", []LnsAny{Nodes_getNodeKindName(node.FP.Get_kind()), node.FP.Get_id(), txt, typeStr, comment}))
}

// 102: decl @lune.@base.@dumpNode.dumpFilter.processNone
...
// 107: decl @lune.@base.@dumpNode.dumpFilter.processLuneControl
...
// 112: decl @lune.@base.@dumpNode.dumpFilter.processBlankLine
...
// 117: decl @lune.@base.@dumpNode.dumpFilter.processLuneKind
...
// 123: decl @lune.@base.@dumpNode.dumpFilter.processImport
...
// 128: decl @lune.@base.@dumpNode.dumpFilter.processRoot
...
// 136: decl @lune.@base.@dumpNode.dumpFilter.processSubfile
func (self *dumpNode_dumpFilter) ProcessSubfile(node *Nodes_SubfileNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, "")
}

// 141: decl @lune.@base.@dumpNode.dumpFilter.processBlockSub
...
// 150: decl @lune.@base.@dumpNode.dumpFilter.processScope
...
// 157: decl @lune.@base.@dumpNode.dumpFilter.processStmtExp
...
// 164: decl @lune.@base.@dumpNode.dumpFilter.processDeclEnum
func (self *dumpNode_dumpFilter) ProcessDeclEnum(node *Nodes_DeclEnumNode,_opt LnsAny) {
    ...
    for _, _name := range( node.FP.Get_valueNameList().Items ) {
        ...
        self.FP.writeln(opt, Lns_getVM().String_format("  %s: %s", []LnsAny{name.Txt, valInfo.FP.Get_val().(LnsAlgeVal).GetTxt()}))
    }
}

// 175: decl @lune.@base.@dumpNode.dumpFilter.processDeclAlge
func (self *dumpNode_dumpFilter) ProcessDeclAlge(node *Nodes_DeclAlgeNode,_opt LnsAny) {
    ...
    {
        __collection863 := algeTypeInfo.FP.Get_valInfoMap()
        __sorted863 := __collection863.CreateKeyListStr()
        __sorted863.Sort( LnsItemKindStr, nil )
        for _, ___key863 := range( __sorted863.Items ) {
            valInfo := __collection863.Items[ ___key863 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            self.FP.writeln(opt, Lns_getVM().String_format("  %s: %s", []LnsAny{algeTypeInfo.FP.Get_rawTxt(), valInfo.FP.Get_name()}))
        }
    }
}

// 185: decl @lune.@base.@dumpNode.dumpFilter.processNewAlgeVal
...
// 194: decl @lune.@base.@dumpNode.dumpFilter.processProtoClass
func (self *dumpNode_dumpFilter) ProcessProtoClass(node *Nodes_ProtoClassNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, node.FP.Get_name().Txt)
}

// 200: decl @lune.@base.@dumpNode.dumpFilter.processDeclClass
...
// 208: decl @lune.@base.@dumpNode.dumpFilter.processDeclMember
...
// 214: decl @lune.@base.@dumpNode.dumpFilter.processExpMacroExp
...
// 223: decl @lune.@base.@dumpNode.dumpFilter.processDeclMacro
...
// 228: decl @lune.@base.@dumpNode.dumpFilter.processExpMacroStat
...
// 238: decl @lune.@base.@dumpNode.dumpFilter.processUnwrapSet
...
// 250: decl @lune.@base.@dumpNode.dumpFilter.processIfUnwrap
...
// 263: decl @lune.@base.@dumpNode.dumpFilter.processWhen
...
// 279: decl @lune.@base.@dumpNode.dumpFilter.processDeclVar
...
// 318: decl @lune.@base.@dumpNode.dumpFilter.processDeclArg
...
// 324: decl @lune.@base.@dumpNode.dumpFilter.processDeclArgDDD
func (self *dumpNode_dumpFilter) ProcessDeclArgDDD(node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, "...")
}

// 329: decl @lune.@base.@dumpNode.dumpFilter.processExpDDD
func (self *dumpNode_dumpFilter) ProcessExpDDD(node *Nodes_ExpDDDNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, "...")
}

// 334: decl @lune.@base.@dumpNode.dumpFilter.processExpSubDDD
...
// 341: decl @lune.@base.@dumpNode.dumpFilter.processDeclForm
...
// 346: decl @lune.@base.@dumpNode.dumpFilter.processDeclFuncInfo
...
// 370: decl @lune.@base.@dumpNode.dumpFilter.processDeclFunc
...
// 403: decl @lune.@base.@dumpNode.dumpFilter.processExpCallSuper
...
// 409: decl @lune.@base.@dumpNode.dumpFilter.processRefType
...
// 417: decl @lune.@base.@dumpNode.dumpFilter.processIf
...
// 429: decl @lune.@base.@dumpNode.dumpFilter.processSwitch
...
// 443: decl @lune.@base.@dumpNode.dumpFilter.processMatch
...
// 458: decl @lune.@base.@dumpNode.dumpFilter.processWhile
...
// 465: decl @lune.@base.@dumpNode.dumpFilter.processRepeat
...
// 472: decl @lune.@base.@dumpNode.dumpFilter.processFor
...
// 483: decl @lune.@base.@dumpNode.dumpFilter.processApply
...
// 495: decl @lune.@base.@dumpNode.dumpFilter.processForeach
...
// 506: decl @lune.@base.@dumpNode.dumpFilter.processForsort
...
// 518: decl @lune.@base.@dumpNode.dumpFilter.processExpUnwrap
...
// 539: decl @lune.@base.@dumpNode.dumpFilter.processExpCall
func (self *dumpNode_dumpFilter) ProcessExpCall(node *Nodes_ExpCallNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, Lns_getVM().String_format("[nilacc:%s] -> %s", []LnsAny{node.FP.Get_nilAccess(), dumpNode_getTypeListTxt_1199_(node.FP.Get_expTypeList())}))
...
// 549: decl @lune.@base.@dumpNode.dumpFilter.processExpList
...
// 570: decl @lune.@base.@dumpNode.dumpFilter.processExpMRet
...
// 577: decl @lune.@base.@dumpNode.dumpFilter.processExpAccessMRet
...
// 583: decl @lune.@base.@dumpNode.dumpFilter.processExpOp1
...
// 590: decl @lune.@base.@dumpNode.dumpFilter.processExpToDDD
...
// 597: decl @lune.@base.@dumpNode.dumpFilter.processExpMultiTo1
...
// 604: decl @lune.@base.@dumpNode.dumpFilter.processExpCast
...
// 615: decl @lune.@base.@dumpNode.dumpFilter.processExpParen
...
// 621: decl @lune.@base.@dumpNode.dumpFilter.processExpSetVal
...
// 628: decl @lune.@base.@dumpNode.dumpFilter.processExpSetItem
func (self *dumpNode_dumpFilter) ProcessExpSetItem(node *Nodes_ExpSetItemNode,_opt LnsAny) {
    ...
    indexNode = nil
    switch _exp3675 := node.FP.Get_index().(type) {
    ...
    dumpNode_filter_1049_(node.FP.Get_val(), self, opt.FP.NextOpt())
    if indexNode != nil{
        indexNode_5523 := indexNode.(*Nodes_Node)
        dumpNode_filter_1049_(indexNode_5523, self, opt.FP.NextOpt())
    }
    dumpNode_filter_1049_(node.FP.Get_exp2(), self, opt.FP.NextOpt())
}

// 648: decl @lune.@base.@dumpNode.dumpFilter.processExpOp2
...
// 656: decl @lune.@base.@dumpNode.dumpFilter.processExpNew
...
// 666: decl @lune.@base.@dumpNode.dumpFilter.processExpRef
...
// 672: decl @lune.@base.@dumpNode.dumpFilter.processExpRefItem
...
// 681: decl @lune.@base.@dumpNode.dumpFilter.processRefField
...
// 690: decl @lune.@base.@dumpNode.dumpFilter.processExpOmitEnum
...
// 697: decl @lune.@base.@dumpNode.dumpFilter.processGetField
...
// 705: decl @lune.@base.@dumpNode.dumpFilter.processReturn
...
// 715: decl @lune.@base.@dumpNode.dumpFilter.processProvide
...
// 721: decl @lune.@base.@dumpNode.dumpFilter.processAlias
...
// 727: decl @lune.@base.@dumpNode.dumpFilter.processTestCase
...
// 734: decl @lune.@base.@dumpNode.dumpFilter.processTestBlock
...
// 743: decl @lune.@base.@dumpNode.dumpFilter.processBoxing
...
// 750: decl @lune.@base.@dumpNode.dumpFilter.processUnboxing
...
// 757: decl @lune.@base.@dumpNode.dumpFilter.processLiteralList
...
// 765: decl @lune.@base.@dumpNode.dumpFilter.processLiteralSet
...
// 773: decl @lune.@base.@dumpNode.dumpFilter.processLiteralMap
...
// 784: decl @lune.@base.@dumpNode.dumpFilter.processLiteralArray
...
// 792: decl @lune.@base.@dumpNode.dumpFilter.processLiteralChar
...
// 798: decl @lune.@base.@dumpNode.dumpFilter.processLiteralInt
func (self *dumpNode_dumpFilter) ProcessLiteralInt(node *Nodes_LiteralIntNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, Lns_getVM().String_format("%s(%s)", []LnsAny{node.FP.Get_num(), node.FP.Get_token().Txt}))
}

// 804: decl @lune.@base.@dumpNode.dumpFilter.processLiteralReal
func (self *dumpNode_dumpFilter) ProcessLiteralReal(node *Nodes_LiteralRealNode,_opt LnsAny) {
    opt := _opt.(*DumpNode_Opt)
    self.FP.dump(opt, &node.Nodes_Node, Lns_getVM().String_format("%s(%s)", []LnsAny{node.FP.Get_num(), node.FP.Get_token().Txt}))
}

// 810: decl @lune.@base.@dumpNode.dumpFilter.processLiteralString
...
// 820: decl @lune.@base.@dumpNode.dumpFilter.processLiteralBool
