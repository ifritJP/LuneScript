...
Filter[TransUnit.nodeKind.Root] = function ( self, node, parent, baseIndent )
  ...
  local typeId2ClassMap = rootNode:get_typeId2ClassMap(  )
  ...
  do
    ...
    for __index, className in ipairs( __sorted ) do
      ...
      do
        ...
        if not TransUnit.isBuiltin( namespaceInfo.typeInfo:get_typeId(  ) ) then
          self:writeln( "do", baseIndent + stepIndent )
          self:writeln( string.format( "local _classInfo%s = {}", className), baseIndent + stepIndent )
          self:writeln( string.format( "_className2InfoMap.%s = _classInfo%s", className, className), baseIndent + stepIndent )
              ...
              do
                if typeInfo:get_kind(  ) ~= TransUnit.TypeInfoKindMethod then
                  if typeInfo:get_accessMode(  ) == "pub" then
                    self:writeln( string.format( "_classInfo%s.%s = {", className, fieldName), baseIndent + stepIndent )
...
do
  ...
  _classInfoUtil.debugLog = {
    name='debugLog', staticFlag = true, accessMode = 'pub', methodFlag = false, typeId = 4058 }
  _classInfoUtil.errorLog = {
    name='errorLog', staticFlag = true, accessMode = 'pub', methodFlag = false, typeId = 4056 }
  _classInfoUtil.memStream = {
    name='memStream', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 4048 }
  _classInfoUtil.outStream = {
    name='outStream', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 4044 }
  _classInfoUtil.profile = {
    name='profile', staticFlag = true, accessMode = 'pub', methodFlag = false, typeId = 4060 }
  end
do
...
do
  ...
  _classInfobase.Util = {
    name='Util', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 4042 }
  end
do
  local _classInfoconvLua = {}
  _className2InfoMap.convLua = _classInfoconvLua
  _classInfoconvLua.Filter = {
    name='Filter', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 4068 }
  _classInfoconvLua.MacroEvalImp = {
    name='MacroEvalImp', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 4280 }
  _classInfoconvLua.Parser = {
    name='Parser', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 3992 }
  _classInfoconvLua.TransUnit = {
    name='TransUnit', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 110 }
  _classInfoconvLua.Util = {
    name='Util', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 4042 }
  _classInfoconvLua.lune = {
    name='lune', staticFlag = false, accessMode = 'pub', methodFlag = false, typeId = 106 }
  _classInfoconvLua.stepIndent = {
...
_typeInfoList[3] = { parentId = 102, typeId = 104, baseId = 1, txt = 'convLua',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {106, 4068, 4280}, }
...
_typeInfoList[5] = { parentId = 106, typeId = 108, baseId = 1, txt = 'base',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {110, 3992, 4042}, }
...
_typeInfoList[522] = { parentId = 3992, typeId = 4040, baseId = 1, txt = 'lune',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[523] = { parentId = 108, typeId = 4042, baseId = 1, txt = 'Util',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {4044, 4048, 4056, 4058, 4060, 4062, 4064, 4066}, }
_typeInfoList[524] = { parentId = 4042, typeId = 4044, baseId = 1, txt = 'outStream',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {4046}, }
_typeInfoList[525] = { parentId = 4044, typeId = 4046, baseId = 1, txt = 'write',
        staticFlag = false, accessMode = 'pub', kind = 8, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[526] = { parentId = 4042, typeId = 4048, baseId = 4044, txt = 'memStream',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {4050, 4052, 4054}, }
_typeInfoList[527] = { parentId = 4048, typeId = 4050, baseId = 1, txt = '__init',
        staticFlag = false, accessMode = 'pub', kind = 8, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[528] = { parentId = 4048, typeId = 4052, baseId = 1, txt = 'write',
        staticFlag = false, accessMode = 'pub', kind = 8, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[529] = { parentId = 4048, typeId = 4054, baseId = 1, txt = 'get_txt',
        staticFlag = false, accessMode = 'pub', kind = 8, itemTypeId = {}, retTypeId = {18}, children = {}, }
_typeInfoList[530] = { parentId = 4042, typeId = 4056, baseId = 1, txt = 'errorLog',
        staticFlag = true, accessMode = 'pub', kind = 7, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[531] = { parentId = 4042, typeId = 4058, baseId = 1, txt = 'debugLog',
        staticFlag = true, accessMode = 'pub', kind = 7, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[532] = { parentId = 4042, typeId = 4060, baseId = 1, txt = 'profile',
        staticFlag = true, accessMode = 'pub', kind = 7, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[533] = { parentId = 4042, typeId = 4062, baseId = 1, txt = 'Util',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[534] = { parentId = 4042, typeId = 4064, baseId = 1, txt = 'base',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[535] = { parentId = 4042, typeId = 4066, baseId = 1, txt = 'lune',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[536] = { parentId = 104, typeId = 4068, baseId = 1, txt = 'Filter',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {}, }
_typeInfoList[537] = { parentId = 104, typeId = 4280, baseId = 3192, txt = 'MacroEvalImp',
        staticFlag = false, accessMode = 'pub', kind = 6, itemTypeId = {}, retTypeId = {}, children = {4284}, }
_typeInfoList[538] = { parentId = 1, typeId = 4282, baseId = 1, txt = 'Map',
        staticFlag = false, accessMode = 'pub', kind = 5, itemTypeId = {18, 6}, retTypeId = {}, children = {}, }
_typeInfoList[539] = { parentId = 4280, typeId = 4284, baseId = 1, txt = 'eval',
        staticFlag = false, accessMode = 'pub', kind = 8, itemTypeId = {}, retTypeId = {4282}, children = {}, }
----- meta -----
return moduleObj
