...
// 412: decl @lune.@base.@Builtin.Builtin.getTypeInfo
...
// 565: decl @lune.@base.@Builtin.Builtin.processField
...
// 405: decl @lune.@base.@Builtin.BuiltinFuncType.isStrFormFunc
