...
// for 647
func Builtin_convExp0_16330(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 639
func Builtin_convExp0_16211(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 667
func Builtin_convExp0_16396(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 197
func Builtin_convExp0_8076(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 75
...
// for 642
func Builtin_convExp0_16234(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 1081
func Builtin_convExp0_18441(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 813
func Builtin_convExp0_17127(arg1 []LnsAny) []LnsAny {
    return Lns_2DDD( arg1[0:])
}
// for 941
func Builtin_convExp0_17814(arg1 []LnsAny) []LnsAny {
    return Lns_2DDD( arg1[0:])
}



// 990: decl @lune.@base.@Builtin.Builtin.registBuiltInScope.processCopyAlterList
...
func Builtin_setupBuiltinTypeInfo_4_(_env *LnsEnv, name string,fieldName string,symInfo *Ast_SymbolInfo) {
    ...
    Builtin_process___lns_runtime = func(_env *LnsEnv) {
        if _switch0 := fieldName; _switch0 == "dumpLog" {
            ...
            Builtin_builtinFunc.G__lns_runtime_time = typeInfo
            Builtin_builtinFunc.G__lns_runtime_time_sym = symInfo
            Builtin_builtinFunc.FP.register(_env, symInfo)
        }
    }
    ...
    var Builtin_process___lns_it func(_env *LnsEnv)
    Builtin_process___lns_it = func(_env *LnsEnv) {
        if _switch0 := fieldName; _switch0 == "hasNext" {
            Builtin_builtinFunc.G__lns_it_hasNext = typeInfo
            Builtin_builtinFunc.G__lns_it_hasNext_sym = symInfo
            Builtin_builtinFunc.FP.register(_env, symInfo)
        } else if _switch0 == "next" {
            Builtin_builtinFunc.G__lns_it_next = typeInfo
            Builtin_builtinFunc.G__lns_it_next_sym = symInfo
            Builtin_builtinFunc.FP.register(_env, symInfo)
        }
    }
    ...
    Builtin_process_string = func(_env *LnsEnv) {
        if _switch0 := fieldName; _switch0 == "__join" {
            Builtin_builtinFunc.String___join = typeInfo
            Builtin_builtinFunc.String___join_sym = symInfo
            Builtin_builtinFunc.FP.register(_env, symInfo)
        } else if _switch0 == "_join" {
            Builtin_builtinFunc.String__join = typeInfo
            Builtin_builtinFunc.String__join_sym = symInfo
            Builtin_builtinFunc.FP.register(_env, symInfo)
        } else if _switch0 == "byte" {
    ...
    } else if _switch0 == "__lns_it" {
        Builtin_process___lns_it(_env)
...
// 526: decl @lune.@base.@Builtin.Builtin.getTypeInfo
func (self *Builtin_Builtin) getTypeInfo(_env *LnsEnv, typeName string,targetScope LnsAny) *Ast_TypeInfo {
    ...
    Builtin_getTypeInfoFromScope = func(_env *LnsEnv, scope *Ast_Scope,symbol string,genTypeList *LnsList2_[*Ast_TypeInfo]) LnsAny {
        ...
        Builtin_getTypeInfo = func(_env *LnsEnv, workScope *Ast_Scope) LnsAny {
            ...
            if nameList.Len() <= 1{
                ...
                for _index, _name := range( nameList.Items ) {
                    ...
                    if workTypeInfo != nil{
                        workTypeInfo_718 := workTypeInfo.(*Ast_TypeInfo)
                        if index == nameList.Len(){
                            return workTypeInfo_718
                        }
                        {
                            __exp := workTypeInfo_718.FP.Get_scope(_env)
                            if !Lns_IsNil( __exp ) {
        ...
        if validGenType{
            if _switch0 := typeInfo.FP.Get_kind(_env); _switch0 == Ast_TypeInfoKind__Map {
                ...
                return self.processInfo.FP.CreateList_(_env, typeInfo.FP.Get_canDealGenInherit(_env), Ast_AccessMode__Pub, typeInfo.FP.Get_parentInfo(_env), genTypeList, typeInfo.FP.Get_mutMode(_env))
    ...
    if Lns_isCondTrue( Lns_car(_env.GetVM().String_find(typeName,"^&", nil, nil))){
        mutable = false
        typeName = Builtin_convExp0_16211(Lns_2DDD(_env.GetVM().String_gsub(typeName,"^&", "")))
    }
    var genTypeList *LnsList2_[*Ast_TypeInfo]
    genTypeList = NewLnsList2_[*Ast_TypeInfo]([]*Ast_TypeInfo{})
    var endIndex LnsAny
    _,endIndex = Builtin_convExp0_16234(Lns_2DDD(_env.GetVM().String_find(typeName,"[%w%.]+<", nil, nil)))
    var suffix string
    suffix = ""
    if endIndex != nil{
        endIndex_756 := endIndex.(LnsInt)
        var genTypeName string
        genTypeName = _env.GetVM().String_sub(typeName,endIndex_756 + 1, nil)
        for  {
            {
                _tailIndex := Builtin_convExp0_16330(Lns_2DDD(_env.GetVM().String_find(genTypeName,"[,>]", nil, nil)))
        ...
        typeName = _env.GetVM().String_sub(typeName,1, endIndex_756 - 1) + suffix
    }
    var typeInfo *Ast_TypeInfo
    ...
    if Lns_isCondTrue( Lns_car(_env.GetVM().String_find(typeName,"!$", nil, nil))){
        nilable = true
        orgTypeName = Builtin_convExp0_16396(Lns_2DDD(_env.GetVM().String_gsub(typeName,"!$", "")))
    } else { 
        nilable = false
    ...
    }
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            if targetScope != nil{
                targetScope_772 := targetScope.(*Ast_Scope)
                {
                    __exp := Builtin_getTypeInfoFromScope(_env, targetScope_772, orgTypeName, genTypeList)
                    if !Lns_IsNil( __exp ) {
                        _exp := __exp.(*Ast_TypeInfo)
                        typeInfo = _exp
                    }
...
// 695: decl @lune.@base.@Builtin.Builtin.createGenType
...
// 720: decl @lune.@base.@Builtin.Builtin.processField
...
// 852: decl @lune.@base.@Builtin.Builtin.registClass
...
// 922: decl @lune.@base.@Builtin.Builtin.createBuiltinAlge
...
// 968: decl @lune.@base.@Builtin.Builtin.registBuiltInScope
            ...
            if Lns_op_not(builtinModuleName2Scope.Get(name)){
                ...
                }
                {
                    ...
                    for _, _orgFieldName := range( __forsortSorted0.Items ) {
                        ...
                        fieldName = Builtin_convExp0_18441(Lns_2DDD(_env.GetVM().String_gsub(orgFieldName,"<.*", "")))
...
// 1127: decl @lune.@base.@Builtin.Builtin.getBuiltInFuncType
...
func (self *Builtin_BuiltinFuncType) registerClass(_env *LnsEnv, classInfo *Ast_TypeInfo) {
    ...
    var fullname string
    if classInfo.FP.Get_kind(_env) == Ast_TypeInfoKind__Box{
        fullname = "Nilable"
    } else { 
        if classInfo.FP.Get_parentInfo(_env) != Ast_headTypeInfo{
            fullname = Builtin_convExp0_8076(Lns_2DDD(_env.GetVM().String_gsub(Lns_car(_env.GetVM().String_gsub(classInfo.FP.GetParentFullName(_env, Ast_defaultTypeNameCtrl, nil, nil),"@", "")).(string),"%.", "_")))
        } else { 
            fullname = ""
        }
        fullname = fullname + classInfo.FP.Get_rawTxt(_env)
    }
    if _switch0 := fullname; _switch0 == "__Er" {
        ...
        Util_err(_env, _env.GetVM().String_format("unmatch class -- %s", Lns_2DDD(fullname)))
    }
}
// 211: decl @lune.@base.@Builtin.BuiltinFuncType.registerAlge
...
// 519: decl @lune.@base.@Builtin.BuiltinFuncType.isStrFormFunc
...
type Builtin_BuiltinFuncType struct {
    ...
    G__lns_runtime_time *Ast_TypeInfo
    G__lns_runtime_time_sym *Ast_SymbolInfo
    ...
    G__lns_it_ *Ast_TypeInfo
    G__lns_it_hasNext *Ast_TypeInfo
    G__lns_it_hasNext_sym *Ast_SymbolInfo
    G__lns_it_next *Ast_TypeInfo
    G__lns_it_next_sym *Ast_SymbolInfo
    ...
    String___join *Ast_TypeInfo
    String___join_sym *Ast_SymbolInfo
    String__join *Ast_TypeInfo
    String__join_sym *Ast_SymbolInfo
...
func (self *Builtin_BuiltinFuncType) InitBuiltin_BuiltinFuncType(_env *LnsEnv) {
    ...
    self.G__lns_runtime_time = Ast_headTypeInfo
    self.G__lns_runtime_time_sym = Ast_dummySymbol
    ...
    self.G__lns_it_ = Ast_headTypeInfo
    self.G__lns_it_hasNext = Ast_headTypeInfo
    self.G__lns_it_hasNext_sym = Ast_dummySymbol
    self.G__lns_it_next = Ast_headTypeInfo
    self.G__lns_it_next_sym = Ast_dummySymbol
    ...
    self.String___join = Ast_headTypeInfo
    self.String___join_sym = Ast_dummySymbol
    self.String__join = Ast_headTypeInfo
    self.String__join_sym = Ast_dummySymbol
