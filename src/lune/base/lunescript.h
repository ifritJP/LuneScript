 ...
 * @return 関数の戻り値
 */
typedef __lune_stem_t * __lune_func_t( __lune_env_t * pEnv, __lune_stem_t * pInfo, ... );
 ...
 * @return メソッドの戻り値
 */
typedef __lune_stem_t * __lune_method_t( __lune_env_t * pEnv, __lune_stem_t * pObj, ... );
...
extern __lune_stem_t * __lune_int2stem( __lune_env_t * pEnv, __lune_int_t val );
extern __lune_str_t __lune_createLiteralStr( const char * pStr );
extern __lune_stem_t * __lune_str2stem( __lune_env_t * pEnv, __lune_str_t val );
extern __lune_stem_t * __lune_func2stem( __lune_env_t * pEnv, __lune_func_t * pFunc, int num, ... );
extern __lune_stem_t * __lune_createDDD( __lune_env_t * pEnv, int num, ... );


extern __lune_block_t * __lune_enter_func( __lune_env_t * pEnv, int num, int argNum, ... );
extern void __lune_leave_block( __lune_env_t * pEnv );
extern __lune_block_t * __lune_enter_block( __lune_env_t * pEnv, int stemVerNum );
extern void __lune_decre_ref( __lune_env_t * pEnv, __lune_stem_t * pStem );
extern __lune_stem_t * __lune_class_new( __lune_env_t * pEnv, int size );
extern void __lune_class_del( __lune_env_t * pEnv, void * pObj );



extern void __lune_print( __lune_env_t * pEnv, __lune_stem_t * pArg );
