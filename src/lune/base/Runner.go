...
func Runner_RunItem__fromMap_1016_(_env,  arg1 LnsAny, paramList []Lns_ToObjParam)(LnsAny, LnsAny){
   return Runner_RunItem_FromMap( arg1, paramList )
}
func Runner_RunItem__fromStem_1018_(_env,  arg1 LnsAny, paramList []Lns_ToObjParam)(LnsAny, LnsAny){
   return Runner_RunItem_FromMap( arg1, paramList )
}
...
func Runner_RunItem__createPipe_1022_(_env *LnsEnv, arg1 LnsInt) LnsAny{
...
func (self *Runner_Runner) InitRunner_Runner(_env *LnsEnv) {
    self.pipe = Runner_RunItem__createPipe_1022_(_env, 1)
