...
func Ast_LuavalConvKind_get__allList_4172_() *LnsList{
...
func Ast_LuavalConvKind__from_4165_(arg1 LnsInt) LnsAny{
...
// for 5378
func Ast_convExp21647(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6774
func Ast_convExp28918(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp29887(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp30045(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp30211(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp30382(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp30548(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp30754(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp30931(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6909
func Ast_convExp31089(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6948
func Ast_convExp31244(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
func dumpScope__dumpScopeSub_2573_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if __exp != nil {
                ...
                for _, _symbol := range( __sorted6931.Items ) {
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if _subScope != nil {
                            ...
                            dumpScope__dumpScopeSub_2573_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2573_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3044: decl @lune.@base.@Ast.isGenericType
...
// 3252: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp11400 := obj.(type) {
...
// 3973: decl @lune.@base.@Ast.isExtType
...
// 3980: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch14647 := typeInfo.FP.Get_kind(); _switch14647 == Ast_TypeInfoKind__FormFunc || _switch14647 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4083: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId(),typeInfo)
}

// 4087: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_4107_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
...
// 4207: decl @lune.@base.@Ast.isClass
...
// 4276: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_4175_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch16570 := typeInfo.FP.Get_kind(); _switch16570 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_4175_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch16570 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch16570 == Ast_TypeInfoKind__Form || _switch16570 == Ast_TypeInfoKind__IF || _switch16570 == Ast_TypeInfoKind__DDD {
        ...
        return nil, false
    } else if _switch16570 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch16570 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch16570 == Ast_TypeInfoKind__Array || _switch16570 == Ast_TypeInfoKind__List || _switch16570 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_4175_(itemType, convFlag, validToCheck)
            if err != nil{
                err_3757 := err.(string)
                return err_3757, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch16570 == Ast_TypeInfoKind__FormFunc {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
...
// 4387: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch16720 := typeInfo.FP.Get_kind(); _switch16720 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 4410: decl @lune.@base.@Ast.isConditionalbe
...
// 5179: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_4539_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
// 5513: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp22309 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp22309.Val1
...
// 5557: decl @lune.@base.@Ast.isNumberType
...
// 6071: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_5111_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 6600: decl @lune.@base.@Ast.createProcessInfo
...
// 3922: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 3993: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch14727 := mutMode; _switch14727 == Ast_MutMode__IMut || _switch14727 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch14727 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp14793 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp14793.Val1
    ...
    if _switch14860 := mutMode; _switch14860 == Ast_MutMode__IMut || _switch14860 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch14860 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4419: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4465: decl @lune.@base.@Ast.ProcessInfo.createSet
...
// 4478: decl @lune.@base.@Ast.ProcessInfo.createList
...
// 4491: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 4504: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4519: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4540: decl @lune.@base.@Ast.ProcessInfo.createClass
...
// 4569: decl @lune.@base.@Ast.ProcessInfo.createFunc
...
// 4590: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4619: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 4766: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4175_(typeInfo, Ast_LuavalConvKind__InLua, true)))) &&
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( extTypeFlag) ).(bool)){
        switch _exp19080 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp19080.Val1
            typeInfo = work
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4175_(typeInfo, Ast_LuavalConvKind__InLua, true))){
...
// 5170: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5436: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    process = func() LnsAny {
        {
            ...
            if _dddType != nil {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp22027 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp22027.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp22027.Val1
        ...
        var err LnsAny
        var canConv bool
        err, canConv = Ast_failCreateLuavalWith_4175_(luneType, Ast_LuavalConvKind__InLua, validToCheck)
        
        if err != nil{
            err_4642 := err.(string)
            return &Ast_LuavalResult__Err{err_4642}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp22165 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp22165.Val1
...
// 5563: decl @lune.@base.@Ast.ProcessInfo.createEnum
...
// 5630: decl @lune.@base.@Ast.ProcessInfo.createAlge
...
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool)(LnsAny, LnsAny) {
    if _switch5853 := kind; _switch5853 == Ast_SymbolKind__Typ || _switch5853 == Ast_SymbolKind__Fun || _switch5853 == Ast_SymbolKind__Mac {
        ...
        if existSymbol != nil{
            ...
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() != existSymbol_1824.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1824.FP.Get_typeInfo().FP.Get_typeId()))) ).(bool){
...
// 4062: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4211: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4628: decl @lune.@base.@Ast.Scope.addAlias
...
// 4641: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch18552 := typeInfo.FP.Get_kind(); _switch18552 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch18552 == Ast_TypeInfoKind__Form || _switch18552 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch18552 == Ast_TypeInfoKind__Macro {
...
// 4974: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp20248 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp20248.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp20248.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch20438 := type1.FP.Get_kind(); _switch20438 == Ast_TypeInfoKind__List {
        ...
        } else if _switch20438 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch20438 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch20438 == Ast_TypeInfoKind__Map {
...
// 5119: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp20610 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp20610.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp20610.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 5886: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from24111 LnsInt = index
            var _to24111 LnsInt = dstTypeList.Len()
            for _work24111 := _from24111; _work24111 <= _to24111; _work24111++ {
                dstIndex := _work24111
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from24367 LnsInt = index
            var _to24367 LnsInt = expTypeList.Len()
            for _work24367 := _from24367; _work24367 <= _to24367; _work24367++ {
                srcIndex := _work24367
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4934 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4934 <= srcIndex{
                        var workMess string
    ...
    if expTypeList.Len() > 0{
        for _index, _expType := range( expTypeList.Items ) {
            ...
            if dstTypeList.Len() == index{
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4957 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4957 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4978 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4978 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_4988 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_4988
    }
    return Ast_MatchType__Match, ""
}

// 6091: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch25686 := canEvalType; _switch25686 == Ast_CanEvalType__SetEq || _switch25686 == Ast_CanEvalType__SetOp || _switch25686 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch25495 := otherSrc; _switch25495 == Ast_builtinTypeAbbr || _switch25495 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            if _switch25582 := nonNilOtherType.FP.Get_kind(); _switch25582 == Ast_TypeInfoKind__Set || _switch25582 == Ast_TypeInfoKind__Map || _switch25582 == Ast_TypeInfoKind__List || _switch25582 == Ast_TypeInfoKind__IF {
                return false, nil
            } else if _switch25582 == Ast_TypeInfoKind__Class {
                if Ast_builtinTypeString != nonNilOtherType{
                    return false, nil
                }
            } else if _switch25582 == Ast_TypeInfoKind__Prim {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return Ast_isSettableToForm_5111_(processInfo, otherSrc), nil
    }
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( otherSrc == Ast_builtinTypeNil) ||
    ...
    }
    {
        ...
        if _extTypeInfo != nil {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4175_(extTypeInfo.FP.Get_extedType(), Ast_LuavalConvKind__ToLua, false)))) ).(bool)){
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if _switch26342 := otherSrc.FP.Get_kind(); _switch26342 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch26342 == Ast_TypeInfoKind__FormFunc || _switch26342 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_5111_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch26547 := otherSrc.FP.Get_kind(); _switch26547 == Ast_TypeInfoKind__FormFunc || _switch26547 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
    ...
    if _switch27518 := dest.FP.Get_kind(); _switch27518 == Ast_TypeInfoKind__Prim {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch27518 == Ast_TypeInfoKind__List || _switch27518 == Ast_TypeInfoKind__Array || _switch27518 == Ast_TypeInfoKind__Set {
        ...
        return true, nil
    } else if _switch27518 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch27518 == Ast_TypeInfoKind__Class || _switch27518 == Ast_TypeInfoKind__IF {
        ...
        return false, nil
    } else if _switch27518 == Ast_TypeInfoKind__Form {
        return Ast_isSettableToForm_5111_(processInfo, otherSrc), nil
    } else if _switch27518 == Ast_TypeInfoKind__Func || _switch27518 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch27518 == Ast_TypeInfoKind__Method {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return true, nil
    } else if _switch27518 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch27518 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch27518 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, nil
    }
...
// 6585: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 4256: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
func Ast_AutoBoxingInfo____init_2053_() {
...
func Ast_CanEvalCtrlTypeInfo____init_2083_() {
...
// 5713: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
// 2538: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2338 := alt2type.(*LnsMap)
        var otherWork *Ast_TypeInfo
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2338)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2338.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2338)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2338)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2338
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2357 := workAlt2type.(*LnsMap)
            workAlt2type_2357.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2589: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2615: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2381 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2381.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2381)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2625: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2631: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2404 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2404)
    }
    return false
}

// 2659: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2664: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2668: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2672: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2676: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2681: decl @lune.@base.@Ast.AlternateTypeInfo.getParentFullName
...
// 2688: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2700: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4215: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if _genType != nil {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_3705 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_3705, alt2type)).(bool)
            }
...
// 4362: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 2770: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 2774: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 2779: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 2786: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 2797: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4432: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3824 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3824)
    }
    return nil
}

// 5677: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch23175 := canEvalType; _switch23175 == Ast_CanEvalType__SetOp || _switch23175 == Ast_CanEvalType__SetOpIMut || _switch23175 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 2824: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 2867: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 2872: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 2912: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2916: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2919: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2924: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 2985: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 3018: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 3032: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5200: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_4539_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4361 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4361, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
// 3078: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3086: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3090: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
...
// 3097: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch10837 := canEvalType; _switch10837 == Ast_CanEvalType__SetEq || _switch10837 == Ast_CanEvalType__SetOp {
...
// 3127: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4601: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4609: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6501: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5172 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5172, Ast_MutMode__IMut)
    }
    return nil
}
...
// 3222: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
// 3361: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3366: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Items[name]
}

// 3370: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5600: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    {
        __collection22870 := self.name2EnumValInfo
        __sorted22870 := __collection22870.CreateKeyListStr()
        __sorted22870.Sort( LnsItemKindStr, nil )
        for _, ___key22870 := range( __sorted22870.Items ) {
            enumValInfo := __collection22870.Items[ ___key22870 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp22868 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp22868.Val1
...
// 3465: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3487: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 5652: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    firstFlag = true
    {
        __collection23111 := self.valInfoMap
        __sorted23111 := __collection23111.CreateKeyListStr()
        __sorted23111.Sort( LnsItemKindStr, nil )
        for _, ___key23111 := range( __sorted23111.Items ) {
            algeValInfo := __collection23111.Items[ ___key23111 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3475: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3570: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,typeId LnsInt,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3589:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch12913 := kind; _switch12913 == Ast_TypeInfoKind__Set || _switch12913 == Ast_TypeInfoKind__Map || _switch12913 == Ast_TypeInfoKind__List || _switch12913 == Ast_TypeInfoKind__Array || _switch12913 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch12913 == Ast_TypeInfoKind__Class || _switch12913 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        if parentInfo != nil{
            parentInfo_3343 := parentInfo.(*Ast_TypeInfo)
            parentInfo_3343.FP.AddChildren(&self.Ast_TypeInfo)
        }
        var hasNilable bool
        hasNilable = false
        if _switch13015 := (kind); _switch13015 == Ast_TypeInfoKind__Prim || _switch13015 == Ast_TypeInfoKind__List || _switch13015 == Ast_TypeInfoKind__Array || _switch13015 == Ast_TypeInfoKind__Set || _switch13015 == Ast_TypeInfoKind__Map || _switch13015 == Ast_TypeInfoKind__Class || _switch13015 == Ast_TypeInfoKind__Stem || _switch13015 == Ast_TypeInfoKind__Module || _switch13015 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch13015 == Ast_TypeInfoKind__Func || _switch13015 == Ast_TypeInfoKind__Method || _switch13015 == Ast_TypeInfoKind__Form || _switch13015 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3678: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3688: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3692: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3696: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() LnsInt {
    return self.parentInfo.FP.Get_typeId()
}

// 3700: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() LnsInt {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3705: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 3711: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
func (self *Ast_NormalTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    parentTxt = ""
    if typeNameCtrl != nil{
        typeNameCtrl_3398 := typeNameCtrl.(*Ast_TypeNameCtrl)
        parentTxt = self.FP.GetParentFullName(typeNameCtrl_3398, importInfo, localFlag)
...
// 3739: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch13452 := self.kind; _switch13452 == Ast_TypeInfoKind__Func || _switch13452 == Ast_TypeInfoKind__Form || _switch13452 == Ast_TypeInfoKind__FormFunc || _switch13452 == Ast_TypeInfoKind__Method || _switch13452 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 3784: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3789: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 3820: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch13926 := self.kind; _switch13926 == Ast_TypeInfoKind__List || _switch13926 == Ast_TypeInfoKind__Map || _switch13926 == Ast_TypeInfoKind__Array || _switch13926 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 3890: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 3898: decl @lune.@base.@Ast.NormalTypeInfo.create
...
// 4116: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch15339 := kind; _switch15339 == Ast_TypeInfoKind__Array || _switch15339 == Ast_TypeInfoKind__List || _switch15339 == Ast_TypeInfoKind__Set || _switch15339 == Ast_TypeInfoKind__Class || _switch15339 == Ast_TypeInfoKind__Module || _switch15339 == Ast_TypeInfoKind__IF || _switch15339 == Ast_TypeInfoKind__Form || _switch15339 == Ast_TypeInfoKind__FormFunc || _switch15339 == Ast_TypeInfoKind__Func || _switch15339 == Ast_TypeInfoKind__Method || _switch15339 == Ast_TypeInfoKind__Macro {
    ...
    if _switch15437 := kind; _switch15437 == Ast_TypeInfoKind__Array || _switch15437 == Ast_TypeInfoKind__List || _switch15437 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch15437 == Ast_TypeInfoKind__Map {
    ...
    Ast_registBuiltin_4107_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 5779: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch23770 := typeInfo.FP.Get_kind(); _switch23770 == Ast_TypeInfoKind__Prim || _switch23770 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch23770 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch23770 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch23770 == Ast_TypeInfoKind__Class || _switch23770 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch23770 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch23770 == Ast_TypeInfoKind__List || _switch23770 == Ast_TypeInfoKind__Array || _switch23770 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch23770 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch23770 == Ast_TypeInfoKind__Nilable {
...
// 5853: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 6491: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6515: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_4539_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch27967 := self.FP.Get_kind(); _switch27967 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch27967 == Ast_TypeInfoKind__Func || _switch27967 == Ast_TypeInfoKind__Form || _switch27967 == Ast_TypeInfoKind__FormFunc {
        var argTypeInfoList *LnsList
        var workArg bool
        
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_4539_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_4539_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
...
// 3951: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 4674: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 4678: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeId LnsInt,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_4041 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_4041
...
// 4702: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 4706: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 4713: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 4720: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 4726: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5142: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 4857: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 4869: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 4888: decl @lune.@base.@Ast.CombineType.createStem
...
// 4902: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5234: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
...
// 5348: decl @lune.@base.@Ast.ExtTypeInfo.equals
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4175_(self.extedType, Ast_LuavalConvKind__InLua, false))){
        return false
    }
    return self.extedType.FP.Equals(processInfo, typeInfo, alt2type, checkModifer)
}

// 5364: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp21647(Lns_2DDD(Ast_failCreateLuavalWith_4175_(other, Ast_LuavalConvKind__ToLua, true)))
        if __exp != nil {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5388: decl @lune.@base.@Ast.ExtTypeInfo.serialize
...
// 6666: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 6677: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 6688: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 6728: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Types_Position)(LnsAny, LnsAny, LnsAny) {
    ...
    for  {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp28918(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5339 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5339))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5339.FP.Get_typeInfo()))
                }
            ...
            if _switch29545 := typeInfo.FP.Get_kind(); _switch29545 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch29545 == Ast_TypeInfoKind__List {
            ...
            } else if _switch29545 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29545 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29545 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29545 == Ast_TypeInfoKind__Class || _switch29545 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch29545 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29545 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp29523 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp29523.Val1
...
func Lns_Ast_init() {
    ...
    Ast_AutoBoxingInfo____init_2053_()
    Ast_CanEvalCtrlTypeInfo____init_2083_()
    ...
    Ast_registBuiltin_4107_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_4107_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_4107_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    ...
    switch _exp22203 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp22203.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_4107_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_4107_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
