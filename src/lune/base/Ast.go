...
var Ast_processInfoQueue *LnsList
var Ast_rootProcessInfo *Ast_ProcessInfo
var Ast_curProcessInfo *Ast_ProcessInfo
...
// for 5265
func Ast_convExp21208(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6649
func Ast_convExp28396(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp29367(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp29525(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp29691(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp29862(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp30028(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp30232(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp30409(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6786
func Ast_convExp30567(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6825
func Ast_convExp30722(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
// 989: decl @lune.@base.@Ast.getAllNameForKind
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection2755 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted2755 := __collection2755.CreateKeyListStr()
            __sorted2755.Sort( LnsItemKindStr, nil )
            for _, ___key2755 := range( __sorted2755.Items ) {
                symbolInfo := __collection2755.Items[ ___key2755 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch2753 := symbolInfo.FP.Get_kind(); _switch2753 == symbolKind {
                    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                        Lns_setStackVal( symbolKind == Ast_SymbolKind__Mtd) &&
                        Lns_setStackVal( symbolInfo.FP.Get_name() == "__init") ).(bool)){
                    } else { 
                        var staticFlag bool
                        staticFlag = symbolInfo.FP.Get_staticFlag()
                        if Lns_popVal( Lns_incStack() ||
                            Lns_setStackVal( kind == Ast_MethodKind__All) ||
                            Lns_setStackVal( kind == Ast_MethodKind__Static) &&
                            Lns_setStackVal( staticFlag) ||
                            Lns_setStackVal( kind == Ast_MethodKind__Object) &&
                            Lns_setStackVal( Lns_op_not(staticFlag)) ).(bool){
...
// 1023: decl @lune.@base.@Ast.getAllMethodName
...
// 1904: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2393_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if __exp != nil {
            ...
            {
                __collection6325 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted6325 := __collection6325.CreateKeyListStr()
                __sorted6325.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted6325.Items ) {
                    symbolInfo := __collection6325.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if _subScope != nil {
                            ...
                            dumpScope__dumpScopeSub_2393_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
// 1899: decl @lune.@base.@Ast.dumpScope
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2393_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3007: decl @lune.@base.@Ast.isGenericType
...
// 3216: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp11313 := obj.(type) {
...
// 3932: decl @lune.@base.@Ast.isExtType
func Ast_isExtType(typeInfo *Ast_TypeInfo) bool {
    return Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Ext) ||
        Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( typeInfo.FP.Get_kind() == Ast_TypeInfoKind__DDD) &&
            Lns_setStackVal( typeInfo.FP.Get_extedType() != typeInfo) ).(bool))) ).(bool)
}

// 3939: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch14532 := typeInfo.FP.Get_kind(); _switch14532 == Ast_TypeInfoKind__FormFunc || _switch14532 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4040: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId(),typeInfo)
}

// 4044: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_4083_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
    Ast_sym2builtInTypeMap.Set(typeTxt,&NewAst_NormalSymbolInfo(Ast_rootProcessInfo, Ast_SymbolKind__Typ, false, false, Ast_rootScope, Ast_AccessMode__Pub, false, typeTxt, nil, typeInfo, Ast_MutMode__IMut, true).Ast_SymbolInfo)
    if nilableTypeInfo != Ast_headTypeInfo{
        Ast_sym2builtInTypeMap.Set(typeTxt + "!",&NewAst_NormalSymbolInfo(Ast_rootProcessInfo, Ast_SymbolKind__Typ, false, kind == Ast_TypeInfoKind__Func, Ast_rootScope, Ast_AccessMode__Pub, false, typeTxt, nil, nilableTypeInfo, Ast_MutMode__IMut, true).Ast_SymbolInfo)
    }
...
// 4180: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_4127_(typeInfo *Ast_TypeInfo,convFlag bool)(LnsAny, bool) {
    ...
    if _switch16127 := typeInfo.FP.Get_kind(); _switch16127 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_4127_(typeInfo.FP.Get_nonnilableType(), convFlag)
    } else if _switch16127 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch16127 == Ast_TypeInfoKind__Form || _switch16127 == Ast_TypeInfoKind__IF || _switch16127 == Ast_TypeInfoKind__Stem || _switch16127 == Ast_TypeInfoKind__DDD {
        if convFlag{
            return mess, false
        }
        return nil, false
    } else if _switch16127 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch16127 == Ast_TypeInfoKind__Array || _switch16127 == Ast_TypeInfoKind__List || _switch16127 == Ast_TypeInfoKind__Map {
        if Ast_isMutable(typeInfo.FP.Get_mutMode()){
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_4127_(itemType, convFlag)
            if err != nil{
                err_3622 := err.(string)
                return err_3622, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch16127 == Ast_TypeInfoKind__FormFunc {
        if convFlag{
            return mess, false
        }
...
// 4248: decl @lune.@base.@Ast.isClass
func Ast_isClass(typeInfo *Ast_TypeInfo) bool {
    return Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class) &&
        Lns_setStackVal( typeInfo != Ast_builtinTypeString) ).(bool)
}

// 4278: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch16300 := typeInfo.FP.Get_kind(); _switch16300 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( typeInfo.FP.Get_baseTypeInfo() != Ast_headTypeInfo) ||
            Lns_setStackVal( typeInfo.FP.Get_interfaceList().Len() != 0) ||
            Lns_setStackVal( typeInfo.FP.Get_children().Len() != 1) ).(bool){
            return false
        }
        return true
    }
...
// 4301: decl @lune.@base.@Ast.isConditionalbe
func Ast_isConditionalbe(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( typeInfo.FP.Get_nilable()) ||
        Lns_setStackVal( typeInfo.FP.Equals(processInfo, Ast_builtinTypeBool, nil, nil)) ).(bool){
        return true
    }
    return false
}
...
// 5066: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_4490_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
// 5392: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp21829 := processInfo.FP.CreateLuaval(typeInfo).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp21829.Val1
...
// 5436: decl @lune.@base.@Ast.isNumberType
...
// 5949: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_5056_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 6475: decl @lune.@base.@Ast.createProcessInfo
func Ast_createProcessInfo() *Ast_ProcessInfo {
    return Ast_ProcessInfo_createUser_1064_(Ast_builtinTypeInfo2Map.FP.Clone())
}
...
type Ast_ProcessInfoMtd interface {
    ...
    CreateAlias(arg1 string, arg2 bool, arg3 LnsInt, arg4 *Ast_TypeInfo, arg5 *Ast_TypeInfo) *Ast_AliasTypeInfo
    ...
    CreateLuaval(arg1 *Ast_TypeInfo) LnsAny
...
func NewAst_ProcessInfo(arg1 *Ast_IdProvider, arg2 LnsAny) *Ast_ProcessInfo {
    obj := &Ast_ProcessInfo{}
    obj.FP = obj
    obj.InitAst_ProcessInfo(arg1, arg2)
    return obj
}
...
// 80: DeclConstr
func (self *Ast_ProcessInfo) InitAst_ProcessInfo(idProvBase *Ast_IdProvider,typeInfo2Map LnsAny) {
...
// 90: decl @lune.@base.@Ast.ProcessInfo.createRoot
func Ast_ProcessInfo_createRoot_1061_() *Ast_ProcessInfo {
    return NewAst_ProcessInfo(NewAst_IdProvider(0, Ast_userStartId), nil)
}

// 94: decl @lune.@base.@Ast.ProcessInfo.createUser
func Ast_ProcessInfo_createUser_1064_(typeInfo2Map LnsAny) *Ast_ProcessInfo {
    return NewAst_ProcessInfo(NewAst_IdProvider(Ast_userStartId, Ast_extStartId), typeInfo2Map)
}

// 98: decl @lune.@base.@Ast.ProcessInfo.switchIdProvier
func (self *Ast_ProcessInfo) SwitchIdProvier(idType LnsInt) {
    __func__ := "@lune.@base.@Ast.ProcessInfo.switchIdProvier"
    Log_log(Log_Level__Trace, __func__, 99, Log_CreateMessage(ProcessInfo_switchIdProvier___anonymous_1070_))
...
// 3881: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 3952: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch14612 := mutMode; _switch14612 == Ast_MutMode__IMut || _switch14612 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch14612 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp14676 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode)).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp14676.Val1
    ...
    if _switch14743 := mutMode; _switch14743 == Ast_MutMode__IMut || _switch14743 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch14743 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4310: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4356: decl @lune.@base.@Ast.ProcessInfo.createSet
...
// 4369: decl @lune.@base.@Ast.ProcessInfo.createList
...
// 4382: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 4395: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4410: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4431: decl @lune.@base.@Ast.ProcessInfo.createClass
func (self *Ast_ProcessInfo) CreateClass(classFlag bool,abstractFlag bool,scope LnsAny,baseInfo LnsAny,interfaceList LnsAny,genTypeList *LnsList,parentInfo *Ast_TypeInfo,externalFlag bool,accessMode LnsInt,className string) *Ast_TypeInfo {
    ...
    info = NewAst_NormalTypeInfo(self, abstractFlag, scope, baseInfo, interfaceList, false, externalFlag, false, accessMode, className, parentInfo, self.FP.Get_idProv().FP.GetNewId(), Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( classFlag) &&
        Lns_setStackVal( Ast_TypeInfoKind__Class) ||
        Lns_setStackVal( Ast_TypeInfoKind__IF) ).(LnsInt), genTypeList, nil, nil, Ast_MutMode__Mut)
    return &info.Ast_TypeInfo
}

// 4460: decl @lune.@base.@Ast.ProcessInfo.createFunc
...
// 4481: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4510: decl @lune.@base.@Ast.ProcessInfo.createAlias
func (self *Ast_ProcessInfo) CreateAlias(name string,externalFlag bool,accessMode LnsInt,parentInfo *Ast_TypeInfo,typeInfo *Ast_TypeInfo) *Ast_AliasTypeInfo {
    return NewAst_AliasTypeInfo(nil, self, name, accessMode, parentInfo, typeInfo.FP.Get_srcTypeInfo(), externalFlag, self.FP.Get_idProv().FP.GetNewId())
}

// 4653: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4127_(typeInfo, true)))) &&
        Lns_setStackVal( extTypeFlag) ).(bool)){
        extTypeFlag = false
        
    }
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( typeInfo.FP.Get_nonnilableType().FP.Get_kind() != Ast_TypeInfoKind__Ext) &&
        Lns_setStackVal( extTypeFlag) ).(bool)){
        switch _exp18647 := self.FP.CreateLuaval(typeInfo).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp18647.Val1
            typeInfo = work
    ...
    }
    {
        ...
        if __exp != nil {
            ...
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( _exp.FP.Get_typeId() < Ast_userStartId) &&
                Lns_setStackVal( typeInfo.FP.Get_typeId() >= Ast_userStartId) ).(bool)){
                Util_err("on cache")
            }
            return _exp
        }
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4127_(typeInfo, true))){
...
// 5057: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5321: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo) LnsAny {
    ...
    }
    {
        ...
        if _extType != nil {
            ...
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( extType.FP.Get_typeId() < Ast_userStartId) &&
                Lns_setStackVal( luneType.FP.Get_typeId() >= Ast_userStartId) ).(bool)){
                Util_err("on cache")
            }
    ...
    process = func() LnsAny {
        {
            ...
            if _dddType != nil {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp21563 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo()).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp21563.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp21563.Val1
        ...
        var err LnsAny
        var canConv bool
        err,canConv = Ast_failCreateLuavalWith_4127_(luneType, false)
        if err != nil{
            err_4498 := err.(string)
            return &Ast_LuavalResult__Err{err_4498}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp21689 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp21689.Val1
...
// 5442: decl @lune.@base.@Ast.ProcessInfo.createEnum
...
// 5509: decl @lune.@base.@Ast.ProcessInfo.createAlge
...
// 142: decl @lune.@base.@Ast.DummyModuleInfoManager.___init
...
// 149: decl @lune.@base.@Ast.DummyModuleInfoManager.getModuleInfo
...
// 1028: decl @lune.@base.@Ast.TypeNameCtrl.getModuleName
...
// 1043: decl @lune.@base.@Ast.TypeNameCtrl.getParentFullName
...
func (self *Ast_SymbolInfo) HasAccess() bool {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.FP.Get_posForModToRef()) ||
        Lns_setStackVal( self.FP.Get_posForLatestMod() != self.FP.Get_pos()) )){
        return true
    }
    return false
}
...
// 971: decl @lune.@base.@Ast.SymbolInfo.getModule
...
type Ast_ScopeMtd interface {
    ...
    Add(arg1 *Ast_ProcessInfo, arg2 LnsInt, arg3 bool, arg4 bool, arg5 string, arg6 LnsAny, arg7 *Ast_TypeInfo, arg8 LnsInt, arg9 bool, arg10 LnsInt, arg11 bool)(LnsAny, LnsAny)
    ...
    AddAlias(arg1 *Ast_ProcessInfo, arg2 string, arg3 *Parser_Position, arg4 bool, arg5 LnsInt, arg6 *Ast_TypeInfo, arg7 *Ast_SymbolInfo)(LnsAny, LnsAny)
...
// 1101: decl @lune.@base.@Ast.Scope.getNamespaceTypeInfo
...
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection4200 := self.symbol2SymbolInfoMap
                __sorted4200 := __collection4200.CreateKeyListStr()
                __sorted4200.Sort( LnsItemKindStr, nil )
                for _, ___key4200 := range( __sorted4200.Items ) {
                    symbolInfo := __collection4200.Items[ ___key4200 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1453: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1483: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1510: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1532: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1553: decl @lune.@base.@Ast.Scope.getSymbolInfo
func (self *Ast_Scope) GetSymbolInfo(name string,fromScope *Ast_Scope,onlySameNsFlag bool,access LnsInt) LnsAny {
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Lns_op_not(onlySameNsFlag)) ||
        Lns_setStackVal( Lns_op_not(self.ownerTypeInfo)) ).(bool){
        if self.parent != self{
        ...
        for workScope.parent != workScope {
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( Lns_NilAccFin(Lns_NilAccPush(workScope.ownerTypeInfo) && 
                Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.Get_kind()})) != Ast_TypeInfoKind__Class) &&
                Lns_setStackVal( Lns_NilAccFin(Lns_NilAccPush(workScope.ownerTypeInfo) && 
                Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.Get_kind()})) != Ast_TypeInfoKind__Module) ).(bool)){
...
// 1614: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1631: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
func (self *Ast_Scope) GetSymbolTypeInfo(name string,fromScope *Ast_Scope,moduleScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    limitSymbol = false
    {
        ...
        if __exp != nil {
            _exp := __exp.(*Ast_TypeInfo)
            if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__Func) ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__Method) ||
                Lns_setStackVal( self == moduleScope) ||
                Lns_setStackVal( self == Ast_rootScope) ).(bool){
                validThisScope = true
                
            } else if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__IF) ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__Class) ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__Module) ).(bool){
                limitSymbol = true
                
                validThisScope = true
                
            } else if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__Enum) ||
                Lns_setStackVal( _exp.FP.Get_kind() == Ast_TypeInfoKind__Alge) ).(bool){
                validThisScope = true
    ...
    if validThisScope{
        {
            ...
            if _symbolInfo != nil {
                symbolInfo := _symbolInfo.(*Ast_SymbolInfo)
                if Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( Lns_op_not(limitSymbol)) ||
                    Lns_setStackVal( name == "self") ||
                    Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
                        Lns_setStackVal( symbolInfo.FP.Get_typeInfo().FP.Get_kind() == Ast_TypeInfoKind__Alternate) &&
                        Lns_setStackVal( symbolInfo.FP.Get_kind() == Ast_SymbolKind__Typ) ).(bool))) ).(bool){
...
// 1674: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
func (self *Ast_Scope) FilterSymbolTypeInfo(fromScope *Ast_Scope,moduleScope *Ast_Scope,access LnsInt,callback Ast_filterForm) {
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( moduleScope == fromScope) ||
        Lns_setStackVal( moduleScope == self) ||
        Lns_setStackVal( Lns_op_not(self.classFlag)) ).(bool){
...
// 1696: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool)(LnsAny, LnsAny) {
    if _switch5247 := kind; _switch5247 == Ast_SymbolKind__Typ || _switch5247 == Ast_SymbolKind__Fun || _switch5247 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch5213 := typeInfo.FP.Get_kind(); _switch5213 == Ast_TypeInfoKind__Enum {
            if Lns_NilAccFin(Lns_NilAccPush(self.ownerTypeInfo) && 
            Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.Get_kind()})) == Ast_TypeInfoKind__Class{
        ...
        } else if _switch5213 == Ast_TypeInfoKind__Class || _switch5213 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1604 := existSymbol.(*Ast_SymbolInfo)
            if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( typeInfo.FP.Get_kind() != existSymbol_1604.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_setStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1604.FP.Get_typeInfo().FP.Get_typeId()))) ).(bool){
                return nil, existSymbol_1604
            }
        }
    }
    var symbolInfo *Ast_NormalSymbolInfo
    symbolInfo = NewAst_NormalSymbolInfo(processInfo, kind, canBeLeft, canBeRight, self, accessMode, staticFlag, name, pos, typeInfo, mutMode, hasValueFlag)
    self.symbol2SymbolInfoMap.Set(name,&symbolInfo.Ast_SymbolInfo)
    return &symbolInfo.Ast_SymbolInfo, nil
}

// 1738: decl @lune.@base.@Ast.Scope.addLocalVar
func (self *Ast_Scope) AddLocalVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( argFlag) &&
        Lns_setStackVal( Ast_SymbolKind__Arg) ||
        Lns_setStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, name != "_", name, pos, typeInfo, Ast_AccessMode__Local, false, mutable, true)
}

// 1751: decl @lune.@base.@Ast.Scope.addUnwrapedVar
func (self *Ast_Scope) AddUnwrapedVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( argFlag) &&
        Lns_setStackVal( Ast_SymbolKind__Arg) ||
        Lns_setStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, true, name, pos, typeInfo, Ast_AccessMode__Local, false, mutable, true)
}

// 1762: decl @lune.@base.@Ast.Scope.addStaticVar
func (self *Ast_Scope) AddStaticVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( argFlag) &&
        Lns_setStackVal( Ast_SymbolKind__Arg) ||
        Lns_setStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, true, name, pos, typeInfo, Ast_AccessMode__Local, true, mutable, true)
}

// 1772: decl @lune.@base.@Ast.Scope.addVar
func (self *Ast_Scope) AddVar(processInfo *Ast_ProcessInfo,accessMode LnsInt,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt,hasValueFlag bool)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Var, true, true, name, pos, typeInfo, accessMode, false, mutable, hasValueFlag)
}

// 1786: decl @lune.@base.@Ast.Scope.addEnumVal
func (self *Ast_Scope) AddEnumVal(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Mbr, false, true, name, pos, typeInfo, Ast_AccessMode__Pub, true, Ast_MutMode__Mut, true)
}

// 1796: decl @lune.@base.@Ast.Scope.addEnum
func (self *Ast_Scope) AddEnum(processInfo *Ast_ProcessInfo,accessMode LnsInt,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Typ, false, false, name, pos, typeInfo, accessMode, true, Ast_MutMode__Mut, true)
}

// 1806: decl @lune.@base.@Ast.Scope.addAlgeVal
func (self *Ast_Scope) AddAlgeVal(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Mbr, false, true, name, pos, typeInfo, Ast_AccessMode__Pub, true, Ast_MutMode__Mut, true)
}

// 1816: decl @lune.@base.@Ast.Scope.addAlge
...
// 1826: decl @lune.@base.@Ast.Scope.addAlternate
func (self *Ast_Scope) AddAlternate(processInfo *Ast_ProcessInfo,accessMode LnsInt,name string,pos LnsAny,typeInfo *Ast_TypeInfo) {
    self.FP.Add(processInfo, Ast_SymbolKind__Typ, false, false, name, pos, typeInfo, accessMode, true, Ast_MutMode__Mut, true)
}

// 1835: decl @lune.@base.@Ast.Scope.addMember
func (self *Ast_Scope) AddMember(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Mbr, true, true, name, pos, typeInfo, accessMode, staticFlag, mutMode, true)
}

// 1845: decl @lune.@base.@Ast.Scope.addMethod
func (self *Ast_Scope) AddMethod(processInfo *Ast_ProcessInfo,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutable bool)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Mtd, true, staticFlag, typeInfo.FP.Get_rawTxt(), pos, typeInfo, accessMode, staticFlag, Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( mutable) &&
        Lns_setStackVal( Ast_MutMode__Mut) ||
        Lns_setStackVal( Ast_MutMode__IMut) ).(LnsInt), true)
}

// 1855: decl @lune.@base.@Ast.Scope.addFunc
func (self *Ast_Scope) AddFunc(processInfo *Ast_ProcessInfo,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutable bool)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Fun, true, true, typeInfo.FP.Get_rawTxt(), pos, typeInfo, accessMode, staticFlag, Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( mutable) &&
        Lns_setStackVal( Ast_MutMode__Mut) ||
        Lns_setStackVal( Ast_MutMode__IMut) ).(LnsInt), true)
}

// 1866: decl @lune.@base.@Ast.Scope.addForm
func (self *Ast_Scope) AddForm(processInfo *Ast_ProcessInfo,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt) {
    self.FP.Add(processInfo, Ast_SymbolKind__Typ, false, false, typeInfo.FP.Get_rawTxt(), pos, typeInfo, accessMode, true, Ast_MutMode__IMut, false)
}

// 1875: decl @lune.@base.@Ast.Scope.addMacro
func (self *Ast_Scope) AddMacro(processInfo *Ast_ProcessInfo,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Mac, false, false, typeInfo.FP.Get_rawTxt(), pos, typeInfo, accessMode, true, Ast_MutMode__IMut, true)
}

// 1886: decl @lune.@base.@Ast.Scope.addClass
func (self *Ast_Scope) AddClass(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Typ, false, false, name, pos, typeInfo, typeInfo.FP.Get_accessMode(), true, Ast_MutMode__Mut, true)
}

// 1931: decl @lune.@base.@Ast.Scope.setClosure
...
// 1960: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch6568 := symbol.FP.Get_kind(); _switch6568 == Ast_SymbolKind__Var || _switch6568 == Ast_SymbolKind__Arg || _switch6568 == Ast_SymbolKind__Fun {
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( symbol.FP.Get_scope() == moduleScope) ||
            Lns_setStackVal( symbol.FP.Get_scope() == Ast_rootScope) ).(bool){
...
// 2000: decl @lune.@base.@Ast.Scope.accessSymbol
func (self *Ast_Scope) AccessSymbol(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        Lns_setStackVal( self.FP.GetNamespaceTypeInfo() == symbol.FP.Get_typeInfo()) ).(bool)){
        return 
    }
...
// 2125: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if _owner != nil {
                ...
                if _switch6953 := owner.FP.Get_kind(); _switch6953 == Ast_TypeInfoKind__Class || _switch6953 == Ast_TypeInfoKind__IF || _switch6953 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4019: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4162: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4519: decl @lune.@base.@Ast.Scope.addAlias
func (self *Ast_Scope) AddAlias(processInfo *Ast_ProcessInfo,name string,pos *Parser_Position,externalFlag bool,accessMode LnsInt,parentInfo *Ast_TypeInfo,symbolInfo *Ast_SymbolInfo)(LnsAny, LnsAny) {
    var aliasType *Ast_AliasTypeInfo
    aliasType = self.FP.GetProcessInfo().FP.CreateAlias(name, externalFlag, accessMode, parentInfo, symbolInfo.FP.Get_typeInfo().FP.Get_srcTypeInfo())
    return self.FP.Add(processInfo, symbolInfo.FP.Get_kind(), false, symbolInfo.FP.Get_canBeRight(), name, pos, &aliasType.Ast_TypeInfo, accessMode, true, Ast_MutMode__IMut, true)
}

// 4531: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch18134 := typeInfo.FP.Get_kind(); _switch18134 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch18134 == Ast_TypeInfoKind__Form || _switch18134 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch18134 == Ast_TypeInfoKind__Macro {
        skind = Ast_SymbolKind__Mac
        
    }
    return self.FP.Add(processInfo, skind, false, canBeRight, name, pos, typeInfo, typeInfo.FP.Get_accessMode(), true, Ast_MutMode__IMut, true)
}
...
func NewAst_TypeInfo(arg1 LnsAny, arg2 *Ast_ProcessInfo) *Ast_TypeInfo {
    obj := &Ast_TypeInfo{}
    obj.FP = obj
    obj.InitAst_TypeInfo(arg1, arg2)
    return obj
}
...
// 740: decl @lune.@base.@Ast.TypeInfo.canEvalWith
...
// 786: decl @lune.@base.@Ast.TypeInfo.get_externalFlag
func (self *Ast_TypeInfo) Get_externalFlag() bool {
    return false
}

// 791: decl @lune.@base.@Ast.TypeInfo.get_interfaceList
func (self *Ast_TypeInfo) Get_interfaceList() *LnsList {
    return Ast_dummyList
}

// 795: decl @lune.@base.@Ast.TypeInfo.get_itemTypeInfoList
func (self *Ast_TypeInfo) Get_itemTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 799: decl @lune.@base.@Ast.TypeInfo.get_argTypeInfoList
func (self *Ast_TypeInfo) Get_argTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 803: decl @lune.@base.@Ast.TypeInfo.get_retTypeInfoList
func (self *Ast_TypeInfo) Get_retTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 807: decl @lune.@base.@Ast.TypeInfo.get_parentInfo
func (self *Ast_TypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return self
}

// 815: decl @lune.@base.@Ast.TypeInfo.hasRouteNamespaceFrom
...
// 828: decl @lune.@base.@Ast.TypeInfo.getModule
...
// 905: decl @lune.@base.@Ast.TypeInfo.applyGeneric
func (self *Ast_TypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    return self
}

// 911: decl @lune.@base.@Ast.TypeInfo.get_genSrcTypeInfo
func (self *Ast_TypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self
}

// 915: decl @lune.@base.@Ast.TypeInfo.serializeTypeInfoList
func (self *Ast_TypeInfo) SerializeTypeInfoList(name string,list *LnsList,onlyPub LnsAny) string {
    ...
    for _, _typeInfo := range( list.Items ) {
        typeInfo := _typeInfo.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( Lns_op_not(onlyPub)) ||
            Lns_setStackVal( typeInfo.FP.Get_accessMode() == Ast_AccessMode__Pub) ).(bool){
...
// 930: decl @lune.@base.@Ast.TypeInfo.createScope
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_1030 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_1030.scope).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_1033 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_1033.Items ) {
...
// 2020: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 4861: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    getType = func(workType *Ast_TypeInfo) LnsAny {
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( typeInfo.FP.Get_nilable()) ||
            Lns_setStackVal( other.FP.Get_nilable()) ).(bool){
            workType = workType.FP.Get_nilableTypeInfo()
            
        }
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( Lns_op_not(Ast_TypeInfo_isMut(typeInfo))) ||
            Lns_setStackVal( Lns_op_not(Ast_TypeInfo_isMut(other))) ).(bool){
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        Lns_setStackVal( Ast_TypeInfo_isMut(other)) ).(bool)){
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp19813 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp19813.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp19813.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch20003 := type1.FP.Get_kind(); _switch20003 == Ast_TypeInfoKind__List {
        ...
        } else if _switch20003 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch20003 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch20003 == Ast_TypeInfoKind__Map {
...
// 5006: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp20175 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp20175.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp20175.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 5765: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from23631 LnsInt = index
            var _to23631 LnsInt = dstTypeList.Len()
            for _work23631 := _from23631; _work23631 <= _to23631; _work23631++ {
                dstIndex := _work23631
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from23885 LnsInt = index
            var _to23885 LnsInt = expTypeList.Len()
            for _work23885 := _from23885; _work23885 <= _to23885; _work23885++ {
                srcIndex := _work23885
                ...
                if expType.FP.Get_kind() == Ast_TypeInfoKind__DDD{
                    ...
                    Lns_setStackVal( srcIndex > index) &&
                    Lns_setStackVal( expType.FP.Get_kind() == Ast_TypeInfoKind__Abbr) ).(bool)){
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4789 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4789 <= srcIndex{
                        var workMess string
                ...
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    ...
                    Lns_setStackVal( Lns_op_not(Ast_isExtType(dstType.FP.Get_srcTypeInfo().FP.Get_nonnilableType()))) &&
                    Lns_setStackVal( Ast_isExtType(expType.FP.Get_srcTypeInfo().FP.Get_nonnilableType())) ).(bool)){
                    warnMess = Lns_getVM().String_format("%s <- %s", []LnsAny{dstType.FP.GetTxt(nil, nil, nil), expType.FP.GetTxt(nil, nil, nil)})
            ...
            if dstTypeList.Len() == index{
                if dstType.FP.Get_srcTypeInfo().FP.Get_kind() != Ast_TypeInfoKind__DDD{
                    ...
                    if Lns_op_not(isMatch){
                        return Ast_MatchType__Error, Lns_getVM().String_format("exp(%d) type mismatch %s <- %s: index %d%s", []LnsAny{index, Ast_applyGenericDefault(dstType, alt2type, dstType.FP.GetModule()).FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), index, Lns_popVal( Lns_incStack() ||
                            Lns_setStackVal( msg) &&
                            Lns_setStackVal( Lns_getVM().String_format(" -- %s", []LnsAny{msg})) ||
                            Lns_setStackVal( "") ).(string)})
                    }
                    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                        Lns_setStackVal( Lns_op_not(allowDstShort)) &&
                        Lns_setStackVal( dstTypeList.Len() < expTypeList.Len()) ).(bool)){
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4812 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4812 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4826 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4826 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4833 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4833 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_4843 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_4843
    }
    return Ast_MatchType__Match, ""
}

// 5969: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( dest == Ast_builtinTypeExp) ||
        Lns_setStackVal( dest == Ast_builtinTypeMultiExp) ).(bool){
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( other == Ast_builtinTypeMultiExp) &&
            Lns_setStackVal( dest != Ast_builtinTypeMultiExp) ).(bool)){
    ...
    if _switch25171 := canEvalType; _switch25171 == Ast_CanEvalType__SetEq || _switch25171 == Ast_CanEvalType__SetOp || _switch25171 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch24980 := otherSrc; _switch24980 == Ast_builtinTypeAbbr || _switch24980 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            Lns_setStackVal( Lns_op_not(otherMut)) &&
            Lns_setStackVal( destMut) ).(bool)){
            var nonNilOtherType *Ast_TypeInfo
            nonNilOtherType = otherSrc.FP.Get_nonnilableType()
            if _switch25067 := nonNilOtherType.FP.Get_kind(); _switch25067 == Ast_TypeInfoKind__Set || _switch25067 == Ast_TypeInfoKind__Map || _switch25067 == Ast_TypeInfoKind__List || _switch25067 == Ast_TypeInfoKind__IF {
                return false, nil
            } else if _switch25067 == Ast_TypeInfoKind__Class {
                if Ast_builtinTypeString != nonNilOtherType{
                    return false, nil
                }
            } else if _switch25067 == Ast_TypeInfoKind__Prim {
        ...
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( otherSrc != Ast_builtinTypeNil) &&
            Lns_setStackVal( otherSrc != Ast_builtinTypeString) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Prim) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Func) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Method) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Form) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__FormFunc) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Enum) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Abbr) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Alternate) &&
            Lns_setStackVal( otherSrc.FP.Get_kind() != Ast_TypeInfoKind__Box) &&
            Lns_setStackVal( Lns_op_not(Ast_isGenericType(otherSrc))) &&
            Lns_setStackVal( destMut) &&
            Lns_setStackVal( Lns_op_not(otherMut)) ).(bool)){
            return false, nil
        }
    }
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Lns_op_not(dest.FP.Get_nilable())) &&
        Lns_setStackVal( otherSrc.FP.Get_nilable()) ).(bool)){
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( dest == Ast_builtinTypeStem) &&
        Lns_setStackVal( Lns_op_not(otherSrc.FP.Get_nilable())) ).(bool)){
        return true, nil
    }
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( dest == Ast_builtinTypeForm) &&
        Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Func) ||
            Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Form) ||
            Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__FormFunc) ).(bool))) ).(bool)){
        return Ast_isSettableToForm_5056_(processInfo, otherSrc), nil
    }
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( otherSrc == Ast_builtinTypeNil) ||
        Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Abbr) ).(bool){
    ...
    }
    {
        ...
        if _extTypeInfo != nil {
            ...
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( canEvalType != Ast_CanEvalType__SetEq) &&
                Lns_setStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4127_(extTypeInfo.FP.Get_extedType(), true)))) ).(bool)){
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Alternate) &&
            Lns_setStackVal( otherSrc.FP.HasBase()) ).(bool)){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( dest.FP.Get_kind() == Ast_TypeInfoKind__Class) ||
                Lns_setStackVal( dest.FP.Get_kind() == Ast_TypeInfoKind__IF) ).(bool))) &&
            Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Class) ||
                Lns_setStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__IF) ).(bool))) ).(bool)){
            if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( canEvalType == Ast_CanEvalType__SetOp) ||
                Lns_setStackVal( canEvalType == Ast_CanEvalType__SetOpIMut) ).(bool){
            ...
            if _switch25825 := otherSrc.FP.Get_kind(); _switch25825 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch25825 == Ast_TypeInfoKind__FormFunc || _switch25825 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_5056_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch26030 := otherSrc.FP.Get_kind(); _switch26030 == Ast_TypeInfoKind__FormFunc || _switch26030 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
    ...
    if _switch27001 := dest.FP.Get_kind(); _switch27001 == Ast_TypeInfoKind__Prim {
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( dest == Ast_builtinTypeInt) &&
            Lns_setStackVal( otherSrc == Ast_builtinTypeChar) ||
            Lns_setStackVal( dest == Ast_builtinTypeChar) &&
            Lns_setStackVal( otherSrc == Ast_builtinTypeInt) ).(bool){
            return true, nil
        }
        return false, nil
    } else if _switch27001 == Ast_TypeInfoKind__List || _switch27001 == Ast_TypeInfoKind__Array || _switch27001 == Ast_TypeInfoKind__Set {
        if otherSrc.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo() == Ast_builtinTypeNone{
            return true, nil
        }
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( dest.FP.Get_itemTypeInfoList().Len() >= 1) &&
            Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().Len() >= 1) ).(bool)){
            var ret bool
            var mess LnsAny
            ret,mess = (dest.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()).FP.CanEvalWith(processInfo, otherSrc.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( destMut) &&
                Lns_setStackVal( Ast_CanEvalType__SetEq) ||
                Lns_setStackVal( Ast_CanEvalType__SetOpIMut) ).(LnsInt), alt2type)
            if Lns_op_not(ret){
                return false, mess
            }
        } else { 
        ...
        return true, nil
    } else if _switch27001 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo() == Ast_builtinTypeNone) &&
            Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().GetAt(2).(Ast_TypeInfoDownCast).ToAst_TypeInfo() == Ast_builtinTypeNone) ).(bool)){
            return true, nil
        }
        ...
        check1 = func() LnsAny {
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                ...
                Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().Len() >= 1) ).(bool)){
                var ret bool
                ret,_ = (dest.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()).FP.CanEvalWith(processInfo, otherSrc.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( destMut) &&
                    Lns_setStackVal( Ast_CanEvalType__SetEq) ||
                    Lns_setStackVal( Ast_CanEvalType__SetOpIMut) ).(LnsInt), alt2type)
                if Lns_op_not(ret){
        ...
        check2 = func() bool {
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( dest.FP.Get_itemTypeInfoList().Len() >= 2) &&
                Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().Len() >= 2) ).(bool)){
                var ret bool
                ret,_ = (dest.FP.Get_itemTypeInfoList().GetAt(2).(Ast_TypeInfoDownCast).ToAst_TypeInfo()).FP.CanEvalWith(processInfo, otherSrc.FP.Get_itemTypeInfoList().GetAt(2).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( destMut) &&
                    Lns_setStackVal( Ast_CanEvalType__SetEq) ||
                    Lns_setStackVal( Ast_CanEvalType__SetOpIMut) ).(LnsInt), alt2type)
                if Lns_op_not(ret){
        ...
        result2 = check2()
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( result1) &&
            Lns_setStackVal( result2) )){
            return true, nil
        }
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( Lns_op_not(result1)) &&
            Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo() == Ast_builtinTypeNone) ||
            Lns_setStackVal( Lns_op_not(result2)) &&
            Lns_setStackVal( otherSrc.FP.Get_itemTypeInfoList().GetAt(2).(Ast_TypeInfoDownCast).ToAst_TypeInfo() == Ast_builtinTypeNone) ).(bool){
            return true, nil
        }
        return false, nil
    } else if _switch27001 == Ast_TypeInfoKind__Class || _switch27001 == Ast_TypeInfoKind__IF {
        ...
        return false, nil
    } else if _switch27001 == Ast_TypeInfoKind__Form {
        return Ast_isSettableToForm_5056_(processInfo, otherSrc), nil
    } else if _switch27001 == Ast_TypeInfoKind__Func || _switch27001 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch27001 == Ast_TypeInfoKind__Method {
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( dest.FP.Get_argTypeInfoList().Len() != otherSrc.FP.Get_argTypeInfoList().Len()) ||
            Lns_setStackVal( dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len()) ).(bool){
            return false, nil
        }
        ...
        return true, nil
    } else if _switch27001 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch27001 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch27001 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, nil
    }
...
// 6460: decl @lune.@base.@Ast.TypeInfo.getFullName
func (self *Ast_TypeInfo) GetFullName(typeNameCtrl *Ast_TypeNameCtrl,importInfo Ast_ModuleInfoManager,localFlag LnsAny) string {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( localFlag) &&
        Lns_setStackVal( self.FP.IsModule()) )){
...
func NewAst_NormalSymbolInfo(arg1 *Ast_ProcessInfo, arg2 LnsInt, arg3 bool, arg4 bool, arg5 *Ast_Scope, arg6 LnsInt, arg7 bool, arg8 string, arg9 LnsAny, arg10 *Ast_TypeInfo, arg11 LnsAny, arg12 bool) *Ast_NormalSymbolInfo {
    obj := &Ast_NormalSymbolInfo{}
    obj.FP = obj
    obj.Ast_SymbolInfo.FP = obj
    obj.InitAst_NormalSymbolInfo(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12)
    return obj
}
...
// 1160: decl @lune.@base.@Ast.NormalSymbolInfo.get_mutable
func (self *Ast_NormalSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.mutMode)
}

// 1168: decl @lune.@base.@Ast.NormalSymbolInfo.getOrg
func (self *Ast_NormalSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return &self.Ast_SymbolInfo
}

// 1172: DeclConstr
func (self *Ast_NormalSymbolInfo) InitAst_NormalSymbolInfo(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,scope *Ast_Scope,accessMode LnsInt,staticFlag bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutMode LnsAny,hasValueFlag bool) {
...
// 2147: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch7114 := self.FP.Get_accessMode(); _switch7114 == Ast_AccessMode__Pub || _switch7114 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch7114 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch7114 == Ast_AccessMode__Local {
        return &self.Ast_SymbolInfo
    } else if _switch7114 == Ast_AccessMode__Pri {
...
// 4166: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 1238: decl @lune.@base.@Ast.AutoBoxingInfo.___init
func Ast_AutoBoxingInfo____init_2056_() {
...
// 1255: decl @lune.@base.@Ast.AutoBoxingInfo.get_kind
func (self *Ast_AutoBoxingInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Etc
}

// 1259: decl @lune.@base.@Ast.AutoBoxingInfo.inc
...
// 1264: decl @lune.@base.@Ast.AutoBoxingInfo.unregist
...
// 1269: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.___init
func Ast_CanEvalCtrlTypeInfo____init_2086_() {
...
// 1283: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_kind
func (self *Ast_CanEvalCtrlTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__CanEvalCtrl
}

// 1287: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_typeId
func (self *Ast_CanEvalCtrlTypeInfo) Get_typeId() LnsInt {
    return -1
}

// 1291: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.createDefaultAlt2typeMap
...
// 1300: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.isValidApply
...
// 1304: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.setupNeedAutoBoxing
...
// 1310: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.updateNeedAutoBoxing
...
// 1321: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.hasNeedAutoBoxing
...
// 1331: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.finishNeedAutoBoxing
...
// 1348: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.canAutoBoxing
...
func NewAst_AliasTypeInfo(arg1 LnsAny, arg2 *Ast_ProcessInfo, arg3 string, arg4 LnsInt, arg5 *Ast_TypeInfo, arg6 *Ast_TypeInfo, arg7 bool, arg8 LnsInt) *Ast_AliasTypeInfo {
    obj := &Ast_AliasTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_AliasTypeInfo(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
    return obj
}
func (self *Ast_AliasTypeInfo) InitAst_AliasTypeInfo(arg1 LnsAny, arg2 *Ast_ProcessInfo, arg3 string, arg4 LnsInt, arg5 *Ast_TypeInfo, arg6 *Ast_TypeInfo, arg7 bool, arg8 LnsInt) {
    self.Ast_TypeInfo.InitAst_TypeInfo( arg1,arg2)
    self.rawTxt = arg3
    self.accessMode = arg4
    self.parentInfo = arg5
    self.aliasSrcTypeInfo = arg6
    self.externalFlag = arg7
    self.typeId = arg8
}
...
func (self *Ast_AliasTypeInfo) CanEvalWith(arg1 *Ast_ProcessInfo,arg2 *Ast_TypeInfo,arg3 LnsInt,arg4 *LnsMap)(bool, LnsAny) {
    return self.aliasSrcTypeInfo. FP.CanEvalWith( arg1,arg2,arg3,arg4)
}
func (self *Ast_AliasTypeInfo) CreateAlt2typeMap(arg1 bool) *LnsMap {
    return self.aliasSrcTypeInfo. FP.CreateAlt2typeMap( arg1)
}
func (self *Ast_AliasTypeInfo) Equals(arg1 *Ast_ProcessInfo,arg2 *Ast_TypeInfo,arg3 LnsAny,arg4 LnsAny) bool {
    return self.aliasSrcTypeInfo. FP.Equals( arg1,arg2,arg3,arg4)
}
func (self *Ast_AliasTypeInfo) GetFullName(arg1 *Ast_TypeNameCtrl,arg2 Ast_ModuleInfoManager,arg3 LnsAny) string {
    return self.aliasSrcTypeInfo. FP.GetFullName( arg1,arg2,arg3)
}
func (self *Ast_AliasTypeInfo) GetModule() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo. FP.GetModule( )
}
func (self *Ast_AliasTypeInfo) GetOverridingType() LnsAny {
    return self.aliasSrcTypeInfo. FP.GetOverridingType( )
}
func (self *Ast_AliasTypeInfo) GetParentFullName(arg1 *Ast_TypeNameCtrl,arg2 LnsAny,arg3 LnsAny) string {
    return self.aliasSrcTypeInfo. FP.GetParentFullName( arg1,arg2,arg3)
}
...
func (self *Ast_AliasTypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo. FP.Get_genSrcTypeInfo( )
}
...
func (self *Ast_AliasTypeInfo) Get_nilableTypeInfo() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo. FP.Get_nilableTypeInfo( )
}
func (self *Ast_AliasTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo. FP.Get_nonnilableType( )
}
...
func (self *Ast_AliasTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo. FP.Get_srcTypeInfo( )
}
...
// 1371: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1377: decl @lune.@base.@Ast.AliasTypeInfo.serialize
...
// 2064: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp7302 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp7302.Val1
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( self.symbolInfo.FP.Get_kind() == Ast_SymbolKind__Mbr) &&
            Lns_setStackVal( symType.FP.Get_kind() == Ast_TypeInfoKind__Alternate) &&
            Lns_setStackVal( prefixTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class) &&
            Lns_setStackVal( prefixTypeInfo.FP.Get_itemTypeInfoList().Len() > 0) ).(bool)){
            ...
            if typeInfo != nil{
                typeInfo_1972 := typeInfo.(*Ast_TypeInfo)
                work = typeInfo_1972
...
// 2245: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2249: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2258: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2262: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp7430 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp7430.Val1
        if _switch7423 := self.symbolInfo.FP.Get_mutMode(); _switch7423 == Ast_MutMode__AllMut || _switch7423 == Ast_MutMode__IMut || _switch7423 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch7423 == Ast_MutMode__Mut {
            if _switch7421 := prefixTypeInfo.FP.Get_mutMode(); _switch7421 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch7421 == Ast_MutMode__Mut || _switch7421 == Ast_MutMode__IMut || _switch7421 == Ast_MutMode__IMutRe {
...
// 2291: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2295: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
// 2335: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng_with
...
// 2343: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng
func (self *Ast_NilableTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 2347: decl @lune.@base.@Ast.NilableTypeInfo.serialize
func (self *Ast_NilableTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    var parentId LnsInt
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, nilable = true, orgTypeId = %d }\n", []LnsAny{Ast_SerializeKind__Nilable, parentId, self.typeId, self.nonnilableType.FP.Get_typeId()}))
}

// 2354: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 2365: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_2115 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_2115.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 5592: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if _genType != nil {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_2231 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_2231, alt2type)).(bool)
            }
    ...
    if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type)){
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( otherWork.FP.Get_kind() != Ast_TypeInfoKind__Class) &&
            Lns_setStackVal( otherWork.FP.Get_kind() != Ast_TypeInfoKind__IF) ).(bool)){
            return false
        }
...
// 2505: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2251 := alt2type.(*LnsMap)
        var otherWork *Ast_TypeInfo
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2251)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2251.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2251)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2251)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2251
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2270 := workAlt2type.(*LnsMap)
            workAlt2type_2270.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2556: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
    ...
    if Lns_op_not(self.belongClassFlag){
        {
            ...
            if _altType != nil {
                ...
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( Lns_op_not(altType.belongClassFlag)) &&
                    Lns_setStackVal( altType.altIndex == self.altIndex) ).(bool)){
                    return true, nil
                }
            }
        }
...
// 2582: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2294 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2294.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2294)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2592: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2598: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2317 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2317)
    }
    return false
}

// 2626: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2631: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2635: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2639: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2643: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2648: decl @lune.@base.@Ast.AlternateTypeInfo.getParentFullName
...
// 2655: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2667: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4253: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 2734: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 2738: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 2743: decl @lune.@base.@Ast.BoxTypeInfo.serialize
func (self *Ast_BoxTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    var parentId LnsInt
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, accessMode = %d, boxingType = %d }\n", []LnsAny{Ast_SerializeKind__Box, parentId, self.typeId, self.accessMode, self.boxingType.FP.Get_typeId()}))
}

// 2751: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 2762: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4323: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3692 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3692)
    }
    return nil
}

// 5556: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch22695 := canEvalType; _switch22695 == Ast_CanEvalType__SetOp || _switch22695 == Ast_CanEvalType__SetOpIMut || _switch22695 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 2789: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 2832: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 2837: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 2878: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2881: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2886: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
func (self *Ast_GenericTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Ast_TypeInfo_isMut(&self.Ast_TypeInfo)) &&
        Lns_setStackVal( Lns_op_not(Ast_TypeInfo_isMut(other))) ).(bool)){
        return false, nil
    }
    var otherSrc *Ast_TypeInfo
...
// 2947: decl @lune.@base.@Ast.GenericTypeInfo.equals
func (self *Ast_GenericTypeInfo) Equals(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.FP.Get_kind() != self.FP.Get_kind()) ||
        Lns_setStackVal( self.itemTypeInfoList.Len() != other.FP.Get_itemTypeInfoList().Len()) ).(bool){
        return false
    }
...
// 2980: decl @lune.@base.@Ast.GenericTypeInfo.serialize
func (self *Ast_GenericTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    var parentId LnsInt
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, genSrcTypeId = %d, genTypeList = {", []LnsAny{Ast_SerializeKind__Generic, parentId, self.typeId, self.genSrcTypeInfo.FP.Get_typeId()}))
    var count LnsInt
    count = 0
...
// 2995: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5087: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_4490_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4223 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4223, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
// 3041: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3049: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3053: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
func (self *Ast_ModifierTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    var parentId LnsInt
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, srcTypeId = %d, mutMode = %d }\n", []LnsAny{Ast_SerializeKind__Modifier, parentId, self.typeId, self.srcTypeInfo.FP.Get_typeId(), self.mutMode}))
}

// 3061: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch10747 := canEvalType; _switch10747 == Ast_CanEvalType__SetEq || _switch10747 == Ast_CanEvalType__SetOp {
...
// 3091: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4492: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
func (self *Ast_ModifierTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Ast_TypeInfo_isMut(&self.Ast_TypeInfo)) ||
        Lns_setStackVal( Lns_op_not(Ast_TypeInfo_isMut(orgType))) ).(bool){
        return orgType
    }
    return self.FP.getProcessInfo().FP.CreateModifier(orgType, Ast_MutMode__IMut)
}

// 4500: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6376: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5026 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5026, Ast_MutMode__IMut)
    }
    return nil
}
...
// 3186: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
func (self *Ast_ModuleTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    var txt string
    txt = Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, txt = '%s', kind = %d, ", []LnsAny{Ast_SerializeKind__Module, self.FP.GetParentId(), self.typeId, self.rawTxt, Ast_TypeInfoKind__Module})
    stream.Write(txt + "\n")
    ...
    if Lns_isCondTrue( validChildrenSet){
        for _, _child := range( self.FP.Get_children().Items ) {
            ...
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( set.Items[child.FP.Get_typeId()]) &&
                Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( child.FP.Get_accessMode() == Ast_AccessMode__Pub) ||
                    Lns_setStackVal( child.FP.Get_accessMode() == Ast_AccessMode__Global) ).(bool))) )){
...
func (self *Ast_EnumTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    return &self.Ast_TypeInfo == other.FP.Get_srcTypeInfo(), nil
}

// 3325: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3330: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Items[name]
}

// 3334: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5479: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    {
        __collection22390 := self.name2EnumValInfo
        __sorted22390 := __collection22390.CreateKeyListStr()
        __sorted22390.Sort( LnsItemKindStr, nil )
        for _, ___key22390 := range( __sorted22390.Items ) {
            enumValInfo := __collection22390.Items[ ___key22390 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp22388 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp22388.Val1
...
// 3429: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3451: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 5531: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    firstFlag = true
    {
        __collection22631 := self.valInfoMap
        __sorted22631 := __collection22631.CreateKeyListStr()
        __sorted22631.Sort( LnsItemKindStr, nil )
        for _, ___key22631 := range( __sorted22631.Items ) {
            algeValInfo := __collection22631.Items[ ___key22631 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3439: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3534: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,typeId LnsInt,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny) {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( kind == Ast_TypeInfoKind__Method) &&
        Lns_setStackVal( Lns_NilAccFin(Lns_NilAccPush(parentInfo) && 
        Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3553:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( self.baseTypeInfo == Ast_headTypeInfo) &&
            Lns_setStackVal( self.interfaceList.Len() == 0) ).(bool)){
            return NewLnsMap( map[LnsAny]LnsAny{})
        }
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch12824 := kind; _switch12824 == Ast_TypeInfoKind__Set || _switch12824 == Ast_TypeInfoKind__Map || _switch12824 == Ast_TypeInfoKind__List || _switch12824 == Ast_TypeInfoKind__Array || _switch12824 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch12824 == Ast_TypeInfoKind__Class || _switch12824 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        var hasNilable bool
        hasNilable = false
        if _switch12926 := (kind); _switch12926 == Ast_TypeInfoKind__Prim || _switch12926 == Ast_TypeInfoKind__List || _switch12926 == Ast_TypeInfoKind__Array || _switch12926 == Ast_TypeInfoKind__Set || _switch12926 == Ast_TypeInfoKind__Map || _switch12926 == Ast_TypeInfoKind__Class || _switch12926 == Ast_TypeInfoKind__Stem || _switch12926 == Ast_TypeInfoKind__Module || _switch12926 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch12926 == Ast_TypeInfoKind__Func || _switch12926 == Ast_TypeInfoKind__Method || _switch12926 == Ast_TypeInfoKind__Form || _switch12926 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3642: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3652: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3656: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3660: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() LnsInt {
    return self.parentInfo.FP.Get_typeId()
}

// 3664: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() LnsInt {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3669: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 3675: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
...
// 3703: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch13363 := self.kind; _switch13363 == Ast_TypeInfoKind__Func || _switch13363 == Ast_TypeInfoKind__Form || _switch13363 == Ast_TypeInfoKind__FormFunc || _switch13363 == Ast_TypeInfoKind__Method || _switch13363 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 3748: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3753: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 3784: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.kind != typeInfo.FP.Get_kind()) ||
        Lns_setStackVal( self.staticFlag != typeInfo.FP.Get_staticFlag()) ||
        Lns_setStackVal( self.autoFlag != typeInfo.FP.Get_autoFlag()) ||
        Lns_setStackVal( self.FP.Get_nilable() != typeInfo.FP.Get_nilable()) ||
        Lns_setStackVal( self.rawTxt != typeInfo.FP.Get_rawTxt()) ||
        Lns_setStackVal( self.parentInfo != typeInfo.FP.Get_parentInfo()) ||
        Lns_setStackVal( self.baseTypeInfo != typeInfo.FP.Get_baseTypeInfo()) ).(bool){
        return false
    }
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch13811 := self.kind; _switch13811 == Ast_TypeInfoKind__List || _switch13811 == Ast_TypeInfoKind__Map || _switch13811 == Ast_TypeInfoKind__Array || _switch13811 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 3849: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 3857: decl @lune.@base.@Ast.NormalTypeInfo.create
...
// 4073: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch15222 := kind; _switch15222 == Ast_TypeInfoKind__Array || _switch15222 == Ast_TypeInfoKind__List || _switch15222 == Ast_TypeInfoKind__Set || _switch15222 == Ast_TypeInfoKind__Class || _switch15222 == Ast_TypeInfoKind__Module || _switch15222 == Ast_TypeInfoKind__IF || _switch15222 == Ast_TypeInfoKind__Form || _switch15222 == Ast_TypeInfoKind__FormFunc || _switch15222 == Ast_TypeInfoKind__Func || _switch15222 == Ast_TypeInfoKind__Method || _switch15222 == Ast_TypeInfoKind__Macro {
        scope = NewAst_Scope(Ast_rootProcessInfo, Ast_rootScope, Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( kind == Ast_TypeInfoKind__Class) ||
            Lns_setStackVal( kind == Ast_TypeInfoKind__Module) ||
            Lns_setStackVal( kind == Ast_TypeInfoKind__IF) ||
            Lns_setStackVal( kind == Ast_TypeInfoKind__List) ||
            Lns_setStackVal( kind == Ast_TypeInfoKind__Array) ||
            Lns_setStackVal( kind == Ast_TypeInfoKind__Set) ).(bool), nil, nil)
        
    }
    var genTypeList *LnsList
    genTypeList = NewLnsList([]LnsAny{})
    if _switch15320 := kind; _switch15320 == Ast_TypeInfoKind__Array || _switch15320 == Ast_TypeInfoKind__List || _switch15320 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch15320 == Ast_TypeInfoKind__Map {
    ...
    Ast_registBuiltin_4083_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 5658: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch23290 := typeInfo.FP.Get_kind(); _switch23290 == Ast_TypeInfoKind__Prim || _switch23290 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch23290 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch23290 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch23290 == Ast_TypeInfoKind__Class || _switch23290 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch23290 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch23290 == Ast_TypeInfoKind__List || _switch23290 == Ast_TypeInfoKind__Array || _switch23290 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch23290 == Ast_TypeInfoKind__Map {
            if Ast_NormalTypeInfo_isAvailableMapping(processInfo, typeInfo.FP.Get_itemTypeInfoList().GetAt(2).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), checkedTypeMap){
                ...
                if Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( keyType.FP.Equals(processInfo, Ast_builtinTypeString, nil, nil)) ||
                    Lns_setStackVal( keyType.FP.Get_kind() == Ast_TypeInfoKind__Prim) ||
                    Lns_setStackVal( keyType.FP.Get_kind() == Ast_TypeInfoKind__Enum) ).(bool){
                    return true
                }
            }
            return false
        } else if _switch23290 == Ast_TypeInfoKind__Nilable {
...
// 5732: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
func (self *Ast_NormalTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( self.FP.Get_kind() != Ast_TypeInfoKind__Class) &&
            Lns_setStackVal( self.FP.Get_kind() != Ast_TypeInfoKind__IF) ).(bool))) ||
        Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( other.FP.Get_kind() != Ast_TypeInfoKind__Class) &&
            Lns_setStackVal( other.FP.Get_kind() != Ast_TypeInfoKind__IF) ).(bool))) ).(bool){
...
// 6366: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6390: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_4490_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch27450 := self.FP.Get_kind(); _switch27450 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch27450 == Ast_TypeInfoKind__Func || _switch27450 == Ast_TypeInfoKind__Form || _switch27450 == Ast_TypeInfoKind__FormFunc {
        var argTypeInfoList *LnsList
        var workArg bool
        
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_4490_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_4490_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( needNew) ||
            Lns_setStackVal( workArg) ||
            Lns_setStackVal( workRet) ).(bool){
...
// 3910: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 4564: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 4568: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeId LnsInt,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_3908 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_3908
...
// 4592: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 4596: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 4603: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 4610: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 4616: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5029: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 4744: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 4756: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 4775: decl @lune.@base.@Ast.CombineType.createStem
...
// 4789: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5121: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
...
// 5235: decl @lune.@base.@Ast.ExtTypeInfo.equals
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4127_(self.extedType, true))){
        return false
    }
    return self.extedType.FP.Equals(processInfo, typeInfo, alt2type, checkModifer)
}

// 5251: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp21208(Lns_2DDD(Ast_failCreateLuavalWith_4127_(other, true)))
        if __exp != nil {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5275: decl @lune.@base.@Ast.ExtTypeInfo.serialize
func (self *Ast_ExtTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    var parentId LnsInt
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, extedTypeId = %d }\n", []LnsAny{Ast_SerializeKind__Ext, parentId, self.typeId, self.extedType.FP.Get_typeId()}))
}

// 5282: decl @lune.@base.@Ast.ExtTypeInfo.get_display_stirng_with
func (self *Ast_ExtTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
}

// 5286: decl @lune.@base.@Ast.ExtTypeInfo.get_display_stirng
func (self *Ast_ExtTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 5290: decl @lune.@base.@Ast.ExtTypeInfo.getModule
func (self *Ast_ExtTypeInfo) GetModule() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5293: decl @lune.@base.@Ast.ExtTypeInfo.get_kind
func (self *Ast_ExtTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Ext
}

// 5296: decl @lune.@base.@Ast.ExtTypeInfo.get_srcTypeInfo
func (self *Ast_ExtTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5299: decl @lune.@base.@Ast.ExtTypeInfo.get_nonnilableType
func (self *Ast_ExtTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5302: decl @lune.@base.@Ast.ExtTypeInfo.get_nilable
func (self *Ast_ExtTypeInfo) Get_nilable() bool {
    return false
}

// 5305: decl @lune.@base.@Ast.ExtTypeInfo.applyGeneric
...
func NewAst_RefTypeInfo(arg1 *Parser_Position, arg2 *LnsList, arg3 *Ast_TypeInfo) *Ast_RefTypeInfo {
    obj := &Ast_RefTypeInfo{}
    obj.FP = obj
    obj.InitAst_RefTypeInfo(arg1, arg2, arg3)
    return obj
}
func (self *Ast_RefTypeInfo) InitAst_RefTypeInfo(arg1 *Parser_Position, arg2 *LnsList, arg3 *Ast_TypeInfo) {
    self.pos = arg1
    self.itemRefTypeList = arg2
    self.typeInfo = arg3
}
func (self *Ast_RefTypeInfo) Get_pos() *Parser_Position{ return self.pos }
...
type Ast_TypeAnalyzerMtd interface {
    ...
    AnalyzeTypeItemList(arg1 bool, arg2 bool, arg3 bool, arg4 *Ast_TypeInfo, arg5 *Parser_Position)(LnsAny, LnsAny, LnsAny)
...
// 6541: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 6552: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 6563: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 6603: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Parser_Position)(LnsAny, LnsAny, LnsAny) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.parentPub) &&
        Lns_setStackVal( Ast_isPubToExternal(self.accessMode)) &&
    ...
    token = self.parser.GetTokenNoErr()
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( token.Consecutive) &&
    ...
    for  {
        if Lns_popVal( Lns_incStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp28396(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5192 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5192))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5192.FP.Get_typeInfo()))
                }
            ...
            if _switch29021 := typeInfo.FP.Get_kind(); _switch29021 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch29021 == Ast_TypeInfoKind__List {
            ...
            } else if _switch29021 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29021 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29021 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29021 == Ast_TypeInfoKind__Class || _switch29021 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch29021 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29021 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp28999 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp28999.Val1
...
func Lns_Ast_init() {
    ...
    Ast_processInfoQueue = NewLnsList([]LnsAny{})
    Ast_rootProcessInfo = Ast_ProcessInfo_createRoot_1061_()
    Ast_processInfoQueue.Insert(Ast_ProcessInfo2Stem(Ast_rootProcessInfo))
    _ = Ast_rootProcessInfo
    ...
    _ = NewLnsList([]LnsAny{})
    Ast_headTypeInfo = NewAst_TypeInfo(Ast_rootScope, Ast_rootProcessInfo)
    Ast_defaultTypeNameCtrl = NewAst_TypeNameCtrl(Ast_headTypeInfo)
    Ast_AutoBoxingInfo____init_2056_()
    Ast_CanEvalCtrlTypeInfo____init_2086_()
    ...
    Ast_registBuiltin_4083_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_4083_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_4083_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    ...
    switch _exp21725 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp21725.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_4083_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_4083_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
