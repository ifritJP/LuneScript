...
func Ast_LuavalConvKind_get__allList_4270_() *LnsList{
...
func Ast_LuavalConvKind__from_4263_(arg1 LnsInt) LnsAny{
...
// for 5638
func Ast_convExp22580(arg1 []LnsAny) LnsAny {
...
// 1005: decl @lune.@base.@Ast.getAllNameForKind
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection2763 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted2763 := __collection2763.CreateKeyListStr()
            __sorted2763.Sort( LnsItemKindStr, nil )
            for _, ___key2763 := range( __sorted2763.Items ) {
                symbolInfo := __collection2763.Items[ ___key2763 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch2761 := symbolInfo.FP.Get_kind(); _switch2761 == symbolKind {
...
// 1039: decl @lune.@base.@Ast.getAllMethodName
...
// 2196: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2650_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if __exp != nil {
            ...
            {
                __collection7421 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted7421 := __collection7421.CreateKeyListStr()
                __sorted7421.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted7421.Items ) {
                    symbolInfo := __collection7421.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if _subScope != nil {
                            ...
                            dumpScope__dumpScopeSub_2650_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
// 2191: decl @lune.@base.@Ast.dumpScope
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2650_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3200: decl @lune.@base.@Ast.isGenericType
...
// 3413: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp11927 := obj.(type) {
...
// 4169: decl @lune.@base.@Ast.isExtType
...
// 4176: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch15313 := typeInfo.FP.Get_kind(); _switch15313 == Ast_TypeInfoKind__FormFunc || _switch15313 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4279: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId(),typeInfo)
}

// 4285: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_4205_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
...
// 4405: decl @lune.@base.@Ast.isClass
...
// 4476: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_4273_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch17255 := typeInfo.FP.Get_kind(); _switch17255 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_4273_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch17255 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch17255 == Ast_TypeInfoKind__Form || _switch17255 == Ast_TypeInfoKind__IF || _switch17255 == Ast_TypeInfoKind__DDD || _switch17255 == Ast_TypeInfoKind__ExtModule {
        ...
        return nil, false
    } else if _switch17255 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch17255 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch17255 == Ast_TypeInfoKind__Array || _switch17255 == Ast_TypeInfoKind__List || _switch17255 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_4273_(itemType, convFlag, validToCheck)
            if err != nil{
                err_3925 := err.(string)
                return err_3925, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch17255 == Ast_TypeInfoKind__FormFunc || _switch17255 == Ast_TypeInfoKind__Func {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
...
// 4587: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch17409 := typeInfo.FP.Get_kind(); _switch17409 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 4610: decl @lune.@base.@Ast.isConditionalbe
...
// 5430: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_4646_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp23248 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp23248.Val1
...
// 6348: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_5226_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 6881: decl @lune.@base.@Ast.createProcessInfo
...
// 4118: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 4189: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch15393 := mutMode; _switch15393 == Ast_MutMode__IMut || _switch15393 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch15393 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp15461 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp15461.Val1
    ...
    if _switch15528 := mutMode; _switch15528 == Ast_MutMode__IMut || _switch15528 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch15528 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4619: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4665: decl @lune.@base.@Ast.ProcessInfo.createSet
func (self *Ast_ProcessInfo) CreateSet(accessMode LnsInt,parentInfo *Ast_TypeInfo,itemTypeInfo *LnsList,mutMode LnsInt) *Ast_TypeInfo {
    ...
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeSet), Ast_builtinTypeSet, nil, false, false, false, Ast_AccessMode__Pub, "Set", Ast_headTypeInfo, self.FP.Get_idProv().FP.Get_id(), Ast_TypeInfoKind__Set, itemTypeInfo, nil, nil, workMutMode, nil).Ast_TypeInfo
    }
...
// 4678: decl @lune.@base.@Ast.ProcessInfo.createList
func (self *Ast_ProcessInfo) CreateList(accessMode LnsInt,parentInfo *Ast_TypeInfo,itemTypeInfo *LnsList,mutMode LnsInt) *Ast_TypeInfo {
    ...
    var newTypeFunc func(workMutMode LnsInt) *Ast_TypeInfo
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeList), Ast_builtinTypeList, nil, false, false, false, Ast_AccessMode__Pub, "List", Ast_headTypeInfo, self.FP.Get_idProv().FP.Get_id(), Ast_TypeInfoKind__List, itemTypeInfo, nil, nil, workMutMode, nil).Ast_TypeInfo
    }
    var typeInfo *Ast_TypeInfo
    typeInfo = newTypeFunc(tmpMutMode)
    if Ast_isMutable(mutMode){
...
// 4691: decl @lune.@base.@Ast.ProcessInfo.createArray
func (self *Ast_ProcessInfo) CreateArray(accessMode LnsInt,parentInfo *Ast_TypeInfo,itemTypeInfo *LnsList,mutMode LnsInt) *Ast_TypeInfo {
    ...
    var newTypeFunc func(workMutMode LnsInt) *Ast_TypeInfo
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeArray), Ast_builtinTypeArray, nil, false, false, false, Ast_AccessMode__Pub, "Array", Ast_headTypeInfo, self.FP.Get_idProv().FP.Get_id(), Ast_TypeInfoKind__Array, itemTypeInfo, nil, nil, workMutMode, nil).Ast_TypeInfo
    }
    var typeInfo *Ast_TypeInfo
    typeInfo = newTypeFunc(tmpMutMode)
    if Ast_isMutable(mutMode){
...
// 4704: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4719: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4740: decl @lune.@base.@Ast.ProcessInfo.createClass
...
// 4774: decl @lune.@base.@Ast.ProcessInfo.createExtModule
func (self *Ast_ProcessInfo) CreateExtModule(scope LnsAny,parentInfo *Ast_TypeInfo,externalFlag bool,accessMode LnsInt,className string,moduleLang LnsInt,requirePath string) *Ast_TypeInfo {
    ...
    var info *Ast_NormalTypeInfo
    info = NewAst_NormalTypeInfo(self, false, scope, nil, nil, false, externalFlag, false, accessMode, className, parentInfo, self.FP.Get_idProv().FP.GetNewId(), Ast_TypeInfoKind__ExtModule, nil, nil, nil, Ast_MutMode__Mut, moduleLang)
    info.FP.set_requirePath(requirePath)
    return &info.Ast_TypeInfo
}

// 4802: decl @lune.@base.@Ast.ProcessInfo.createFunc
func (self *Ast_ProcessInfo) CreateFunc(abstractFlag bool,builtinFlag bool,scope LnsAny,kind LnsInt,parentInfo *Ast_TypeInfo,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,funcName string,altTypeList LnsAny,argTypeList LnsAny,retTypeInfoList LnsAny,mutable LnsAny) *Ast_NormalTypeInfo {
    ...
    if altTypeList != nil{
        altTypeList_4146 := altTypeList.(*LnsList)
        for _, _genType := range( altTypeList_4146.Items ) {
...
// 4832: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4861: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 5017: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4273_(typeInfo, Ast_LuavalConvKind__InLua, true)))) &&
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( extTypeFlag) ).(bool)){
        switch _exp19985 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp19985.Val1
            typeInfo = work
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4273_(typeInfo, Ast_LuavalConvKind__InLua, true))){
...
// 5421: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    process = func() LnsAny {
        {
            ...
            if _dddType != nil {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp22962 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp22962.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp22962.Val1
        ...
        var err LnsAny
        var canConv bool
        err, canConv = Ast_failCreateLuavalWith_4273_(luneType, Ast_LuavalConvKind__InLua, validToCheck)
        
        if err != nil{
            err_4849 := err.(string)
            return &Ast_LuavalResult__Err{err_4849}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp23101 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23101.Val1
...
// 151: decl @lune.@base.@Ast.DummyModuleInfoManager.___init
func Ast_DummyModuleInfoManager____init_1163_() {
...
// 158: decl @lune.@base.@Ast.DummyModuleInfoManager.getModuleInfo
...
// 1044: decl @lune.@base.@Ast.TypeNameCtrl.getModuleName
...
// 1059: decl @lune.@base.@Ast.TypeNameCtrl.getParentFullName
...
// 414: decl @lune.@base.@Ast.SymbolInfo.hasAccess
...
// 565: decl @lune.@base.@Ast.SymbolInfo.get_namespaceTypeInfo
...
// 987: decl @lune.@base.@Ast.SymbolInfo.getModule
...
// 512: decl @lune.@base.@Ast.Scope.isRoot
func (self *Ast_Scope) IsRoot() bool {
    return self.parent == self
}

// 516: decl @lune.@base.@Ast.Scope.set_ownerTypeInfo
...
// 521: decl @lune.@base.@Ast.Scope.switchOwnerTypeInfo
func (self *Ast_Scope) SwitchOwnerTypeInfo(owner LnsAny) {
    self.ownerTypeInfo = owner
    
}

// 526: decl @lune.@base.@Ast.Scope.getTypeInfoChild
...
// 554: decl @lune.@base.@Ast.Scope.getModuleInfo
...
// 582: decl @lune.@base.@Ast.Scope.isInnerOf
...
// 1151: decl @lune.@base.@Ast.Scope.getNamespaceTypeInfo
...
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection4971 := self.symbol2SymbolInfoMap
                __sorted4971 := __collection4971.CreateKeyListStr()
                __sorted4971.Sort( LnsItemKindStr, nil )
                for _, ___key4971 := range( __sorted4971.Items ) {
                    symbolInfo := __collection4971.Items[ ___key4971 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1668: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1698: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1725: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1747: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1771: decl @lune.@base.@Ast.Scope.filterTypeInfoFieldAndIF
func (self *Ast_Scope) FilterTypeInfoFieldAndIF(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5341 := self.symbol2SymbolInfoMap
                __sorted5341 := __collection5341.CreateKeyListStr()
                __sorted5341.Sort( LnsItemKindStr, nil )
                for _, ___key5341 := range( __sorted5341.Items ) {
                    symbolInfo := __collection5341.Items[ ___key5341 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    if Lns_isCondTrue( symbolInfo.FP.CanAccess(fromScope, access)){
                        if Lns_op_not(callback(symbolInfo)){
                            return false
                        }
...
// 1819: decl @lune.@base.@Ast.Scope.getSymbolInfo
...
// 1880: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1897: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
...
// 1940: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
...
// 1962: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool,isLazyLoad bool)(LnsAny, LnsAny) {
    if _switch6163 := kind; _switch6163 == Ast_SymbolKind__Typ || _switch6163 == Ast_SymbolKind__Fun || _switch6163 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch6129 := typeInfo.FP.Get_kind(); _switch6129 == Ast_TypeInfoKind__Enum {
        ...
        } else if _switch6129 == Ast_TypeInfoKind__Class || _switch6129 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1946 := existSymbol.(*Ast_SymbolInfo)
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() != existSymbol_1946.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1946.FP.Get_typeInfo().FP.Get_typeId()))) ).(bool){
                return nil, existSymbol_1946
            }
        }
    }
...
// 2004: decl @lune.@base.@Ast.Scope.addLocalVar
...
// 2017: decl @lune.@base.@Ast.Scope.addUnwrapedVar
...
// 2028: decl @lune.@base.@Ast.Scope.addStaticVar
...
// 2038: decl @lune.@base.@Ast.Scope.addVar
...
// 2052: decl @lune.@base.@Ast.Scope.addEnumVal
...
// 2062: decl @lune.@base.@Ast.Scope.addEnum
...
// 2092: decl @lune.@base.@Ast.Scope.addAlternate
...
// 2101: decl @lune.@base.@Ast.Scope.addMember
...
// 2111: decl @lune.@base.@Ast.Scope.addMethod
...
// 2121: decl @lune.@base.@Ast.Scope.addFunc
...
// 2132: decl @lune.@base.@Ast.Scope.addForm
...
// 2142: decl @lune.@base.@Ast.Scope.addMacro
...
// 2153: decl @lune.@base.@Ast.Scope.addClassLazy
...
// 2162: decl @lune.@base.@Ast.Scope.addClass
...
// 2169: decl @lune.@base.@Ast.Scope.addExtModule
func (self *Ast_Scope) AddExtModule(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo,lazy bool,lang LnsInt)(LnsAny, LnsAny) {
    if lang != Types_Lang__Same{
        switch _exp7277 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__Err:
        mess := _exp7277.Val1
            Util_err(mess)
        case *Ast_LuavalResult__OK:
        luavalTypeInfo := _exp7277.Val1
...
// 2223: decl @lune.@base.@Ast.Scope.setClosure
...
// 2252: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch7663 := symbol.FP.Get_kind(); _switch7663 == Ast_SymbolKind__Var || _switch7663 == Ast_SymbolKind__Arg || _switch7663 == Ast_SymbolKind__Fun {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2292: decl @lune.@base.@Ast.Scope.accessSymbol
...
// 2417: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if _owner != nil {
                ...
                if _switch8048 := owner.FP.Get_kind(); _switch8048 == Ast_TypeInfoKind__Class || _switch8048 == Ast_TypeInfoKind__IF || _switch8048 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4258: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4409: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4870: decl @lune.@base.@Ast.Scope.addAlias
...
// 4883: decl @lune.@base.@Ast.Scope.addAliasForType
...
// 602: decl @lune.@base.@Ast.TypeData.addChildren
...
// 656: decl @lune.@base.@Ast.TypeInfo.getProcessInfo
func (self *Ast_TypeInfo) getProcessInfo() *Ast_ProcessInfo {
    return self.processInfo
}

// 660: decl @lune.@base.@Ast.TypeInfo.switchScope
...
// 670: decl @lune.@base.@Ast.TypeInfo.getOverridingType
...
// 759: decl @lune.@base.@Ast.TypeInfo.canEvalWith
...
// 805: decl @lune.@base.@Ast.TypeInfo.get_externalFlag
func (self *Ast_TypeInfo) Get_externalFlag() bool {
    return false
}

// 810: decl @lune.@base.@Ast.TypeInfo.get_interfaceList
func (self *Ast_TypeInfo) Get_interfaceList() *LnsList {
    return Ast_dummyList
}

// 814: decl @lune.@base.@Ast.TypeInfo.get_itemTypeInfoList
func (self *Ast_TypeInfo) Get_itemTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 818: decl @lune.@base.@Ast.TypeInfo.get_argTypeInfoList
func (self *Ast_TypeInfo) Get_argTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 822: decl @lune.@base.@Ast.TypeInfo.get_retTypeInfoList
func (self *Ast_TypeInfo) Get_retTypeInfoList() *LnsList {
    return Ast_dummyList
}


// 832: decl @lune.@base.@Ast.TypeInfo.hasRouteNamespaceFrom
...
// 845: decl @lune.@base.@Ast.TypeInfo.getModule
...
// 921: decl @lune.@base.@Ast.TypeInfo.applyGeneric
func (self *Ast_TypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    return self
}

// 927: decl @lune.@base.@Ast.TypeInfo.get_genSrcTypeInfo
func (self *Ast_TypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self
}

// 931: decl @lune.@base.@Ast.TypeInfo.serializeTypeInfoList
...
// 946: decl @lune.@base.@Ast.TypeInfo.createScope
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_1117 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_1117.FP.Get_scope()).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_1120 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_1120.Items ) {
...
// 2312: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 5225: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp21161 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp21161.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp21161.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch21351 := type1.FP.Get_kind(); _switch21351 == Ast_TypeInfoKind__List {
        ...
        } else if _switch21351 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch21351 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch21351 == Ast_TypeInfoKind__Map {
...
// 5370: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp21525 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp21525.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp21525.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 6146: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from25098 LnsInt = index
            var _to25098 LnsInt = dstTypeList.Len()
            for _work25098 := _from25098; _work25098 <= _to25098; _work25098++ {
                dstIndex := _work25098
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from25385 LnsInt = index
            var _to25385 LnsInt = expTypeList.Len()
            for _work25385 := _from25385; _work25385 <= _to25385; _work25385++ {
                srcIndex := _work25385
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_5148 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_5148 <= srcIndex{
                        var workMess string
        ...
        for _index, _expType := range( expTypeList.Items ) {
            ...
            if dstTypeList.Len() == index{
                ...
                if warnForFollowSrcIndex != nil{
                    ...
                    if warnForFollowSrcIndex_5171 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_5185 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_5185 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
                ...
                if Lns_op_not(canEval){
                    return Ast_MatchType__Error, Lns_getVM().String_format("exp(%d) type mismatch %s(%d) <- %s(%d)%s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), dstType.FP.Get_typeId(), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.Get_typeId(), (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        Lns_GetEnv().SetStackVal( evalMess) &&
                        Lns_GetEnv().SetStackVal( Lns_getVM().String_format(" -- %s", []LnsAny{evalMess})) ||
                        Lns_GetEnv().SetStackVal( "") ).(string))})
                }
    ...
    if warnMess != nil{
        warnMess_5204 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_5204
    }
    return Ast_MatchType__Match, ""
}

// 6368: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch26748 := canEvalType; _switch26748 == Ast_CanEvalType__SetEq || _switch26748 == Ast_CanEvalType__SetOp || _switch26748 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch26545 := otherSrc; _switch26545 == Ast_builtinTypeAbbr || _switch26545 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            if processInfo.FP.Get_validCheckingMutable(){
                ...
                if _switch26637 := nonNilOtherType.FP.Get_kind(); _switch26637 == Ast_TypeInfoKind__Set || _switch26637 == Ast_TypeInfoKind__Map || _switch26637 == Ast_TypeInfoKind__List || _switch26637 == Ast_TypeInfoKind__IF || _switch26637 == Ast_TypeInfoKind__Alternate {
                    return false, nil
                } else if _switch26637 == Ast_TypeInfoKind__Class {
                    if Ast_builtinTypeString != nonNilOtherType{
                        return false, nil
                    }
                } else if _switch26637 == Ast_TypeInfoKind__Prim {
    ...
    }
    {
        ...
        if _extTypeInfo != nil {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4273_(extTypeInfo.FP.Get_extedType(), Ast_LuavalConvKind__ToLua, false)))) ).(bool)){
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if _switch27404 := otherSrc.FP.Get_kind(); _switch27404 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch27404 == Ast_TypeInfoKind__FormFunc || _switch27404 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_5226_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch27609 := otherSrc.FP.Get_kind(); _switch27609 == Ast_TypeInfoKind__FormFunc || _switch27609 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
...
// 6866: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 1115: decl @lune.@base.@Ast.RootTypeInfo.get_baseTypeInfo
func (self *Ast_RootTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1119: decl @lune.@base.@Ast.RootTypeInfo.get_parentInfo
func (self *Ast_RootTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1123: decl @lune.@base.@Ast.RootTypeInfo.create
func Ast_RootTypeInfo_create_1982_() *Ast_RootTypeInfo {
    return NewAst_RootTypeInfo()
}

// 1127: decl @lune.@base.@Ast.RootTypeInfo.get_rawTxt
func (self *Ast_RootTypeInfo) Get_rawTxt() string {
    return "<head>"
}

// 1131: decl @lune.@base.@Ast.RootTypeInfo.getTxt
...
// 1212: decl @lune.@base.@Ast.NormalSymbolInfo.get_mutable
func (self *Ast_NormalSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.mutMode)
}

// 1220: decl @lune.@base.@Ast.NormalSymbolInfo.getOrg
...
// 2439: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch8233 := self.FP.Get_accessMode(); _switch8233 == Ast_AccessMode__Pub || _switch8233 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch8233 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch8233 == Ast_AccessMode__Local {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            Lns_GetEnv().SetStackVal( Ast_isBuiltin(self.FP.Get_typeInfo().FP.Get_typeId())) ||
            Lns_GetEnv().SetStackVal( self.FP.GetModule() == fromScope.FP.GetModule()) ).(bool){
            return &self.Ast_SymbolInfo
        }
        return nil
    } else if _switch8233 == Ast_AccessMode__Pri {
...
// 4454: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 1291: decl @lune.@base.@Ast.AutoBoxingInfo.___init
func Ast_AutoBoxingInfo____init_2112_() {
...
// 1308: decl @lune.@base.@Ast.AutoBoxingInfo.get_baseTypeInfo
func (self *Ast_AutoBoxingInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1312: decl @lune.@base.@Ast.AutoBoxingInfo.get_parentInfo
func (self *Ast_AutoBoxingInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1316: decl @lune.@base.@Ast.AutoBoxingInfo.get_kind
func (self *Ast_AutoBoxingInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Etc
}

// 1320: decl @lune.@base.@Ast.AutoBoxingInfo.inc
...
// 1325: decl @lune.@base.@Ast.AutoBoxingInfo.unregist
...
// 1330: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.___init
func Ast_CanEvalCtrlTypeInfo____init_2145_() {
...
// 1344: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_kind
func (self *Ast_CanEvalCtrlTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__CanEvalCtrl
}

// 1348: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_typeId
func (self *Ast_CanEvalCtrlTypeInfo) Get_typeId() LnsInt {
    return -1
}

// 1353: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_baseTypeInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1357: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_parentInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1361: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.createDefaultAlt2typeMap
...
// 1370: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.isValidApply
...
// 1374: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.setupNeedAutoBoxing
...
// 1380: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.updateNeedAutoBoxing
...
// 1391: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.hasNeedAutoBoxing
...
// 1401: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.finishNeedAutoBoxing
...
// 1418: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.canAutoBoxing
...
// 1464: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng_with
...
// 1482: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 1493: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_1560 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_1560.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 5973: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
// 1534: decl @lune.@base.@Ast.AliasTypeInfo.getParentFullName
...
// 1541: decl @lune.@base.@Ast.AliasTypeInfo.getFullName
...
// 1549: decl @lune.@base.@Ast.AliasTypeInfo.get_aliasSrc
func (self *Ast_AliasTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo
}

// 1553: decl @lune.@base.@Ast.AliasTypeInfo.get_nonnilableType
func (self *Ast_AliasTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1557: decl @lune.@base.@Ast.AliasTypeInfo.get_srcTypeInfo
func (self *Ast_AliasTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1560: decl @lune.@base.@Ast.AliasTypeInfo.get_genSrcTypeInfo
func (self *Ast_AliasTypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1564: decl @lune.@base.@Ast.AliasTypeInfo.getModule
func (self *Ast_AliasTypeInfo) GetModule() *Ast_TypeInfo {
    return self.FP.Get_parentInfo().FP.GetModule()
}

// 1569: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1575: decl @lune.@base.@Ast.AliasTypeInfo.serialize
...
// 1602: decl @lune.@base.@Ast.AliasTypeInfo.canEvalWith
...
// 1610: decl @lune.@base.@Ast.AliasTypeInfo.equals
...
// 2356: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp8424 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp8424.Val1
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if typeInfo != nil{
                typeInfo_2339 := typeInfo.(*Ast_TypeInfo)
                work = typeInfo_2339
...
// 2542: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2546: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2555: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2559: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp8555 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp8555.Val1
        if _switch8546 := self.symbolInfo.FP.Get_mutMode(); _switch8546 == Ast_MutMode__AllMut || _switch8546 == Ast_MutMode__IMut || _switch8546 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch8546 == Ast_MutMode__Mut {
            if _switch8544 := prefixTypeInfo.FP.Get_mutMode(); _switch8544 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch8544 == Ast_MutMode__Mut || _switch8544 == Ast_MutMode__IMut || _switch8544 == Ast_MutMode__IMutRe {
...
// 2588: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2592: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
// 2694: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        ...
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2496)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2496.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2496)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2496)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2496
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2515 := workAlt2type.(*LnsMap)
            workAlt2type_2515.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2745: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2771: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2539 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2539.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2539)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2781: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2787: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2562 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2562)
    }
    return false
}

// 2815: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2820: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2824: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2828: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2832: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2844: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2856: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4413: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if _genType != nil {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_3873 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_3873, alt2type)).(bool)
            }
...
// 4562: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 2926: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 2930: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 2935: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 2942: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 2953: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4632: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3992 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3992)
    }
    return nil
}

// 5937: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch24125 := canEvalType; _switch24125 == Ast_CanEvalType__SetOp || _switch24125 == Ast_CanEvalType__SetOpIMut || _switch24125 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 2980: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 3023: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 3028: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 3068: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3072: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3075: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3080: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 3141: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 3174: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 3188: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5451: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_4646_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4560 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4560, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
// 3234: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3242: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3246: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
...
// 3253: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch11352 := canEvalType; _switch11352 == Ast_CanEvalType__SetEq || _switch11352 == Ast_CanEvalType__SetOp {
...
// 3283: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4843: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4851: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6782: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5390 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5390, Ast_MutMode__IMut)
    }
    return nil
}
...
// 3383: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
func (self *Ast_EnumTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    return false, Lns_getVM().String_format("%d != %d", []LnsAny{self.FP.Get_typeId(), other.FP.Get_srcTypeInfo().FP.Get_aliasSrc().FP.Get_typeId()})
}

// 3530: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3535: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Items[name]
}

// 3539: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
...
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    {
        __collection23818 := self.name2EnumValInfo
        __sorted23818 := __collection23818.CreateKeyListStr()
        __sorted23818.Sort( LnsItemKindStr, nil )
        for _, ___key23818 := range( __sorted23818.Items ) {
            enumValInfo := __collection23818.Items[ ___key23818 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp23816 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp23816.Val1
...
// 3565: decl @lune.@base.@Ast.AlgeTypeInfo.get_baseTypeInfo
...
// 3638: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3661: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 5912: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    firstFlag = true
    {
        __collection24061 := self.valInfoMap
        __sorted24061 := __collection24061.CreateKeyListStr()
        __sorted24061.Sort( LnsItemKindStr, nil )
        for _, ___key24061 := range( __sorted24061.Items ) {
            algeValInfo := __collection24061.Items[ ___key24061 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3649: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3746: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,typeId LnsInt,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny,moduleLang LnsAny) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3765:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch13516 := kind; _switch13516 == Ast_TypeInfoKind__Set || _switch13516 == Ast_TypeInfoKind__Map || _switch13516 == Ast_TypeInfoKind__List || _switch13516 == Ast_TypeInfoKind__Array || _switch13516 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch13516 == Ast_TypeInfoKind__Class || _switch13516 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        if parentInfo != nil{
            parentInfo_3525 := parentInfo.(*Ast_TypeInfo)
            parentInfo_3525.FP.AddChildren(&self.Ast_TypeInfo)
        }
        var hasNilable bool
        hasNilable = false
        if _switch13618 := (kind); _switch13618 == Ast_TypeInfoKind__Prim || _switch13618 == Ast_TypeInfoKind__List || _switch13618 == Ast_TypeInfoKind__Array || _switch13618 == Ast_TypeInfoKind__Set || _switch13618 == Ast_TypeInfoKind__Map || _switch13618 == Ast_TypeInfoKind__Class || _switch13618 == Ast_TypeInfoKind__Stem || _switch13618 == Ast_TypeInfoKind__Module || _switch13618 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch13618 == Ast_TypeInfoKind__Func || _switch13618 == Ast_TypeInfoKind__Method || _switch13618 == Ast_TypeInfoKind__Form || _switch13618 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3855: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3865: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3869: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3873: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() LnsInt {
    return self.parentInfo.FP.Get_typeId()
}

// 3877: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() LnsInt {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3882: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 3888: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
func (self *Ast_NormalTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    parentTxt = ""
    if typeNameCtrl != nil{
        typeNameCtrl_3580 := typeNameCtrl.(*Ast_TypeNameCtrl)
        parentTxt = self.FP.GetParentFullName(typeNameCtrl_3580, importInfo, localFlag)
...
// 3916: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch14055 := self.kind; _switch14055 == Ast_TypeInfoKind__Func || _switch14055 == Ast_TypeInfoKind__Form || _switch14055 == Ast_TypeInfoKind__FormFunc || _switch14055 == Ast_TypeInfoKind__Method || _switch14055 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 3961: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3966: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 4005: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch14576 := self.kind; _switch14576 == Ast_TypeInfoKind__List || _switch14576 == Ast_TypeInfoKind__Map || _switch14576 == Ast_TypeInfoKind__Array || _switch14576 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 4075: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 4089: decl @lune.@base.@Ast.NormalTypeInfo.create
func Ast_NormalTypeInfo_create(processInfo *Ast_ProcessInfo,accessMode LnsInt,abstractFlag bool,scope LnsAny,baseInfo *Ast_TypeInfo,parentInfo *Ast_TypeInfo,staticFlag bool,kind LnsInt,txt string,itemTypeInfo *LnsList,argTypeInfoList *LnsList,retTypeInfoList *LnsList,mutMode LnsAny) *Ast_TypeInfo {
    if _switch14787 := kind; _switch14787 == Ast_TypeInfoKind__Class || _switch14787 == Ast_TypeInfoKind__ExtModule || _switch14787 == Ast_TypeInfoKind__IF {
    ...
    processInfo.FP.Get_idProv().FP.Increment()
    var info *Ast_NormalTypeInfo
    info = NewAst_NormalTypeInfo(processInfo, abstractFlag, scope, baseInfo, nil, false, true, staticFlag, accessMode, txt, parentInfo, processInfo.FP.Get_idProv().FP.Get_id(), kind, itemTypeInfo, argTypeInfoList, retTypeInfoList, mutMode, nil)
    return &info.Ast_TypeInfo
}

// 4314: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch16018 := kind; _switch16018 == Ast_TypeInfoKind__Array || _switch16018 == Ast_TypeInfoKind__List || _switch16018 == Ast_TypeInfoKind__Set || _switch16018 == Ast_TypeInfoKind__Class || _switch16018 == Ast_TypeInfoKind__Module || _switch16018 == Ast_TypeInfoKind__IF || _switch16018 == Ast_TypeInfoKind__Form || _switch16018 == Ast_TypeInfoKind__FormFunc || _switch16018 == Ast_TypeInfoKind__Func || _switch16018 == Ast_TypeInfoKind__Method || _switch16018 == Ast_TypeInfoKind__Macro {
    ...
    if _switch16116 := kind; _switch16116 == Ast_TypeInfoKind__Array || _switch16116 == Ast_TypeInfoKind__List || _switch16116 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch16116 == Ast_TypeInfoKind__Map {
    ...
    var info *Ast_NormalTypeInfo
    info = NewAst_NormalTypeInfo(Ast_rootProcessInfo, false, scope, nil, ifList, false, false, false, Ast_AccessMode__Pub, typeTxt, Ast_headTypeInfo, typeId, kind, genTypeList, argTypeList, retTypeList, Ast_MutMode__Mut, nil)
    Ast_registBuiltin_4205_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 6039: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch24720 := typeInfo.FP.Get_kind(); _switch24720 == Ast_TypeInfoKind__Prim || _switch24720 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch24720 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch24720 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch24720 == Ast_TypeInfoKind__Class || _switch24720 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch24720 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch24720 == Ast_TypeInfoKind__List || _switch24720 == Ast_TypeInfoKind__Array || _switch24720 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch24720 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch24720 == Ast_TypeInfoKind__Nilable {
...
// 6113: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 6772: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6796: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_4646_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch29031 := self.FP.Get_kind(); _switch29031 == Ast_TypeInfoKind__Set {
        ...
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_4646_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_4646_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
...
// 4147: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 4916: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 4920: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
func (self *Ast_DDDTypeInfo) Get_scope() LnsAny {
    return nil
}

// 4925: decl @lune.@base.@Ast.DDDTypeInfo.get_baseTypeInfo
func (self *Ast_DDDTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 4929: decl @lune.@base.@Ast.DDDTypeInfo.get_parentInfo
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeId LnsInt,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_4245 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_4245
...
// 4953: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 4957: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 4964: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 4971: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 4977: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5393: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 5108: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 5120: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 5139: decl @lune.@base.@Ast.CombineType.createStem
...
// 5153: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5485: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
func (self *Ast_AbbrTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5490: decl @lune.@base.@Ast.AbbrTypeInfo.get_baseTypeInfo
func (self *Ast_AbbrTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5494: decl @lune.@base.@Ast.AbbrTypeInfo.get_parentInfo
...
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4273_(self.extedType, Ast_LuavalConvKind__InLua, false))){
        return false
    }
...
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp22580(Lns_2DDD(Ast_failCreateLuavalWith_4273_(other, Ast_LuavalConvKind__ToLua, true)))
        if __exp != nil {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 6950: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 6961: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 6972: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 7012: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
        ...
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            for {
                ...
                if refType != nil{
                    ...
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5558.FP.Get_typeInfo()))
                }
...
func Lns_Ast_init() {
    ...
    Ast_DummyModuleInfoManager____init_1163_()
    ...
    _ = NewLnsList([]LnsAny{})
    Ast_headTypeInfo = &Ast_RootTypeInfo_create_1982_().Ast_TypeInfo
    Ast_defaultTypeNameCtrl = NewAst_TypeNameCtrl(Ast_headTypeInfo)
    Ast_AutoBoxingInfo____init_2112_()
    Ast_CanEvalCtrlTypeInfo____init_2145_()
    ...
    Ast_registBuiltin_4205_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_4205_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_4205_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    ...
    switch _exp23140 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23140.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_4205_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_4205_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
