...
// for 5730
func Ast_convExp22900(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7156
func Ast_convExp30335(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
func Ast_convExp31308(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
func Ast_convExp31466(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
func Ast_convExp31632(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
func Ast_convExp31803(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
func Ast_convExp31969(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
...
// for 7292
func Ast_convExp32354(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7292
func Ast_convExp32512(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7331
func Ast_convExp32667(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
func Ast_isPubToExternal(mode LnsInt) bool {
    if _switch858 := mode; _switch858 == Ast_AccessMode__Pub || _switch858 == Ast_AccessMode__Pro || _switch858 == Ast_AccessMode__Global {
        return true
    }
    return false
}
...
func Ast_isMutable(mode LnsInt) bool {
    if _switch1071 := mode; _switch1071 == Ast_MutMode__AllMut || _switch1071 == Ast_MutMode__Mut {
        return true
    }
    return false
}
...
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection3086 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted3086 := __collection3086.CreateKeyListStr()
            __sorted3086.Sort( LnsItemKindStr, nil )
            for _, ___key3086 := range( __sorted3086.Items ) {
                symbolInfo := __collection3086.Items[ ___key3086 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch3084 := symbolInfo.FP.Get_kind(); _switch3084 == symbolKind {
...
// 2295: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2178_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            {
                __collection7893 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted7893 := __collection7893.CreateKeyListStr()
                __sorted7893.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted7893.Items ) {
                    symbolInfo := __collection7893.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 3533: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp12449 := obj.(type) {
...
// 4286: decl @lune.@base.@Ast.isExtType
...
// 4293: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch15805 := typeInfo.FP.Get_kind(); _switch15805 == Ast_TypeInfoKind__FormFunc || _switch15805 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4390: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId().Id,typeInfo)
}

// 4396: decl @lune.@base.@Ast.registBuiltin
...
// 4512: decl @lune.@base.@Ast.isClass
...
// 4583: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_3281_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch17706 := typeInfo.FP.Get_kind(); _switch17706 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_3281_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch17706 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch17706 == Ast_TypeInfoKind__Form || _switch17706 == Ast_TypeInfoKind__IF || _switch17706 == Ast_TypeInfoKind__DDD || _switch17706 == Ast_TypeInfoKind__ExtModule {
        ...
        return nil, false
    } else if _switch17706 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch17706 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch17706 == Ast_TypeInfoKind__Array || _switch17706 == Ast_TypeInfoKind__List || _switch17706 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return nil, canConv
    } else if _switch17706 == Ast_TypeInfoKind__FormFunc || _switch17706 == Ast_TypeInfoKind__Func {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
...
// 4694: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch17860 := typeInfo.FP.Get_kind(); _switch17860 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 4716: decl @lune.@base.@Ast.isConditionalbe
...
// 5530: decl @lune.@base.@Ast.applyGenericList
...
// 5865: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp23566 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp23566.Val1
...
// 5909: decl @lune.@base.@Ast.isNumberType
...
// 6441: decl @lune.@base.@Ast.isSettableToForm
...
// 6974: decl @lune.@base.@Ast.createProcessInfo
...
// 4235: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 4306: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch15885 := mutMode; _switch15885 == Ast_MutMode__IMut || _switch15885 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch15885 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp15947 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp15947.Val1
    ...
    if _switch16008 := mutMode; _switch16008 == Ast_MutMode__IMut || _switch16008 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch16008 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4725: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4769: decl @lune.@base.@Ast.ProcessInfo.createSet
...
// 4782: decl @lune.@base.@Ast.ProcessInfo.createList
...
// 4795: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 4808: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4823: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4843: decl @lune.@base.@Ast.ProcessInfo.createClass
...
// 4877: decl @lune.@base.@Ast.ProcessInfo.createExtModule
...
// 4905: decl @lune.@base.@Ast.ProcessInfo.createFunc
func (self *Ast_ProcessInfo) CreateFunc(abstractFlag bool,builtinFlag bool,scope LnsAny,kind LnsInt,parentInfo *Ast_TypeInfo,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,funcName string,altTypeList LnsAny,argTypeList LnsAny,retTypeInfoList LnsAny,mutable LnsAny) *Ast_NormalTypeInfo {
    ...
    if altTypeList != nil{
        altTypeList_3864 := altTypeList.(*LnsList)
        for _, _genType := range( altTypeList_3864.Items ) {
...
// 4935: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4964: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 5121: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( extTypeFlag) ).(bool)){
        switch _exp20353 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp20353.Val1
            typeInfo = work
...
// 5522: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5789: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    process = func() LnsAny {
        {
            ...
            if !Lns_IsNil( _dddType ) {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp23286 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp23286.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp23286.Val1
        ...
        if err != nil{
            err_4564 := err.(string)
            return &Ast_LuavalResult__Err{err_4564}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp23419 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23419.Val1
...
// 5915: decl @lune.@base.@Ast.ProcessInfo.createEnum
...
// 5983: decl @lune.@base.@Ast.ProcessInfo.createAlge
...
// 6981: decl @lune.@base.@Ast.ProcessInfo.newUser
...
func (self *Ast_IdInfo) Equals(idInfo *Ast_IdInfo) bool {
    if self.FP.Get_orgId() == idInfo.FP.Get_orgId(){
        ...
        if self.FP.Get_orgId() >= Ast_extStartId{
            return true
        }
    }
    return false
...
// 1721: decl @lune.@base.@Ast.Scope.filterTypeInfoField
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5351 := self.symbol2SymbolInfoMap
                __sorted5351 := __collection5351.CreateKeyListStr()
                __sorted5351.Sort( LnsItemKindStr, nil )
                for _, ___key5351 := range( __sorted5351.Items ) {
                    symbolInfo := __collection5351.Items[ ___key5351 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1750: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1780: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1807: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1829: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1853: decl @lune.@base.@Ast.Scope.filterTypeInfoFieldAndIF
func (self *Ast_Scope) FilterTypeInfoFieldAndIF(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5721 := self.symbol2SymbolInfoMap
                __sorted5721 := __collection5721.CreateKeyListStr()
                __sorted5721.Sort( LnsItemKindStr, nil )
                for _, ___key5721 := range( __sorted5721.Items ) {
                    symbolInfo := __collection5721.Items[ ___key5721 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    if Lns_isCondTrue( symbolInfo.FP.CanAccess(fromScope, access)){
                        if Lns_op_not(callback(symbolInfo)){
                            return false
                        }
...
// 1901: decl @lune.@base.@Ast.Scope.getSymbolInfo
...
// 1962: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1979: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
...
// 2022: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
...
// 2044: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool,isLazyLoad bool)(LnsAny, LnsAny) {
    ...
    ownerTypeInfo = nil
    if _switch6569 := kind; _switch6569 == Ast_SymbolKind__Typ || _switch6569 == Ast_SymbolKind__Fun || _switch6569 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch6515 := typeInfo.FP.Get_kind(); _switch6515 == Ast_TypeInfoKind__Enum {
        ...
        } else if _switch6515 == Ast_TypeInfoKind__Class || _switch6515 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1646 := existSymbol.(*Ast_SymbolInfo)
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() != existSymbol_1646.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1646.FP.Get_typeInfo().FP.Get_typeId().Id))) ).(bool){
                return nil, existSymbol_1646
            }
        }
    } else if _switch6569 == Ast_SymbolKind__Var {
...
// 2093: decl @lune.@base.@Ast.Scope.addSymbolInfo
...
// 2103: decl @lune.@base.@Ast.Scope.addLocalVar
...
// 2116: decl @lune.@base.@Ast.Scope.addUnwrapedVar
...
// 2127: decl @lune.@base.@Ast.Scope.addStaticVar
...
// 2137: decl @lune.@base.@Ast.Scope.addVar
...
// 2151: decl @lune.@base.@Ast.Scope.addEnumVal
...
// 2161: decl @lune.@base.@Ast.Scope.addEnum
...
// 2191: decl @lune.@base.@Ast.Scope.addAlternate
...
// 2200: decl @lune.@base.@Ast.Scope.addMember
...
// 2210: decl @lune.@base.@Ast.Scope.addMethod
...
// 2220: decl @lune.@base.@Ast.Scope.addFunc
...
// 2231: decl @lune.@base.@Ast.Scope.addForm
...
// 2241: decl @lune.@base.@Ast.Scope.addMacro
...
// 2252: decl @lune.@base.@Ast.Scope.addClassLazy
...
// 2261: decl @lune.@base.@Ast.Scope.addClass
...
// 2268: decl @lune.@base.@Ast.Scope.addExtModule
func (self *Ast_Scope) AddExtModule(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo,lazy bool,lang LnsInt)(LnsAny, LnsAny) {
    if lang != Types_Lang__Same{
        switch _exp7749 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__Err:
        mess := _exp7749.Val1
            Util_err(mess)
        case *Ast_LuavalResult__OK:
        luavalTypeInfo := _exp7749.Val1
...
// 2322: decl @lune.@base.@Ast.Scope.setClosure
...
// 2351: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch8135 := symbol.FP.Get_kind(); _switch8135 == Ast_SymbolKind__Var || _switch8135 == Ast_SymbolKind__Arg || _switch8135 == Ast_SymbolKind__Fun {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2391: decl @lune.@base.@Ast.Scope.accessSymbol
...
// 2515: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if !Lns_IsNil( _owner ) {
                ...
                if _switch8519 := owner.FP.Get_kind(); _switch8519 == Ast_TypeInfoKind__Class || _switch8519 == Ast_TypeInfoKind__IF || _switch8519 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4373: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4516: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4973: decl @lune.@base.@Ast.Scope.addAlias
...
// 4986: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch19796 := typeInfo.FP.Get_kind(); _switch19796 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch19796 == Ast_TypeInfoKind__Form || _switch19796 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch19796 == Ast_TypeInfoKind__Macro {
...
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_809 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_809.FP.Get_scope()).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_812 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_812.Items ) {
...
// 2411: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 5326: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp21521 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp21521.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp21521.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch21711 := type1.FP.Get_kind(); _switch21711 == Ast_TypeInfoKind__List {
        ...
        } else if _switch21711 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch21711 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch21711 == Ast_TypeInfoKind__Map {
...
// 5471: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp21885 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp21885.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp21885.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 6237: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from25409 LnsInt = index
            var _to25409 LnsInt = dstTypeList.Len()
            for _work25409 := _from25409; _work25409 <= _to25409; _work25409++ {
                dstIndex := _work25409
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from25696 LnsInt = index
            var _to25696 LnsInt = expTypeList.Len()
            for _work25696 := _from25696; _work25696 <= _to25696; _work25696++ {
                srcIndex := _work25696
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4863 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4863 <= srcIndex{
                        var workMess string
    ...
    if expTypeList.Len() > 0{
        for _index, _expType := range( expTypeList.Items ) {
            ...
            if dstTypeList.Len() == index{
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4886 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4886 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    ...
                    if warnForFollowSrcIndex_4900 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4909 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4909 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_4919 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_4919
    }
    return Ast_MatchType__Match, ""
}

// 6461: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch27069 := canEvalType; _switch27069 == Ast_CanEvalType__SetEq || _switch27069 == Ast_CanEvalType__SetOp || _switch27069 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch26866 := otherSrc; _switch26866 == Ast_builtinTypeAbbr || _switch26866 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            if processInfo.FP.Get_validCheckingMutable(){
                ...
                if _switch26958 := nonNilOtherType.FP.Get_kind(); _switch26958 == Ast_TypeInfoKind__Set || _switch26958 == Ast_TypeInfoKind__Map || _switch26958 == Ast_TypeInfoKind__List || _switch26958 == Ast_TypeInfoKind__IF || _switch26958 == Ast_TypeInfoKind__Alternate {
                    return false, nil
                } else if _switch26958 == Ast_TypeInfoKind__Class {
                    if Ast_builtinTypeString != nonNilOtherType{
                        return false, nil
                    }
                } else if _switch26958 == Ast_TypeInfoKind__Prim {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return Ast_isSettableToForm_3920_(processInfo, otherSrc), nil
    }
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( otherSrc == Ast_builtinTypeNil) ||
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if _switch27727 := otherSrc.FP.Get_kind(); _switch27727 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch27727 == Ast_TypeInfoKind__FormFunc || _switch27727 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_3920_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch27932 := otherSrc.FP.Get_kind(); _switch27932 == Ast_TypeInfoKind__FormFunc || _switch27932 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
    ...
    if _switch28905 := dest.FP.Get_kind(); _switch28905 == Ast_TypeInfoKind__Prim {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch28905 == Ast_TypeInfoKind__List || _switch28905 == Ast_TypeInfoKind__Array || _switch28905 == Ast_TypeInfoKind__Set {
        ...
        return true, nil
    } else if _switch28905 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch28905 == Ast_TypeInfoKind__Class || _switch28905 == Ast_TypeInfoKind__IF {
        ...
        return false, nil
    } else if _switch28905 == Ast_TypeInfoKind__Form {
        return Ast_isSettableToForm_3920_(processInfo, otherSrc), nil
    } else if _switch28905 == Ast_TypeInfoKind__Func || _switch28905 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch28905 == Ast_TypeInfoKind__Method {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return true, nil
    } else if _switch28905 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch28905 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch28905 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, nil
    }
...
// 6959: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 2537: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch8710 := self.FP.Get_accessMode(); _switch8710 == Ast_AccessMode__Pub || _switch8710 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch8710 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch8710 == Ast_AccessMode__Local {
        ...
        return nil
    } else if _switch8710 == Ast_AccessMode__Pri {
...
// 4561: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
func (self *Ast_NilableTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind = %d, typeId = %d, orgTypeId = %d }\n", []LnsAny{Ast_SerializeKind__Nilable, self.typeId.Id, self.nonnilableType.FP.Get_typeId().Id}))
}

// 1563: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 1574: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_1260 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_1260.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 6064: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
// 1614: decl @lune.@base.@Ast.AliasTypeInfo.getParentFullName
...
// 1621: decl @lune.@base.@Ast.AliasTypeInfo.getFullName
...
// 1629: decl @lune.@base.@Ast.AliasTypeInfo.get_aliasSrc
func (self *Ast_AliasTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo
}

// 1633: decl @lune.@base.@Ast.AliasTypeInfo.get_nonnilableType
func (self *Ast_AliasTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1637: decl @lune.@base.@Ast.AliasTypeInfo.get_srcTypeInfo
func (self *Ast_AliasTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1640: decl @lune.@base.@Ast.AliasTypeInfo.get_genSrcTypeInfo
func (self *Ast_AliasTypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1644: decl @lune.@base.@Ast.AliasTypeInfo.getModule
func (self *Ast_AliasTypeInfo) GetModule() *Ast_TypeInfo {
    return self.FP.Get_parentInfo().FP.GetModule()
}

// 1649: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1655: decl @lune.@base.@Ast.AliasTypeInfo.serialize
...
// 1684: decl @lune.@base.@Ast.AliasTypeInfo.canEvalWith
...
// 1692: decl @lune.@base.@Ast.AliasTypeInfo.equals
...
// 2454: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp8901 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp8901.Val1
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2643: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2647: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2656: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2660: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp9032 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp9032.Val1
        if _switch9023 := self.symbolInfo.FP.Get_mutMode(); _switch9023 == Ast_MutMode__AllMut || _switch9023 == Ast_MutMode__IMut || _switch9023 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch9023 == Ast_MutMode__Mut {
            if _switch9021 := prefixTypeInfo.FP.Get_mutMode(); _switch9021 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch9021 == Ast_MutMode__Mut || _switch9021 == Ast_MutMode__IMut || _switch9021 == Ast_MutMode__IMutRe {
...
// 2689: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2693: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
// 2795: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
...
// 2846: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2872: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
...
// 2882: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2888: decl @lune.@base.@Ast.AlternateTypeInfo.equals
...
// 2916: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2921: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2925: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2929: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2933: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2945: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2960: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4520: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if !Lns_IsNil( _genType ) {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_3591 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_3591, alt2type)).(bool)
            }
...
// 4669: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 3028: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3032: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 3037: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 3044: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 3055: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4737: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3710 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3710)
    }
    return nil
}

// 6028: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch24432 := canEvalType; _switch24432 == Ast_CanEvalType__SetOp || _switch24432 == Ast_CanEvalType__SetOpIMut || _switch24432 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 3082: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 3124: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 3129: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 3169: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3173: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3176: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3181: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 3242: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 3275: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 3290: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5551: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        if itemTypeInfoList != nil{
            itemTypeInfoList_4277 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4277, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
func (self *Ast_ModifierTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    if _switch11689 := self.mutMode; _switch11689 == Ast_MutMode__IMut || _switch11689 == Ast_MutMode__IMutRe {
        txt = "&" + txt
        
    } else if _switch11689 == Ast_MutMode__AllMut {
        txt = "allmut " + txt
...
// 3348: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3356: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3360: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
...
// 3368: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch11858 := canEvalType; _switch11858 == Ast_CanEvalType__SetEq || _switch11858 == Ast_CanEvalType__SetOp {
...
// 3398: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4946: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4954: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6875: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5105 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5105, Ast_MutMode__IMut)
    }
    return nil
}
...
func (self *Ast_ModuleTypeInfo) InitAst_ModuleTypeInfo(processInfo *Ast_ProcessInfo,scope *Ast_Scope,externalFlag bool,txt string,parentInfo LnsAny,mutable bool) {
    ...
    var fullName string
    if parentInfo != nil{
        parentInfo_2799 := parentInfo.(*Ast_TypeInfo)
        parentInfo_2799.FP.AddChildren(&self.Ast_TypeInfo)
        var parentFull string
        parentFull = parentInfo_2799.FP.GetParentFullName(Ast_defaultTypeNameCtrl, nil, nil)
...
// 3457: decl @lune.@base.@Ast.ModuleTypeInfo.equals
...
// 3516: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
// 3650: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3655: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Get(name)
}

// 3659: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5952: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    ...
    {
        __collection24130 := self.name2EnumValInfo
        __sorted24130 := __collection24130.CreateKeyListStr()
        __sorted24130.Sort( LnsItemKindStr, nil )
        for _, ___key24130 := range( __sorted24130.Items ) {
            enumValInfo := __collection24130.Items[ ___key24130 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp24128 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp24128.Val1
...
// 3685: decl @lune.@base.@Ast.AlgeTypeInfo.get_baseTypeInfo
...
// 3756: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3779: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 6004: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    ...
    firstFlag = true
    {
        __collection24368 := self.valInfoMap
        __sorted24368 := __collection24368.CreateKeyListStr()
        __sorted24368.Sort( LnsItemKindStr, nil )
        for _, ___key24368 := range( __sorted24368.Items ) {
            algeValInfo := __collection24368.Items[ ___key24368 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3767: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3864: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny,moduleLang LnsAny) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3883:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch14027 := kind; _switch14027 == Ast_TypeInfoKind__Set || _switch14027 == Ast_TypeInfoKind__Map || _switch14027 == Ast_TypeInfoKind__List || _switch14027 == Ast_TypeInfoKind__Array || _switch14027 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch14027 == Ast_TypeInfoKind__Class || _switch14027 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        if parentInfo != nil{
            parentInfo_3248 := parentInfo.(*Ast_TypeInfo)
            parentInfo_3248.FP.AddChildren(&self.Ast_TypeInfo)
        }
        var hasNilable bool
        hasNilable = false
        if _switch14136 := (kind); _switch14136 == Ast_TypeInfoKind__Prim || _switch14136 == Ast_TypeInfoKind__List || _switch14136 == Ast_TypeInfoKind__Array || _switch14136 == Ast_TypeInfoKind__Set || _switch14136 == Ast_TypeInfoKind__Map || _switch14136 == Ast_TypeInfoKind__Class || _switch14136 == Ast_TypeInfoKind__Stem || _switch14136 == Ast_TypeInfoKind__Module || _switch14136 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch14136 == Ast_TypeInfoKind__Func || _switch14136 == Ast_TypeInfoKind__Method || _switch14136 == Ast_TypeInfoKind__Form || _switch14136 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3970: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3980: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3984: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3988: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() *Ast_IdInfo {
    return self.parentInfo.FP.Get_typeId()
}

// 3992: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() *Ast_IdInfo {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3997: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 4003: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
func (self *Ast_NormalTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    parentTxt = ""
    if typeNameCtrl != nil{
        typeNameCtrl_3303 := typeNameCtrl.(*Ast_TypeNameCtrl)
        parentTxt = self.FP.GetParentFullName(typeNameCtrl_3303, importInfo, localFlag)
...
// 4031: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch14554 := self.kind; _switch14554 == Ast_TypeInfoKind__Func || _switch14554 == Ast_TypeInfoKind__Form || _switch14554 == Ast_TypeInfoKind__FormFunc || _switch14554 == Ast_TypeInfoKind__Method || _switch14554 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 4076: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 4081: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 4123: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch15078 := self.kind; _switch15078 == Ast_TypeInfoKind__List || _switch15078 == Ast_TypeInfoKind__Map || _switch15078 == Ast_TypeInfoKind__Array || _switch15078 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 4193: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 4207: decl @lune.@base.@Ast.NormalTypeInfo.create
func Ast_NormalTypeInfo_create(processInfo *Ast_ProcessInfo,accessMode LnsInt,abstractFlag bool,scope LnsAny,baseInfo *Ast_TypeInfo,parentInfo *Ast_TypeInfo,staticFlag bool,kind LnsInt,txt string,itemTypeInfo *LnsList,argTypeInfoList *LnsList,retTypeInfoList *LnsList,mutMode LnsAny) *Ast_TypeInfo {
    if _switch15289 := kind; _switch15289 == Ast_TypeInfoKind__Class || _switch15289 == Ast_TypeInfoKind__ExtModule || _switch15289 == Ast_TypeInfoKind__IF {
...
// 4425: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin_3239_(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch16471 := kind; _switch16471 == Ast_TypeInfoKind__Array || _switch16471 == Ast_TypeInfoKind__List || _switch16471 == Ast_TypeInfoKind__Set || _switch16471 == Ast_TypeInfoKind__Class || _switch16471 == Ast_TypeInfoKind__Module || _switch16471 == Ast_TypeInfoKind__IF || _switch16471 == Ast_TypeInfoKind__Form || _switch16471 == Ast_TypeInfoKind__FormFunc || _switch16471 == Ast_TypeInfoKind__Func || _switch16471 == Ast_TypeInfoKind__Method || _switch16471 == Ast_TypeInfoKind__Macro {
    ...
    if _switch16569 := kind; _switch16569 == Ast_TypeInfoKind__Array || _switch16569 == Ast_TypeInfoKind__List || _switch16569 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch16569 == Ast_TypeInfoKind__Map {
...
// 6130: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch25029 := typeInfo.FP.Get_kind(); _switch25029 == Ast_TypeInfoKind__Prim || _switch25029 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch25029 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch25029 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch25029 == Ast_TypeInfoKind__Class || _switch25029 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch25029 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch25029 == Ast_TypeInfoKind__List || _switch25029 == Ast_TypeInfoKind__Array || _switch25029 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch25029 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch25029 == Ast_TypeInfoKind__Nilable {
...
// 6204: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 6865: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6889: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    } else if _switch29356 == Ast_TypeInfoKind__Func || _switch29356 == Ast_TypeInfoKind__Form || _switch29356 == Ast_TypeInfoKind__FormFunc {
...
// 4264: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 5019: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 5023: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
func (self *Ast_DDDTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5028: decl @lune.@base.@Ast.DDDTypeInfo.get_baseTypeInfo
func (self *Ast_DDDTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5032: decl @lune.@base.@Ast.DDDTypeInfo.get_parentInfo
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_3962 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_3962
...
// 5056: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 5060: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 5067: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 5075: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 5081: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5494: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 5209: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 5221: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 5240: decl @lune.@base.@Ast.CombineType.createStem
...
// 5254: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5585: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
func (self *Ast_AbbrTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5590: decl @lune.@base.@Ast.AbbrTypeInfo.get_baseTypeInfo
func (self *Ast_AbbrTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5594: decl @lune.@base.@Ast.AbbrTypeInfo.get_parentInfo
...
// 5700: decl @lune.@base.@Ast.ExtTypeInfo.equals
...
// 5716: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp22900(Lns_2DDD(Ast_failCreateLuavalWith_3281_(other, Ast_LuavalConvKind__ToLua, true)))
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5740: decl @lune.@base.@Ast.ExtTypeInfo.serialize
...
// 7048: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 7059: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 7070: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 7110: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Types_Position)(LnsAny, LnsAny, LnsAny) {
    ...
    for  {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp30335(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5277 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5277))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5277.FP.Get_typeInfo()))
                }
            ...
            if _switch30964 := typeInfo.FP.Get_kind(); _switch30964 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch30964 == Ast_TypeInfoKind__List {
            ...
            } else if _switch30964 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30964 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30964 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30964 == Ast_TypeInfoKind__Class || _switch30964 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch30964 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30964 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp30942 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp30942.Val1
...
func Lns_Ast_init() {
    ...
    switch _exp23458 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23458.Val1
