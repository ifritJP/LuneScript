...
func Ast_LuavalConvKind_get__allList_3279_() *LnsList{
...
func Ast_LuavalConvKind__from_3274_(arg1 LnsInt) LnsAny{
...
// for 5735
func Ast_convExp22909(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7194
func Ast_convExp30720(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp31685(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp31842(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp32007(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp32177(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp32342(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp32549(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp32725(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7330
func Ast_convExp32882(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7369
func Ast_convExp33036(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
func ProcessInfo_switchIdProvier___anonymous_1080_() string {
    return "start"
}
// 203: decl @lune.@base.@Ast.getRootProcessInfo
func Ast_getRootProcessInfo() *Ast_ProcessInfo {
    return Ast_rootProcessInfo
}

// 314: decl @lune.@base.@Ast.getSym2builtInTypeMap
func Ast_getSym2builtInTypeMap() *LnsMap {
    return Ast_sym2builtInTypeMap
}

// 318: decl @lune.@base.@Ast.getBuiltInTypeIdMap
func Ast_getBuiltInTypeIdMap() *LnsMap {
    return Ast_builtInTypeIdSet
}

// 338: decl @lune.@base.@Ast.isBuiltin
func Ast_isBuiltin(typeId LnsInt) bool {
    return Ast_TypeInfo2Stem(Ast_builtInTypeIdSet.Get(typeId)) != nil
}

// 343: decl @lune.@base.@Ast.isPubToExternal
func Ast_isPubToExternal(mode LnsInt) bool {
    if _switch846 := mode; _switch846 == Ast_AccessMode__Pub || _switch846 == Ast_AccessMode__Pro || _switch846 == Ast_AccessMode__Global {
        return true
    }
    return false
}

// 359: decl @lune.@base.@Ast.txt2AccessMode
func Ast_txt2AccessMode(accessMode string) LnsAny {
    return Ast_txt2AccessModeMap.Get(accessMode)
}

// 370: decl @lune.@base.@Ast.accessMode2txt
func Ast_accessMode2txt(accessMode LnsInt) string {
    return Lns_unwrap( Ast_accessMode2txtMap.Get(accessMode)).(string)
}

// 384: decl @lune.@base.@Ast.isMutable
func Ast_isMutable(mode LnsInt) bool {
    if _switch1059 := mode; _switch1059 == Ast_MutMode__AllMut || _switch1059 == Ast_MutMode__Mut {
        return true
    }
    return false
}

// 1048: decl @lune.@base.@Ast.applyGenericDefault
...
// 1076: decl @lune.@base.@Ast.getAllNameForKind
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection3074 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted3074 := __collection3074.CreateKeyListStr()
            __sorted3074.Sort( LnsItemKindStr, nil )
            for _, ___key3074 := range( __sorted3074.Items ) {
                symbolInfo := __collection3074.Items[ ___key3074 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch3072 := symbolInfo.FP.Get_kind(); _switch3072 == symbolKind {
...
// 1110: decl @lune.@base.@Ast.getAllMethodName
...
// 1163: decl @lune.@base.@Ast.getScope
func Ast_getScope(typeInfo *Ast_TypeInfo) LnsAny {
    return typeInfo.FP.Get_scope()
}

// 1169: decl @lune.@base.@Ast.isExtId
func Ast_isExtId(typeInfo *Ast_TypeInfo) bool {
    if typeInfo.FP.Get_typeId().Id >= Ast_extStartId{
        return true
    }
    return false
}

// 2296: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2178_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if !Lns_IsNil( __exp ) {
            ...
            {
                __collection7885 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted7885 := __collection7885.CreateKeyListStr()
                __sorted7885.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted7885.Items ) {
                    symbolInfo := __collection7885.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if !Lns_IsNil( _subScope ) {
                            ...
                            dumpScope__dumpScopeSub_2178_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
// 2291: decl @lune.@base.@Ast.dumpScope
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2178_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3306: decl @lune.@base.@Ast.isGenericType
...
// 3538: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp12471 := obj.(type) {
...
// 4291: decl @lune.@base.@Ast.isExtType
...
// 4298: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch15821 := typeInfo.FP.Get_kind(); _switch15821 == Ast_TypeInfoKind__FormFunc || _switch15821 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4395: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId().Id,typeInfo)
}

// 4401: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_3234_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
...
// 4517: decl @lune.@base.@Ast.isClass
...
// 4588: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_3281_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch17719 := typeInfo.FP.Get_kind(); _switch17719 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_3281_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch17719 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch17719 == Ast_TypeInfoKind__Form || _switch17719 == Ast_TypeInfoKind__IF || _switch17719 == Ast_TypeInfoKind__DDD || _switch17719 == Ast_TypeInfoKind__ExtModule {
        ...
        return nil, false
    } else if _switch17719 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch17719 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch17719 == Ast_TypeInfoKind__Array || _switch17719 == Ast_TypeInfoKind__List || _switch17719 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_3281_(itemType, convFlag, validToCheck)
            if err != nil{
                err_3645 := err.(string)
                return err_3645, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch17719 == Ast_TypeInfoKind__FormFunc || _switch17719 == Ast_TypeInfoKind__Func {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
    ...
    return Lns_getVM().String_format("not support -- %s:%s", []LnsAny{typeInfo.FP.GetTxt(nil, nil, nil), Ast_TypeInfoKind_getTxt( typeInfo.FP.Get_kind())}), false
}

// 4699: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch17873 := typeInfo.FP.Get_kind(); _switch17873 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 4721: decl @lune.@base.@Ast.isConditionalbe
...
// 5535: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_3536_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
// 5870: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp23575 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp23575.Val1
...
// 5914: decl @lune.@base.@Ast.isNumberType
...
// 6447: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_3920_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 7012: decl @lune.@base.@Ast.createProcessInfo
func Ast_createProcessInfo(validCheckingMutable bool,validExtType bool) *Ast_ProcessInfo {
    return Ast_ProcessInfo_createUser_1076_(validCheckingMutable, validExtType, Ast_builtinTypeInfo2Map.FP.Clone())
}
...
// 35: decl @lune.@base.@Ast.IdProvider.getNewId
...
type Ast_ProcessInfoMtd interface {
    ...
    CreateFunc(arg1 bool, arg2 bool, arg3 LnsAny, arg4 LnsInt, arg5 *Ast_TypeInfo, arg6 bool, arg7 bool, arg8 bool, arg9 LnsInt, arg10 string, arg11 LnsAny, arg12 LnsAny, arg13 LnsAny, arg14 LnsAny) *Ast_NormalTypeInfo
    ...
    Get_validCheckingMutable() bool
    Get_validExtType() bool
    newId(arg1 *Ast_TypeInfo) *Ast_IdInfo
    newIdForRoot() *Ast_IdInfo
    NewUser() *Ast_ProcessInfo
    setRootTypeInfo(arg1 LnsInt, arg2 *Ast_TypeInfo)
...
func NewAst_ProcessInfo(arg1 bool, arg2 *Ast_IdProvider, arg3 bool, arg4 LnsAny) *Ast_ProcessInfo {
    obj := &Ast_ProcessInfo{}
    obj.FP = obj
    obj.InitAst_ProcessInfo(arg1, arg2, arg3, arg4)
    return obj
}
...
func (self *Ast_ProcessInfo) Get_validCheckingMutable() bool{ return self.validCheckingMutable }
// 113: decl @lune.@base.@Ast.ProcessInfo.get_typeInfo2Map
func (self *Ast_ProcessInfo) get_typeInfo2Map() *Ast_TypeInfo2Map {
    return Lns_unwrap( self.typeInfo2Map).(*Ast_TypeInfo2Map)
}

// 116: decl @lune.@base.@Ast.ProcessInfo.set_typeInfo2Map
func (self *Ast_ProcessInfo) set_typeInfo2Map(typeInfo2Map *Ast_TypeInfo2Map) {
    self.typeInfo2Map = typeInfo2Map
    
}

// 120: decl @lune.@base.@Ast.ProcessInfo.getTypeInfo
func (self *Ast_ProcessInfo) GetTypeInfo(id LnsInt) LnsAny {
    return self.id2TypeInfo.Get(id)
}

// 124: DeclConstr
func (self *Ast_ProcessInfo) InitAst_ProcessInfo(validCheckingMutable bool,idProvBase *Ast_IdProvider,validExtType bool,typeInfo2Map LnsAny) {
...
// 139: decl @lune.@base.@Ast.ProcessInfo.createRoot
func Ast_ProcessInfo_createRoot_1074_() *Ast_ProcessInfo {
    return NewAst_ProcessInfo(true, NewAst_IdProvider(0, Ast_userStartId), true, nil)
}

// 144: decl @lune.@base.@Ast.ProcessInfo.createUser
func Ast_ProcessInfo_createUser_1076_(validCheckingMutable bool,validExtType bool,typeInfo2Map LnsAny) *Ast_ProcessInfo {
    return NewAst_ProcessInfo(validCheckingMutable, NewAst_IdProvider(Ast_userStartId, Ast_extStartId), validExtType, typeInfo2Map)
}

// 153: decl @lune.@base.@Ast.ProcessInfo.switchIdProvier
func (self *Ast_ProcessInfo) SwitchIdProvier(idType LnsInt) {
    __func__ := "@lune.@base.@Ast.ProcessInfo.switchIdProvier"
    Log_log(Log_Level__Trace, __func__, 154, Log_CreateMessage(ProcessInfo_switchIdProvier___anonymous_1080_))
...
// 207: decl @lune.@base.@Ast.ProcessInfo.newIdForRoot
func (self *Ast_ProcessInfo) newIdForRoot() *Ast_IdInfo {
    var id LnsInt
    id = self.idProv.FP.GetNewId()
    return NewAst_IdInfo(id, self)
}

// 211: decl @lune.@base.@Ast.ProcessInfo.setRootTypeInfo
func (self *Ast_ProcessInfo) setRootTypeInfo(id LnsInt,typeInfo *Ast_TypeInfo) {
    self.id2TypeInfo.Set(id,typeInfo)
}

// 215: decl @lune.@base.@Ast.ProcessInfo.newId
func (self *Ast_ProcessInfo) newId(typeInfo *Ast_TypeInfo) *Ast_IdInfo {
    var id LnsInt
    id = self.idProv.FP.GetNewId()
    self.id2TypeInfo.Set(id,typeInfo)
    return NewAst_IdInfo(id, self)
...
// 4240: decl @lune.@base.@Ast.ProcessInfo.createAlternate
func (self *Ast_ProcessInfo) CreateAlternate(belongClassFlag bool,altIndex LnsInt,txt string,accessMode LnsInt,parentInfo *Ast_TypeInfo,baseTypeInfo LnsAny,interfaceList LnsAny) *Ast_AlternateTypeInfo {
    return NewAst_AlternateTypeInfo(self, belongClassFlag, altIndex, txt, accessMode, parentInfo, baseTypeInfo, interfaceList)
}

// 4311: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch15901 := mutMode; _switch15901 == Ast_MutMode__IMut || _switch15901 == Ast_MutMode__IMutRe {
        {
            __exp := self.FP.get_typeInfo2Map().ImutModifierMap.Get(srcTypeInfo)
            if !Lns_IsNil( __exp ) {
                _exp := __exp.(*Ast_TypeInfo)
                return _exp
            }
        }
    } else if _switch15901 == Ast_MutMode__AllMut {
        {
            __exp := self.FP.get_typeInfo2Map().MutModifierMap.Get(srcTypeInfo)
            if !Lns_IsNil( __exp ) {
                _exp := __exp.(*Ast_TypeInfo)
                return _exp
            }
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp15963 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp15963.Val1
        ...
        modifier = &NewAst_ModifierTypeInfo(self, srcTypeInfo, mutMode).Ast_TypeInfo
        
    }
    if _switch16024 := mutMode; _switch16024 == Ast_MutMode__IMut || _switch16024 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch16024 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4730: decl @lune.@base.@Ast.ProcessInfo.createBox
func (self *Ast_ProcessInfo) CreateBox(accessMode LnsInt,nonnilableType *Ast_TypeInfo) *Ast_TypeInfo {
    {
        _boxType := self.FP.get_typeInfo2Map().BoxMap.Get(nonnilableType)
    ...
    boxType = NewAst_BoxTypeInfo(self, accessMode, nonnilableType)
    self.FP.get_typeInfo2Map().BoxMap.Set(nonnilableType,&boxType.Ast_TypeInfo)
    return &boxType.Ast_TypeInfo
}

// 4774: decl @lune.@base.@Ast.ProcessInfo.createSet
func (self *Ast_ProcessInfo) CreateSet(accessMode LnsInt,parentInfo *Ast_TypeInfo,itemTypeInfo *LnsList,mutMode LnsInt) *Ast_TypeInfo {
    ...
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeSet), Ast_builtinTypeSet, nil, false, false, false, Ast_AccessMode__Pub, "Set", Ast_headTypeInfo, Ast_TypeInfoKind__Set, itemTypeInfo, nil, nil, workMutMode, nil).Ast_TypeInfo
    }
...
// 4787: decl @lune.@base.@Ast.ProcessInfo.createList
func (self *Ast_ProcessInfo) CreateList(accessMode LnsInt,parentInfo *Ast_TypeInfo,itemTypeInfo *LnsList,mutMode LnsInt) *Ast_TypeInfo {
    ...
    var newTypeFunc func(workMutMode LnsInt) *Ast_TypeInfo
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeList), Ast_builtinTypeList, nil, false, false, false, Ast_AccessMode__Pub, "List", Ast_headTypeInfo, Ast_TypeInfoKind__List, itemTypeInfo, nil, nil, workMutMode, nil).Ast_TypeInfo
    }
    var typeInfo *Ast_TypeInfo
    typeInfo = newTypeFunc(tmpMutMode)
    if Ast_isMutable(mutMode){
...
// 4800: decl @lune.@base.@Ast.ProcessInfo.createArray
func (self *Ast_ProcessInfo) CreateArray(accessMode LnsInt,parentInfo *Ast_TypeInfo,itemTypeInfo *LnsList,mutMode LnsInt) *Ast_TypeInfo {
    ...
    var newTypeFunc func(workMutMode LnsInt) *Ast_TypeInfo
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeArray), Ast_builtinTypeArray, nil, false, false, false, Ast_AccessMode__Pub, "Array", Ast_headTypeInfo, Ast_TypeInfoKind__Array, itemTypeInfo, nil, nil, workMutMode, nil).Ast_TypeInfo
    }
    var typeInfo *Ast_TypeInfo
    typeInfo = newTypeFunc(tmpMutMode)
    if Ast_isMutable(mutMode){
...
// 4813: decl @lune.@base.@Ast.ProcessInfo.createMap
func (self *Ast_ProcessInfo) CreateMap(accessMode LnsInt,parentInfo *Ast_TypeInfo,keyTypeInfo *Ast_TypeInfo,valTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    var newTypeFunc func(workMutMode LnsInt) *Ast_TypeInfo
    newTypeFunc = func(workMutMode LnsInt) *Ast_TypeInfo {
        return &NewAst_NormalTypeInfo(self, false, Ast_getScope(Ast_builtinTypeMap), Ast_builtinTypeMap, nil, false, false, false, Ast_AccessMode__Pub, "Map", Ast_headTypeInfo, Ast_TypeInfoKind__Map, NewLnsList([]LnsAny{Ast_TypeInfo2Stem(keyTypeInfo), Ast_TypeInfo2Stem(valTypeInfo)}), nil, nil, workMutMode, nil).Ast_TypeInfo
    }
    var typeInfo *Ast_TypeInfo
    typeInfo = newTypeFunc(tmpMutMode)
    if Ast_isMutable(mutMode){
...
// 4828: decl @lune.@base.@Ast.ProcessInfo.createModule
func (self *Ast_ProcessInfo) CreateModule(scope *Ast_Scope,parentInfo *Ast_TypeInfo,externalFlag bool,moduleName string,mutable bool) *Ast_TypeInfo {
    ...
    info = NewAst_ModuleTypeInfo(self, scope, externalFlag, moduleName, parentInfo, mutable)
    return &info.Ast_TypeInfo
}

// 4848: decl @lune.@base.@Ast.ProcessInfo.createClass
func (self *Ast_ProcessInfo) CreateClass(classFlag bool,abstractFlag bool,scope LnsAny,baseInfo LnsAny,interfaceList LnsAny,genTypeList *LnsList,parentInfo *Ast_TypeInfo,externalFlag bool,accessMode LnsInt,className string) *Ast_TypeInfo {
    ...
    info = NewAst_NormalTypeInfo(self, abstractFlag, scope, baseInfo, interfaceList, false, externalFlag, false, accessMode, className, parentInfo, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( classFlag) &&
        Lns_GetEnv().SetStackVal( Ast_TypeInfoKind__Class) ||
        Lns_GetEnv().SetStackVal( Ast_TypeInfoKind__IF) ).(LnsInt), genTypeList, nil, nil, Ast_MutMode__Mut, nil)
    for _, _genType := range( genTypeList.Items ) {
        genType := _genType.(Ast_AlternateTypeInfoDownCast).ToAst_AlternateTypeInfo()
        genType.FP.updateParentInfo(&info.Ast_TypeInfo)
    }
    return &info.Ast_TypeInfo
}

// 4882: decl @lune.@base.@Ast.ProcessInfo.createExtModule
func (self *Ast_ProcessInfo) CreateExtModule(scope LnsAny,parentInfo *Ast_TypeInfo,externalFlag bool,accessMode LnsInt,className string,moduleLang LnsInt,requirePath string) *Ast_TypeInfo {
    ...
    var info *Ast_NormalTypeInfo
    info = NewAst_NormalTypeInfo(self, false, scope, nil, nil, false, externalFlag, false, accessMode, className, parentInfo, Ast_TypeInfoKind__ExtModule, nil, nil, nil, Ast_MutMode__Mut, moduleLang)
    info.FP.set_requirePath(requirePath)
    return &info.Ast_TypeInfo
}

// 4910: decl @lune.@base.@Ast.ProcessInfo.createFunc
func (self *Ast_ProcessInfo) CreateFunc(abstractFlag bool,builtinFlag bool,scope LnsAny,kind LnsInt,parentInfo *Ast_TypeInfo,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,funcName string,altTypeList LnsAny,argTypeList LnsAny,retTypeInfoList LnsAny,mutable LnsAny) *Ast_NormalTypeInfo {
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        for _, _genType := range( altTypeList_3866.Items ) {
            genType := _genType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            {
                ...
                if !Lns_IsNil( __exp ) {
                    ...
                    _exp.FP.updateParentInfo(&info.Ast_TypeInfo)
                }
            }
        }
    }
...
// 4940: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
func (self *Ast_ProcessInfo) CreateAdvertiseMethodFrom(classTypeInfo *Ast_TypeInfo,typeInfo *Ast_TypeInfo) *Ast_TypeInfo {
    return &self.FP.CreateFunc(false, false, Ast_getScope(typeInfo), typeInfo.FP.Get_kind(), classTypeInfo, true, false, false, typeInfo.FP.Get_accessMode(), typeInfo.FP.Get_rawTxt(), typeInfo.FP.Get_itemTypeInfoList(), typeInfo.FP.Get_argTypeInfoList(), typeInfo.FP.Get_retTypeInfoList(), Ast_TypeInfo_isMut(typeInfo)).Ast_TypeInfo
}

// 4969: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 5126: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_3281_(typeInfo, Ast_LuavalConvKind__InLua, true)))) &&
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( extTypeFlag) ).(bool)){
        switch _exp20362 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp20362.Val1
            typeInfo = work
    ...
    }
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( _exp.FP.Get_typeId().Id < Ast_userStartId) &&
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_typeId().Id >= Ast_userStartId) ).(bool)){
                Util_err("on cache")
            }
            return _exp
        }
    ...
    dddType = NewAst_DDDTypeInfo(self, typeInfo, externalFlag, nil)
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_3281_(typeInfo, Ast_LuavalConvKind__InLua, true))){
        var extDDDType *Ast_DDDTypeInfo
        extDDDType = NewAst_DDDTypeInfo(self, typeInfo, externalFlag, dddType)
        if extTypeFlag{
            return extDDDType
        }
    }
...
// 5527: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5794: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    {
        _extType := self.FP.get_typeInfo2Map().ExtMap.Get(luneType)
        if !Lns_IsNil( _extType ) {
            extType := _extType.(*Ast_TypeInfo)
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( extType.FP.Get_typeId().Id < Ast_userStartId) &&
                Lns_GetEnv().SetStackVal( luneType.FP.Get_typeId().Id >= Ast_userStartId) ).(bool)){
                Util_err("on cache")
            }
    ...
    process = func() LnsAny {
        {
            ...
            if !Lns_IsNil( _dddType ) {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp23295 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp23295.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp23295.Val1
        ...
        var err LnsAny
        var canConv bool
        err, canConv = Ast_failCreateLuavalWith_3281_(luneType, Ast_LuavalConvKind__InLua, validToCheck)
        
        if err != nil{
            err_4566 := err.(string)
            return &Ast_LuavalResult__Err{err_4566}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp23428 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23428.Val1
...
// 5920: decl @lune.@base.@Ast.ProcessInfo.createEnum
func (self *Ast_ProcessInfo) CreateEnum(scope *Ast_Scope,parentInfo *Ast_TypeInfo,externalFlag bool,accessMode LnsInt,enumName string,valTypeInfo *Ast_TypeInfo) *Ast_EnumTypeInfo {
    ...
    info = NewAst_EnumTypeInfo(self, scope, externalFlag, accessMode, enumName, parentInfo, valTypeInfo)
    ...
    scope.FP.AddMethod(self, nil, &getEnumName.Ast_TypeInfo, Ast_AccessMode__Pub, false, false)
    ...
    scope.FP.AddMethod(self, nil, &fromVal.Ast_TypeInfo, Ast_AccessMode__Pub, true, false)
    ...
    scope.FP.AddMethod(self, nil, &allList.Ast_TypeInfo, Ast_AccessMode__Pub, true, false)
    return info
}

// 5988: decl @lune.@base.@Ast.ProcessInfo.createAlge
func (self *Ast_ProcessInfo) CreateAlge(scope *Ast_Scope,parentInfo *Ast_TypeInfo,externalFlag bool,accessMode LnsInt,algeName string) *Ast_AlgeTypeInfo {
    ...
    info = NewAst_AlgeTypeInfo(self, scope, externalFlag, accessMode, algeName, parentInfo)
    ...
    scope.FP.AddMethod(self, nil, &getAlgeName.Ast_TypeInfo, Ast_AccessMode__Pub, false, false)
    return info
}

// 7019: decl @lune.@base.@Ast.ProcessInfo.newUser
func (self *Ast_ProcessInfo) NewUser() *Ast_ProcessInfo {
    return Ast_ProcessInfo_createUser_1076_(self.validCheckingMutable, self.validExtType, Ast_builtinTypeInfo2Map.FP.Clone())
}


// declaration Class -- IdInfo
type Ast_IdInfoMtd interface {
    Equals(arg1 *Ast_IdInfo) bool
    Get_orgId() LnsInt
    Get_processInfo() *Ast_ProcessInfo
    IsSwichingId() bool
    Set_orgId(arg1 LnsInt)
}
...
func NewAst_IdInfo(arg1 LnsInt, arg2 *Ast_ProcessInfo) *Ast_IdInfo {
    obj := &Ast_IdInfo{}
    obj.FP = obj
    obj.InitAst_IdInfo(arg1, arg2)
    return obj
}
func (self *Ast_IdInfo) Get_processInfo() *Ast_ProcessInfo{ return self.ProcessInfo }
// 169: decl @lune.@base.@Ast.IdInfo.isSwichingId
func (self *Ast_IdInfo) IsSwichingId() bool {
    var orgId LnsInt
...
// 176: decl @lune.@base.@Ast.IdInfo.set_orgId
func (self *Ast_IdInfo) Set_orgId(id LnsInt) {
    self.orgId = id
    
}

// 180: decl @lune.@base.@Ast.IdInfo.get_orgId
func (self *Ast_IdInfo) Get_orgId() LnsInt {
    return Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( self.orgId) ||
        Lns_GetEnv().SetStackVal( self.Id) ).(LnsInt)
}

// 183: DeclConstr
func (self *Ast_IdInfo) InitAst_IdInfo(id LnsInt,processInfo *Ast_ProcessInfo) {
    self.Id = id
...
// 189: decl @lune.@base.@Ast.IdInfo.equals
func (self *Ast_IdInfo) Equals(idInfo *Ast_IdInfo) bool {
    if self.FP.Get_orgId() == idInfo.FP.Get_orgId(){
...
func NewAst_SimpleModuleInfo(arg1 string, arg2 string) *Ast_SimpleModuleInfo {
    ...
    obj.FP = obj
    obj.InitAst_SimpleModuleInfo(arg1, arg2)
    return obj
}
...
func (self *Ast_SimpleModuleInfo) Get_assignName() string{ return self.assignName }
func (self *Ast_SimpleModuleInfo) Get_modulePath() string{ return self.modulePath }
...
// 244: decl @lune.@base.@Ast.DummyModuleInfoManager.___init
func Ast_DummyModuleInfoManager____init_1151_() {
...
// 251: decl @lune.@base.@Ast.DummyModuleInfoManager.getModuleInfo
...
// 1115: decl @lune.@base.@Ast.TypeNameCtrl.getModuleName
...
// 1130: decl @lune.@base.@Ast.TypeNameCtrl.getParentFullName
...
type Ast_SymbolInfoMtd interface {
    ...
    set_namespaceTypeInfo(arg1 LnsAny)
...
func (self *Ast_SymbolInfo) set_namespaceTypeInfo(arg1 LnsAny){ self.namespaceTypeInfo = arg1 }
...
// 467: decl @lune.@base.@Ast.SymbolInfo.hasAccess
...
// 618: decl @lune.@base.@Ast.SymbolInfo.get_namespaceTypeInfo
...
// 1058: decl @lune.@base.@Ast.SymbolInfo.getModule
...
type Ast_ScopeMtd interface {
    ...
    AddForm(arg1 *Ast_ProcessInfo, arg2 LnsAny, arg3 *Ast_TypeInfo, arg4 LnsInt)(LnsAny, LnsAny)
    ...
    AddSymbolInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_SymbolInfo)(LnsAny, LnsAny)
    ...
    FilterTypeInfoFieldAndIF(arg1 LnsAny, arg2 *Ast_Scope, arg3 LnsInt, arg4 Ast_filterForm) bool
...
// 565: decl @lune.@base.@Ast.Scope.isRoot
func (self *Ast_Scope) IsRoot() bool {
    return self.parent == self
}

// 569: decl @lune.@base.@Ast.Scope.set_ownerTypeInfo
...
// 574: decl @lune.@base.@Ast.Scope.switchOwnerTypeInfo
func (self *Ast_Scope) SwitchOwnerTypeInfo(owner LnsAny) {
    self.ownerTypeInfo = owner
    
}

// 579: decl @lune.@base.@Ast.Scope.getTypeInfoChild
...
// 607: decl @lune.@base.@Ast.Scope.getModuleInfo
...
// 635: decl @lune.@base.@Ast.Scope.isInnerOf
...
// 1224: decl @lune.@base.@Ast.Scope.getNamespaceTypeInfo
...
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5343 := self.symbol2SymbolInfoMap
                __sorted5343 := __collection5343.CreateKeyListStr()
                __sorted5343.Sort( LnsItemKindStr, nil )
                for _, ___key5343 := range( __sorted5343.Items ) {
                    symbolInfo := __collection5343.Items[ ___key5343 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1751: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1781: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1808: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1830: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1854: decl @lune.@base.@Ast.Scope.filterTypeInfoFieldAndIF
func (self *Ast_Scope) FilterTypeInfoFieldAndIF(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5713 := self.symbol2SymbolInfoMap
                __sorted5713 := __collection5713.CreateKeyListStr()
                __sorted5713.Sort( LnsItemKindStr, nil )
                for _, ___key5713 := range( __sorted5713.Items ) {
                    symbolInfo := __collection5713.Items[ ___key5713 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    if Lns_isCondTrue( symbolInfo.FP.CanAccess(fromScope, access)){
                        if Lns_op_not(callback(symbolInfo)){
                            return false
                        }
...
// 1902: decl @lune.@base.@Ast.Scope.getSymbolInfo
...
// 1963: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1980: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
...
// 2023: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
...
// 2045: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool,isLazyLoad bool)(LnsAny, LnsAny) {
    ...
    ownerTypeInfo = nil
    if _switch6561 := kind; _switch6561 == Ast_SymbolKind__Typ || _switch6561 == Ast_SymbolKind__Fun || _switch6561 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch6507 := typeInfo.FP.Get_kind(); _switch6507 == Ast_TypeInfoKind__Enum {
        ...
        } else if _switch6507 == Ast_TypeInfoKind__Class || _switch6507 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1645 := existSymbol.(*Ast_SymbolInfo)
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() != existSymbol_1645.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1645.FP.Get_typeInfo().FP.Get_typeId().Id))) ).(bool){
                return nil, existSymbol_1645
            }
        }
    } else if _switch6561 == Ast_SymbolKind__Var {
    ...
    symbolInfo.FP.set_namespaceTypeInfo(ownerTypeInfo)
    self.symbol2SymbolInfoMap.Set(name,&symbolInfo.Ast_SymbolInfo)
    return &symbolInfo.Ast_SymbolInfo, nil
}

// 2094: decl @lune.@base.@Ast.Scope.addSymbolInfo
func (self *Ast_Scope) AddSymbolInfo(processInfo *Ast_ProcessInfo,symbolInfo *Ast_SymbolInfo)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, symbolInfo.FP.Get_kind(), symbolInfo.FP.Get_canBeLeft(), symbolInfo.FP.Get_canBeRight(), symbolInfo.FP.Get_name(), symbolInfo.FP.Get_pos(), symbolInfo.FP.Get_typeInfo(), symbolInfo.FP.Get_accessMode(), symbolInfo.FP.Get_staticFlag(), symbolInfo.FP.Get_mutMode(), symbolInfo.FP.Get_hasValueFlag(), symbolInfo.FP.Get_isLazyLoad())
}

// 2104: decl @lune.@base.@Ast.Scope.addLocalVar
...
// 2117: decl @lune.@base.@Ast.Scope.addUnwrapedVar
...
// 2128: decl @lune.@base.@Ast.Scope.addStaticVar
func (self *Ast_Scope) AddStaticVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( argFlag) &&
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Arg) ||
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, true, name, pos, typeInfo, Ast_AccessMode__Pub, true, mutable, true, false)
}

// 2138: decl @lune.@base.@Ast.Scope.addVar
...
// 2152: decl @lune.@base.@Ast.Scope.addEnumVal
...
// 2162: decl @lune.@base.@Ast.Scope.addEnum
...
// 2192: decl @lune.@base.@Ast.Scope.addAlternate
...
// 2201: decl @lune.@base.@Ast.Scope.addMember
...
// 2211: decl @lune.@base.@Ast.Scope.addMethod
...
// 2221: decl @lune.@base.@Ast.Scope.addFunc
...
// 2232: decl @lune.@base.@Ast.Scope.addForm
func (self *Ast_Scope) AddForm(processInfo *Ast_ProcessInfo,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Ast_SymbolKind__Typ, false, false, typeInfo.FP.Get_rawTxt(), pos, typeInfo, accessMode, true, Ast_MutMode__IMut, false, false)
}

// 2242: decl @lune.@base.@Ast.Scope.addMacro
...
// 2253: decl @lune.@base.@Ast.Scope.addClassLazy
...
// 2262: decl @lune.@base.@Ast.Scope.addClass
...
// 2269: decl @lune.@base.@Ast.Scope.addExtModule
func (self *Ast_Scope) AddExtModule(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo,lazy bool,lang LnsInt)(LnsAny, LnsAny) {
    if lang != Types_Lang__Same{
        switch _exp7741 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__Err:
        mess := _exp7741.Val1
            Util_err(mess)
        case *Ast_LuavalResult__OK:
        luavalTypeInfo := _exp7741.Val1
            typeInfo = luavalTypeInfo
            
        }
    }
    return self.FP.Add(processInfo, Ast_SymbolKind__Typ, false, false, name, pos, typeInfo, typeInfo.FP.Get_accessMode(), false, Ast_MutMode__Mut, true, lazy)
}

// 2323: decl @lune.@base.@Ast.Scope.setClosure
func (self *Ast_Scope) SetClosure(workSymbol *Ast_SymbolInfo) {
    ...
    for  {
        ...
        if Lns_op_not(funcScope.closureSymMap.Get(symbol.FP.Get_symbolId())){
...
// 2352: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch8127 := symbol.FP.Get_kind(); _switch8127 == Ast_SymbolKind__Var || _switch8127 == Ast_SymbolKind__Arg || _switch8127 == Ast_SymbolKind__Fun {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2392: decl @lune.@base.@Ast.Scope.accessSymbol
...
// 2519: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if !Lns_IsNil( _owner ) {
                ...
                if _switch8535 := owner.FP.Get_kind(); _switch8535 == Ast_TypeInfoKind__Class || _switch8535 == Ast_TypeInfoKind__IF || _switch8535 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4378: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4521: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4978: decl @lune.@base.@Ast.Scope.addAlias
...
// 4991: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch19805 := typeInfo.FP.Get_kind(); _switch19805 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch19805 == Ast_TypeInfoKind__Form || _switch19805 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch19805 == Ast_TypeInfoKind__Macro {
...
// 655: decl @lune.@base.@Ast.TypeData.addChildren
...
type Ast_SerializeInfoMtd interface {
    Get_validChildrenMap() *LnsMap
    IsValidChildren(arg1 *Ast_IdInfo) bool
    SerializeId(arg1 *Ast_IdInfo) string
}
...
func NewAst_SerializeInfo(arg1 *LnsMap, arg2 *LnsMap) *Ast_SerializeInfo {
    obj := &Ast_SerializeInfo{}
    obj.FP = obj
    obj.InitAst_SerializeInfo(arg1, arg2)
    return obj
}
func (self *Ast_SerializeInfo) InitAst_SerializeInfo(arg1 *LnsMap, arg2 *LnsMap) {
    self.processInfo2Id = arg1
    self.validChildrenMap = arg2
}
func (self *Ast_SerializeInfo) Get_validChildrenMap() *LnsMap{ return self.validChildrenMap }
// 704: decl @lune.@base.@Ast.SerializeInfo.isValidChildren
func (self *Ast_SerializeInfo) IsValidChildren(idInfo *Ast_IdInfo) bool {
    return Lns_op_not(self.validChildrenMap.Get(idInfo))
}

// 707: decl @lune.@base.@Ast.SerializeInfo.serializeId
func (self *Ast_SerializeInfo) SerializeId(idInfo *Ast_IdInfo) string {
    var id LnsInt
    id = idInfo.FP.Get_orgId()
    if id >= Ast_extStartId{
        return Lns_getVM().String_format("{ id = %d, mod = 0 }", []LnsAny{id})
    }
    var processId LnsInt
    processId = Lns_unwrap( self.processInfo2Id.Get(idInfo.ProcessInfo)).(LnsInt)
    return Lns_getVM().String_format("{ id = %d, mod = %d }", []LnsAny{idInfo.FP.Get_orgId(), processId})
}
...
type Ast_TypeInfoMtd interface {
    ...
    Get_typeId() *Ast_IdInfo
    HasBase() bool
    HasRouteNamespaceFrom(arg1 *Ast_TypeInfo) bool
    IsInheritFrom(arg1 *Ast_ProcessInfo, arg2 *Ast_TypeInfo, arg3 LnsAny) bool
    IsModule() bool
    Serialize(arg1 Lns_oStream, arg2 *Ast_SerializeInfo)
    SerializeTypeInfoList(arg1 *Ast_SerializeInfo, arg2 string, arg3 *LnsList, arg4 LnsAny) string
...
// 726: decl @lune.@base.@Ast.TypeInfo.getProcessInfo
func (self *Ast_TypeInfo) getProcessInfo() *Ast_ProcessInfo {
    return self.processInfo
}

// 730: decl @lune.@base.@Ast.TypeInfo.switchScope
...
// 740: decl @lune.@base.@Ast.TypeInfo.getOverridingType
...
// 759: decl @lune.@base.@Ast.TypeInfo.get_aliasSrc
func (self *Ast_TypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return self
}

// 763: decl @lune.@base.@Ast.TypeInfo.get_extedType
func (self *Ast_TypeInfo) Get_extedType() *Ast_TypeInfo {
    return self
}

// 767: decl @lune.@base.@Ast.TypeInfo.getModulePath
func Ast_TypeInfo_getModulePath(fullname string) string {
    return Lns_car(Lns_getVM().String_gsub(fullname,"@", "")).(string)
}

// 772: decl @lune.@base.@Ast.TypeInfo.isModule
func (self *Ast_TypeInfo) IsModule() bool {
    return true
}

// 777: decl @lune.@base.@Ast.TypeInfo.getParentId
func (self *Ast_TypeInfo) GetParentId() *Ast_IdInfo {
    return Ast_rootTypeIdInfo
}

// 782: decl @lune.@base.@Ast.TypeInfo.get_baseId
func (self *Ast_TypeInfo) Get_baseId() *Ast_IdInfo {
    return Ast_rootTypeIdInfo
}

// 787: decl @lune.@base.@Ast.TypeInfo.isInheritFrom
func (self *Ast_TypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    return false
}

// 794: decl @lune.@base.@Ast.TypeInfo.get_rawTxt
func (self *Ast_TypeInfo) Get_rawTxt() string {
    return ""
}

// 804: decl @lune.@base.@Ast.TypeInfo.getTxtWithRaw
func (self *Ast_TypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return ""
}

// 817: decl @lune.@base.@Ast.TypeInfo.getTxt
...
// 829: decl @lune.@base.@Ast.TypeInfo.canEvalWith
...
// 837: decl @lune.@base.@Ast.TypeInfo.get_abstractFlag
func (self *Ast_TypeInfo) Get_abstractFlag() bool {
    return false
}

// 842: decl @lune.@base.@Ast.TypeInfo.serialize
func (self *Ast_TypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    return 
}

// 848: decl @lune.@base.@Ast.TypeInfo.get_display_stirng_with
func (self *Ast_TypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    return ""
}

// 853: decl @lune.@base.@Ast.TypeInfo.get_display_stirng
func (self *Ast_TypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with("", nil)
}

// 859: decl @lune.@base.@Ast.TypeInfo.get_srcTypeInfo
func (self *Ast_TypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return self
}

// 864: decl @lune.@base.@Ast.TypeInfo.equals
...
// 875: decl @lune.@base.@Ast.TypeInfo.get_externalFlag
func (self *Ast_TypeInfo) Get_externalFlag() bool {
    return false
}

// 880: decl @lune.@base.@Ast.TypeInfo.get_interfaceList
func (self *Ast_TypeInfo) Get_interfaceList() *LnsList {
    return Ast_dummyList
}

// 884: decl @lune.@base.@Ast.TypeInfo.get_itemTypeInfoList
func (self *Ast_TypeInfo) Get_itemTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 888: decl @lune.@base.@Ast.TypeInfo.get_argTypeInfoList
func (self *Ast_TypeInfo) Get_argTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 892: decl @lune.@base.@Ast.TypeInfo.get_retTypeInfoList
func (self *Ast_TypeInfo) Get_retTypeInfoList() *LnsList {
    return Ast_dummyList
}


// 902: decl @lune.@base.@Ast.TypeInfo.hasRouteNamespaceFrom
...
// 915: decl @lune.@base.@Ast.TypeInfo.getModule
...
// 991: decl @lune.@base.@Ast.TypeInfo.applyGeneric
func (self *Ast_TypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    return self
}

// 997: decl @lune.@base.@Ast.TypeInfo.get_genSrcTypeInfo
func (self *Ast_TypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self
}

// 1001: decl @lune.@base.@Ast.TypeInfo.serializeTypeInfoList
func (self *Ast_TypeInfo) SerializeTypeInfoList(serializeInfo *Ast_SerializeInfo,name string,list *LnsList,onlyPub LnsAny) string {
    var work string
    work = name
    for _, _typeInfo := range( list.Items ) {
        typeInfo := _typeInfo.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            work = Lns_getVM().String_format("%s%s", []LnsAny{work, serializeInfo.FP.SerializeId(typeInfo.FP.Get_typeId())})
...
// 1017: decl @lune.@base.@Ast.TypeInfo.createScope
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_808 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_808.FP.Get_scope()).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_811 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_811.Items ) {
...
func Ast_TypeInfo_isInherit(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if typeInfo.FP.Get_typeId().FP.Equals(otherTypeId){
        return true
    }
...
// 2412: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 5331: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp21530 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp21530.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp21530.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch21720 := type1.FP.Get_kind(); _switch21720 == Ast_TypeInfoKind__List {
        ...
        } else if _switch21720 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch21720 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch21720 == Ast_TypeInfoKind__Map {
...
// 5476: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp21894 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp21894.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp21894.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 6242: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from25418 LnsInt = index
            var _to25418 LnsInt = dstTypeList.Len()
            for _work25418 := _from25418; _work25418 <= _to25418; _work25418++ {
                dstIndex := _work25418
                var workDstType *Ast_TypeInfo
                workDstType = dstTypeList.GetAt(dstIndex).(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                var canEval bool
                var evalMess LnsAny
                canEval,evalMess = workDstType.FP.CanEvalWith(processInfo, workExpType, Ast_CanEvalType__SetOp, alt2type)
                if Lns_op_not(canEval){
                    var message string
                    message = Lns_getVM().String_format("exp(%d) type mismatch %s <- %s: dst %d%s", []LnsAny{dstIndex, workDstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), workExpType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), dstIndex, (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        Lns_GetEnv().SetStackVal( evalMess) &&
                        Lns_GetEnv().SetStackVal( Lns_getVM().String_format(" -- %s", []LnsAny{evalMess})) ||
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from25704 LnsInt = index
            var _to25704 LnsInt = expTypeList.Len()
            for _work25704 := _from25704; _work25704 <= _to25704; _work25704++ {
                srcIndex := _work25704
                ...
                var canEval bool
                var evalMess LnsAny
                canEval,evalMess = dstType.FP.CanEvalWith(processInfo, checkType, Ast_CanEvalType__SetOp, alt2type)
                if Lns_op_not(canEval){
                    return Ast_MatchType__Error, Lns_getVM().String_format("exp(%d) type mismatch %s <- %s: src: %d%s", []LnsAny{srcIndex, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), srcIndex, (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        Lns_GetEnv().SetStackVal( evalMess) &&
                        Lns_GetEnv().SetStackVal( Lns_getVM().String_format(" -- %s", []LnsAny{evalMess})) ||
                        Lns_GetEnv().SetStackVal( "") ).(string))})
                }
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4865 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4865 <= srcIndex{
                        var workMess string
            ...
            if dstTypeList.Len() == index{
                if dstType.FP.Get_srcTypeInfo().FP.Get_kind() != Ast_TypeInfoKind__DDD{
                    ...
                    if Lns_op_not(isMatch){
                        var workDstType *Ast_TypeInfo
                        workDstType = Ast_applyGenericDefault(dstType, alt2type, dstType.FP.GetModule())
                        return Ast_MatchType__Error, Lns_getVM().String_format("exp(%d) type mismatch %s(%d) <- %s(%d): index %d%s", []LnsAny{index, workDstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), workDstType.FP.Get_typeId().Id, expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.Get_typeId().Id, index, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                            Lns_GetEnv().SetStackVal( msg) &&
                            Lns_GetEnv().SetStackVal( Lns_getVM().String_format(" -- %s", []LnsAny{msg})) ||
                            Lns_GetEnv().SetStackVal( Lns_getVM().String_format("(%s)", []LnsAny{Ast_TypeInfoKind_getTxt( dstType.FP.Get_kind())})) ).(string)})
                    }
                    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4889 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4889 <= index{
                        var workMess string
                ...
                if expType.FP.Get_kind() == Ast_TypeInfoKind__DDD{
                    ...
                    if expType.FP.Get_itemTypeInfoList().Len() > 0{
                        srcType = expType.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo().FP.Get_nilableTypeInfo()
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4903 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4903 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
                ...
                var canEval bool
                var evalMess LnsAny
                canEval,evalMess = dstType.FP.CanEvalWith(processInfo, expType, Ast_CanEvalType__SetOp, alt2type)
                if Lns_op_not(canEval){
                    return Ast_MatchType__Error, Lns_getVM().String_format("exp(%d) type mismatch %s(%s:%d) <- %s(%s:%d)%s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), Ast_TypeInfoKind_getTxt( dstType.FP.Get_kind()), dstType.FP.Get_typeId().Id, expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), Ast_TypeInfoKind_getTxt( expType.FP.Get_kind()), expType.FP.Get_typeId().Id, (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                        Lns_GetEnv().SetStackVal( evalMess) &&
                        Lns_GetEnv().SetStackVal( Lns_getVM().String_format(" -- %s", []LnsAny{evalMess})) ||
                        Lns_GetEnv().SetStackVal( "") ).(string))})
                }
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4912 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4912 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_4922 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_4922
    }
    return Ast_MatchType__Match, ""
}

// 6467: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if other.FP.Equals(processInfo, Ast_builtinTypeAbbr, nil, nil){
            return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6489 - topLine})
        }
        return true, nil
    }
    var otherMut bool
    ...
    if _switch27186 := canEvalType; _switch27186 == Ast_CanEvalType__SetEq || _switch27186 == Ast_CanEvalType__SetOp || _switch27186 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch26923 := otherSrc; _switch26923 == Ast_builtinTypeAbbr || _switch26923 == Ast_builtinTypeAbbrNone {
                return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6517 - topLine})
            }
            if otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Func{
                return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6526 - topLine})
            }
            return true, nil
        } else if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            Lns_GetEnv().SetStackVal( Lns_op_not(otherMut)) &&
            Lns_GetEnv().SetStackVal( destMut) ).(bool)){
            if processInfo.FP.Get_validCheckingMutable(){
                var nonNilOtherType *Ast_TypeInfo
                nonNilOtherType = otherSrc.FP.Get_nonnilableType()
                if _switch27063 := nonNilOtherType.FP.Get_kind(); _switch27063 == Ast_TypeInfoKind__Set || _switch27063 == Ast_TypeInfoKind__Map || _switch27063 == Ast_TypeInfoKind__List || _switch27063 == Ast_TypeInfoKind__IF || _switch27063 == Ast_TypeInfoKind__Alternate {
                    return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6536 - topLine})
                } else if _switch27063 == Ast_TypeInfoKind__Class {
                    if Ast_builtinTypeString != nonNilOtherType{
                        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6540 - topLine})
                    }
                } else if _switch27063 == Ast_TypeInfoKind__Prim {
                    if Ast_builtinTypeStem == nonNilOtherType{
                        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6545 - topLine})
                    }
                }
            }
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if processInfo.FP.Get_validCheckingMutable(){
                return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6567 - topLine})
            }
        }
    }
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if canEvalType != Ast_CanEvalType__Equal{
            ...
            return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6591 - topLine})
        } else { 
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        if Ast_isSettableToForm_3920_(processInfo, otherSrc){
            return true, nil
        }
        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6607 - topLine})
    }
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( otherSrc == Ast_builtinTypeNil) ||
        Lns_GetEnv().SetStackVal( otherSrc.FP.Get_kind() == Ast_TypeInfoKind__Abbr) ).(bool){
        if dest.FP.Get_kind() != Ast_TypeInfoKind__Nilable{
            return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6611 - topLine})
        }
        return true, nil
    }
    if dest.FP.Get_typeId().FP.Equals(otherSrc.FP.Get_typeId()){
        return true, nil
    }
    ...
    }
    {
        ...
        if !Lns_IsNil( _extTypeInfo ) {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_3281_(extTypeInfo.FP.Get_extedType(), Ast_LuavalConvKind__ToLua, false)))) ).(bool)){
                otherSrc = extTypeInfo.FP.Get_extedType()
                
            }
        }
    }
    if otherSrc.FP.Get_typeId().FP.Equals(dest.FP.Get_typeId()){
        return true, nil
    }
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                var result bool
                result = otherSrc.FP.IsInheritFrom(processInfo, dest, alt2type)
                if result{
                    return result, nil
                }
                return false, Lns_getVM().String_format("not inherit %s(%d) <- %s(%d)", []LnsAny{dest.FP.GetTxt(nil, nil, nil), dest.FP.Get_typeId().FP.Get_orgId(), otherSrc.FP.GetTxt(nil, nil, nil), otherSrc.FP.Get_typeId().FP.Get_orgId()})
            }
            return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6678 - topLine})
            ...
            if _switch27982 := otherSrc.FP.Get_kind(); _switch27982 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch27982 == Ast_TypeInfoKind__FormFunc || _switch27982 == Ast_TypeInfoKind__Func {
                if Ast_isSettableToForm_3920_(processInfo, otherSrc){
                    return true, nil
                }
                return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6702 - topLine})
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch28187 := otherSrc.FP.Get_kind(); _switch28187 == Ast_TypeInfoKind__FormFunc || _switch28187 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
        ...
        return false, Lns_getVM().String_format("illegal type -- %s, %s", []LnsAny{Ast_TypeInfoKind_getTxt( dest.FP.Get_kind()), Ast_TypeInfoKind_getTxt( otherSrc.FP.Get_kind())})
    }
    if _switch29291 := dest.FP.Get_kind(); _switch29291 == Ast_TypeInfoKind__Prim {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6768 - topLine})
    } else if _switch29291 == Ast_TypeInfoKind__List || _switch29291 == Ast_TypeInfoKind__Array || _switch29291 == Ast_TypeInfoKind__Set {
        ...
        return true, nil
    } else if _switch29291 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6803 - topLine})
    } else if _switch29291 == Ast_TypeInfoKind__Class || _switch29291 == Ast_TypeInfoKind__IF {
        ...
        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6819 - topLine})
    } else if _switch29291 == Ast_TypeInfoKind__Form {
        if Ast_isSettableToForm_3920_(processInfo, otherSrc){
            return true, nil
        }
        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6826 - topLine})
    } else if _switch29291 == Ast_TypeInfoKind__Func || _switch29291 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch29291 == Ast_TypeInfoKind__Method {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6851 - topLine})
        }
        ...
        return true, nil
    } else if _switch29291 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch29291 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch29291 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, Lns_getVM().String_format("(err:%d)", []LnsAny{6896 - topLine})
    }
// insert a dummy
    return false,nil
}

// 6997: decl @lune.@base.@Ast.TypeInfo.getFullName
...
func (self *Ast_RootTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
// 1180: DeclConstr
...
// 1187: decl @lune.@base.@Ast.RootTypeInfo.get_baseTypeInfo
func (self *Ast_RootTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1191: decl @lune.@base.@Ast.RootTypeInfo.get_parentInfo
func (self *Ast_RootTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1195: decl @lune.@base.@Ast.RootTypeInfo.create
func Ast_RootTypeInfo_create_1728_() *Ast_RootTypeInfo {
    return NewAst_RootTypeInfo()
}

// 1199: decl @lune.@base.@Ast.RootTypeInfo.get_rawTxt
func (self *Ast_RootTypeInfo) Get_rawTxt() string {
    return "<head>"
}

// 1203: decl @lune.@base.@Ast.RootTypeInfo.getTxt
...
// 1285: decl @lune.@base.@Ast.NormalSymbolInfo.get_mutable
func (self *Ast_NormalSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.mutMode)
}

// 1293: decl @lune.@base.@Ast.NormalSymbolInfo.getOrg
...
// 2541: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch8726 := self.FP.Get_accessMode(); _switch8726 == Ast_AccessMode__Pub || _switch8726 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch8726 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch8726 == Ast_AccessMode__Local {
        var selfMod *Ast_TypeInfo
        selfMod = self.FP.GetModule()
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            Lns_GetEnv().SetStackVal( selfMod == Ast_headTypeInfo) ||
            Lns_GetEnv().SetStackVal( selfMod.FP.Equals(processInfo, fromScope.FP.GetModule(), nil, nil)) ).(bool){
            return &self.Ast_SymbolInfo
        }
        return nil
    } else if _switch8726 == Ast_AccessMode__Pri {
...
// 4566: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 1364: decl @lune.@base.@Ast.AutoBoxingInfo.___init
func Ast_AutoBoxingInfo____init_1816_() {
...
// 1381: decl @lune.@base.@Ast.AutoBoxingInfo.get_baseTypeInfo
func (self *Ast_AutoBoxingInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1385: decl @lune.@base.@Ast.AutoBoxingInfo.get_parentInfo
func (self *Ast_AutoBoxingInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1389: decl @lune.@base.@Ast.AutoBoxingInfo.get_kind
func (self *Ast_AutoBoxingInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Etc
}

// 1393: decl @lune.@base.@Ast.AutoBoxingInfo.inc
...
// 1398: decl @lune.@base.@Ast.AutoBoxingInfo.unregist
...
// 1404: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.___init
func Ast_CanEvalCtrlTypeInfo____init_1838_() {
...
// 1418: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_kind
func (self *Ast_CanEvalCtrlTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__CanEvalCtrl
}

// 1422: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_typeId
func (self *Ast_CanEvalCtrlTypeInfo) Get_typeId() *Ast_IdInfo {
    return Ast_dummyIdInfo
}

// 1428: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_baseTypeInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1432: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_parentInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1436: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.createDefaultAlt2typeMap
...
// 1445: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.isValidApply
...
// 1449: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.setupNeedAutoBoxing
...
// 1455: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.updateNeedAutoBoxing
...
// 1466: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.hasNeedAutoBoxing
...
// 1476: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.finishNeedAutoBoxing
...
// 1493: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.canAutoBoxing
...
func NewAst_NilableTypeInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_TypeInfo) *Ast_NilableTypeInfo {
    obj := &Ast_NilableTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_NilableTypeInfo(arg1, arg2)
    return obj
}
...
// 1511: DeclConstr
func (self *Ast_NilableTypeInfo) InitAst_NilableTypeInfo(processInfo *Ast_ProcessInfo,nonnilableType *Ast_TypeInfo) {
    self.InitAst_TypeInfo(nil, processInfo)
    self.nonnilableType = nonnilableType
    
    self.typeId = processInfo.FP.newId(&self.Ast_TypeInfo)
    
}

// 1517: decl @lune.@base.@Ast.NilableTypeInfo.get_kind
func (self *Ast_NilableTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Nilable
}

// 1520: decl @lune.@base.@Ast.NilableTypeInfo.get_aliasSrc
func (self *Ast_NilableTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1523: decl @lune.@base.@Ast.NilableTypeInfo.get_srcTypeInfo
func (self *Ast_NilableTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1526: decl @lune.@base.@Ast.NilableTypeInfo.get_nilable
func (self *Ast_NilableTypeInfo) Get_nilable() bool {
    return true
}

// 1531: decl @lune.@base.@Ast.NilableTypeInfo.getTxt
func (self *Ast_NilableTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 1536: decl @lune.@base.@Ast.NilableTypeInfo.getTxtWithRaw
...
// 1545: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng_with
...
// 1553: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng
func (self *Ast_NilableTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 1557: decl @lune.@base.@Ast.NilableTypeInfo.serialize
func (self *Ast_NilableTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind = %d, typeId = %d, orgTypeId = %s }\n", []LnsAny{Ast_SerializeKind__Nilable, self.typeId.Id, serializeInfo.FP.SerializeId(self.nonnilableType.FP.Get_typeId())}))
}

// 1564: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 1575: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_1259 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_1259.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 6069: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
func (self *Ast_NilableTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.typeId.FP.Equals(otherSrc.FP.Get_typeId()){
        return true, nil
    }
    if otherSrc.FP.Get_nilable(){
        if otherSrc.FP.Get_kind() == Ast_TypeInfoKind__DDD{
...
func (self *Ast_AliasTypeInfo) InitAst_AliasTypeInfo(processInfo *Ast_ProcessInfo,rawTxt string,accessMode LnsInt,parentInfo *Ast_TypeInfo,aliasSrcTypeInfo *Ast_TypeInfo,externalFlag bool) {
    ...
    self.nilableTypeInfo = &NewAst_NilableTypeInfo(processInfo, &self.Ast_TypeInfo).Ast_TypeInfo
    
}

// 1615: decl @lune.@base.@Ast.AliasTypeInfo.getParentFullName
...
// 1622: decl @lune.@base.@Ast.AliasTypeInfo.getFullName
...
// 1630: decl @lune.@base.@Ast.AliasTypeInfo.get_aliasSrc
func (self *Ast_AliasTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo
}

// 1634: decl @lune.@base.@Ast.AliasTypeInfo.get_nonnilableType
func (self *Ast_AliasTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1638: decl @lune.@base.@Ast.AliasTypeInfo.get_srcTypeInfo
func (self *Ast_AliasTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1641: decl @lune.@base.@Ast.AliasTypeInfo.get_genSrcTypeInfo
func (self *Ast_AliasTypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1645: decl @lune.@base.@Ast.AliasTypeInfo.getModule
func (self *Ast_AliasTypeInfo) GetModule() *Ast_TypeInfo {
    return self.FP.Get_parentInfo().FP.GetModule()
}

// 1650: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1656: decl @lune.@base.@Ast.AliasTypeInfo.serialize
func (self *Ast_AliasTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    var parentId *Ast_IdInfo
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, rawTxt = %q, srcTypeId = %s }\n", []LnsAny{Ast_SerializeKind__Alias, parentId.Id, self.typeId.Id, self.rawTxt, serializeInfo.FP.SerializeId(self.aliasSrcTypeInfo.FP.Get_typeId())}))
}

// 1666: decl @lune.@base.@Ast.AliasTypeInfo.get_display_stirng
func (self *Ast_AliasTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.rawTxt, nil)
}

// 1671: decl @lune.@base.@Ast.AliasTypeInfo.getParentId
func (self *Ast_AliasTypeInfo) GetParentId() *Ast_IdInfo {
    return self.parentInfo.FP.Get_typeId()
}

// 1675: decl @lune.@base.@Ast.AliasTypeInfo.applyGeneric
...
// 1685: decl @lune.@base.@Ast.AliasTypeInfo.canEvalWith
...
// 1693: decl @lune.@base.@Ast.AliasTypeInfo.equals
...
func (self *Ast_NilTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
// 2420: DeclConstr
...
func (self *Ast_NilTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    if Lns_op_not(other.FP.Get_nilable()){
        return false, Lns_getVM().String_format("%s is not nilable.", []LnsAny{other.FP.GetTxt(nil, nil, nil)})
    }
    return other.FP.Get_nilable(), nil
}

// 2458: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp8917 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp8917.Val1
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if typeInfo != nil{
                typeInfo_2048 := typeInfo.(*Ast_TypeInfo)
                work = typeInfo_2048
...
// 2647: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2651: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2660: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2664: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp9048 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp9048.Val1
        if _switch9039 := self.symbolInfo.FP.Get_mutMode(); _switch9039 == Ast_MutMode__AllMut || _switch9039 == Ast_MutMode__IMut || _switch9039 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch9039 == Ast_MutMode__Mut {
            if _switch9037 := prefixTypeInfo.FP.Get_mutMode(); _switch9037 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch9037 == Ast_MutMode__Mut || _switch9037 == Ast_MutMode__IMut || _switch9037 == Ast_MutMode__IMutRe {
...
// 2693: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2697: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
type Ast_AlternateTypeInfoMtd interface {
    ...
    SerializeTypeInfoList(arg1 *Ast_SerializeInfo, arg2 string, arg3 *LnsList, arg4 LnsAny) string
    SwitchScope(arg1 *Ast_Scope)
    updateParentInfo(arg1 *Ast_TypeInfo)
}
...
func (self *Ast_AlternateTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 2731: DeclConstr
func (self *Ast_AlternateTypeInfo) InitAst_AlternateTypeInfo(processInfo *Ast_ProcessInfo,belongClassFlag bool,altIndex LnsInt,txt string,accessMode LnsInt,parentInfo *Ast_TypeInfo,baseTypeInfo LnsAny,interfaceList LnsAny) {
    ...
    self.nilableTypeInfo = NewAst_NilableTypeInfo(processInfo, &self.Ast_TypeInfo)
    
}

// 2754: decl @lune.@base.@Ast.AlternateTypeInfo.updateParentInfo
func (self *Ast_AlternateTypeInfo) updateParentInfo(typeInfo *Ast_TypeInfo) {
    self.parentInfo = typeInfo
    
}

// 2759: decl @lune.@base.@Ast.AlternateTypeInfo.isModule
func (self *Ast_AlternateTypeInfo) IsModule() bool {
    return false
}

// 2764: decl @lune.@base.@Ast.AlternateTypeInfo.getParentId
func (self *Ast_AlternateTypeInfo) GetParentId() *Ast_IdInfo {
    return self.parentInfo.FP.Get_typeId()
}

// 2768: decl @lune.@base.@Ast.AlternateTypeInfo.get_baseId
func (self *Ast_AlternateTypeInfo) Get_baseId() *Ast_IdInfo {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 2772: decl @lune.@base.@Ast.AlternateTypeInfo.get_parentInfo
func (self *Ast_AlternateTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return self.parentInfo
}

// 2777: decl @lune.@base.@Ast.AlternateTypeInfo.getTxt
func (self *Ast_AlternateTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 2783: decl @lune.@base.@Ast.AlternateTypeInfo.getTxtWithRaw
...
// 2799: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2206 := alt2type.(*LnsMap)
        var otherWork *Ast_TypeInfo
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2206)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2206.Get(&self.Ast_TypeInfo)
            if !Lns_IsNil( _genType ) {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2206)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2206)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2206
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2225 := workAlt2type.(*LnsMap)
            workAlt2type_2225.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2850: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2876: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2249 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2249.Get(&self.Ast_TypeInfo)
            if !Lns_IsNil( _genType ) {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2249)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2886: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2892: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2272 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2272)
    }
    return false
}

// 2920: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2925: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2929: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2933: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2937: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2949: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
func (self *Ast_AlternateTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    var parentId *Ast_IdInfo
    parentId = self.FP.GetParentId()
    stream.Write(Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, txt = %q, ", []LnsAny{Ast_SerializeKind__Alternate, parentId.Id, self.typeId.Id, self.txt}) + Lns_getVM().String_format("accessMode = %d, baseId = %s, ", []LnsAny{self.accessMode, serializeInfo.FP.SerializeId(self.FP.Get_baseId())}) + Lns_getVM().String_format("belongClassFlag = %s, altIndex = %d, ", []LnsAny{self.belongClassFlag, self.altIndex}))
    stream.Write(self.FP.SerializeTypeInfoList(serializeInfo, "ifList = {", self.interfaceList, nil))
    stream.Write("}\n")
}

// 2964: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4525: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if !Lns_IsNil( _genType ) {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_3593 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_3593, alt2type)).(bool)
            }
...
// 4674: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
func NewAst_BoxTypeInfo(arg1 *Ast_ProcessInfo, arg2 LnsInt, arg3 *Ast_TypeInfo) *Ast_BoxTypeInfo {
    obj := &Ast_BoxTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_BoxTypeInfo(arg1, arg2, arg3)
    return obj
}
func (self *Ast_BoxTypeInfo) Get_boxingType() *Ast_TypeInfo{ return self.boxingType }
func (self *Ast_BoxTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 2982: DeclConstr
func (self *Ast_BoxTypeInfo) InitAst_BoxTypeInfo(processInfo *Ast_ProcessInfo,accessMode LnsInt,boxingType *Ast_TypeInfo) {
...
// 3032: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3036: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 3041: decl @lune.@base.@Ast.BoxTypeInfo.serialize
func (self *Ast_BoxTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind = %d, typeId = %d, accessMode = %d, boxingType = %d }\n", []LnsAny{Ast_SerializeKind__Box, self.typeId.Id, self.accessMode, self.boxingType.FP.Get_typeId().Id}))
}

// 3048: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 3059: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4742: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3712 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3712)
    }
    return nil
}

// 6033: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch24441 := canEvalType; _switch24441 == Ast_CanEvalType__SetOp || _switch24441 == Ast_CanEvalType__SetOpIMut || _switch24441 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
func (self *Ast_GenericTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 3086: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 3128: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 3133: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 3173: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3177: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3180: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3185: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
    ...
    }
    {
        ...
        if !Lns_IsNil( _otherGen ) {
            ...
            for _key, _val := range( self.alt2typeMap.Items ) {
                ...
                otherType = Ast_AlternateTypeInfo_getAssign(Lns_unwrap( otherGen.alt2typeMap.Get(key)).(*Ast_TypeInfo), alt2type)
                var ret bool
                var mess LnsAny
...
// 3246: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 3279: decl @lune.@base.@Ast.GenericTypeInfo.serialize
func (self *Ast_GenericTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind = %d, typeId = %d, genSrcTypeId = %s, genTypeList = {", []LnsAny{Ast_SerializeKind__Generic, self.typeId.Id, serializeInfo.FP.SerializeId(self.genSrcTypeInfo.FP.Get_typeId())}))
    var count LnsInt
    count = 0
    for _, _genType := range( self.alt2typeMap.Items ) {
        ...
        stream.Write(serializeInfo.FP.SerializeId(genType.FP.Get_typeId()))
    }
    stream.Write("} }\n")
}

// 3294: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5556: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_3536_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4279 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4279, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
func NewAst_ModifierTypeInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_TypeInfo, arg3 LnsInt) *Ast_ModifierTypeInfo {
    obj := &Ast_ModifierTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_ModifierTypeInfo(arg1, arg2, arg3)
    return obj
}
...
// 3318: DeclConstr
func (self *Ast_ModifierTypeInfo) InitAst_ModifierTypeInfo(processInfo *Ast_ProcessInfo,srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) {
    self.InitAst_TypeInfo(nil, processInfo)
...
func (self *Ast_ModifierTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    if _switch11705 := self.mutMode; _switch11705 == Ast_MutMode__IMut || _switch11705 == Ast_MutMode__IMutRe {
        txt = "&" + txt
        
    } else if _switch11705 == Ast_MutMode__AllMut {
        txt = "allmut " + txt
...
// 3352: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3360: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3364: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
func (self *Ast_ModifierTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind = %d, typeId = %d, srcTypeId = %s, mutMode = %d }\n", []LnsAny{Ast_SerializeKind__Modifier, self.typeId.Id, serializeInfo.FP.SerializeId(self.srcTypeInfo.FP.Get_typeId()), self.mutMode}))
}

// 3372: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch11874 := canEvalType; _switch11874 == Ast_CanEvalType__SetEq || _switch11874 == Ast_CanEvalType__SetOp {
    ...
    var result bool
    var mess LnsAny
    result,mess = Ast_TypeInfo_canEvalWithBase(processInfo, self.srcTypeInfo, Ast_TypeInfo_isMut(&self.Ast_TypeInfo), other.FP.Get_srcTypeInfo(), evalType, alt2type)
    return result, mess
}

// 3403: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4951: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4959: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6913: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5119 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5119, Ast_MutMode__IMut)
    }
    return nil
}
...
func NewAst_ModuleTypeInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_Scope, arg3 bool, arg4 string, arg5 LnsAny, arg6 bool) *Ast_ModuleTypeInfo {
    obj := &Ast_ModuleTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_ModuleTypeInfo(arg1, arg2, arg3, arg4, arg5, arg6)
    return obj
}
...
func (self *Ast_ModuleTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 3434: DeclConstr
func (self *Ast_ModuleTypeInfo) InitAst_ModuleTypeInfo(processInfo *Ast_ProcessInfo,scope *Ast_Scope,externalFlag bool,txt string,parentInfo LnsAny,mutable bool) {
    ...
    var fullName string
    if parentInfo != nil{
        parentInfo_2801 := parentInfo.(*Ast_TypeInfo)
        parentInfo_2801.FP.AddChildren(&self.Ast_TypeInfo)
        var parentFull string
        parentFull = parentInfo_2801.FP.GetParentFullName(Ast_defaultTypeNameCtrl, nil, nil)
        fullName = Lns_getVM().String_format("%s.@%s", []LnsAny{parentFull, txt})
        
    } else {
        fullName = Lns_getVM().String_format("%s", []LnsAny{txt})
...
// 3462: decl @lune.@base.@Ast.ModuleTypeInfo.equals
func (self *Ast_ModuleTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
...
// 3521: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
func (self *Ast_ModuleTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    var txt string
    txt = Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, txt = '%s', ", []LnsAny{Ast_SerializeKind__Module, self.FP.GetParentId().Id, self.typeId.Id, self.rawTxt})
    stream.Write(txt + "\n")
    stream.Write("}\n")
}
...
func NewAst_EnumValInfo(arg1 string, arg2 LnsAny, arg3 *Ast_SymbolInfo) *Ast_EnumValInfo {
    obj := &Ast_EnumValInfo{}
    obj.FP = obj
    obj.InitAst_EnumValInfo(arg1, arg2, arg3)
    return obj
}
func (self *Ast_EnumValInfo) InitAst_EnumValInfo(arg1 string, arg2 LnsAny, arg3 *Ast_SymbolInfo) {
    self.name = arg1
    self.val = arg2
...
func (self *Ast_EnumValInfo) Get_symbolInfo() *Ast_SymbolInfo{ return self.symbolInfo }
...
func NewAst_EnumTypeInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_Scope, arg3 bool, arg4 LnsInt, arg5 string, arg6 LnsAny, arg7 *Ast_TypeInfo) *Ast_EnumTypeInfo {
    obj := &Ast_EnumTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_EnumTypeInfo(arg1, arg2, arg3, arg4, arg5, arg6, arg7)
    return obj
}
...
func (self *Ast_EnumTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 3580: DeclConstr
func (self *Ast_EnumTypeInfo) InitAst_EnumTypeInfo(processInfo *Ast_ProcessInfo,scope *Ast_Scope,externalFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,valTypeInfo *Ast_TypeInfo) {
    self.InitAst_TypeInfo(scope, processInfo)
    self.externalFlag = externalFlag
...
func (self *Ast_EnumTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    if &self.Ast_TypeInfo == other.FP.Get_srcTypeInfo().FP.Get_aliasSrc(){
        return true, nil
    }
    return false, Lns_getVM().String_format("%d != %d", []LnsAny{self.FP.Get_typeId().Id, other.FP.Get_srcTypeInfo().FP.Get_aliasSrc().FP.Get_typeId().Id})
}

// 3655: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3660: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Get(name)
}

// 3664: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5957: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    var txt string
    txt = Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, txt = '%s',\naccessMode = %d, kind = %d, valTypeId = %d, ", []LnsAny{Ast_SerializeKind__Enum, self.FP.GetParentId().Id, self.typeId.Id, self.rawTxt, self.accessMode, Ast_TypeInfoKind__Enum, self.valTypeInfo.FP.Get_typeId().Id})
    stream.Write(txt)
    stream.Write("enumValList = {")
    {
        __collection24139 := self.name2EnumValInfo
        __sorted24139 := __collection24139.CreateKeyListStr()
        __sorted24139.Sort( LnsItemKindStr, nil )
        for _, ___key24139 := range( __sorted24139.Items ) {
            enumValInfo := __collection24139.Items[ ___key24139 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp24137 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp24137.Val1
...
func NewAst_AlgeTypeInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_Scope, arg3 bool, arg4 LnsInt, arg5 string, arg6 LnsAny) *Ast_AlgeTypeInfo {
    obj := &Ast_AlgeTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_AlgeTypeInfo(arg1, arg2, arg3, arg4, arg5, arg6)
    return obj
}
...
func (self *Ast_AlgeTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 3690: decl @lune.@base.@Ast.AlgeTypeInfo.get_baseTypeInfo
func (self *Ast_AlgeTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 3694: DeclConstr
func (self *Ast_AlgeTypeInfo) InitAst_AlgeTypeInfo(processInfo *Ast_ProcessInfo,scope *Ast_Scope,externalFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny) {
    self.InitAst_TypeInfo(scope, processInfo)
    self.externalFlag = externalFlag
...
// 3761: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3784: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 6009: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    var txt string
    txt = Lns_getVM().String_format("{ skind = %d, parentId = %d, typeId = %d, txt = '%s',\naccessMode = %d, kind = %d, ", []LnsAny{Ast_SerializeKind__Alge, self.FP.GetParentId().Id, self.typeId.Id, self.rawTxt, self.accessMode, Ast_TypeInfoKind__Alge})
    stream.Write(txt)
    stream.Write("algeValList = {")
    var firstFlag bool
    firstFlag = true
    {
        __collection24377 := self.valInfoMap
        __sorted24377 := __collection24377.CreateKeyListStr()
        __sorted24377.Sort( LnsItemKindStr, nil )
        for _, ___key24377 := range( __sorted24377.Items ) {
            algeValInfo := __collection24377.Items[ ___key24377 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            ...
            algeValInfo.FP.Serialize(stream, serializeInfo)
        }
    }
    stream.Write("} }\n")
}
...
func NewAst_AlgeValInfo(arg1 string, arg2 *LnsList, arg3 *Ast_AlgeTypeInfo, arg4 *Ast_SymbolInfo) *Ast_AlgeValInfo {
    obj := &Ast_AlgeValInfo{}
    obj.FP = obj
    obj.InitAst_AlgeValInfo(arg1, arg2, arg3, arg4)
    return obj
}
func (self *Ast_AlgeValInfo) InitAst_AlgeValInfo(arg1 string, arg2 *LnsList, arg3 *Ast_AlgeTypeInfo, arg4 *Ast_SymbolInfo) {
    self.name = arg1
    self.typeList = arg2
    self.algeTpye = arg3
...
func (self *Ast_AlgeValInfo) Get_symbolInfo() *Ast_SymbolInfo{ return self.symbolInfo }
// 3772: decl @lune.@base.@Ast.AlgeValInfo.serialize
func (self *Ast_AlgeValInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    ...
    for _index, _typeInfo := range( self.typeList.Items ) {
        ...
        stream.Write(Lns_getVM().String_format("%s", []LnsAny{serializeInfo.FP.SerializeId(typeInfo.FP.Get_typeId())}))
    }
    stream.Write("} }")
}
...
func NewAst_NormalTypeInfo(arg1 *Ast_ProcessInfo, arg2 bool, arg3 LnsAny, arg4 LnsAny, arg5 LnsAny, arg6 bool, arg7 bool, arg8 bool, arg9 LnsInt, arg10 string, arg11 LnsAny, arg12 LnsInt, arg13 LnsAny, arg14 LnsAny, arg15 LnsAny, arg16 LnsAny, arg17 LnsAny) *Ast_NormalTypeInfo {
...
func (self *Ast_NormalTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
func (self *Ast_NormalTypeInfo) Get_requirePath() string{ return self.requirePath }
func (self *Ast_NormalTypeInfo) set_requirePath(arg1 string){ self.requirePath = arg1 }
// 3841: decl @lune.@base.@Ast.NormalTypeInfo.getOverridingType
func (self *Ast_NormalTypeInfo) GetOverridingType() LnsAny {
    switch _exp13599 := self.overridingType.(type) {
    case *Ast_OverridingType__NotOverride:
        return nil
    case *Ast_OverridingType__Override:
    typeInfo := _exp13599.Val1
        return typeInfo
...
// 3869: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
func (self *Ast_NormalTypeInfo) SwitchScopeTo(scope *Ast_Scope) {
    self.FP.SwitchScope(scope)
}

// 3873: DeclConstr
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny,moduleLang LnsAny) {
    self.InitAst_TypeInfo(scope, processInfo)
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3888:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch14049 := kind; _switch14049 == Ast_TypeInfoKind__Set || _switch14049 == Ast_TypeInfoKind__Map || _switch14049 == Ast_TypeInfoKind__List || _switch14049 == Ast_TypeInfoKind__Array || _switch14049 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch14049 == Ast_TypeInfoKind__Class || _switch14049 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        if parentInfo != nil{
            parentInfo_3250 := parentInfo.(*Ast_TypeInfo)
            parentInfo_3250.FP.AddChildren(&self.Ast_TypeInfo)
        }
        var hasNilable bool
        hasNilable = false
        if _switch14158 := (kind); _switch14158 == Ast_TypeInfoKind__Prim || _switch14158 == Ast_TypeInfoKind__List || _switch14158 == Ast_TypeInfoKind__Array || _switch14158 == Ast_TypeInfoKind__Set || _switch14158 == Ast_TypeInfoKind__Map || _switch14158 == Ast_TypeInfoKind__Class || _switch14158 == Ast_TypeInfoKind__Stem || _switch14158 == Ast_TypeInfoKind__Module || _switch14158 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch14158 == Ast_TypeInfoKind__Func || _switch14158 == Ast_TypeInfoKind__Method || _switch14158 == Ast_TypeInfoKind__Form || _switch14158 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3975: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3985: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3989: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3993: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() *Ast_IdInfo {
    return self.parentInfo.FP.Get_typeId()
}

// 3997: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() *Ast_IdInfo {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 4002: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 4008: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
func (self *Ast_NormalTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    parentTxt = ""
    if typeNameCtrl != nil{
        typeNameCtrl_3305 := typeNameCtrl.(*Ast_TypeNameCtrl)
        parentTxt = self.FP.GetParentFullName(typeNameCtrl_3305, importInfo, localFlag)
...
// 4036: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch14576 := self.kind; _switch14576 == Ast_TypeInfoKind__Func || _switch14576 == Ast_TypeInfoKind__Form || _switch14576 == Ast_TypeInfoKind__FormFunc || _switch14576 == Ast_TypeInfoKind__Method || _switch14576 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 4081: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 4086: decl @lune.@base.@Ast.NormalTypeInfo.serialize
func (self *Ast_NormalTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    ...
    parentId = self.FP.GetParentId()
    var txt string
    txt = Lns_getVM().String_format("{ skind=%d, parentId = %d, typeId = %d, baseId = %s, txt = '%s',\n        abstractFlag = %s, staticFlag = %s, accessMode = %d, kind = %d, mutMode = %d, ", []LnsAny{Ast_SerializeKind__Normal, parentId.Id, self.typeId.Id, serializeInfo.FP.SerializeId(self.FP.Get_baseId()), self.rawTxt, self.abstractFlag, self.staticFlag, self.accessMode, self.kind, self.mutMode})
    {
        __exp := self.moduleLang
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(LnsInt)
            txt = txt + Lns_getVM().String_format("moduleLang = %d, ", []LnsAny{_exp})
            
        }
    }
    if self.requirePath != ""{
        txt = txt + Lns_getVM().String_format("requirePath = \"%s\", ", []LnsAny{self.requirePath})
    ...
    for _, _child := range( self.FP.Get_children().Items ) {
        ...
        if serializeInfo.FP.IsValidChildren(child.FP.Get_typeId()){
            children.Insert(Ast_TypeInfo2Stem(child))
        }
    }
    stream.Write(txt + self.FP.SerializeTypeInfoList(serializeInfo, "itemTypeId = {", self.itemTypeInfoList, nil) + self.FP.SerializeTypeInfoList(serializeInfo, "ifList = {", self.interfaceList, nil) + self.FP.SerializeTypeInfoList(serializeInfo, "argTypeId = {", self.argTypeInfoList, nil) + self.FP.SerializeTypeInfoList(serializeInfo, "retTypeId = {", self.retTypeInfoList, nil) + self.FP.SerializeTypeInfoList(serializeInfo, "children = {", children, true) + "}\n")
}

// 4128: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    if self.typeId.FP.Equals(typeInfo.FP.Get_typeId()){
        return true
    }
    if typeInfo.FP.Get_kind() == Ast_TypeInfoKind__Alternate{
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch15100 := self.kind; _switch15100 == Ast_TypeInfoKind__List || _switch15100 == Ast_TypeInfoKind__Map || _switch15100 == Ast_TypeInfoKind__Array || _switch15100 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 4198: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 4212: decl @lune.@base.@Ast.NormalTypeInfo.create
func Ast_NormalTypeInfo_create(processInfo *Ast_ProcessInfo,accessMode LnsInt,abstractFlag bool,scope LnsAny,baseInfo *Ast_TypeInfo,parentInfo *Ast_TypeInfo,staticFlag bool,kind LnsInt,txt string,itemTypeInfo *LnsList,argTypeInfoList *LnsList,retTypeInfoList *LnsList,mutMode LnsAny) *Ast_TypeInfo {
    if _switch15311 := kind; _switch15311 == Ast_TypeInfoKind__Class || _switch15311 == Ast_TypeInfoKind__ExtModule || _switch15311 == Ast_TypeInfoKind__IF {
        Util_err("can't use create() method. use createClass(), createExtModule().")
    }
    ...
    var info *Ast_NormalTypeInfo
    info = NewAst_NormalTypeInfo(processInfo, abstractFlag, scope, baseInfo, nil, false, true, staticFlag, accessMode, txt, parentInfo, kind, itemTypeInfo, argTypeInfoList, retTypeInfoList, mutMode, nil)
    return &info.Ast_TypeInfo
}

// 4430: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin_3239_(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch16487 := kind; _switch16487 == Ast_TypeInfoKind__Array || _switch16487 == Ast_TypeInfoKind__List || _switch16487 == Ast_TypeInfoKind__Set || _switch16487 == Ast_TypeInfoKind__Class || _switch16487 == Ast_TypeInfoKind__Module || _switch16487 == Ast_TypeInfoKind__IF || _switch16487 == Ast_TypeInfoKind__Form || _switch16487 == Ast_TypeInfoKind__FormFunc || _switch16487 == Ast_TypeInfoKind__Func || _switch16487 == Ast_TypeInfoKind__Method || _switch16487 == Ast_TypeInfoKind__Macro {
    ...
    if _switch16585 := kind; _switch16585 == Ast_TypeInfoKind__Array || _switch16585 == Ast_TypeInfoKind__List || _switch16585 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch16585 == Ast_TypeInfoKind__Map {
    ...
    var info *Ast_NormalTypeInfo
    info = NewAst_NormalTypeInfo(Ast_rootProcessInfo, false, scope, nil, ifList, false, false, false, Ast_AccessMode__Pub, typeTxt, Ast_headTypeInfo, kind, genTypeList, argTypeList, retTypeList, Ast_MutMode__Mut, nil)
    Ast_registBuiltin_3234_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 6135: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch25038 := typeInfo.FP.Get_kind(); _switch25038 == Ast_TypeInfoKind__Prim || _switch25038 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch25038 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch25038 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch25038 == Ast_TypeInfoKind__Class || _switch25038 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch25038 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch25038 == Ast_TypeInfoKind__List || _switch25038 == Ast_TypeInfoKind__Array || _switch25038 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch25038 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch25038 == Ast_TypeInfoKind__Nilable {
...
// 6903: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6927: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_3536_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch29742 := self.FP.Get_kind(); _switch29742 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch29742 == Ast_TypeInfoKind__Func || _switch29742 == Ast_TypeInfoKind__Form || _switch29742 == Ast_TypeInfoKind__FormFunc {
        var argTypeInfoList *LnsList
        var workArg bool
        
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_3536_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_3536_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            return &processInfo.FP.CreateFunc(self.abstractFlag, false, Ast_getScope(&self.Ast_TypeInfo), self.kind, self.parentInfo, self.autoFlag, self.externalFlag, self.staticFlag, self.accessMode, self.rawTxt, itemTypeInfoList, argTypeInfoList, retTypeInfoList, Ast_TypeInfo_isMut(&self.Ast_TypeInfo)).Ast_TypeInfo
        }
        return &self.Ast_TypeInfo
    } else {
        if self.itemTypeInfoList.Len() == 0{
...
// 4269: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
func NewAst_DDDTypeInfo(arg1 *Ast_ProcessInfo, arg2 *Ast_TypeInfo, arg3 bool, arg4 LnsAny) *Ast_DDDTypeInfo {
    obj := &Ast_DDDTypeInfo{}
    obj.FP = obj
    obj.Ast_TypeInfo.FP = obj
    obj.InitAst_DDDTypeInfo(arg1, arg2, arg3, arg4)
    return obj
}
func (self *Ast_DDDTypeInfo) Get_typeInfo() *Ast_TypeInfo{ return self.typeInfo }
func (self *Ast_DDDTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
...
// 5024: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 5028: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
func (self *Ast_DDDTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5033: decl @lune.@base.@Ast.DDDTypeInfo.get_baseTypeInfo
func (self *Ast_DDDTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5037: decl @lune.@base.@Ast.DDDTypeInfo.get_parentInfo
func (self *Ast_DDDTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5041: DeclConstr
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    self.InitAst_TypeInfo(nil, processInfo)
    self.typeId = processInfo.FP.newId(&self.Ast_TypeInfo)
    ...
    if extOrgDDType != nil{
        extOrgDDType_3964 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_3964
...
// 5061: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 5065: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 5072: decl @lune.@base.@Ast.DDDTypeInfo.serialize
func (self *Ast_DDDTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind=%d, typeId = %d, itemTypeId = %s, parentId = %d, extTypeFlag = %s }\n", []LnsAny{Ast_SerializeKind__DDD, self.typeId.Id, serializeInfo.FP.SerializeId(self.typeInfo.FP.Get_typeId()), Ast_headTypeInfo.FP.Get_typeId().Id, self.FP.Get_extTypeFlag()}))
}

// 5080: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 5086: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5091: decl @lune.@base.@Ast.DDDTypeInfo.getModule
func (self *Ast_DDDTypeInfo) GetModule() *Ast_TypeInfo {
    return self.FP.Get_typeInfo().FP.GetModule()
}

// 5094: decl @lune.@base.@Ast.DDDTypeInfo.get_rawTxt
func (self *Ast_DDDTypeInfo) Get_rawTxt() string {
    return self.FP.GetTxt(nil, nil, nil)
}

// 5097: decl @lune.@base.@Ast.DDDTypeInfo.get_kind
func (self *Ast_DDDTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__DDD
}

// 5100: decl @lune.@base.@Ast.DDDTypeInfo.get_nilable
func (self *Ast_DDDTypeInfo) Get_nilable() bool {
    return true
}

// 5104: decl @lune.@base.@Ast.DDDTypeInfo.get_nilableTypeInfo
func (self *Ast_DDDTypeInfo) Get_nilableTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5107: decl @lune.@base.@Ast.DDDTypeInfo.get_mutMode
func (self *Ast_DDDTypeInfo) Get_mutMode() LnsInt {
    return self.FP.Get_typeInfo().FP.Get_mutMode()
}

// 5110: decl @lune.@base.@Ast.DDDTypeInfo.get_aliasSrc
func (self *Ast_DDDTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5113: decl @lune.@base.@Ast.DDDTypeInfo.get_srcTypeInfo
func (self *Ast_DDDTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5116: decl @lune.@base.@Ast.DDDTypeInfo.get_accessMode
func (self *Ast_DDDTypeInfo) Get_accessMode() LnsInt {
    return Ast_AccessMode__Pub
}

// 5493: decl @lune.@base.@Ast.DDDTypeInfo.getTxt
...
// 5499: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 5214: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 5226: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 5245: decl @lune.@base.@Ast.CombineType.createStem
...
// 5259: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
func (self *Ast_AbbrTypeInfo) Get_typeId() *Ast_IdInfo{ return self.typeId }
func (self *Ast_AbbrTypeInfo) Get_rawTxt() string{ return self.rawTxt }
// 5590: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
func (self *Ast_AbbrTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5595: decl @lune.@base.@Ast.AbbrTypeInfo.get_baseTypeInfo
func (self *Ast_AbbrTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5599: decl @lune.@base.@Ast.AbbrTypeInfo.get_parentInfo
...
// 5636: decl @lune.@base.@Ast.AbbrTypeInfo.serialize
func (self *Ast_AbbrTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    Util_err("illegal call")
}

// 5640: decl @lune.@base.@Ast.AbbrTypeInfo.get_display_stirng_with
func (self *Ast_AbbrTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
}

// 5644: decl @lune.@base.@Ast.AbbrTypeInfo.get_display_stirng
func (self *Ast_AbbrTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 5648: decl @lune.@base.@Ast.AbbrTypeInfo.getModule
func (self *Ast_AbbrTypeInfo) GetModule() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5651: decl @lune.@base.@Ast.AbbrTypeInfo.get_kind
func (self *Ast_AbbrTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Abbr
}

// 5654: decl @lune.@base.@Ast.AbbrTypeInfo.get_nilable
func (self *Ast_AbbrTypeInfo) Get_nilable() bool {
    return true
}

// 5657: decl @lune.@base.@Ast.AbbrTypeInfo.get_nilableTypeInfo
func (self *Ast_AbbrTypeInfo) Get_nilableTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5660: decl @lune.@base.@Ast.AbbrTypeInfo.get_mutMode
func (self *Ast_AbbrTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__IMut
}

// 5663: decl @lune.@base.@Ast.AbbrTypeInfo.get_accessMode
...
// 5705: decl @lune.@base.@Ast.ExtTypeInfo.equals
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_3281_(self.extedType, Ast_LuavalConvKind__InLua, false))){
        return false
    }
    return self.extedType.FP.Equals(processInfo, typeInfo, alt2type, checkModifer)
}

// 5721: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp22909(Lns_2DDD(Ast_failCreateLuavalWith_3281_(other, Ast_LuavalConvKind__ToLua, true)))
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5745: decl @lune.@base.@Ast.ExtTypeInfo.serialize
func (self *Ast_ExtTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    stream.Write(Lns_getVM().String_format("{ skind = %d, typeId = %d, extedTypeId = %s }\n", []LnsAny{Ast_SerializeKind__Ext, self.typeId.Id, serializeInfo.FP.SerializeId(self.extedType.FP.Get_typeId())}))
}

// 5752: decl @lune.@base.@Ast.ExtTypeInfo.get_display_stirng_with
func (self *Ast_ExtTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
}

// 5756: decl @lune.@base.@Ast.ExtTypeInfo.get_display_stirng
func (self *Ast_ExtTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 5760: decl @lune.@base.@Ast.ExtTypeInfo.getModule
func (self *Ast_ExtTypeInfo) GetModule() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5763: decl @lune.@base.@Ast.ExtTypeInfo.get_kind
func (self *Ast_ExtTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Ext
}

// 5766: decl @lune.@base.@Ast.ExtTypeInfo.get_aliasSrc
func (self *Ast_ExtTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5769: decl @lune.@base.@Ast.ExtTypeInfo.get_srcTypeInfo
func (self *Ast_ExtTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5772: decl @lune.@base.@Ast.ExtTypeInfo.get_nonnilableType
func (self *Ast_ExtTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 5775: decl @lune.@base.@Ast.ExtTypeInfo.get_nilable
func (self *Ast_ExtTypeInfo) Get_nilable() bool {
    return false
}

// 5778: decl @lune.@base.@Ast.ExtTypeInfo.applyGeneric
...
// 7086: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 7097: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
func (self *Ast_TypeAnalyzer) AnalyzeTypeFromTxt(txt string,scope *Ast_Scope,accessMode LnsInt,parentPub bool)(LnsAny, LnsAny, LnsAny) {
    ...
    parser = NewParser_DefaultPushbackParser(&NewParser_StreamParser(stream.FP, "test", nil, nil).Parser_Parser)
    return self.FP.AnalyzeType(scope, parser.FP, accessMode, true, parentPub)
}

// 7108: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 7148: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Types_Position)(LnsAny, LnsAny, LnsAny) {
    ...
    for  {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp30720(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5291 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5291))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5291.FP.Get_typeInfo()))
                }
            ...
            if _switch31341 := typeInfo.FP.Get_kind(); _switch31341 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch31341 == Ast_TypeInfoKind__List {
            ...
            } else if _switch31341 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch31341 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch31341 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch31341 == Ast_TypeInfoKind__Class || _switch31341 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch31341 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch31341 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp31319 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp31319.Val1
...
func Lns_Ast_init() {
    ...
    Ast_rootProcessInfo = Ast_ProcessInfo_createRoot_1074_()
    Ast_rootTypeIdInfo = Ast_rootProcessInfo.FP.newIdForRoot()
    Ast_rootTypeId = Ast_rootTypeIdInfo.Id
    Ast_DummyModuleInfoManager____init_1151_()
    ...
    _ = NewLnsList([]LnsAny{})
    Ast_headTypeInfo = &Ast_RootTypeInfo_create_1728_().Ast_TypeInfo
    Ast_rootProcessInfo.FP.setRootTypeInfo(Ast_rootTypeId, Ast_headTypeInfo)
    Ast_defaultTypeNameCtrl = NewAst_TypeNameCtrl(Ast_headTypeInfo)
    Ast_AutoBoxingInfo____init_1816_()
    Ast_dummyIdInfo = NewAst_IdInfo(1, Ast_rootProcessInfo)
    Ast_CanEvalCtrlTypeInfo____init_1838_()
    ...
    Ast_addBuiltin(Ast_headTypeInfo)
    Ast_builtinTypeNone = Ast_NormalTypeInfo_createBuiltin_3239_("__None", "", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeEmpty = Ast_NormalTypeInfo_createBuiltin_3239_("__Empty", "::", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeNeverRet = Ast_NormalTypeInfo_createBuiltin_3239_("__NRet", "__", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeStem = Ast_NormalTypeInfo_createBuiltin_3239_("Stem", "stem", Ast_TypeInfoKind__Stem, nil, nil)
    Ast_builtinTypeStem_ = Ast_builtinTypeStem.FP.Get_nilableTypeInfo()
    Ast_builtinTypeBool = Ast_NormalTypeInfo_createBuiltin_3239_("Bool", "bool", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeInt = Ast_NormalTypeInfo_createBuiltin_3239_("Int", "int", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeReal = Ast_NormalTypeInfo_createBuiltin_3239_("Real", "real", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeChar = Ast_NormalTypeInfo_createBuiltin_3239_("char", "__char", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeMapping = Ast_NormalTypeInfo_createBuiltin_3239_("Mapping", "Mapping", Ast_TypeInfoKind__IF, nil, nil)
    Ast_builtinTypeAsyncItem = Ast_NormalTypeInfo_createBuiltin_3239_("__AsyncItem", "__AsyncItem", Ast_TypeInfoKind__IF, nil, nil)
    Ast_builtinTypeString = Ast_NormalTypeInfo_createBuiltin_3239_("String", "str", Ast_TypeInfoKind__Class, nil, NewLnsList([]LnsAny{Ast_TypeInfo2Stem(Ast_builtinTypeMapping)}))
    Ast_builtinTypeMap = Ast_NormalTypeInfo_createBuiltin_3239_("Map", "Map", Ast_TypeInfoKind__Map, nil, nil)
    Ast_builtinTypeSet = Ast_NormalTypeInfo_createBuiltin_3239_("Set", "Set", Ast_TypeInfoKind__Set, nil, nil)
    Ast_builtinTypeList = Ast_NormalTypeInfo_createBuiltin_3239_("List", "List", Ast_TypeInfoKind__List, nil, nil)
    Ast_builtinTypeArray = Ast_NormalTypeInfo_createBuiltin_3239_("Array", "Array", Ast_TypeInfoKind__Array, nil, nil)
    ...
    Ast_builtinTypeBox = NewAst_BoxTypeInfo(Ast_rootProcessInfo, Ast_AccessMode__Pub, &Ast_boxRootAltType.Ast_TypeInfo)
    Ast_registBuiltin_3234_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_3234_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_3234_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    Ast_builtinTypeForm = Ast_NormalTypeInfo_createBuiltin_3239_("Form", "form", Ast_TypeInfoKind__Form, Ast_builtinTypeDDD, nil)
    Ast_immutableTypeSet.Add(Ast_TypeInfo2Stem(Ast_builtinTypeForm))
    Ast_builtinTypeSymbol = Ast_NormalTypeInfo_createBuiltin_3239_("Symbol", "sym", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeStat = Ast_NormalTypeInfo_createBuiltin_3239_("Stat", "stat", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeExp = Ast_NormalTypeInfo_createBuiltin_3239_("Exp", "__exp", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeMultiExp = Ast_NormalTypeInfo_createBuiltin_3239_("Exps", "__exps", Ast_TypeInfoKind__Prim, nil, nil)
    ...
    switch _exp23467 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23467.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_3234_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_3234_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
