...
// 4040: decl @lune.@base.@Ast.isGenericType
...
// 4177: decl @lune.@base.@Ast.getEnumLiteralVal
...
// 5103: decl @lune.@base.@Ast.isExtType
...
// 5126: decl @lune.@base.@Ast.addBuiltin
...
// 5130: decl @lune.@base.@Ast.addBuiltinMut
...
// 5149: decl @lune.@base.@Ast.getBuiltinMut
...
// 5158: decl @lune.@base.@Ast.registBuiltin
...
// 5337: decl @lune.@base.@Ast.isClass
...
// 5503: decl @lune.@base.@Ast.failCreateLuavalWith
...
// 5618: decl @lune.@base.@Ast.isStruct
...
// 5646: decl @lune.@base.@Ast.isConditionalbe
...
// 6573: decl @lune.@base.@Ast.applyGenericList
...
// 6952: decl @lune.@base.@Ast.convToExtTypeList
...
// 6998: decl @lune.@base.@Ast.isNumberType
...
// 7364: decl @lune.@base.@Ast.createProcessInfo
...
// 7626: decl @lune.@base.@Ast.TypeInfo.checkMatchTypeAsync.mismatchErrMess
...
// 7650: decl @lune.@base.@Ast.isSettableToForm
...
// 8263: decl @lune.@base.@Ast.isPrimitive
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(_env *LnsEnv, processInfo *Ast_ProcessInfo,finalFlag bool,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,typeDataAccessor LnsAny,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny,moduleLang LnsAny,asyncMode LnsInt) {
    ...
    if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_TypeInfo).FP.HasBase(_env)})/* 4719:30 */)) )){
...
// 5052: decl @lune.@base.@Ast.ProcessInfo.duplicate
...
// 5090: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 5654: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 5714: decl @lune.@base.@Ast.ProcessInfo.createSet_
...
// 5750: decl @lune.@base.@Ast.ProcessInfo.createList_
...
// 5775: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 5787: decl @lune.@base.@Ast.ProcessInfo.createMap_
...
// 5893: decl @lune.@base.@Ast.ProcessInfo.createFuncAsync
...
// 5928: decl @lune.@base.@Ast.ProcessInfo.createTuple
...
// 5947: decl @lune.@base.@Ast.ProcessInfo.createDummyNameSpace
...
// 5959: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 5990: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 6154: decl @lune.@base.@Ast.ProcessInfo.createDDD
...
// 6564: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 6864: decl @lune.@base.@Ast.ProcessInfo.createLuaval
...
// 7371: decl @lune.@base.@Ast.ProcessInfo.newUser
...
// 5108: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 5401: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 6000: decl @lune.@base.@Ast.Scope.addAlias
...
// 6013: decl @lune.@base.@Ast.Scope.addAliasForType
...
// 5136: decl @lune.@base.@Ast.TypeInfo.getBuiltinInfo
...
// 5341: decl @lune.@base.@Ast.TypeInfo.canBeAsyncParam
...
// 6368: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
...
// 6514: decl @lune.@base.@Ast.TypeInfo.getCommonType
...
// 7397: decl @lune.@base.@Ast.TypeInfo.checkMatchTypeMain
...
// 7588: decl @lune.@base.@Ast.TypeInfo.checkMatchType
...
// 7621: decl @lune.@base.@Ast.TypeInfo.checkMatchTypeAsync
...
// 7670: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
...
// 8254: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 5476: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 5972: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 5981: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 8165: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
...
// 7161: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
// 5405: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
...
// 5589: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 3713: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng(_env *LnsEnv) string {
    return self.FP.Get_display_stirng_with(_env, self.FP.Get_rawTxt(_env), nil)
}
// 3717: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 3722: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 3729: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 3740: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 5668: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
...
// 7125: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
...
// 3768: decl @lune.@base.@Ast.GenericTypeInfo.get_nonnilableType
func (self *Ast_GenericTypeInfo) Get_nonnilableType(_env *LnsEnv) *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}
// 3772: decl @lune.@base.@Ast.GenericTypeInfo.get_nilableTypeInfoMut
func (self *Ast_GenericTypeInfo) get_nilableTypeInfoMut(_env *LnsEnv) *Ast_TypeInfo {
    return &self.nilableTypeInfo.Ast_TypeInfo
}
// 3776: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 3782: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng
func (self *Ast_GenericTypeInfo) Get_display_stirng(_env *LnsEnv) string {
    return self.FP.Get_display_stirng_with(_env, self.FP.Get_rawTxt(_env), nil)
}
// 3826: decl @lune.@base.@Ast.GenericTypeInfo.create
...
// 3840: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule(_env *LnsEnv) *Ast_TypeInfo {
    return self.moduleTypeInfo
}
// 3845: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 3891: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc(_env *LnsEnv) *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}
// 3894: decl @lune.@base.@Ast.GenericTypeInfo.get_canDealGenInherit
...
// 3898: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo(_env *LnsEnv) *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}
// 3901: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType(_env *LnsEnv) *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}
// 3906: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 3979: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 4013: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 4028: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 6597: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
...
// 4145: decl @lune.@base.@Ast.ModuleTypeInfo.get_display_stirng_with
func (self *Ast_ModuleTypeInfo) Get_display_stirng_with(_env *LnsEnv, raw string,alt2type LnsAny) string {
    return self.FP.GetTxtWithRaw(_env, raw, nil, nil, nil)
}
// 4150: decl @lune.@base.@Ast.ModuleTypeInfo.get_display_stirng
func (self *Ast_ModuleTypeInfo) Get_display_stirng(_env *LnsEnv) string {
    return self.FP.Get_display_stirng_with(_env, self.FP.Get_rawTxt(_env), nil)
}
// 4153: decl @lune.@base.@Ast.ModuleTypeInfo.canEvalWith
...
// 4160: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
// 4289: decl @lune.@base.@Ast.EnumTypeInfo.get_display_stirng_with
func (self *Ast_EnumTypeInfo) Get_display_stirng_with(_env *LnsEnv, raw string,alt2type LnsAny) string {
    return self.FP.GetTxtWithRaw(_env, raw, nil, nil, nil)
}
// 4294: decl @lune.@base.@Ast.EnumTypeInfo.get_display_stirng
func (self *Ast_EnumTypeInfo) Get_display_stirng(_env *LnsEnv) string {
    return self.FP.Get_display_stirng_with(_env, self.FP.Get_rawTxt(_env), nil)
}
// 4298: decl @lune.@base.@Ast.EnumTypeInfo.canEvalWith
...
// 4309: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 4416: decl @lune.@base.@Ast.AlgeTypeInfo.get_display_stirng_with
...
// 4422: decl @lune.@base.@Ast.AlgeTypeInfo.get_display_stirng
func (self *Ast_AlgeTypeInfo) Get_display_stirng(_env *LnsEnv) string {
    return self.FP.Get_display_stirng_with(_env, self.FP.Get_rawTxt(_env), nil)
}
// 4426: decl @lune.@base.@Ast.AlgeTypeInfo.canEvalWith
...
// 4433: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode(_env *LnsEnv) LnsInt {
    return Ast_MutMode__Mut
}
// 4437: decl @lune.@base.@Ast.AlgeTypeInfo.create
...
// 4468: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 7097: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
...
// 4456: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 4577: decl @lune.@base.@Ast.TupleTypeInfo.serialize
...
// 4591: decl @lune.@base.@Ast.TupleTypeInfo.canEvalWith
...
// 4663: decl @lune.@base.@Ast.NormalTypeInfo.get_nilableTypeInfoMut
func (self *Ast_NormalTypeInfo) get_nilableTypeInfoMut(_env *LnsEnv) *Ast_TypeInfo {
    return self.nilableTypeInfo
}
// 4667: decl @lune.@base.@Ast.NormalTypeInfo.getOverridingType
...
// 4695: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
func (self *Ast_NormalTypeInfo) SwitchScopeTo(_env *LnsEnv, scope *Ast_Scope) {
    self.FP.SwitchScope(_env, scope)
}
// 4811: decl @lune.@base.@Ast.NormalTypeInfo.cloneForMeta
...
// 4826: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 4867: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
...
// 4901: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng(_env *LnsEnv) string {
    return self.FP.Get_display_stirng_with(_env, self.FP.Get_rawTxt(_env), nil)
}
// 4906: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 4973: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
...
// 5044: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 5204: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
...
// 7266: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
...
// 7343: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 8155: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 8181: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
...
// 6101: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 6109: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 6115: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 6537: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 6245: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 6257: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 6277: decl @lune.@base.@Ast.CombineType.createStem
...
// 6294: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 6327: decl @lune.@base.@Ast.CombineType.andType
...
// 6682: decl @lune.@base.@Ast.AbbrTypeInfo.canEvalWith
...
// 6689: decl @lune.@base.@Ast.AbbrTypeInfo.serialize
...
// 6766: decl @lune.@base.@Ast.ExtTypeInfo.equals
...
// 6782: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
...
// 6810: decl @lune.@base.@Ast.ExtTypeInfo.serialize
...
// 8401: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
