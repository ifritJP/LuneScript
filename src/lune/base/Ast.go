...
func Ast_LuavalConvKind_get__allList_4216_() *LnsList{
...
func Ast_LuavalConvKind__from_4209_(arg1 LnsInt) LnsAny{
...
// for 5447
func Ast_convExp21793(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6843
func Ast_convExp29064(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp30033(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp30191(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp30357(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp30528(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp30694(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp30900(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp31077(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6978
func Ast_convExp31235(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7017
func Ast_convExp31390(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
// 958: decl @lune.@base.@Ast.applyGenericDefault
...
// 986: decl @lune.@base.@Ast.getAllNameForKind
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection2722 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted2722 := __collection2722.CreateKeyListStr()
            __sorted2722.Sort( LnsItemKindStr, nil )
            for _, ___key2722 := range( __sorted2722.Items ) {
                symbolInfo := __collection2722.Items[ ___key2722 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch2720 := symbolInfo.FP.Get_kind(); _switch2720 == symbolKind {
...
// 1020: decl @lune.@base.@Ast.getAllMethodName
...
// 2087: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2608_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if __exp != nil {
            ...
            {
                __collection7014 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted7014 := __collection7014.CreateKeyListStr()
                __sorted7014.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted7014.Items ) {
                    symbolInfo := __collection7014.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if _subScope != nil {
                            ...
                            dumpScope__dumpScopeSub_2608_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
// 2082: decl @lune.@base.@Ast.dumpScope
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2608_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3082: decl @lune.@base.@Ast.isGenericType
...
// 3295: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp11492 := obj.(type) {
...
// 4024: decl @lune.@base.@Ast.isExtType
...
// 4031: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch14757 := typeInfo.FP.Get_kind(); _switch14757 == Ast_TypeInfoKind__FormFunc || _switch14757 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4134: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId(),typeInfo)
}

// 4138: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_4151_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
...
// 4258: decl @lune.@base.@Ast.isClass
...
// 4327: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_4219_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch16680 := typeInfo.FP.Get_kind(); _switch16680 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_4219_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch16680 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch16680 == Ast_TypeInfoKind__Form || _switch16680 == Ast_TypeInfoKind__IF || _switch16680 == Ast_TypeInfoKind__DDD {
        ...
        return nil, false
    } else if _switch16680 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch16680 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch16680 == Ast_TypeInfoKind__Array || _switch16680 == Ast_TypeInfoKind__List || _switch16680 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_4219_(itemType, convFlag, validToCheck)
            if err != nil{
                err_3793 := err.(string)
                return err_3793, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch16680 == Ast_TypeInfoKind__FormFunc {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
...
// 4438: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch16830 := typeInfo.FP.Get_kind(); _switch16830 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 4461: decl @lune.@base.@Ast.isConditionalbe
...
// 5239: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_4589_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
// 5582: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp22455 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp22455.Val1
...
// 5626: decl @lune.@base.@Ast.isNumberType
...
// 6140: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_5167_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 6669: decl @lune.@base.@Ast.createProcessInfo
...
// 3973: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 4044: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch14837 := mutMode; _switch14837 == Ast_MutMode__IMut || _switch14837 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch14837 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp14903 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp14903.Val1
    ...
    if _switch14970 := mutMode; _switch14970 == Ast_MutMode__IMut || _switch14970 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch14970 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4470: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4516: decl @lune.@base.@Ast.ProcessInfo.createSet
...
// 4529: decl @lune.@base.@Ast.ProcessInfo.createList
...
// 4542: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 4555: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4570: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4591: decl @lune.@base.@Ast.ProcessInfo.createClass
...
// 4620: decl @lune.@base.@Ast.ProcessInfo.createFunc
...
// 4641: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4670: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 4826: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4219_(typeInfo, Ast_LuavalConvKind__InLua, true)))) &&
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( extTypeFlag) ).(bool)){
        switch _exp19208 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp19208.Val1
            typeInfo = work
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4219_(typeInfo, Ast_LuavalConvKind__InLua, true))){
...
// 5230: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5505: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    process = func() LnsAny {
        {
            ...
            if _dddType != nil {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp22173 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp22173.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp22173.Val1
        ...
        var err LnsAny
        var canConv bool
        err, canConv = Ast_failCreateLuavalWith_4219_(luneType, Ast_LuavalConvKind__InLua, validToCheck)
        
        if err != nil{
            err_4694 := err.(string)
            return &Ast_LuavalResult__Err{err_4694}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp22311 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp22311.Val1
...
// 5632: decl @lune.@base.@Ast.ProcessInfo.createEnum
...
// 5699: decl @lune.@base.@Ast.ProcessInfo.createAlge
...
// 1025: decl @lune.@base.@Ast.TypeNameCtrl.getModuleName
...
// 1040: decl @lune.@base.@Ast.TypeNameCtrl.getParentFullName
...
// 968: decl @lune.@base.@Ast.SymbolInfo.getModule
...
// 1122: decl @lune.@base.@Ast.Scope.getNamespaceTypeInfo
...
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection4889 := self.symbol2SymbolInfoMap
                __sorted4889 := __collection4889.CreateKeyListStr()
                __sorted4889.Sort( LnsItemKindStr, nil )
                for _, ___key4889 := range( __sorted4889.Items ) {
                    symbolInfo := __collection4889.Items[ ___key4889 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1636: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1666: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1693: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1715: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1736: decl @lune.@base.@Ast.Scope.getSymbolInfo
...
// 1797: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1814: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
...
// 1857: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
...
// 1879: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool)(LnsAny, LnsAny) {
    if _switch5936 := kind; _switch5936 == Ast_SymbolKind__Typ || _switch5936 == Ast_SymbolKind__Fun || _switch5936 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch5902 := typeInfo.FP.Get_kind(); _switch5902 == Ast_TypeInfoKind__Enum {
        ...
        } else if _switch5902 == Ast_TypeInfoKind__Class || _switch5902 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1851 := existSymbol.(*Ast_SymbolInfo)
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() != existSymbol_1851.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1851.FP.Get_typeInfo().FP.Get_typeId()))) ).(bool){
                return nil, existSymbol_1851
            }
        }
    }
...
// 1921: decl @lune.@base.@Ast.Scope.addLocalVar
func (self *Ast_Scope) AddLocalVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, name != "_", name, pos, typeInfo, Ast_AccessMode__Local, false, mutable, true)
}

// 1934: decl @lune.@base.@Ast.Scope.addUnwrapedVar
func (self *Ast_Scope) AddUnwrapedVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( argFlag) &&
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Arg) ||
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, true, name, pos, typeInfo, Ast_AccessMode__Local, false, mutable, true)
}

// 1945: decl @lune.@base.@Ast.Scope.addStaticVar
func (self *Ast_Scope) AddStaticVar(processInfo *Ast_ProcessInfo,argFlag bool,canBeLeft bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,mutable LnsInt)(LnsAny, LnsAny) {
    return self.FP.Add(processInfo, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( argFlag) &&
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Arg) ||
        Lns_GetEnv().SetStackVal( Ast_SymbolKind__Var) ).(LnsInt), canBeLeft, true, name, pos, typeInfo, Ast_AccessMode__Local, true, mutable, true)
}

// 1955: decl @lune.@base.@Ast.Scope.addVar
...
// 1969: decl @lune.@base.@Ast.Scope.addEnumVal
...
// 1979: decl @lune.@base.@Ast.Scope.addEnum
...
// 2009: decl @lune.@base.@Ast.Scope.addAlternate
...
// 2018: decl @lune.@base.@Ast.Scope.addMember
...
// 2028: decl @lune.@base.@Ast.Scope.addMethod
...
// 2038: decl @lune.@base.@Ast.Scope.addFunc
...
// 2049: decl @lune.@base.@Ast.Scope.addForm
...
// 2058: decl @lune.@base.@Ast.Scope.addMacro
...
// 2069: decl @lune.@base.@Ast.Scope.addClass
...
// 2114: decl @lune.@base.@Ast.Scope.setClosure
...
// 2143: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch7257 := symbol.FP.Get_kind(); _switch7257 == Ast_SymbolKind__Var || _switch7257 == Ast_SymbolKind__Arg || _switch7257 == Ast_SymbolKind__Fun {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2183: decl @lune.@base.@Ast.Scope.accessSymbol
...
// 2308: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if _owner != nil {
                ...
                if _switch7642 := owner.FP.Get_kind(); _switch7642 == Ast_TypeInfoKind__Class || _switch7642 == Ast_TypeInfoKind__IF || _switch7642 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4113: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4262: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4679: decl @lune.@base.@Ast.Scope.addAlias
...
// 4692: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch18662 := typeInfo.FP.Get_kind(); _switch18662 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch18662 == Ast_TypeInfoKind__Form || _switch18662 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch18662 == Ast_TypeInfoKind__Macro {
...
// 813: decl @lune.@base.@Ast.TypeInfo.hasRouteNamespaceFrom
...
// 826: decl @lune.@base.@Ast.TypeInfo.getModule
...
// 902: decl @lune.@base.@Ast.TypeInfo.applyGeneric
func (self *Ast_TypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    return self
}

// 908: decl @lune.@base.@Ast.TypeInfo.get_genSrcTypeInfo
func (self *Ast_TypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self
}

// 912: decl @lune.@base.@Ast.TypeInfo.serializeTypeInfoList
...
// 927: decl @lune.@base.@Ast.TypeInfo.createScope
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_1059 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_1059.scope).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_1062 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_1062.Items ) {
...
// 2203: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 5034: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp20376 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp20376.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp20376.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch20566 := type1.FP.Get_kind(); _switch20566 == Ast_TypeInfoKind__List {
        ...
        } else if _switch20566 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch20566 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch20566 == Ast_TypeInfoKind__Map {
...
// 5179: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp20738 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp20738.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp20738.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 5955: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from24257 LnsInt = index
            var _to24257 LnsInt = dstTypeList.Len()
            for _work24257 := _from24257; _work24257 <= _to24257; _work24257++ {
                dstIndex := _work24257
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from24513 LnsInt = index
            var _to24513 LnsInt = expTypeList.Len()
            for _work24513 := _from24513; _work24513 <= _to24513; _work24513++ {
                srcIndex := _work24513
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4986 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4986 <= srcIndex{
                        var workMess string
    ...
    if expTypeList.Len() > 0{
        for _index, _expType := range( expTypeList.Items ) {
            ...
            if dstTypeList.Len() == index{
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_5009 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_5009 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_5023 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_5023 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_5030 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_5030 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_5040 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_5040
    }
    return Ast_MatchType__Match, ""
}

// 6160: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch25832 := canEvalType; _switch25832 == Ast_CanEvalType__SetEq || _switch25832 == Ast_CanEvalType__SetOp || _switch25832 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch25641 := otherSrc; _switch25641 == Ast_builtinTypeAbbr || _switch25641 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            if _switch25728 := nonNilOtherType.FP.Get_kind(); _switch25728 == Ast_TypeInfoKind__Set || _switch25728 == Ast_TypeInfoKind__Map || _switch25728 == Ast_TypeInfoKind__List || _switch25728 == Ast_TypeInfoKind__IF {
                return false, nil
            } else if _switch25728 == Ast_TypeInfoKind__Class {
                if Ast_builtinTypeString != nonNilOtherType{
                    return false, nil
                }
            } else if _switch25728 == Ast_TypeInfoKind__Prim {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return Ast_isSettableToForm_5167_(processInfo, otherSrc), nil
    }
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( otherSrc == Ast_builtinTypeNil) ||
    ...
    }
    {
        ...
        if _extTypeInfo != nil {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4219_(extTypeInfo.FP.Get_extedType(), Ast_LuavalConvKind__ToLua, false)))) ).(bool)){
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if _switch26488 := otherSrc.FP.Get_kind(); _switch26488 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch26488 == Ast_TypeInfoKind__FormFunc || _switch26488 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_5167_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch26693 := otherSrc.FP.Get_kind(); _switch26693 == Ast_TypeInfoKind__FormFunc || _switch26693 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
    ...
    if _switch27664 := dest.FP.Get_kind(); _switch27664 == Ast_TypeInfoKind__Prim {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch27664 == Ast_TypeInfoKind__List || _switch27664 == Ast_TypeInfoKind__Array || _switch27664 == Ast_TypeInfoKind__Set {
        ...
        return true, nil
    } else if _switch27664 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch27664 == Ast_TypeInfoKind__Class || _switch27664 == Ast_TypeInfoKind__IF {
        ...
        return false, nil
    } else if _switch27664 == Ast_TypeInfoKind__Form {
        return Ast_isSettableToForm_5167_(processInfo, otherSrc), nil
    } else if _switch27664 == Ast_TypeInfoKind__Func || _switch27664 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch27664 == Ast_TypeInfoKind__Method {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return true, nil
    } else if _switch27664 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch27664 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch27664 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, nil
    }
...
// 6654: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 1096: decl @lune.@base.@Ast.RootTypeInfo.get_baseTypeInfo
func (self *Ast_RootTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1100: decl @lune.@base.@Ast.RootTypeInfo.get_parentInfo
func (self *Ast_RootTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1104: decl @lune.@base.@Ast.RootTypeInfo.create
func Ast_RootTypeInfo_create_1955_() *Ast_RootTypeInfo {
...
// 1181: decl @lune.@base.@Ast.NormalSymbolInfo.get_mutable
func (self *Ast_NormalSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.mutMode)
}

// 1189: decl @lune.@base.@Ast.NormalSymbolInfo.getOrg
...
// 2330: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch7803 := self.FP.Get_accessMode(); _switch7803 == Ast_AccessMode__Pub || _switch7803 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch7803 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch7803 == Ast_AccessMode__Local {
        return &self.Ast_SymbolInfo
    } else if _switch7803 == Ast_AccessMode__Pri {
...
// 4307: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 1259: decl @lune.@base.@Ast.AutoBoxingInfo.___init
func Ast_AutoBoxingInfo____init_2076_() {
...
// 1276: decl @lune.@base.@Ast.AutoBoxingInfo.get_baseTypeInfo
func (self *Ast_AutoBoxingInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1280: decl @lune.@base.@Ast.AutoBoxingInfo.get_parentInfo
func (self *Ast_AutoBoxingInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1284: decl @lune.@base.@Ast.AutoBoxingInfo.get_kind
func (self *Ast_AutoBoxingInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Etc
}

// 1288: decl @lune.@base.@Ast.AutoBoxingInfo.inc
...
// 1293: decl @lune.@base.@Ast.AutoBoxingInfo.unregist
...
// 1298: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.___init
func Ast_CanEvalCtrlTypeInfo____init_2112_() {
...
// 1312: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_kind
func (self *Ast_CanEvalCtrlTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__CanEvalCtrl
}

// 1316: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_typeId
func (self *Ast_CanEvalCtrlTypeInfo) Get_typeId() LnsInt {
    return -1
}

// 1321: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_baseTypeInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1325: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_parentInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1329: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.createDefaultAlt2typeMap
...
// 1338: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.isValidApply
...
// 1342: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.setupNeedAutoBoxing
...
// 1348: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.updateNeedAutoBoxing
...
// 1359: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.hasNeedAutoBoxing
...
// 1369: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.finishNeedAutoBoxing
...
// 1386: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.canAutoBoxing
...
// 1432: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng_with
...
// 1450: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 1461: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_1487 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_1487.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 5782: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
// 1502: decl @lune.@base.@Ast.AliasTypeInfo.getParentFullName
...
// 1509: decl @lune.@base.@Ast.AliasTypeInfo.getFullName
...
// 1517: decl @lune.@base.@Ast.AliasTypeInfo.get_aliasSrc
func (self *Ast_AliasTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo
}

// 1521: decl @lune.@base.@Ast.AliasTypeInfo.get_nonnilableType
func (self *Ast_AliasTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1525: decl @lune.@base.@Ast.AliasTypeInfo.get_srcTypeInfo
func (self *Ast_AliasTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1528: decl @lune.@base.@Ast.AliasTypeInfo.get_genSrcTypeInfo
func (self *Ast_AliasTypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1532: decl @lune.@base.@Ast.AliasTypeInfo.getModule
func (self *Ast_AliasTypeInfo) GetModule() *Ast_TypeInfo {
    return self.FP.Get_parentInfo().FP.GetModule()
}

// 1537: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1543: decl @lune.@base.@Ast.AliasTypeInfo.serialize
...
// 1570: decl @lune.@base.@Ast.AliasTypeInfo.canEvalWith
...
// 1578: decl @lune.@base.@Ast.AliasTypeInfo.equals
...
// 2247: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp7991 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp7991.Val1
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if typeInfo != nil{
                typeInfo_2217 := typeInfo.(*Ast_TypeInfo)
                work = typeInfo_2217
...
// 2428: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2432: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2441: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2445: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp8119 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp8119.Val1
        if _switch8112 := self.symbolInfo.FP.Get_mutMode(); _switch8112 == Ast_MutMode__AllMut || _switch8112 == Ast_MutMode__IMut || _switch8112 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch8112 == Ast_MutMode__Mut {
            if _switch8110 := prefixTypeInfo.FP.Get_mutMode(); _switch8110 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch8110 == Ast_MutMode__Mut || _switch8110 == Ast_MutMode__IMut || _switch8110 == Ast_MutMode__IMutRe {
...
// 2474: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2478: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
// 2576: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2362 := alt2type.(*LnsMap)
        var otherWork *Ast_TypeInfo
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2362)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2362.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2362)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2362)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2362
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2381 := workAlt2type.(*LnsMap)
            workAlt2type_2381.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2627: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2653: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2405 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2405.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2405)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2663: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2669: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2428 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2428)
    }
    return false
}

// 2697: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2702: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2706: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2710: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2714: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2719: decl @lune.@base.@Ast.AlternateTypeInfo.getParentFullName
...
// 2726: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2738: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4266: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if _genType != nil {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_3741 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_3741, alt2type)).(bool)
            }
...
// 4413: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 2808: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 2812: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 2817: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 2824: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 2835: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4483: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3860 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3860)
    }
    return nil
}

// 5746: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch23321 := canEvalType; _switch23321 == Ast_CanEvalType__SetOp || _switch23321 == Ast_CanEvalType__SetOpIMut || _switch23321 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 2862: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 2905: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 2910: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 2950: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2954: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2957: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2962: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 3023: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 3056: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 3070: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5260: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_4589_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4405 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4405, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
// 3116: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3124: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3128: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
...
// 3135: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch10920 := canEvalType; _switch10920 == Ast_CanEvalType__SetEq || _switch10920 == Ast_CanEvalType__SetOp {
...
// 3165: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4652: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4660: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6570: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5224 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5224, Ast_MutMode__IMut)
    }
    return nil
}
...
// 3265: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
// 3408: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3413: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Items[name]
}

// 3417: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5669: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    {
        __collection23016 := self.name2EnumValInfo
        __sorted23016 := __collection23016.CreateKeyListStr()
        __sorted23016.Sort( LnsItemKindStr, nil )
        for _, ___key23016 := range( __sorted23016.Items ) {
            enumValInfo := __collection23016.Items[ ___key23016 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp23014 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp23014.Val1
...
// 3443: decl @lune.@base.@Ast.AlgeTypeInfo.get_baseTypeInfo
...
// 3516: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3538: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 5721: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    firstFlag = true
    {
        __collection23257 := self.valInfoMap
        __sorted23257 := __collection23257.CreateKeyListStr()
        __sorted23257.Sort( LnsItemKindStr, nil )
        for _, ___key23257 := range( __sorted23257.Items ) {
            algeValInfo := __collection23257.Items[ ___key23257 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3526: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3621: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,typeId LnsInt,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3640:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch13023 := kind; _switch13023 == Ast_TypeInfoKind__Set || _switch13023 == Ast_TypeInfoKind__Map || _switch13023 == Ast_TypeInfoKind__List || _switch13023 == Ast_TypeInfoKind__Array || _switch13023 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch13023 == Ast_TypeInfoKind__Class || _switch13023 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        if parentInfo != nil{
            parentInfo_3379 := parentInfo.(*Ast_TypeInfo)
            parentInfo_3379.FP.AddChildren(&self.Ast_TypeInfo)
        }
        var hasNilable bool
        hasNilable = false
        if _switch13125 := (kind); _switch13125 == Ast_TypeInfoKind__Prim || _switch13125 == Ast_TypeInfoKind__List || _switch13125 == Ast_TypeInfoKind__Array || _switch13125 == Ast_TypeInfoKind__Set || _switch13125 == Ast_TypeInfoKind__Map || _switch13125 == Ast_TypeInfoKind__Class || _switch13125 == Ast_TypeInfoKind__Stem || _switch13125 == Ast_TypeInfoKind__Module || _switch13125 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch13125 == Ast_TypeInfoKind__Func || _switch13125 == Ast_TypeInfoKind__Method || _switch13125 == Ast_TypeInfoKind__Form || _switch13125 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3729: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3739: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3743: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3747: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() LnsInt {
    return self.parentInfo.FP.Get_typeId()
}

// 3751: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() LnsInt {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3756: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 3762: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
func (self *Ast_NormalTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    parentTxt = ""
    if typeNameCtrl != nil{
        typeNameCtrl_3434 := typeNameCtrl.(*Ast_TypeNameCtrl)
        parentTxt = self.FP.GetParentFullName(typeNameCtrl_3434, importInfo, localFlag)
...
// 3790: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch13562 := self.kind; _switch13562 == Ast_TypeInfoKind__Func || _switch13562 == Ast_TypeInfoKind__Form || _switch13562 == Ast_TypeInfoKind__FormFunc || _switch13562 == Ast_TypeInfoKind__Method || _switch13562 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 3835: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3840: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 3871: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch14036 := self.kind; _switch14036 == Ast_TypeInfoKind__List || _switch14036 == Ast_TypeInfoKind__Map || _switch14036 == Ast_TypeInfoKind__Array || _switch14036 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 3941: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 3949: decl @lune.@base.@Ast.NormalTypeInfo.create
...
// 4167: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch15449 := kind; _switch15449 == Ast_TypeInfoKind__Array || _switch15449 == Ast_TypeInfoKind__List || _switch15449 == Ast_TypeInfoKind__Set || _switch15449 == Ast_TypeInfoKind__Class || _switch15449 == Ast_TypeInfoKind__Module || _switch15449 == Ast_TypeInfoKind__IF || _switch15449 == Ast_TypeInfoKind__Form || _switch15449 == Ast_TypeInfoKind__FormFunc || _switch15449 == Ast_TypeInfoKind__Func || _switch15449 == Ast_TypeInfoKind__Method || _switch15449 == Ast_TypeInfoKind__Macro {
    ...
    if _switch15547 := kind; _switch15547 == Ast_TypeInfoKind__Array || _switch15547 == Ast_TypeInfoKind__List || _switch15547 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch15547 == Ast_TypeInfoKind__Map {
    ...
    Ast_registBuiltin_4151_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 5848: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch23916 := typeInfo.FP.Get_kind(); _switch23916 == Ast_TypeInfoKind__Prim || _switch23916 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch23916 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch23916 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch23916 == Ast_TypeInfoKind__Class || _switch23916 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch23916 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch23916 == Ast_TypeInfoKind__List || _switch23916 == Ast_TypeInfoKind__Array || _switch23916 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch23916 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch23916 == Ast_TypeInfoKind__Nilable {
...
// 5922: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 6560: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6584: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_4589_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch28113 := self.FP.Get_kind(); _switch28113 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch28113 == Ast_TypeInfoKind__Func || _switch28113 == Ast_TypeInfoKind__Form || _switch28113 == Ast_TypeInfoKind__FormFunc {
        var argTypeInfoList *LnsList
        var workArg bool
        
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_4589_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_4589_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
...
// 4002: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 4725: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 4729: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
func (self *Ast_DDDTypeInfo) Get_scope() LnsAny {
    return nil
}

// 4734: decl @lune.@base.@Ast.DDDTypeInfo.get_baseTypeInfo
func (self *Ast_DDDTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 4738: decl @lune.@base.@Ast.DDDTypeInfo.get_parentInfo
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeId LnsInt,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_4085 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_4085
...
// 4762: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 4766: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 4773: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 4780: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 4786: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5202: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 4917: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 4929: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 4948: decl @lune.@base.@Ast.CombineType.createStem
...
// 4962: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5294: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
func (self *Ast_AbbrTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5299: decl @lune.@base.@Ast.AbbrTypeInfo.get_baseTypeInfo
func (self *Ast_AbbrTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5303: decl @lune.@base.@Ast.AbbrTypeInfo.get_parentInfo
...
// 5417: decl @lune.@base.@Ast.ExtTypeInfo.equals
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4219_(self.extedType, Ast_LuavalConvKind__InLua, false))){
        return false
    }
    return self.extedType.FP.Equals(processInfo, typeInfo, alt2type, checkModifer)
}

// 5433: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp21793(Lns_2DDD(Ast_failCreateLuavalWith_4219_(other, Ast_LuavalConvKind__ToLua, true)))
        if __exp != nil {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5457: decl @lune.@base.@Ast.ExtTypeInfo.serialize
...
// 6735: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 6746: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 6757: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 6797: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Types_Position)(LnsAny, LnsAny, LnsAny) {
    ...
    for  {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp29064(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5391 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5391))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5391.FP.Get_typeInfo()))
                }
            ...
            if _switch29691 := typeInfo.FP.Get_kind(); _switch29691 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch29691 == Ast_TypeInfoKind__List {
            ...
            } else if _switch29691 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29691 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29691 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29691 == Ast_TypeInfoKind__Class || _switch29691 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch29691 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29691 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp29669 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp29669.Val1
...
func Lns_Ast_init() {
    ...
    _ = NewLnsList([]LnsAny{})
    Ast_headTypeInfo = &Ast_RootTypeInfo_create_1955_().Ast_TypeInfo
    Ast_defaultTypeNameCtrl = NewAst_TypeNameCtrl(Ast_headTypeInfo)
    Ast_AutoBoxingInfo____init_2076_()
    Ast_CanEvalCtrlTypeInfo____init_2112_()
    ...
    Ast_registBuiltin_4151_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_4151_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_4151_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    ...
    switch _exp22349 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp22349.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_4151_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_4151_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
