...
func Ast_LuavalConvKind_get__allList_3275_() *LnsList{
...
func Ast_LuavalConvKind__from_3270_(arg1 LnsInt) LnsAny{
...
// for 5720
func Ast_convExp22872(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7146
func Ast_convExp30307(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp31280(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp31438(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp31604(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp31775(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp31941(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp32149(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp32326(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7282
func Ast_convExp32484(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 7321
func Ast_convExp32639(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
func ProcessInfo_switchIdProvier___anonymous_1080_() string {
    return "start"
}
// 196: decl @lune.@base.@Ast.getRootProcessInfo
func Ast_getRootProcessInfo() *Ast_ProcessInfo {
    return Ast_rootProcessInfo
}

// 307: decl @lune.@base.@Ast.getSym2builtInTypeMap
func Ast_getSym2builtInTypeMap() *LnsMap {
    return Ast_sym2builtInTypeMap
}

// 311: decl @lune.@base.@Ast.getBuiltInTypeIdMap
func Ast_getBuiltInTypeIdMap() *LnsMap {
    return Ast_builtInTypeIdSet
}

// 331: decl @lune.@base.@Ast.isBuiltin
func Ast_isBuiltin(typeId LnsInt) bool {
    return Ast_TypeInfo2Stem(Ast_builtInTypeIdSet.Get(typeId)) != nil
}

// 336: decl @lune.@base.@Ast.isPubToExternal
func Ast_isPubToExternal(mode LnsInt) bool {
    if _switch835 := mode; _switch835 == Ast_AccessMode__Pub || _switch835 == Ast_AccessMode__Pro || _switch835 == Ast_AccessMode__Global {
        return true
    }
    return false
}

// 352: decl @lune.@base.@Ast.txt2AccessMode
func Ast_txt2AccessMode(accessMode string) LnsAny {
    return Ast_txt2AccessModeMap.Get(accessMode)
}

// 363: decl @lune.@base.@Ast.accessMode2txt
func Ast_accessMode2txt(accessMode LnsInt) string {
    return Lns_unwrap( Ast_accessMode2txtMap.Get(accessMode)).(string)
}

// 377: decl @lune.@base.@Ast.isMutable
func Ast_isMutable(mode LnsInt) bool {
    if _switch1048 := mode; _switch1048 == Ast_MutMode__AllMut || _switch1048 == Ast_MutMode__Mut {
        return true
    }
    return false
}

// 1041: decl @lune.@base.@Ast.applyGenericDefault
...
// 1069: decl @lune.@base.@Ast.getAllNameForKind
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection3063 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted3063 := __collection3063.CreateKeyListStr()
            __sorted3063.Sort( LnsItemKindStr, nil )
            for _, ___key3063 := range( __sorted3063.Items ) {
                symbolInfo := __collection3063.Items[ ___key3063 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch3061 := symbolInfo.FP.Get_kind(); _switch3061 == symbolKind {
...
// 1103: decl @lune.@base.@Ast.getAllMethodName
...
// 2288: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2174_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if !Lns_IsNil( __exp ) {
            ...
            {
                __collection7870 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted7870 := __collection7870.CreateKeyListStr()
                __sorted7870.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted7870.Items ) {
                    symbolInfo := __collection7870.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if !Lns_IsNil( _subScope ) {
                            ...
                            dumpScope__dumpScopeSub_2174_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
// 2283: decl @lune.@base.@Ast.dumpScope
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2174_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3292: decl @lune.@base.@Ast.isGenericType
...
// 3523: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp12421 := obj.(type) {
...
// 4276: decl @lune.@base.@Ast.isExtType
...
// 4283: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch15777 := typeInfo.FP.Get_kind(); _switch15777 == Ast_TypeInfoKind__FormFunc || _switch15777 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4380: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId().Id,typeInfo)
}

// 4386: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_3230_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
...
// 4502: decl @lune.@base.@Ast.isClass
...
// 4573: decl @lune.@base.@Ast.failCreateLuavalWith
func Ast_failCreateLuavalWith_3277_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch17678 := typeInfo.FP.Get_kind(); _switch17678 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_3277_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch17678 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch17678 == Ast_TypeInfoKind__Form || _switch17678 == Ast_TypeInfoKind__IF || _switch17678 == Ast_TypeInfoKind__DDD || _switch17678 == Ast_TypeInfoKind__ExtModule {
        ...
        return nil, false
    } else if _switch17678 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch17678 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch17678 == Ast_TypeInfoKind__Array || _switch17678 == Ast_TypeInfoKind__List || _switch17678 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_3277_(itemType, convFlag, validToCheck)
            if err != nil{
                err_3634 := err.(string)
                return err_3634, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch17678 == Ast_TypeInfoKind__FormFunc || _switch17678 == Ast_TypeInfoKind__Func {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
...
// 4684: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch17832 := typeInfo.FP.Get_kind(); _switch17832 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 4706: decl @lune.@base.@Ast.isConditionalbe
...
// 5520: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_3532_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
// 5855: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp23538 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp23538.Val1
...
// 5899: decl @lune.@base.@Ast.isNumberType
...
// 6431: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_3916_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 6964: decl @lune.@base.@Ast.createProcessInfo
...
// 200: decl @lune.@base.@Ast.ProcessInfo.newIdForRoot
...
// 4225: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 4296: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch15857 := mutMode; _switch15857 == Ast_MutMode__IMut || _switch15857 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch15857 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp15919 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp15919.Val1
    ...
    if _switch15980 := mutMode; _switch15980 == Ast_MutMode__IMut || _switch15980 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch15980 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4715: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4759: decl @lune.@base.@Ast.ProcessInfo.createSet
...
// 4772: decl @lune.@base.@Ast.ProcessInfo.createList
...
// 4785: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 4798: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4813: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4833: decl @lune.@base.@Ast.ProcessInfo.createClass
...
// 4867: decl @lune.@base.@Ast.ProcessInfo.createExtModule
...
// 4895: decl @lune.@base.@Ast.ProcessInfo.createFunc
func (self *Ast_ProcessInfo) CreateFunc(abstractFlag bool,builtinFlag bool,scope LnsAny,kind LnsInt,parentInfo *Ast_TypeInfo,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,funcName string,altTypeList LnsAny,argTypeList LnsAny,retTypeInfoList LnsAny,mutable LnsAny) *Ast_NormalTypeInfo {
    ...
    if altTypeList != nil{
        altTypeList_3855 := altTypeList.(*LnsList)
        for _, _genType := range( altTypeList_3855.Items ) {
...
// 4925: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4954: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 5111: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_3277_(typeInfo, Ast_LuavalConvKind__InLua, true)))) &&
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_GetEnv().SetStackVal( extTypeFlag) ).(bool)){
        switch _exp20325 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp20325.Val1
            typeInfo = work
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_3277_(typeInfo, Ast_LuavalConvKind__InLua, true))){
...
// 5512: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5779: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    process = func() LnsAny {
        {
            ...
            if !Lns_IsNil( _dddType ) {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp23258 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp23258.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp23258.Val1
        ...
        var err LnsAny
        var canConv bool
        err, canConv = Ast_failCreateLuavalWith_3277_(luneType, Ast_LuavalConvKind__InLua, validToCheck)
        
        if err != nil{
            err_4555 := err.(string)
            return &Ast_LuavalResult__Err{err_4555}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp23391 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23391.Val1
...
// 5905: decl @lune.@base.@Ast.ProcessInfo.createEnum
...
// 5973: decl @lune.@base.@Ast.ProcessInfo.createAlge
...
// 6971: decl @lune.@base.@Ast.ProcessInfo.newUser
...
// 169: decl @lune.@base.@Ast.IdInfo.set_orgId
func (self *Ast_IdInfo) Set_orgId(id LnsInt) {
    self.orgId = id
    
}

// 173: decl @lune.@base.@Ast.IdInfo.get_orgId
...
// 182: decl @lune.@base.@Ast.IdInfo.equals
...
// 237: decl @lune.@base.@Ast.DummyModuleInfoManager.___init
func Ast_DummyModuleInfoManager____init_1147_() {
...
// 244: decl @lune.@base.@Ast.DummyModuleInfoManager.getModuleInfo
...
// 1108: decl @lune.@base.@Ast.TypeNameCtrl.getModuleName
...
// 1123: decl @lune.@base.@Ast.TypeNameCtrl.getParentFullName
...
// 460: decl @lune.@base.@Ast.SymbolInfo.hasAccess
...
// 611: decl @lune.@base.@Ast.SymbolInfo.get_namespaceTypeInfo
...
// 1051: decl @lune.@base.@Ast.SymbolInfo.getModule
...
// 558: decl @lune.@base.@Ast.Scope.isRoot
func (self *Ast_Scope) IsRoot() bool {
    return self.parent == self
}

// 562: decl @lune.@base.@Ast.Scope.set_ownerTypeInfo
...
// 567: decl @lune.@base.@Ast.Scope.switchOwnerTypeInfo
func (self *Ast_Scope) SwitchOwnerTypeInfo(owner LnsAny) {
    self.ownerTypeInfo = owner
    
}

// 572: decl @lune.@base.@Ast.Scope.getTypeInfoChild
...
// 600: decl @lune.@base.@Ast.Scope.getModuleInfo
...
// 628: decl @lune.@base.@Ast.Scope.isInnerOf
...
// 1217: decl @lune.@base.@Ast.Scope.getNamespaceTypeInfo
...
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5328 := self.symbol2SymbolInfoMap
                __sorted5328 := __collection5328.CreateKeyListStr()
                __sorted5328.Sort( LnsItemKindStr, nil )
                for _, ___key5328 := range( __sorted5328.Items ) {
                    symbolInfo := __collection5328.Items[ ___key5328 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1743: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1773: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1800: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1822: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1846: decl @lune.@base.@Ast.Scope.filterTypeInfoFieldAndIF
func (self *Ast_Scope) FilterTypeInfoFieldAndIF(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection5698 := self.symbol2SymbolInfoMap
                __sorted5698 := __collection5698.CreateKeyListStr()
                __sorted5698.Sort( LnsItemKindStr, nil )
                for _, ___key5698 := range( __sorted5698.Items ) {
                    symbolInfo := __collection5698.Items[ ___key5698 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    if Lns_isCondTrue( symbolInfo.FP.CanAccess(fromScope, access)){
                        if Lns_op_not(callback(symbolInfo)){
                            return false
                        }
...
// 1894: decl @lune.@base.@Ast.Scope.getSymbolInfo
...
// 1955: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1972: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
...
// 2015: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
...
// 2037: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool,isLazyLoad bool)(LnsAny, LnsAny) {
    ...
    ownerTypeInfo = nil
    if _switch6546 := kind; _switch6546 == Ast_SymbolKind__Typ || _switch6546 == Ast_SymbolKind__Fun || _switch6546 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch6492 := typeInfo.FP.Get_kind(); _switch6492 == Ast_TypeInfoKind__Enum {
        ...
        } else if _switch6492 == Ast_TypeInfoKind__Class || _switch6492 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1638 := existSymbol.(*Ast_SymbolInfo)
            if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                Lns_GetEnv().SetStackVal( typeInfo.FP.Get_kind() != existSymbol_1638.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1638.FP.Get_typeInfo().FP.Get_typeId().Id))) ).(bool){
                return nil, existSymbol_1638
            }
        }
    } else if _switch6546 == Ast_SymbolKind__Var {
...
// 2086: decl @lune.@base.@Ast.Scope.addSymbolInfo
...
// 2096: decl @lune.@base.@Ast.Scope.addLocalVar
...
// 2109: decl @lune.@base.@Ast.Scope.addUnwrapedVar
...
// 2120: decl @lune.@base.@Ast.Scope.addStaticVar
...
// 2130: decl @lune.@base.@Ast.Scope.addVar
...
// 2144: decl @lune.@base.@Ast.Scope.addEnumVal
...
// 2154: decl @lune.@base.@Ast.Scope.addEnum
...
// 2184: decl @lune.@base.@Ast.Scope.addAlternate
...
// 2193: decl @lune.@base.@Ast.Scope.addMember
...
// 2203: decl @lune.@base.@Ast.Scope.addMethod
...
// 2213: decl @lune.@base.@Ast.Scope.addFunc
...
// 2224: decl @lune.@base.@Ast.Scope.addForm
...
// 2234: decl @lune.@base.@Ast.Scope.addMacro
...
// 2245: decl @lune.@base.@Ast.Scope.addClassLazy
...
// 2254: decl @lune.@base.@Ast.Scope.addClass
...
// 2261: decl @lune.@base.@Ast.Scope.addExtModule
func (self *Ast_Scope) AddExtModule(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo,lazy bool,lang LnsInt)(LnsAny, LnsAny) {
    if lang != Types_Lang__Same{
        switch _exp7726 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__Err:
        mess := _exp7726.Val1
            Util_err(mess)
        case *Ast_LuavalResult__OK:
        luavalTypeInfo := _exp7726.Val1
...
// 2315: decl @lune.@base.@Ast.Scope.setClosure
...
// 2344: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch8112 := symbol.FP.Get_kind(); _switch8112 == Ast_SymbolKind__Var || _switch8112 == Ast_SymbolKind__Arg || _switch8112 == Ast_SymbolKind__Fun {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2384: decl @lune.@base.@Ast.Scope.accessSymbol
...
// 2508: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if !Lns_IsNil( _owner ) {
                ...
                if _switch8496 := owner.FP.Get_kind(); _switch8496 == Ast_TypeInfoKind__Class || _switch8496 == Ast_TypeInfoKind__IF || _switch8496 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4363: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4506: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4963: decl @lune.@base.@Ast.Scope.addAlias
...
// 4976: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch19768 := typeInfo.FP.Get_kind(); _switch19768 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch19768 == Ast_TypeInfoKind__Form || _switch19768 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch19768 == Ast_TypeInfoKind__Macro {
...
// 648: decl @lune.@base.@Ast.TypeData.addChildren
...
// 719: decl @lune.@base.@Ast.TypeInfo.getProcessInfo
func (self *Ast_TypeInfo) getProcessInfo() *Ast_ProcessInfo {
    return self.processInfo
}

// 723: decl @lune.@base.@Ast.TypeInfo.switchScope
...
// 733: decl @lune.@base.@Ast.TypeInfo.getOverridingType
...
// 822: decl @lune.@base.@Ast.TypeInfo.canEvalWith
...
// 868: decl @lune.@base.@Ast.TypeInfo.get_externalFlag
func (self *Ast_TypeInfo) Get_externalFlag() bool {
    return false
}

// 873: decl @lune.@base.@Ast.TypeInfo.get_interfaceList
func (self *Ast_TypeInfo) Get_interfaceList() *LnsList {
    return Ast_dummyList
}

// 877: decl @lune.@base.@Ast.TypeInfo.get_itemTypeInfoList
func (self *Ast_TypeInfo) Get_itemTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 881: decl @lune.@base.@Ast.TypeInfo.get_argTypeInfoList
func (self *Ast_TypeInfo) Get_argTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 885: decl @lune.@base.@Ast.TypeInfo.get_retTypeInfoList
func (self *Ast_TypeInfo) Get_retTypeInfoList() *LnsList {
    return Ast_dummyList
}


// 895: decl @lune.@base.@Ast.TypeInfo.hasRouteNamespaceFrom
...
// 908: decl @lune.@base.@Ast.TypeInfo.getModule
...
// 984: decl @lune.@base.@Ast.TypeInfo.applyGeneric
func (self *Ast_TypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    return self
}

// 990: decl @lune.@base.@Ast.TypeInfo.get_genSrcTypeInfo
func (self *Ast_TypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self
}

// 994: decl @lune.@base.@Ast.TypeInfo.serializeTypeInfoList
...
// 1010: decl @lune.@base.@Ast.TypeInfo.createScope
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_801 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_801.FP.Get_scope()).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_804 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_804.Items ) {
...
// 2404: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 5316: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp21493 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp21493.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp21493.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch21683 := type1.FP.Get_kind(); _switch21683 == Ast_TypeInfoKind__List {
        ...
        } else if _switch21683 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch21683 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch21683 == Ast_TypeInfoKind__Map {
...
// 5461: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp21857 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp21857.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp21857.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 6227: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from25381 LnsInt = index
            var _to25381 LnsInt = dstTypeList.Len()
            for _work25381 := _from25381; _work25381 <= _to25381; _work25381++ {
                dstIndex := _work25381
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from25668 LnsInt = index
            var _to25668 LnsInt = expTypeList.Len()
            for _work25668 := _from25668; _work25668 <= _to25668; _work25668++ {
                srcIndex := _work25668
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4854 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4854 <= srcIndex{
                        var workMess string
    ...
    if expTypeList.Len() > 0{
        for _index, _expType := range( expTypeList.Items ) {
            ...
            if dstTypeList.Len() == index{
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4877 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4877 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4891 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4891 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_4910 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_4910
    }
    return Ast_MatchType__Match, ""
}

// 6451: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch27041 := canEvalType; _switch27041 == Ast_CanEvalType__SetEq || _switch27041 == Ast_CanEvalType__SetOp || _switch27041 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch26838 := otherSrc; _switch26838 == Ast_builtinTypeAbbr || _switch26838 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            if processInfo.FP.Get_validCheckingMutable(){
                ...
                if _switch26930 := nonNilOtherType.FP.Get_kind(); _switch26930 == Ast_TypeInfoKind__Set || _switch26930 == Ast_TypeInfoKind__Map || _switch26930 == Ast_TypeInfoKind__List || _switch26930 == Ast_TypeInfoKind__IF || _switch26930 == Ast_TypeInfoKind__Alternate {
                    return false, nil
                } else if _switch26930 == Ast_TypeInfoKind__Class {
                    if Ast_builtinTypeString != nonNilOtherType{
                        return false, nil
                    }
                } else if _switch26930 == Ast_TypeInfoKind__Prim {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return Ast_isSettableToForm_3916_(processInfo, otherSrc), nil
    }
    if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( otherSrc == Ast_builtinTypeNil) ||
    ...
    }
    {
        ...
        if !Lns_IsNil( _extTypeInfo ) {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                Lns_GetEnv().SetStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_3277_(extTypeInfo.FP.Get_extedType(), Ast_LuavalConvKind__ToLua, false)))) ).(bool)){
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if _switch27699 := otherSrc.FP.Get_kind(); _switch27699 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch27699 == Ast_TypeInfoKind__FormFunc || _switch27699 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_3916_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch27904 := otherSrc.FP.Get_kind(); _switch27904 == Ast_TypeInfoKind__FormFunc || _switch27904 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
    ...
    if _switch28877 := dest.FP.Get_kind(); _switch28877 == Ast_TypeInfoKind__Prim {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch28877 == Ast_TypeInfoKind__List || _switch28877 == Ast_TypeInfoKind__Array || _switch28877 == Ast_TypeInfoKind__Set {
        ...
        return true, nil
    } else if _switch28877 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return false, nil
    } else if _switch28877 == Ast_TypeInfoKind__Class || _switch28877 == Ast_TypeInfoKind__IF {
        ...
        return false, nil
    } else if _switch28877 == Ast_TypeInfoKind__Form {
        return Ast_isSettableToForm_3916_(processInfo, otherSrc), nil
    } else if _switch28877 == Ast_TypeInfoKind__Func || _switch28877 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch28877 == Ast_TypeInfoKind__Method {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        return true, nil
    } else if _switch28877 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch28877 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch28877 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, nil
    }
...
// 6949: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 1180: decl @lune.@base.@Ast.RootTypeInfo.get_baseTypeInfo
func (self *Ast_RootTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1184: decl @lune.@base.@Ast.RootTypeInfo.get_parentInfo
func (self *Ast_RootTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1188: decl @lune.@base.@Ast.RootTypeInfo.create
func Ast_RootTypeInfo_create_1724_() *Ast_RootTypeInfo {
    return NewAst_RootTypeInfo()
}

// 1192: decl @lune.@base.@Ast.RootTypeInfo.get_rawTxt
func (self *Ast_RootTypeInfo) Get_rawTxt() string {
    return "<head>"
}

// 1196: decl @lune.@base.@Ast.RootTypeInfo.getTxt
...
// 1278: decl @lune.@base.@Ast.NormalSymbolInfo.get_mutable
func (self *Ast_NormalSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.mutMode)
}

// 1286: decl @lune.@base.@Ast.NormalSymbolInfo.getOrg
...
// 2530: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch8682 := self.FP.Get_accessMode(); _switch8682 == Ast_AccessMode__Pub || _switch8682 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch8682 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch8682 == Ast_AccessMode__Local {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            Lns_GetEnv().SetStackVal( Ast_isBuiltin(self.FP.Get_typeInfo().FP.Get_typeId().Id)) ||
            Lns_GetEnv().SetStackVal( self.FP.GetModule() == fromScope.FP.GetModule()) ).(bool){
            return &self.Ast_SymbolInfo
        }
        return nil
    } else if _switch8682 == Ast_AccessMode__Pri {
...
// 4551: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 1357: decl @lune.@base.@Ast.AutoBoxingInfo.___init
func Ast_AutoBoxingInfo____init_1812_() {
...
// 1374: decl @lune.@base.@Ast.AutoBoxingInfo.get_baseTypeInfo
func (self *Ast_AutoBoxingInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1378: decl @lune.@base.@Ast.AutoBoxingInfo.get_parentInfo
func (self *Ast_AutoBoxingInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1382: decl @lune.@base.@Ast.AutoBoxingInfo.get_kind
func (self *Ast_AutoBoxingInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Etc
}

// 1386: decl @lune.@base.@Ast.AutoBoxingInfo.inc
...
// 1391: decl @lune.@base.@Ast.AutoBoxingInfo.unregist
...
// 1397: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.___init
func Ast_CanEvalCtrlTypeInfo____init_1834_() {
...
// 1411: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_kind
func (self *Ast_CanEvalCtrlTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__CanEvalCtrl
}

// 1415: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_typeId
func (self *Ast_CanEvalCtrlTypeInfo) Get_typeId() *Ast_IdInfo {
    return Ast_dummyIdInfo
}

// 1421: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_baseTypeInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1425: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_parentInfo
func (self *Ast_CanEvalCtrlTypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 1429: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.createDefaultAlt2typeMap
...
// 1438: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.isValidApply
...
// 1442: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.setupNeedAutoBoxing
...
// 1448: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.updateNeedAutoBoxing
...
// 1459: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.hasNeedAutoBoxing
...
// 1469: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.finishNeedAutoBoxing
...
// 1486: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.canAutoBoxing
...
// 1538: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng_with
...
// 1556: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 1567: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_1252 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_1252.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 6054: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
// 1607: decl @lune.@base.@Ast.AliasTypeInfo.getParentFullName
...
// 1614: decl @lune.@base.@Ast.AliasTypeInfo.getFullName
...
// 1622: decl @lune.@base.@Ast.AliasTypeInfo.get_aliasSrc
func (self *Ast_AliasTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return self.aliasSrcTypeInfo
}

// 1626: decl @lune.@base.@Ast.AliasTypeInfo.get_nonnilableType
func (self *Ast_AliasTypeInfo) Get_nonnilableType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1630: decl @lune.@base.@Ast.AliasTypeInfo.get_srcTypeInfo
func (self *Ast_AliasTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1633: decl @lune.@base.@Ast.AliasTypeInfo.get_genSrcTypeInfo
func (self *Ast_AliasTypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 1637: decl @lune.@base.@Ast.AliasTypeInfo.getModule
func (self *Ast_AliasTypeInfo) GetModule() *Ast_TypeInfo {
    return self.FP.Get_parentInfo().FP.GetModule()
}

// 1642: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1648: decl @lune.@base.@Ast.AliasTypeInfo.serialize
...
// 1677: decl @lune.@base.@Ast.AliasTypeInfo.canEvalWith
...
// 1685: decl @lune.@base.@Ast.AliasTypeInfo.equals
...
// 2447: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp8873 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp8873.Val1
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            if typeInfo != nil{
                typeInfo_2039 := typeInfo.(*Ast_TypeInfo)
                work = typeInfo_2039
...
// 2633: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2637: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2646: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2650: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp9004 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp9004.Val1
        if _switch8995 := self.symbolInfo.FP.Get_mutMode(); _switch8995 == Ast_MutMode__AllMut || _switch8995 == Ast_MutMode__IMut || _switch8995 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch8995 == Ast_MutMode__Mut {
            if _switch8993 := prefixTypeInfo.FP.Get_mutMode(); _switch8993 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch8993 == Ast_MutMode__Mut || _switch8993 == Ast_MutMode__IMut || _switch8993 == Ast_MutMode__IMutRe {
...
// 2679: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2683: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
// 2785: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2197 := alt2type.(*LnsMap)
        var otherWork *Ast_TypeInfo
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2197)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2197.Get(&self.Ast_TypeInfo)
            if !Lns_IsNil( _genType ) {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2197)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2197)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2197
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2216 := workAlt2type.(*LnsMap)
            workAlt2type_2216.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2836: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2862: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2240 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2240.Get(&self.Ast_TypeInfo)
            if !Lns_IsNil( _genType ) {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2240)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2872: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2878: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2263 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2263)
    }
    return false
}

// 2906: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2911: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2915: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2919: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2923: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2935: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2950: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4510: decl @lune.@base.@Ast.AlternateTypeInfo.canSetFrom
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if !Lns_IsNil( _genType ) {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_3582 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_3582, alt2type)).(bool)
            }
...
// 4659: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 3018: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3022: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 3027: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 3034: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 3045: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4727: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3701 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3701)
    }
    return nil
}

// 6018: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch24404 := canEvalType; _switch24404 == Ast_CanEvalType__SetOp || _switch24404 == Ast_CanEvalType__SetOpIMut || _switch24404 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 3072: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 3114: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 3119: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 3159: decl @lune.@base.@Ast.GenericTypeInfo.get_aliasSrc
func (self *Ast_GenericTypeInfo) Get_aliasSrc() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3163: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3166: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 3171: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 3232: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 3265: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 3280: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5541: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_3532_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4268 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4268, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
func (self *Ast_ModifierTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    if _switch11661 := self.mutMode; _switch11661 == Ast_MutMode__IMut || _switch11661 == Ast_MutMode__IMutRe {
        txt = "&" + txt
        
    } else if _switch11661 == Ast_MutMode__AllMut {
        txt = "allmut " + txt
...
// 3338: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3346: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3350: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
...
// 3358: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch11830 := canEvalType; _switch11830 == Ast_CanEvalType__SetEq || _switch11830 == Ast_CanEvalType__SetOp {
...
// 3388: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4936: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4944: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6865: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5096 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5096, Ast_MutMode__IMut)
    }
    return nil
}
...
func (self *Ast_ModuleTypeInfo) InitAst_ModuleTypeInfo(processInfo *Ast_ProcessInfo,scope *Ast_Scope,externalFlag bool,txt string,parentInfo LnsAny,mutable bool) {
    ...
    var fullName string
    if parentInfo != nil{
        parentInfo_2790 := parentInfo.(*Ast_TypeInfo)
        parentInfo_2790.FP.AddChildren(&self.Ast_TypeInfo)
        var parentFull string
        parentFull = parentInfo_2790.FP.GetParentFullName(Ast_defaultTypeNameCtrl, nil, nil)
...
// 3447: decl @lune.@base.@Ast.ModuleTypeInfo.equals
...
// 3506: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
// 3640: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3645: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Get(name)
}

// 3649: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5942: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    ...
    {
        __collection24102 := self.name2EnumValInfo
        __sorted24102 := __collection24102.CreateKeyListStr()
        __sorted24102.Sort( LnsItemKindStr, nil )
        for _, ___key24102 := range( __sorted24102.Items ) {
            enumValInfo := __collection24102.Items[ ___key24102 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp24100 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp24100.Val1
...
// 3675: decl @lune.@base.@Ast.AlgeTypeInfo.get_baseTypeInfo
...
// 3746: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3769: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 5994: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,serializeInfo *Ast_SerializeInfo) {
    ...
    firstFlag = true
    {
        __collection24340 := self.valInfoMap
        __sorted24340 := __collection24340.CreateKeyListStr()
        __sorted24340.Sort( LnsItemKindStr, nil )
        for _, ___key24340 := range( __sorted24340.Items ) {
            algeValInfo := __collection24340.Items[ ___key24340 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3757: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3854: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny,moduleLang LnsAny) {
    ...
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        ...
        Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3873:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch13999 := kind; _switch13999 == Ast_TypeInfoKind__Set || _switch13999 == Ast_TypeInfoKind__Map || _switch13999 == Ast_TypeInfoKind__List || _switch13999 == Ast_TypeInfoKind__Array || _switch13999 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch13999 == Ast_TypeInfoKind__Class || _switch13999 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        if parentInfo != nil{
            parentInfo_3239 := parentInfo.(*Ast_TypeInfo)
            parentInfo_3239.FP.AddChildren(&self.Ast_TypeInfo)
        }
        var hasNilable bool
        hasNilable = false
        if _switch14108 := (kind); _switch14108 == Ast_TypeInfoKind__Prim || _switch14108 == Ast_TypeInfoKind__List || _switch14108 == Ast_TypeInfoKind__Array || _switch14108 == Ast_TypeInfoKind__Set || _switch14108 == Ast_TypeInfoKind__Map || _switch14108 == Ast_TypeInfoKind__Class || _switch14108 == Ast_TypeInfoKind__Stem || _switch14108 == Ast_TypeInfoKind__Module || _switch14108 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch14108 == Ast_TypeInfoKind__Func || _switch14108 == Ast_TypeInfoKind__Method || _switch14108 == Ast_TypeInfoKind__Form || _switch14108 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3960: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3970: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3974: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3978: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() *Ast_IdInfo {
    return self.parentInfo.FP.Get_typeId()
}

// 3982: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() *Ast_IdInfo {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3987: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 3993: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
func (self *Ast_NormalTypeInfo) GetTxtWithRaw(raw string,typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    ...
    parentTxt = ""
    if typeNameCtrl != nil{
        typeNameCtrl_3294 := typeNameCtrl.(*Ast_TypeNameCtrl)
        parentTxt = self.FP.GetParentFullName(typeNameCtrl_3294, importInfo, localFlag)
...
// 4021: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch14526 := self.kind; _switch14526 == Ast_TypeInfoKind__Func || _switch14526 == Ast_TypeInfoKind__Form || _switch14526 == Ast_TypeInfoKind__FormFunc || _switch14526 == Ast_TypeInfoKind__Method || _switch14526 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 4066: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 4071: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 4113: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch15050 := self.kind; _switch15050 == Ast_TypeInfoKind__List || _switch15050 == Ast_TypeInfoKind__Map || _switch15050 == Ast_TypeInfoKind__Array || _switch15050 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 4183: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 4197: decl @lune.@base.@Ast.NormalTypeInfo.create
func Ast_NormalTypeInfo_create(processInfo *Ast_ProcessInfo,accessMode LnsInt,abstractFlag bool,scope LnsAny,baseInfo *Ast_TypeInfo,parentInfo *Ast_TypeInfo,staticFlag bool,kind LnsInt,txt string,itemTypeInfo *LnsList,argTypeInfoList *LnsList,retTypeInfoList *LnsList,mutMode LnsAny) *Ast_TypeInfo {
    if _switch15261 := kind; _switch15261 == Ast_TypeInfoKind__Class || _switch15261 == Ast_TypeInfoKind__ExtModule || _switch15261 == Ast_TypeInfoKind__IF {
...
// 4415: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin_3235_(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch16443 := kind; _switch16443 == Ast_TypeInfoKind__Array || _switch16443 == Ast_TypeInfoKind__List || _switch16443 == Ast_TypeInfoKind__Set || _switch16443 == Ast_TypeInfoKind__Class || _switch16443 == Ast_TypeInfoKind__Module || _switch16443 == Ast_TypeInfoKind__IF || _switch16443 == Ast_TypeInfoKind__Form || _switch16443 == Ast_TypeInfoKind__FormFunc || _switch16443 == Ast_TypeInfoKind__Func || _switch16443 == Ast_TypeInfoKind__Method || _switch16443 == Ast_TypeInfoKind__Macro {
    ...
    if _switch16541 := kind; _switch16541 == Ast_TypeInfoKind__Array || _switch16541 == Ast_TypeInfoKind__List || _switch16541 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch16541 == Ast_TypeInfoKind__Map {
    ...
    Ast_registBuiltin_3230_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 6120: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch25001 := typeInfo.FP.Get_kind(); _switch25001 == Ast_TypeInfoKind__Prim || _switch25001 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch25001 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch25001 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch25001 == Ast_TypeInfoKind__Class || _switch25001 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch25001 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch25001 == Ast_TypeInfoKind__List || _switch25001 == Ast_TypeInfoKind__Array || _switch25001 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch25001 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch25001 == Ast_TypeInfoKind__Nilable {
...
// 6194: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 6855: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6879: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_3532_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch29328 := self.FP.Get_kind(); _switch29328 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch29328 == Ast_TypeInfoKind__Func || _switch29328 == Ast_TypeInfoKind__Form || _switch29328 == Ast_TypeInfoKind__FormFunc {
        var argTypeInfoList *LnsList
        var workArg bool
        
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_3532_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_3532_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
...
// 4254: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 5009: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 5013: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
func (self *Ast_DDDTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5018: decl @lune.@base.@Ast.DDDTypeInfo.get_baseTypeInfo
func (self *Ast_DDDTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5022: decl @lune.@base.@Ast.DDDTypeInfo.get_parentInfo
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_3953 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_3953
...
// 5046: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 5050: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 5057: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 5065: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 5071: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5484: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 5199: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 5211: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 5230: decl @lune.@base.@Ast.CombineType.createStem
...
// 5244: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5575: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
func (self *Ast_AbbrTypeInfo) Get_scope() LnsAny {
    return nil
}

// 5580: decl @lune.@base.@Ast.AbbrTypeInfo.get_baseTypeInfo
func (self *Ast_AbbrTypeInfo) Get_baseTypeInfo() *Ast_TypeInfo {
    return Ast_headTypeInfo
}

// 5584: decl @lune.@base.@Ast.AbbrTypeInfo.get_parentInfo
...
// 5690: decl @lune.@base.@Ast.ExtTypeInfo.equals
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_3277_(self.extedType, Ast_LuavalConvKind__InLua, false))){
        return false
    }
    return self.extedType.FP.Equals(processInfo, typeInfo, alt2type, checkModifer)
}

// 5706: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp22872(Lns_2DDD(Ast_failCreateLuavalWith_3277_(other, Ast_LuavalConvKind__ToLua, true)))
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5730: decl @lune.@base.@Ast.ExtTypeInfo.serialize
...
// 7038: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 7049: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 7060: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 7100: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Types_Position)(LnsAny, LnsAny, LnsAny) {
    ...
    for  {
        if Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp30307(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5268 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5268))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5268.FP.Get_typeInfo()))
                }
            ...
            if _switch30936 := typeInfo.FP.Get_kind(); _switch30936 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch30936 == Ast_TypeInfoKind__List {
            ...
            } else if _switch30936 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30936 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30936 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30936 == Ast_TypeInfoKind__Class || _switch30936 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch30936 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch30936 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp30914 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp30914.Val1
...
func Lns_Ast_init() {
    ...
    Ast_DummyModuleInfoManager____init_1147_()
    ...
    _ = NewLnsList([]LnsAny{})
    Ast_headTypeInfo = &Ast_RootTypeInfo_create_1724_().Ast_TypeInfo
    ...
    Ast_AutoBoxingInfo____init_1812_()
    Ast_dummyIdInfo = NewAst_IdInfo(1, Ast_rootProcessInfo)
    Ast_CanEvalCtrlTypeInfo____init_1834_()
    ...
    Ast_builtinTypeNone = Ast_NormalTypeInfo_createBuiltin_3235_("__None", "", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeEmpty = Ast_NormalTypeInfo_createBuiltin_3235_("__Empty", "::", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeNeverRet = Ast_NormalTypeInfo_createBuiltin_3235_("__NRet", "__", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeStem = Ast_NormalTypeInfo_createBuiltin_3235_("Stem", "stem", Ast_TypeInfoKind__Stem, nil, nil)
    Ast_builtinTypeStem_ = Ast_builtinTypeStem.FP.Get_nilableTypeInfo()
    Ast_builtinTypeBool = Ast_NormalTypeInfo_createBuiltin_3235_("Bool", "bool", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeInt = Ast_NormalTypeInfo_createBuiltin_3235_("Int", "int", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeReal = Ast_NormalTypeInfo_createBuiltin_3235_("Real", "real", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeChar = Ast_NormalTypeInfo_createBuiltin_3235_("char", "__char", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeMapping = Ast_NormalTypeInfo_createBuiltin_3235_("Mapping", "Mapping", Ast_TypeInfoKind__IF, nil, nil)
    Ast_builtinTypeAsyncItem = Ast_NormalTypeInfo_createBuiltin_3235_("__AsyncItem", "__AsyncItem", Ast_TypeInfoKind__IF, nil, nil)
    Ast_builtinTypeString = Ast_NormalTypeInfo_createBuiltin_3235_("String", "str", Ast_TypeInfoKind__Class, nil, NewLnsList([]LnsAny{Ast_TypeInfo2Stem(Ast_builtinTypeMapping)}))
    Ast_builtinTypeMap = Ast_NormalTypeInfo_createBuiltin_3235_("Map", "Map", Ast_TypeInfoKind__Map, nil, nil)
    Ast_builtinTypeSet = Ast_NormalTypeInfo_createBuiltin_3235_("Set", "Set", Ast_TypeInfoKind__Set, nil, nil)
    Ast_builtinTypeList = Ast_NormalTypeInfo_createBuiltin_3235_("List", "List", Ast_TypeInfoKind__List, nil, nil)
    Ast_builtinTypeArray = Ast_NormalTypeInfo_createBuiltin_3235_("Array", "Array", Ast_TypeInfoKind__Array, nil, nil)
    ...
    Ast_registBuiltin_3230_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_3230_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_3230_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    Ast_builtinTypeForm = Ast_NormalTypeInfo_createBuiltin_3235_("Form", "form", Ast_TypeInfoKind__Form, Ast_builtinTypeDDD, nil)
    Ast_immutableTypeSet.Add(Ast_TypeInfo2Stem(Ast_builtinTypeForm))
    Ast_builtinTypeSymbol = Ast_NormalTypeInfo_createBuiltin_3235_("Symbol", "sym", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeStat = Ast_NormalTypeInfo_createBuiltin_3235_("Stat", "stat", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeExp = Ast_NormalTypeInfo_createBuiltin_3235_("Exp", "__exp", Ast_TypeInfoKind__Prim, nil, nil)
    Ast_builtinTypeMultiExp = Ast_NormalTypeInfo_createBuiltin_3235_("Exps", "__exps", Ast_TypeInfoKind__Prim, nil, nil)
    ...
    switch _exp23430 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp23430.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_3230_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_3230_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
