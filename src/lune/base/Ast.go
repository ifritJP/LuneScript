...
func Ast_LuavalConvKind_get__allList_4130_() *LnsList{
...
func Ast_LuavalConvKind__from_4123_(arg1 LnsInt) LnsAny{
...
// for 5285
func Ast_convExp21243(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6675
func Ast_convExp28476(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp29445(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp29603(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp29769(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp29940(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp30106(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp30312(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp30489(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6810
func Ast_convExp30647(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 6849
func Ast_convExp30802(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
// 957: decl @lune.@base.@Ast.applyGenericDefault
...
// 985: decl @lune.@base.@Ast.getAllNameForKind
func Ast_getAllNameForKind(classInfo *Ast_TypeInfo,kind LnsInt,symbolKind LnsInt) *Util_OrderedSet {
    ...
    process = func(scope *Ast_Scope) {
        ...
        {
            __collection2723 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted2723 := __collection2723.CreateKeyListStr()
            __sorted2723.Sort( LnsItemKindStr, nil )
            for _, ___key2723 := range( __sorted2723.Items ) {
                symbolInfo := __collection2723.Items[ ___key2723 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch2721 := symbolInfo.FP.Get_kind(); _switch2721 == symbolKind {
...
// 1019: decl @lune.@base.@Ast.getAllMethodName
...
// 1900: decl @lune.@base.@Ast.dumpScope.dumpScopeSub
func dumpScope__dumpScopeSub_2384_(scope LnsAny,prefix string,readyIdSet *LnsSet) {
    {
        __exp := scope
        if __exp != nil {
            ...
            {
                __collection6293 := _exp.FP.Get_symbol2SymbolInfoMap()
                __sorted6293 := __collection6293.CreateKeyListStr()
                __sorted6293.Sort( LnsItemKindStr, nil )
                for _, _symbol := range( __sorted6293.Items ) {
                    symbolInfo := __collection6293.Items[ _symbol ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                    ...
                    Util_log(Lns_getVM().String_format("scope: %s, %s, %s", []LnsAny{prefix, _exp, symbol}))
                    {
                        ...
                        if _subScope != nil {
                            ...
                            dumpScope__dumpScopeSub_2384_(subScope, prefix + "  ", readyIdSet)
                        }
                    }
                }
            }
...
// 1895: decl @lune.@base.@Ast.dumpScope
func Ast_dumpScope(workscope LnsAny,workprefix string) {
    dumpScope__dumpScopeSub_2384_(workscope, workprefix, NewLnsSet([]LnsAny{}))
}


// 3000: decl @lune.@base.@Ast.isGenericType
...
// 3208: decl @lune.@base.@Ast.getEnumLiteralVal
func Ast_getEnumLiteralVal(obj LnsAny) LnsAny {
    switch _exp11246 := obj.(type) {
...
// 3924: decl @lune.@base.@Ast.isExtType
...
// 3931: decl @lune.@base.@Ast.isMutableType
func Ast_isMutableType(typeInfo *Ast_TypeInfo) bool {
    ...
    if _switch14465 := typeInfo.FP.Get_kind(); _switch14465 == Ast_TypeInfoKind__FormFunc || _switch14465 == Ast_TypeInfoKind__Enum {
        return false
    }
    return true
}

// 4034: decl @lune.@base.@Ast.addBuiltin
func Ast_addBuiltin(typeInfo *Ast_TypeInfo) {
    Ast_builtInTypeIdSet.Set(typeInfo.FP.Get_typeId(),typeInfo)
}

// 4038: decl @lune.@base.@Ast.registBuiltin
func Ast_registBuiltin_4074_(idName string,typeTxt string,kind LnsInt,typeInfo *Ast_TypeInfo,nilableTypeInfo *Ast_TypeInfo,registScope bool) {
...
func Ast_failCreateLuavalWith_4133_(typeInfo *Ast_TypeInfo,convFlag LnsInt,validToCheck bool)(LnsAny, bool) {
    ...
    if _switch16152 := typeInfo.FP.Get_kind(); _switch16152 == Ast_TypeInfoKind__Nilable {
        return Ast_failCreateLuavalWith_4133_(typeInfo.FP.Get_nonnilableType(), convFlag, validToCheck)
    } else if _switch16152 == Ast_TypeInfoKind__Prim {
        return nil, true
    } else if _switch16152 == Ast_TypeInfoKind__Form || _switch16152 == Ast_TypeInfoKind__IF || _switch16152 == Ast_TypeInfoKind__DDD {
        ...
        return nil, false
    } else if _switch16152 == Ast_TypeInfoKind__Stem {
        return nil, false
    } else if _switch16152 == Ast_TypeInfoKind__Class {
        ...
        return nil, true
    } else if _switch16152 == Ast_TypeInfoKind__Array || _switch16152 == Ast_TypeInfoKind__List || _switch16152 == Ast_TypeInfoKind__Map {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        for _, _itemType := range( typeInfo.FP.Get_itemTypeInfoList().Items ) {
            ...
            var err LnsAny
            var work bool
            err,work = Ast_failCreateLuavalWith_4133_(itemType, convFlag, validToCheck)
            if err != nil{
                err_3635 := err.(string)
                return err_3635, false
            }
            if Lns_op_not(work){
                canConv = false
        ...
        return nil, canConv
    } else if _switch16152 == Ast_TypeInfoKind__FormFunc {
        if Lns_op_not(validToCheck){
            return nil, false
        }
        if convFlag != Ast_LuavalConvKind__InLua{
...
// 4268: decl @lune.@base.@Ast.isClass
...
// 4298: decl @lune.@base.@Ast.isStruct
func Ast_isStruct(typeInfo *Ast_TypeInfo) bool {
    if _switch16325 := typeInfo.FP.Get_kind(); _switch16325 == Ast_TypeInfoKind__Class {
        if typeInfo == Ast_builtinTypeString{
            return false
        }
        if Lns_popVal( Lns_incStack() ||
...
// 4321: decl @lune.@base.@Ast.isConditionalbe
...
// 5086: decl @lune.@base.@Ast.applyGenericList
func Ast_applyGenericList_4496_(typeList *LnsList,alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo)(LnsAny, bool) {
...
// 5417: decl @lune.@base.@Ast.convToExtTypeList
func Ast_convToExtTypeList(processInfo *Ast_ProcessInfo,list *LnsList)(LnsAny, string) {
    ...
    for _, _typeInfo := range( list.Items ) {
        ...
        switch _exp21894 := processInfo.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        extType := _exp21894.Val1
...
// 5461: decl @lune.@base.@Ast.isNumberType
...
// 5975: decl @lune.@base.@Ast.isSettableToForm
func Ast_isSettableToForm_5062_(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo) bool {
...
// 6501: decl @lune.@base.@Ast.createProcessInfo
...
// 3873: decl @lune.@base.@Ast.ProcessInfo.createAlternate
...
// 3944: decl @lune.@base.@Ast.ProcessInfo.createModifier
func (self *Ast_ProcessInfo) CreateModifier(srcTypeInfo *Ast_TypeInfo,mutMode LnsInt) *Ast_TypeInfo {
    ...
    if _switch14545 := mutMode; _switch14545 == Ast_MutMode__IMut || _switch14545 == Ast_MutMode__IMutRe {
        {
    ...
    } else if _switch14545 == Ast_MutMode__AllMut {
        {
    ...
    if srcTypeInfo.FP.Get_nonnilableType().FP.Get_kind() == Ast_TypeInfoKind__Ext{
        switch _exp14611 := self.FP.CreateLuaval(self.FP.CreateModifier(srcTypeInfo.FP.Get_extedType(), mutMode), false).(type) {
        case *Ast_LuavalResult__OK:
        workType := _exp14611.Val1
    ...
    if _switch14678 := mutMode; _switch14678 == Ast_MutMode__IMut || _switch14678 == Ast_MutMode__IMutRe {
        self.FP.get_typeInfo2Map().ImutModifierMap.Set(srcTypeInfo,modifier)
    } else if _switch14678 == Ast_MutMode__AllMut {
        self.FP.get_typeInfo2Map().MutModifierMap.Set(srcTypeInfo,modifier)
    }
    return modifier
}

// 4330: decl @lune.@base.@Ast.ProcessInfo.createBox
...
// 4376: decl @lune.@base.@Ast.ProcessInfo.createSet
...
// 4389: decl @lune.@base.@Ast.ProcessInfo.createList
...
// 4402: decl @lune.@base.@Ast.ProcessInfo.createArray
...
// 4415: decl @lune.@base.@Ast.ProcessInfo.createMap
...
// 4430: decl @lune.@base.@Ast.ProcessInfo.createModule
...
// 4451: decl @lune.@base.@Ast.ProcessInfo.createClass
...
// 4480: decl @lune.@base.@Ast.ProcessInfo.createFunc
...
// 4501: decl @lune.@base.@Ast.ProcessInfo.createAdvertiseMethodFrom
...
// 4530: decl @lune.@base.@Ast.ProcessInfo.createAlias
...
// 4673: decl @lune.@base.@Ast.ProcessInfo.createDDD
func (self *Ast_ProcessInfo) CreateDDD(typeInfo *Ast_TypeInfo,externalFlag bool,extTypeFlag bool) *Ast_DDDTypeInfo {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4133_(typeInfo, Ast_LuavalConvKind__InLua, true)))) &&
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        Lns_setStackVal( extTypeFlag) ).(bool)){
        switch _exp18676 := self.FP.CreateLuaval(typeInfo, true).(type) {
        case *Ast_LuavalResult__OK:
        work := _exp18676.Val1
            typeInfo = work
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4133_(typeInfo, Ast_LuavalConvKind__InLua, true))){
...
// 5077: decl @lune.@base.@Ast.ProcessInfo.createGeneric
...
// 5340: decl @lune.@base.@Ast.ProcessInfo.createLuaval
func (self *Ast_ProcessInfo) CreateLuaval(luneType *Ast_TypeInfo,validToCheck bool) LnsAny {
    ...
    process = func() LnsAny {
        {
            ...
            if _dddType != nil {
                dddType := _dddType.(*Ast_DDDTypeInfo)
                switch _exp21612 := self.FP.CreateLuaval(dddType.FP.Get_typeInfo(), validToCheck).(type) {
                case *Ast_LuavalResult__Err:
                mess := _exp21612.Val1
                    Util_err(mess)
                case *Ast_LuavalResult__OK:
                workType := _exp21612.Val1
        ...
        var err LnsAny
        var canConv bool
        err, canConv = Ast_failCreateLuavalWith_4133_(luneType, Ast_LuavalConvKind__InLua, validToCheck)
        
        if err != nil{
            err_4513 := err.(string)
            return &Ast_LuavalResult__Err{err_4513}
        }
        if canConv{
            return &Ast_LuavalResult__OK{luneType, true}
        }
    ...
    var result LnsAny
    result = process()
    switch _exp21750 := result.(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp21750.Val1
...
// 5467: decl @lune.@base.@Ast.ProcessInfo.createEnum
...
// 5534: decl @lune.@base.@Ast.ProcessInfo.createAlge
...
// 1024: decl @lune.@base.@Ast.TypeNameCtrl.getModuleName
...
// 1039: decl @lune.@base.@Ast.TypeNameCtrl.getParentFullName
...
// 967: decl @lune.@base.@Ast.SymbolInfo.getModule
...
// 1097: decl @lune.@base.@Ast.Scope.getNamespaceTypeInfo
...
func (self *Ast_Scope) FilterTypeInfoField(includeSelfFlag LnsAny,fromScope *Ast_Scope,access LnsInt,callback Ast_filterForm) bool {
    if self.classFlag{
        if Lns_isCondTrue( includeSelfFlag){
            {
                __collection4168 := self.symbol2SymbolInfoMap
                __sorted4168 := __collection4168.CreateKeyListStr()
                __sorted4168.Sort( LnsItemKindStr, nil )
                for _, ___key4168 := range( __sorted4168.Items ) {
                    symbolInfo := __collection4168.Items[ ___key4168 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 1449: decl @lune.@base.@Ast.Scope.getSymbolInfoField
...
// 1479: decl @lune.@base.@Ast.Scope.getSymbolInfoIfField
...
// 1506: decl @lune.@base.@Ast.Scope.filterSymbolInfoIfField
...
// 1528: decl @lune.@base.@Ast.Scope.getTypeInfoField
...
// 1549: decl @lune.@base.@Ast.Scope.getSymbolInfo
...
// 1610: decl @lune.@base.@Ast.Scope.getTypeInfo
...
// 1627: decl @lune.@base.@Ast.Scope.getSymbolTypeInfo
...
// 1670: decl @lune.@base.@Ast.Scope.filterSymbolTypeInfo
...
// 1692: decl @lune.@base.@Ast.Scope.add
func (self *Ast_Scope) Add(processInfo *Ast_ProcessInfo,kind LnsInt,canBeLeft bool,canBeRight bool,name string,pos LnsAny,typeInfo *Ast_TypeInfo,accessMode LnsInt,staticFlag bool,mutMode LnsInt,hasValueFlag bool)(LnsAny, LnsAny) {
    if _switch5215 := kind; _switch5215 == Ast_SymbolKind__Typ || _switch5215 == Ast_SymbolKind__Fun || _switch5215 == Ast_SymbolKind__Mac {
        var existSymbol LnsAny
        if _switch5181 := typeInfo.FP.Get_kind(); _switch5181 == Ast_TypeInfoKind__Enum {
        ...
        } else if _switch5181 == Ast_TypeInfoKind__Class || _switch5181 == Ast_TypeInfoKind__Module {
        ...
        if existSymbol != nil{
            existSymbol_1610 := existSymbol.(*Ast_SymbolInfo)
            if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( typeInfo.FP.Get_kind() != existSymbol_1610.FP.Get_typeInfo().FP.Get_kind()) ||
                Lns_setStackVal( Lns_op_not(Ast_isBuiltin(existSymbol_1610.FP.Get_typeInfo().FP.Get_typeId()))) ).(bool){
                return nil, existSymbol_1610
            }
        }
    }
...
// 1734: decl @lune.@base.@Ast.Scope.addLocalVar
...
// 1747: decl @lune.@base.@Ast.Scope.addUnwrapedVar
...
// 1758: decl @lune.@base.@Ast.Scope.addStaticVar
...
// 1768: decl @lune.@base.@Ast.Scope.addVar
...
// 1782: decl @lune.@base.@Ast.Scope.addEnumVal
...
// 1792: decl @lune.@base.@Ast.Scope.addEnum
...
// 1822: decl @lune.@base.@Ast.Scope.addAlternate
...
// 1831: decl @lune.@base.@Ast.Scope.addMember
...
// 1841: decl @lune.@base.@Ast.Scope.addMethod
...
// 1851: decl @lune.@base.@Ast.Scope.addFunc
...
// 1862: decl @lune.@base.@Ast.Scope.addForm
...
// 1871: decl @lune.@base.@Ast.Scope.addMacro
...
// 1882: decl @lune.@base.@Ast.Scope.addClass
...
// 1927: decl @lune.@base.@Ast.Scope.setClosure
...
// 1956: decl @lune.@base.@Ast.Scope.isClosureAccess
func (self *Ast_Scope) IsClosureAccess(moduleScope *Ast_Scope,symbol *Ast_SymbolInfo) bool {
    ...
    if _switch6536 := symbol.FP.Get_kind(); _switch6536 == Ast_SymbolKind__Var || _switch6536 == Ast_SymbolKind__Arg || _switch6536 == Ast_SymbolKind__Fun {
        if Lns_popVal( Lns_incStack() ||
...
// 1996: decl @lune.@base.@Ast.Scope.accessSymbol
...
// 2121: decl @lune.@base.@Ast.Scope.getClassTypeInfo
    ...
    for  {
        {
            ...
            if _owner != nil {
                ...
                if _switch6921 := owner.FP.Get_kind(); _switch6921 == Ast_TypeInfoKind__Class || _switch6921 == Ast_TypeInfoKind__IF || _switch6921 == Ast_TypeInfoKind__Module {
                    return owner
                }
            }
        }
...
// 4013: decl @lune.@base.@Ast.Scope.addOverrideImut
...
// 4158: decl @lune.@base.@Ast.Scope.addIgnoredVar
...
// 4539: decl @lune.@base.@Ast.Scope.addAlias
...
// 4551: decl @lune.@base.@Ast.Scope.addAliasForType
func (self *Ast_Scope) AddAliasForType(processInfo *Ast_ProcessInfo,name string,pos LnsAny,typeInfo *Ast_TypeInfo)(LnsAny, LnsAny) {
    ...
    var canBeRight bool
    canBeRight = false
    if _switch18159 := typeInfo.FP.Get_kind(); _switch18159 == Ast_TypeInfoKind__Func {
        skind = Ast_SymbolKind__Fun
        
        canBeRight = true
        
    } else if _switch18159 == Ast_TypeInfoKind__Form || _switch18159 == Ast_TypeInfoKind__FormFunc {
        canBeRight = true
        
    } else if _switch18159 == Ast_TypeInfoKind__Macro {
...
// 736: decl @lune.@base.@Ast.TypeInfo.canEvalWith
...
// 782: decl @lune.@base.@Ast.TypeInfo.get_externalFlag
func (self *Ast_TypeInfo) Get_externalFlag() bool {
    return false
}

// 787: decl @lune.@base.@Ast.TypeInfo.get_interfaceList
func (self *Ast_TypeInfo) Get_interfaceList() *LnsList {
    return Ast_dummyList
}

// 791: decl @lune.@base.@Ast.TypeInfo.get_itemTypeInfoList
func (self *Ast_TypeInfo) Get_itemTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 795: decl @lune.@base.@Ast.TypeInfo.get_argTypeInfoList
func (self *Ast_TypeInfo) Get_argTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 799: decl @lune.@base.@Ast.TypeInfo.get_retTypeInfoList
func (self *Ast_TypeInfo) Get_retTypeInfoList() *LnsList {
    return Ast_dummyList
}

// 803: decl @lune.@base.@Ast.TypeInfo.get_parentInfo
func (self *Ast_TypeInfo) Get_parentInfo() *Ast_TypeInfo {
    return self
}

// 811: decl @lune.@base.@Ast.TypeInfo.hasRouteNamespaceFrom
...
// 824: decl @lune.@base.@Ast.TypeInfo.getModule
...
// 901: decl @lune.@base.@Ast.TypeInfo.applyGeneric
func (self *Ast_TypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    return self
}

// 907: decl @lune.@base.@Ast.TypeInfo.get_genSrcTypeInfo
func (self *Ast_TypeInfo) Get_genSrcTypeInfo() *Ast_TypeInfo {
    return self
}

// 911: decl @lune.@base.@Ast.TypeInfo.serializeTypeInfoList
...
// 926: decl @lune.@base.@Ast.TypeInfo.createScope
func Ast_TypeInfo_createScope(processInfo *Ast_ProcessInfo,parent LnsAny,classFlag bool,baseInfo LnsAny,interfaceList LnsAny) *Ast_Scope {
    ...
    inheritScope = nil
    if baseInfo != nil{
        baseInfo_1035 := baseInfo.(*Ast_TypeInfo)
        inheritScope = Lns_unwrap( baseInfo_1035.scope).(*Ast_Scope)
        
    }
    var ifScopeList *LnsList
    ifScopeList = NewLnsList([]LnsAny{})
    if interfaceList != nil{
        interfaceList_1038 := interfaceList.(*LnsList)
        for _, _ifType := range( interfaceList_1038.Items ) {
...
// 2016: decl @lune.@base.@Ast.TypeInfo.createAlt2typeMap
...
// 4881: decl @lune.@base.@Ast.TypeInfo.getCommonTypeCombo
func Ast_TypeInfo_getCommonTypeCombo(processInfo *Ast_ProcessInfo,commonType LnsAny,otherType LnsAny,alt2type *LnsMap) LnsAny {
    ...
    switch _exp19534 := commonType.(type) {
    ...
    switch _exp19565 := otherType.(type) {
    case *Ast_CommonType__Combine:
    comb := _exp19565.Val1
        return comb.FP.AndType(processInfo, commonType, alt2type)
    case *Ast_CommonType__Normal:
    workTypeInfo := _exp19565.Val1
        other = workTypeInfo
    ...
    if type1.FP.Get_kind() == type2.FP.Get_kind(){
        ...
        getCommon = func(workTypeInfo *Ast_TypeInfo,workOther *Ast_TypeInfo,workAlt2type *LnsMap) *Ast_TypeInfo {
            switch _exp19844 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{workTypeInfo}, &Ast_CommonType__Normal{workOther}, workAlt2type).(type) {
            case *Ast_CommonType__Normal:
            info := _exp19844.Val1
                return info
            case *Ast_CommonType__Combine:
            combine := _exp19844.Val1
                return combine.FP.Get_typeInfo(processInfo)
            }
        // insert a dummy
            return nil
        }
        if _switch20034 := type1.FP.Get_kind(); _switch20034 == Ast_TypeInfoKind__List {
        ...
        } else if _switch20034 == Ast_TypeInfoKind__Array {
        ...
        } else if _switch20034 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch20034 == Ast_TypeInfoKind__Map {
...
// 5026: decl @lune.@base.@Ast.TypeInfo.getCommonType
func Ast_TypeInfo_getCommonType(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,other *Ast_TypeInfo,alt2type *LnsMap) *Ast_TypeInfo {
    switch _exp20206 := Ast_TypeInfo_getCommonTypeCombo(processInfo, &Ast_CommonType__Normal{typeInfo}, &Ast_CommonType__Normal{other}, alt2type).(type) {
    case *Ast_CommonType__Normal:
    info := _exp20206.Val1
        return info
    case *Ast_CommonType__Combine:
    combine := _exp20206.Val1
        return combine.FP.Get_typeInfo(processInfo)
    }
// insert a dummy
    return nil
...
// 5790: decl @lune.@base.@Ast.TypeInfo.checkMatchType
func Ast_TypeInfo_checkMatchType(processInfo *Ast_ProcessInfo,dstTypeList *LnsList,expTypeList *LnsList,allowDstShort bool,warnForFollowSrcIndex LnsAny,alt2type *LnsMap)(LnsInt, string) {
    ...
    checkDstTypeFrom = func(index LnsInt,srcType *Ast_TypeInfo,srcType2nd *Ast_TypeInfo)(LnsInt, string) {
        ...
        workExpType = srcType
        {
            var _from23696 LnsInt = index
            var _to23696 LnsInt = dstTypeList.Len()
            for _work23696 := _from23696; _work23696 <= _to23696; _work23696++ {
                dstIndex := _work23696
    ...
    checkSrcTypeFrom = func(index LnsInt,dstType *Ast_TypeInfo)(LnsInt, string) {
        {
            var _from23952 LnsInt = index
            var _to23952 LnsInt = expTypeList.Len()
            for _work23952 := _from23952; _work23952 <= _to23952; _work23952++ {
                srcIndex := _work23952
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4804 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4804 <= srcIndex{
                        var workMess string
    ...
    if expTypeList.Len() > 0{
        for _index, _expType := range( expTypeList.Items ) {
            ...
            if dstTypeList.Len() == index{
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4827 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4827 <= index{
                        var workMess string
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4841 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4841 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
                ...
                if warnForFollowSrcIndex != nil{
                    warnForFollowSrcIndex_4848 := warnForFollowSrcIndex.(LnsInt)
                    if warnForFollowSrcIndex_4848 <= index{
                        var workMess string
                        workMess = Lns_getVM().String_format("use '**' at arg(%d). %s <- %s", []LnsAny{index, dstType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil), expType.FP.GetTxt(Ast_defaultTypeNameCtrl, nil, nil)})
                        return Ast_MatchType__Warn, workMess
                    }
    ...
    if warnMess != nil{
        warnMess_4858 := warnMess.(string)
        return Ast_MatchType__Warn, warnMess_4858
    }
    return Ast_MatchType__Match, ""
}

// 5995: decl @lune.@base.@Ast.TypeInfo.canEvalWithBase
func Ast_TypeInfo_canEvalWithBase(processInfo *Ast_ProcessInfo,dest *Ast_TypeInfo,destMut bool,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch25244 := canEvalType; _switch25244 == Ast_CanEvalType__SetEq || _switch25244 == Ast_CanEvalType__SetOp || _switch25244 == Ast_CanEvalType__SetOpIMut {
        if dest == Ast_builtinTypeEmpty{
            if _switch25053 := otherSrc; _switch25053 == Ast_builtinTypeAbbr || _switch25053 == Ast_builtinTypeAbbrNone {
                return false, nil
            }
            ...
            if _switch25140 := nonNilOtherType.FP.Get_kind(); _switch25140 == Ast_TypeInfoKind__Set || _switch25140 == Ast_TypeInfoKind__Map || _switch25140 == Ast_TypeInfoKind__List || _switch25140 == Ast_TypeInfoKind__IF {
                return false, nil
            } else if _switch25140 == Ast_TypeInfoKind__Class {
                if Ast_builtinTypeString != nonNilOtherType{
                    return false, nil
                }
            } else if _switch25140 == Ast_TypeInfoKind__Prim {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        return Ast_isSettableToForm_5062_(processInfo, otherSrc), nil
    }
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( otherSrc == Ast_builtinTypeNil) ||
    ...
    }
    {
        ...
        if _extTypeInfo != nil {
            ...
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                ...
                Lns_setStackVal( Lns_op_not(Lns_car(Ast_failCreateLuavalWith_4133_(extTypeInfo.FP.Get_extedType(), Ast_LuavalConvKind__ToLua, false)))) ).(bool)){
    ...
    if dest.FP.Get_kind() != otherSrc.FP.Get_kind(){
        ...
        if dest.FP.Get_kind() == Ast_TypeInfoKind__Nilable{
            ...
            if _switch25900 := otherSrc.FP.Get_kind(); _switch25900 == Ast_TypeInfoKind__Form {
                return true, nil
            } else if _switch25900 == Ast_TypeInfoKind__FormFunc || _switch25900 == Ast_TypeInfoKind__Func {
                return Ast_isSettableToForm_5062_(processInfo, otherSrc), nil
            }
        } else if dest.FP.Get_kind() == Ast_TypeInfoKind__FormFunc{
            if _switch26105 := otherSrc.FP.Get_kind(); _switch26105 == Ast_TypeInfoKind__FormFunc || _switch26105 == Ast_TypeInfoKind__Func {
                {
                    var result LnsInt
                    var mess string
    ...
    if _switch27076 := dest.FP.Get_kind(); _switch27076 == Ast_TypeInfoKind__Prim {
        if Lns_popVal( Lns_incStack() ||
        ...
        return false, nil
    } else if _switch27076 == Ast_TypeInfoKind__List || _switch27076 == Ast_TypeInfoKind__Array || _switch27076 == Ast_TypeInfoKind__Set {
        ...
        return true, nil
    } else if _switch27076 == Ast_TypeInfoKind__Map {
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        return false, nil
    } else if _switch27076 == Ast_TypeInfoKind__Class || _switch27076 == Ast_TypeInfoKind__IF {
        ...
        return false, nil
    } else if _switch27076 == Ast_TypeInfoKind__Form {
        return Ast_isSettableToForm_5062_(processInfo, otherSrc), nil
    } else if _switch27076 == Ast_TypeInfoKind__Func || _switch27076 == Ast_TypeInfoKind__FormFunc {
        if dest.FP.Get_retTypeInfoList().Len() != otherSrc.FP.Get_retTypeInfoList().Len(){
            return false, Lns_getVM().String_format("argNum %d != %d", []LnsAny{dest.FP.Get_retTypeInfoList().Len(), otherSrc.FP.Get_retTypeInfoList().Len()})
        }
        var argCheck LnsInt
        ...
        return true, nil
    } else if _switch27076 == Ast_TypeInfoKind__Method {
        if Lns_popVal( Lns_incStack() ||
        ...
        return true, nil
    } else if _switch27076 == Ast_TypeInfoKind__Nilable {
        var dstNonNil *Ast_TypeInfo
        if destMut{
            dstNonNil = dest.FP.Get_nonnilableType()
        ...
        return dstNonNil.FP.CanEvalWith(processInfo, otherSrc.FP.Get_nonnilableType(), canEvalType, alt2type)
    } else if _switch27076 == Ast_TypeInfoKind__Alternate {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else if _switch27076 == Ast_TypeInfoKind__Box {
        return dest.FP.CanEvalWith(processInfo, otherSrc, canEvalType, alt2type)
    } else {
        return false, nil
    }
...
// 6486: decl @lune.@base.@Ast.TypeInfo.getFullName
...
// 1156: decl @lune.@base.@Ast.NormalSymbolInfo.get_mutable
func (self *Ast_NormalSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.mutMode)
}

// 1164: decl @lune.@base.@Ast.NormalSymbolInfo.getOrg
...
// 2143: decl @lune.@base.@Ast.NormalSymbolInfo.canAccess
func (self *Ast_NormalSymbolInfo) CanAccess(fromScope *Ast_Scope,access LnsInt) LnsAny {
    ...
    if _switch7082 := self.FP.Get_accessMode(); _switch7082 == Ast_AccessMode__Pub || _switch7082 == Ast_AccessMode__Global {
        return &self.Ast_SymbolInfo
    } else if _switch7082 == Ast_AccessMode__Pro {
        ...
        return nil
    } else if _switch7082 == Ast_AccessMode__Local {
        return &self.Ast_SymbolInfo
    } else if _switch7082 == Ast_AccessMode__Pri {
...
// 4162: decl @lune.@base.@Ast.NormalSymbolInfo.set_typeInfo
...
// 1234: decl @lune.@base.@Ast.AutoBoxingInfo.___init
func Ast_AutoBoxingInfo____init_2047_() {
...
// 1251: decl @lune.@base.@Ast.AutoBoxingInfo.get_kind
func (self *Ast_AutoBoxingInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Etc
}

// 1255: decl @lune.@base.@Ast.AutoBoxingInfo.inc
...
// 1260: decl @lune.@base.@Ast.AutoBoxingInfo.unregist
...
// 1265: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.___init
func Ast_CanEvalCtrlTypeInfo____init_2077_() {
...
// 1279: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_kind
func (self *Ast_CanEvalCtrlTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__CanEvalCtrl
}

// 1283: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.get_typeId
func (self *Ast_CanEvalCtrlTypeInfo) Get_typeId() LnsInt {
    return -1
}

// 1287: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.createDefaultAlt2typeMap
...
// 1296: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.isValidApply
...
// 1300: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.setupNeedAutoBoxing
...
// 1306: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.updateNeedAutoBoxing
...
// 1317: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.hasNeedAutoBoxing
...
// 1327: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.finishNeedAutoBoxing
...
// 1344: decl @lune.@base.@Ast.CanEvalCtrlTypeInfo.canAutoBoxing
...
// 1367: decl @lune.@base.@Ast.AliasTypeInfo.getTxt
...
// 1373: decl @lune.@base.@Ast.AliasTypeInfo.serialize
...
// 2060: decl @lune.@base.@Ast.NilTypeInfo.get_display_stirng_with
...
func (self *Ast_AccessSymbolInfo) InitAst_AccessSymbolInfo(symbolInfo *Ast_SymbolInfo,overrideMut LnsAny,overrideCanBeLeft bool) {
    ...
    var work *Ast_TypeInfo
    switch _exp7270 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
        work = symType
        
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp7270.Val1
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            ...
            if typeInfo != nil{
                typeInfo_1978 := typeInfo.(*Ast_TypeInfo)
                work = typeInfo_1978
...
// 2241: decl @lune.@base.@Ast.AccessSymbolInfo.getOrg
func (self *Ast_AccessSymbolInfo) GetOrg() *Ast_SymbolInfo {
    return self.symbolInfo.FP.GetOrg()
}

// 2245: decl @lune.@base.@Ast.AccessSymbolInfo.canAccess
...
// 2254: decl @lune.@base.@Ast.AccessSymbolInfo.get_typeInfo
func (self *Ast_AccessSymbolInfo) Get_typeInfo() *Ast_TypeInfo {
    return self.overrideTypeInfo
}

// 2258: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutMode
func (self *Ast_AccessSymbolInfo) Get_mutMode() LnsInt {
    switch _exp7398 := self.overrideMut.(type) {
    case *Ast_OverrideMut__None:
    case *Ast_OverrideMut__Prefix:
    prefixTypeInfo := _exp7398.Val1
        if _switch7391 := self.symbolInfo.FP.Get_mutMode(); _switch7391 == Ast_MutMode__AllMut || _switch7391 == Ast_MutMode__IMut || _switch7391 == Ast_MutMode__IMutRe {
            return self.symbolInfo.FP.Get_mutMode()
        } else if _switch7391 == Ast_MutMode__Mut {
            if _switch7389 := prefixTypeInfo.FP.Get_mutMode(); _switch7389 == Ast_MutMode__AllMut {
                return Ast_MutMode__Mut
            } else if _switch7389 == Ast_MutMode__Mut || _switch7389 == Ast_MutMode__IMut || _switch7389 == Ast_MutMode__IMutRe {
...
// 2287: decl @lune.@base.@Ast.AccessSymbolInfo.get_mutable
func (self *Ast_AccessSymbolInfo) Get_mutable() bool {
    return Ast_isMutable(self.FP.Get_mutMode())
}

// 2291: decl @lune.@base.@Ast.AccessSymbolInfo.get_canBeLeft
...
// 2331: decl @lune.@base.@Ast.NilableTypeInfo.get_display_stirng_with
...
// 2349: decl @lune.@base.@Ast.NilableTypeInfo.equals
...
// 2360: decl @lune.@base.@Ast.NilableTypeInfo.applyGeneric
func (self *Ast_NilableTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_2120 := typeInfo.(*Ast_TypeInfo)
        return typeInfo_2120.FP.Get_nilableTypeInfo()
    }
    return nil
}

// 5617: decl @lune.@base.@Ast.NilableTypeInfo.canEvalWith
...
func (self *Ast_AlternateTypeInfo) canSetFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsAny,alt2type *LnsMap) bool {
    ...
    }
    {
        ...
        if _genType != nil {
            genType := _genType.(*Ast_TypeInfo)
            if canEvalType != nil{
                canEvalType_2236 := canEvalType.(LnsInt)
                return Lns_car(genType.FP.CanEvalWith(processInfo, otherWork, canEvalType_2236, alt2type)).(bool)
            }
...
// 2500: decl @lune.@base.@Ast.AlternateTypeInfo.isInheritFrom
func (self *Ast_AlternateTypeInfo) IsInheritFrom(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,alt2type LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2256 := alt2type.(*LnsMap)
        var otherWork *Ast_TypeInfo
        otherWork = Ast_AlternateTypeInfo_getAssign(other, alt2type_2256)
        if &self.Ast_TypeInfo == otherWork.FP.Get_srcTypeInfo(){
            return true
        }
        {
            _genType := alt2type_2256.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.IsInheritFrom(processInfo, otherWork, alt2type_2256)
            }
        }
        if Lns_op_not(Ast_CanEvalCtrlTypeInfo_isValidApply(alt2type_2256)){
            workAlt2type = nil
            
        } else { 
            workAlt2type = alt2type_2256
    ...
    if check(){
        if workAlt2type != nil{
            workAlt2type_2275 := workAlt2type.(*LnsMap)
            workAlt2type_2275.Set(&self.Ast_TypeInfo,other)
        }
        return true
    }
    return false
...
// 2551: decl @lune.@base.@Ast.AlternateTypeInfo.canEvalWith
...
// 2577: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng_with
func (self *Ast_AlternateTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if alt2type != nil{
        alt2type_2299 := alt2type.(*LnsMap)
        {
            _genType := alt2type_2299.Items[&self.Ast_TypeInfo]
            if _genType != nil {
                genType := _genType.(*Ast_TypeInfo)
                return genType.FP.Get_display_stirng_with(genType.FP.Get_rawTxt(), alt2type_2299)
            }
        }
    }
    return self.FP.GetTxtWithRaw(raw, nil, nil, nil)
...
// 2587: decl @lune.@base.@Ast.AlternateTypeInfo.get_display_stirng
func (self *Ast_AlternateTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.txt, nil)
}

// 2593: decl @lune.@base.@Ast.AlternateTypeInfo.equals
func (self *Ast_AlternateTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if alt2type != nil{
        alt2type_2322 := alt2type.(*LnsMap)
        return self.FP.canSetFrom(processInfo, typeInfo, nil, alt2type_2322)
    }
    return false
}

// 2621: decl @lune.@base.@Ast.AlternateTypeInfo.hasRouteNamespaceFrom
func (self *Ast_AlternateTypeInfo) HasRouteNamespaceFrom(other *Ast_TypeInfo) bool {
    return true
}

// 2626: decl @lune.@base.@Ast.AlternateTypeInfo.get_rawTxt
func (self *Ast_AlternateTypeInfo) Get_rawTxt() string {
    return self.txt
}

// 2630: decl @lune.@base.@Ast.AlternateTypeInfo.get_kind
func (self *Ast_AlternateTypeInfo) Get_kind() LnsInt {
    return Ast_TypeInfoKind__Alternate
}

// 2634: decl @lune.@base.@Ast.AlternateTypeInfo.get_nilable
func (self *Ast_AlternateTypeInfo) Get_nilable() bool {
    return false
}

// 2638: decl @lune.@base.@Ast.AlternateTypeInfo.get_mutMode
func (self *Ast_AlternateTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 2643: decl @lune.@base.@Ast.AlternateTypeInfo.getParentFullName
...
// 2650: decl @lune.@base.@Ast.AlternateTypeInfo.serialize
...
// 2662: decl @lune.@base.@Ast.AlternateTypeInfo.applyGeneric
...
// 4273: decl @lune.@base.@Ast.AlternateTypeInfo.getAssign
...
// 2729: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng
func (self *Ast_BoxTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 2733: decl @lune.@base.@Ast.BoxTypeInfo.get_display_stirng_with
...
// 2738: decl @lune.@base.@Ast.BoxTypeInfo.serialize
...
// 2745: decl @lune.@base.@Ast.BoxTypeInfo.equals
...
// 2756: decl @lune.@base.@Ast.BoxTypeInfo.createAlt2typeMap
...
// 4343: decl @lune.@base.@Ast.BoxTypeInfo.applyGeneric
func (self *Ast_BoxTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_3706 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateBox(self.accessMode, typeInfo_3706)
    }
    return nil
}

// 5581: decl @lune.@base.@Ast.BoxTypeInfo.canEvalWith
func (self *Ast_BoxTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if _switch22760 := canEvalType; _switch22760 == Ast_CanEvalType__SetOp || _switch22760 == Ast_CanEvalType__SetOpIMut || _switch22760 == Ast_CanEvalType__SetEq {
    } else {
        return false, nil
    }
    if other.FP.Get_nilable(){
...
// 2783: decl @lune.@base.@Ast.GenericTypeInfo.get_display_stirng_with
...
// 2826: decl @lune.@base.@Ast.GenericTypeInfo.getModule
func (self *Ast_GenericTypeInfo) GetModule() *Ast_TypeInfo {
    return self.moduleTypeInfo
}

// 2831: decl @lune.@base.@Ast.GenericTypeInfo.isInheritFrom
...
// 2872: decl @lune.@base.@Ast.GenericTypeInfo.get_srcTypeInfo
func (self *Ast_GenericTypeInfo) Get_srcTypeInfo() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2875: decl @lune.@base.@Ast.GenericTypeInfo.get_extedType
func (self *Ast_GenericTypeInfo) Get_extedType() *Ast_TypeInfo {
    return &self.Ast_TypeInfo
}

// 2880: decl @lune.@base.@Ast.GenericTypeInfo.canEvalWith
...
// 2941: decl @lune.@base.@Ast.GenericTypeInfo.equals
...
// 2974: decl @lune.@base.@Ast.GenericTypeInfo.serialize
...
// 2988: decl @lune.@base.@Ast.GenericTypeInfo.createAlt2typeMap
...
// 5107: decl @lune.@base.@Ast.GenericTypeInfo.applyGeneric
func (self *Ast_GenericTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    if self.genSrcTypeInfo.FP.Get_kind() == Ast_TypeInfoKind__Class{
        ...
        var newFlag bool
        itemTypeInfoList,newFlag = Ast_applyGenericList_4496_(self.FP.Get_itemTypeInfoList(), alt2typeMap, moduleTypeInfo)
        if itemTypeInfoList != nil{
            itemTypeInfoList_4237 := itemTypeInfoList.(*LnsList)
            if newFlag{
                return &moduleTypeInfo.FP.getProcessInfo().FP.CreateGeneric(self.genSrcTypeInfo, itemTypeInfoList_4237, moduleTypeInfo).Ast_TypeInfo
            }
        }
    }
...
// 3034: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng_with
...
// 3042: decl @lune.@base.@Ast.ModifierTypeInfo.get_display_stirng
func (self *Ast_ModifierTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3046: decl @lune.@base.@Ast.ModifierTypeInfo.serialize
...
// 3053: decl @lune.@base.@Ast.ModifierTypeInfo.canEvalWith
func (self *Ast_ModifierTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    if self.srcTypeInfo.FP.Get_itemTypeInfoList().Len() >= 1{
        if _switch10683 := canEvalType; _switch10683 == Ast_CanEvalType__SetEq || _switch10683 == Ast_CanEvalType__SetOp {
...
// 3083: decl @lune.@base.@Ast.ModifierTypeInfo.equals
...
// 4512: decl @lune.@base.@Ast.ModifierTypeInfo.get_nonnilableType
...
// 4520: decl @lune.@base.@Ast.ModifierTypeInfo.get_nilableTypeInfo
...
// 6402: decl @lune.@base.@Ast.ModifierTypeInfo.applyGeneric
func (self *Ast_ModifierTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    if typeInfo != nil{
        typeInfo_5041 := typeInfo.(*Ast_TypeInfo)
        return moduleTypeInfo.FP.getProcessInfo().FP.CreateModifier(typeInfo_5041, Ast_MutMode__IMut)
    }
    return nil
}
...
// 3178: decl @lune.@base.@Ast.ModuleTypeInfo.serialize
...
// 3317: decl @lune.@base.@Ast.EnumTypeInfo.addEnumValInfo
...
// 3322: decl @lune.@base.@Ast.EnumTypeInfo.getEnumValInfo
func (self *Ast_EnumTypeInfo) GetEnumValInfo(name string) LnsAny {
    return self.name2EnumValInfo.Items[name]
}

// 3326: decl @lune.@base.@Ast.EnumTypeInfo.get_mutMode
func (self *Ast_EnumTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 5504: decl @lune.@base.@Ast.EnumTypeInfo.serialize
func (self *Ast_EnumTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    {
        __collection22455 := self.name2EnumValInfo
        __sorted22455 := __collection22455.CreateKeyListStr()
        __sorted22455.Sort( LnsItemKindStr, nil )
        for _, ___key22455 := range( __sorted22455.Items ) {
            enumValInfo := __collection22455.Items[ ___key22455 ].(Ast_EnumValInfoDownCast).ToAst_EnumValInfo()
            stream.Write(Lns_getVM().String_format("%s = ", []LnsAny{enumValInfo.FP.Get_name()}))
            switch _exp22453 := enumValInfo.FP.Get_val().(type) {
            case *Ast_EnumLiteral__Int:
            val := _exp22453.Val1
...
// 3421: decl @lune.@base.@Ast.AlgeTypeInfo.get_mutMode
func (self *Ast_AlgeTypeInfo) Get_mutMode() LnsInt {
    return Ast_MutMode__Mut
}

// 3443: decl @lune.@base.@Ast.AlgeTypeInfo.addValInfo
...
// 5556: decl @lune.@base.@Ast.AlgeTypeInfo.serialize
func (self *Ast_AlgeTypeInfo) Serialize(stream Lns_oStream,validChildrenSet LnsAny) {
    ...
    firstFlag = true
    {
        __collection22696 := self.valInfoMap
        __sorted22696 := __collection22696.CreateKeyListStr()
        __sorted22696.Sort( LnsItemKindStr, nil )
        for _, ___key22696 := range( __sorted22696.Items ) {
            algeValInfo := __collection22696.Items[ ___key22696 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 3431: decl @lune.@base.@Ast.AlgeValInfo.serialize
...
// 3526: decl @lune.@base.@Ast.NormalTypeInfo.switchScopeTo
...
func (self *Ast_NormalTypeInfo) InitAst_NormalTypeInfo(processInfo *Ast_ProcessInfo,abstractFlag bool,scope LnsAny,baseTypeInfo LnsAny,interfaceList LnsAny,autoFlag bool,externalFlag bool,staticFlag bool,accessMode LnsInt,txt string,parentInfo LnsAny,typeId LnsInt,kind LnsInt,itemTypeInfoList LnsAny,argTypeInfoList LnsAny,retTypeInfoList LnsAny,mutMode LnsAny) {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.HasBase()})/* 3545:30 */)) )){
    ...
    setupAlt2typeMap = func() *LnsMap {
        ...
        var alt2typeMap *LnsMap
        alt2typeMap = NewLnsMap( map[LnsAny]LnsAny{})
        if _switch12757 := kind; _switch12757 == Ast_TypeInfoKind__Set || _switch12757 == Ast_TypeInfoKind__Map || _switch12757 == Ast_TypeInfoKind__List || _switch12757 == Ast_TypeInfoKind__Array || _switch12757 == Ast_TypeInfoKind__Box {
        ...
        } else if _switch12757 == Ast_TypeInfoKind__Class || _switch12757 == Ast_TypeInfoKind__IF {
            for _, _ifType := range( self.interfaceList.Items ) {
                ifType := _ifType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                {
    ...
    if kind == Ast_TypeInfoKind__Root{
        ...
        var hasNilable bool
        hasNilable = false
        if _switch12859 := (kind); _switch12859 == Ast_TypeInfoKind__Prim || _switch12859 == Ast_TypeInfoKind__List || _switch12859 == Ast_TypeInfoKind__Array || _switch12859 == Ast_TypeInfoKind__Set || _switch12859 == Ast_TypeInfoKind__Map || _switch12859 == Ast_TypeInfoKind__Class || _switch12859 == Ast_TypeInfoKind__Stem || _switch12859 == Ast_TypeInfoKind__Module || _switch12859 == Ast_TypeInfoKind__IF {
            hasNilable = true
            
        } else if _switch12859 == Ast_TypeInfoKind__Func || _switch12859 == Ast_TypeInfoKind__Method || _switch12859 == Ast_TypeInfoKind__Form || _switch12859 == Ast_TypeInfoKind__FormFunc {
            hasNilable = true
...
// 3634: decl @lune.@base.@Ast.NormalTypeInfo.createAlt2typeMap
...
// 3644: decl @lune.@base.@Ast.NormalTypeInfo.get_nilable
func (self *Ast_NormalTypeInfo) Get_nilable() bool {
    return false
}

// 3648: decl @lune.@base.@Ast.NormalTypeInfo.isModule
func (self *Ast_NormalTypeInfo) IsModule() bool {
    return false
}

// 3652: decl @lune.@base.@Ast.NormalTypeInfo.getParentId
func (self *Ast_NormalTypeInfo) GetParentId() LnsInt {
    return self.parentInfo.FP.Get_typeId()
}

// 3656: decl @lune.@base.@Ast.NormalTypeInfo.get_baseId
func (self *Ast_NormalTypeInfo) Get_baseId() LnsInt {
    return self.baseTypeInfo.FP.Get_typeId()
}

// 3661: decl @lune.@base.@Ast.NormalTypeInfo.getTxt
func (self *Ast_NormalTypeInfo) GetTxt(typeNameCtrl LnsAny,importInfo LnsAny,localFlag LnsAny) string {
    return self.FP.GetTxtWithRaw(self.FP.Get_rawTxt(), typeNameCtrl, importInfo, localFlag)
}

// 3667: decl @lune.@base.@Ast.NormalTypeInfo.getTxtWithRaw
...
// 3695: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng_with
func (self *Ast_NormalTypeInfo) Get_display_stirng_with(raw string,alt2type LnsAny) string {
    if _switch13296 := self.kind; _switch13296 == Ast_TypeInfoKind__Func || _switch13296 == Ast_TypeInfoKind__Form || _switch13296 == Ast_TypeInfoKind__FormFunc || _switch13296 == Ast_TypeInfoKind__Method || _switch13296 == Ast_TypeInfoKind__Macro {
        var txt string
        txt = raw + "("
...
// 3740: decl @lune.@base.@Ast.NormalTypeInfo.get_display_stirng
func (self *Ast_NormalTypeInfo) Get_display_stirng() string {
    return self.FP.Get_display_stirng_with(self.FP.Get_rawTxt(), nil)
}

// 3745: decl @lune.@base.@Ast.NormalTypeInfo.serialize
...
// 3776: decl @lune.@base.@Ast.NormalTypeInfo.equalsSub
func (self *Ast_NormalTypeInfo) EqualsSub(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if self.accessMode != typeInfo.FP.Get_accessMode(){
        if _switch13744 := self.kind; _switch13744 == Ast_TypeInfoKind__List || _switch13744 == Ast_TypeInfoKind__Map || _switch13744 == Ast_TypeInfoKind__Array || _switch13744 == Ast_TypeInfoKind__Set {
        } else {
            return false
        }
    }
...
// 3841: decl @lune.@base.@Ast.NormalTypeInfo.equals
...
// 3849: decl @lune.@base.@Ast.NormalTypeInfo.create
...
// 4067: decl @lune.@base.@Ast.NormalTypeInfo.createBuiltin
func Ast_NormalTypeInfo_createBuiltin(idName string,typeTxt string,kind LnsInt,typeDDD LnsAny,ifList LnsAny) *Ast_TypeInfo {
    ...
    var scope LnsAny
    scope = nil
    if _switch15157 := kind; _switch15157 == Ast_TypeInfoKind__Array || _switch15157 == Ast_TypeInfoKind__List || _switch15157 == Ast_TypeInfoKind__Set || _switch15157 == Ast_TypeInfoKind__Class || _switch15157 == Ast_TypeInfoKind__Module || _switch15157 == Ast_TypeInfoKind__IF || _switch15157 == Ast_TypeInfoKind__Form || _switch15157 == Ast_TypeInfoKind__FormFunc || _switch15157 == Ast_TypeInfoKind__Func || _switch15157 == Ast_TypeInfoKind__Method || _switch15157 == Ast_TypeInfoKind__Macro {
    ...
    if _switch15255 := kind; _switch15255 == Ast_TypeInfoKind__Array || _switch15255 == Ast_TypeInfoKind__List || _switch15255 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch15255 == Ast_TypeInfoKind__Map {
    ...
    Ast_registBuiltin_4074_(idName, typeTxt, kind, &info.Ast_TypeInfo, Ast_headTypeInfo, Ast_Scope2Stem(scope) != nil)
    return &info.Ast_TypeInfo
}

// 5683: decl @lune.@base.@Ast.NormalTypeInfo.isAvailableMapping
func Ast_NormalTypeInfo_isAvailableMapping(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,checkedTypeMap *LnsMap) bool {
    ...
    isAvailableMappingSub = func() bool {
        if _switch23355 := typeInfo.FP.Get_kind(); _switch23355 == Ast_TypeInfoKind__Prim || _switch23355 == Ast_TypeInfoKind__Enum {
            return true
        } else if _switch23355 == Ast_TypeInfoKind__Alge {
            ...
            return true
        } else if _switch23355 == Ast_TypeInfoKind__Stem {
            return true
        } else if _switch23355 == Ast_TypeInfoKind__Class || _switch23355 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch23355 == Ast_TypeInfoKind__Alternate {
            return typeInfo.FP.IsInheritFrom(processInfo, Ast_builtinTypeMapping, nil)
        } else if _switch23355 == Ast_TypeInfoKind__List || _switch23355 == Ast_TypeInfoKind__Array || _switch23355 == Ast_TypeInfoKind__Set {
        ...
        } else if _switch23355 == Ast_TypeInfoKind__Map {
            ...
            return false
        } else if _switch23355 == Ast_TypeInfoKind__Nilable {
...
// 5757: decl @lune.@base.@Ast.NormalTypeInfo.isInheritFrom
...
// 6392: decl @lune.@base.@Ast.NormalTypeInfo.canEvalWith
...
// 6416: decl @lune.@base.@Ast.NormalTypeInfo.applyGeneric
func (self *Ast_NormalTypeInfo) ApplyGeneric(alt2typeMap *LnsMap,moduleTypeInfo *Ast_TypeInfo) LnsAny {
    ...
    {
        _itemTypeInfoList, _needNew := Ast_applyGenericList_4496_(self.itemTypeInfoList, alt2typeMap, moduleTypeInfo)
    ...
    if _switch27525 := self.FP.Get_kind(); _switch27525 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch27525 == Ast_TypeInfoKind__Func || _switch27525 == Ast_TypeInfoKind__Form || _switch27525 == Ast_TypeInfoKind__FormFunc {
        var argTypeInfoList *LnsList
        var workArg bool
        
        {
            _argTypeInfoList, _workArg := Ast_applyGenericList_4496_(self.argTypeInfoList, alt2typeMap, moduleTypeInfo)
        ...
        {
            _retTypeInfoList, _workRet := Ast_applyGenericList_4496_(self.retTypeInfoList, alt2typeMap, moduleTypeInfo)
...
// 3902: decl @lune.@base.@Ast.TypeInfo2Map.clone
...
// 4584: decl @lune.@base.@Ast.DDDTypeInfo.get_extTypeFlag
func (self *Ast_DDDTypeInfo) Get_extTypeFlag() bool {
    return self.extedType != &self.Ast_TypeInfo
}

// 4588: decl @lune.@base.@Ast.DDDTypeInfo.get_scope
...
func (self *Ast_DDDTypeInfo) InitAst_DDDTypeInfo(processInfo *Ast_ProcessInfo,typeId LnsInt,typeInfo *Ast_TypeInfo,externalFlag bool,extOrgDDType LnsAny) {
    ...
    if extOrgDDType != nil{
        extOrgDDType_3922 := extOrgDDType.(*Ast_DDDTypeInfo)
        extOrgType = extOrgDDType_3922
...
// 4612: decl @lune.@base.@Ast.DDDTypeInfo.isModule
func (self *Ast_DDDTypeInfo) IsModule() bool {
    return false
}

// 4616: decl @lune.@base.@Ast.DDDTypeInfo.canEvalWith
...
// 4623: decl @lune.@base.@Ast.DDDTypeInfo.serialize
...
// 4630: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng_with
...
// 4636: decl @lune.@base.@Ast.DDDTypeInfo.get_display_stirng
...
// 5049: decl @lune.@base.@Ast.DDDTypeInfo.getTxtWithRaw
...
// 4764: decl @lune.@base.@Ast.CombineType.isInheritFrom
...
// 4776: decl @lune.@base.@Ast.CombineType.andIfSet
...
// 4795: decl @lune.@base.@Ast.CombineType.createStem
...
// 4809: decl @lune.@base.@Ast.CombineType.get_typeInfo
...
// 5141: decl @lune.@base.@Ast.AbbrTypeInfo.get_scope
...
// 5255: decl @lune.@base.@Ast.ExtTypeInfo.equals
func (self *Ast_ExtTypeInfo) Equals(processInfo *Ast_ProcessInfo,typeInfo *Ast_TypeInfo,alt2type LnsAny,checkModifer LnsAny) bool {
    ...
    if Lns_isCondTrue( Lns_car(Ast_failCreateLuavalWith_4133_(self.extedType, Ast_LuavalConvKind__InLua, false))){
        return false
    }
    return self.extedType.FP.Equals(processInfo, typeInfo, alt2type, checkModifer)
}

// 5271: decl @lune.@base.@Ast.ExtTypeInfo.canEvalWith
func (self *Ast_ExtTypeInfo) CanEvalWith(processInfo *Ast_ProcessInfo,other *Ast_TypeInfo,canEvalType LnsInt,alt2type *LnsMap)(bool, LnsAny) {
    ...
    {
        __exp := Ast_convExp21243(Lns_2DDD(Ast_failCreateLuavalWith_4133_(other, Ast_LuavalConvKind__ToLua, true)))
        if __exp != nil {
            _exp := __exp.(string)
            return false, _exp
        }
...
// 5295: decl @lune.@base.@Ast.ExtTypeInfo.serialize
...
// 6567: decl @lune.@base.@Ast.TypeAnalyzer.analyzeType
...
// 6578: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeFromTxt
...
// 6589: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeSub
...
// 6629: decl @lune.@base.@Ast.TypeAnalyzer.analyzeTypeItemList
func (self *Ast_TypeAnalyzer) AnalyzeTypeItemList(allowDDD bool,refFlag bool,mutFlag bool,typeInfo *Ast_TypeInfo,pos *Parser_Position)(LnsAny, LnsAny, LnsAny) {
    ...
    for  {
        if Lns_popVal( Lns_incStack() ||
            ...
            for {
                var refType LnsAny
                refType = Ast_convExp28476(Lns_2DDD(self.FP.analyzeTypeSub(false)))
                if refType != nil{
                    refType_5208 := refType.(*Ast_RefTypeInfo)
                    genericRefList.Insert(Ast_RefTypeInfo2Stem(refType_5208))
                    genericList.Insert(Ast_TypeInfo2Stem(refType_5208.FP.Get_typeInfo()))
                }
            ...
            if _switch29103 := typeInfo.FP.Get_kind(); _switch29103 == Ast_TypeInfoKind__Map {
            ...
            } else if _switch29103 == Ast_TypeInfoKind__List {
            ...
            } else if _switch29103 == Ast_TypeInfoKind__Array {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29103 == Ast_TypeInfoKind__Set {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29103 == Ast_TypeInfoKind__DDD {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29103 == Ast_TypeInfoKind__Class || _switch29103 == Ast_TypeInfoKind__IF {
            ...
            } else if _switch29103 == Ast_TypeInfoKind__Box {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
            ...
            } else if _switch29103 == Ast_TypeInfoKind__Ext {
                if genericList.Len() != 1{
                    return nil, pos, Lns_getVM().String_format("generic type count is unmatch. -- %d", []LnsAny{genericList.Len()})
                }
                
                switch _exp29081 := self.processInfo.FP.CreateLuaval(genericList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), true).(type) {
                case *Ast_LuavalResult__OK:
                extTypeInfo := _exp29081.Val1
...
func Lns_Ast_init() {
    ...
    Ast_AutoBoxingInfo____init_2047_()
    Ast_CanEvalCtrlTypeInfo____init_2077_()
    ...
    Ast_registBuiltin_4074_("Nilable", "Nilable", Ast_TypeInfoKind__Box, &Ast_builtinTypeBox.Ast_TypeInfo, Ast_headTypeInfo, true)
    Ast_builtinTypeNil = &NewAst_NilTypeInfo(Ast_rootProcessInfo).Ast_TypeInfo
    Ast_registBuiltin_4074_("Nil", "nil", Ast_TypeInfoKind__Prim, Ast_builtinTypeNil, Ast_headTypeInfo, false)
    Ast_builtinTypeDDD = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, false).Ast_TypeInfo
    Ast_registBuiltin_4074_("DDD", "...", Ast_TypeInfoKind__DDD, Ast_builtinTypeDDD, Ast_headTypeInfo, false)
    ...
    switch _exp21788 := Ast_rootProcessInfo.FP.CreateLuaval(Ast_builtinTypeStem, true).(type) {
    case *Ast_LuavalResult__OK:
    typeInfo := _exp21788.Val1
        Ast_builtinTypeLua = typeInfo
        
    default:
        Util_err("illegal")
    }
    Ast_registBuiltin_4074_("Luaval", "Luaval", Ast_TypeInfoKind__Ext, Ast_builtinTypeLua, Ast_headTypeInfo, false)
    Ast_builtinTypeDDDLua = &Ast_rootProcessInfo.FP.CreateDDD(Ast_builtinTypeStem_, true, true).Ast_TypeInfo
    Ast_registBuiltin_4074_("__LuaDDD", "__LuaDDD", Ast_TypeInfoKind__Ext, Ast_builtinTypeDDDLua, Ast_headTypeInfo, false)
