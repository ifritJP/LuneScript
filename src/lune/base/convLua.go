...
type convLua_outputMacroStmtBlock_2349_ func (_env *LnsEnv)
// for 3777
func convLua_convExp18849(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3516
func convLua_convExp17456(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 285
func convLua_convExp1112(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1328
func convLua_convExp6079(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 1329
func convLua_convExp6094(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 1339
func convLua_convExp6156(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 1347
func convLua_convExp6207(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 1415
func convLua_convExp6586(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 1477
func convLua_convExp6893(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 1812
func convLua_convExp8512(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 2901
func convLua_convExp14312(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2916
func convLua_convExp14388(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 3614
func convLua_convExp17854(arg1 []LnsAny) (LnsAny, string) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 3636
func convLua_convExp17970(arg1 []LnsAny) (LnsAny, string) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 ).(string)
}
// for 3706
func convLua_convExp18365(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3775
func convLua_convExp18597(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 3801
func convLua_convExp18922(arg1 []LnsAny) (string, string) {
...
// 1256: decl @lune.@base.@convLua.isGenericType
func convLua_isGenericType_1969_(_env *LnsEnv, typeInfo *Ast_TypeInfo) bool {
    if Ast_isGenericType(_env, typeInfo){
        return true
    }
    if _switch5788 := typeInfo.FP.Get_kind(_env); _switch5788 == Ast_TypeInfoKind__Class || _switch5788 == Ast_TypeInfoKind__IF {
...
// 3597: decl @lune.@base.@convLua.createFilter
...
// 3613: decl @lune.@base.@convLua.runLuaOnLns
func ConvLua_runLuaOnLns(_env *LnsEnv, code string)(LnsAny, string) {
    var loadFunc LnsAny
    var err string
    loadFunc,err = DependLuaOnLns_runLuaOnLns(_env, code)
    if loadFunc != nil{
        loadFunc_1808 := loadFunc.(*Lns_luaValue)
        var mod LnsAny
        mod = _env.CommonLuaVM.RunLoadedfunc(loadFunc_1808,[]LnsAny{})[0]
        if mod != nil{
            mod_1811 := mod
            return mod_1811, ""
        }
...
// 3685: decl @lune.@base.@convLua.createAstFromStream
...
// 3705: decl @lune.@base.@convLua.createAstFromFile
func ConvLua_createAstFromFile(_env *LnsEnv, scriptPath string,option *Option_Option) *TransUnit_ASTInfo {
    ...
    {
        _stream := convLua_convExp18365(Lns_2DDD(Lns_io_open(scriptPath, nil)))
        if _stream == nil{
...
// 3716: decl @lune.@base.@convLua.createAst
...
// 3724: decl @lune.@base.@convLua.getTestLnsCode
...
// 3756: decl @lune.@base.@convLua.Ast2Code
func convLua_Ast2Code_3747_(_env *LnsEnv, option *Option_Option,ast *TransUnit_ASTInfo,streamName string)(string, string) {
...
// 3774: decl @lune.@base.@convLua.runTestCode
func ConvLua_runTestCode(_env *LnsEnv, ctrl *Testing_Ctrl,luaCode string) {
    var loaded LnsAny
    var mess LnsAny
    loaded,mess = _env.CommonLuaVM.Load(luaCode, nil)
    if loaded != nil{
        loaded_1899 := loaded.(*Lns_luaValue)
        {
            _mod := convLua_convExp18849(Lns_2DDD(_env.CommonLuaVM.RunLoadedfunc(loaded_1899,Lns_2DDD([]LnsAny{}))[0]))
            if !Lns_IsNil( _mod ) {
                mod := _mod
                {
                    ...
                    if !Lns_IsNil( _listobj ) {
                        ...
                        if ctrl.FP.CheckEq(_env, strList.Len(), 4, "#strList", "4", nil, convLua__mod__, 3780){
                            ctrl.FP.CheckEq(_env, strList.GetAt(1).(string), "hello world", "strList[ 1 ]", "\"hello world\"", nil, convLua__mod__, 3781)
                            ctrl.FP.CheckEq(_env, strList.GetAt(2).(string), "11", "strList[ 2 ]", "\"11\"", nil, convLua__mod__, 3782)
                            ctrl.FP.CheckEq(_env, strList.GetAt(3).(string), "12", "strList[ 3 ]", "\"12\"", nil, convLua__mod__, 3783)
                            ctrl.FP.CheckEq(_env, strList.GetAt(4).(string), "13", "strList[ 4 ]", "\"13\"", nil, convLua__mod__, 3784)
                        }
                    }
                }
            }
...
type convLua_ConvFilterMtd interface {
    ...
    OutputDeclMacro(_env *LnsEnv, arg1 string, arg2 *LnsList, arg3 convLua_outputMacroStmtBlock_2349_)
...
func (self *convLua_ConvFilter) ProcessImport(_env *LnsEnv, node *Nodes_ImportNode,_opt LnsAny) {
    ...
    var modSym string
    modSym = convLua_convExp1112(Lns_2DDD(_env.LuaVM.String_gsub(modulePath,".*%.", "")))
    modSym = info.FP.Get_assignName(_env)
    
    self.FP.Write(_env, _env.LuaVM.String_format("local %s = _lune.", []LnsAny{modSym}))
    if _switch1164 := info.FP.Get_lazy(_env); _switch1164 == Nodes_LazyLoad__Off {
        self.FP.Write(_env, "loadModule")
    } else if _switch1164 == Nodes_LazyLoad__On || _switch1164 == Nodes_LazyLoad__Auto {
        self.FP.Write(_env, "_lazyImport")
    }
    self.FP.Write(_env, _env.LuaVM.String_format("( '%s' )", []LnsAny{modulePath}))
}

// 326: decl @lune.@base.@convLua.ConvFilter.outputMeta
func (self *convLua_ConvFilter) outputMeta(_env *LnsEnv, node *Nodes_RootNode) {
    ...
    importNameMap = NewLnsMap( map[LnsAny]LnsAny{})
    {
        ...
        index = 0
        {
            __collection1528 := importNameMap
            __sorted1528 := __collection1528.CreateKeyListStr()
            __sorted1528.Sort( LnsItemKindStr, nil )
            for _, ___key1528 := range( __sorted1528.Items ) {
                moduleInfo := __collection1528.Items[ ___key1528 ].(FrontInterface_ModuleInfoDownCast).ToFrontInterface_ModuleInfo()
                index = index + 1
    ...
    pickupTypeId = func(_env *LnsEnv, typeInfo *Ast_TypeInfo,forceFlag LnsAny,pickupChildFlag LnsAny) {
            ...
            if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                ...
                for _, _itemTypeInfo := range( typeInfo.FP.Get_children(_env).Items ) {
                    ...
                    if Ast_isPubToExternal(_env, itemTypeInfo.FP.Get_accessMode(_env)){
                        if _switch1804 := itemTypeInfo.FP.Get_kind(_env); _switch1804 == Ast_TypeInfoKind__Class || _switch1804 == Ast_TypeInfoKind__IF || _switch1804 == Ast_TypeInfoKind__Form || _switch1804 == Ast_TypeInfoKind__FormFunc || _switch1804 == Ast_TypeInfoKind__Func || _switch1804 == Ast_TypeInfoKind__Method {
        ...
        if typeInfo != typeInfo.FP.Get_srcTypeInfo(_env){
            ...
            if Lns_op_not(typeInfo.FP.Get_externalFlag(_env)){
                if _switch1991 := typeInfo.FP.Get_kind(_env); _switch1991 == Ast_TypeInfoKind__IF || _switch1991 == Ast_TypeInfoKind__Class || _switch1991 == Ast_TypeInfoKind__Form || _switch1991 == Ast_TypeInfoKind__FormFunc || _switch1991 == Ast_TypeInfoKind__Alge || _switch1991 == Ast_TypeInfoKind__Enum || _switch1991 == Ast_TypeInfoKind__Map || _switch1991 == Ast_TypeInfoKind__Set || _switch1991 == Ast_TypeInfoKind__List || _switch1991 == Ast_TypeInfoKind__Array || _switch1991 == Ast_TypeInfoKind__Alternate || _switch1991 == Ast_TypeInfoKind__Box {
            ...
            if Lns_isCondTrue( pickupChildFlag){
                for _, _itemTypeInfo := range( typeInfo.FP.Get_children(_env).Items ) {
                    ...
                    if itemTypeInfo.FP.Get_accessMode(_env) == Ast_AccessMode__Pub{
                        if _switch2155 := itemTypeInfo.FP.Get_kind(_env); _switch2155 == Ast_TypeInfoKind__Class || _switch2155 == Ast_TypeInfoKind__IF || _switch2155 == Ast_TypeInfoKind__Form || _switch2155 == Ast_TypeInfoKind__FormFunc || _switch2155 == Ast_TypeInfoKind__Func || _switch2155 == Ast_TypeInfoKind__Method {
                            pickupTypeId(_env, itemTypeInfo, true, true)
                        }
                    }
                }
    ...
    {
        __collection2555 := classId2TypeInfo
        __sorted2555 := __collection2555.CreateKeyListInt()
        __sorted2555.Sort( LnsItemKindInt, nil )
        for _, _classTypeId := range( __sorted2555.Items ) {
            classTypeInfo := __collection2555.Items[ _classTypeId ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
    ...
    for  {
        ...
        {
            __collection2876 := workClassMap
            __sorted2876 := __collection2876.CreateKeyListInt()
            __sorted2876.Sort( LnsItemKindInt, nil )
            for _, _classTypeId := range( __sorted2876.Items ) {
                classTypeInfo := __collection2876.Items[ _classTypeId ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                classTypeId := _classTypeId.(LnsInt)
                if Lns_op_not(Ast_isBuiltin(_env, classTypeId)){
                    ...
                    if Lns_isCondTrue( checkExportTypeInfo(_env, classTypeInfo)){
                        ...
                        self.FP.writeln(_env, _env.LuaVM.String_format("__typeId2ClassInfoMap[ %d ] = __classInfo%d", []LnsAny{classTypeId, classTypeId}))
                        {
                            __collection2854 := scope.FP.Get_symbol2SymbolInfoMap(_env)
                            __sorted2854 := __collection2854.CreateKeyListStr()
                            __sorted2854.Sort( LnsItemKindStr, nil )
                            for _, _fieldName := range( __sorted2854.Items ) {
                                symbolInfo := __collection2854.Items[ _fieldName ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
    ...
    for _, _macroDeclNode := range( node.FP.Get_nodeManager(_env).FP.GetDeclMacroNodeList(_env).Items ) {
        ...
        if declInfo.FP.Get_pubFlag(_env){
            ...
            firstFlag = true
            {
                __collection3143 := macroInfo.Symbol2MacroValInfoMap
                __sorted3143 := __collection3143.CreateKeyListStr()
                __sorted3143.Sort( LnsItemKindStr, nil )
                for _, _name := range( __sorted3143.Items ) {
                    symInfo := __collection3143.Items[ _name ].(Nodes_MacroValInfoDownCast).ToNodes_MacroValInfo()
                    name := _name.(string)
                    if firstFlag{
                        firstFlag = false
    ...
    {
        __collection3492 := self.pubVarName2InfoMap
        __sorted3492 := __collection3492.CreateKeyListStr()
        __sorted3492.Sort( LnsItemKindStr, nil )
        for _, _varName := range( __sorted3492.Items ) {
            varInfo := __collection3492.Items[ _varName ].(convLua_PubVerInfoDownCast).ToconvLua_PubVerInfo()
    ...
    {
        __collection3509 := self.pubFuncName2InfoMap
        __sorted3509 := __collection3509.CreateKeyListStr()
        __sorted3509.Sort( LnsItemKindStr, nil )
        for _, ___key3509 := range( __sorted3509.Items ) {
            funcInfo := __collection3509.Items[ ___key3509 ].(convLua_PubFuncInfoDownCast).ToconvLua_PubFuncInfo()
    ...
    outputTypeInfo = func(_env *LnsEnv, typeInfo *Ast_TypeInfo) {
        ...
        if _switch3708 := typeInfo.FP.Get_kind(_env); _switch3708 == Ast_TypeInfoKind__Class || _switch3708 == Ast_TypeInfoKind__IF {
            if _switch3706 := typeInfo.FP.Get_accessMode(_env); _switch3706 == Ast_AccessMode__Pub || _switch3706 == Ast_AccessMode__Pro || _switch3706 == Ast_AccessMode__Global {
            } else {
    ...
    for _typeId, _typeInfo := range( self.pubAlgeId2AlgeTypeInfo.Items ) {
        ...
        typeId2TypeInfo.Set(typeId,&typeInfo.Ast_TypeInfo)
        {
            __collection3857 := typeInfo.FP.Get_valInfoMap(_env)
            __sorted3857 := __collection3857.CreateKeyListStr()
            __sorted3857.Sort( LnsItemKindStr, nil )
            for _, ___key3857 := range( __sorted3857.Items ) {
                valInfo := __collection3857.Items[ ___key3857 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
    ...
    exportNeedModuleTypeInfo = NewLnsSet([]LnsAny{})
    {
        ...
        {
            __collection4067 := module2TypeList
            __sorted4067 := __collection4067.CreateKeyListInt()
            __sorted4067.Sort( LnsItemKindInt, nil )
            for _, ___key4067 := range( __sorted4067.Items ) {
                _map := __collection4067.Items[ ___key4067 ].(*LnsMap)
                {
                    __collection4065 := _map
                    __sorted4065 := __collection4065.CreateKeyListInt()
                    __sorted4065.Sort( LnsItemKindInt, nil )
                    for _, ___key4065 := range( __sorted4065.Items ) {
                        typeInfo := __collection4065.Items[ ___key4065 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                        var moduleTypeInfo *Ast_TypeInfo
                        moduleTypeInfo = typeInfo.FP.GetModule(_env)
    ...
    {
        __collection4155 := importNameMap
        __sorted4155 := __collection4155.CreateKeyListStr()
        __sorted4155.Sort( LnsItemKindStr, nil )
        for _, _name := range( __sorted4155.Items ) {
            moduleInfo := __collection4155.Items[ _name ].(FrontInterface_ModuleInfoDownCast).ToFrontInterface_ModuleInfo()
            name := _name.(string)
            var moduleTypeInfo *Ast_TypeInfo
...
// 975: decl @lune.@base.@convLua.ConvFilter.processRoot
...
// 1082: decl @lune.@base.@convLua.ConvFilter.processSubfile
func (self *convLua_ConvFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}

// 1087: decl @lune.@base.@convLua.ConvFilter.processAsyncLock
...
// 1094: decl @lune.@base.@convLua.ConvFilter.processBlockSub
func (self *convLua_ConvFilter) ProcessBlockSub(_env *LnsEnv, node *Nodes_BlockNode,_opt LnsAny) {
    var word string
    word = ""
    if _switch5183 := node.FP.Get_blockKind(_env); _switch5183 == Nodes_BlockKind__If || _switch5183 == Nodes_BlockKind__Elseif {
        word = "then"
        
    } else if _switch5183 == Nodes_BlockKind__Else {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__While {
        word = "do"
        
    } else if _switch5183 == Nodes_BlockKind__Repeat {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__For {
        word = "do"
        
    } else if _switch5183 == Nodes_BlockKind__Apply {
        word = "do"
        
    } else if _switch5183 == Nodes_BlockKind__Foreach {
        word = "do"
        
    } else if _switch5183 == Nodes_BlockKind__Macro {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__Func {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__Default {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__Block || _switch5183 == Nodes_BlockKind__AsyncLock {
        word = "do"
        
    } else if _switch5183 == Nodes_BlockKind__LetUnwrap {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__LetUnwrapThenDo {
        word = ""
        
    } else if _switch5183 == Nodes_BlockKind__IfUnwrap {
        word = ""
    ...
    self.FP.popIndent(_env)
    if _switch5276 := node.FP.Get_blockKind(_env); _switch5276 == Nodes_BlockKind__Block || _switch5276 == Nodes_BlockKind__AsyncLock {
        self.FP.writeln(_env, "end")
    }
}

// 1164: decl @lune.@base.@convLua.ConvFilter.processLoadRuntime
...
// 1174: decl @lune.@base.@convLua.ConvFilter.processScope
...
// 1184: decl @lune.@base.@convLua.ConvFilter.processStmtExp
...
// 1190: decl @lune.@base.@convLua.ConvFilter.processDeclEnum
...
// 1272: decl @lune.@base.@convLua.ConvFilter.getMapInfo
func (self *convLua_ConvFilter) getMapInfo(_env *LnsEnv, typeInfo *Ast_TypeInfo)(string, bool, string) {
    ...
    var funcTxt string
    funcTxt = ""
    if _switch6268 := nonnilableType.FP.Get_kind(_env); _switch6268 == Ast_TypeInfoKind__Stem {
        funcTxt = "_lune._toStem"
        
    } else if _switch6268 == Ast_TypeInfoKind__Class || _switch6268 == Ast_TypeInfoKind__IF {
        if Lns_op_not(nonnilableType.FP.Equals(_env, self.processInfo, Ast_builtinTypeString, nil, nil)){
            if Ast_NormalTypeInfo_isAvailableMapping(_env, self.processInfo, nonnilableType, NewLnsMap( map[LnsAny]LnsAny{})){
                ...
                if convLua_isGenericType_1969_(_env, nonnilableType){
                    var memStream *Util_memStream
                    memStream = NewUtil_memStream(_env)
    ...
    } else if _switch6268 == Ast_TypeInfoKind__Enum || _switch6268 == Ast_TypeInfoKind__Alge {
        funcTxt = _env.LuaVM.String_format("%s._from", []LnsAny{self.FP.getFullName(_env, nonnilableType)})
        
    } else if _switch6268 == Ast_TypeInfoKind__Prim {
        if _switch6048 := nonnilableType; _switch6048 == Ast_builtinTypeInt {
            funcTxt = "_lune._toInt"
            
        } else if _switch6048 == Ast_builtinTypeReal {
            funcTxt = "_lune._toReal"
            
        } else if _switch6048 == Ast_builtinTypeBool {
    ...
    } else if _switch6268 == Ast_TypeInfoKind__Map {
    ...
    } else if _switch6268 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch6268 == Ast_TypeInfoKind__List || _switch6268 == Ast_TypeInfoKind__Array {
    ...
    } else if _switch6268 == Ast_TypeInfoKind__Alternate {
        var prefix string
...
// 1362: decl @lune.@base.@convLua.ConvFilter.processDeclAlge
func (self *convLua_ConvFilter) ProcessDeclAlge(_env *LnsEnv, node *Nodes_DeclAlgeNode,_opt LnsAny) {
    ...
    {
        __collection6660 := node.FP.Get_algeType(_env).FP.Get_valInfoMap(_env)
        __sorted6660 := __collection6660.CreateKeyListStr()
        __sorted6660.Sort( LnsItemKindStr, nil )
        for _, ___key6660 := range( __sorted6660.Items ) {
            valInfo := __collection6660.Items[ ___key6660 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 1430: decl @lune.@base.@convLua.ConvFilter.processNewAlgeVal
...
// 1451: decl @lune.@base.@convLua.ConvFilter.getDestrClass
...
// 1464: decl @lune.@base.@convLua.ConvFilter.outputAlter2MapFunc
...
// 1489: decl @lune.@base.@convLua.ConvFilter.processProtoClass
...
// 1495: decl @lune.@base.@convLua.ConvFilter.processDeclClass
func (self *convLua_ConvFilter) ProcessDeclClass(_env *LnsEnv, node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    self.classId2MemberList.Set(classTypeId,nodeInfo.FP.Get_memberList(_env))
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            if _switch7127 := node.FP.Get_accessMode(_env); _switch7127 == Ast_AccessMode__Pub || _switch7127 == Ast_AccessMode__Pro {
                if self.needModuleObj{
                    self.FP.writeln(_env, "")
    ...
    if classTypeInfo.FP.IsInheritFrom(_env, self.processInfo, Ast_builtinTypeMapping, nil){
        ...
        var argTxt string
        argTxt = "{}, val"
        if convLua_isGenericType_1969_(_env, classTypeInfo){
...
// 1828: decl @lune.@base.@convLua.ConvFilter.processDeclMember
func (self *convLua_ConvFilter) ProcessDeclMember(_env *LnsEnv, node *Nodes_DeclMemberNode,_opt LnsAny) {
}

// 1835: decl @lune.@base.@convLua.ConvFilter.processExpMacroExp
...
// 1847: decl @lune.@base.@convLua.ConvFilter.outputDeclMacro
func (self *convLua_ConvFilter) OutputDeclMacro(_env *LnsEnv, name string,argNameList *LnsList,callback convLua_outputMacroStmtBlock_2349_) {
...
// 1891: decl @lune.@base.@convLua.ConvFilter.processExpMacroStatList
...
// 1899: decl @lune.@base.@convLua.ConvFilter.processDeclMacro
func (self *convLua_ConvFilter) ProcessDeclMacro(_env *LnsEnv, node *Nodes_DeclMacroNode,_opt LnsAny) {
    if self.inMacro{
        ...
        self.FP.OutputDeclMacro(_env, macroInfo.FP.Get_name(_env).Txt, argNameList, convLua_outputMacroStmtBlock_2349_(func(_env *LnsEnv) {
            {
...
// 1918: decl @lune.@base.@convLua.ConvFilter.processExpMacroStat
...
// 1936: decl @lune.@base.@convLua.ConvFilter.processExpNew
...
// 1947: decl @lune.@base.@convLua.ConvFilter.process__func__symbol
...
// 1961: decl @lune.@base.@convLua.ConvFilter.processDeclConstr
...
// 2016: decl @lune.@base.@convLua.ConvFilter.processDeclDestr
func (self *convLua_ConvFilter) ProcessDeclDestr(_env *LnsEnv, node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_TypeInfo).FP.GetTxt(_env, nil, nil, nil)})/* 2020:9 */)}))
...
// 2036: decl @lune.@base.@convLua.ConvFilter.processExpCallSuperCtor
...
// 2055: decl @lune.@base.@convLua.ConvFilter.processExpCallSuper
...
// 2071: decl @lune.@base.@convLua.ConvFilter.processDeclMethod
...
// 2104: decl @lune.@base.@convLua.ConvFilter.processUnwrapSet
...
// 2137: decl @lune.@base.@convLua.ConvFilter.processExpListSub
...
// 2164: decl @lune.@base.@convLua.ConvFilter.processExpMRet
...
// 2170: decl @lune.@base.@convLua.ConvFilter.processIfUnwrap
...
// 2213: decl @lune.@base.@convLua.ConvFilter.processWhen
...
// 2235: decl @lune.@base.@convLua.ConvFilter.processDeclVar
...
// 2347: decl @lune.@base.@convLua.ConvFilter.processDeclArg
...
// 2355: decl @lune.@base.@convLua.ConvFilter.processDeclArgDDD
func (self *convLua_ConvFilter) ProcessDeclArgDDD(_env *LnsEnv, node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.Write(_env, "...")
}

// 2361: decl @lune.@base.@convLua.ConvFilter.processDeclFunc
...
// 2402: decl @lune.@base.@convLua.ConvFilter.processRefType
func (self *convLua_ConvFilter) ProcessRefType(_env *LnsEnv, node *Nodes_RefTypeNode,_opt LnsAny) {
    if _switch11596 := node.FP.Get_mutMode(_env); _switch11596 == Ast_MutMode__IMut {
        self.FP.Write(_env, "&")
    } else if _switch11596 == Ast_MutMode__AllMut {
        self.FP.Write(_env, "+")
    }
...
// 2422: decl @lune.@base.@convLua.ConvFilter.processIf
...
// 2444: decl @lune.@base.@convLua.ConvFilter.processSwitch
...
// 2487: decl @lune.@base.@convLua.ConvFilter.processMatch
...
// 2526: decl @lune.@base.@convLua.ConvFilter.processWhile
...
// 2537: decl @lune.@base.@convLua.ConvFilter.processRepeat
...
// 2546: decl @lune.@base.@convLua.ConvFilter.processFor
...
// 2562: decl @lune.@base.@convLua.ConvFilter.processApply
...
// 2580: decl @lune.@base.@convLua.ConvFilter.processForeach
func (self *convLua_ConvFilter) ProcessForeach(_env *LnsEnv, node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    self.FP.Write(_env, "for ")
    if keySym != nil{
        keySym_1245 := keySym.(*Ast_SymbolInfo)
        self.FP.Write(_env, convLua_getSymTxt_1066_(_env, keySym_1245.FP.Get_name(_env), _env.LuaVM.String_format("%d", []LnsAny{keySym_1245.FP.Get_symbolId(_env)})))
    } else {
        self.FP.Write(_env, "__index")
    }
    self.FP.Write(_env, ", ")
    if valSym != nil{
        valSym_1248 := valSym.(*Ast_SymbolInfo)
        self.FP.Write(_env, convLua_getSymTxt_1066_(_env, valSym_1248.FP.Get_name(_env), _env.LuaVM.String_format("%d", []LnsAny{valSym_1248.FP.Get_symbolId(_env)})))
    } else {
...
// 2630: decl @lune.@base.@convLua.ConvFilter.processForsort
func (self *convLua_ConvFilter) ProcessForsort(_env *LnsEnv, node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    key = "__key"
    if keySym != nil{
        keySym_1267 := keySym.(*Ast_SymbolInfo)
        key = convLua_getSymTxt_1066_(_env, keySym_1267.FP.Get_name(_env), _env.LuaVM.String_format("%d", []LnsAny{keySym_1267.FP.Get_symbolId(_env)}))
    ...
    self.FP.pushIndent(_env, nil)
    if valSym != nil{
        valSym_1269 := valSym.(*Ast_SymbolInfo)
        self.FP.writeln(_env, _env.LuaVM.String_format("local %s = __map[ %s ]", []LnsAny{convLua_getSymTxt_1066_(_env, valSym_1269.FP.Get_name(_env), _env.LuaVM.String_format("%d", []LnsAny{valSym_1269.FP.Get_symbolId(_env)})), key}))
    }
    convLua_filter_1253_(_env, &node.FP.Get_block(_env).Nodes_Node, self, &node.Nodes_Node)
    self.FP.writeln(_env, "end")
    self.FP.popIndent(_env)
...
// 2683: decl @lune.@base.@convLua.ConvFilter.processExpUnwrap
...
// 2701: decl @lune.@base.@convLua.ConvFilter.processExpCall
func (self *convLua_ConvFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    fieldCall = func(_env *LnsEnv) bool {
        ...
        processSet = func(_env *LnsEnv) bool {
            ...
            if _switch13475 := fieldNode.FP.Get_field(_env).Txt; _switch13475 == "add" || _switch13475 == "del" {
                ...
                self.FP.Write(_env, "]")
                if _switch13469 := fieldNode.FP.Get_field(_env).Txt; _switch13469 == "add" {
                    self.FP.Write(_env, "= true")
                } else if _switch13469 == "del" {
                    self.FP.Write(_env, "= nil")
                }
                return false
            }
        ...
        if node.FP.Get_nilAccess(_env){
            ...
            if _switch13729 := prefixType.FP.Get_kind(_env); _switch13729 == Ast_TypeInfoKind__List || _switch13729 == Ast_TypeInfoKind__Array {
            ...
            if _switch13975 := prefixType.FP.Get_kind(_env); _switch13975 == Ast_TypeInfoKind__List || _switch13975 == Ast_TypeInfoKind__Array {
                setArgFlag = true
                ...
                convLua_filter_1253_(_env, prefixNode, self, &fieldNode.Nodes_Node)
            } else if _switch13975 == Ast_TypeInfoKind__Set {
                if Lns_op_not(processSet(_env)){
                    return false
                }
            } else if _switch13975 == Ast_TypeInfoKind__Enum || _switch13975 == Ast_TypeInfoKind__Alge {
                processEnumAlge(_env)
            } else if _switch13975 == Ast_TypeInfoKind__Box {
                convLua_filter_1253_(_env, prefixNode, self, &fieldNode.Nodes_Node)
                self.FP.Write(_env, "[1]")
                return false
            } else if _switch13975 == Ast_TypeInfoKind__Class {
                if Lns_isCondTrue( _env.PopVal( _env.IncStack() ||
                    _env.SetStackVal( prefixType.FP.IsInheritFrom(_env, self.processInfo, Ast_builtinTypeMapping, nil)) &&
                    _env.SetStackVal( convLua_isGenericType_1969_(_env, prefixType)) &&
                    _env.SetStackVal( (_env.PopVal( _env.IncStack() ||
    ...
    }
    {
        ...
        if !Lns_IsNil( _argList ) {
            ...
            if convStrFlag{
                ...
                if expList.Len() > 0{
                    var literal LnsAny
                    literal = convLua_convExp14312(Lns_2DDD(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node().FP.GetLiteral(_env)))
                    if literal != nil{
                        literal_1359 := literal
                        switch _exp14332 := literal_1359.(type) {
                ...
                for _index, _argNode := range( expList.Items ) {
                    ...
                    if index > 1{
                        ...
                        if index - 1 <= opList.Len(){
                            var formType LnsInt
                            formType = convLua_convExp14388(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index - 1).(string), argNode.FP.Get_expType(_env), self.targetLuaVer)))
...
// 2938: decl @lune.@base.@convLua.ConvFilter.processExpList
...
// 2947: decl @lune.@base.@convLua.ConvFilter.processExpOp1
func (self *convLua_ConvFilter) ProcessExpOp1(_env *LnsEnv, node *Nodes_ExpOp1Node,_opt LnsAny) {
    ...
    if op == ",,,"{
        ...
        if _switch14683 := node.FP.Get_exp(_env).FP.Get_expType(_env); _switch14683 == Ast_builtinTypeInt || _switch14683 == Ast_builtinTypeReal || _switch14683 == Ast_builtinTypeBool {
            convLua_filter_1253_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
        } else {
...
func (self *convLua_ConvFilter) ProcessExpCast(_env *LnsEnv, node *Nodes_ExpCastNode,_opt LnsAny) {
    ...
    } else if _switch15102 == Nodes_CastKind__Normal {
        self.FP.Write(_env, "_lune.__Cast( ")
        convLua_filter_1253_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
        var castKind LnsInt
        var classObj string
        classObj = "nil"
        if _switch15066 := node.FP.Get_expType(_env).FP.Get_nonnilableType(_env); _switch15066 == Ast_builtinTypeInt {
            castKind = LuaMod_CastKind__Int
            
        } else if _switch15066 == Ast_builtinTypeReal {
            castKind = LuaMod_CastKind__Real
            
        } else if _switch15066 == Ast_builtinTypeString {
    ...
    } else if _switch15102 == Nodes_CastKind__Implicit {
        convLua_filter_1253_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
    }
}

// 3055: decl @lune.@base.@convLua.ConvFilter.processExpParen
...
// 3064: decl @lune.@base.@convLua.ConvFilter.processExpSetVal
...
// 3089: decl @lune.@base.@convLua.ConvFilter.processExpOp2
func (self *convLua_ConvFilter) ProcessExpOp2(_env *LnsEnv, node *Nodes_ExpOp2Node,_opt LnsAny) {
    ...
    opTxt = node.FP.Get_op(_env).Txt
    {
        ...
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(LnsInt)
            if self.targetLuaVer.FP.Get_hasBitOp(_env) == LuaVer_BitOp__HasOp{
                if _switch15392 := _exp; _switch15392 == Ast_BitOpKind__LShift {
                    opTxt = "<<"
                    
                } else if _switch15392 == Ast_BitOpKind__RShift {
                    opTxt = ">>"
                ...
                var exp2Mod string
                exp2Mod = ""
                if _switch15509 := _exp; _switch15509 == Ast_BitOpKind__And {
                    binfunc = "band"
                    
                } else if _switch15509 == Ast_BitOpKind__Or {
                    binfunc = "bor"
                    
                } else if _switch15509 == Ast_BitOpKind__Xor {
                    binfunc = "bxor"
                    
                } else if _switch15509 == Ast_BitOpKind__LShift {
                    binfunc = "lshift"
                    
                } else if _switch15509 == Ast_BitOpKind__RShift {
                    binfunc = "lshift"
...
// 3159: decl @lune.@base.@convLua.ConvFilter.processExpRef
func (self *convLua_ConvFilter) ProcessExpRef(_env *LnsEnv, node *Nodes_ExpRefNode,_opt LnsAny) {
    if _switch15802 := node.FP.Get_symbolInfo(_env).FP.Get_name(_env); _switch15802 == "super" {
        var funcType *Ast_TypeInfo
...
// 3195: decl @lune.@base.@convLua.ConvFilter.processExpRefItem
...
// 3237: decl @lune.@base.@convLua.ConvFilter.processRefField
...
// 3269: decl @lune.@base.@convLua.ConvFilter.processExpOmitEnum
...
// 3280: decl @lune.@base.@convLua.ConvFilter.processGetField
...
// 3319: decl @lune.@base.@convLua.ConvFilter.processJoinRunner
func (self *convLua_ConvFilter) ProcessJoinRunner(_env *LnsEnv, node *Nodes_JoinRunnerNode,_opt LnsAny) {
}

// 3325: decl @lune.@base.@convLua.ConvFilter.processReturn
...
// 3335: decl @lune.@base.@convLua.ConvFilter.processLuneKind
...
// 3348: decl @lune.@base.@convLua.ConvFilter.processTestCase
...
// 3370: decl @lune.@base.@convLua.ConvFilter.processTestBlock
...
// 3381: decl @lune.@base.@convLua.ConvFilter.processProvide
func (self *convLua_ConvFilter) ProcessProvide(_env *LnsEnv, node *Nodes_ProvideNode,_opt LnsAny) {
}

// 3386: decl @lune.@base.@convLua.ConvFilter.processAlias
...
// 3396: decl @lune.@base.@convLua.ConvFilter.processBoxing
...
// 3406: decl @lune.@base.@convLua.ConvFilter.processUnboxing
func (self *convLua_ConvFilter) ProcessUnboxing(_env *LnsEnv, node *Nodes_UnboxingNode,_opt LnsAny) {
    convLua_filter_1253_(_env, node.FP.Get_src(_env), self, &node.Nodes_Node)
    self.FP.Write(_env, "[1]")
}

// 3414: decl @lune.@base.@convLua.ConvFilter.processLiteralList
...
// 3426: decl @lune.@base.@convLua.ConvFilter.processLiteralSet
...
// 3444: decl @lune.@base.@convLua.ConvFilter.processLiteralMap
...
// 3462: decl @lune.@base.@convLua.ConvFilter.processLiteralArray
...
// 3475: decl @lune.@base.@convLua.ConvFilter.processLiteralChar
...
// 3481: decl @lune.@base.@convLua.ConvFilter.processLiteralInt
...
// 3489: decl @lune.@base.@convLua.ConvFilter.processLiteralReal
func (self *convLua_ConvFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.Write(_env, node.FP.Get_token(_env).Txt)
}

// 3496: decl @lune.@base.@convLua.ConvFilter.processLiteralString
    ...
    opList = TransUnit_findForm(_env, txt)
    {
        ...
        if !Lns_IsNil( _expList ) {
            ...
            for _index, _val := range( expList.FP.Get_expList(_env).Items ) {
                ...
                if index <= opList.Len(){
                    matchFlag = convLua_convExp17456(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index).(string), val.FP.Get_expType(_env), self.targetLuaVer)))
...
// 3562: decl @lune.@base.@convLua.ConvFilter.processLuneControl
...
// 3578: decl @lune.@base.@convLua.FilterInfo.outputLuaAndMeta
...
// 3585: decl @lune.@base.@convLua.FilterInfo.outputLua
func (self *ConvLua_FilterInfo) OutputLua(_env *LnsEnv, node *Nodes_RootNode) {
    node.FP.ProcessFilter(_env, self.filter, ConvLua_Opt2Stem(NewConvLua_Opt(_env, &node.Nodes_Node)))
}

// 3590: decl @lune.@base.@convLua.FilterInfo.outputMeta
...
// 3632: decl @lune.@base.@convLua.MacroEvalImp.evalFromMacroCode
func (self *ConvLua_MacroEvalImp) evalFromMacroCode(_env *LnsEnv, code string) *Lns_luaValue {
    ...
    Log_log(_env, Log_Level__Trace, __func__, 3634, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 3643: decl @lune.@base.@convLua.MacroEvalImp.evalFromCode
func (self *ConvLua_MacroEvalImp) EvalFromCode(_env *LnsEnv, processInfo *Ast_ProcessInfo,name string,argNameList *LnsList,code LnsAny) *Lns_luaValue {
    ...
    conv.FP.OutputDeclMacro(_env, name, argNameList, convLua_outputMacroStmtBlock_2349_(func(_env *LnsEnv) {
        if code != nil{
            code_1838 := code.(string)
            conv.FP.Write(_env, code_1838)
        }
    }))
    return self.FP.evalFromMacroCode(_env, stream.FP.Get_txt(_env))
}

// 3665: decl @lune.@base.@convLua.MacroEvalImp.eval
