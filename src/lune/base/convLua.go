...
type convLua_outputMacroStmtBlock_1411_ func ()
// for 3656
func convLua_convExp18524(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3443
func convLua_convExp17295(arg1 []LnsAny) LnsInt {
...
// for 2833
func convLua_convExp14161(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2848
func convLua_convExp14237(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 3592
func convLua_convExp18081(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
// 1194: decl @lune.@base.@convLua.isGenericType
func convLua_isGenericType_1344_(typeInfo *Ast_TypeInfo) bool {
    if Ast_isGenericType(typeInfo){
        return true
    }
    if _switch5627 := typeInfo.FP.Get_kind(); _switch5627 == Ast_TypeInfoKind__Class || _switch5627 == Ast_TypeInfoKind__IF {
...
// 3499: decl @lune.@base.@convLua.createFilter
...
// 3510: decl @lune.@base.@convLua.runLuaOnLns
func ConvLua_runLuaOnLns(code string)(LnsAny, string) {
    var loadFunc LnsAny
    var err string
    loadFunc,err = DependLuaOnLns_runLuaOnLns(code)
    if loadFunc != nil{
        loadFunc_7481 := loadFunc.(*Lns_luaValue)
        var mod LnsAny
        mod = Lns_getVM().RunLoadedfunc(loadFunc_7481,[]LnsAny{})[0]
        if mod != nil{
            mod_7484 := mod
            return mod_7484, ""
        }
...
// 3575: decl @lune.@base.@convLua.createAstFromStream
...
// 3598: decl @lune.@base.@convLua.createAst
...
// 3605: decl @lune.@base.@convLua.getTestLnsCode
...
// 3637: decl @lune.@base.@convLua.Ast2Code
func convLua_Ast2Code_1726_(option *Option_Option,ast *TransUnit_ASTInfo,streamName string)(string, string) {
...
// 3653: decl @lune.@base.@convLua.runTestCode
func ConvLua_runTestCode(ctrl *Testing_Ctrl,luaCode string) {
    var loaded LnsAny
    var mess LnsAny
    loaded,mess = Lns_getVM().Load(luaCode, nil)
    if loaded != nil{
        loaded_7568 := loaded.(*Lns_luaValue)
        {
            _mod := convLua_convExp18524(Lns_2DDD(Lns_getVM().RunLoadedfunc(loaded_7568,Lns_2DDD([]LnsAny{}))[0]))
            if !Lns_IsNil( _mod ) {
                mod := _mod
                {
                    ...
                    if !Lns_IsNil( _listobj ) {
                        ...
                        if ctrl.FP.CheckEq(strList.Len(), 4, "#strList", "4", nil, convLua__mod__, 3659){
                            ctrl.FP.CheckEq(strList.GetAt(1).(string), "hello world", "strList[ 1 ]", "\"hello world\"", nil, convLua__mod__, 3660)
                            ctrl.FP.CheckEq(strList.GetAt(2).(string), "11", "strList[ 2 ]", "\"11\"", nil, convLua__mod__, 3661)
                            ctrl.FP.CheckEq(strList.GetAt(3).(string), "12", "strList[ 3 ]", "\"12\"", nil, convLua__mod__, 3662)
                            ctrl.FP.CheckEq(strList.GetAt(4).(string), "13", "strList[ 4 ]", "\"13\"", nil, convLua__mod__, 3663)
                        }
                    }
                }
            }
...
type convLua_convFilterMtd interface {
    ...
    OutputDeclMacro(arg1 string, arg2 *LnsList, arg3 convLua_outputMacroStmtBlock_1411_)
...
func (self *convLua_convFilter) outputMeta(node *Nodes_RootNode) {
    ...
    importNameMap = NewLnsMap( map[LnsAny]LnsAny{})
    {
        ...
        index = 0
        {
            __collection1438 := importNameMap
            __sorted1438 := __collection1438.CreateKeyListStr()
            __sorted1438.Sort( LnsItemKindStr, nil )
            for _, ___key1438 := range( __sorted1438.Items ) {
                typeInfo := __collection1438.Items[ ___key1438 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                index = index + 1
    ...
    typeId2TypeInfo = NewLnsMap( map[LnsAny]LnsAny{})
    {
        ...
        work = node.FP.Get_moduleTypeInfo().FP.Get_parentInfo()
    ...
    pickupTypeId = func(typeInfo *Ast_TypeInfo,forceFlag LnsAny,pickupChildFlag LnsAny) {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                for _, _itemTypeInfo := range( typeInfo.FP.Get_children().Items ) {
                    ...
                    if Ast_isPubToExternal(itemTypeInfo.FP.Get_accessMode()){
                        if _switch1714 := itemTypeInfo.FP.Get_kind(); _switch1714 == Ast_TypeInfoKind__Class || _switch1714 == Ast_TypeInfoKind__IF || _switch1714 == Ast_TypeInfoKind__Form || _switch1714 == Ast_TypeInfoKind__FormFunc || _switch1714 == Ast_TypeInfoKind__Func || _switch1714 == Ast_TypeInfoKind__Method {
        ...
        if typeInfo != typeInfo.FP.Get_srcTypeInfo(){
            ...
            if Lns_op_not(typeInfo.FP.Get_externalFlag()){
                if _switch1923 := typeInfo.FP.Get_kind(); _switch1923 == Ast_TypeInfoKind__IF || _switch1923 == Ast_TypeInfoKind__Class || _switch1923 == Ast_TypeInfoKind__Form || _switch1923 == Ast_TypeInfoKind__FormFunc || _switch1923 == Ast_TypeInfoKind__Alge || _switch1923 == Ast_TypeInfoKind__Enum || _switch1923 == Ast_TypeInfoKind__Map || _switch1923 == Ast_TypeInfoKind__Set || _switch1923 == Ast_TypeInfoKind__List || _switch1923 == Ast_TypeInfoKind__Array || _switch1923 == Ast_TypeInfoKind__Alternate || _switch1923 == Ast_TypeInfoKind__Box {
            ...
            if Lns_isCondTrue( pickupChildFlag){
                for _, _itemTypeInfo := range( typeInfo.FP.Get_children().Items ) {
                    ...
                    if itemTypeInfo.FP.Get_accessMode() == Ast_AccessMode__Pub{
                        if _switch2087 := itemTypeInfo.FP.Get_kind(); _switch2087 == Ast_TypeInfoKind__Class || _switch2087 == Ast_TypeInfoKind__IF || _switch2087 == Ast_TypeInfoKind__Form || _switch2087 == Ast_TypeInfoKind__FormFunc || _switch2087 == Ast_TypeInfoKind__Func || _switch2087 == Ast_TypeInfoKind__Method {
                            pickupTypeId(itemTypeInfo, true, true)
                        }
                    }
                }
    ...
    {
        __collection2466 := classId2TypeInfo
        __sorted2466 := __collection2466.CreateKeyListInt()
        __sorted2466.Sort( LnsItemKindInt, nil )
        for _, _classTypeId := range( __sorted2466.Items ) {
            classTypeInfo := __collection2466.Items[ _classTypeId ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
    ...
    for  {
        ...
        {
            __collection2787 := workClassMap
            __sorted2787 := __collection2787.CreateKeyListInt()
            __sorted2787.Sort( LnsItemKindInt, nil )
            for _, _classTypeId := range( __sorted2787.Items ) {
                classTypeInfo := __collection2787.Items[ _classTypeId ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                classTypeId := _classTypeId.(LnsInt)
                if Lns_op_not(Ast_isBuiltin(classTypeId)){
                    ...
                    if Lns_isCondTrue( checkExportTypeInfo(classTypeInfo)){
                        ...
                        self.FP.writeln(Lns_getVM().String_format("__typeId2ClassInfoMap[ %d ] = __classInfo%d", []LnsAny{classTypeId, classTypeId}))
                        {
                            __collection2765 := scope.FP.Get_symbol2SymbolInfoMap()
                            __sorted2765 := __collection2765.CreateKeyListStr()
                            __sorted2765.Sort( LnsItemKindStr, nil )
                            for _, _fieldName := range( __sorted2765.Items ) {
                                symbolInfo := __collection2765.Items[ _fieldName ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
    ...
    for _, _macroDeclNode := range( node.FP.Get_nodeManager().FP.GetDeclMacroNodeList().Items ) {
        ...
        if declInfo.FP.Get_pubFlag(){
            ...
            firstFlag = true
            {
                __collection3054 := macroInfo.Symbol2MacroValInfoMap
                __sorted3054 := __collection3054.CreateKeyListStr()
                __sorted3054.Sort( LnsItemKindStr, nil )
                for _, _name := range( __sorted3054.Items ) {
                    symInfo := __collection3054.Items[ _name ].(Nodes_MacroValInfoDownCast).ToNodes_MacroValInfo()
                    name := _name.(string)
                    if firstFlag{
                        firstFlag = false
    ...
    {
        __collection3393 := self.pubVarName2InfoMap
        __sorted3393 := __collection3393.CreateKeyListStr()
        __sorted3393.Sort( LnsItemKindStr, nil )
        for _, _varName := range( __sorted3393.Items ) {
            varInfo := __collection3393.Items[ _varName ].(convLua_PubVerInfoDownCast).ToconvLua_PubVerInfo()
    ...
    {
        __collection3410 := self.pubFuncName2InfoMap
        __sorted3410 := __collection3410.CreateKeyListStr()
        __sorted3410.Sort( LnsItemKindStr, nil )
        for _, ___key3410 := range( __sorted3410.Items ) {
            funcInfo := __collection3410.Items[ ___key3410 ].(convLua_PubFuncInfoDownCast).ToconvLua_PubFuncInfo()
    ...
    outputTypeInfo = func(typeInfo *Ast_TypeInfo) {
        ...
        if _switch3604 := typeInfo.FP.Get_kind(); _switch3604 == Ast_TypeInfoKind__Class || _switch3604 == Ast_TypeInfoKind__IF {
            if _switch3602 := typeInfo.FP.Get_accessMode(); _switch3602 == Ast_AccessMode__Pub || _switch3602 == Ast_AccessMode__Pro || _switch3602 == Ast_AccessMode__Global {
            } else {
        ...
        validChildren = validChildrenSet.Get(typeInfo)
    ...
    for _typeId, _typeInfo := range( self.pubAlgeId2AlgeTypeInfo.Items ) {
        ...
        typeId2TypeInfo.Set(typeId,&typeInfo.Ast_TypeInfo)
        {
            __collection3749 := typeInfo.FP.Get_valInfoMap()
            __sorted3749 := __collection3749.CreateKeyListStr()
            __sorted3749.Sort( LnsItemKindStr, nil )
            for _, ___key3749 := range( __sorted3749.Items ) {
                valInfo := __collection3749.Items[ ___key3749 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
    ...
    exportNeedModuleTypeInfo = NewLnsSet([]LnsAny{})
    {
        ...
        {
            __collection3966 := module2TypeList
            __sorted3966 := __collection3966.CreateKeyListStr()
            __sorted3966.Sort( LnsItemKindStr, nil )
            for _, ___key3966 := range( __sorted3966.Items ) {
                _map := __collection3966.Items[ ___key3966 ].(*LnsMap)
                {
                    __collection3964 := _map
                    __sorted3964 := __collection3964.CreateKeyListInt()
                    __sorted3964.Sort( LnsItemKindInt, nil )
                    for _, ___key3964 := range( __sorted3964.Items ) {
                        typeInfo := __collection3964.Items[ ___key3964 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                        var valid bool
                        valid = false
                        var moduleTypeInfo *Ast_TypeInfo
                        moduleTypeInfo = typeInfo.FP.GetModule()
    ...
    {
        __collection4048 := importNameMap
        __sorted4048 := __collection4048.CreateKeyListStr()
        __sorted4048.Sort( LnsItemKindStr, nil )
        for _, _name := range( __sorted4048.Items ) {
            moduleTypeInfo := __collection4048.Items[ _name ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            name := _name.(string)
...
// 913: decl @lune.@base.@convLua.convFilter.processRoot
...
// 1020: decl @lune.@base.@convLua.convFilter.processSubfile
func (self *convLua_convFilter) ProcessSubfile(node *Nodes_SubfileNode,_opt LnsAny) {
}

// 1025: decl @lune.@base.@convLua.convFilter.processEnv
...
// 1032: decl @lune.@base.@convLua.convFilter.processBlockSub
func (self *convLua_convFilter) ProcessBlockSub(node *Nodes_BlockNode,_opt LnsAny) {
    var word string
    word = ""
    if _switch5026 := node.FP.Get_blockKind(); _switch5026 == Nodes_BlockKind__If || _switch5026 == Nodes_BlockKind__Elseif {
        word = "then"
        
    } else if _switch5026 == Nodes_BlockKind__Else {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__While {
        word = "do"
        
    } else if _switch5026 == Nodes_BlockKind__Repeat {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__For {
        word = "do"
        
    } else if _switch5026 == Nodes_BlockKind__Apply {
        word = "do"
        
    } else if _switch5026 == Nodes_BlockKind__Foreach {
        word = "do"
        
    } else if _switch5026 == Nodes_BlockKind__Macro {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__Func {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__Default {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__Block || _switch5026 == Nodes_BlockKind__Env {
        word = "do"
        
    } else if _switch5026 == Nodes_BlockKind__LetUnwrap {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__LetUnwrapThenDo {
        word = ""
        
    } else if _switch5026 == Nodes_BlockKind__IfUnwrap {
        word = ""
    ...
    self.FP.popIndent()
    if _switch5119 := node.FP.Get_blockKind(); _switch5119 == Nodes_BlockKind__Block || _switch5119 == Nodes_BlockKind__Env {
        self.FP.writeln("end")
    }
}

// 1102: decl @lune.@base.@convLua.convFilter.processLoadRuntime
...
// 1112: decl @lune.@base.@convLua.convFilter.processScope
...
// 1122: decl @lune.@base.@convLua.convFilter.processStmtExp
...
// 1128: decl @lune.@base.@convLua.convFilter.processDeclEnum
...
// 1210: decl @lune.@base.@convLua.convFilter.getMapInfo
func (self *convLua_convFilter) getMapInfo(typeInfo *Ast_TypeInfo)(string, bool, string) {
    ...
    var funcTxt string
    funcTxt = ""
    if _switch6107 := nonnilableType.FP.Get_kind(); _switch6107 == Ast_TypeInfoKind__Stem {
        funcTxt = "_lune._toStem"
        
    } else if _switch6107 == Ast_TypeInfoKind__Class || _switch6107 == Ast_TypeInfoKind__IF {
        if Lns_op_not(nonnilableType.FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil)){
            if Ast_NormalTypeInfo_isAvailableMapping(self.processInfo, nonnilableType, NewLnsMap( map[LnsAny]LnsAny{})){
                ...
                if convLua_isGenericType_1344_(nonnilableType){
                    var memStream *Util_memStream
                    memStream = NewUtil_memStream()
    ...
    } else if _switch6107 == Ast_TypeInfoKind__Enum || _switch6107 == Ast_TypeInfoKind__Alge {
        funcTxt = Lns_getVM().String_format("%s._from", []LnsAny{self.FP.getFullName(nonnilableType)})
        
    } else if _switch6107 == Ast_TypeInfoKind__Prim {
        if _switch5887 := nonnilableType; _switch5887 == Ast_builtinTypeInt {
            funcTxt = "_lune._toInt"
            
        } else if _switch5887 == Ast_builtinTypeReal {
            funcTxt = "_lune._toReal"
            
        } else if _switch5887 == Ast_builtinTypeBool {
            funcTxt = "_lune._toBool"
            
        } else {
            Util_err(Lns_getVM().String_format("unknown type -- %s", []LnsAny{nonnilableType.FP.GetTxt(nil, nil, nil)}))
        }
    } else if _switch6107 == Ast_TypeInfoKind__Map {
    ...
    } else if _switch6107 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch6107 == Ast_TypeInfoKind__List || _switch6107 == Ast_TypeInfoKind__Array {
    ...
    } else if _switch6107 == Ast_TypeInfoKind__Alternate {
        var prefix string
...
// 1300: decl @lune.@base.@convLua.convFilter.processDeclAlge
func (self *convLua_convFilter) ProcessDeclAlge(node *Nodes_DeclAlgeNode,_opt LnsAny) {
    ...
    {
        __collection6495 := node.FP.Get_algeType().FP.Get_valInfoMap()
        __sorted6495 := __collection6495.CreateKeyListStr()
        __sorted6495.Sort( LnsItemKindStr, nil )
        for _, ___key6495 := range( __sorted6495.Items ) {
            valInfo := __collection6495.Items[ ___key6495 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 1368: decl @lune.@base.@convLua.convFilter.processNewAlgeVal
...
// 1389: decl @lune.@base.@convLua.convFilter.getDestrClass
...
// 1402: decl @lune.@base.@convLua.convFilter.outputAlter2MapFunc
...
// 1427: decl @lune.@base.@convLua.convFilter.processProtoClass
...
// 1433: decl @lune.@base.@convLua.convFilter.processDeclClass
func (self *convLua_convFilter) ProcessDeclClass(node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    self.classId2MemberList.Set(classTypeId,nodeInfo.FP.Get_memberList())
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            if _switch6970 := node.FP.Get_accessMode(); _switch6970 == Ast_AccessMode__Pub || _switch6970 == Ast_AccessMode__Pro {
                if self.needModuleObj{
                    self.FP.writeln("")
    ...
    if classTypeInfo.FP.IsInheritFrom(self.processInfo, Ast_builtinTypeMapping, nil){
        ...
        var argTxt string
        argTxt = "{}, val"
        if convLua_isGenericType_1344_(classTypeInfo){
...
// 1766: decl @lune.@base.@convLua.convFilter.processDeclMember
func (self *convLua_convFilter) ProcessDeclMember(node *Nodes_DeclMemberNode,_opt LnsAny) {
}

// 1773: decl @lune.@base.@convLua.convFilter.processExpMacroExp
...
// 1785: decl @lune.@base.@convLua.convFilter.outputDeclMacro
func (self *convLua_convFilter) OutputDeclMacro(name string,argNameList *LnsList,callback convLua_outputMacroStmtBlock_1411_) {
...
// 1829: decl @lune.@base.@convLua.convFilter.processExpMacroStatList
...
// 1837: decl @lune.@base.@convLua.convFilter.processDeclMacro
func (self *convLua_convFilter) ProcessDeclMacro(node *Nodes_DeclMacroNode,_opt LnsAny) {
    if self.inMacro{
        ...
        self.FP.OutputDeclMacro(macroInfo.FP.Get_name().Txt, argNameList, convLua_outputMacroStmtBlock_1411_(func() {
            {
...
// 1856: decl @lune.@base.@convLua.convFilter.processExpMacroStat
...
// 1874: decl @lune.@base.@convLua.convFilter.processExpNew
...
// 1885: decl @lune.@base.@convLua.convFilter.process__func__symbol
...
// 1899: decl @lune.@base.@convLua.convFilter.processDeclConstr
...
// 1954: decl @lune.@base.@convLua.convFilter.processDeclDestr
func (self *convLua_convFilter) ProcessDeclDestr(node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.GetTxt(nil, nil, nil)})/* 1958:9 */)}))
...
// 1974: decl @lune.@base.@convLua.convFilter.processExpCallSuperCtor
...
// 1993: decl @lune.@base.@convLua.convFilter.processExpCallSuper
...
// 2009: decl @lune.@base.@convLua.convFilter.processDeclMethod
...
// 2042: decl @lune.@base.@convLua.convFilter.processUnwrapSet
...
// 2075: decl @lune.@base.@convLua.convFilter.processExpListSub
...
// 2102: decl @lune.@base.@convLua.convFilter.processExpMRet
...
// 2108: decl @lune.@base.@convLua.convFilter.processIfUnwrap
...
// 2151: decl @lune.@base.@convLua.convFilter.processWhen
...
// 2173: decl @lune.@base.@convLua.convFilter.processDeclVar
...
// 2285: decl @lune.@base.@convLua.convFilter.processDeclArg
...
// 2293: decl @lune.@base.@convLua.convFilter.processDeclArgDDD
func (self *convLua_convFilter) ProcessDeclArgDDD(node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.Write("...")
}

// 2299: decl @lune.@base.@convLua.convFilter.processDeclFunc
...
// 2340: decl @lune.@base.@convLua.convFilter.processRefType
...
// 2354: decl @lune.@base.@convLua.convFilter.processIf
...
// 2376: decl @lune.@base.@convLua.convFilter.processSwitch
...
// 2419: decl @lune.@base.@convLua.convFilter.processMatch
...
// 2458: decl @lune.@base.@convLua.convFilter.processWhile
...
// 2469: decl @lune.@base.@convLua.convFilter.processRepeat
...
// 2478: decl @lune.@base.@convLua.convFilter.processFor
...
// 2494: decl @lune.@base.@convLua.convFilter.processApply
...
// 2512: decl @lune.@base.@convLua.convFilter.processForeach
func (self *convLua_convFilter) ProcessForeach(node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    self.FP.Write("for ")
    if keySym != nil{
        keySym_6947 := keySym.(*Ast_SymbolInfo)
        self.FP.Write(convLua_getSymTxt_1068_(keySym_6947.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{keySym_6947.FP.Get_symbolId()})))
    } else {
        self.FP.Write("__index")
    }
    self.FP.Write(", ")
    if valSym != nil{
        valSym_6950 := valSym.(*Ast_SymbolInfo)
        self.FP.Write(convLua_getSymTxt_1068_(valSym_6950.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{valSym_6950.FP.Get_symbolId()})))
    } else {
        self.FP.Write("__val")
    }
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2562: decl @lune.@base.@convLua.convFilter.processForsort
func (self *convLua_convFilter) ProcessForsort(node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    key = "__key"
    if keySym != nil{
        keySym_6969 := keySym.(*Ast_SymbolInfo)
        key = convLua_getSymTxt_1068_(keySym_6969.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{keySym_6969.FP.Get_symbolId()}))
    ...
    self.FP.pushIndent(nil)
    if valSym != nil{
        valSym_6971 := valSym.(*Ast_SymbolInfo)
        self.FP.writeln(Lns_getVM().String_format("local %s = __map[ %s ]", []LnsAny{convLua_getSymTxt_1068_(valSym_6971.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{valSym_6971.FP.Get_symbolId()})), key}))
    }
    convLua_filter_1171_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    self.FP.writeln("end")
    self.FP.popIndent()
...
// 2615: decl @lune.@base.@convLua.convFilter.processExpUnwrap
...
// 2633: decl @lune.@base.@convLua.convFilter.processExpCall
func (self *convLua_convFilter) ProcessExpCall(node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    fieldCall = func() bool {
        ...
        processSet = func() bool {
            ...
            if _switch13324 := fieldNode.FP.Get_field().Txt; _switch13324 == "add" || _switch13324 == "del" {
                ...
                self.FP.Write("]")
                if _switch13318 := fieldNode.FP.Get_field().Txt; _switch13318 == "add" {
                    self.FP.Write("= true")
                } else if _switch13318 == "del" {
                    self.FP.Write("= nil")
                }
                return false
            }
        ...
        if node.FP.Get_nilAccess(){
            ...
            if _switch13578 := prefixType.FP.Get_kind(); _switch13578 == Ast_TypeInfoKind__List || _switch13578 == Ast_TypeInfoKind__Array {
            ...
            if _switch13824 := prefixType.FP.Get_kind(); _switch13824 == Ast_TypeInfoKind__List || _switch13824 == Ast_TypeInfoKind__Array {
                setArgFlag = true
                ...
                convLua_filter_1171_(prefixNode, self, &fieldNode.Nodes_Node)
            } else if _switch13824 == Ast_TypeInfoKind__Set {
                if Lns_op_not(processSet()){
                    return false
                }
            } else if _switch13824 == Ast_TypeInfoKind__Enum || _switch13824 == Ast_TypeInfoKind__Alge {
                processEnumAlge()
            } else if _switch13824 == Ast_TypeInfoKind__Box {
                convLua_filter_1171_(prefixNode, self, &fieldNode.Nodes_Node)
                self.FP.Write("[1]")
                return false
            } else if _switch13824 == Ast_TypeInfoKind__Class {
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( prefixType.FP.IsInheritFrom(self.processInfo, Ast_builtinTypeMapping, nil)) &&
                    Lns_GetEnv().SetStackVal( convLua_isGenericType_1344_(prefixType)) &&
                    Lns_GetEnv().SetStackVal( (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    }
    {
        ...
        if !Lns_IsNil( _argList ) {
            ...
            if convStrFlag{
                ...
                if expList.Len() > 0{
                    var literal LnsAny
                    literal = convLua_convExp14161(Lns_2DDD(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node().FP.GetLiteral()))
                    if literal != nil{
                        literal_7061 := literal
                        switch _exp14181 := literal_7061.(type) {
                ...
                for _index, _argNode := range( expList.Items ) {
                    ...
                    if index > 1{
                        ...
                        if index - 1 <= opList.Len(){
                            var formType LnsInt
                            formType = convLua_convExp14237(Lns_2DDD(TransUnit_isMatchStringFormatType(opList.GetAt(index - 1).(string), argNode.FP.Get_expType(), self.targetLuaVer)))
...
// 2870: decl @lune.@base.@convLua.convFilter.processExpList
...
// 2879: decl @lune.@base.@convLua.convFilter.processExpOp1
func (self *convLua_convFilter) ProcessExpOp1(node *Nodes_ExpOp1Node,_opt LnsAny) {
    ...
    if op == ",,,"{
        ...
        if _switch14532 := node.FP.Get_exp().FP.Get_expType(); _switch14532 == Ast_builtinTypeInt || _switch14532 == Ast_builtinTypeReal || _switch14532 == Ast_builtinTypeBool {
            convLua_filter_1171_(node.FP.Get_exp(), self, &node.Nodes_Node)
        } else {
...
func (self *convLua_convFilter) ProcessExpCast(node *Nodes_ExpCastNode,_opt LnsAny) {
    ...
    } else if _switch14951 == Nodes_CastKind__Normal {
        self.FP.Write("_lune.__Cast( ")
        convLua_filter_1171_(node.FP.Get_exp(), self, &node.Nodes_Node)
        var castKind LnsInt
        var classObj string
        classObj = "nil"
        if _switch14915 := node.FP.Get_expType().FP.Get_nonnilableType(); _switch14915 == Ast_builtinTypeInt {
            castKind = LuaMod_CastKind__Int
            
        } else if _switch14915 == Ast_builtinTypeReal {
            castKind = LuaMod_CastKind__Real
            
        } else if _switch14915 == Ast_builtinTypeString {
    ...
    } else if _switch14951 == Nodes_CastKind__Implicit {
        convLua_filter_1171_(node.FP.Get_exp(), self, &node.Nodes_Node)
    }
}

// 2987: decl @lune.@base.@convLua.convFilter.processExpParen
...
// 2996: decl @lune.@base.@convLua.convFilter.processExpSetVal
...
// 3003: decl @lune.@base.@convLua.convFilter.processExpSetItem
func (self *convLua_convFilter) ProcessExpSetItem(node *Nodes_ExpSetItemNode,_opt LnsAny) {
    convLua_filter_1171_(node.FP.Get_val(), self, &node.Nodes_Node)
    self.FP.Write("[")
    switch _exp15111 := node.FP.Get_index().(type) {
    case *Nodes_IndexVal__NodeIdx:
    index := _exp15111.Val1
...
// 3021: decl @lune.@base.@convLua.convFilter.processExpOp2
func (self *convLua_convFilter) ProcessExpOp2(node *Nodes_ExpOp2Node,_opt LnsAny) {
    ...
    opTxt = node.FP.Get_op().Txt
    {
        ...
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(LnsInt)
            if self.targetLuaVer.FP.Get_hasBitOp() == LuaVer_BitOp__HasOp{
                if _switch15241 := _exp; _switch15241 == Ast_BitOpKind__LShift {
                    opTxt = "<<"
                    
                } else if _switch15241 == Ast_BitOpKind__RShift {
                    opTxt = ">>"
                ...
                var exp2Mod string
                exp2Mod = ""
                if _switch15358 := _exp; _switch15358 == Ast_BitOpKind__And {
                    binfunc = "band"
                    
                } else if _switch15358 == Ast_BitOpKind__Or {
                    binfunc = "bor"
                    
                } else if _switch15358 == Ast_BitOpKind__Xor {
                    binfunc = "bxor"
                    
                } else if _switch15358 == Ast_BitOpKind__LShift {
                    binfunc = "lshift"
                    
                } else if _switch15358 == Ast_BitOpKind__RShift {
                    binfunc = "lshift"
...
// 3091: decl @lune.@base.@convLua.convFilter.processExpRef
func (self *convLua_convFilter) ProcessExpRef(node *Nodes_ExpRefNode,_opt LnsAny) {
    if _switch15652 := node.FP.Get_symbolInfo().FP.Get_name(); _switch15652 == "super" {
        var funcType *Ast_TypeInfo
...
// 3127: decl @lune.@base.@convLua.convFilter.processExpRefItem
...
// 3169: decl @lune.@base.@convLua.convFilter.processRefField
...
// 3201: decl @lune.@base.@convLua.convFilter.processExpOmitEnum
...
// 3212: decl @lune.@base.@convLua.convFilter.processGetField
...
// 3252: decl @lune.@base.@convLua.convFilter.processReturn
...
// 3262: decl @lune.@base.@convLua.convFilter.processLuneKind
...
// 3275: decl @lune.@base.@convLua.convFilter.processTestCase
...
// 3297: decl @lune.@base.@convLua.convFilter.processTestBlock
...
// 3308: decl @lune.@base.@convLua.convFilter.processProvide
func (self *convLua_convFilter) ProcessProvide(node *Nodes_ProvideNode,_opt LnsAny) {
}

// 3313: decl @lune.@base.@convLua.convFilter.processAlias
...
// 3323: decl @lune.@base.@convLua.convFilter.processBoxing
...
// 3333: decl @lune.@base.@convLua.convFilter.processUnboxing
func (self *convLua_convFilter) ProcessUnboxing(node *Nodes_UnboxingNode,_opt LnsAny) {
    convLua_filter_1171_(node.FP.Get_src(), self, &node.Nodes_Node)
    self.FP.Write("[1]")
}

// 3341: decl @lune.@base.@convLua.convFilter.processLiteralList
...
// 3353: decl @lune.@base.@convLua.convFilter.processLiteralSet
...
// 3371: decl @lune.@base.@convLua.convFilter.processLiteralMap
...
// 3389: decl @lune.@base.@convLua.convFilter.processLiteralArray
...
// 3402: decl @lune.@base.@convLua.convFilter.processLiteralChar
    ...
    opList = TransUnit_findForm(txt)
    {
        ...
        if !Lns_IsNil( _expList ) {
            ...
            for _index, _val := range( expList.FP.Get_expList().Items ) {
                ...
                if index <= opList.Len(){
                    matchFlag = convLua_convExp17295(Lns_2DDD(TransUnit_isMatchStringFormatType(opList.GetAt(index).(string), val.FP.Get_expType(), self.targetLuaVer)))
...
// 3489: decl @lune.@base.@convLua.convFilter.processLuneControl
...
// 3524: decl @lune.@base.@convLua.MacroEvalImp.evalFromMacroCode
func (self *ConvLua_MacroEvalImp) evalFromMacroCode(code string) *Lns_luaValue {
    ...
    Log_log(Log_Level__Trace, __func__, 3526, Log_CreateMessage(func() string {
...
// 3535: decl @lune.@base.@convLua.MacroEvalImp.evalFromCode
func (self *ConvLua_MacroEvalImp) EvalFromCode(processInfo *Ast_ProcessInfo,name string,argNameList *LnsList,code LnsAny) *Lns_luaValue {
    ...
    conv.FP.OutputDeclMacro(name, argNameList, convLua_outputMacroStmtBlock_1411_(func() {
        if code != nil{
            code_7510 := code.(string)
            conv.FP.Write(code_7510)
        }
    }))
    return self.FP.evalFromMacroCode(stream.FP.Get_txt())
}

// 3556: decl @lune.@base.@convLua.MacroEvalImp.eval
