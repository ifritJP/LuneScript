...
// for 4072
func convLua_convExp0_4756(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3830
func convLua_convExp0_3731(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 342
func convLua_convExp1_527(arg1 []LnsAny) string {
...
// for 2017
func convLua_convExp2_4589(arg1 []LnsAny) (string, bool, string) {
    return Lns_getFromMulti( arg1, 0 ).(string), Lns_getFromMulti( arg1, 1 ).(bool), Lns_getFromMulti( arg1, 2 ).(string)
}
// for 3204
func convLua_convExp4_2302(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3219
func convLua_convExp4_2378(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 3995
func convLua_convExp0_4284(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 4070
func convLua_convExp0_4504(arg1 []LnsAny) (LnsAny, LnsAny) {
...
// 275: decl @lune.@base.@convLua.filter
...
// 1464: decl @lune.@base.@convLua.isGenericType
...
// 3908: decl @lune.@base.@convLua.createFilter
...
func (self *convLua_ConvFilter) getCanonicalName(_env *LnsEnv, typeInfo *Ast_TypeInfo,localFlag bool) string {
    if _switch0 := typeInfo; _switch0 == self.builtinFunc.G__ret_ {
        return "_lune.Result"
    }
    var enumName string
...
// 232: decl @lune.@base.@convLua.ConvFilter.getFullName
...
// 236: decl @lune.@base.@convLua.ConvFilter.close
func (self *convLua_ConvFilter) Close(_env *LnsEnv) {
}
// 238: decl @lune.@base.@convLua.ConvFilter.flush
func (self *convLua_ConvFilter) Flush(_env *LnsEnv) {
}
// 241: decl @lune.@base.@convLua.ConvFilter.writeRaw
...
// 253: decl @lune.@base.@convLua.ConvFilter.write
...
// 313: decl @lune.@base.@convLua.ConvFilter.popIndent
...
func (self *convLua_ConvFilter) ProcessImport(_env *LnsEnv, node *Nodes_ImportNode,_opt LnsAny) {
    ...
    var modSym string
    modSym = convLua_convExp1_527(Lns_2DDD(_env.GetVM().String_gsub(modulePath,".*%.", "")))
...
// 383: decl @lune.@base.@convLua.ConvFilter.outputMeta
...
// 1046: decl @lune.@base.@convLua.ConvFilter.outputMainDirect
...
// 1087: decl @lune.@base.@convLua.ConvFilter.processRoot
func (self *convLua_ConvFilter) ProcessRoot(_env *LnsEnv, node *Nodes_RootNode,_opt LnsAny) {
    ...
    Log_log(_env, Log_Level__Log, __func__, 1090, Log_CreateMessage(func(_env *LnsEnv) string {
        return _env.GetVM().String_format("streamName: %s, enableTest: %s", []LnsAny{self.streamName, self.enableTest})
    }))
...
// 1218: decl @lune.@base.@convLua.ConvFilter.processSubfile
func (self *convLua_ConvFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}
// 1223: decl @lune.@base.@convLua.ConvFilter.processRequest
...
// 1229: decl @lune.@base.@convLua.ConvFilter.processAsyncLock
...
// 1236: decl @lune.@base.@convLua.ConvFilter.processBlockSub
...
// 1306: decl @lune.@base.@convLua.ConvFilter.processLoadRuntime
...
// 1316: decl @lune.@base.@convLua.ConvFilter.processScope
...
// 1325: decl @lune.@base.@convLua.ConvFilter.processCondRet
func (self *convLua_ConvFilter) ProcessCondRet(_env *LnsEnv, node *Nodes_CondRetNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, _env.GetVM().String_format("_cond%s", []LnsAny{node.FP.Get_order(_env)}))
}
// 1331: decl @lune.@base.@convLua.ConvFilter.outputCondRet
func (self *convLua_ConvFilter) outputCondRet(_env *LnsEnv, node *Nodes_CondRetNode) {
    ...
    if _switch0 := node.FP.Get_condKind(_env); _switch0 == Nodes_CondRetKind__Nilable {
        self.FP.Write(_env, _env.GetVM().String_format("local %s = ", []LnsAny{symName}))
        convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
        self.FP.writeln(_env, "")
        self.FP.writeln(_env, _env.GetVM().String_format("if %s == nil then return nil end", []LnsAny{symName}))
    } else if _switch0 == Nodes_CondRetKind__Ret {
        self.FP.writeln(_env, _env.GetVM().String_format("local %s", []LnsAny{symName}))
        self.FP.writeln(_env, "do")
        self.FP.pushIndent(_env, nil)
        ...
        self.FP.pushIndent(_env, nil)
        self.FP.writeln(_env, _env.GetVM().String_format("%s = _matchExp[2][1]", []LnsAny{symName}))
        self.FP.popIndent(_env)
        self.FP.writeln(_env, "end")
        self.FP.popIndent(_env)
        self.FP.writeln(_env, "end")
        ...
        self.FP.Write(_env, _env.GetVM().String_format("%s, __condWork = ", []LnsAny{symName}))
        convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
        self.FP.writeln(_env, "")
        self.FP.writeln(_env, _env.GetVM().String_format("if %s == nil then return nil, __condWork end", []LnsAny{symName}))
        self.FP.popIndent(_env)
        self.FP.writeln(_env, "end")
    }
}
// 1376: decl @lune.@base.@convLua.ConvFilter.processCondRetList
func (self *convLua_ConvFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 1382: decl @lune.@base.@convLua.ConvFilter.outputCondRetInfo
...
// 1388: decl @lune.@base.@convLua.ConvFilter.processStmtExp
...
// 1398: decl @lune.@base.@convLua.ConvFilter.processDeclEnum
...
// 1480: decl @lune.@base.@convLua.ConvFilter.getMapInfo
...
// 1570: decl @lune.@base.@convLua.ConvFilter.processDeclAlge
...
// 1638: decl @lune.@base.@convLua.ConvFilter.processNewAlgeVal
...
// 1659: decl @lune.@base.@convLua.ConvFilter.getDestrClass
...
// 1672: decl @lune.@base.@convLua.ConvFilter.outputAlter2MapFunc
...
// 1697: decl @lune.@base.@convLua.ConvFilter.processProtoClass
...
// 1703: decl @lune.@base.@convLua.ConvFilter.processDeclClass
func (self *convLua_ConvFilter) ProcessDeclClass(_env *LnsEnv, node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    destTxt = ""
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            destTxt = _env.GetVM().String_format(", __gc = %s.__free", []LnsAny{self.FP.getFullName(_env, _exp)})
        }
    }
...
// 2033: decl @lune.@base.@convLua.ConvFilter.processDeclMember
func (self *convLua_ConvFilter) ProcessDeclMember(_env *LnsEnv, node *Nodes_DeclMemberNode,_opt LnsAny) {
}
// 2040: decl @lune.@base.@convLua.ConvFilter.processExpMacroExp
...
// 2052: decl @lune.@base.@convLua.ConvFilter.outputDeclMacro
...
// 2096: decl @lune.@base.@convLua.ConvFilter.processExpMacroStatList
...
// 2104: decl @lune.@base.@convLua.ConvFilter.processDeclMacro
...
// 2123: decl @lune.@base.@convLua.ConvFilter.processExpMacroStat
...
// 2141: decl @lune.@base.@convLua.ConvFilter.processExpNew
...
// 2152: decl @lune.@base.@convLua.ConvFilter.process__func__symbol
...
// 2166: decl @lune.@base.@convLua.ConvFilter.processDeclConstr
...
// 2221: decl @lune.@base.@convLua.ConvFilter.processDeclDestr
func (self *convLua_ConvFilter) ProcessDeclDestr(_env *LnsEnv, node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_TypeInfo).FP.GetTxt(_env, nil, nil, nil)})/* 2225:9 */)}))
    ...
    classTypeInfo = node.FP.Get_expType(_env).FP.Get_parentInfo(_env)
    {
        ...
        if !Lns_IsNil( __exp ) {
            _exp := __exp.(*Ast_TypeInfo)
            self.FP.writeln(_env, _env.GetVM().String_format("%s.__free( self )", []LnsAny{self.FP.getFullName(_env, _exp)}))
        }
    }
    self.FP.writeln(_env, "end")
}
// 2241: decl @lune.@base.@convLua.ConvFilter.processExpCallSuperCtor
...
// 2256: decl @lune.@base.@convLua.ConvFilter.processExpCallSuper
...
// 2272: decl @lune.@base.@convLua.ConvFilter.processDeclMethod
...
// 2305: decl @lune.@base.@convLua.ConvFilter.processUnwrapSet
...
// 2338: decl @lune.@base.@convLua.ConvFilter.processExpListSub
...
// 2365: decl @lune.@base.@convLua.ConvFilter.processExpMRet
...
// 2371: decl @lune.@base.@convLua.ConvFilter.processIfUnwrap
...
// 2418: decl @lune.@base.@convLua.ConvFilter.processWhen
...
// 2440: decl @lune.@base.@convLua.ConvFilter.processLetExpandTuple
func (self *convLua_ConvFilter) ProcessLetExpandTuple(_env *LnsEnv, node *Nodes_LetExpandTupleNode,_opt LnsAny) {
    {
    ...
    self.FP.WriteRaw(_env, "=")
    self.FP.WriteRaw(_env, "table.unpack( ")
    convLua_filter_9_(_env, &node.FP.Get_expList(_env).Nodes_Node, self, &node.Nodes_Node)
    self.FP.writeln(_env, ")")
}
// 2462: decl @lune.@base.@convLua.ConvFilter.processExpExpandTuple
...
// 2471: decl @lune.@base.@convLua.ConvFilter.processDeclVar
...
// 2590: decl @lune.@base.@convLua.ConvFilter.processDeclArg
...
// 2598: decl @lune.@base.@convLua.ConvFilter.processDeclArgDDD
func (self *convLua_ConvFilter) ProcessDeclArgDDD(_env *LnsEnv, node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, "...")
}
// 2604: decl @lune.@base.@convLua.ConvFilter.processDeclFunc
...
// 2646: decl @lune.@base.@convLua.ConvFilter.processRefType
...
// 2666: decl @lune.@base.@convLua.ConvFilter.processIf
...
// 2691: decl @lune.@base.@convLua.ConvFilter.processSwitch
...
// 2734: decl @lune.@base.@convLua.ConvFilter.processMatch
...
// 2773: decl @lune.@base.@convLua.ConvFilter.processWhile
...
// 2784: decl @lune.@base.@convLua.ConvFilter.processRepeat
...
// 2793: decl @lune.@base.@convLua.ConvFilter.processFor
...
// 2809: decl @lune.@base.@convLua.ConvFilter.processApply
...
// 2827: decl @lune.@base.@convLua.ConvFilter.processForeach
func (self *convLua_ConvFilter) ProcessForeach(_env *LnsEnv, node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    if keySym != nil{
        ...
        self.FP.WriteRaw(_env, convLua_getSymbolTxt_5_(_env, keySym_36))
    } else {
    ...
    if valSym != nil{
        ...
        self.FP.WriteRaw(_env, convLua_getSymbolTxt_5_(_env, valSym_39))
    } else {
...
// 2877: decl @lune.@base.@convLua.ConvFilter.processForsort
...
// 2929: decl @lune.@base.@convLua.ConvFilter.processExpUnwrap
...
// 2947: decl @lune.@base.@convLua.ConvFilter.processExpCall
func (self *convLua_ConvFilter) ProcessExpCall(_env *LnsEnv, node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    convLua_fieldCall = func(_env *LnsEnv) bool {
        ...
        if node.FP.Get_nilAccess(_env){
            ...
            if _switch2 := prefixType.FP.Get_kind(_env); _switch2 == Ast_TypeInfoKind__List || _switch2 == Ast_TypeInfoKind__Array || _switch2 == Ast_TypeInfoKind__Tuple {
                setArgFlag = true
                wroteFuncFlag = true
    ...
    }
    {
        ...
        if !Lns_IsNil( _argList ) {
            ...
            if convStrFlag{
                ...
                if expList.Len() > 0{
                    var literal LnsAny
                    literal = convLua_convExp4_2302(Lns_2DDD(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node().FP.GetLiteral(_env)))
                    if literal != nil{
                        literal_145 := literal
                        switch _matchExp0 := literal_145.(type) {
                ...
                for _index, _argNode := range( expList.Items ) {
                    ...
                    if index > 1{
                        ...
                        if index - 1 <= opList.Len(){
                            var formType LnsInt
                            formType = convLua_convExp4_2378(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index - 1).(string), argNode.FP.Get_expType(_env), self.targetLuaVer)))
...
// 3241: decl @lune.@base.@convLua.ConvFilter.processExpList
...
// 3250: decl @lune.@base.@convLua.ConvFilter.processExpOp1
...
// 3358: decl @lune.@base.@convLua.ConvFilter.processExpParen
func (self *convLua_ConvFilter) ProcessExpParen(_env *LnsEnv, node *Nodes_ExpParenNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, "(")
    convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
    self.FP.WriteRaw(_env, " )")
}
// 3367: decl @lune.@base.@convLua.ConvFilter.processExpSetVal
...
// 3374: decl @lune.@base.@convLua.ConvFilter.processExpSetItem
...
// 3392: decl @lune.@base.@convLua.ConvFilter.processExpOp2
...
// 3462: decl @lune.@base.@convLua.ConvFilter.processExpRef
...
// 3498: decl @lune.@base.@convLua.ConvFilter.processExpRefItem
...
// 3541: decl @lune.@base.@convLua.ConvFilter.processRefField
...
// 3580: decl @lune.@base.@convLua.ConvFilter.processExpOmitEnum
...
// 3591: decl @lune.@base.@convLua.ConvFilter.processGetField
...
// 3630: decl @lune.@base.@convLua.ConvFilter.processReturn
...
// 3640: decl @lune.@base.@convLua.ConvFilter.processLuneKind
...
// 3653: decl @lune.@base.@convLua.ConvFilter.processTestCase
...
// 3675: decl @lune.@base.@convLua.ConvFilter.processTestBlock
...
// 3686: decl @lune.@base.@convLua.ConvFilter.processProvide
func (self *convLua_ConvFilter) ProcessProvide(_env *LnsEnv, node *Nodes_ProvideNode,_opt LnsAny) {
}
// 3691: decl @lune.@base.@convLua.ConvFilter.processAlias
...
// 3701: decl @lune.@base.@convLua.ConvFilter.processBoxing
...
// 3740: decl @lune.@base.@convLua.ConvFilter.processLiteralSet
...
// 3758: decl @lune.@base.@convLua.ConvFilter.processLiteralMap
...
// 3776: decl @lune.@base.@convLua.ConvFilter.processLiteralArray
...
// 3789: decl @lune.@base.@convLua.ConvFilter.processLiteralChar
...
// 3795: decl @lune.@base.@convLua.ConvFilter.processLiteralInt
...
// 3803: decl @lune.@base.@convLua.ConvFilter.processLiteralReal
func (self *convLua_ConvFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 3810: decl @lune.@base.@convLua.ConvFilter.processLiteralString
    ...
    opList = TransUnit_findForm(_env, txt)
    {
        ...
        if !Lns_IsNil( _expList ) {
            ...
            for _index, _val := range( expList.FP.Get_expList(_env).Items ) {
                ...
                if index <= opList.Len(){
                    matchFlag = convLua_convExp0_3731(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index).(string), val.FP.Get_expType(_env), self.targetLuaVer)))
                }
...
// 3876: decl @lune.@base.@convLua.ConvFilter.processLuneControl
...
// 3889: decl @lune.@base.@convLua.FilterInfo.outputLuaAndMeta
...
// 3896: decl @lune.@base.@convLua.FilterInfo.outputLua
func (self *ConvLua_FilterInfo) OutputLua(_env *LnsEnv, node *Nodes_RootNode) {
    node.FP.ProcessFilter(_env, self.filter, ConvLua_Opt2Stem(NewConvLua_Opt(_env, &node.Nodes_Node)))
}
// 3901: decl @lune.@base.@convLua.FilterInfo.outputMeta
func (self *ConvLua_FilterInfo) OutputMeta(_env *LnsEnv, node *Nodes_RootNode) {
}
// 3932: decl @lune.@base.@convLua.MacroEvalImp.evalFromCodeToLuaCode
...
// 3952: decl @lune.@base.@convLua.MacroEvalImp.evalToLuaCode
