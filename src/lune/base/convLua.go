...
type convLua_outputMacroStmtBlock_1385_ func ()
// for 3608
func convLua_convExp18247(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3395
func convLua_convExp17021(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 265
func convLua_convExp1057(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 2785
func convLua_convExp13890(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2800
func convLua_convExp13965(arg1 []LnsAny) LnsInt {
    return Lns_getFromMulti( arg1, 0 ).(LnsInt)
}
// for 3544
func convLua_convExp17804(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
...
// 1159: decl @lune.@base.@convLua.isGenericType
func convLua_isGenericType_1323_(typeInfo *Ast_TypeInfo) bool {
    if Ast_isGenericType(typeInfo){
        return true
    }
    if _switch5414 := typeInfo.FP.Get_kind(); _switch5414 == Ast_TypeInfoKind__Class || _switch5414 == Ast_TypeInfoKind__IF {
...
// 3462: decl @lune.@base.@convLua.runLuaOnLns
func convLua_runLuaOnLns_1654_(code string)(LnsAny, string) {
    var loadFunc LnsAny
    var err string
    loadFunc,err = DependLuaOnLns_runLuaOnLns(code)
    if loadFunc != nil{
        loadFunc_7226 := loadFunc.(*Lns_luaValue)
        var mod LnsAny
        mod = Lns_getVM().RunLoadedfunc(loadFunc_7226,[]LnsAny{})[0]
        if mod != nil{
            mod_7229 := mod
            return mod_7229, ""
        }
...
func ConvLua_createAstFromStream(scriptPath string,stream Lns_iStream,option *Option_Option) *TransUnit_ASTInfo {
    ...
    parser = NewParser_StreamParser(stream, scriptPath, false)
...
func ConvLua_createAstFromFile(scriptPath string,option *Option_Option) *TransUnit_ASTInfo {
    ...
    {
        _stream := convLua_convExp17804(Lns_2DDD(Lns_io_open(scriptPath, nil)))
        if _stream == nil{
...
// 3589: decl @lune.@base.@convLua.Ast2Code
func convLua_Ast2Code_1699_(option *Option_Option,ast *TransUnit_ASTInfo,streamName string)(string, string) {
...
func ConvLua_runTestCode(ctrl *Testing_Ctrl,luaCode string) {
    ...
    if loaded != nil{
        loaded_7313 := loaded.(*Lns_luaValue)
        {
            _mod := convLua_convExp18247(Lns_2DDD(Lns_getVM().RunLoadedfunc(loaded_7313,Lns_2DDD([]LnsAny{}))[0]))
            if _mod != nil {
                mod := _mod
                {
                    ...
                    if _listobj != nil {
                        ...
                        if ctrl.FP.CheckEq(strList.Len(), 4, "#strList", "4", nil, convLua__mod__, 3611){
                            ctrl.FP.CheckEq(strList.GetAt(1).(string), "hello world", "strList[ 1 ]", "\"hello world\"", nil, convLua__mod__, 3612)
                            ctrl.FP.CheckEq(strList.GetAt(2).(string), "11", "strList[ 2 ]", "\"11\"", nil, convLua__mod__, 3613)
                            ctrl.FP.CheckEq(strList.GetAt(3).(string), "12", "strList[ 3 ]", "\"12\"", nil, convLua__mod__, 3614)
                            ctrl.FP.CheckEq(strList.GetAt(4).(string), "13", "strList[ 4 ]", "\"13\"", nil, convLua__mod__, 3615)
                        }
                    }
                }
            }
...
type convLua_convFilterMtd interface {
    ...
    OutputDeclMacro(arg1 string, arg2 *LnsList, arg3 convLua_outputMacroStmtBlock_1385_)
...
// 150: decl @lune.@base.@convLua.convFilter.get_indent
...
// 157: decl @lune.@base.@convLua.convFilter.getCanonicalName
func (self *convLua_convFilter) getCanonicalName(typeInfo *Ast_TypeInfo,localFlag bool) string {
    ...
    {
        _assignSym := self.moduleType2SymbolMap.Items[moduleType]
        if _assignSym != nil {
...
// 241: decl @lune.@base.@convLua.convFilter.popIndent
...
// 249: decl @lune.@base.@convLua.convFilter.writeln
...
func (self *convLua_convFilter) outputMeta(node *Nodes_RootNode) {
    ...
    importNameMap = NewLnsMap( map[LnsAny]LnsAny{})
    {
        ...
        index = 0
        {
            __collection1422 := importNameMap
            __sorted1422 := __collection1422.CreateKeyListStr()
            __sorted1422.Sort( LnsItemKindStr, nil )
            for _, ___key1422 := range( __sorted1422.Items ) {
                typeInfo := __collection1422.Items[ ___key1422 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                index = index + 1
    ...
    checkExportTypeInfo = func(typeInfo *Ast_TypeInfo) LnsAny {
        ...
        return Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            Lns_GetEnv().SetStackVal( typeId2TypeInfo.Items[typeId]) &&
            Lns_GetEnv().SetStackVal( Lns_op_not(Ast_isBuiltin(typeId))) &&
    ...
    pickupTypeId = func(typeInfo *Ast_TypeInfo,forceFlag LnsAny,pickupChildFlag LnsAny) {
            ...
            if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                ...
                for _, _itemTypeInfo := range( typeInfo.FP.Get_children().Items ) {
                    ...
                    if Ast_isPubToExternal(itemTypeInfo.FP.Get_accessMode()){
                        if _switch1659 := itemTypeInfo.FP.Get_kind(); _switch1659 == Ast_TypeInfoKind__Class || _switch1659 == Ast_TypeInfoKind__IF || _switch1659 == Ast_TypeInfoKind__Form || _switch1659 == Ast_TypeInfoKind__FormFunc || _switch1659 == Ast_TypeInfoKind__Func || _switch1659 == Ast_TypeInfoKind__Method {
        ...
        if typeInfo != typeInfo.FP.Get_srcTypeInfo(){
            ...
            if Lns_op_not(typeInfo.FP.Get_externalFlag()){
                if _switch1865 := typeInfo.FP.Get_kind(); _switch1865 == Ast_TypeInfoKind__IF || _switch1865 == Ast_TypeInfoKind__Class || _switch1865 == Ast_TypeInfoKind__Form || _switch1865 == Ast_TypeInfoKind__FormFunc || _switch1865 == Ast_TypeInfoKind__Alge || _switch1865 == Ast_TypeInfoKind__Enum || _switch1865 == Ast_TypeInfoKind__Map || _switch1865 == Ast_TypeInfoKind__Set || _switch1865 == Ast_TypeInfoKind__List || _switch1865 == Ast_TypeInfoKind__Array || _switch1865 == Ast_TypeInfoKind__Alternate || _switch1865 == Ast_TypeInfoKind__Box {
            ...
            if Lns_isCondTrue( pickupChildFlag){
                for _, _itemTypeInfo := range( typeInfo.FP.Get_children().Items ) {
                    ...
                    if itemTypeInfo.FP.Get_accessMode() == Ast_AccessMode__Pub{
                        if _switch2029 := itemTypeInfo.FP.Get_kind(); _switch2029 == Ast_TypeInfoKind__Class || _switch2029 == Ast_TypeInfoKind__IF || _switch2029 == Ast_TypeInfoKind__Form || _switch2029 == Ast_TypeInfoKind__FormFunc || _switch2029 == Ast_TypeInfoKind__Func || _switch2029 == Ast_TypeInfoKind__Method {
                            pickupTypeId(itemTypeInfo, true, true)
                        }
                    }
                }
    ...
    {
        __collection2392 := classId2TypeInfo
        __sorted2392 := __collection2392.CreateKeyListInt()
        __sorted2392.Sort( LnsItemKindInt, nil )
        for _, _classTypeId := range( __sorted2392.Items ) {
            classTypeInfo := __collection2392.Items[ _classTypeId ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            ...
            if classTypeInfo.FP.Get_accessMode() == Ast_AccessMode__Pub{
                pickupTypeId(classTypeInfo, true, Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( validChildrenSet.Items[classTypeInfo] == nil) &&
    ...
    for  {
        ...
        {
            __collection2701 := workClassMap
            __sorted2701 := __collection2701.CreateKeyListInt()
            __sorted2701.Sort( LnsItemKindInt, nil )
            for _, _classTypeId := range( __sorted2701.Items ) {
                classTypeInfo := __collection2701.Items[ _classTypeId ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                classTypeId := _classTypeId.(LnsInt)
                if Lns_op_not(Ast_isBuiltin(classTypeId)){
                    ...
                    if Lns_isCondTrue( checkExportTypeInfo(classTypeInfo)){
                        ...
                        self.FP.writeln(Lns_getVM().String_format("__typeId2ClassInfoMap[ %d ] = __classInfo%d", []LnsAny{classTypeId, classTypeId}))
                        {
                            __collection2679 := scope.FP.Get_symbol2SymbolInfoMap()
                            __sorted2679 := __collection2679.CreateKeyListStr()
                            __sorted2679.Sort( LnsItemKindStr, nil )
                            for _, _fieldName := range( __sorted2679.Items ) {
                                symbolInfo := __collection2679.Items[ _fieldName ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
    ...
    for _, _macroDeclNode := range( node.FP.Get_nodeManager().FP.GetDeclMacroNodeList().Items ) {
        ...
        if declInfo.FP.Get_pubFlag(){
            ...
            firstFlag = true
            {
                __collection2940 := macroInfo.Symbol2MacroValInfoMap
                __sorted2940 := __collection2940.CreateKeyListStr()
                __sorted2940.Sort( LnsItemKindStr, nil )
                for _, _name := range( __sorted2940.Items ) {
                    symInfo := __collection2940.Items[ _name ].(Nodes_MacroValInfoDownCast).ToNodes_MacroValInfo()
                    name := _name.(string)
                    if firstFlag{
                        firstFlag = false
    ...
    {
        __collection3278 := self.pubVarName2InfoMap
        __sorted3278 := __collection3278.CreateKeyListStr()
        __sorted3278.Sort( LnsItemKindStr, nil )
        for _, _varName := range( __sorted3278.Items ) {
            varInfo := __collection3278.Items[ _varName ].(convLua_PubVerInfoDownCast).ToconvLua_PubVerInfo()
    ...
    {
        __collection3295 := self.pubFuncName2InfoMap
        __sorted3295 := __collection3295.CreateKeyListStr()
        __sorted3295.Sort( LnsItemKindStr, nil )
        for _, ___key3295 := range( __sorted3295.Items ) {
            funcInfo := __collection3295.Items[ ___key3295 ].(convLua_PubFuncInfoDownCast).ToconvLua_PubFuncInfo()
    ...
    outputDepend = func(typeInfo *Ast_TypeInfo,moduleTypeInfo *Ast_TypeInfo) bool {
        if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
            ...
            Lns_GetEnv().SetStackVal( typeInfo.FP.Get_nonnilableType() != typeInfo) ).(bool)){
            return false
        }
        {
    ...
    outputTypeInfo = func(typeInfo *Ast_TypeInfo) {
        ...
        if _switch3503 := typeInfo.FP.Get_kind(); _switch3503 == Ast_TypeInfoKind__Class || _switch3503 == Ast_TypeInfoKind__IF {
            if _switch3501 := typeInfo.FP.Get_accessMode(); _switch3501 == Ast_AccessMode__Pub || _switch3501 == Ast_AccessMode__Pro || _switch3501 == Ast_AccessMode__Global {
            } else {
    ...
    {
        __collection3648 := self.pubAlgeId2AlgeTypeInfo
        __sorted3648 := __collection3648.CreateKeyListInt()
        __sorted3648.Sort( LnsItemKindInt, nil )
        for _, _typeId := range( __sorted3648.Items ) {
            typeInfo := __collection3648.Items[ _typeId ].(Ast_AlgeTypeInfoDownCast).ToAst_AlgeTypeInfo()
            typeId := _typeId.(LnsInt)
            typeId2TypeInfo.Set(typeId,&typeInfo.Ast_TypeInfo)
            {
                __collection3646 := typeInfo.FP.Get_valInfoMap()
                __sorted3646 := __collection3646.CreateKeyListStr()
                __sorted3646.Sort( LnsItemKindStr, nil )
                for _, ___key3646 := range( __sorted3646.Items ) {
                    valInfo := __collection3646.Items[ ___key3646 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
    ...
    {
        __collection3787 := typeId2TypeInfo
        __sorted3787 := __collection3787.CreateKeyListInt()
        __sorted3787.Sort( LnsItemKindInt, nil )
        for _, ___key3787 := range( __sorted3787.Items ) {
            typeInfo := __collection3787.Items[ ___key3787 ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            var valid bool
            valid = false
            var moduleTypeInfo *Ast_TypeInfo
            moduleTypeInfo = typeInfo.FP.GetModule()
    ...
    {
        __collection3867 := importNameMap
        __sorted3867 := __collection3867.CreateKeyListStr()
        __sorted3867.Sort( LnsItemKindStr, nil )
        for _, _name := range( __sorted3867.Items ) {
            moduleTypeInfo := __collection3867.Items[ _name ].(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            name := _name.(string)
...
// 886: decl @lune.@base.@convLua.convFilter.processRoot
...
// 993: decl @lune.@base.@convLua.convFilter.processSubfile
func (self *convLua_convFilter) ProcessSubfile(node *Nodes_SubfileNode,_opt LnsAny) {
}

// 999: decl @lune.@base.@convLua.convFilter.processBlockSub
func (self *convLua_convFilter) ProcessBlockSub(node *Nodes_BlockNode,_opt LnsAny) {
    var word string
    word = ""
    if _switch4816 := node.FP.Get_blockKind(); _switch4816 == Nodes_BlockKind__If || _switch4816 == Nodes_BlockKind__Elseif {
        word = "then"
        
    } else if _switch4816 == Nodes_BlockKind__Else {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__While {
        word = "do"
        
    } else if _switch4816 == Nodes_BlockKind__Repeat {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__For {
        word = "do"
        
    } else if _switch4816 == Nodes_BlockKind__Apply {
        word = "do"
        
    } else if _switch4816 == Nodes_BlockKind__Foreach {
        word = "do"
        
    } else if _switch4816 == Nodes_BlockKind__Macro {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__Func {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__Default {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__Block {
        word = "do"
        
    } else if _switch4816 == Nodes_BlockKind__LetUnwrap {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__LetUnwrapThenDo {
        word = ""
        
    } else if _switch4816 == Nodes_BlockKind__IfUnwrap {
        word = ""
...
// 1067: decl @lune.@base.@convLua.convFilter.processLoadRuntime
...
// 1077: decl @lune.@base.@convLua.convFilter.processScope
...
// 1087: decl @lune.@base.@convLua.convFilter.processStmtExp
...
// 1093: decl @lune.@base.@convLua.convFilter.processDeclEnum
...
// 1175: decl @lune.@base.@convLua.convFilter.getMapInfo
func (self *convLua_convFilter) getMapInfo(typeInfo *Ast_TypeInfo)(string, bool, string) {
    ...
    var funcTxt string
    funcTxt = ""
    if _switch5868 := nonnilableType.FP.Get_kind(); _switch5868 == Ast_TypeInfoKind__Stem {
        funcTxt = "_lune._toStem"
        
    } else if _switch5868 == Ast_TypeInfoKind__Class || _switch5868 == Ast_TypeInfoKind__IF {
        if Lns_op_not(nonnilableType.FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil)){
            ...
            if convLua_isGenericType_1323_(nonnilableType){
                var memStream *Util_memStream
                memStream = NewUtil_memStream()
    ...
    } else if _switch5868 == Ast_TypeInfoKind__Enum || _switch5868 == Ast_TypeInfoKind__Alge {
        funcTxt = Lns_getVM().String_format("%s._from", []LnsAny{self.FP.getFullName(nonnilableType)})
        
    } else if _switch5868 == Ast_TypeInfoKind__Prim {
        if _switch5648 := nonnilableType; _switch5648 == Ast_builtinTypeInt {
            funcTxt = "_lune._toInt"
            
        } else if _switch5648 == Ast_builtinTypeReal {
            funcTxt = "_lune._toReal"
            
        } else if _switch5648 == Ast_builtinTypeBool {
            funcTxt = "_lune._toBool"
            
        } else {
            Util_err(Lns_getVM().String_format("unknown type -- %s", []LnsAny{nonnilableType.FP.GetTxt(nil, nil, nil)}))
        }
    } else if _switch5868 == Ast_TypeInfoKind__Map {
    ...
    } else if _switch5868 == Ast_TypeInfoKind__Set {
    ...
    } else if _switch5868 == Ast_TypeInfoKind__List || _switch5868 == Ast_TypeInfoKind__Array {
    ...
    } else if _switch5868 == Ast_TypeInfoKind__Alternate {
        var prefix string
...
// 1259: decl @lune.@base.@convLua.convFilter.processDeclAlge
func (self *convLua_convFilter) ProcessDeclAlge(node *Nodes_DeclAlgeNode,_opt LnsAny) {
    ...
    {
        __collection6226 := node.FP.Get_algeType().FP.Get_valInfoMap()
        __sorted6226 := __collection6226.CreateKeyListStr()
        __sorted6226.Sort( LnsItemKindStr, nil )
        for _, ___key6226 := range( __sorted6226.Items ) {
            valInfo := __collection6226.Items[ ___key6226 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
...
// 1320: decl @lune.@base.@convLua.convFilter.processNewAlgeVal
...
// 1341: decl @lune.@base.@convLua.convFilter.getDestrClass
...
// 1354: decl @lune.@base.@convLua.convFilter.outputAlter2MapFunc
...
// 1379: decl @lune.@base.@convLua.convFilter.processProtoClass
...
// 1385: decl @lune.@base.@convLua.convFilter.processDeclClass
func (self *convLua_convFilter) ProcessDeclClass(node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    self.classId2MemberList.Set(classTypeId,nodeInfo.FP.Get_memberList())
    {
        ...
        if __exp != nil {
            ...
            if _switch6699 := node.FP.Get_accessMode(); _switch6699 == Ast_AccessMode__Pub || _switch6699 == Ast_AccessMode__Pro {
                if self.needModuleObj{
                    self.FP.writeln("")
    ...
    baseTxt = ""
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
        Lns_GetEnv().SetStackVal( baseInfo.FP.Get_typeId() != Ast_rootTypeId) &&
    ...
    if classTypeInfo.FP.IsInheritFrom(self.processInfo, Ast_builtinTypeMapping, nil){
        ...
        var argTxt string
        argTxt = "{}, val"
        if convLua_isGenericType_1323_(classTypeInfo){
...
// 1718: decl @lune.@base.@convLua.convFilter.processDeclMember
func (self *convLua_convFilter) ProcessDeclMember(node *Nodes_DeclMemberNode,_opt LnsAny) {
}

// 1725: decl @lune.@base.@convLua.convFilter.processExpMacroExp
...
// 1737: decl @lune.@base.@convLua.convFilter.outputDeclMacro
func (self *convLua_convFilter) OutputDeclMacro(name string,argNameList *LnsList,callback convLua_outputMacroStmtBlock_1385_) {
...
// 1781: decl @lune.@base.@convLua.convFilter.processExpMacroStatList
...
// 1789: decl @lune.@base.@convLua.convFilter.processDeclMacro
func (self *convLua_convFilter) ProcessDeclMacro(node *Nodes_DeclMacroNode,_opt LnsAny) {
    if self.inMacro{
        ...
        self.FP.OutputDeclMacro(macroInfo.FP.Get_name().Txt, argNameList, convLua_outputMacroStmtBlock_1385_(func() {
            {
...
// 1808: decl @lune.@base.@convLua.convFilter.processExpMacroStat
...
// 1826: decl @lune.@base.@convLua.convFilter.processExpNew
...
// 1837: decl @lune.@base.@convLua.convFilter.process__func__symbol
...
// 1851: decl @lune.@base.@convLua.convFilter.processDeclConstr
...
// 1906: decl @lune.@base.@convLua.convFilter.processDeclDestr
func (self *convLua_convFilter) ProcessDeclDestr(node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( Lns_GetEnv(), func () LnsAny { return Lns_GetEnv().NilAccPop().(*Ast_TypeInfo).FP.GetTxt(nil, nil, nil)})/* 1910:9 */)}))
...
// 1926: decl @lune.@base.@convLua.convFilter.processExpCallSuperCtor
...
// 1945: decl @lune.@base.@convLua.convFilter.processExpCallSuper
...
// 1961: decl @lune.@base.@convLua.convFilter.processDeclMethod
...
// 1994: decl @lune.@base.@convLua.convFilter.processUnwrapSet
...
// 2027: decl @lune.@base.@convLua.convFilter.processExpListSub
...
// 2054: decl @lune.@base.@convLua.convFilter.processExpMRet
...
// 2060: decl @lune.@base.@convLua.convFilter.processIfUnwrap
...
// 2103: decl @lune.@base.@convLua.convFilter.processWhen
...
// 2125: decl @lune.@base.@convLua.convFilter.processDeclVar
...
// 2237: decl @lune.@base.@convLua.convFilter.processDeclArg
...
// 2245: decl @lune.@base.@convLua.convFilter.processDeclArgDDD
func (self *convLua_convFilter) ProcessDeclArgDDD(node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.Write("...")
}

// 2251: decl @lune.@base.@convLua.convFilter.processDeclFunc
...
// 2292: decl @lune.@base.@convLua.convFilter.processRefType
...
// 2306: decl @lune.@base.@convLua.convFilter.processIf
...
// 2328: decl @lune.@base.@convLua.convFilter.processSwitch
...
// 2371: decl @lune.@base.@convLua.convFilter.processMatch
...
// 2410: decl @lune.@base.@convLua.convFilter.processWhile
...
// 2421: decl @lune.@base.@convLua.convFilter.processRepeat
...
// 2430: decl @lune.@base.@convLua.convFilter.processFor
...
// 2446: decl @lune.@base.@convLua.convFilter.processApply
...
// 2464: decl @lune.@base.@convLua.convFilter.processForeach
func (self *convLua_convFilter) ProcessForeach(node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    self.FP.Write("for ")
    if keySym != nil{
        keySym_6692 := keySym.(*Ast_SymbolInfo)
        self.FP.Write(convLua_getSymTxt_1068_(keySym_6692.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{keySym_6692.FP.Get_symbolId()})))
    } else {
        self.FP.Write("__index")
    }
    self.FP.Write(", ")
    if valSym != nil{
        valSym_6695 := valSym.(*Ast_SymbolInfo)
        self.FP.Write(convLua_getSymTxt_1068_(valSym_6695.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{valSym_6695.FP.Get_symbolId()})))
    } else {
        self.FP.Write("__val")
    }
    if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
...
// 2514: decl @lune.@base.@convLua.convFilter.processForsort
func (self *convLua_convFilter) ProcessForsort(node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    key = "__key"
    if keySym != nil{
        keySym_6714 := keySym.(*Ast_SymbolInfo)
        key = convLua_getSymTxt_1068_(keySym_6714.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{keySym_6714.FP.Get_symbolId()}))
    ...
    self.FP.pushIndent(nil)
    if valSym != nil{
        valSym_6716 := valSym.(*Ast_SymbolInfo)
        self.FP.writeln(Lns_getVM().String_format("local %s = __map[ %s ]", []LnsAny{convLua_getSymTxt_1068_(valSym_6716.FP.Get_name(), Lns_getVM().String_format("%d", []LnsAny{valSym_6716.FP.Get_symbolId()})), key}))
    }
    convLua_filter_1170_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    self.FP.writeln("end")
    self.FP.popIndent()
...
// 2567: decl @lune.@base.@convLua.convFilter.processExpUnwrap
...
// 2585: decl @lune.@base.@convLua.convFilter.processExpCall
func (self *convLua_convFilter) ProcessExpCall(node *Nodes_ExpCallNode,_opt LnsAny) {
    ...
    fieldCall = func() bool {
        ...
        processSet = func() bool {
            ...
            if _switch13053 := fieldNode.FP.Get_field().Txt; _switch13053 == "add" || _switch13053 == "del" {
                ...
                self.FP.Write("]")
                if _switch13047 := fieldNode.FP.Get_field().Txt; _switch13047 == "add" {
                    self.FP.Write("= true")
                } else if _switch13047 == "del" {
                    self.FP.Write("= nil")
                }
                return false
            }
        ...
        if node.FP.Get_nilAccess(){
            ...
            if _switch13307 := prefixType.FP.Get_kind(); _switch13307 == Ast_TypeInfoKind__List || _switch13307 == Ast_TypeInfoKind__Array {
            ...
            if _switch13553 := prefixType.FP.Get_kind(); _switch13553 == Ast_TypeInfoKind__List || _switch13553 == Ast_TypeInfoKind__Array {
                setArgFlag = true
                ...
                convLua_filter_1170_(prefixNode, self, &fieldNode.Nodes_Node)
            } else if _switch13553 == Ast_TypeInfoKind__Set {
                if Lns_op_not(processSet()){
                    return false
                }
            } else if _switch13553 == Ast_TypeInfoKind__Enum || _switch13553 == Ast_TypeInfoKind__Alge {
                processEnumAlge()
            } else if _switch13553 == Ast_TypeInfoKind__Box {
                convLua_filter_1170_(prefixNode, self, &fieldNode.Nodes_Node)
                self.FP.Write("[1]")
                return false
            } else if _switch13553 == Ast_TypeInfoKind__Class {
                if Lns_isCondTrue( Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
                    Lns_GetEnv().SetStackVal( prefixType.FP.IsInheritFrom(self.processInfo, Ast_builtinTypeMapping, nil)) &&
                    Lns_GetEnv().SetStackVal( convLua_isGenericType_1323_(prefixType)) &&
                    Lns_GetEnv().SetStackVal( (Lns_GetEnv().PopVal( Lns_GetEnv().IncStack() ||
    ...
    }
    {
        ...
        if _argList != nil {
            ...
            if convStrFlag{
                ...
                if expList.Len() > 0{
                    var literal LnsAny
                    literal = convLua_convExp13890(Lns_2DDD(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node().FP.GetLiteral()))
                    if literal != nil{
                        literal_6806 := literal
                        switch _exp13909 := literal_6806.(type) {
                ...
                for _index, _argNode := range( expList.Items ) {
                    ...
                    if index > 1{
                        ...
                        if index - 1 <= opList.Len(){
                            var formType LnsInt
                            formType = convLua_convExp13965(Lns_2DDD(TransUnit_isMatchStringFormatType(opList.GetAt(index - 1).(string), argNode.FP.Get_expType(), self.targetLuaVer)))
...
// 2822: decl @lune.@base.@convLua.convFilter.processExpList
...
// 2831: decl @lune.@base.@convLua.convFilter.processExpOp1
func (self *convLua_convFilter) ProcessExpOp1(node *Nodes_ExpOp1Node,_opt LnsAny) {
    ...
    if op == ",,,"{
        ...
        if _switch14260 := node.FP.Get_exp().FP.Get_expType(); _switch14260 == Ast_builtinTypeInt || _switch14260 == Ast_builtinTypeReal || _switch14260 == Ast_builtinTypeBool {
            convLua_filter_1170_(node.FP.Get_exp(), self, &node.Nodes_Node)
        } else {
...
func (self *convLua_convFilter) ProcessExpCast(node *Nodes_ExpCastNode,_opt LnsAny) {
    ...
    } else if _switch14679 == Nodes_CastKind__Normal {
        self.FP.Write("_lune.__Cast( ")
        convLua_filter_1170_(node.FP.Get_exp(), self, &node.Nodes_Node)
        var castKind LnsInt
        var classObj string
        classObj = "nil"
        if _switch14643 := node.FP.Get_expType().FP.Get_nonnilableType(); _switch14643 == Ast_builtinTypeInt {
            castKind = LuaMod_CastKind__Int
            
        } else if _switch14643 == Ast_builtinTypeReal {
            castKind = LuaMod_CastKind__Real
            
        } else if _switch14643 == Ast_builtinTypeString {
    ...
    } else if _switch14679 == Nodes_CastKind__Implicit {
        convLua_filter_1170_(node.FP.Get_exp(), self, &node.Nodes_Node)
    }
}

// 2939: decl @lune.@base.@convLua.convFilter.processExpParen
...
// 2948: decl @lune.@base.@convLua.convFilter.processExpSetVal
...
// 2955: decl @lune.@base.@convLua.convFilter.processExpSetItem
func (self *convLua_convFilter) ProcessExpSetItem(node *Nodes_ExpSetItemNode,_opt LnsAny) {
    convLua_filter_1170_(node.FP.Get_val(), self, &node.Nodes_Node)
    self.FP.Write("[")
    switch _exp14837 := node.FP.Get_index().(type) {
    case *Nodes_IndexVal__NodeIdx:
    index := _exp14837.Val1
...
// 2973: decl @lune.@base.@convLua.convFilter.processExpOp2
func (self *convLua_convFilter) ProcessExpOp2(node *Nodes_ExpOp2Node,_opt LnsAny) {
    ...
    opTxt = node.FP.Get_op().Txt
    {
        ...
        if __exp != nil {
            _exp := __exp.(LnsInt)
            if self.targetLuaVer.FP.Get_hasBitOp() == LuaVer_BitOp__HasOp{
                if _switch14967 := _exp; _switch14967 == Ast_BitOpKind__LShift {
                    opTxt = "<<"
                    
                } else if _switch14967 == Ast_BitOpKind__RShift {
                    opTxt = ">>"
                ...
                var exp2Mod string
                exp2Mod = ""
                if _switch15084 := _exp; _switch15084 == Ast_BitOpKind__And {
                    binfunc = "band"
                    
                } else if _switch15084 == Ast_BitOpKind__Or {
                    binfunc = "bor"
                    
                } else if _switch15084 == Ast_BitOpKind__Xor {
                    binfunc = "bxor"
                    
                } else if _switch15084 == Ast_BitOpKind__LShift {
                    binfunc = "lshift"
                    
                } else if _switch15084 == Ast_BitOpKind__RShift {
                    binfunc = "lshift"
...
// 3043: decl @lune.@base.@convLua.convFilter.processExpRef
func (self *convLua_convFilter) ProcessExpRef(node *Nodes_ExpRefNode,_opt LnsAny) {
    if _switch15378 := node.FP.Get_symbolInfo().FP.Get_name(); _switch15378 == "super" {
        var funcType *Ast_TypeInfo
...
// 3079: decl @lune.@base.@convLua.convFilter.processExpRefItem
...
// 3121: decl @lune.@base.@convLua.convFilter.processRefField
...
// 3153: decl @lune.@base.@convLua.convFilter.processExpOmitEnum
...
// 3164: decl @lune.@base.@convLua.convFilter.processGetField
...
// 3204: decl @lune.@base.@convLua.convFilter.processReturn
...
// 3214: decl @lune.@base.@convLua.convFilter.processLuneKind
...
// 3227: decl @lune.@base.@convLua.convFilter.processTestCase
...
// 3249: decl @lune.@base.@convLua.convFilter.processTestBlock
...
// 3260: decl @lune.@base.@convLua.convFilter.processProvide
func (self *convLua_convFilter) ProcessProvide(node *Nodes_ProvideNode,_opt LnsAny) {
}

// 3265: decl @lune.@base.@convLua.convFilter.processAlias
...
// 3275: decl @lune.@base.@convLua.convFilter.processBoxing
...
// 3285: decl @lune.@base.@convLua.convFilter.processUnboxing
func (self *convLua_convFilter) ProcessUnboxing(node *Nodes_UnboxingNode,_opt LnsAny) {
    convLua_filter_1170_(node.FP.Get_src(), self, &node.Nodes_Node)
    self.FP.Write("[1]")
}

// 3293: decl @lune.@base.@convLua.convFilter.processLiteralList
...
// 3305: decl @lune.@base.@convLua.convFilter.processLiteralSet
...
// 3323: decl @lune.@base.@convLua.convFilter.processLiteralMap
...
// 3341: decl @lune.@base.@convLua.convFilter.processLiteralArray
...
// 3354: decl @lune.@base.@convLua.convFilter.processLiteralChar
    ...
    opList = TransUnit_findForm(txt)
    {
        ...
        if _expList != nil {
            ...
            for _index, _val := range( expList.FP.Get_expList().Items ) {
                ...
                if index <= opList.Len(){
                    matchFlag = convLua_convExp17021(Lns_2DDD(TransUnit_isMatchStringFormatType(opList.GetAt(index).(string), val.FP.Get_expType(), self.targetLuaVer)))
...
// 3441: decl @lune.@base.@convLua.convFilter.processLuneControl
...
// 3476: decl @lune.@base.@convLua.MacroEvalImp.evalFromMacroCode
func (self *ConvLua_MacroEvalImp) evalFromMacroCode(code string) *Lns_luaValue {
    ...
    Log_log(Log_Level__Trace, __func__, 3478, Log_CreateMessage(func() string {
        return Lns_getVM().String_format("macro: %s", []LnsAny{code})
    }))
    
    var _func LnsAny
    var err string
    _func,err = convLua_runLuaOnLns_1654_(code)
    if _func != nil{
        func_7241 := _func
        return func_7241.(*Lns_luaValue)
    }
    Util_err(err)
// insert a dummy
    return nil
...
func (self *ConvLua_MacroEvalImp) EvalFromCode(processInfo *Ast_ProcessInfo,name string,argNameList *LnsList,code LnsAny) *Lns_luaValue {
    ...
    conv.FP.OutputDeclMacro(name, argNameList, convLua_outputMacroStmtBlock_1385_(func() {
        if code != nil{
            code_7255 := code.(string)
            conv.FP.Write(code_7255)
        }
    }))
