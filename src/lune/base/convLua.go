...
// for 3819
func convLua_convExp0_3724(arg1 []LnsAny) LnsInt {
...
// 276: decl @lune.@base.@convLua.filter
...
// 233: decl @lune.@base.@convLua.ConvFilter.getFullName
...
// 237: decl @lune.@base.@convLua.ConvFilter.close
func (self *convLua_ConvFilter) Close(_env *LnsEnv) {
}
// 239: decl @lune.@base.@convLua.ConvFilter.flush
func (self *convLua_ConvFilter) Flush(_env *LnsEnv) {
}
// 242: decl @lune.@base.@convLua.ConvFilter.writeRaw
...
// 254: decl @lune.@base.@convLua.ConvFilter.write
...
// 314: decl @lune.@base.@convLua.ConvFilter.popIndent
...
func (self *convLua_ConvFilter) ProcessImport(_env *LnsEnv, node *Nodes_ImportNode,_opt LnsAny) {
    ...
    self.FP.WriteRaw(_env, _env.GetVM().String_format("( '%s' )", Lns_2DDD(modulePath)))
}
...
// 2040: decl @lune.@base.@convLua.ConvFilter.processExpMacroArgExp
func (self *convLua_ConvFilter) ProcessExpMacroArgExp(_env *LnsEnv, node *Nodes_ExpMacroArgExpNode,_opt LnsAny) {
    convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 2047: decl @lune.@base.@convLua.ConvFilter.processExpMacroExp
...
// 2059: decl @lune.@base.@convLua.ConvFilter.outputDeclMacro
...
// 2103: decl @lune.@base.@convLua.ConvFilter.processExpMacroStatList
...
// 2111: decl @lune.@base.@convLua.ConvFilter.processDeclMacro
...
// 2130: decl @lune.@base.@convLua.ConvFilter.processExpMacroStat
...
// 2148: decl @lune.@base.@convLua.ConvFilter.processExpNew
...
// 2159: decl @lune.@base.@convLua.ConvFilter.process__func__symbol
...
// 2173: decl @lune.@base.@convLua.ConvFilter.processDeclConstr
...
// 2228: decl @lune.@base.@convLua.ConvFilter.processDeclDestr
func (self *convLua_ConvFilter) ProcessDeclDestr(_env *LnsEnv, node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_TypeInfo).FP.GetTxt(_env, nil, nil, nil)})/* 2232:9 */))))
...
// 2248: decl @lune.@base.@convLua.ConvFilter.processExpCallSuperCtor
...
// 2263: decl @lune.@base.@convLua.ConvFilter.processExpCallSuper
...
// 2279: decl @lune.@base.@convLua.ConvFilter.processDeclMethod
...
// 2312: decl @lune.@base.@convLua.ConvFilter.processUnwrapSet
...
// 2345: decl @lune.@base.@convLua.ConvFilter.processExpListSub
...
// 2372: decl @lune.@base.@convLua.ConvFilter.processExpMRet
...
// 2378: decl @lune.@base.@convLua.ConvFilter.processIfUnwrap
...
// 2425: decl @lune.@base.@convLua.ConvFilter.processWhen
...
// 2447: decl @lune.@base.@convLua.ConvFilter.processExpExpandTuple
...
// 2456: decl @lune.@base.@convLua.ConvFilter.processDeclVar
...
// 2572: decl @lune.@base.@convLua.ConvFilter.processDeclArg
...
// 2580: decl @lune.@base.@convLua.ConvFilter.processDeclArgDDD
func (self *convLua_ConvFilter) ProcessDeclArgDDD(_env *LnsEnv, node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, "...")
}
// 2586: decl @lune.@base.@convLua.ConvFilter.processDeclFunc
...
// 2628: decl @lune.@base.@convLua.ConvFilter.processRefType
...
// 2648: decl @lune.@base.@convLua.ConvFilter.processIf
...
// 2673: decl @lune.@base.@convLua.ConvFilter.processSwitch
...
// 2716: decl @lune.@base.@convLua.ConvFilter.processMatch
...
// 2755: decl @lune.@base.@convLua.ConvFilter.processWhile
...
// 2766: decl @lune.@base.@convLua.ConvFilter.processRepeat
...
// 2775: decl @lune.@base.@convLua.ConvFilter.processFor
...
// 2791: decl @lune.@base.@convLua.ConvFilter.processApply
...
// 2809: decl @lune.@base.@convLua.ConvFilter.processForeach
...
// 2859: decl @lune.@base.@convLua.ConvFilter.processForsort
...
// 2911: decl @lune.@base.@convLua.ConvFilter.processExpUnwrap
...
// 2929: decl @lune.@base.@convLua.ConvFilter.processExpCall
    ...
    }
    {
        ...
        if !Lns_IsNil( _argList ) {
            ...
            if convStrFlag{
                ...
                if expList.Len() > 0{
                    var literal LnsAny
                    literal = convLua_convExp4_2081(Lns_2DDD(expList.GetAt(1).FP.GetLiteral(_env)))
                    if literal != nil{
                        literal_131 := literal
                ...
                for _index, _argNode := range( expList.Items ) {
                    ...
                    if index > 1{
                        ...
                        if index - 1 <= opList.Len(){
                            var formType LnsInt
                            formType = convLua_convExp4_2157(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index - 1), argNode.FP.Get_expType(_env), self.targetLuaVer)))
    ...
    opList = TransUnit_findForm(_env, txt)
    {
        ...
        if !Lns_IsNil( _expList ) {
            ...
            for _index, _val := range( expList.FP.Get_expList(_env).Items ) {
                ...
                if index <= opList.Len(){
                    matchFlag = convLua_convExp0_3724(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index), val.FP.Get_expType(_env), self.targetLuaVer)))
                }
