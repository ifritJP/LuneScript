...
// for 4088
func convLua_convExp0_4772(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 3845
func convLua_convExp0_3738(arg1 []LnsAny) LnsInt {
...
// for 4011
func convLua_convExp0_4300(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 4086
func convLua_convExp0_4520(arg1 []LnsAny) (LnsAny, LnsAny) {
...
// 1474: decl @lune.@base.@convLua.isGenericType
...
// 3923: decl @lune.@base.@convLua.createFilter
...
// 1238: decl @lune.@base.@convLua.ConvFilter.processAsyncLock
...
// 1245: decl @lune.@base.@convLua.ConvFilter.processBlockSub
...
// 1315: decl @lune.@base.@convLua.ConvFilter.processLoadRuntime
...
// 1325: decl @lune.@base.@convLua.ConvFilter.processScope
...
// 1334: decl @lune.@base.@convLua.ConvFilter.processCondRet
...
// 1340: decl @lune.@base.@convLua.ConvFilter.outputCondRet
...
// 1385: decl @lune.@base.@convLua.ConvFilter.processCondRetList
func (self *convLua_ConvFilter) ProcessCondRetList(_env *LnsEnv, node *Nodes_CondRetListNode,_opt LnsAny) {
    convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
}
// 1391: decl @lune.@base.@convLua.ConvFilter.outputCondRetInfo
...
// 1397: decl @lune.@base.@convLua.ConvFilter.processStmtExp
...
// 1408: decl @lune.@base.@convLua.ConvFilter.processDeclEnum
...
// 1490: decl @lune.@base.@convLua.ConvFilter.getMapInfo
...
// 1580: decl @lune.@base.@convLua.ConvFilter.processDeclAlge
...
// 1648: decl @lune.@base.@convLua.ConvFilter.processNewAlgeVal
...
// 1669: decl @lune.@base.@convLua.ConvFilter.getDestrClass
...
// 1682: decl @lune.@base.@convLua.ConvFilter.outputAlter2MapFunc
...
// 1707: decl @lune.@base.@convLua.ConvFilter.processProtoClass
...
// 1713: decl @lune.@base.@convLua.ConvFilter.processDeclClass
...
// 2069: decl @lune.@base.@convLua.ConvFilter.outputDeclMacro
...
// 2113: decl @lune.@base.@convLua.ConvFilter.processExpMacroStatList
...
// 2121: decl @lune.@base.@convLua.ConvFilter.processDeclMacro
...
// 2140: decl @lune.@base.@convLua.ConvFilter.processExpMacroStat
...
// 2158: decl @lune.@base.@convLua.ConvFilter.processExpNew
...
// 2169: decl @lune.@base.@convLua.ConvFilter.process__func__symbol
...
// 2183: decl @lune.@base.@convLua.ConvFilter.processDeclConstr
...
// 2238: decl @lune.@base.@convLua.ConvFilter.processDeclDestr
func (self *convLua_ConvFilter) ProcessDeclDestr(_env *LnsEnv, node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_TypeInfo).FP.GetTxt(_env, nil, nil, nil)})/* 2242:9 */))))
...
// 2258: decl @lune.@base.@convLua.ConvFilter.processExpCallSuperCtor
...
// 2273: decl @lune.@base.@convLua.ConvFilter.processExpCallSuper
...
// 2289: decl @lune.@base.@convLua.ConvFilter.processDeclMethod
...
// 2322: decl @lune.@base.@convLua.ConvFilter.processUnwrapSet
...
// 2355: decl @lune.@base.@convLua.ConvFilter.processExpListSub
...
// 2382: decl @lune.@base.@convLua.ConvFilter.processExpMRet
...
// 2388: decl @lune.@base.@convLua.ConvFilter.processIfUnwrap
...
// 2435: decl @lune.@base.@convLua.ConvFilter.processWhen
...
// 2457: decl @lune.@base.@convLua.ConvFilter.processExpExpandTuple
...
// 2466: decl @lune.@base.@convLua.ConvFilter.processDeclVar
...
// 2583: decl @lune.@base.@convLua.ConvFilter.processDeclArg
...
// 2591: decl @lune.@base.@convLua.ConvFilter.processDeclArgDDD
func (self *convLua_ConvFilter) ProcessDeclArgDDD(_env *LnsEnv, node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, "...")
}
// 2597: decl @lune.@base.@convLua.ConvFilter.processDeclFunc
...
// 2640: decl @lune.@base.@convLua.ConvFilter.processRefType
...
// 2660: decl @lune.@base.@convLua.ConvFilter.processIf
...
// 2685: decl @lune.@base.@convLua.ConvFilter.processSwitch
...
// 2728: decl @lune.@base.@convLua.ConvFilter.processMatch
...
// 2767: decl @lune.@base.@convLua.ConvFilter.processWhile
...
// 2778: decl @lune.@base.@convLua.ConvFilter.processRepeat
...
// 2788: decl @lune.@base.@convLua.ConvFilter.processFor
...
// 2804: decl @lune.@base.@convLua.ConvFilter.processApply
...
// 2822: decl @lune.@base.@convLua.ConvFilter.processForeach
...
// 2872: decl @lune.@base.@convLua.ConvFilter.processForsort
...
// 2924: decl @lune.@base.@convLua.ConvFilter.processExpUnwrap
...
// 2942: decl @lune.@base.@convLua.ConvFilter.processExpCall
...
// 3247: decl @lune.@base.@convLua.ConvFilter.processExpList
...
// 3256: decl @lune.@base.@convLua.ConvFilter.processExpOp1
...
// 3364: decl @lune.@base.@convLua.ConvFilter.processExpParen
func (self *convLua_ConvFilter) ProcessExpParen(_env *LnsEnv, node *Nodes_ExpParenNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, "(")
    convLua_filter_9_(_env, node.FP.Get_exp(_env), self, &node.Nodes_Node)
    self.FP.WriteRaw(_env, " )")
}
// 3373: decl @lune.@base.@convLua.ConvFilter.processExpSetVal
...
// 3384: decl @lune.@base.@convLua.ConvFilter.processExpSetItem
...
// 3406: decl @lune.@base.@convLua.ConvFilter.processExpOp2
...
// 3476: decl @lune.@base.@convLua.ConvFilter.processExpRef
...
// 3512: decl @lune.@base.@convLua.ConvFilter.processExpRefItem
...
// 3555: decl @lune.@base.@convLua.ConvFilter.processRefField
...
// 3594: decl @lune.@base.@convLua.ConvFilter.processExpOmitEnum
...
// 3605: decl @lune.@base.@convLua.ConvFilter.processGetField
...
// 3644: decl @lune.@base.@convLua.ConvFilter.processReturn
...
// 3655: decl @lune.@base.@convLua.ConvFilter.processLuneKind
...
// 3668: decl @lune.@base.@convLua.ConvFilter.processTestCase
...
// 3690: decl @lune.@base.@convLua.ConvFilter.processTestBlock
...
// 3701: decl @lune.@base.@convLua.ConvFilter.processProvide
func (self *convLua_ConvFilter) ProcessProvide(_env *LnsEnv, node *Nodes_ProvideNode,_opt LnsAny) {
}
// 3706: decl @lune.@base.@convLua.ConvFilter.processAlias
...
// 3716: decl @lune.@base.@convLua.ConvFilter.processBoxing
...
// 3755: decl @lune.@base.@convLua.ConvFilter.processLiteralSet
...
// 3773: decl @lune.@base.@convLua.ConvFilter.processLiteralMap
...
// 3791: decl @lune.@base.@convLua.ConvFilter.processLiteralArray
...
// 3804: decl @lune.@base.@convLua.ConvFilter.processLiteralChar
...
// 3810: decl @lune.@base.@convLua.ConvFilter.processLiteralInt
...
// 3818: decl @lune.@base.@convLua.ConvFilter.processLiteralReal
func (self *convLua_ConvFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.WriteRaw(_env, node.FP.Get_token(_env).Txt)
}
// 3825: decl @lune.@base.@convLua.ConvFilter.processLiteralString
    ...
    opList = TransUnit_findForm(_env, txt)
    {
        ...
        if !Lns_IsNil( _expList ) {
            ...
            for _index, _val := range( expList.FP.Get_expList(_env).Items ) {
                ...
                if index <= opList.Len(){
                    matchFlag = convLua_convExp0_3738(Lns_2DDD(TransUnit_isMatchStringFormatType(_env, opList.GetAt(index), val.FP.Get_expType(_env), self.targetLuaVer)))
                }
...
// 3891: decl @lune.@base.@convLua.ConvFilter.processLuneControl
...
// 3904: decl @lune.@base.@convLua.FilterInfo.outputLuaAndMeta
...
// 3911: decl @lune.@base.@convLua.FilterInfo.outputLua
func (self *ConvLua_FilterInfo) OutputLua(_env *LnsEnv, node *Nodes_RootNode) {
    node.FP.ProcessFilter(_env, self.filter, ConvLua_Opt2Stem(NewConvLua_Opt(_env, &node.Nodes_Node)))
}
// 3916: decl @lune.@base.@convLua.FilterInfo.outputMeta
func (self *ConvLua_FilterInfo) OutputMeta(_env *LnsEnv, node *Nodes_RootNode) {
}
// 3947: decl @lune.@base.@convLua.MacroEvalImp.evalFromCodeToLuaCode
func (self *ConvLua_MacroEvalImp) EvalFromCodeToLuaCode(_env *LnsEnv, processInfo *Ast_ProcessInfo,name string,argNameList *LnsList2_[string],code LnsAny) string {
    ...
    conv.FP.OutputDeclMacro(_env, name, argNameList, convLua_outputMacroStmtBlock_13_(func(_env *LnsEnv) {
        if code != nil{
            code_919 := code.(string)
            conv.FP.Write(_env, code_919)
        }
    }))
    return stream.FP.Get_txt(_env)
}
// 3967: decl @lune.@base.@convLua.MacroEvalImp.evalToLuaCode
