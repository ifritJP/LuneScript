...
// 206: decl @lune.@base.@convLua.filter
...
// 1240: decl @lune.@base.@convLua.isGenericType
...
// 3551: decl @lune.@base.@convLua.createFilter
...
// 3562: decl @lune.@base.@convLua.runLuaOnLns
...
// 3629: decl @lune.@base.@convLua.createAstFromStream
...
// 3645: decl @lune.@base.@convLua.createAstFromFile
...
// 3654: decl @lune.@base.@convLua.createAst
...
// 3661: decl @lune.@base.@convLua.getTestLnsCode
...
// 3693: decl @lune.@base.@convLua.Ast2Code
...
// 3711: decl @lune.@base.@convLua.runTestCode
            ...
            if !Lns_IsNil( _mod ) {
                mod := _mod
                {
                    ...
                    if !Lns_IsNil( _listobj ) {
                        ...
                        if ctrl.FP.CheckEq(_env, strList.Len(), 4, "#strList", "4", nil, convLua__mod__, 3717){
                            ctrl.FP.CheckEq(_env, strList.GetAt(1).(string), "hello world", "strList[ 1 ]", "\"hello world\"", nil, convLua__mod__, 3718)
                            ctrl.FP.CheckEq(_env, strList.GetAt(2).(string), "11", "strList[ 2 ]", "\"11\"", nil, convLua__mod__, 3719)
                            ctrl.FP.CheckEq(_env, strList.GetAt(3).(string), "12", "strList[ 3 ]", "\"12\"", nil, convLua__mod__, 3720)
                            ctrl.FP.CheckEq(_env, strList.GetAt(4).(string), "13", "strList[ 4 ]", "\"13\"", nil, convLua__mod__, 3721)
                        }
                    }
                }
            }
...
// 153: decl @lune.@base.@convLua.convFilter.get_indent
...
// 160: decl @lune.@base.@convLua.convFilter.getCanonicalName
...
// 175: decl @lune.@base.@convLua.convFilter.getFullName
...
// 179: decl @lune.@base.@convLua.convFilter.close
func (self *convLua_convFilter) Close(_env *LnsEnv) {
}

// 181: decl @lune.@base.@convLua.convFilter.flush
func (self *convLua_convFilter) Flush(_env *LnsEnv) {
}

// 184: decl @lune.@base.@convLua.convFilter.write
...
// 244: decl @lune.@base.@convLua.convFilter.popIndent
...
// 252: decl @lune.@base.@convLua.convFilter.writeln
...
// 313: decl @lune.@base.@convLua.convFilter.outputMeta
...
// 959: decl @lune.@base.@convLua.convFilter.processRoot
...
// 1066: decl @lune.@base.@convLua.convFilter.processSubfile
func (self *convLua_convFilter) ProcessSubfile(_env *LnsEnv, node *Nodes_SubfileNode,_opt LnsAny) {
}

// 1071: decl @lune.@base.@convLua.convFilter.processEnv
...
// 1078: decl @lune.@base.@convLua.convFilter.processBlockSub
...
// 1148: decl @lune.@base.@convLua.convFilter.processLoadRuntime
...
// 1158: decl @lune.@base.@convLua.convFilter.processScope
...
// 1168: decl @lune.@base.@convLua.convFilter.processStmtExp
...
// 1174: decl @lune.@base.@convLua.convFilter.processDeclEnum
...
// 1256: decl @lune.@base.@convLua.convFilter.getMapInfo
...
// 1346: decl @lune.@base.@convLua.convFilter.processDeclAlge
...
// 1414: decl @lune.@base.@convLua.convFilter.processNewAlgeVal
...
// 1435: decl @lune.@base.@convLua.convFilter.getDestrClass
...
// 1448: decl @lune.@base.@convLua.convFilter.outputAlter2MapFunc
...
// 1473: decl @lune.@base.@convLua.convFilter.processProtoClass
...
// 1479: decl @lune.@base.@convLua.convFilter.processDeclClass
...
// 1812: decl @lune.@base.@convLua.convFilter.processDeclMember
func (self *convLua_convFilter) ProcessDeclMember(_env *LnsEnv, node *Nodes_DeclMemberNode,_opt LnsAny) {
}

// 1819: decl @lune.@base.@convLua.convFilter.processExpMacroExp
...
// 1831: decl @lune.@base.@convLua.convFilter.outputDeclMacro
...
// 1875: decl @lune.@base.@convLua.convFilter.processExpMacroStatList
...
// 1883: decl @lune.@base.@convLua.convFilter.processDeclMacro
...
// 1902: decl @lune.@base.@convLua.convFilter.processExpMacroStat
...
// 1920: decl @lune.@base.@convLua.convFilter.processExpNew
...
// 1931: decl @lune.@base.@convLua.convFilter.process__func__symbol
...
// 1945: decl @lune.@base.@convLua.convFilter.processDeclConstr
...
// 2000: decl @lune.@base.@convLua.convFilter.processDeclDestr
func (self *convLua_convFilter) ProcessDeclDestr(_env *LnsEnv, node *Nodes_DeclDestrNode,_opt LnsAny) {
    ...
    Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_TypeInfo).FP.GetTxt(_env, nil, nil, nil)})/* 2004:9 */)}))
...
// 2020: decl @lune.@base.@convLua.convFilter.processExpCallSuperCtor
...
// 2039: decl @lune.@base.@convLua.convFilter.processExpCallSuper
...
// 2055: decl @lune.@base.@convLua.convFilter.processDeclMethod
...
// 2088: decl @lune.@base.@convLua.convFilter.processUnwrapSet
...
// 2121: decl @lune.@base.@convLua.convFilter.processExpListSub
...
// 2148: decl @lune.@base.@convLua.convFilter.processExpMRet
...
// 2154: decl @lune.@base.@convLua.convFilter.processIfUnwrap
...
// 2197: decl @lune.@base.@convLua.convFilter.processWhen
...
// 2219: decl @lune.@base.@convLua.convFilter.processDeclVar
...
// 2331: decl @lune.@base.@convLua.convFilter.processDeclArg
...
// 2339: decl @lune.@base.@convLua.convFilter.processDeclArgDDD
func (self *convLua_convFilter) ProcessDeclArgDDD(_env *LnsEnv, node *Nodes_DeclArgDDDNode,_opt LnsAny) {
    self.FP.Write(_env, "...")
}

// 2345: decl @lune.@base.@convLua.convFilter.processDeclFunc
...
// 2386: decl @lune.@base.@convLua.convFilter.processRefType
...
// 2406: decl @lune.@base.@convLua.convFilter.processIf
...
// 2428: decl @lune.@base.@convLua.convFilter.processSwitch
...
// 2471: decl @lune.@base.@convLua.convFilter.processMatch
...
// 2510: decl @lune.@base.@convLua.convFilter.processWhile
...
// 2521: decl @lune.@base.@convLua.convFilter.processRepeat
...
// 2530: decl @lune.@base.@convLua.convFilter.processFor
...
// 2546: decl @lune.@base.@convLua.convFilter.processApply
...
// 2564: decl @lune.@base.@convLua.convFilter.processForeach
...
// 2614: decl @lune.@base.@convLua.convFilter.processForsort
...
// 2667: decl @lune.@base.@convLua.convFilter.processExpUnwrap
...
// 2685: decl @lune.@base.@convLua.convFilter.processExpCall
...
// 2922: decl @lune.@base.@convLua.convFilter.processExpList
...
// 2931: decl @lune.@base.@convLua.convFilter.processExpOp1
...
// 3039: decl @lune.@base.@convLua.convFilter.processExpParen
...
// 3048: decl @lune.@base.@convLua.convFilter.processExpSetVal
...
// 3055: decl @lune.@base.@convLua.convFilter.processExpSetItem
...
// 3073: decl @lune.@base.@convLua.convFilter.processExpOp2
...
// 3143: decl @lune.@base.@convLua.convFilter.processExpRef
...
// 3179: decl @lune.@base.@convLua.convFilter.processExpRefItem
...
// 3221: decl @lune.@base.@convLua.convFilter.processRefField
...
// 3253: decl @lune.@base.@convLua.convFilter.processExpOmitEnum
...
// 3264: decl @lune.@base.@convLua.convFilter.processGetField
...
// 3304: decl @lune.@base.@convLua.convFilter.processReturn
...
// 3314: decl @lune.@base.@convLua.convFilter.processLuneKind
...
// 3327: decl @lune.@base.@convLua.convFilter.processTestCase
...
// 3349: decl @lune.@base.@convLua.convFilter.processTestBlock
...
// 3360: decl @lune.@base.@convLua.convFilter.processProvide
func (self *convLua_convFilter) ProcessProvide(_env *LnsEnv, node *Nodes_ProvideNode,_opt LnsAny) {
}

// 3365: decl @lune.@base.@convLua.convFilter.processAlias
...
// 3375: decl @lune.@base.@convLua.convFilter.processBoxing
...
// 3385: decl @lune.@base.@convLua.convFilter.processUnboxing
func (self *convLua_convFilter) ProcessUnboxing(_env *LnsEnv, node *Nodes_UnboxingNode,_opt LnsAny) {
    convLua_filter_1127_(_env, node.FP.Get_src(_env), self, &node.Nodes_Node)
    self.FP.Write(_env, "[1]")
}

// 3393: decl @lune.@base.@convLua.convFilter.processLiteralList
...
// 3405: decl @lune.@base.@convLua.convFilter.processLiteralSet
...
// 3423: decl @lune.@base.@convLua.convFilter.processLiteralMap
...
// 3441: decl @lune.@base.@convLua.convFilter.processLiteralArray
...
// 3454: decl @lune.@base.@convLua.convFilter.processLiteralChar
...
// 3460: decl @lune.@base.@convLua.convFilter.processLiteralInt
...
// 3468: decl @lune.@base.@convLua.convFilter.processLiteralReal
func (self *convLua_convFilter) ProcessLiteralReal(_env *LnsEnv, node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.Write(_env, node.FP.Get_token(_env).Txt)
}

// 3475: decl @lune.@base.@convLua.convFilter.processLiteralString
...
// 3541: decl @lune.@base.@convLua.convFilter.processLuneControl
...
// 3578: decl @lune.@base.@convLua.MacroEvalImp.evalFromMacroCode
func (self *ConvLua_MacroEvalImp) evalFromMacroCode(_env *LnsEnv, code string) *Lns_luaValue {
    ...
    Log_log(_env, Log_Level__Trace, __func__, 3580, Log_CreateMessage(func(_env *LnsEnv) string {
...
// 3589: decl @lune.@base.@convLua.MacroEvalImp.evalFromCode
...
// 3610: decl @lune.@base.@convLua.MacroEvalImp.eval
