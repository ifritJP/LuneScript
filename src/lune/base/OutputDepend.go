...
func OutputDepend_Ast2Depend_1096_(ast *TransUnit_ASTInfo) string {
...
func (self *OutputDepend_Front) LoadModule(mod string)(LnsAny, *FrontInterface_ModuleMeta) {
...
func (self *OutputDepend_Front) LoadMeta(importModuleInfo *FrontInterface_ImportModuleInfo,mod string) LnsAny {
    ...
    if loaded != nil{
        loaded_3754 := loaded.(*Lns_luaValue)
        var meta LnsAny
        
        {
            _meta := OutputDepend_convExp502(Lns_2DDD(Lns_getVM().RunLoadedfunc(loaded_3754,Lns_2DDD([]LnsAny{}))[0]))
            if _meta == nil{
                return nil
            } else {
                meta = _meta
