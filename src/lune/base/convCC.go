...
func convCC_ValKind_get__allList_1161_() *LnsList{
...
func convCC_ValKind__from_1154_(arg1 LnsInt) LnsAny{
...
func convCC_ProcessMode_get__allList_1210_() *LnsList{
...
func convCC_ProcessMode__from_1203_(arg1 LnsInt) LnsAny{
...
func convCC_Out2HMode_get__allList_1509_() *LnsList{
...
func convCC_Out2HMode__from_1502_(arg1 LnsInt) LnsAny{
...
func convCC_FuncWrap_get__allList_1999_() *LnsList{
...
func convCC_FuncWrap__from_1992_(arg1 LnsInt) LnsAny{
...
type convCC_processExp_1872_ func ()
type convCC_process2stemCallback_2047_ func ()
type convCC_outputMacroStmtBlock_2209_ func ()
type convCC_processRValue_2289_ func ()
type convCC_ProcessToValForm_2532_ func (arg1 LnsInt)
// for 5410: ExpCast
func conv2Form24613( src func ()) LnsForm {
...
// for 360
func convCC_convExp851(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 365
func convCC_convExp918(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 10416
func convCC_convExp44546(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1640
func convCC_convExp7126(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 1978
func convCC_convExp9750(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 4760
func convCC_convExp22072(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6222
func convCC_convExp27585(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6400
func convCC_convExp28525(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 6401
func convCC_convExp28539(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 10777
func convCC_convExp46422(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
// for 10778
func convCC_convExp46436(arg1 []LnsAny) string {
    return Lns_getFromMulti( arg1, 0 ).(string)
}
...
// 208: decl @lune.@base.@convCC.getValKind
func convCC_getValKind_1164_(valType *Ast_TypeInfo) LnsInt {
    var expType *Ast_TypeInfo
    expType = valType.FP.Get_srcTypeInfo()
    if expType.FP.Get_nilable(){
        return convCC_ValKind__Stem
    }
    if _switch463 := expType.FP.Get_kind(); _switch463 == Ast_TypeInfoKind__Alternate || _switch463 == Ast_TypeInfoKind__Stem || _switch463 == Ast_TypeInfoKind__DDD || _switch463 == Ast_TypeInfoKind__Alge {
        return convCC_ValKind__Stem
    }
    if _switch519 := expType; _switch519 == Ast_builtinTypeInt || _switch519 == Ast_builtinTypeChar {
        return convCC_ValKind__Prim
    } else if _switch519 == Ast_builtinTypeReal {
        return convCC_ValKind__Prim
    } else if _switch519 == Ast_builtinTypeBool {
        return convCC_ValKind__Prim
    } else {
        {
            ...
            if _enumType != nil {
                ...
                return convCC_getValKind_1164_(enumType.FP.Get_valTypeInfo())
            }
        }
...
// 245: decl @lune.@base.@convCC.isStemType
func convCC_isStemType_1168_(valType *Ast_TypeInfo) bool {
    return convCC_getValKind_1164_(valType) == convCC_ValKind__Stem
}

// 250: decl @lune.@base.@convCC.getRetKind
func convCC_getRetKind_1175_(retTypeList *LnsList) LnsInt {
    if _switch579 := retTypeList.Len(); _switch579 == 0 {
        return convCC_ValKind__Other
    } else if _switch579 == 1 {
        return convCC_getValKind_1164_(retTypeList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo())
    }
    return convCC_ValKind__Stem
}


// 273: decl @lune.@base.@convCC.getCType
func convCC_getCType_1185_(valType *Ast_TypeInfo) string {
    var expType *Ast_TypeInfo
    expType = valType.FP.Get_srcTypeInfo()
    if _switch694 := expType; _switch694 == Ast_builtinTypeInt || _switch694 == Ast_builtinTypeChar {
        return convCC_cTypeInt
    } else if _switch694 == Ast_builtinTypeReal {
        return convCC_cTypeReal
    } else if _switch694 == Ast_builtinTypeBool {
    ...
    } else {
        {
            ...
            if _enumType != nil {
                enumType := _enumType.(*Ast_EnumTypeInfo)
                return convCC_getCType_1185_(enumType.FP.Get_valTypeInfo())
            }
        }
        if convCC_getValKind_1164_(valType) == convCC_ValKind__Any{
...
// 302: decl @lune.@base.@convCC.getCRetType
func convCC_getCRetType_1192_(retTypeList *LnsList) string {
    if _switch733 := retTypeList.Len(); _switch733 == 0 {
        return "void"
    } else if _switch733 == 1 {
        return convCC_getCType_1185_(retTypeList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo())
    }
    return convCC_cTypeStem
}

// 314: decl @lune.@base.@convCC.getBlockName
func convCC_getBlockName_1195_(scope *Ast_Scope) string {
    return Lns_getVM().String_format("pBlock_%X", []LnsAny{scope.FP.Get_scopeId()})
}

// 344: decl @lune.@base.@convCC.isClassMember
func convCC_isClassMember_1213_(symbol Ast_LowSymbol) bool {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Lns_NilAccFin(Lns_NilAccPush(symbol.Get_scope().FP.Get_ownerTypeInfo()) && 
        Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.Get_kind()})) == Ast_TypeInfoKind__Class) &&
        Lns_setStackVal( symbol.Get_kind() == Ast_SymbolKind__Mbr) &&
        Lns_setStackVal( symbol.Get_staticFlag()) ).(bool)){
        return true
    }
    return false
}

// 357: decl @lune.@base.@convCC.str2cstr
func convCC_str2cstr_1216_(txt string) string {
    var work string
    work = txt
    if Lns_isCondTrue( Lns_car(Lns_getVM().String_find(work, "^```", nil, nil))){
        work = convCC_convExp851(Lns_2DDD(Lns_getVM().String_gsub((Lns_getVM().String_format("%q", []LnsAny{Lns_getVM().String_sub(work,4, -4)})),"\\\n", "\\n")))
    ...
    work = convCC_convExp918(Lns_2DDD(Lns_getVM().String_gsub(work,"\\9", "\\t")))
    
    return work
}

// 714: decl @lune.@base.@convCC.getOrgTypeInfo
func convCC_getOrgTypeInfo_1424_(typeInfo *Ast_TypeInfo) *Ast_TypeInfo {
    {
...
// 721: decl @lune.@base.@convCC.getAccessPrimValFromSymbolDirect
func convCC_getAccessPrimValFromSymbolDirect_1427_(symName string,valKind LnsInt,symType *Ast_TypeInfo) string {
    var txt string
    txt = symName
    if _switch3223 := valKind; _switch3223 == convCC_ValKind__Var {
        txt = txt + "->stem"
        
    } else if _switch3223 == convCC_ValKind__Stem {
    } else if _switch3223 == convCC_ValKind__Prim {
        return txt
    }
    if _switch3278 := convCC_getOrgTypeInfo_1424_(symType); _switch3278 == Ast_builtinTypeInt || _switch3278 == Ast_builtinTypeChar {
        txt = txt + ".val.intVal"
        
    } else if _switch3278 == Ast_builtinTypeReal {
        txt = txt + ".val.realVal"
        
    } else if _switch3278 == Ast_builtinTypeBool {
        txt = txt + ".val.boolVal"
...
// 751: decl @lune.@base.@convCC.createSymbolParam
func convCC_createSymbolParam_1430_(name string,valKind LnsInt,cTypeTxt string) *convCC_SymbolParam {
    if _switch3387 := valKind; _switch3387 == convCC_ValKind__Stem {
        return NewconvCC_SymbolParam(convCC_ValKind__Stem, 0, convCC_cTypeStem)
    } else if _switch3387 == convCC_ValKind__Any {
        return NewconvCC_SymbolParam(convCC_ValKind__Any, 0, convCC_cTypeAnyP)
    } else if _switch3387 == convCC_ValKind__Prim {
        return NewconvCC_SymbolParam(convCC_ValKind__Prim, 0, cTypeTxt)
    } else if _switch3387 == convCC_ValKind__Other {
...
// 999: decl @lune.@base.@convCC.getLiteralStrAny
func convCC_getLiteralStrAny_1491_(txt string) string {
    return Lns_getVM().String_format("lns_litStr2any( _pEnv, %s )", []LnsAny{txt})
}

// 1003: decl @lune.@base.@convCC.getLiteralStrStem
func convCC_getLiteralStrStem_1494_(txt string) string {
    return Lns_getVM().String_format("LNS_STEM_ANY( %s )", []LnsAny{convCC_getLiteralStrAny_1491_(txt)})
}

// 1015: decl @lune.@base.@convCC.getOut2HeaderPrefix
func convCC_getOut2HeaderPrefix_1512_(mode LnsInt) string {
    if _switch4486 := mode; _switch4486 == convCC_Out2HMode__HeaderPub {
        return "extern "
    } else if _switch4486 == convCC_Out2HMode__SourcePri {
        return "static "
    }
    return ""
}

// 1209: decl @lune.@base.@convCC.processAddModuleGlobal
func convCC_processAddModuleGlobal_1633_(stream Util_SourceStream,valName string) {
    stream.Writeln(Lns_getVM().String_format("lns_mtd_List_insert( _pEnv, *lns_module_globalStemList, %s );", []LnsAny{valName}))
}

// 1217: decl @lune.@base.@convCC.filter
func convCC_filter_1636_(node *Nodes_Node,filter *convCC_convFilter,parent *Nodes_Node) {
    node.FP.ProcessFilter(&filter.Nodes_Filter, ConvCC_Opt2Stem(NewConvCC_Opt(parent)))
}



// 1285: decl @lune.@base.@convCC.getSymbolIndex
func convCC_getSymbolIndex_1651_(symbol *Ast_SymbolInfo) LnsInt {
    var param LnsAny
...
// 1489: decl @lune.@base.@convCC.registerBuiltin
func convCC_registerBuiltin_1752_() {
    ...
    for _, _symbol := range( builtin.FP.Get_allSymbol().Items ) {
        ...
        if _switch6356 := symbol.FP.Get_kind(); _switch6356 == Ast_SymbolKind__Mtd || _switch6356 == Ast_SymbolKind__Fun {
            var retTypeList *LnsList
            retTypeList = symbol.FP.Get_typeInfo().FP.Get_retTypeInfoList()
            param = convCC_createSymbolParam_1430_(symbol.FP.Get_name(), convCC_getRetKind_1175_(retTypeList), convCC_getCRetType_1192_(retTypeList))
            
        } else if _switch6356 == Ast_SymbolKind__Mbr || _switch6356 == Ast_SymbolKind__Var {
            param = convCC_createSymbolParam_1430_(symbol.FP.Get_name(), convCC_getValKind_1164_(symbol.FP.Get_typeInfo()), convCC_getCType_1185_(symbol.FP.Get_typeInfo()))
            
        } else {
            Util_err(Lns_getVM().String_format("illeal symbol -- %s %d", []LnsAny{symbol.FP.Get_name(), 1505}))
        }
...
// 1859: decl @lune.@base.@convCC.getAccessPrimValFromStem
func convCC_getAccessPrimValFromStem_1842_(dddFlag bool,typeInfo *Ast_TypeInfo,index LnsInt) string {
    var txt string
    txt = ""
    if dddFlag{
    ...
    if _switch9397 := expType; _switch9397 == Ast_builtinTypeInt || _switch9397 == Ast_builtinTypeChar {
        txt = txt + ".val.intVal"
        
    } else if _switch9397 == Ast_builtinTypeReal {
        txt = txt + ".val.realVal"
        
    } else if _switch9397 == Ast_builtinTypeBool {
        txt = txt + ".val.boolVal"
        
    } else {
        if convCC_getValKind_1164_(expType) == convCC_ValKind__Any{
            txt = txt + ".val.pAny"
...
// 1893: decl @lune.@base.@convCC.getAccessValFromStem
func convCC_getAccessValFromStem_1845_(typeInfo *Ast_TypeInfo) string {
    var txt string
    var expType *Ast_TypeInfo
    {
        _enumType := Ast_EnumTypeInfoDownCastF(typeInfo.FP.Get_srcTypeInfo().FP)
    ...
    if _switch9512 := expType; _switch9512 == Ast_builtinTypeInt || _switch9512 == Ast_builtinTypeChar {
        txt = ".val.intVal"
        
    } else if _switch9512 == Ast_builtinTypeReal {
        txt = ".val.realVal"
        
    } else if _switch9512 == Ast_builtinTypeBool {
        txt = ".val.boolVal"
        
    } else {
        if convCC_getValKind_1164_(typeInfo) == convCC_ValKind__Any{
...
// 2087: decl @lune.@base.@convCC.getLiteral2Stem
func convCC_getLiteral2Stem_1875_(valTxt string,typeInfo *Ast_TypeInfo) string {
    if _switch10257 := typeInfo.FP.Get_srcTypeInfo(); _switch10257 == Ast_builtinTypeInt || _switch10257 == Ast_builtinTypeChar {
        return Lns_getVM().String_format("LNS_STEM_INT( %s )", []LnsAny{valTxt})
    } else if _switch10257 == Ast_builtinTypeReal {
        return Lns_getVM().String_format("LNS_STEM_REAL( %s )", []LnsAny{valTxt})
    } else if _switch10257 == Ast_builtinTypeBool {
...
// 2105: decl @lune.@base.@convCC.getStemTypeId
func convCC_getStemTypeId_1878_(typeInfo *Ast_TypeInfo) string {
    if typeInfo.FP.Get_nilable(){
        return "lns_stem_type_none"
    }
    if _switch10317 := typeInfo; _switch10317 == Ast_builtinTypeInt || _switch10317 == Ast_builtinTypeChar {
        return "lns_stem_type_int"
    } else if _switch10317 == Ast_builtinTypeInt || _switch10317 == Ast_builtinTypeReal {
        return "lns_stem_type_real"
    } else if _switch10317 == Ast_builtinTypeBool {
...
// 2125: decl @lune.@base.@convCC.getPrepareClosure
func convCC_getPrepareClosure_1885_(scopeMgr *convCC_ScopeMgr,funcName string,argNum LnsInt,hasDDD bool,symList *LnsList) string {
    var txt string
...
// 2142: decl @lune.@base.@convCC.getFunc2any
func convCC_getFunc2any_1888_(moduleCtrl *convCC_ModuleCtrl,scopeMgr *convCC_ScopeMgr,funcType *Ast_TypeInfo) string {
    var argList *LnsList
    argList = funcType.FP.Get_argTypeInfoList()
    var hasDDD bool
    hasDDD = Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( argList.Len() > 0) &&
        Lns_setStackVal( argList.GetAt(argList.Len()).(Ast_TypeInfoDownCast).ToAst_TypeInfo().FP.Get_kind() == Ast_TypeInfoKind__DDD) ||
        Lns_setStackVal( false) ).(bool)
    return convCC_getPrepareClosure_1885_(scopeMgr, moduleCtrl.FP.GetFuncName(funcType), funcType.FP.Get_argTypeInfoList().Len(), hasDDD, (Lns_unwrap( funcType.FP.Get_scope()).(*Ast_Scope)).FP.Get_closureSymList())
}




// 2624: decl @lune.@base.@convCC.processAlgeNewProto
func convCC_processAlgeNewProto_1916_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,typeInfo *Ast_TypeInfo,valInfo *Ast_AlgeValInfo) {
    ...
    for _index, _valTypeInfo := range( valInfo.FP.Get_typeList().Items ) {
        ...
        stream.Write(Lns_getVM().String_format(", %s _val%d", []LnsAny{convCC_getCType_1185_(valTypeInfo), index}))
    }
    stream.Write(")")
}
...
// 2638: decl @lune.@base.@convCC.processAlgePrototype
func convCC_processAlgePrototype_1919_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,node *Nodes_DeclAlgeNode) {
    var algeType *Ast_AlgeTypeInfo
    algeType = node.FP.Get_algeType()
    var valList *LnsList
    valList = NewLnsList([]LnsAny{})
    {
        __collection12377 := algeType.FP.Get_valInfoMap()
        __sorted12377 := __collection12377.CreateKeyListStr()
        __sorted12377.Sort( LnsItemKindStr, nil )
        for _, ___key12377 := range( __sorted12377.Items ) {
            valInfo := __collection12377.Items[ ___key12377 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
    ...
    process = func() {
        ...
        for _, _valInfo := range( valList.Items ) {
            ...
            if valInfo.FP.Get_typeList().Len() > 0{
                ...
                for _index, _typeInfo := range( valInfo.FP.Get_typeList().Items ) {
                    ...
                    stream.Writeln(Lns_getVM().String_format("%s _val%d;", []LnsAny{convCC_getCType_1185_(typeInfo), index}))
                }
                stream.PopIndent()
        ...
        for _, _valInfo := range( valList.Items ) {
            valInfo := _valInfo.(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            if valInfo.FP.Get_typeList().Len() > 0{
                convCC_processAlgeNewProto_1916_(stream, moduleCtrl, node.FP.Get_expType(), valInfo)
                stream.Writeln(";")
            }
        }
    }
    {
        ...
        processwork = func(out2HMode LnsInt) {
            if _switch12643 := out2HMode; _switch12643 == convCC_Out2HMode__HeaderPub || _switch12643 == convCC_Out2HMode__SourcePri {
                process()
            }
        }
...
// 2708: decl @lune.@base.@convCC.processAlgeWideScope
func convCC_processAlgeWideScope_1935_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,node *Nodes_DeclAlgeNode) {
    var algeType *Ast_AlgeTypeInfo
    algeType = node.FP.Get_algeType()
    var valList *LnsList
    valList = NewLnsList([]LnsAny{})
    {
        __collection12766 := algeType.FP.Get_valInfoMap()
        __sorted12766 := __collection12766.CreateKeyListStr()
        __sorted12766.Sort( LnsItemKindStr, nil )
        for _, ___key12766 := range( __sorted12766.Items ) {
            valInfo := __collection12766.Items[ ___key12766 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            valList.Insert(Ast_AlgeValInfo2Stem(valInfo))
        }
    }
    ...
    process = func(out2HMode LnsInt) {
        var prefix string
        prefix = convCC_getOut2HeaderPrefix_1512_(out2HMode)
        for _, _valInfo := range( valList.Items ) {
            valInfo := _valInfo.(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            if valInfo.FP.Get_typeList().Len() == 0{
                var varName string
    ...
    }
    {
        var processwork func(out2HMode LnsInt)
        processwork = func(out2HMode LnsInt) {
            if _switch12907 := out2HMode; _switch12907 == convCC_Out2HMode__HeaderPub || _switch12907 == convCC_Out2HMode__SourcePri || _switch12907 == convCC_Out2HMode__SourcePub {
                process(out2HMode)
            }
        }
        if Ast_isPubToExternal(node.FP.Get_expType().FP.Get_accessMode()){
...
// 2747: decl @lune.@base.@convCC.processAlgeForm
func convCC_processAlgeForm_1951_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,node *Nodes_DeclAlgeNode) {
    var algeType *Ast_AlgeTypeInfo
    algeType = node.FP.Get_algeType()
    var valList *LnsList
    valList = NewLnsList([]LnsAny{})
    {
        __collection13034 := algeType.FP.Get_valInfoMap()
        __sorted13034 := __collection13034.CreateKeyListStr()
        __sorted13034.Sort( LnsItemKindStr, nil )
        for _, ___key13034 := range( __sorted13034.Items ) {
            valInfo := __collection13034.Items[ ___key13034 ].(Ast_AlgeValInfoDownCast).ToAst_AlgeValInfo()
            valList.Insert(Ast_AlgeValInfo2Stem(valInfo))
        }
    }
    var algeName string
    ...
    convCC_processAddModuleGlobal_1633_(stream, Lns_getVM().String_format("LNS_STEM_ANY( %s )", []LnsAny{type2NameMapName}))
    var fullName string
    ...
    for _, _valInfo := range( valList.Items ) {
        ...
        if valInfo.FP.Get_typeList().Len() > 0{
            ...
            for _, _valType := range( valInfo.FP.Get_typeList().Items ) {
                ...
                if convCC_isStemType_1168_(valType){
                    hasAnyFlag = true
            ...
            convCC_processAlgeNewProto_1916_(stream, moduleCtrl, &algeType.Ast_TypeInfo, valInfo)
            stream.Writeln("{")
            stream.PushIndent(nil)
...
// 3027: decl @lune.@base.@convCC.getMethodTypeTxt
func convCC_getMethodTypeTxt_1978_(retTypeList *LnsList) string {
    if retTypeList.Len() == 1{
        ...
        if _switch13947 := retType; _switch13947 == Ast_builtinTypeInt || _switch13947 == Ast_builtinTypeChar {
            return "lns_method_int_t"
        } else if _switch13947 == Ast_builtinTypeReal {
            return "lns_method_real_t"
        } else if _switch13947 == Ast_builtinTypeBool {
            return "lns_method_bool_t"
        }
        if convCC_getValKind_1164_(retType) == convCC_ValKind__Any{
...
// 3051: decl @lune.@base.@convCC.processNewConstrProto
func convCC_processNewConstrProto_1981_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,node *Nodes_DeclClassNode,out2HMode LnsInt,outputBuiltinFlag bool) {
    stream.Write(convCC_getOut2HeaderPrefix_1512_(out2HMode))
    ...
    if Lns_op_not(outputBuiltinFlag){
        ...
        for _index, _argType := range( initFuncType.FP.Get_argTypeInfoList().Items ) {
            ...
            stream.Write(Lns_getVM().String_format(", %s arg%d", []LnsAny{convCC_getCType_1185_(argType), index}))
        }
    }
    stream.Write(")")
}

// 3073: decl @lune.@base.@convCC.processDeclAlgeSub
func convCC_processDeclAlgeSub_1984_(stream Util_SourceStream,node *Nodes_DeclArgNode) {
    stream.Write(convCC_getCType_1185_(node.FP.Get_expType()))
...
// 3102: decl @lune.@base.@convCC.processMethodDeclTxt
func convCC_processMethodDeclTxt_2006_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,wrapKind LnsInt,methodTypeInfo *Ast_TypeInfo,argList LnsAny) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( methodTypeInfo.FP.Get_rawTxt() != "__init") &&
        Lns_setStackVal( wrapKind == convCC_FuncWrap__Normal) ).(bool)){
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( Lns_op_not(methodTypeInfo.FP.Get_staticFlag())) ||
            Lns_setStackVal( Lns_op_not(Ast_isPubToExternal(methodTypeInfo.FP.Get_accessMode()))) ||
            Lns_setStackVal( Lns_op_not(Ast_isPubToExternal(methodTypeInfo.FP.Get_parentInfo().FP.Get_accessMode()))) ).(bool){
            stream.Write("static ")
        }
    }
    var name string
    var objDecl string
    var retType string
    if _switch14385 := wrapKind; _switch14385 == convCC_FuncWrap__Normal {
        name = moduleCtrl.FP.GetMethodCName(methodTypeInfo)
        
        objDecl = Lns_getVM().String_format(", %s pObj", []LnsAny{convCC_cTypeAnyP})
        
        retType = convCC_getCRetType_1192_(methodTypeInfo.FP.Get_retTypeInfoList())
        
    } else if _switch14385 == convCC_FuncWrap__CallWrap {
    ...
    } else if _switch14385 == convCC_FuncWrap__NilWrap {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( methodTypeInfo.FP.Get_rawTxt() == "___init") &&
        Lns_setStackVal( methodTypeInfo.FP.Get_staticFlag()) ).(bool)){
        stream.Write(Lns_getVM().String_format(", %s %s", []LnsAny{convCC_cTypeBlockP, convCC_getBlockName_1195_(Lns_unwrap( methodTypeInfo.FP.GetModule().FP.Get_scope()).(*Ast_Scope))}))
    } else { 
        if argList != nil{
            argList_6914 := argList.(*LnsList)
            for _, _argNode := range( argList_6914.Items ) {
                ...
                stream.Write(", ")
                {
                    ...
                    if _declArgNode != nil {
                        ...
                        convCC_processDeclAlgeSub_1984_(stream, declArgNode)
                    } else {
            ...
            for _index, _arg := range( methodTypeInfo.FP.Get_argTypeInfoList().Items ) {
                ...
                stream.Write(Lns_getVM().String_format(", %s arg%d", []LnsAny{convCC_getCType_1185_(arg), index}))
            }
        }
    }
    stream.Write(")")
...
// 3180: decl @lune.@base.@convCC.processDeclMethodTable
func convCC_processDeclMethodTable_2011_(stream Util_SourceStream,classTypeInfo *Ast_TypeInfo) {
    var outputField func(name string,retTypeList *LnsList)
    outputField = func(name string,retTypeList *LnsList) {
        var methodType string
        methodType = convCC_getMethodTypeTxt_1978_(retTypeList)
    ...
    for _, _name := range( nameSet.FP.Get_list().Items ) {
        name := _name.(string)
        {
            _symbolInfo := Lns_NilAccFin(Lns_NilAccPush(classTypeInfo.FP.Get_scope()) && 
            Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_Scope).FP.GetSymbolInfoField(name, true, Lns_unwrap( classTypeInfo.FP.Get_scope()).(*Ast_Scope), Ast_ScopeAccess__Normal)})/* 3209:28 */)
            if _symbolInfo != nil {
...
// 3219: decl @lune.@base.@convCC.processDeclMemberTable
func convCC_processDeclMemberTable_2025_(normal bool,stream Util_SourceStream,classTypeInfo *Ast_TypeInfo) {
    ...
    outputVal = func(scope *Ast_Scope) {
        ...
        {
            __collection14735 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted14735 := __collection14735.CreateKeyListStr()
            __sorted14735.Sort( LnsItemKindStr, nil )
            for _, ___key14735 := range( __sorted14735.Items ) {
                symbolInfo := __collection14735.Items[ ___key14735 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch14733 := symbolInfo.FP.Get_kind(); _switch14733 == Ast_SymbolKind__Mbr {
                    if Lns_op_not(symbolInfo.FP.Get_staticFlag()){
                        stream.Writeln(Lns_getVM().String_format("%s %s;", []LnsAny{convCC_getCType_1185_(symbolInfo.FP.Get_typeInfo()), symbolInfo.FP.Get_name()}))
                    }
                }
            }
        }
...
// 3246: decl @lune.@base.@convCC.hasGC
func convCC_hasGC_2031_(classTypeInfo *Ast_TypeInfo) bool {
    {
...
// 3265: decl @lune.@base.@convCC.processPrototypeMethod
func convCC_processPrototypeMethod_2038_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,declArgNodeList LnsAny,funcTypeInfo *Ast_TypeInfo) {
    ...
    processHeader = func(out2HMode LnsInt) {
        ...
        if Lns_op_not(funcTypeInfo.FP.Get_staticFlag()){
            convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__CallWrap, funcTypeInfo, declArgNodeList)
            stream.Writeln(";")
            convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__NilWrap, funcTypeInfo, declArgNodeList)
            stream.Writeln(";")
        } else { 
            convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, funcTypeInfo, declArgNodeList)
            stream.Writeln(";")
        }
    }
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( funcTypeInfo.FP.Get_parentInfo().FP.Get_kind() == Ast_TypeInfoKind__Class) &&
        Lns_setStackVal( funcTypeInfo.FP.Get_rawTxt() == "__init") ).(bool)){
        convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, funcTypeInfo, declArgNodeList)
        stream.Writeln(";")
    } else { 
        {
            var processwork func(out2HMode LnsInt)
            processwork = func(out2HMode LnsInt) {
                if _switch15242 := out2HMode; _switch15242 == convCC_Out2HMode__SourcePri {
                    if funcTypeInfo.FP.Get_parentInfo().FP.Get_kind() == Ast_TypeInfoKind__Class{
                        processHeader(out2HMode)
                        convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, funcTypeInfo, declArgNodeList)
                        stream.Writeln(";")
                    }
                } else if _switch15242 == convCC_Out2HMode__SourcePub {
                    if funcTypeInfo.FP.Get_parentInfo().FP.Get_kind() == Ast_TypeInfoKind__Class{
                        if Lns_op_not(funcTypeInfo.FP.Get_staticFlag()){
                            convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, funcTypeInfo, declArgNodeList)
                            stream.Writeln(";")
                ...
                } else if _switch15242 == convCC_Out2HMode__HeaderPub {
                    processHeader(out2HMode)
                }
            }
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( Ast_isPubToExternal(funcTypeInfo.FP.Get_parentInfo().FP.Get_accessMode())) &&
                Lns_setStackVal( Ast_isPubToExternal(funcTypeInfo.FP.Get_accessMode())) ).(bool)){
                stream.SwitchToHeader()
                processwork(convCC_Out2HMode__HeaderPub)
                stream.ReturnToSource()
                processwork(convCC_Out2HMode__SourcePub)
...
// 3339: decl @lune.@base.@convCC.process2stem
func convCC_process2stem_2050_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,scopeMgr *convCC_ScopeMgr,valKind LnsInt,typeInfo *Ast_TypeInfo,parent *Nodes_Node,callback convCC_process2stemCallback_2047_) {
    if _switch15565 := valKind; _switch15565 == convCC_ValKind__Stem {
        callback()
    } else {
        var expType *Ast_TypeInfo
        expType = typeInfo.FP.Get_srcTypeInfo()
        ...
        if _switch15562 := expType; _switch15562 == Ast_builtinTypeInt || _switch15562 == Ast_builtinTypeChar {
            stream.Write("LNS_STEM_INT( ")
            callback()
            stream.Write(")")
        } else if _switch15562 == Ast_builtinTypeReal {
            stream.Write("LNS_STEM_REAL( ")
            callback()
            stream.Write(")")
        } else if _switch15562 == Ast_builtinTypeBool {
            stream.Write("LNS_STEM_BOOL( ")
            callback()
            stream.Write(")")
        } else {
            if _switch15560 := expType.FP.Get_kind(); _switch15560 == Ast_TypeInfoKind__DDD {
                stream.Write("_pDDD")
            } else if _switch15560 == Ast_TypeInfoKind__Func {
                if Lns_isCondTrue( expType.FP.Get_scope()){
                    stream.Write("LNS_STEM_ANY(")
                    stream.Write(convCC_getFunc2any_1888_(moduleCtrl, scopeMgr, expType))
                    stream.Write(")")
                } else { 
                ...
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( valKind == convCC_ValKind__Var) &&
                    Lns_setStackVal( convCC_getValKind_1164_(expType) == convCC_ValKind__Stem) ).(bool)){
                    callback()
                } else { 
                    stream.Write("LNS_STEM_ANY( ")
                    callback()
...
// 3409: decl @lune.@base.@convCC.processDeclCallMethodWrapper
func convCC_processDeclCallMethodWrapper_2053_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,scopeMgr *convCC_ScopeMgr,parent *Nodes_Node,funcTypeInfo *Ast_TypeInfo,callFlag bool) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( funcTypeInfo.FP.Get_rawTxt() != "__init") &&
        Lns_setStackVal( Lns_op_not(funcTypeInfo.FP.Get_staticFlag())) ).(bool)){
        convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( callFlag) &&
            Lns_setStackVal( convCC_FuncWrap__CallWrap) ||
            Lns_setStackVal( convCC_FuncWrap__NilWrap) ).(LnsInt), funcTypeInfo, nil)
        stream.Writeln("{")
        if Lns_op_not(callFlag){
            var retVal string
            if _switch15674 := funcTypeInfo.FP.Get_retTypeInfoList().Len(); _switch15674 == 0 {
                retVal = ""
                
            } else if _switch15674 == 1 {
        ...
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( Lns_op_not(callFlag)) &&
            Lns_setStackVal( retList.Len() > 0) ).(bool)){
            convCC_process2stem_2050_(stream, moduleCtrl, scopeMgr, convCC_getRetKind_1175_(retList), retList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), parent, convCC_process2stemCallback_2047_(process))
        } else { 
            process()
        }
        stream.Writeln(";")
...
// 3477: decl @lune.@base.@convCC.getAccessMember
func convCC_getAccessMember_2059_(className string,obj string,member string) string {
    return Lns_getVM().String_format("lns_obj_%s( %s )->%s", []LnsAny{className, obj, member})
}

// 3481: decl @lune.@base.@convCC.getAccessMethod
func convCC_getAccessMethod_2062_(className string,obj string,method string) string {
    return Lns_getVM().String_format("lns_mtd_%s( %s )->%s", []LnsAny{className, obj, method})
}

// 3489: decl @lune.@base.@convCC.processAdvertise
func convCC_processAdvertise_2065_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,scopeMgr *convCC_ScopeMgr,processMode LnsInt,node *Nodes_DeclClassNode) {
        ...
        for _, _name := range( Ast_getAllMethodName(member.FP.Get_expType(), Ast_MethodKind__Object).FP.Get_list().Items ) {
            ...
            if Lns_op_not(declMethodNameSet.Has(name)){
                ...
                if methodType.FP.Get_accessMode() != Ast_AccessMode__Pri{
                    if _switch16359 := processMode; _switch16359 == convCC_ProcessMode__Prototype {
                        convCC_processPrototypeMethod_2038_(stream, moduleCtrl, nil, methodType)
                    } else if _switch16359 == convCC_ProcessMode__DefClass {
                        convCC_processDeclCallMethodWrapper_2053_(stream, moduleCtrl, scopeMgr, &node.Nodes_Node, methodType, true)
                        convCC_processDeclCallMethodWrapper_2053_(stream, moduleCtrl, scopeMgr, &node.Nodes_Node, methodType, false)
                        convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, methodType, nil)
                        stream.Writeln("{")
                        var className string
                        ...
                        stream.PushIndent(nil)
                        stream.Writeln(Lns_getVM().String_format("%s pVal = %s;", []LnsAny{convCC_cTypeAnyP, convCC_getAccessMember_2059_(className, "pObj", member.FP.Get_name().Txt)}))
                        if methodType.FP.Get_retTypeInfoList().Len() != 0{
                            stream.Write("return ")
                        }
                        stream.Write(Lns_getVM().String_format("%s( _pEnv, pVal", []LnsAny{convCC_getAccessMethod_2062_(memberClassName, "pVal", name)}))
...
// 3584: decl @lune.@base.@convCC.processDeclClassPrototype
func convCC_processDeclClassPrototype_2078_(normal bool,stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,node *Nodes_DeclClassNode) {
    var className string
    className = moduleCtrl.FP.GetClassCName(node.FP.Get_expType())
    ...
    if convCC_hasGC_2031_(node.FP.Get_expType()){
    ...
    for _, _member := range( node.FP.Get_memberList().Items ) {
        ...
        if member.FP.Get_getterMode() != Ast_AccessMode__None{
            ...
            convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, getterType, nil)
            stream.Writeln(";")
        }
        if member.FP.Get_setterMode() != Ast_AccessMode__None{
            ...
            convCC_processMethodDeclTxt_2006_(stream, moduleCtrl, convCC_FuncWrap__Normal, setterType, nil)
            stream.Writeln(";")
        }
    }
}

// 3622: decl @lune.@base.@convCC.processDefaultCtor
func convCC_processDefaultCtor_2081_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,scopeMgr *convCC_ScopeMgr,node *Nodes_DeclClassNode) {
    var className string
    className = moduleCtrl.FP.GetClassCName(node.FP.Get_expType())
    if Lns_op_not(node.FP.HasUserInit()){
        ...
        for _index, _argType := range( ctorType.FP.Get_argTypeInfoList().Items ) {
            index := _index + 1
            argType := _argType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            stream.Write(Lns_getVM().String_format(", %s _arg%d", []LnsAny{convCC_getCType_1185_(argType), index}))
        }
        stream.Writeln(") {")
        stream.PushIndent(nil)
...
// 3715: decl @lune.@base.@convCC.processIFObjDecl
func convCC_processIFObjDecl_2084_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,classType *Ast_TypeInfo) {
    if classType.FP.HasBase(){
        convCC_processIFObjDecl_2084_(stream, moduleCtrl, classType.FP.Get_baseTypeInfo())
    }
...
// 3727: decl @lune.@base.@convCC.processIFObjInit
func convCC_processIFObjInit_2087_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,classType *Ast_TypeInfo,impClassType *Ast_TypeInfo) {
    if classType.FP.HasBase(){
        convCC_processIFObjInit_2087_(stream, moduleCtrl, classType.FP.Get_baseTypeInfo(), impClassType)
    }
    var className string
...
// 4480: decl @lune.@base.@convCC.processInitMethodTable
func convCC_processInitMethodTable_2157_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,classTypeInfo *Ast_TypeInfo) {
    var outputField func(name string,retTypeList *LnsList)
    outputField = func(name string,retTypeList *LnsList) {
        var methodType string
        methodType = convCC_getMethodTypeTxt_1978_(retTypeList)
...
// 4520: decl @lune.@base.@convCC.processInitIFMethodTable
func convCC_processInitIFMethodTable_2171_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,ifType *Ast_TypeInfo,classTypeInfo *Ast_TypeInfo) {
    var outputField func(name string,retTypeList *LnsList)
    outputField = func(name string,retTypeList *LnsList) {
        var methodType string
        methodType = convCC_getMethodTypeTxt_1978_(retTypeList)
    ...
    outputVal = func(scope *Ast_Scope,impScope *Ast_Scope) {
        ...
        {
            __collection21342 := scope.FP.Get_symbol2SymbolInfoMap()
            __sorted21342 := __collection21342.CreateKeyListStr()
            __sorted21342.Sort( LnsItemKindStr, nil )
            for _, ___key21342 := range( __sorted21342.Items ) {
                symbolInfo := __collection21342.Items[ ___key21342 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                if _switch21340 := symbolInfo.FP.Get_kind(); _switch21340 == Ast_SymbolKind__Mtd {
...
// 4552: decl @lune.@base.@convCC.processIFMethodDataInit
func convCC_processIFMethodDataInit_2184_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,classType *Ast_TypeInfo,orgClassType *Ast_TypeInfo) {
    if classType.FP.HasBase(){
        convCC_processIFMethodDataInit_2184_(stream, moduleCtrl, classType.FP.Get_baseTypeInfo(), orgClassType)
    }
    if Lns_op_not(orgClassType.FP.Get_abstractFlag()){
        ...
        for _, _ifType := range( classType.FP.Get_interfaceList().Items ) {
            ...
            stream.PushIndent(nil)
            convCC_processInitIFMethodTable_2171_(stream, moduleCtrl, ifType, orgClassType)
            stream.PopIndent()
            stream.Writeln("};")
        }
    }
...
// 4576: decl @lune.@base.@convCC.processClassMeta
func convCC_processClassMeta_2187_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,classTypeInfo *Ast_TypeInfo) {
    var className string
    className = moduleCtrl.FP.GetClassCName(classTypeInfo)
...
// 4590: decl @lune.@base.@convCC.processClassDataInit
func convCC_processClassDataInit_2194_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,scopeMgr *convCC_ScopeMgr,classTypeInfo *Ast_TypeInfo,fieldList *LnsList) {
    var className string
    className = moduleCtrl.FP.GetClassCName(classTypeInfo)
    if Lns_op_not(Ast_isPubToExternal(classTypeInfo.FP.Get_accessMode())){
        stream.Write("static ")
    }
    convCC_processClassMeta_2187_(stream, moduleCtrl, classTypeInfo)
    if Lns_op_not(classTypeInfo.FP.Get_abstractFlag()){
        ...
        if convCC_hasGC_2031_(classTypeInfo){
            stream.Writeln(Lns_getVM().String_format("mtd_%s__gc,", []LnsAny{className}))
        } else { 
            stream.Writeln("NULL,")
        }
        convCC_processInitMethodTable_2157_(stream, moduleCtrl, classTypeInfo)
        stream.PopIndent()
        stream.Writeln("};")
    }
    var process func(out2HMode LnsInt,symbolInfo *Ast_SymbolInfo)
    process = func(out2HMode LnsInt,symbolInfo *Ast_SymbolInfo) {
        if _switch21813 := out2HMode; _switch21813 == convCC_Out2HMode__HeaderPub || _switch21813 == convCC_Out2HMode__SourcePub || _switch21813 == convCC_Out2HMode__SourcePri {
            stream.Writeln(Lns_getVM().String_format("%s%s %s;", []LnsAny{convCC_getOut2HeaderPrefix_1512_(out2HMode), Lns_car(scopeMgr.FP.GetCTypeForSym(symbolInfo.FP)).(string), moduleCtrl.FP.GetClassMemberName(symbolInfo.FP)}))
        }
    }
    for _, _symbolInfo := range( (Lns_unwrap( classTypeInfo.FP.Get_scope()).(*Ast_Scope)).FP.Get_symbol2SymbolInfoMap().Items ) {
        symbolInfo := _symbolInfo.(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
        if convCC_isClassMember_1213_(symbolInfo.FP){
            {
                var processwork func(out2HMode LnsInt)
                processwork = func(out2HMode LnsInt) {
                ...
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( Ast_isPubToExternal(classTypeInfo.FP.Get_accessMode())) &&
                    Lns_setStackVal( Ast_isPubToExternal(symbolInfo.FP.Get_accessMode())) ).(bool)){
                    stream.SwitchToHeader()
                    processwork(convCC_Out2HMode__HeaderPub)
                    stream.ReturnToSource()
                    processwork(convCC_Out2HMode__SourcePub)
...
// 5613: decl @lune.@base.@convCC.processToIF
func convCC_processToIF_2301_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,expType *Ast_TypeInfo,process convCC_processExp_1872_) {
...
// 5629: decl @lune.@base.@convCC.processGetMRet
func convCC_processGetMRet_2304_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,typeInfo *Ast_TypeInfo,index LnsInt) {
    var process func()
    process = func() {
        stream.Write(Lns_getVM().String_format("lns_getMRet( _pEnv, %d )", []LnsAny{index}))
        stream.Write(convCC_getAccessValFromStem_1845_(typeInfo))
    }
    if typeInfo.FP.Get_kind() == Ast_TypeInfoKind__IF{
        convCC_processToIF_2301_(stream, moduleCtrl, typeInfo, convCC_processExp_1872_(process))
    } else { 
        process()
    }
}
...
// 5762: decl @lune.@base.@convCC.processAlterAccessVal
func convCC_processAlterAccessVal_2347_(stream Util_SourceStream,srcTypeList *LnsList,dstTypeList *LnsList) {
    if dstTypeList.Len() == 1{
        if srcTypeList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo().FP.Get_kind() == Ast_TypeInfoKind__Alternate{
            stream.Write(convCC_getAccessValFromStem_1845_(dstTypeList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()))
        }
    }
}

// 5783: decl @lune.@base.@convCC.processAlterToActualType
func convCC_processAlterToActualType_2350_(stream Util_SourceStream,moduleCtrl *convCC_ModuleCtrl,fromType *Ast_TypeInfo,toType *Ast_TypeInfo,process convCC_processExp_1872_) {
    if fromType.FP.Get_kind() == Ast_TypeInfoKind__Alternate{
        if toType.FP.Get_kind() == Ast_TypeInfoKind__IF{
            convCC_processToIF_2301_(stream, moduleCtrl, toType, process)
        } else { 
            process()
        }
    } else { 
...
// 7404: decl @lune.@base.@convCC.getCollectionKind
func convCC_getCollectionKind_2610_(typeInfo *Ast_TypeInfo) LnsAny {
    if _switch33172 := typeInfo.FP.Get_kind(); _switch33172 == Ast_TypeInfoKind__List {
        return convCC_CollectionKind__List_Obj
    } else if _switch33172 == Ast_TypeInfoKind__Array {
        return convCC_CollectionKind__Array_Obj
    } else if _switch33172 == Ast_TypeInfoKind__Set {
        return convCC_CollectionKind__Set_Obj
    } else if _switch33172 == Ast_TypeInfoKind__Map {
        return convCC_CollectionKind__Map_Obj
    } else if _switch33172 == Ast_TypeInfoKind__Ext {
        ...
        if _switch33170 := extedType.FP.Get_kind(); _switch33170 == Ast_TypeInfoKind__List {
            return &convCC_CollectionKind__ExtList{extedType}
        } else if _switch33170 == Ast_TypeInfoKind__Array {
            return &convCC_CollectionKind__ExtArray{extedType}
        } else if _switch33170 == Ast_TypeInfoKind__Set {
            return &convCC_CollectionKind__ExtSet{extedType}
        } else if _switch33170 == Ast_TypeInfoKind__Map {
...
// 7764: decl @lune.@base.@convCC.needMRetWrap
func convCC_needMRetWrap_2645_(funcArgTypeList *LnsList,argNodeList *Nodes_ExpListNode) bool {
    ...
    for _index, _funcArgType := range( funcArgTypeList.Items ) {
        ...
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( argType.FP.Get_kind() == Ast_TypeInfoKind__DDD) ||
            Lns_setStackVal( mRetExp.FP.Get_index() == index) ).(bool){
            return true
        }
...
// 8110: decl @lune.@base.@convCC.getMRetFuncName
func convCC_getMRetFuncName_2686_(node *Nodes_Node) string {
    return Lns_getVM().String_format("l_call_mret_%d", []LnsAny{node.FP.Get_id()})
}

// 8581: decl @lune.@base.@convCC.getFormNilWrapper
func convCC_getFormNilWrapper_2707_(node *Nodes_Node) string {
    return Lns_getVM().String_format("l_nil_form_%d", []LnsAny{node.FP.Get_id()})
}

// 8737: decl @lune.@base.@convCC.convFilter.processExpCall.process.fieldCall.processEnumAlge
func convFilter_processExpCall_process_fieldCall__processEnumAlge_2728_() {
}
...
// 9524: decl @lune.@base.@convCC.convFilter.processAndOr.isAndOr
func convFilter_processAndOr__isAndOr_2777_(exp *Nodes_Node) bool {
    {
        _parentNode := Nodes_ExpOp2NodeDownCastF(exp.FP)
        if _parentNode != nil {
            parentNode := _parentNode.(*Nodes_ExpOp2Node)
            if _switch40759 := parentNode.FP.Get_op().Txt; _switch40759 == "and" || _switch40759 == "or" {
                return true
            }
        }
    }
...
// 10360: decl @lune.@base.@convCC.getLiteralListFuncName
func convCC_getLiteralListFuncName_2845_(node *Nodes_LiteralListNode) string {
    return Lns_getVM().String_format("lns_list_%X", []LnsAny{node.FP.Get_id()})
}

// 10464: decl @lune.@base.@convCC.getLiteralSetFuncName
func convCC_getLiteralSetFuncName_2873_(node *Nodes_LiteralSetNode) string {
    return Lns_getVM().String_format("lns_set_%X", []LnsAny{node.FP.Get_id()})
}

// 10493: decl @lune.@base.@convCC.getLiteralMapFuncName
func convCC_getLiteralMapFuncName_2883_(node *Nodes_LiteralMapNode) string {
    return Lns_getVM().String_format("lns_map_%X", []LnsAny{node.FP.Get_id()})
}

// 10572: decl @lune.@base.@convCC.getLiteralArrayFuncName
func convCC_getLiteralArrayFuncName_2907_(node *Nodes_LiteralArrayNode) string {
    return Lns_getVM().String_format("lns_array_%X", []LnsAny{node.FP.Get_id()})
}

// 10765: decl @lune.@base.@convCC.createFilter
...
// 10773: decl @lune.@base.@convCC.outputBootcode
func ConvCC_outputBootcode(stream Lns_oStream,launchModuleName string) {
    ...
    launchModulePath = convCC_convExp46422(Lns_2DDD(Lns_getVM().String_gsub(launchModuleName,"%.", "/")))
    var moduleName string
    moduleName = convCC_convExp46436(Lns_2DDD(Lns_getVM().String_gsub(launchModuleName,"%.", "_")))
...
func NewconvCC_ModuleInfo(arg1 string, arg2 string) *convCC_ModuleInfo {
    obj := &convCC_ModuleInfo{}
    obj.FP = obj
    obj.InitconvCC_ModuleInfo(arg1, arg2)
    return obj
}
func (self *convCC_ModuleInfo) InitconvCC_ModuleInfo(arg1 string, arg2 string) {
...
// 131: decl @lune.@base.@convCC.DepthInfo.pushDepth
func (self *convCC_DepthInfo) PushDepth() {
    self.blockDepth = self.blockDepth + 1
    
}

// 134: decl @lune.@base.@convCC.DepthInfo.popDepth
...
// 158: decl @lune.@base.@convCC.DepthStack.currentR
...
// 164: decl @lune.@base.@convCC.DepthStack.pushDepth
func (self *convCC_DepthStack) PushDepth() {
    self.FP.Current().FP.PushDepth()
}

// 167: decl @lune.@base.@convCC.DepthStack.popDepth
func (self *convCC_DepthStack) PopDepth() {
    self.FP.Current().FP.PopDepth()
}

// 170: decl @lune.@base.@convCC.DepthStack.get_blockDepth
...
// 381: decl @lune.@base.@convCC.ModuleCtrl.setupBuiltinSym
func convCC_ModuleCtrl_setupBuiltinSym_1243_()(*LnsMap, *LnsMap) {
...
func (self *convCC_ModuleCtrl) InitconvCC_ModuleCtrl(typeNameCtrl *Ast_TypeNameCtrl,moduleInfoManager Ast_ModuleInfoManager) {
    self.builtinSym2CFuncMap, self.builtinType2CFuncMap = convCC_ModuleCtrl_setupBuiltinSym_1243_()
...
// 460: decl @lune.@base.@convCC.ModuleCtrl.getFilePath
...
// 468: decl @lune.@base.@convCC.ModuleCtrl.getCanonicalName
...
// 475: decl @lune.@base.@convCC.ModuleCtrl.getFullName
...
// 499: decl @lune.@base.@convCC.ModuleCtrl.getAlgeValCName
...
// 502: decl @lune.@base.@convCC.ModuleCtrl.getAlgeValStrCName
...
// 505: decl @lune.@base.@convCC.ModuleCtrl.getNewAlgeCName
...
// 509: decl @lune.@base.@convCC.ModuleCtrl.getAlgeInitCName
...
// 514: decl @lune.@base.@convCC.ModuleCtrl.getEnumTypeName
...
// 524: decl @lune.@base.@convCC.ModuleCtrl.getEnumValCName
...
// 528: decl @lune.@base.@convCC.ModuleCtrl.getEnumVal2NameMapName
...
// 541: decl @lune.@base.@convCC.ModuleCtrl.getCtorName
...
// 545: decl @lune.@base.@convCC.ModuleCtrl.getClassMetaName
...
// 553: decl @lune.@base.@convCC.ModuleCtrl.getMethodCName
...
// 559: decl @lune.@base.@convCC.ModuleCtrl.getFuncName
func (self *convCC_ModuleCtrl) GetFuncName(typeInfo *Ast_TypeInfo) string {
    ...
    if _switch2607 := typeInfo.FP.Get_accessMode(); _switch2607 == Ast_AccessMode__Pub || _switch2607 == Ast_AccessMode__Global {
        {
        ...
        if _switch2596 := typeInfo.FP.Get_parentInfo().FP.Get_kind(); _switch2596 == Ast_TypeInfoKind__Class || _switch2596 == Ast_TypeInfoKind__Enum {
...
// 584: decl @lune.@base.@convCC.ModuleCtrl.getNilMethodCName
...
// 610: decl @lune.@base.@convCC.ModuleCtrl.getClassMemberName
...
// 619: decl @lune.@base.@convCC.ModuleCtrl.getSymbolName
func (self *convCC_ModuleCtrl) GetSymbolName(symbolInfo Ast_LowSymbol) string {
    ...
    if symbolInfo.Get_kind() == Ast_SymbolKind__Mbr{
        if convCC_isClassMember_1213_(symbolInfo){
    ...
    if _switch2936 := symbolInfo.Get_kind(); _switch2936 == Ast_SymbolKind__Var {
...
// 647: decl @lune.@base.@convCC.ModuleCtrl.getFormName
...
// 650: decl @lune.@base.@convCC.ModuleCtrl.getCallFormName
...
// 654: decl @lune.@base.@convCC.ModuleCtrl.getFuncCastWrapName
...
// 658: decl @lune.@base.@convCC.ModuleCtrl.getEnumFuncName
...
// 692: decl @lune.@base.@convCC.WorkSymbol.get_mutable
func (self *convCC_WorkSymbol) Get_mutable() bool {
    return false
}

// 696: decl @lune.@base.@convCC.WorkSymbol.get_symbolId
func (self *convCC_WorkSymbol) Get_symbolId() LnsInt {
    return convCC_invalidSymbolId
}

// 699: decl @lune.@base.@convCC.WorkSymbol.get_hasAccessFromClosure
...
// 788: decl @lune.@base.@convCC.ScopeMgr.setSymbolParam
func convCC_ScopeMgr_setSymbolParam_1450_(scopeInfo *convCC_ScopeInfo,symbol *Ast_SymbolInfo) *convCC_SymbolParam {
    var param *convCC_SymbolParam
    if _switch3674 := convCC_getValKind_1164_(symbol.FP.Get_typeInfo()); _switch3674 == convCC_ValKind__Stem {
        param = NewconvCC_SymbolParam(convCC_ValKind__Stem, scopeInfo.StemNum, convCC_cTypeStem)
        
        scopeInfo.StemNum = scopeInfo.StemNum + 1
        
    } else if _switch3674 == convCC_ValKind__Any {
        if symbol.FP.Get_name() == "self"{
            param = NewconvCC_SymbolParam(convCC_ValKind__Any, 0, convCC_cTypeAnyP)
            
        } else { 
            if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( symbol.FP.Get_kind() == Ast_SymbolKind__Var) ||
                Lns_setStackVal( symbol.FP.Get_kind() == Ast_SymbolKind__Mbr) ).(bool){
    ...
    } else if _switch3674 == convCC_ValKind__Prim {
        param = NewconvCC_SymbolParam(convCC_ValKind__Prim, 0, convCC_getCType_1185_(symbol.FP.Get_typeInfo()))
...
// 828: decl @lune.@base.@convCC.ScopeMgr.setupScopeParamSub
func (self *convCC_ScopeMgr) setupScopeParamSub(scope *Ast_Scope) *convCC_ScopeInfo {
    ...
    if Lns_isCondTrue( Lns_NilAccFin(Lns_NilAccPush(scope.FP.Get_ownerTypeInfo()) && 
    Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_TypeInfo).FP.IsModule()})/* 839:13 */)){
        scopeInfo.AnyNum = 2
        
    }
    {
        __collection4037 := scope.FP.Get_symbol2SymbolInfoMap()
        __sorted4037 := __collection4037.CreateKeyListStr()
        __sorted4037.Sort( LnsItemKindStr, nil )
        for _, ___key4037 := range( __sorted4037.Items ) {
            symbol := __collection4037.Items[ ___key4037 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
            if Lns_op_not(symbol.FP.Get_convModuleParam()){
                var param *convCC_SymbolParam
                if symbol.FP.Get_name() != "__func__"{
                    if _switch3986 := symbol.FP.Get_kind(); _switch3986 == Ast_SymbolKind__Var || _switch3986 == Ast_SymbolKind__Arg {
                        if symbol.FP.Get_hasAccessFromClosure(){
                            ...
                            param = convCC_ScopeMgr_setSymbolParam_1450_(scopeInfo, symbol)
                            
                        }
                    } else if _switch3986 == Ast_SymbolKind__Fun {
                        if symbol.FP.Get_hasAccessFromClosure(){
                            param = NewconvCC_SymbolParam(convCC_ValKind__Var, scopeInfo.VarNum, convCC_cTypeVarP)
                    ...
                    } else if _switch3986 == Ast_SymbolKind__Mtd {
                        var retTypeList *LnsList
                        retTypeList = symbol.FP.Get_typeInfo().FP.Get_retTypeInfoList()
                        param = convCC_createSymbolParam_1430_(symbol.FP.Get_name(), convCC_getRetKind_1175_(retTypeList), convCC_getCRetType_1192_(retTypeList))
                        
                    } else if _switch3986 == Ast_SymbolKind__Mbr {
                        if convCC_isClassMember_1213_(symbol.FP){
...
// 909: decl @lune.@base.@convCC.ScopeMgr.setup
func (self *convCC_ScopeMgr) Setup(scope *Ast_Scope,declMemberList *LnsList) {
    ...
    for _, _declMember := range( declMemberList.Items ) {
        ...
        if convCC_isClassMember_1213_(symbol.FP){
            symbol.FP.Set_convModuleParam(convCC_ScopeMgr_setSymbolParam_1450_(scopeInfo, symbol).FP)
        }
    }
}

// 922: decl @lune.@base.@convCC.ScopeMgr.create
func convCC_ScopeMgr_create_1463_(moduleCtrl *convCC_ModuleCtrl,initBlockScope *Ast_Scope) *convCC_ScopeMgr {
...
// 930: decl @lune.@base.@convCC.ScopeMgr.setupScopeParam
...
// 936: decl @lune.@base.@convCC.ScopeMgr.getSymbolParam
func (self *convCC_ScopeMgr) GetSymbolParam(symbol Ast_LowSymbol) *convCC_SymbolParam {
    ...
    Util_err(Lns_getVM().String_format("illegal symbol -- %s %s %s %d", []LnsAny{symbol.Get_name(), Ast_SymbolKind_getTxt( symbol.Get_kind()), self.moduleCtrl.FP.GetCanonicalName(symbol.Get_scope().FP.GetNamespaceTypeInfo()), 952}))
// insert a dummy
    return nil
}

// 955: decl @lune.@base.@convCC.ScopeMgr.getSymbolValKind
...
// 961: decl @lune.@base.@convCC.ScopeMgr.getCTypeForSym
...
// 983: decl @lune.@base.@convCC.ScopeMgr.getAccessPrimValFromSymbol
func (self *convCC_ScopeMgr) GetAccessPrimValFromSymbol(symbolInfo Ast_LowSymbol) string {
    return convCC_getAccessPrimValFromSymbolDirect_1427_(self.moduleCtrl.FP.GetSymbolName(symbolInfo), self.FP.GetSymbolValKind(symbolInfo), symbolInfo.Get_typeInfo())
}

// 990: decl @lune.@base.@convCC.ScopeMgr.getAccessPrimValFromSymbolOnly
func (self *convCC_ScopeMgr) GetAccessPrimValFromSymbolOnly(symbolInfo Ast_LowSymbol) string {
    return convCC_getAccessPrimValFromSymbolDirect_1427_("", self.FP.GetSymbolValKind(symbolInfo), symbolInfo.Get_typeInfo())
}

// 2154: decl @lune.@base.@convCC.ScopeMgr.symbol2Any
func (self *convCC_ScopeMgr) Symbol2Any(symbol Ast_LowSymbol) string {
    if symbol.Get_kind() == Ast_SymbolKind__Fun{
        return convCC_getFunc2any_1888_(self.moduleCtrl, self, symbol.Get_typeInfo())
    }
    var name string
    name = self.moduleCtrl.FP.GetSymbolName(symbol)
    if _switch10564 := self.FP.GetSymbolValKind(symbol); _switch10564 == convCC_ValKind__Var {
        return name
    } else {
...
type convCC_convFilterMtd interface {
    ...
    OutputDeclMacro(arg1 string, arg2 *LnsList, arg3 convCC_outputMacroStmtBlock_2209_)
    PopIndent()
    popRoutine()
    popStream()
    ...
    processEquals(arg1 bool, arg2 *Ast_TypeInfo, arg3 *Ast_TypeInfo, arg4 convCC_ProcessToValForm_2532_, arg5 convCC_ProcessToValForm_2532_)
    ...
    processSetValSingleDirect(arg1 *Nodes_Node, arg2 LnsAny, arg3 Ast_LowSymbol, arg4 bool, arg5 LnsInt, arg6 *Ast_TypeInfo, arg7 LnsInt, arg8 bool, arg9 convCC_processRValue_2289_)
...
// 1108: decl @lune.@base.@convCC.convFilter.createRefNodeFromSym
func (self *convCC_convFilter) createRefNodeFromSym(symbol *Ast_SymbolInfo) *Nodes_ExpRefNode {
    return Nodes_ExpRefNode_create(self.dummyNodeManager, Lns_unwrap( symbol.FP.Get_pos()).(*Parser_Position), false, NewLnsList([]LnsAny{Ast_TypeInfo2Stem(symbol.FP.Get_typeInfo())}), symbol)
}
...
func (self *convCC_convFilter) InitconvCC_convFilter(enableTest bool,outputBuiltin bool,streamName string,stream Lns_oStream,headerStream Lns_oStream,ast *TransUnit_ASTInfo) {
    ...
    self.scopeMgr = convCC_ScopeMgr_create_1463_(self.moduleCtrl, Lns_unwrap( ast.FP.Get_moduleTypeInfo().FP.Get_scope()).(*Ast_Scope))
    
    self.stream = NewUtil_SimpleSourceOStream(stream, headerStream, convCC_stepIndent)
    
}

// 1172: decl @lune.@base.@convCC.convFilter.pushStream
...
// 1182: decl @lune.@base.@convCC.convFilter.popStream
...
// 1193: decl @lune.@base.@convCC.convFilter.getFullName
...
// 1250: decl @lune.@base.@convCC.convFilter.processNone
func (self *convCC_convFilter) ProcessNone(node *Nodes_NoneNode,_opt LnsAny) {
}

// 1256: decl @lune.@base.@convCC.convFilter.processImport
func (self *convCC_convFilter) ProcessImport(node *Nodes_ImportNode,_opt LnsAny) {
    if self.processMode == convCC_ProcessMode__Include{
        var process func(out2HMode LnsInt)
        process = func(out2HMode LnsInt) {
            if _switch5254 := out2HMode; _switch5254 == convCC_Out2HMode__HeaderPub {
                if node.FP.Get_symbolInfo().FP.Get_scope() != node.FP.Get_moduleTypeInfo().FP.Get_scope(){
                    return 
                }
            } else if _switch5254 == convCC_Out2HMode__SourcePub || _switch5254 == convCC_Out2HMode__SourcePri {
            } else {
                return 
            }
...
// 1292: decl @lune.@base.@convCC.convFilter.processInitModule
func (self *convCC_convFilter) processInitModule(node *Nodes_RootNode) {
    ...
    var process func(out2HMode LnsInt)
    process = func(out2HMode LnsInt) {
        self.FP.Write(Lns_getVM().String_format("%s%s lns_init_%s( %s _pEnv )", []LnsAny{convCC_getOut2HeaderPrefix_1512_(out2HMode), convCC_cTypeModP, moduleFullName, convCC_cTypeEnvP}))
        if _switch5556 := out2HMode; _switch5556 == convCC_Out2HMode__HeaderPub {
            self.FP.Writeln(";")
        } else if _switch5556 == convCC_Out2HMode__SourcePub {
            self.FP.Writeln("{")
        }
    }
    {
    ...
    moduleBlockName = convCC_getBlockName_1195_(self.ast.FP.Get_moduleScope())
    ...
    if Lns_op_not(self.canConv){
        ...
        for _, _declAlgeNode := range( node.FP.Get_nodeManager().FP.GetDeclAlgeNodeList().Items ) {
            ...
            convCC_filter_1636_(&declAlgeNode.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _child := range( node.FP.Get_children().Items ) {
            child := _child.(Nodes_NodeDownCast).ToNodes_Node()
            if _switch6005 := child.FP.Get_kind(); _switch6005 == Nodes_NodeKind_get_DeclAlge() || _switch6005 == Nodes_NodeKind_get_DeclFunc() || _switch6005 == Nodes_NodeKind_get_DeclMacro() || _switch6005 == Nodes_NodeKind_get_TestCase() {
            } else {
                convCC_filter_1636_(child, self, &node.Nodes_Node)
                self.FP.Writeln("")
            }
        }
    }
...
// 1512: decl @lune.@base.@convCC.convFilter.processBuiltin
func (self *convCC_convFilter) processBuiltin() *Nodes_NodeManager {
    ...
    var dummyPos *Parser_Position
    dummyPos = NewParser_Position(0, 0, "builtin")
    ...
    createNodeFromSymbol = func(classInfo LnsAny,symbol *Ast_SymbolInfo) LnsAny {
        ...
        token = NewParser_Token(Parser_TokenKind__Symb, symbol.FP.Get_name(), dummyPos, false, nil)
        if _switch6785 := symbol.FP.Get_kind(); _switch6785 == Ast_SymbolKind__Mtd || _switch6785 == Ast_SymbolKind__Fun {
            var argList *LnsList
            argList = NewLnsList([]LnsAny{})
            for _index, _argType := range( symbol.FP.Get_typeInfo().FP.Get_argTypeInfoList().Items ) {
                index := _index + 1
                argType := _argType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                var argToken *Parser_Token
                argToken = NewParser_Token(Parser_TokenKind__Symb, Lns_getVM().String_format("arg%d", []LnsAny{index}), dummyPos, false, nil)
            ...
            if classInfo != nil{
                classInfo_6253 := classInfo.(*Ast_TypeInfo)
                var declFuncInfo *Nodes_DeclFuncInfo
                declFuncInfo = NewNodes_DeclFuncInfo(Nodes_FuncKind__Mtd, classInfo_6253, nil, token, symbol, argList, false, Ast_AccessMode__Pub, nil, symbol.FP.Get_typeInfo().FP.Get_retTypeInfoList(), false, false)
        ...
        } else if _switch6785 == Ast_SymbolKind__Var {
            var varToken *Parser_Token
            varToken = NewParser_Token(Parser_TokenKind__Symb, symbol.FP.Get_name(), dummyPos, false, nil)
        ...
        } else if _switch6785 == Ast_SymbolKind__Mbr {
            return nil
        } else {
    ...
    for _, _classInfo := range( builtin.FP.Get_allClass().Items ) {
        ...
        if _switch6964 := classInfo.FP.Get_kind(); _switch6964 == Ast_TypeInfoKind__List || _switch6964 == Ast_TypeInfoKind__Array || _switch6964 == Ast_TypeInfoKind__Set || _switch6964 == Ast_TypeInfoKind__Map || _switch6964 == Ast_TypeInfoKind__Box {
        } else {
            if classInfo != Ast_builtinTypeString{
                ...
                Nodes_DeclClassNode_create(nodeManager, dummyPos, false, NewLnsList([]LnsAny{Ast_TypeInfo2Stem(classInfo)}), Ast_AccessMode__Pub, NewParser_Token(Parser_TokenKind__Symb, classInfo.FP.Get_rawTxt(), dummyPos, false, nil), false, classInfo.FP.Get_rawTxt(), nil, false, fieldList, NewLnsList([]LnsAny{}), fieldList, NewLnsList([]LnsAny{}), classScope, NewNodes_ClassInitBlockInfo(nil), NewLnsList([]LnsAny{}), NewLnsList([]LnsAny{}), NewLnsList([]LnsAny{}), NewLnsSet([]LnsAny{}))
                {
                    __collection6959 := classScope.FP.Get_symbol2SymbolInfoMap()
                    __sorted6959 := __collection6959.CreateKeyListStr()
                    __sorted6959.Sort( LnsItemKindStr, nil )
                    for _, ___key6959 := range( __sorted6959.Items ) {
                        field := __collection6959.Items[ ___key6959 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
                        {
    ...
    for _, _symbol := range( builtin.FP.Get_allSymbol().Items ) {
        ...
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( symbol.FP.Get_kind() == Ast_SymbolKind__Var) ||
            Lns_setStackVal( symbol.FP.Get_kind() == Ast_SymbolKind__Fun) ||
            Lns_setStackVal( symbol.FP.Get_namespaceTypeInfo().FP.Get_kind() == Ast_TypeInfoKind__Root) ).(bool){
...
// 1609: decl @lune.@base.@convCC.convFilter.processRoot
func (self *convCC_convFilter) ProcessRoot(node *Nodes_RootNode,_opt LnsAny) {
    var nodeManager *Nodes_NodeManager
    convCC_registerBuiltin_1752_()
    if self.outputBuiltinFlag{
    ...
    for _pragma := range( node.FP.Get_luneHelperInfo().PragmaSet.Items ) {
        pragma := _pragma
        switch _exp7096 := pragma.(type) {
        case *LuneControl_Pragma__limit_conv_code:
        codeSet := _exp7096.Val1
    ...
    ifdefname = convCC_convExp7126(Lns_2DDD(Lns_getVM().String_gsub(self.moduleCtrl.FP.GetFilePath(self.moduleTypeInfo),"/", "_")))
    ...
    for _, _importNode := range( nodeManager.FP.GetImportNodeList().Items ) {
        ...
        convCC_filter_1636_(&importNode.Nodes_Node, self, &node.Nodes_Node)
    }
    self.processMode = convCC_ProcessMode__Prototype
    ...
    for _, _workNode := range( nodeManager.FP.GetTestCaseNodeList().Items ) {
        ...
        convCC_filter_1636_(&workNode.Nodes_Node, self, &node.Nodes_Node)
    }
    var moduleName string
    ...
    process = func(onlyPub bool) {
        ...
        for _, _decl := range( nodeManager.FP.GetDeclVarNodeList().Items ) {
            ...
            convCC_filter_1636_(&decl.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _workNode := range( nodeManager.FP.GetDeclAlgeNodeList().Items ) {
            workNode := _workNode.(Nodes_DeclAlgeNodeDownCast).ToNodes_DeclAlgeNode()
            if Lns_op_not(workNode.FP.Get_macroArgFlag()){
    ...
    if self.canConv{
        ...
        for _, _litStr := range( nodeManager.FP.GetLiteralStringNodeList().Items ) {
            ...
            if Lns_op_not(litStr.FP.Get_macroArgFlag()){
                convCC_filter_1636_(&litStr.Nodes_Node, self, &node.Nodes_Node)
            }
        }
        ...
        procssLiteralCtor = func(literalNodeList *LnsList) {
            for _, _literalNode := range( literalNodeList.Items ) {
                ...
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( Lns_op_not(self.processedNodeSet.Has(Nodes_Node2Stem(literalNode)))) &&
                    Lns_setStackVal( Lns_op_not(literalNode.FP.Get_macroArgFlag())) ).(bool)){
                    self.accessSymbolSet = NewUtil_OrderedSet()
                    
                    convCC_filter_1636_(literalNode, self, &node.Nodes_Node)
        ...
        for _, _callNode := range( nodeManager.FP.GetExpCallNodeList().Items ) {
            ...
            convCC_filter_1636_(&callNode.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _dddNode := range( nodeManager.FP.GetExpToDDDNodeList().Items ) {
            ...
            convCC_filter_1636_(&dddNode.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _castNode := range( nodeManager.FP.GetExpCastNodeList().Items ) {
            ...
            convCC_filter_1636_(&castNode.Nodes_Node, self, &node.Nodes_Node)
        }
        ...
        for _, _declConstrNode := range( nodeManager.FP.GetDeclConstrNodeList().Items ) {
            ...
            convCC_filter_1636_(&declConstrNode.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _declMethodNode := range( nodeManager.FP.GetDeclMethodNodeList().Items ) {
            ...
            convCC_filter_1636_(&declMethodNode.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _declFuncNode := range( nodeManager.FP.GetDeclFuncNodeList().Items ) {
            ...
            convCC_filter_1636_(&declFuncNode.Nodes_Node, self, &node.Nodes_Node)
        }
        self.FP.PopIndent()
        self.FP.Writeln("}")
        ...
        for _, _declEnumNode := range( nodeManager.FP.GetDeclEnumNodeList().Items ) {
            ...
            convCC_filter_1636_(&declEnumNode.Nodes_Node, self, &node.Nodes_Node)
        }
        ...
        for _, _declFormNode := range( nodeManager.FP.GetDeclFormNodeList().Items ) {
            ...
            convCC_filter_1636_(&declFormNode.Nodes_Node, self, &node.Nodes_Node)
        }
        for _, _declFuncNode := range( nodeManager.FP.GetDeclFuncNodeList().Items ) {
            declFuncNode := _declFuncNode.(Nodes_DeclFuncNodeDownCast).ToNodes_DeclFuncNode()
            self.duringDeclFunc = false
    ...
    for _, _testBlock := range( nodeManager.FP.GetTestCaseNodeList().Items ) {
        ...
        convCC_filter_1636_(&testBlock.Nodes_Node, self, &node.Nodes_Node)
    }
    if self.outputBuiltinFlag{
...
// 1854: decl @lune.@base.@convCC.convFilter.processSubfile
func (self *convCC_convFilter) ProcessSubfile(node *Nodes_SubfileNode,_opt LnsAny) {
}

// 1927: decl @lune.@base.@convCC.convFilter.processBlockPreProcess
func (self *convCC_convFilter) processBlockPreProcess(scope *Ast_Scope) {
    ...
    self.FP.Writeln(Lns_getVM().String_format("lns_block_t * %s = lns_enter_block( _pEnv, %d, %d, %d );", []LnsAny{convCC_getBlockName_1195_(scope), anyNum, stemNum, varNum}))
    self.routineInfoStack.FP.PushDepth()
    self.loopInfoStack.FP.PushDepth()
}

// 1936: decl @lune.@base.@convCC.convFilter.processBlockPostProcess
...
// 1943: decl @lune.@base.@convCC.convFilter.pushRoutine
...
func (self *convCC_convFilter) ProcessBlockSub(node *Nodes_BlockNode,_opt LnsAny) {
    ...
    {
        __collection9793 := scope.FP.Get_closureSymMap()
        __sorted9793 := __collection9793.CreateKeyListInt()
        __sorted9793.Sort( LnsItemKindInt, nil )
        for _, ___key9793 := range( __sorted9793.Items ) {
            symbol := __collection9793.Items[ ___key9793 ].(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
            var typeTxt string
            typeTxt = convCC_convExp9750(Lns_2DDD(self.scopeMgr.FP.GetCTypeForSym(symbol.FP)))
    ...
    var word string
    word = ""
    if _switch10035 := node.FP.Get_blockKind(); _switch10035 == Nodes_BlockKind__If || _switch10035 == Nodes_BlockKind__Elseif {
        word = "{"
        
    } else if _switch10035 == Nodes_BlockKind__Else {
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__While {
        loopFlag = true
        
    } else if _switch10035 == Nodes_BlockKind__Repeat {
        word = ""
        
        loopFlag = true
        
    } else if _switch10035 == Nodes_BlockKind__For {
        word = ""
        
        loopFlag = true
        
    } else if _switch10035 == Nodes_BlockKind__Apply {
        word = ""
        
        loopFlag = true
        
    } else if _switch10035 == Nodes_BlockKind__Foreach {
        word = ""
        
        loopFlag = true
        
    } else if _switch10035 == Nodes_BlockKind__Macro {
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__Func {
        readyBlock = true
        
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__Default {
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__Block {
        word = "{"
        
    } else if _switch10035 == Nodes_BlockKind__LetUnwrap {
        readyBlock = true
        
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__LetUnwrapThenDo {
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__IfUnwrap {
        readyBlock = true
        
        word = ""
        
    } else if _switch10035 == Nodes_BlockKind__When {
        readyBlock = true
    ...
    for _, _statement := range( stmtList.Items ) {
        ...
        convCC_filter_1636_(statement, self, &node.Nodes_Node)
        self.FP.Writeln("")
    }
    if Lns_op_not(readyBlock){
        self.FP.processBlockPostProcess()
...
func (self *convCC_convFilter) processSym2stem(symbolInfo Ast_LowSymbol) {
    ...
    if _switch10682 := valKind; _switch10682 == convCC_ValKind__Any {
        ...
        self.FP.Write(")")
        return 
    } else if _switch10682 == convCC_ValKind__Var {
        self.FP.Write(self.moduleCtrl.FP.GetSymbolName(symbolInfo))
        self.FP.Write("->stem")
        return 
    } else if _switch10682 == convCC_ValKind__Stem {
        self.FP.Write(self.moduleCtrl.FP.GetSymbolName(symbolInfo))
        return 
    }
    var expType *Ast_TypeInfo
    ...
    if _switch10932 := expType; _switch10932 == Ast_builtinTypeInt || _switch10932 == Ast_builtinTypeChar {
        self.FP.Write("LNS_STEM_INT( ")
        self.FP.Write("")
        self.FP.Write(self.scopeMgr.FP.GetAccessPrimValFromSymbol(symbolInfo))
        self.FP.Write(")")
    } else if _switch10932 == Ast_builtinTypeReal {
        self.FP.Write("LNS_STEM_REAL( ")
        self.FP.Write(self.scopeMgr.FP.GetAccessPrimValFromSymbol(symbolInfo))
        self.FP.Write(")")
    } else if _switch10932 == Ast_builtinTypeBool {
        self.FP.Write("LNS_STEM_BOOL( ")
        self.FP.Write(self.scopeMgr.FP.GetAccessPrimValFromSymbol(symbolInfo))
        self.FP.Write(")")
    } else if _switch10932 == Ast_builtinTypeStem || _switch10932 == Ast_builtinTypeStem_ {
        self.FP.Write(self.moduleCtrl.FP.GetSymbolName(symbolInfo))
    } else {
        if _switch10930 := expType.FP.Get_kind(); _switch10930 == Ast_TypeInfoKind__DDD {
            self.FP.Write("_pDDD")
        } else if _switch10930 == Ast_TypeInfoKind__Func {
            if Lns_isCondTrue( expType.FP.Get_scope()){
                self.FP.Write("LNS_STEM_ANY(")
                self.FP.Write(convCC_getFunc2any_1888_(self.moduleCtrl, self.scopeMgr, expType))
                self.FP.Write(")")
            } else { 
                Util_err("illegal func")
            }
...
// 2244: decl @lune.@base.@convCC.convFilter.processDeclEnum
func (self *convCC_convFilter) ProcessDeclEnum(node *Nodes_DeclEnumNode,_opt LnsAny) {
    ...
    if _switch12198 := self.processMode; _switch12198 == convCC_ProcessMode__Prototype {
        var process func(out2HMode LnsInt)
        process = func(out2HMode LnsInt) {
            var prefix string
            prefix = convCC_getOut2HeaderPrefix_1512_(out2HMode)
            for _, _valName := range( node.FP.Get_valueNameList().Items ) {
                ...
                if isStrEnum{
                    ...
                    if _switch11106 := out2HMode; _switch11106 == convCC_Out2HMode__HeaderPub || _switch11106 == convCC_Out2HMode__SourcePri {
                        var valTxt string
            ...
            if _switch11200 := out2HMode; _switch11200 == convCC_Out2HMode__HeaderPub || _switch11200 == convCC_Out2HMode__SourcePri {
                self.FP.Writeln(Lns_getVM().String_format("%s%s %s_get__allList( lns_env_t * _pEnv );", []LnsAny{prefix, convCC_cTypeAnyP, enumFullName}))
                self.FP.Writeln(Lns_getVM().String_format("%s%s %s_get__txt( %s _pEnv, %s val );", []LnsAny{prefix, convCC_cTypeAnyP, enumFullName, convCC_cTypeEnvP, convCC_getCType_1185_(enumType.FP.Get_valTypeInfo())}))
                self.FP.Writeln(Lns_getVM().String_format("%s%s %s( %s _pEnv, %s val );", []LnsAny{prefix, convCC_cTypeStem, self.moduleCtrl.FP.GetEnumFuncName(enumType, "_from"), convCC_cTypeEnvP, convCC_getCType_1185_(enumType.FP.Get_valTypeInfo())}))
            }
        }
        {
            var processwork func(out2HMode LnsInt)
    ...
    } else if _switch12198 == convCC_ProcessMode__Form {
        ...
        self.FP.Writeln("}")
        {
            ...
            self.FP.Writeln(Lns_getVM().String_format("%s %s_get__txt( %s _pEnv, %s val ) {", []LnsAny{convCC_cTypeAnyP, enumFullName, convCC_cTypeEnvP, convCC_getCType_1185_(enumType.FP.Get_valTypeInfo())}))
            self.FP.PushIndent(nil)
            ...
            workSym = NewconvCC_WorkSymbol(Lns_unwrap( self.moduleTypeInfo.FP.Get_scope()).(*Ast_Scope), Ast_AccessMode__Local, "val", enumType.FP.Get_valTypeInfo(), Ast_SymbolKind__Arg, false, NewconvCC_SymbolParam(convCC_getValKind_1164_(enumType.FP.Get_valTypeInfo()), 0, convCC_getCType_1185_(enumType.FP.Get_valTypeInfo())))
        ...
        }
        {
            ...
            self.FP.Writeln(Lns_getVM().String_format("%s %s( %s _pEnv, %s val ) {", []LnsAny{convCC_cTypeStem, self.moduleCtrl.FP.GetEnumFuncName(enumType, "_from"), convCC_cTypeEnvP, convCC_getCType_1185_(enumType.FP.Get_valTypeInfo())}))
            self.FP.PushIndent(nil)
        ...
        if isStrEnum{
            ...
            for _, _valName := range( node.FP.Get_valueNameList().Items ) {
                ...
                self.FP.Write(convCC_getLiteral2Stem_1875_(valTxt, enumType.FP.Get_valTypeInfo()))
                self.FP.Writeln(";")
            }
        }
        ...
        convCC_processAddModuleGlobal_1633_(self.stream.FP, Lns_getVM().String_format("LNS_STEM_ANY( %s )", []LnsAny{allListName}))
        ...
        convCC_processAddModuleGlobal_1633_(self.stream.FP, Lns_getVM().String_format("LNS_STEM_ANY( %s )", []LnsAny{val2NameMapName}))
        for _index, _anyVar := range( anyVarList.Items ) {
            ...
            self.FP.Writeln(Lns_getVM().String_format("  LNS_STEM_ANY( lns_litStr2any( _pEnv, \"%s.%s\" ) ) );", []LnsAny{fullName, node.FP.Get_valueNameList().GetAt(index).(Parser_TokenDownCast).ToParser_Token().Txt}))
        }
        self.FP.PopIndent()
        self.FP.Writeln("}")
    } else if _switch12198 == convCC_ProcessMode__InitModule {
        self.FP.Writeln(Lns_getVM().String_format("init_%s( _pEnv );", []LnsAny{enumFullName}))
    }
}

// 2876: decl @lune.@base.@convCC.convFilter.processDeclAlge
func (self *convCC_convFilter) ProcessDeclAlge(node *Nodes_DeclAlgeNode,_opt LnsAny) {
    if _switch13728 := self.processMode; _switch13728 == convCC_ProcessMode__Prototype {
        convCC_processAlgePrototype_1919_(self.stream.FP, self.moduleCtrl, node)
    } else if _switch13728 == convCC_ProcessMode__WideScopeVer {
        convCC_processAlgeWideScope_1935_(self.stream.FP, self.moduleCtrl, node)
    } else if _switch13728 == convCC_ProcessMode__Form {
        convCC_processAlgeForm_1951_(self.stream.FP, self.moduleCtrl, node)
    } else if _switch13728 == convCC_ProcessMode__InitModule {
        self.FP.Writeln(Lns_getVM().String_format("%s( _pEnv );", []LnsAny{self.moduleCtrl.FP.GetAlgeInitCName(node.FP.Get_expType())}))
    }
}

// 2952: decl @lune.@base.@convCC.convFilter.processNewAlgeVal
func (self *convCC_convFilter) ProcessNewAlgeVal(node *Nodes_NewAlgeValNode,_opt LnsAny) {
    ...
    if valInfo.FP.Get_typeList().Len() == 0{
        ...
        for _, _arg := range( node.FP.Get_paramList().Items ) {
            ...
            self.FP.Write(",")
            convCC_filter_1636_(arg, self, &node.Nodes_Node)
        }
        self.FP.Write(")")
    }
}

// 3003: decl @lune.@base.@convCC.convFilter.outputAlter2MapFunc
func (self *convCC_convFilter) outputAlter2MapFunc(stream Util_SourceStream,alt2Map *LnsMap) {
}

// 3744: decl @lune.@base.@convCC.convFilter.processNewInsance
func (self *convCC_convFilter) processNewInsance(classType *Ast_TypeInfo,callInit bool) {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( callInit) &&
        Lns_setStackVal( Lns_op_not(self.outputBuiltinFlag)) ).(bool)){
    ...
    if (Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.outputBuiltinFlag) ||
        Lns_setStackVal( Lns_op_not(self.canConv)) ).(bool)){
    ...
    convCC_processIFObjInit_2087_(self.stream.FP, self.moduleCtrl, classType, classType)
}

// 3773: decl @lune.@base.@convCC.convFilter.processMapping
func (self *convCC_convFilter) processMapping(node *Nodes_DeclClassNode,classType *Ast_TypeInfo,out2HMode LnsInt) {
    ...
    processDeclToMap = func(callFlag bool) {
        self.FP.Write(Lns_getVM().String_format("%s%s ", []LnsAny{convCC_getOut2HeaderPrefix_1512_(out2HMode), convCC_cTypeAnyP}))
        if callFlag{
        ...
        self.FP.Write(Lns_getVM().String_format("( %s _pEnv, %s pObj)", []LnsAny{convCC_cTypeEnvP, convCC_getCRetType_1192_(toMapMtdSym.FP.Get_typeInfo().FP.Get_retTypeInfoList())}))
    }
    var processDeclFromMap func(sub bool)
    processDeclFromMap = func(sub bool) {
        self.FP.Write(Lns_getVM().String_format("%s%s ", []LnsAny{convCC_getOut2HeaderPrefix_1512_(out2HMode), convCC_cTypeStem}))
        ...
        self.FP.Write(Lns_getVM().String_format(", %s mapStem)", []LnsAny{convCC_getCRetType_1192_(fromMapMtdSym.FP.Get_typeInfo().FP.Get_retTypeInfoList())}))
    }
    ...
    processToMapBody = func() {
        ...
        for _, _varName := range( Ast_getAllNameForKind(classType, Ast_MethodKind__Object, Ast_SymbolKind__Mbr).FP.Get_list().Items ) {
            ...
            var valKind LnsInt
            valKind = convCC_getValKind_1164_(memberSym.FP.Get_typeInfo())
            var valTxt LnsAny
            valTxt = convCC_getAccessMember_2059_(className, "pObj", varName)
            if _switch17833 := valKind; _switch17833 == convCC_ValKind__Prim {
            } else if _switch17833 == convCC_ValKind__Stem {
                self.FP.Writeln(Lns_getVM().String_format("lns_toMapFromStem( _pEnv, %s ) );", []LnsAny{valTxt}))
                valTxt = nil
                
            } else if _switch17833 == convCC_ValKind__Any {
            ...
            if valTxt != nil{
                valTxt_7235 := valTxt.(string)
                convCC_process2stem_2050_(self.stream.FP, self.moduleCtrl, self.scopeMgr, convCC_getValKind_1164_(memberSym.FP.Get_typeInfo()), memberSym.FP.Get_typeInfo(), &node.Nodes_Node, convCC_process2stemCallback_2047_(func() {
                    self.FP.Write(valTxt_7235)
                }))
                self.FP.Writeln(");")
            }
        }
        ...
        self.FP.Write(convCC_getAccessMethod_2062_(className, "pObj", "_toMap"))
    ...
    processFromMapBody = func() {
        ...
        for _, _varName := range( Ast_getAllNameForKind(classType, Ast_MethodKind__Object, Ast_SymbolKind__Mbr).FP.Get_list().Items ) {
            ...
            if _switch18249 := nonNilMemberType.FP.Get_kind(); _switch18249 == Ast_TypeInfoKind__List {
                fromMapSym = "lns_fromMapToList"
                
            } else if _switch18249 == Ast_TypeInfoKind__Array {
                fromMapSym = "lns_fromMapToArray"
                
            } else if _switch18249 == Ast_TypeInfoKind__Set {
                fromMapSym = "lns_fromMapToSet"
                
            } else if _switch18249 == Ast_TypeInfoKind__Map {
            ...
            process = func(nilable bool) {
                var kind string
                if _switch18317 := nonNilMemberType; _switch18317 == Ast_builtinTypeInt || _switch18317 == Ast_builtinTypeChar {
                    kind = "lns_stem_type_int"
                    
                } else if _switch18317 == Ast_builtinTypeReal {
                    kind = "lns_stem_type_real"
                    
                } else if _switch18317 == Ast_builtinTypeBool {
                ...
                self.FP.Writeln(Lns_getVM().String_format("lns_check_err_from_map( pErr, _pEnv, pMap, %s, %s, %s, %s );", []LnsAny{Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( nilable) &&
                    Lns_setStackVal( "true") ||
                    Lns_setStackVal( "false") ).(string), memberSym.FP.Get_name(), kind, convCC_getAccessPrimValFromStem_1842_(false, memberSym.FP.Get_typeInfo(), 0)}))
            }
            self.FP.Writeln(Lns_getVM().String_format("%s %s;", []LnsAny{convCC_getCType_1185_(memberSym.FP.Get_typeInfo()), memberSym.FP.Get_name()}))
            var nilable bool
            ...
            if fromMapSym != nil{
                fromMapSym_7269 := fromMapSym.(string)
                ...
                self.FP.Writeln(Lns_getVM().String_format("( pErr, _pEnv, pMap, %s, %s, %sSub, %s, %s );", []LnsAny{nilable, memberSym.FP.Get_name(), fromMapSym_7269, infoValName, convCC_getAccessPrimValFromStem_1842_(false, memberSym.FP.Get_typeInfo(), 0)}))
            } else {
                if nonNilMemberType.FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil){
                    self.FP.Writeln(Lns_getVM().String_format("lns_check_err_from_map_str( pErr, _pEnv, pMap, %s, %s, %s );", []LnsAny{nilable, memberSym.FP.Get_name(), convCC_getAccessPrimValFromStem_1842_(false, memberSym.FP.Get_typeInfo(), 0)}))
        ...
        for _, _varName := range( Ast_getAllNameForKind(classType, Ast_MethodKind__Object, Ast_SymbolKind__Mbr).FP.Get_list().Items ) {
            ...
            var memberSym *Ast_SymbolInfo
            memberSym = Lns_unwrap( classScope.FP.GetSymbolInfoField(varName, true, classScope, Ast_ScopeAccess__Full)).(*Ast_SymbolInfo)
            if _switch18729 := convCC_getValKind_1164_(memberSym.FP.Get_typeInfo()); _switch18729 == convCC_ValKind__Stem {
                self.FP.Writeln(Lns_getVM().String_format("lns_setQ( pObj->%s, %s );", []LnsAny{varName, varName}))
            } else if _switch18729 == convCC_ValKind__Any {
                self.FP.Writeln(Lns_getVM().String_format("lns_setQ_any( &pObj->%s, %s );", []LnsAny{varName, varName}))
            } else if _switch18729 == convCC_ValKind__Prim {
    ...
    processFromMapInfo = func(memberSym *Ast_SymbolInfo) {
        ...
        processGenType = func(genType *Ast_TypeInfo,name string,depth LnsInt,index LnsInt) {
            ...
            if _switch18985 := genType.FP.Get_nonnilableType().FP.Get_srcTypeInfo(); _switch18985 == Ast_builtinTypeStem {
                self.FP.Write("lns_fromMapToStemSub")
            } else if _switch18985 == Ast_builtinTypeInt || _switch18985 == Ast_builtinTypeChar {
                self.FP.Write("lns_fromMapToIntSub")
            } else if _switch18985 == Ast_builtinTypeReal {
                self.FP.Write("lns_fromMapToRealSub")
            } else if _switch18985 == Ast_builtinTypeBool {
                self.FP.Write("lns_fromMapToBoolSub")
            } else if _switch18985 == Ast_builtinTypeString {
                self.FP.Write("lns_fromMapToStrSub")
            } else {
                if _switch18983 := genType.FP.Get_nonnilableType().FP.Get_kind(); _switch18983 == Ast_TypeInfoKind__List || _switch18983 == Ast_TypeInfoKind__Array {
                    self.FP.Write("lns_fromMapToListSub")
                } else if _switch18983 == Ast_TypeInfoKind__Set {
                    self.FP.Write("lns_fromMapToSetSub")
                } else if _switch18983 == Ast_TypeInfoKind__Map {
    ...
    if _switch19292 := self.processMode; _switch19292 == convCC_ProcessMode__Prototype {
        processDeclToMap(true)
        self.FP.Writeln(";")
        processDeclToMap(false)
        self.FP.Writeln(";")
        ...
        processDeclFromMap(true)
        self.FP.Writeln(";")
    } else if _switch19292 == convCC_ProcessMode__DefClass {
        processToMapBody()
        processFromMapBody()
    }
}

// 4149: decl @lune.@base.@convCC.convFilter.processDeclClassNodePrototype
func (self *convCC_convFilter) processDeclClassNodePrototype(node *Nodes_DeclClassNode) {
    ...
    process = func(out2HMode LnsInt) {
        ...
        convCC_processDeclMethodTable_2011_(self.stream.FP, node.FP.Get_expType())
        self.FP.PopIndent()
        ...
        if kind == Ast_TypeInfoKind__Class{
            ...
            self.FP.PushIndent(nil)
            convCC_processIFObjDecl_2084_(self.stream.FP, self.moduleCtrl, node.FP.Get_expType())
        ...
        if _switch19626 := kind; _switch19626 == Ast_TypeInfoKind__Class {
            ...
            convCC_processDeclMemberTable_2025_(Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( Lns_op_not(self.outputBuiltinFlag)) &&
                Lns_setStackVal( self.canConv) ).(bool), self.stream.FP, node.FP.Get_expType())
            self.FP.Writeln("// interface implements")
            self.FP.Writeln(Lns_getVM().String_format("u_if_imp_%s_t imp;", []LnsAny{className}))
        } else if _switch19626 == Ast_TypeInfoKind__IF {
        ...
        if _switch19801 := kind; _switch19801 == Ast_TypeInfoKind__Class {
            ...
            if Lns_op_not(node.FP.Get_expType().FP.Get_abstractFlag()){
                convCC_processNewConstrProto_1981_(self.stream.FP, self.moduleCtrl, node, out2HMode, self.outputBuiltinFlag)
                self.stream.FP.Writeln(";")
            }
            self.FP.processMapping(node, node.FP.Get_expType(), out2HMode)
        } else if _switch19801 == Ast_TypeInfoKind__IF {
    ...
    }
    {
        var processwork func(out2HMode LnsInt)
        processwork = func(out2HMode LnsInt) {
            if _switch19862 := out2HMode; _switch19862 == convCC_Out2HMode__HeaderPub || _switch19862 == convCC_Out2HMode__SourcePri {
                process(out2HMode)
            }
        }
        if Ast_isPubToExternal(node.FP.Get_expType().FP.Get_accessMode()){
    ...
    if kind == Ast_TypeInfoKind__Class{
        convCC_processDeclClassPrototype_2078_(Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( Lns_op_not(self.outputBuiltinFlag)) &&
            Lns_setStackVal( self.canConv) ).(bool), self.stream.FP, self.moduleCtrl, node)
        convCC_processAdvertise_2065_(self.stream.FP, self.moduleCtrl, self.scopeMgr, self.processMode, node)
        if Lns_op_not(self.outputBuiltinFlag){
            convCC_processDefaultCtor_2081_(self.stream.FP, self.moduleCtrl, self.scopeMgr, node)
        }
    }
}

// 4261: decl @lune.@base.@convCC.convFilter.isManagedAnySymbol
func (self *convCC_convFilter) isManagedAnySymbol(symbol Ast_LowSymbol) bool {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( valKind == convCC_ValKind__Any) &&
        Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( symbol.Get_kind() == Ast_SymbolKind__Var) ||
            Lns_setStackVal( symbol.Get_kind() == Ast_SymbolKind__Arg) &&
            Lns_setStackVal( symbol.Get_mutable()) ||
            Lns_setStackVal( convCC_isClassMember_1213_(symbol)) ).(bool))) ).(bool)){
        if varName == "self"{
            return false
        }
        return true
...
// 4286: decl @lune.@base.@convCC.convFilter.processDeclClassDef
func (self *convCC_convFilter) processDeclClassDef(node *Nodes_DeclClassNode) {
    ...
    for _, _member := range( node.FP.Get_memberList().Items ) {
        ...
        if Lns_op_not(member.FP.Get_staticFlag()){
            ...
            if _switch20306 := valKind; _switch20306 == convCC_ValKind__Stem {
                var typeInfo *Ast_TypeInfo
                typeInfo = member.FP.Get_symbolInfo().FP.Get_typeInfo()
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( typeInfo.FP.Get_nilable()) &&
                    Lns_setStackVal( convCC_getValKind_1164_(typeInfo.FP.Get_nonnilableType()) == convCC_ValKind__Prim) ).(bool)){
                } else { 
                    self.FP.Writeln(Lns_getVM().String_format("lns_decre_ref_stem( _pEnv, %s );", []LnsAny{convCC_getAccessMember_2059_(className, "pObj", member.FP.Get_name().Txt)}))
                }
            } else if _switch20306 == convCC_ValKind__Any {
                self.FP.Writeln(Lns_getVM().String_format("lns_decre_ref( _pEnv, %s );", []LnsAny{convCC_getAccessMember_2059_(className, "pObj", member.FP.Get_name().Txt)}))
            }
        }
    }
    self.FP.PopIndent()
    self.FP.Writeln("}")
    if Lns_op_not(node.FP.Get_expType().FP.Get_abstractFlag()){
        convCC_processNewConstrProto_1981_(self.stream.FP, self.moduleCtrl, node, convCC_Out2HMode__SourcePub, self.outputBuiltinFlag)
    ...
    for _, _member := range( node.FP.Get_memberList().Items ) {
        ...
        if member.FP.Get_getterMode() != Ast_AccessMode__None{
            ...
            if getterType.FP.Get_autoFlag(){
                if getterType.FP.Get_staticFlag(){
                    convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__CallWrap, getterType, nil)
                    self.FP.Writeln("{")
                    self.FP.PushIndent(nil)
                    ...
                    convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__Normal, getterType, nil)
                    self.FP.Writeln("{")
                    self.FP.PushIndent(nil)
                    self.FP.Writeln(Lns_getVM().String_format("return %s;", []LnsAny{convCC_getAccessMember_2059_(className, "pObj", memberName)}))
                    self.FP.PopIndent()
                    self.FP.Writeln("}")
                    convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__CallWrap, getterType, nil)
                    self.FP.Writeln("{")
        ...
        if member.FP.Get_setterMode() != Ast_AccessMode__None{
            ...
            process = func(accessMemberTxt string) {
                ...
                var valKind LnsInt
                valKind = self.scopeMgr.FP.GetSymbolValKind(member.FP.Get_symbolInfo().FP)
                if _switch20847 := valKind; _switch20847 == convCC_ValKind__Stem {
                    self.FP.Writeln(Lns_getVM().String_format("lns_setq( _pEnv, %s, arg1 );", []LnsAny{accessMemberTxt}))
                } else if _switch20847 == convCC_ValKind__Any {
                    self.FP.Writeln(Lns_getVM().String_format("lns_setq_any( _pEnv, &%s, arg1 );", []LnsAny{accessMemberTxt}))
                } else if _switch20847 == convCC_ValKind__Prim {
                    self.FP.Writeln(Lns_getVM().String_format("%s = arg1;", []LnsAny{accessMemberTxt}))
                } else {
                    Util_err(Lns_getVM().String_format("no support -- %s:%s:%d", []LnsAny{member.FP.Get_symbolInfo().FP.Get_name(), convCC_ValKind_getTxt( valKind), 4412}))
                }
                self.FP.PopIndent()
                self.FP.Writeln("}")
            }
            if setterType.FP.Get_autoFlag(){
                if setterType.FP.Get_staticFlag(){
                    convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__Normal, setterType, nil)
                    var txt string
                    if self.FP.isManagedAnySymbol(member.FP.Get_symbolInfo().FP){
                    ...
                    convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__Normal, setterType, nil)
                    process(convCC_getAccessMember_2059_(className, "pObj", memberName))
                    convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__CallWrap, setterType, nil)
                    self.FP.Writeln("{")
                    self.FP.PushIndent(nil)
...
// 4650: decl @lune.@base.@convCC.convFilter.processDeclMember
func (self *convCC_convFilter) ProcessDeclMember(node *Nodes_DeclMemberNode,_opt LnsAny) {
}

// 4657: decl @lune.@base.@convCC.convFilter.processExpMacroExp
func (self *convCC_convFilter) ProcessExpMacroExp(node *Nodes_ExpMacroExpNode,_opt LnsAny) {
    for _, _stmt := range( node.FP.Get_stmtList().Items ) {
        ...
        convCC_filter_1636_(stmt, self, &node.Nodes_Node)
        self.FP.Writeln("")
    }
}

// 4669: decl @lune.@base.@convCC.convFilter.outputDeclMacro
func (self *convCC_convFilter) OutputDeclMacro(name string,argNameList *LnsList,callback convCC_outputMacroStmtBlock_2209_) {
}

// 4713: decl @lune.@base.@convCC.convFilter.processDeclMacro
func (self *convCC_convFilter) ProcessDeclMacro(node *Nodes_DeclMacroNode,_opt LnsAny) {
}

// 4732: decl @lune.@base.@convCC.convFilter.processExpMacroStat
func (self *convCC_convFilter) ProcessExpMacroStat(node *Nodes_ExpMacroStatNode,_opt LnsAny) {
}

// 4756: decl @lune.@base.@convCC.convFilter.processDeclVarC
func (self *convCC_convFilter) processDeclVarC(declFlag bool,_var Ast_LowSymbol,init0 bool,manageScope LnsAny) {
    if declFlag{
        var typeTxt string
        typeTxt = convCC_convExp22072(Lns_2DDD(self.scopeMgr.FP.GetCTypeForSym(_var)))
    ...
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( Lns_op_not(init0)) ||
        Lns_setStackVal( convCC_isStemType_1168_(_var.Get_typeInfo())) ).(bool){
        {
            _symbolInfo := Ast_SymbolInfoDownCastF(_var)
            if _symbolInfo != nil {
                symbolInfo := _symbolInfo.(*Ast_SymbolInfo)
                if _switch22313 := valKind; _switch22313 == convCC_ValKind__Any {
                    self.FP.Write("lns_set_block_any")
                    self.FP.Writeln(Lns_getVM().String_format("( %s, %d, %s );", []LnsAny{convCC_getBlockName_1195_(scope), convCC_getSymbolIndex_1651_(symbolInfo), self.moduleCtrl.FP.GetSymbolName(_var)}))
                } else if _switch22313 == convCC_ValKind__Stem {
                    self.FP.Write("lns_set_block_stem")
                    self.FP.Writeln(Lns_getVM().String_format("( %s, %d, %s );", []LnsAny{convCC_getBlockName_1195_(scope), convCC_getSymbolIndex_1651_(symbolInfo), self.moduleCtrl.FP.GetSymbolName(_var)}))
                } else if _switch22313 == convCC_ValKind__Var {
                    var typeTxt string
                    typeTxt = convCC_getStemTypeId_1878_(convCC_getOrgTypeInfo_1424_(_var.Get_typeInfo()))
                    self.FP.Writeln(Lns_getVM().String_format("lns_set_block_var( %s, %d, %s, %s );", []LnsAny{convCC_getBlockName_1195_(scope), convCC_getSymbolIndex_1651_(symbolInfo), typeTxt, self.moduleCtrl.FP.GetSymbolName(_var)}))
                }
            }
        }
    } else { 
        var initVal string
        initVal = convCC_getLiteral2Stem_1875_("0", _var.Get_typeInfo())
        {
            _symbolInfo := Ast_SymbolInfoDownCastF(_var)
            if _symbolInfo != nil {
                symbolInfo := _symbolInfo.(*Ast_SymbolInfo)
                if _switch22390 := valKind; _switch22390 == convCC_ValKind__Stem {
                    self.FP.Write("lns_initVal_stem")
                } else if _switch22390 == convCC_ValKind__Any {
                    self.FP.Write("lns_initVal_any")
                } else if _switch22390 == convCC_ValKind__Var {
                    self.FP.Write("lns_initVal_var")
                } else {
                    Util_err(Lns_getVM().String_format("not support -- %s", []LnsAny{convCC_ValKind_getTxt( valKind)}))
                }
                self.FP.Writeln(Lns_getVM().String_format("( %s, %s, %d, %s );", []LnsAny{self.moduleCtrl.FP.GetSymbolName(_var), convCC_getBlockName_1195_(scope), convCC_getSymbolIndex_1651_(symbolInfo), initVal}))
            } else {
...
// 4831: decl @lune.@base.@convCC.convFilter.process__func__symbol
func (self *convCC_convFilter) process__func__symbol(funcTypeInfo *Ast_TypeInfo,has__func__Symbol bool,funcName string) {
    ...
    if _switch22602 := self.processMode; _switch22602 == convCC_ProcessMode__WideScopeVer {
        var scope *Ast_Scope
    ...
    } else if _switch22602 == convCC_ProcessMode__InitFuncSym {
        var scope *Ast_Scope
        scope = Lns_unwrap( funcTypeInfo.FP.Get_scope()).(*Ast_Scope)
        var symbol *Ast_SymbolInfo
        symbol = Lns_unwrap( scope.FP.GetSymbolInfoChild("__func__")).(*Ast_SymbolInfo)
...
// 4861: decl @lune.@base.@convCC.convFilter.processArgClosure
        ...
        argNode := _argNode.(Nodes_NodeDownCast).ToNodes_Node()
        {
            ...
            if _declArg != nil {
                ...
                if symbolInfo.FP.Get_hasAccessFromClosure(){
                    ...
                    self.FP.Write("lns_initVal_var(")
                    self.FP.Write(Lns_getVM().String_format(" %s, %s, %d, ", []LnsAny{self.moduleCtrl.FP.GetSymbolName(symbolInfo.FP), convCC_getBlockName_1195_(symbolInfo.FP.Get_scope()), symbolParam.Index}))
                    var valKind LnsInt
                    valKind = convCC_getValKind_1164_(symbolInfo.FP.Get_typeInfo())
                    var workSymbol *convCC_WorkSymbol
                    workSymbol = NewconvCC_WorkSymbol(symbolInfo.FP.Get_scope(), symbolInfo.FP.Get_accessMode(), Lns_getVM().String_format("_%s", []LnsAny{symbolInfo.FP.Get_name()}), symbolInfo.FP.Get_typeInfo(), symbolInfo.FP.Get_kind(), symbolInfo.FP.Get_staticFlag(), NewconvCC_SymbolParam(valKind, 0, convCC_getCType_1185_(symbolInfo.FP.Get_typeInfo())))
...
// 4911: decl @lune.@base.@convCC.convFilter.processDeclMethodInfo
func (self *convCC_convFilter) processDeclMethodInfo(declInfo *Nodes_DeclFuncInfo,funcTypeInfo *Ast_TypeInfo,parent *Nodes_Node) {
    if _switch23354 := self.processMode; _switch23354 == convCC_ProcessMode__Prototype {
        convCC_processPrototypeMethod_2038_(self.stream.FP, self.moduleCtrl, declInfo.FP.Get_argList(), funcTypeInfo)
    } else if _switch23354 == convCC_ProcessMode__Form {
        ...
        className = self.moduleCtrl.FP.GetClassCName(classType)
        {
            ...
            if _body != nil {
                ...
                convCC_processMethodDeclTxt_2006_(self.stream.FP, self.moduleCtrl, convCC_FuncWrap__Normal, funcTypeInfo, declInfo.FP.Get_argList())
                self.FP.Writeln("{")
                self.FP.PushIndent(nil)
                self.FP.pushRoutine(funcTypeInfo, body)
                {
                    ...
                    if _declClassNode != nil {
                        ...
                        if Lns_NilAccFin(Lns_NilAccPush(declInfo.FP.Get_name()) && 
                        Lns_NilAccPush(Lns_NilAccPop().(*Parser_Token).Txt)) == "__init"{
                            for _, _memberSym := range( declClassNode.FP.Get_uninitMemberList().Items ) {
                                ...
                                if declInfo.FP.Get_staticFlag() == memberSym.FP.Get_staticFlag(){
                                    ...
                                    if declInfo.FP.Get_staticFlag(){
                                        ...
                                        memberAccess = convCC_getAccessMember_2059_(className, "pObj", memberSym.FP.Get_name())
                ...
                if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                    Lns_setStackVal( funcTypeInfo.FP.Get_staticFlag()) &&
                    Lns_setStackVal( funcTypeInfo.FP.Get_rawTxt() == "___init") ).(bool)){
                ...
                scope = body.FP.Get_scope()
                {
                    ...
                    if _selfSymbol != nil {
                        ...
                        if symbolParam.Kind == convCC_ValKind__Var{
                            ...
                            self.FP.Writeln(Lns_getVM().String_format("lns_initVal_var( self, %s, %d, LNS_STEM_ANY( pObj ) );", []LnsAny{convCC_getBlockName_1195_(scope), symbolParam.Index}))
                        } else { 
                            if Lns_op_not(funcTypeInfo.FP.Get_staticFlag()){
                ...
                convCC_filter_1636_(&body.Nodes_Node, self, parent)
                self.duringDeclFunc = false
        ...
        convCC_processDeclCallMethodWrapper_2053_(self.stream.FP, self.moduleCtrl, self.scopeMgr, parent, funcTypeInfo, true)
        convCC_processDeclCallMethodWrapper_2053_(self.stream.FP, self.moduleCtrl, self.scopeMgr, parent, funcTypeInfo, false)
    } else if _switch23354 == convCC_ProcessMode__InitFuncSym || _switch23354 == convCC_ProcessMode__WideScopeVer {
...
// 5005: decl @lune.@base.@convCC.convFilter.processDeclConstr
...
// 5011: decl @lune.@base.@convCC.convFilter.processDeclDestr
func (self *convCC_convFilter) ProcessDeclDestr(node *Nodes_DeclDestrNode,_opt LnsAny) {
}

// 5030: decl @lune.@base.@convCC.convFilter.getValKindOfNode
func (self *convCC_convFilter) getValKindOfNode(node *Nodes_Node) LnsInt {
    ...
    return convCC_getValKind_1164_(node.FP.Get_expType())
}

// 5048: decl @lune.@base.@convCC.convFilter.processVal2stem
func (self *convCC_convFilter) ProcessVal2stem(node *Nodes_Node,parent *Nodes_Node) {
    convCC_process2stem_2050_(self.stream.FP, self.moduleCtrl, self.scopeMgr, self.FP.getValKindOfNode(node), node.FP.Get_expType(), parent, convCC_process2stemCallback_2047_(func() {
        convCC_filter_1636_(node, self, parent)
    }))
}

// 5070: decl @lune.@base.@convCC.convFilter.processCallArgList
func (self *convCC_convFilter) ProcessCallArgList(funcType *Ast_TypeInfo,expListNode LnsAny) {
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.moduleCtrl.FP.GetBuiltinFuncNameFromType(funcType)) ||
        Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( funcType.FP.Get_kind() == Ast_TypeInfoKind__Method) &&
            Lns_setStackVal( funcType.FP.Get_parentInfo().FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil)) ).(bool))) )){
    ...
    if expListNode != nil{
        expListNode_7699 := expListNode.(*Nodes_ExpListNode)
        var expList *LnsList
        expList = expListNode_7699.FP.Get_expList()
        for _index, _funcArgType := range( funcArgTypeList.Items ) {
            index := _index + 1
            funcArgType := _funcArgType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
            self.FP.Write(", ")
                ...
                if expNode.FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__Abbr{
                    ...
                    if funcArgType.FP.Get_kind() == Ast_TypeInfoKind__DDD{
                        if expNode.FP.Get_kind() == Nodes_NodeKind_get_Abbr(){
                            ...
                            convCC_filter_1636_(expNode, self, &expListNode_7699.Nodes_Node)
                        }
                        return 
                    } else { 
                        if convCC_isStemType_1168_(funcArgType){
                            self.FP.ProcessVal2stem(expNode, &expListNode_7699.Nodes_Node)
                        } else { 
                            convCC_filter_1636_(expNode, self, &expListNode_7699.Nodes_Node)
                        }
                    }
...
// 5161: decl @lune.@base.@convCC.convFilter.processExpCallSuper
...
// 5180: decl @lune.@base.@convCC.convFilter.processDeclMethod
func (self *convCC_convFilter) ProcessDeclMethod(node *Nodes_DeclMethodNode,_opt LnsAny) {
    self.FP.processDeclMethodInfo(node.FP.Get_declInfo(), node.FP.Get_expType(), &node.Nodes_Node)
}

// 5186: decl @lune.@base.@convCC.convFilter.processProtoMethod
...
// 5195: decl @lune.@base.@convCC.convFilter.processUnwrapSet
func (self *convCC_convFilter) ProcessUnwrapSet(node *Nodes_UnwrapSetNode,_opt LnsAny) {
}

// 5229: decl @lune.@base.@convCC.convFilter.accessPrimValFromAny
func (self *convCC_convFilter) accessPrimValFromAny(dddFlag bool,typeInfo *Ast_TypeInfo,index LnsInt) {
    self.FP.Write(convCC_getAccessPrimValFromStem_1842_(dddFlag, typeInfo, index))
}

// 5235: decl @lune.@base.@convCC.convFilter.isStemSym
...
// 5240: decl @lune.@base.@convCC.convFilter.isStemVal
func (self *convCC_convFilter) isStemVal(node *Nodes_Node) bool {
    ...
    return convCC_isStemType_1168_(node.FP.Get_expType())
}

// 5256: decl @lune.@base.@convCC.convFilter.accessPrimVal
func (self *convCC_convFilter) AccessPrimVal(exp *Nodes_Node,parent *Nodes_Node) {
    if _switch24206 := self.FP.getValKindOfNode(exp); _switch24206 == convCC_ValKind__Var {
        convCC_filter_1636_(exp, self, parent)
    } else if _switch24206 == convCC_ValKind__Prim {
        convCC_filter_1636_(exp, self, parent)
    } else if _switch24206 == convCC_ValKind__Stem {
        convCC_filter_1636_(exp, self, parent)
        self.FP.accessPrimValFromAny(exp.FP.Get_expTypeList().Len() > 1, exp.FP.Get_expType(), 0)
    } else if _switch24206 == convCC_ValKind__Any {
        convCC_filter_1636_(exp, self, parent)
    } else {
        Util_err(Lns_getVM().String_format("not support -- %d", []LnsAny{5289}))
    }
}

// 5323: decl @lune.@base.@convCC.convFilter.processSym2Any
func (self *convCC_convFilter) ProcessSym2Any(symbol Ast_LowSymbol) {
    ...
    if _switch24348 := valKind; _switch24348 == convCC_ValKind__Stem {
        self.FP.Write(symName)
        self.FP.Write(convCC_accessAny)
    } else if _switch24348 == convCC_ValKind__Any {
        self.FP.Write(symName)
    } else if _switch24348 == convCC_ValKind__Var {
        self.FP.Write(symName)
        self.FP.Write(Lns_getVM().String_format("->stem%s", []LnsAny{convCC_accessAny}))
    } else {
        Util_err(Lns_getVM().String_format("not suppport -- %s, %d", []LnsAny{convCC_ValKind_getTxt( valKind), 5346}))
    }
}

// 5353: decl @lune.@base.@convCC.convFilter.processVal2any
func (self *convCC_convFilter) ProcessVal2any(node *Nodes_Node,parent *Nodes_Node) {
    var valKind LnsInt
    valKind = self.FP.getValKindOfNode(node)
    if _switch24456 := valKind; _switch24456 == convCC_ValKind__Stem {
        convCC_filter_1636_(node, self, parent)
        self.FP.Write(convCC_accessAny)
    } else if _switch24456 == convCC_ValKind__Any {
        convCC_filter_1636_(node, self, parent)
    } else if _switch24456 == convCC_ValKind__Var {
        convCC_filter_1636_(node, self, parent)
    } else {
        Util_err(Lns_getVM().String_format("not suppport -- %d, %s, %s, %d", []LnsAny{node.FP.Get_pos().LineNo, convCC_ValKind_getTxt( valKind), Nodes_getNodeKindName(node.FP.Get_kind()), 5371}))
    }
}

// 5393: decl @lune.@base.@convCC.convFilter.processSetValSingleDirect
func (self *convCC_convFilter) processSetValSingleDirect(parent *Nodes_Node,node LnsAny,_var Ast_LowSymbol,initFlag bool,expValKind LnsInt,expValType *Ast_TypeInfo,index LnsInt,firstMRet bool,processVal convCC_processRValue_2289_) {
    var valKind LnsInt
    valKind = self.scopeMgr.FP.GetSymbolValKind(_var)
    var varName string
    ...
    processPrefix = nil
    {
        ...
        if _fieldNode != nil {
            ...
            if Lns_isCondTrue( Lns_NilAccFin(Lns_NilAccPush(fieldNode.FP.Get_symbolInfo()) && 
            Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_SymbolInfo).FP.Get_staticFlag()}))){
            } else { 
                processPrefix = conv2Form24613(func() {
    ...
    if _var.Get_symbolId() == convCC_invalidSymbolId{
        ...
        Util_err(Lns_getVM().String_format("illegal %s %s %s -- %d", []LnsAny{_var.Get_name(), convCC_ValKind_getTxt( valKind), convCC_ValKind_getTxt( expValKind), 5430}))
    }
    if _switch24939 := valKind; _switch24939 == convCC_ValKind__Var {
        if initFlag{
        ...
        convCC_process2stem_2050_(self.stream.FP, self.moduleCtrl, self.scopeMgr, expValKind, expValType, parent, convCC_process2stemCallback_2047_(processVal))
        self.FP.Write(" );")
    } else if _switch24939 == convCC_ValKind__Stem {
        if _switch24834 := expValKind; _switch24834 == convCC_ValKind__Stem || _switch24834 == convCC_ValKind__Any || _switch24834 == convCC_ValKind__Prim {
            if initFlag{
            ...
            if processPrefix != nil{
                processPrefix_7842 := processPrefix.(LnsForm)
                processPrefix_7842(Lns_2DDD([]LnsAny{}))
            }
            self.FP.Write(Lns_getVM().String_format("%s, ", []LnsAny{varName}))
            processVal()
            self.FP.Write(" );")
        }
    } else if _switch24939 == convCC_ValKind__Any {
        if initFlag{
        ...
        if processPrefix != nil{
            processPrefix_7847 := processPrefix.(LnsForm)
            processPrefix_7847(Lns_2DDD([]LnsAny{}))
        }
        self.FP.Write(Lns_getVM().String_format("%s, ", []LnsAny{varName}))
        processVal()
        self.FP.Write(" );")
        ...
        if processPrefix != nil{
            processPrefix_7850 := processPrefix.(LnsForm)
            processPrefix_7850(Lns_2DDD([]LnsAny{}))
        }
        self.FP.Write(Lns_getVM().String_format("%s = ", []LnsAny{varName}))
        processVal()
        self.FP.Write(";")
...
// 5558: decl @lune.@base.@convCC.convFilter.processSymForSetOp
func (self *convCC_convFilter) processSymForSetOp(parent *Nodes_Node,dstKind LnsInt,dstTypeInfo *Ast_TypeInfo,symbol Ast_LowSymbol) {
    ...
    if dstKind != srcKind{
        if _switch25050 := dstKind; _switch25050 == convCC_ValKind__Prim {
            self.FP.Write(self.scopeMgr.FP.GetAccessPrimValFromSymbol(symbol))
            return 
        } else if _switch25050 == convCC_ValKind__Stem {
            self.FP.processSym2stem(symbol)
            return 
        } else if _switch25050 == convCC_ValKind__Var {
            self.FP.processSym2stem(symbol)
            return 
        } else if _switch25050 == convCC_ValKind__Any {
...
// 5644: decl @lune.@base.@convCC.convFilter.needsWrapper
func (self *convCC_convFilter) needsWrapper(orgFunc *Ast_TypeInfo,castType *Ast_TypeInfo) bool {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( orgFunc.FP.Get_argTypeInfoList().Len() == castType.FP.Get_argTypeInfoList().Len()) &&
        Lns_setStackVal( orgFunc.FP.Get_retTypeInfoList().Len() == castType.FP.Get_retTypeInfoList().Len()) ).(bool)){
        ...
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( check(orgFunc.FP.Get_argTypeInfoList(), castType.FP.Get_argTypeInfoList())) &&
            Lns_setStackVal( check(orgFunc.FP.Get_retTypeInfoList(), castType.FP.Get_retTypeInfoList())) ).(bool)){
            return false
        }
    }
    return true
...
// 5667: decl @lune.@base.@convCC.convFilter.processFuncCast2Form
func (self *convCC_convFilter) processFuncCast2Form(castType *Ast_TypeInfo,orgFunc *Ast_TypeInfo) {
    if Lns_op_not(self.FP.needsWrapper(orgFunc, castType)){
        self.FP.Write(convCC_getFunc2any_1888_(self.moduleCtrl, self.scopeMgr, orgFunc))
        return 
    }
    var closureSymList *LnsList
    closureSymList = Lns_unwrapDefault( Lns_NilAccFin(Lns_NilAccPush(orgFunc.FP.Get_scope()) && 
    Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_Scope).FP.Get_closureSymList()})), NewLnsList([]LnsAny{})).(*LnsList)
    var argList *LnsList
    ...
    hasDDD = Lns_popVal( Lns_incStack() ||
        ...
        Lns_setStackVal( argList.GetAt(argList.Len()).(Ast_TypeInfoDownCast).ToAst_TypeInfo().FP.Get_kind() == Ast_TypeInfoKind__DDD) ||
        Lns_setStackVal( false) ).(bool)
    self.FP.Write(convCC_getPrepareClosure_1885_(self.scopeMgr, self.moduleCtrl.FP.GetFuncCastWrapName(orgFunc, castType), argList.Len(), hasDDD, closureSymList))
}

// 5698: decl @lune.@base.@convCC.convFilter.processValForSetOp
func (self *convCC_convFilter) processValForSetOp(parent *Nodes_Node,dstKind LnsInt,dstTypeInfo *Ast_TypeInfo,exp *Nodes_Node,index LnsInt,firstMRet bool) {
    ...
    accessVal = func() {
        if firstMRet{
            convCC_processGetMRet_2304_(self.stream.FP, self.moduleCtrl, exp.FP.Get_expType(), 0)
        } else { 
    ...
    processVal = func() {
        if firstMRet{
            ...
            Lns_setStackVal( Lns_op_not(firstMRet)) &&
            ...
            self.FP.Write(convCC_getAccessValFromStem_1845_(exp.FP.Get_expType()))
        } else { 
            if dstKind == convCC_ValKind__Stem{
                self.FP.ProcessVal2stem(exp, parent)
            } else if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( dstKind == convCC_ValKind__Var) &&
                Lns_setStackVal( valKind != convCC_ValKind__Stem) ).(bool)){
                accessVal()
            } else { 
                accessVal()
            }
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( dstKind == convCC_ValKind__Prim) &&
        Lns_setStackVal( valKind == convCC_ValKind__Stem) ).(bool)){
...
// 5811: decl @lune.@base.@convCC.convFilter.processSetValSingle
func (self *convCC_convFilter) processSetValSingle(parent *Nodes_Node,node LnsAny,_var Ast_LowSymbol,initFlag bool,exp *Nodes_Node,index LnsInt,firstMRet bool) {
    ...
    if firstMRet{
        expValKind = convCC_getValKind_1164_(exp.FP.Get_expType())
        
    } else { 
        expValKind = self.FP.getValKindOfNode(exp)
        
    }
    self.FP.processSetValSingleDirect(parent, node, _var, initFlag, expValKind, exp.FP.Get_expType(), index, firstMRet, convCC_processRValue_2289_(func() {
        self.FP.processValForSetOp(parent, self.scopeMgr.FP.GetSymbolValKind(_var), _var.Get_typeInfo(), exp, index, firstMRet)
    }))
}

// 5841: decl @lune.@base.@convCC.convFilter.processSetSymSingle
func (self *convCC_convFilter) processSetSymSingle(parent *Nodes_Node,node LnsAny,_var Ast_LowSymbol,initFlag bool,symbol Ast_LowSymbol,toIF bool) {
    ...
    self.FP.processSetValSingleDirect(parent, node, _var, initFlag, self.scopeMgr.FP.GetSymbolValKind(symbol), symbol.Get_typeInfo(), 1, false, convCC_processRValue_2289_(func() {
        if toIF{
            convCC_processToIF_2301_(self.stream.FP, self.moduleCtrl, symbol.Get_typeInfo(), convCC_processExp_1872_(process))
        } else { 
            process()
        }
    }))
...
// 5874: decl @lune.@base.@convCC.convFilter.processSetValSingleNode
func (self *convCC_convFilter) processSetValSingleNode(parent *Nodes_Node,_var *Nodes_Node,initFlag bool,exp *Nodes_Node,index LnsInt,firstMRet bool) {
    ...
    if _switch26446 := _var.FP.Get_kind(); _switch26446 == Nodes_NodeKind_get_ExpRefItem() {
        {
            ...
            if _refItemNode != nil {
                ...
                if _switch26421 := dstType.FP.Get_kind(); _switch26421 == Ast_TypeInfoKind__Map {
                    ...
                    self.FP.Write(", ")
                    {
                        ...
                        if _indexNode != nil {
                            ...
                            self.FP.Write(convCC_getLiteralStrStem_1494_(Lns_getVM().String_format("\"%s\"", []LnsAny{Lns_unwrap( refItemNode.FP.Get_symbol()).(string)})))
                        }
                    }
                    self.FP.Write(", ")
                    ...
                    self.FP.Write(")")
                } else if _switch26421 == Ast_TypeInfoKind__List {
...
// 5956: decl @lune.@base.@convCC.convFilter.processSetValToDst
func (self *convCC_convFilter) processSetValToDst(parent *Nodes_Node,dstList *LnsList,expList *LnsList,mRetExp LnsAny) {
    ...
    for _index, _exp := range( expList.Items ) {
        ...
        if is1stMRet{
            if mRetExp != nil{
                mRetExp_8047 := mRetExp.(*Nodes_MRetExp)
                self.FP.Write("lns_setMRet( _pEnv, ")
                convCC_filter_1636_(mRetExp_8047.FP.Get_exp(), self, parent)
                self.FP.Write(convCC_accessAny)
                self.FP.Writeln(");")
            }
        }
        ...
        if index == expList.Len(){
            {
                var _from26661 LnsInt = index
                var _to26661 LnsInt = dstList.Len()
                for _work26661 := _from26661; _work26661 <= _to26661; _work26661++ {
                    dstIndex := _work26661
                    var accessIndex LnsInt
                    if mRetIndex != nil{
                        mRetIndex_8054 := mRetIndex.(LnsInt)
                        accessIndex = index - mRetIndex_8054
                        
                    } else {
                        accessIndex = 0
                        
                    }
                    switch _exp26651 := dstList.GetAt(dstIndex).(type) {
                    case *convCC_DstInfo__Symbol:
                    symbolInfo := _exp26651.Val1
                    dstNode := _exp26651.Val2
                    initFlag := _exp26651.Val3
                        self.FP.processSetValSingle(parent, dstNode, symbolInfo, initFlag, exp, accessIndex, Lns_popVal( Lns_incStack() ||
                            Lns_setStackVal( is1stMRet) &&
                            Lns_setStackVal( dstIndex == index) ).(bool))
                    case *convCC_DstInfo__Node:
                    dstNode := _exp26651.Val1
                    initFlag := _exp26651.Val2
                        self.FP.processSetValSingleNode(parent, dstNode, initFlag, exp, accessIndex, Lns_popVal( Lns_incStack() ||
                            Lns_setStackVal( is1stMRet) &&
                            Lns_setStackVal( dstIndex == index) ).(bool))
                    }
                    self.FP.Writeln("")
            ...
            var accessIndex LnsInt
            if mRetIndex != nil{
                mRetIndex_8066 := mRetIndex.(LnsInt)
                accessIndex = index - mRetIndex_8066
                
            } else {
                accessIndex = 0
                
            }
            switch _exp26733 := dstList.GetAt(index).(type) {
            case *convCC_DstInfo__Symbol:
            symbolInfo := _exp26733.Val1
            dstNode := _exp26733.Val2
            initFlag := _exp26733.Val3
                self.FP.processSetValSingle(parent, dstNode, symbolInfo, initFlag, exp, accessIndex, is1stMRet)
            case *convCC_DstInfo__Node:
            dstNode := _exp26733.Val1
            initFlag := _exp26733.Val2
...
// 6041: decl @lune.@base.@convCC.convFilter.processSetValToSym
func (self *convCC_convFilter) processSetValToSym(parent *Nodes_Node,varSymList *LnsList,initFlag bool,expList *LnsList,varNode LnsAny,mRetExp LnsAny) {
    var varNodeList *LnsList
    {
        ...
        if _expListNode != nil {
            ...
            if varNode != nil{
                varNode_8090 := varNode.(*Nodes_Node)
                varNodeList = NewLnsList([]LnsAny{Nodes_Node2Stem(varNode_8090)})
...
// 6083: decl @lune.@base.@convCC.convFilter.processSetValToNode
...
// 6113: decl @lune.@base.@convCC.convFilter.processDeclVarAndSet
func (self *convCC_convFilter) processDeclVarAndSet(varSymList *LnsList,expListNode LnsAny) {
    for _, __var := range( varSymList.Items ) {
        ...
        if Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( varSymList.GetAt(1).(Ast_LowSymbol).Get_scope() != self.ast.FP.Get_moduleScope()) ||
            Lns_setStackVal( symbolParam.Index == convCC_invalidSymbolId) ).(bool){
            declVarFlag = true
    ...
    if expListNode != nil{
        expListNode_8138 := expListNode.(*Nodes_ExpListNode)
        self.FP.processSetValToSym(&expListNode_8138.Nodes_Node, varSymList, true, expListNode_8138.FP.Get_expList(), nil, expListNode_8138.FP.Get_mRetExp())
    }
}

// 6146: decl @lune.@base.@convCC.convFilter.processIfUnwrap
func (self *convCC_convFilter) ProcessIfUnwrap(node *Nodes_IfUnwrapNode,_opt LnsAny) {
    ...
    convCC_filter_1636_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    self.FP.processBlockPostProcess()
    self.FP.Writeln("}")
    {
        ...
        if __exp != nil {
            ...
            convCC_filter_1636_(&_exp.Nodes_Node, self, &node.Nodes_Node)
            self.FP.Writeln("}")
        }
    }
    self.FP.PopIndent()
...
// 6211: decl @lune.@base.@convCC.convFilter.processDeclVar
func (self *convCC_convFilter) ProcessDeclVar(node *Nodes_DeclVarNode,_opt LnsAny) {
    if _switch27735 := self.processMode; _switch27735 == convCC_ProcessMode__WideScopeVer {
        if node.FP.Get_mode() == Nodes_DeclVarMode__Let{
            var varSymList *LnsList
            varSymList = node.FP.Get_symbolInfoList()
            if Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( varSymList.GetAt(1).(Ast_SymbolInfoDownCast).ToAst_SymbolInfo().FP.Get_scope() == self.moduleTypeInfo.FP.Get_scope()) ||
                Lns_setStackVal( self.outputBuiltinFlag) ).(bool){
                var process func(out2HMode LnsInt,_var *Ast_SymbolInfo)
                process = func(out2HMode LnsInt,_var *Ast_SymbolInfo) {
                    var typeTxt string
                    typeTxt = convCC_convExp27585(Lns_2DDD(self.scopeMgr.FP.GetCTypeForSym(_var.FP)))
                    self.FP.Write(convCC_getOut2HeaderPrefix_1512_(out2HMode))
        ...
        return 
    } else if _switch27735 == convCC_ProcessMode__InitModule || _switch27735 == convCC_ProcessMode__Form {
    } else {
        return 
    }
    ...
    if node.FP.Get_unwrapFlag(){
        ...
        unwrapScope = Lns_unwrap( Lns_NilAccFin(Lns_NilAccPush(node.FP.Get_unwrapBlock()) && 
        Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Nodes_BlockNode).FP.Get_scope()}))).(*Ast_Scope)
        var workSymList *LnsList
        workSymList = NewLnsList([]LnsAny{})
        for _, _varSym := range( varSymList.Items ) {
            ...
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( node.FP.Get_mode() == Nodes_DeclVarMode__Let) &&
                Lns_setStackVal( varSym.FP.Get_scope() != self.moduleTypeInfo.FP.Get_scope()) ).(bool)){
                self.FP.processDeclVarC(true, varSym.FP, false, nil)
            }
        }
        self.FP.Writeln("{")
        ...
        self.FP.processDeclVarAndSet(workSymList, node.FP.Get_expList())
        {
            ...
            if _unwrapBlock != nil {
                ...
                self.FP.Writeln(" ) {")
                self.FP.PushIndent(nil)
                convCC_filter_1636_(&unwrapBlock.Nodes_Node, self, &node.Nodes_Node)
                self.FP.PopIndent()
                {
                    ...
                    if _thenBlock != nil {
                        ...
                        self.FP.PopIndent()
                        convCC_filter_1636_(&thenBlock.Nodes_Node, self, &node.Nodes_Node)
                        self.FP.Writeln("}")
                    } else {
                        self.FP.Writeln("}")
                        self.FP.Writeln("else {")
...
// 6381: decl @lune.@base.@convCC.convFilter.processWhen
func (self *convCC_convFilter) ProcessWhen(node *Nodes_WhenNode,_opt LnsAny) {
    ...
    for _, _symPair := range( node.FP.Get_symPairList().Items ) {
        ...
        srcTypeTxt = convCC_convExp28525(Lns_2DDD(self.scopeMgr.FP.GetCTypeForSym(srcSymbol.FP)))
        var dstTypeTxt string
        dstTypeTxt = convCC_convExp28539(Lns_2DDD(self.scopeMgr.FP.GetCTypeForSym(dstSymbol.FP)))
...
// 6441: decl @lune.@base.@convCC.convFilter.processDeclArg
func (self *convCC_convFilter) ProcessDeclArg(node *Nodes_DeclArgNode,_opt LnsAny) {
    convCC_processDeclAlgeSub_1984_(self.stream.FP, node)
}

// 6467: decl @lune.@base.@convCC.convFilter.processDeclArgDDD
...
// 6473: decl @lune.@base.@convCC.convFilter.processExpDDD
func (self *convCC_convFilter) ProcessExpDDD(node *Nodes_ExpDDDNode,_opt LnsAny) {
}

// 6479: decl @lune.@base.@convCC.convFilter.processExpSubDDD
...
// 6486: decl @lune.@base.@convCC.convFilter.processFuncPrototype
func (self *convCC_convFilter) processFuncPrototype(parent *Nodes_Node,accessMode LnsInt,needFormVal bool,name string,retType string,argList *LnsList,termFlag bool) {
    var process func(out2HMode LnsInt)
    process = func(out2HMode LnsInt) {
        self.FP.Write(Lns_getVM().String_format("%s%s %s( %s _pEnv", []LnsAny{convCC_getOut2HeaderPrefix_1512_(out2HMode), retType, name, convCC_cTypeEnvP}))
        if needFormVal{
        ...
        for _, _arg := range( argList.Items ) {
            arg := _arg.(Nodes_NodeDownCast).ToNodes_Node()
            self.FP.Write(", ")
            convCC_filter_1636_(arg, self, parent)
        }
        self.FP.Write(" )")
        if termFlag{
            self.FP.Writeln(";")
...
// 6522: decl @lune.@base.@convCC.convFilter.processCallUserForm
...
// 6582: decl @lune.@base.@convCC.convFilter.processDeclForm
func (self *convCC_convFilter) ProcessDeclForm(node *Nodes_DeclFormNode,_opt LnsAny) {
    ...
    if _switch29557 := self.processMode; _switch29557 == convCC_ProcessMode__Prototype {
        self.FP.processFuncPrototype(&node.Nodes_Node, formType.FP.Get_accessMode(), true, self.moduleCtrl.FP.GetCallFormName(formType), convCC_getCRetType_1192_(formType.FP.Get_retTypeInfoList()), node.FP.Get_argList(), true)
    } else if _switch29557 == convCC_ProcessMode__Form {
        self.FP.processFuncPrototype(&node.Nodes_Node, formType.FP.Get_accessMode(), true, self.moduleCtrl.FP.GetCallFormName(formType), convCC_getCRetType_1192_(formType.FP.Get_retTypeInfoList()), node.FP.Get_argList(), false)
        self.FP.Writeln("{")
        self.FP.PushIndent(nil)
...
// 6692: decl @lune.@base.@convCC.convFilter.processClosureFunc
func (self *convCC_convFilter) processClosureFunc(declInfo *Nodes_DeclFuncInfo) {
    var simpleName *Parser_Token
    
    {
        ...
        if _simpleName == nil{
            ...
            simpleName = _simpleName.(*Parser_Token)
        }
    }
    var scope *Ast_Scope
    
    {
        _scope := Lns_NilAccFin(Lns_NilAccPush(declInfo.FP.Get_body()) && 
        Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Nodes_BlockNode).FP.Get_scope()}))
        if _scope == nil{
            return 
        } else {
            scope = _scope.(*Ast_Scope)
    ...
    self.FP.Write(Lns_getVM().String_format("lns_initVal_var( %s, %s, %d, ", []LnsAny{symbolName, convCC_getBlockName_1195_(scope.FP.Get_parent()), symbolParam.Index}))
    self.FP.Writeln(Lns_getVM().String_format("LNS_STEM_ANY( %s ) );", []LnsAny{convCC_getFunc2any_1888_(self.moduleCtrl, self.scopeMgr, funcSym.FP.Get_typeInfo())}))
}

// 6715: decl @lune.@base.@convCC.convFilter.processDeclFunc
func (self *convCC_convFilter) ProcessDeclFunc(node *Nodes_DeclFuncNode,_opt LnsAny) {
    ...
    processFuncPrototype = func(termFlag bool) {
        self.FP.processFuncPrototype(&node.Nodes_Node, declInfo.FP.Get_accessMode(), convCC_isClosure_1011_(node.FP.Get_expType()), name, convCC_getCRetType_1192_(node.FP.Get_expType().FP.Get_retTypeInfoList()), declInfo.FP.Get_argList(), termFlag)
    }
    if _switch29850 := self.processMode; _switch29850 == convCC_ProcessMode__Form {
    } else if _switch29850 == convCC_ProcessMode__Prototype {
        processFuncPrototype(true)
        return 
    } else if _switch29850 == convCC_ProcessMode__InitFuncSym || _switch29850 == convCC_ProcessMode__WideScopeVer {
        ...
        if _switch29847 := opt.Node.FP.Get_kind(); _switch29847 == Nodes_NodeKind_get_Block() || _switch29847 == Nodes_NodeKind_get_ExpMacroExp() {
        } else {
            self.FP.Write(convCC_getFunc2any_1888_(self.moduleCtrl, self.scopeMgr, node.FP.Get_expType()))
        }
        return 
    }
    ...
    convCC_filter_1636_(&body.Nodes_Node, self, &node.Nodes_Node)
    self.FP.popRoutine()
    breakKind = body.FP.GetBreakKind(Nodes_CheckBreakMode__Normal)
    
    if _switch30008 := breakKind; _switch30008 == Nodes_BreakKind__Return || _switch30008 == Nodes_BreakKind__NeverRet {
    } else {
    }
    self.FP.Writeln("}")
    var expType *Ast_TypeInfo
...
// 6812: decl @lune.@base.@convCC.convFilter.processRefType
func (self *convCC_convFilter) ProcessRefType(node *Nodes_RefTypeNode,_opt LnsAny) {
}

// 6826: decl @lune.@base.@convCC.convFilter.processIf
func (self *convCC_convFilter) ProcessIf(node *Nodes_IfNode,_opt LnsAny) {
    ...
    for _index, _val := range( valList.Items ) {
        ...
        self.FP.Write(" ")
        convCC_filter_1636_(&val.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
        self.FP.Write("}")
    }
}

// 6853: decl @lune.@base.@convCC.convFilter.processEquals
func (self *convCC_convFilter) processEquals(eqFlag bool,type1 *Ast_TypeInfo,type2 *Ast_TypeInfo,process1 convCC_ProcessToValForm_2532_,process2 convCC_ProcessToValForm_2532_) {
    var valKind1 LnsInt
    valKind1 = convCC_getValKind_1164_(type1)
    var valKind2 LnsInt
    valKind2 = convCC_getValKind_1164_(type2)
    if Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( valKind1 == convCC_ValKind__Stem) ||
        Lns_setStackVal( valKind2 == convCC_ValKind__Stem) ).(bool){
        ...
        Lns_setStackVal( valKind1 == convCC_ValKind__Any) &&
        Lns_setStackVal( valKind2 == convCC_ValKind__Any) ).(bool)){
        if Lns_op_not(eqFlag){
            self.FP.Write("!")
        }
        ...
        Lns_setStackVal( valKind1 == convCC_ValKind__Prim) &&
        Lns_setStackVal( valKind2 == convCC_ValKind__Prim) ).(bool)){
...
// 6896: decl @lune.@base.@convCC.convFilter.processSwitch
func (self *convCC_convFilter) ProcessSwitch(node *Nodes_SwitchNode,_opt LnsAny) {
    ...
    self.FP.Write(Lns_getVM().String_format("%s %s = ", []LnsAny{convCC_getCType_1185_(expType), expSymName}))
    convCC_filter_1636_(node.FP.Get_exp(), self, &node.Nodes_Node)
    self.FP.Writeln(";")
    var expValKind LnsInt
    ...
    if expValKind != convCC_ValKind__Stem{
        ...
        convCC_process2stem_2050_(self.stream.FP, self.moduleCtrl, self.scopeMgr, expValKind, expType, &node.Nodes_Node, convCC_process2stemCallback_2047_(func() {
    ...
    for _index, _caseInfo := range( node.FP.Get_caseList().Items ) {
        ...
        for _listIndex, _expNode := range( expList.FP.Get_expList().Items ) {
            ...
            self.FP.processEquals(true, expType, expNode.FP.Get_expType(), convCC_ProcessToValForm_2532_(func(valKind LnsInt) {
                if valKind == convCC_ValKind__Stem{
                    self.FP.Write(expStemName)
                } else { 
                    self.FP.Write(expSymName)
                }
            }), convCC_ProcessToValForm_2532_(func(valKind LnsInt) {
                if _switch30793 := valKind; _switch30793 == convCC_ValKind__Stem {
                    self.FP.ProcessVal2stem(expNode, &node.Nodes_Node)
                } else if _switch30793 == convCC_ValKind__Any {
                    self.FP.ProcessVal2any(expNode, &node.Nodes_Node)
                } else if _switch30793 == convCC_ValKind__Prim {
                    self.FP.AccessPrimVal(expNode, &node.Nodes_Node)
                }
            }))
        }
        self.FP.Writeln(" ) {")
        convCC_filter_1636_(&caseInfo.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
    }
    {
...
// 6983: decl @lune.@base.@convCC.convFilter.processMatch
func (self *convCC_convFilter) ProcessMatch(node *Nodes_MatchNode,_opt LnsAny) {
    ...
    convCC_filter_1636_(node.FP.Get_val(), self, &node.Nodes_Node)
    self.FP.Write(convCC_accessAny)
    self.FP.Writeln(";")
    ...
    for _, _caseInfo := range( node.FP.Get_caseList().Items ) {
        ...
        if valInfo.FP.Get_typeList().Len() > 0{
            ...
            for _paramIndex, _paramType := range( valInfo.FP.Get_typeList().Items ) {
                ...
                self.FP.Writeln(Lns_getVM().String_format("%s %s = _pVal->_val%d;", []LnsAny{convCC_getCType_1185_(paramType), paramName.FP.Get_name(), paramIndex}))
            }
        }
        self.FP.PopIndent()
        convCC_filter_1636_(&caseInfo.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
...
// 7059: decl @lune.@base.@convCC.convFilter.processWhile
...
// 7087: decl @lune.@base.@convCC.convFilter.processRepeat
...
// 7118: decl @lune.@base.@convCC.convFilter.processFor
...
// 7162: decl @lune.@base.@convCC.convFilter.processCreateDDD
...
// 7176: decl @lune.@base.@convCC.convFilter.processApply
func (self *convCC_convFilter) ProcessApply(node *Nodes_ApplyNode,_opt LnsAny) {
    ...
    for _index, _varSym := range( node.FP.Get_varList().Items ) {
        ...
        } else if _switch32630 == convCC_ValKind__Prim {
            self.FP.Writeln(Lns_getVM().String_format("%s = lns_fromDDD( %s, %d )%s", []LnsAny{varName, workSymName, index - 1, convCC_getAccessValFromStem_1845_(varSym.FP.Get_typeInfo())}))
        } else {
            Util_err(Lns_getVM().String_format("no support -- %s:%s:%d", []LnsAny{varSym.FP.Get_name(), convCC_ValKind_getTxt( valKind), 7274}))
        }
    }
    convCC_filter_1636_(&node.FP.Get_block().Nodes_Node, self, &node.Nodes_Node)
...
// 7319: decl @lune.@base.@convCC.convFilter.processForeachSetupVal
...
// 7349: decl @lune.@base.@convCC.convFilter.processPoolForeachSetupVal
...
// 7378: decl @lune.@base.@convCC.convFilter.processMapForeachSetupVal
func (self *convCC_convFilter) processMapForeachSetupVal(parent *Nodes_Node,loopType *Ast_TypeInfo,scope *Ast_Scope,keyToken LnsAny,valToken LnsAny,keyTxt string,valTxt string) {
    if keyToken != nil{
        keyToken_8607 := keyToken.(*Ast_SymbolInfo)
        self.FP.processForeachSetupVal(parent, scope, keyTxt, keyToken_8607.FP.Get_name(), loopType.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo())
    }
    self.FP.Writeln("")
    if valToken != nil{
        valToken_8609 := valToken.(*Ast_SymbolInfo)
        self.FP.processForeachSetupVal(parent, scope, valTxt, valToken_8609.FP.Get_name(), loopType.FP.Get_itemTypeInfoList().GetAt(2).(Ast_TypeInfoDownCast).ToAst_TypeInfo())
    }
}

// 7440: decl @lune.@base.@convCC.convFilter.processForeach
func (self *convCC_convFilter) ProcessForeach(node *Nodes_ForeachNode,_opt LnsAny) {
    ...
    collectionKind = convCC_getCollectionKind_2610_(loopType)
    if _switch33534 := loopType.FP.Get_kind(); _switch33534 == Ast_TypeInfoKind__List || _switch33534 == Ast_TypeInfoKind__Array {
    ...
    } else if _switch33534 == Ast_TypeInfoKind__Ext {
        indexSymbol = nil
    ...
    self.FP.Writeln("lns_reset_block( _pEnv );")
    if indexSymbol != nil{
        indexSymbol_8667 := indexSymbol.(*Ast_SymbolInfo)
        if self.scopeMgr.FP.GetSymbolValKind(indexSymbol_8667.FP) != convCC_ValKind__Prim{
            self.FP.Writeln(Lns_getVM().String_format("_%s++;", []LnsAny{self.moduleCtrl.FP.GetSymbolName(indexSymbol_8667.FP)}))
            self.FP.processDeclVarC(true, indexSymbol_8667.FP, true, nil)
            self.FP.processSetValSingleDirect(&node.Nodes_Node, nil, indexSymbol_8667.FP, true, convCC_ValKind__Prim, Ast_builtinTypeInt, 0, false, convCC_processRValue_2289_(func() {
                self.FP.Write(Lns_getVM().String_format("_%s", []LnsAny{self.moduleCtrl.FP.GetSymbolName(indexSymbol_8667.FP)}))
            }))
            self.FP.Writeln("")
        } else { 
            self.FP.Writeln(Lns_getVM().String_format("%s++;", []LnsAny{self.moduleCtrl.FP.GetSymbolName(indexSymbol_8667.FP)}))
        }
    }
    if _switch33898 := loopType.FP.Get_kind(); _switch33898 == Ast_TypeInfoKind__List || _switch33898 == Ast_TypeInfoKind__Set || _switch33898 == Ast_TypeInfoKind__Array {
    ...
    } else if _switch33898 == Ast_TypeInfoKind__Map {
        ...
        switch _exp33896 := collectionKind.(type) {
        case *convCC_CollectionKind__ExtMap:
        extedType := _exp33896.Val1
...
// 7582: decl @lune.@base.@convCC.convFilter.processForsort
func (self *convCC_convFilter) ProcessForsort(node *Nodes_ForsortNode,_opt LnsAny) {
    ...
    var loopType *Ast_TypeInfo
    loopType = node.FP.Get_exp().FP.Get_expType()
    if _switch34160 := loopType.FP.Get_kind(); _switch34160 == Ast_TypeInfoKind__Set {
        ...
        self.FP.Writeln(Lns_getVM().String_format("%s _val;", []LnsAny{convCC_cTypeStem}))
    } else if _switch34160 == Ast_TypeInfoKind__Map {
    ...
    self.FP.processLoopPreProcess(node.FP.Get_block())
    if _switch34214 := loopType.FP.Get_kind(); _switch34214 == Ast_TypeInfoKind__Set {
        self.FP.Writeln("for ( ; lns_itList_hasNext( _pEnv, _itAny, &_val );")
        self.FP.Writeln("      lns_itList_inc( _pEnv, _itAny ) )")
    } else if _switch34214 == Ast_TypeInfoKind__Map {
        self.FP.Writeln("for ( ; lns_itList_hasNext( _pEnv, _itAny, &_key );")
        self.FP.Writeln("      lns_itList_inc( _pEnv, _itAny ) )")
    }
    self.FP.Writeln("{")
    self.FP.Writeln("lns_reset_block( _pEnv );")
    if _switch34293 := loopType.FP.Get_kind(); _switch34293 == Ast_TypeInfoKind__Set {
        self.FP.processPoolForeachSetupVal(&node.Nodes_Node, loopType, node.FP.Get_block().FP.Get_scope(), node.FP.Get_key(), node.FP.Get_val())
    } else if _switch34293 == Ast_TypeInfoKind__Map {
...
// 7655: decl @lune.@base.@convCC.convFilter.processExpUnwrap
func (self *convCC_convFilter) ProcessExpUnwrap(node *Nodes_ExpUnwrapNode,_opt LnsAny) {
    ...
    if _switch34622 := convCC_getOrgTypeInfo_1424_(node.FP.Get_expType()); _switch34622 == Ast_builtinTypeInt || _switch34622 == Ast_builtinTypeChar {
        processUnwrap("int")
    } else if _switch34622 == Ast_builtinTypeReal {
        processUnwrap("real")
    } else if _switch34622 == Ast_builtinTypeBool {
        processUnwrap("bool")
    } else {
        if _switch34557 := self.FP.getValKindOfNode(&node.Nodes_Node); _switch34557 == convCC_ValKind__Stem {
            self.FP.Write("lns_unwrap_stem( ")
        } else if _switch34557 == convCC_ValKind__Any {
            self.FP.Write("lns_unwrap_any( ")
        } else {
            Util_err(Lns_getVM().String_format("no support -- %s: %d", []LnsAny{convCC_ValKind_getTxt( self.FP.getValKindOfNode(&node.Nodes_Node)), 7695}))
        }
        self.FP.ProcessVal2stem(node.FP.Get_exp(), &node.Nodes_Node)
        {
            _defVal := node.FP.Get_default()
...
// 7726: decl @lune.@base.@convCC.convFilter.processCreateMRet
func (self *convCC_convFilter) processCreateMRet(retTypeList *LnsList,expList *LnsList,parent *Nodes_Node) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node().FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__DDD) &&
        Lns_setStackVal( expList.Len() == 1) ).(bool)){
        self.FP.Write("_pDDD")
        return 
    }
...
// 7810: decl @lune.@base.@convCC.convFilter.processCallWithMRet
func (self *convCC_convFilter) ProcessCallWithMRet(parent *Nodes_Node,mRetFuncName string,retTypeName string,mRetInfo LnsAny,argList *Nodes_ExpListNode) {
    ...
    switch _exp34955 := mRetInfo.(type) {
    case *convCC_MRetInfo__Method:
    funcType := _exp34955.Val1
        if Lns_op_not(convCC_needMRetWrap_2645_(funcType.FP.Get_argTypeInfoList(), argList)){
            return 
        }
    case *convCC_MRetInfo__Form:
        if Lns_op_not(convCC_needMRetWrap_2645_(NewLnsList([]LnsAny{Ast_TypeInfo2Stem(Ast_builtinTypeDDD)}), argList)){
            return 
        }
    ...
    funcNode := _exp34955.Val1
        if Lns_op_not(convCC_needMRetWrap_2645_(funcNode.FP.Get_expType().FP.Get_argTypeInfoList(), argList)){
            return 
        }
    ...
    processDeclMRetProto = func() {
        ...
        processArgs = func() {
            for _index, _argNode := range( argList.FP.Get_expList().Items ) {
                ...
                self.FP.Write(Lns_getVM().String_format(", %s arg%d", []LnsAny{convCC_getCType_1185_(argType), index}))
            }
    ...
    if _switch36283 := self.processMode; _switch36283 == convCC_ProcessMode__Intermediate || _switch36283 == convCC_ProcessMode__StringFormat {
        ...
        processSetArg = func(primFlag bool) {
            for _index, _argNode := range( argList.FP.Get_expList().Items ) {
                ...
                if index >= mRetExp.FP.Get_index(){
                    if _switch35538 := argNode.FP.Get_kind(); _switch35538 == Nodes_NodeKind_get_ExpToDDD() {
                    ...
                    } else if _switch35538 == Nodes_NodeKind_get_ExpSubDDD() {
                        self.FP.Write(Lns_getVM().String_format("%s arg%d = ", []LnsAny{convCC_cTypeStem, index}))
                        convCC_filter_1636_(argNode, self, parent)
                    } else {
                        {
                        ...
                        var typeTxt string
                        if primFlag{
                            typeTxt = convCC_getCType_1185_(argType)
                        ...
                        if primFlag{
                            self.FP.Write(convCC_getAccessValFromStem_1845_(argType))
                        } else { 
        ...
        processArg2Stem = func(index LnsInt,typeInfo *Ast_TypeInfo) {
            if argTypeList.Len() >= index{
                if _switch35752 := argTypeList.GetAt(index).(Ast_TypeInfoDownCast).ToAst_TypeInfo(); _switch35752 == Ast_builtinTypeInt || _switch35752 == Ast_builtinTypeChar {
                    self.FP.Write("LNS_STEM_INT(")
                    self.FP.Write(Lns_getVM().String_format("arg%d )", []LnsAny{index}))
                } else if _switch35752 == Ast_builtinTypeReal {
                    self.FP.Write("LNS_STEM_REAL(")
                    self.FP.Write(Lns_getVM().String_format("arg%d )", []LnsAny{index}))
                } else if _switch35752 == Ast_builtinTypeBool {
                    self.FP.Write("LNS_STEM_BOOL(")
                    self.FP.Write(Lns_getVM().String_format("arg%d )", []LnsAny{index}))
                } else {
                    if convCC_getValKind_1164_(argTypeList.GetAt(index).(Ast_TypeInfoDownCast).ToAst_TypeInfo()) == convCC_ValKind__Any{
                        self.FP.Write("LNS_STEM_ANY(")
                        self.FP.Write(Lns_getVM().String_format("arg%d )", []LnsAny{index}))
                    } else { 
                        self.FP.Write(Lns_getVM().String_format("arg%d", []LnsAny{index}))
        ...
        processCreateDDD = func(expList *LnsList) {
            ...
            self.FP.Write(Lns_getVM().String_format("( _pEnv, %s, %d", []LnsAny{Nodes_hasMultiValNode(lastExp), expList.Len()}))
            {
                var _from35907 LnsInt = 1
                var _to35907 LnsInt = expList.Len()
                for _work35907 := _from35907; _work35907 <= _to35907; _work35907++ {
                    index := _work35907
                    self.FP.Write(", ")
        ...
        funcTypeInfo = nil
        switch _exp36179 := mRetInfo.(type) {
        case *convCC_MRetInfo__Method:
        funcType := _exp36179.Val1
        ...
        funcNode := _exp36179.Val1
            ...
            if Lns_op_not(wroteFuncFlag){
                convCC_filter_1636_(funcNode, self, parent)
                self.FP.Write("(")
            }
            self.FP.Write(" _pEnv")
        case *convCC_MRetInfo__DDD:
        expListNode := _exp36179.Val1
            processSetArg(true)
            processCreateDDD(expListNode.FP.Get_expList())
        case *convCC_MRetInfo__Format:
        format := _exp36179.Val1
        expListNode := _exp36179.Val2
            processSetArg(true)
            self.FP.Write("mtd_lns_string_format( _pEnv, ")
            self.FP.Write(convCC_getLiteralStrAny_1491_(format))
            self.FP.Write(", ")
            processCreateDDD(expListNode.FP.Get_expList())
            self.FP.Write(")")
        }
        if funcTypeInfo != nil{
            funcTypeInfo_8882 := funcTypeInfo.(*Ast_TypeInfo)
            for _index, _argType := range( funcTypeInfo_8882.FP.Get_argTypeInfoList().Items ) {
                index := _index + 1
                argType := _argType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                if convCC_getValKind_1164_(argType) == convCC_ValKind__Stem{
                    self.FP.Write(", ")
        ...
        self.FP.Writeln(");")
        self.FP.Writeln("}")
    } else if _switch36283 == convCC_ProcessMode__Prototype {
        processDeclMRetProto()
        self.FP.Writeln(Lns_getVM().String_format("; // %d", []LnsAny{argList.FP.Get_pos().LineNo}))
    }
}

// 8115: decl @lune.@base.@convCC.convFilter.processExpToDDD
func (self *convCC_convFilter) ProcessExpToDDD(node *Nodes_ExpToDDDNode,_opt LnsAny) {
    if _switch36370 := self.processMode; _switch36370 == convCC_ProcessMode__Intermediate || _switch36370 == convCC_ProcessMode__Prototype {
        {
            _mRetExp := node.FP.Get_expList().FP.Get_mRetExp()
            if _mRetExp != nil {
                mRetExp := _mRetExp.(*Nodes_MRetExp)
                if mRetExp.FP.Get_index() > 0{
                    self.FP.ProcessCallWithMRet(&node.Nodes_Node, convCC_getMRetFuncName_2686_(&node.Nodes_Node), convCC_cTypeStem, &convCC_MRetInfo__DDD{node.FP.Get_expList()}, node.FP.Get_expList())
                }
            }
        }
        return 
    ...
    expList = node.FP.Get_expList().FP.Get_expList()
    {
        ...
        if _mRetExp != nil {
            mRetExp := _mRetExp.(*Nodes_MRetExp)
            self.FP.Write(Lns_getVM().String_format("%s( _pEnv", []LnsAny{convCC_getMRetFuncName_2686_(&node.Nodes_Node)}))
            for _index, _exp := range( expList.Items ) {
                index := _index + 1
                exp := _exp.(Nodes_NodeDownCast).ToNodes_Node()
                if index > mRetExp.FP.Get_index(){
                ...
                self.FP.Write(", ")
                convCC_filter_1636_(exp, self, &node.Nodes_Node)
            }
            self.FP.Write(")")
        } else {
            self.FP.processCreateDDD(&node.Nodes_Node, expList)
...
// 8152: decl @lune.@base.@convCC.convFilter.processExpNew
...
// 8166: decl @lune.@base.@convCC.convFilter.processCall
func (self *convCC_convFilter) processCall(funcSym LnsAny,funcType *Ast_TypeInfo,setArgFlag bool,argList LnsAny) {
        ...
        self.FP.Write("_pEnv")
        {
            ...
            if _scope != nil {
                ...
                if scope.FP.Get_closureSymList().Len() > 0{
                    ...
                    setFlag = false
                    if funcSym != nil{
                        funcSym_8935 := funcSym.(*Ast_SymbolInfo)
                        if funcSym_8935.FP.Get_hasAccessFromClosure(){
                            self.FP.ProcessSym2Any(funcSym_8935.FP)
                            setFlag = true
                            
                        }
                    }
                    if Lns_op_not(setFlag){
                        self.FP.Write(convCC_getPrepareClosure_1885_(self.scopeMgr, "NULL", 0, false, scope.FP.Get_closureSymList()))
                    }
                }
            }
        }
    ...
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        Lns_setStackVal( funcType.FP.Get_rawTxt() == "___init") &&
        Lns_setStackVal( funcType.FP.Get_parentInfo().FP.Get_kind() == Ast_TypeInfoKind__Class) ).(bool)){
        self.FP.Write(Lns_getVM().String_format(", %s", []LnsAny{convCC_getBlockName_1195_(self.ast.FP.Get_moduleScope())}))
    } else { 
        if argList != nil{
            argList_8941 := argList.(*Nodes_ExpListNode)
            var expList *LnsList
            expList = NewLnsList([]LnsAny{})
            for _, _expNode := range( argList_8941.FP.Get_expList().Items ) {
                expNode := _expNode.(Nodes_NodeDownCast).ToNodes_Node()
                if expNode.FP.Get_expType().FP.Get_kind() != Ast_TypeInfoKind__Abbr{
                    expList.Insert(Nodes_Node2Stem(expNode))
                }
            }
            self.FP.ProcessCallArgList(funcType, argList_8941)
        } else {
...
// 8217: decl @lune.@base.@convCC.convFilter.processDeclClass
func (self *convCC_convFilter) ProcessDeclClass(node *Nodes_DeclClassNode,_opt LnsAny) {
    ...
    if _switch36988 := self.processMode; _switch36988 == convCC_ProcessMode__Prototype {
        self.FP.processDeclClassNodePrototype(node)
    } else if _switch36988 == convCC_ProcessMode__WideScopeVer {
        if _switch36882 := classType.FP.Get_kind(); _switch36882 == Ast_TypeInfoKind__Class {
            convCC_processIFMethodDataInit_2184_(self.stream.FP, self.moduleCtrl, classType, classType)
            convCC_processClassDataInit_2194_(self.stream.FP, self.moduleCtrl, self.scopeMgr, classType, node.FP.Get_fieldList())
        } else if _switch36882 == Ast_TypeInfoKind__IF {
            convCC_processClassMeta_2187_(self.stream.FP, self.moduleCtrl, classType)
        }
    } else if _switch36988 == convCC_ProcessMode__DefClass {
        if classType.FP.Get_kind() == Ast_TypeInfoKind__Class{
            self.FP.processDeclClassDef(node)
            self.FP.processMapping(node, classType, Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( Ast_isPubToExternal(classType.FP.Get_accessMode())) &&
                Lns_setStackVal( convCC_Out2HMode__SourcePub) ||
                Lns_setStackVal( convCC_Out2HMode__SourcePri) ).(LnsInt))
        }
    } else if _switch36988 == convCC_ProcessMode__Form || _switch36988 == convCC_ProcessMode__InitModule {
        {
...
// 8586: decl @lune.@base.@convCC.convFilter.processExpCallDefWrap
func (self *convCC_convFilter) processExpCallDefWrap(node *Nodes_ExpCallNode,opt *ConvCC_Opt) {
    ...
    var retCode string
    var retType string
    if convCC_getCRetType_1192_(funcType.FP.Get_retTypeInfoList()) == "void"{
        retType = "void"
    ...
    var argNameList *LnsList
    argNameList = NewLnsList([]LnsAny{})
    self.FP.Write(Lns_getVM().String_format("static %s %s( %s * _pEnv, %s form", []LnsAny{retType, convCC_getFormNilWrapper_2707_(&node.Nodes_Node), convCC_cTypeEnvP, convCC_cTypeStem}))
    for _index, _argType := range( funcType.FP.Get_argTypeInfoList().Items ) {
        index := _index + 1
        argType := _argType.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
        var name string
        name = Lns_getVM().String_format("arg%d", []LnsAny{index})
        self.FP.Write(Lns_getVM().String_format(", %s %s", []LnsAny{convCC_getCType_1185_(argType), name}))
...
// 8636: decl @lune.@base.@convCC.convFilter.processExpCall
func (self *convCC_convFilter) ProcessExpCall(node *Nodes_ExpCallNode,_opt LnsAny) {
    opt := _opt.(*ConvCC_Opt)
    var funcType *Ast_TypeInfo
    funcType = node.FP.Get_func().FP.Get_expType().FP.Get_nonnilableType()
    if _switch37417 := self.processMode; _switch37417 == convCC_ProcessMode__Intermediate || _switch37417 == convCC_ProcessMode__Prototype {
        {
            ...
            if _argList != nil {
                ...
                var mRetInfo LnsAny
                if _switch37367 := funcNode.FP.Get_expType().FP.Get_kind(); _switch37367 == Ast_TypeInfoKind__Method {
                    mRetInfo = &convCC_MRetInfo__Method{funcType}
                    
                } else if _switch37367 == Ast_TypeInfoKind__Form {
                    mRetInfo = convCC_MRetInfo__Form_Obj
                    
                } else if _switch37367 == Ast_TypeInfoKind__FormFunc {
                ...
                self.FP.ProcessCallWithMRet(&node.Nodes_Node, convCC_getMRetFuncName_2686_(&node.Nodes_Node), convCC_getCRetType_1192_(node.FP.Get_expTypeList()), mRetInfo, argList)
            }
        }
        return 
    } else if _switch37417 == convCC_ProcessMode__DefWrap {
    ...
    process = func() {
        ...
        fieldCall = func() bool {
            ...
            if node.FP.Get_nilAccess(){
                ...
                if _switch37616 := prefixType.FP.Get_kind(); _switch37616 == Ast_TypeInfoKind__Enum || _switch37616 == Ast_TypeInfoKind__Alge {
                    convFilter_processExpCall_process_fieldCall__processEnumAlge_2728_()
                } else if _switch37616 == Ast_TypeInfoKind__Class {
                    if prefixType.FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil){
                        ...
                        convCC_filter_1636_(prefixNode, self, &fieldNode.Nodes_Node)
                    }
                }
            }
            return true
        ...
        if Lns_op_not(wroteFuncFlag){
            if _switch37980 := funcType.FP.Get_kind(); _switch37980 == Ast_TypeInfoKind__Method {
                {
                    _fieldNode := Nodes_RefFieldNodeDownCastF(node.FP.Get_func().FP)
                    if _fieldNode != nil {
                        fieldNode := _fieldNode.(*Nodes_RefFieldNode)
            ...
            } else if _switch37980 == Ast_TypeInfoKind__Func {
                self.FP.Write(Lns_getVM().String_format("%s( ", []LnsAny{self.moduleCtrl.FP.GetFuncName(funcType)}))
                wroteFuncFlag = true
                
            } else if _switch37980 == Ast_TypeInfoKind__FormFunc {
                if node.FP.Get_nilAccess(){
                    self.FP.Write(Lns_getVM().String_format("%s( _pEnv, ", []LnsAny{convCC_getFormNilWrapper_2707_(&node.Nodes_Node)}))
                } else { 
        ...
        if Lns_op_not(wroteFuncFlag){
            convCC_filter_1636_(node.FP.Get_func(), self, &node.Nodes_Node)
            self.FP.Write("( ")
        }
    ...
    call = func() {
        ...
        isMret = false
        {
            ...
            if _argList != nil {
                argList := _argList.(*Nodes_ExpListNode)
                {
                    ...
                    if _mRetExp != nil {
                        mRetExp := _mRetExp.(*Nodes_MRetExp)
                        if convCC_needMRetWrap_2645_(node.FP.Get_func().FP.Get_expType().FP.Get_argTypeInfoList(), argList){
                            isMret = true
                            
                            self.FP.Write(Lns_getVM().String_format("%s( _pEnv", []LnsAny{convCC_getMRetFuncName_2686_(&node.Nodes_Node)}))
                            var funcNode *Nodes_Node
                            funcNode = node.FP.Get_func()
                            if _switch38156 := funcNode.FP.Get_expType().FP.Get_kind(); _switch38156 == Ast_TypeInfoKind__Method {
                                {
                                    _fieldNode := Nodes_RefFieldNodeDownCastF(node.FP.Get_func().FP)
                                    if _fieldNode != nil {
                                        fieldNode := _fieldNode.(*Nodes_RefFieldNode)
                            ...
                            } else if _switch38156 == Ast_TypeInfoKind__Form || _switch38156 == Ast_TypeInfoKind__FormFunc {
                                self.FP.Write(", ")
                                self.FP.ProcessVal2any(node.FP.Get_func(), &node.Nodes_Node)
                            }
                            for _index, _argNode := range( argList.FP.Get_expList().Items ) {
                                ...
                                if index <= mRetExp.FP.Get_index(){
                                    self.FP.Write(", ")
                                    convCC_filter_1636_(argNode, self, &argList.Nodes_Node)
                                }
                            }
                            self.FP.Write(")")
                        }
        ...
        convCC_processAlterAccessVal_2347_(self.stream.FP, funcType.FP.Get_retTypeInfoList(), node.FP.Get_expTypeList())
    }
    var retTypeInfoList *LnsList
    retTypeInfoList = funcType.FP.Get_retTypeInfoList()
    if retTypeInfoList.Len() == 1{
        convCC_processAlterToActualType_2350_(self.stream.FP, self.moduleCtrl, retTypeInfoList.GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), node.FP.Get_expType(), convCC_processExp_1872_(call))
    } else { 
        call()
    }
}

// 9027: decl @lune.@base.@convCC.convFilter.processExpAccessMRet
func (self *convCC_convFilter) ProcessExpAccessMRet(node *Nodes_ExpAccessMRetNode,_opt LnsAny) {
    convCC_processGetMRet_2304_(self.stream.FP, self.moduleCtrl, node.FP.Get_expType(), node.FP.Get_index() - 1)
}

// 9035: decl @lune.@base.@convCC.convFilter.processExpList
...
// 9089: decl @lune.@base.@convCC.convFilter.processExpMultiTo1
func (self *convCC_convFilter) ProcessExpMultiTo1(node *Nodes_ExpMultiTo1Node,_opt LnsAny) {
    ...
    self.FP.Write(", 0 )")
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( node.FP.Get_exp().FP.Get_expType().FP.Get_kind() == Ast_TypeInfoKind__DDD) &&
        Lns_setStackVal( Ast_isNumberType(node.FP.Get_expType().FP.Get_srcTypeInfo().FP.Get_nonnilableType())) ).(bool)){
    } else { 
        self.FP.Write(convCC_getAccessValFromStem_1845_(node.FP.Get_exp().FP.Get_expType()))
    }
}

// 9108: decl @lune.@base.@convCC.convFilter.processStme2Val
func (self *convCC_convFilter) processStme2Val(dstType *Ast_TypeInfo,srcStemTxt string) {
    if _switch38789 := dstType; _switch38789 == Ast_builtinTypeInt || _switch38789 == Ast_builtinTypeChar {
        self.FP.Write("lns_stem2int( ")
        self.FP.Write(srcStemTxt)
        self.FP.Write(")")
    } else if _switch38789 == Ast_builtinTypeReal {
        self.FP.Write("lns_stem2real( ")
        self.FP.Write(srcStemTxt)
        self.FP.Write(")")
    } else if _switch38789 == Ast_builtinTypeBool {
        self.FP.Write("lns_stem2bool( ")
        self.FP.Write(srcStemTxt)
        self.FP.Write(")")
    } else {
        self.FP.Write(srcStemTxt)
        if convCC_getValKind_1164_(dstType) == convCC_ValKind__Any{
            self.FP.Write(convCC_accessAny)
        }
    }
}

// 9135: decl @lune.@base.@convCC.convFilter.processFuncCast
func (self *convCC_convFilter) processFuncCast(node *Nodes_ExpCastNode) {
    var castType *Ast_TypeInfo
    castType = node.FP.Get_castType()
    if _switch38817 := castType.FP.Get_kind(); _switch38817 == Ast_TypeInfoKind__Func || _switch38817 == Ast_TypeInfoKind__Form || _switch38817 == Ast_TypeInfoKind__FormFunc {
    } else {
        return 
    }
    ...
    closureSymList = Lns_unwrapDefault( Lns_NilAccFin(Lns_NilAccPush(orgFunc.FP.Get_scope()) && 
    Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_Scope).FP.Get_closureSymList()})), NewLnsList([]LnsAny{})).(*LnsList)
    if _switch38872 := orgFunc.FP.Get_nonnilableType().FP.Get_kind(); _switch38872 == Ast_TypeInfoKind__Func || _switch38872 == Ast_TypeInfoKind__Form || _switch38872 == Ast_TypeInfoKind__FormFunc {
    } else if _switch38872 == Ast_TypeInfoKind__Stem {
        return 
    } else {
        Util_err(Lns_getVM().String_format("illegal kind -- %s, %d", []LnsAny{Ast_TypeInfoKind_getTxt( orgFunc.FP.Get_nonnilableType().FP.Get_kind()), 9159}))
    }
    if Lns_op_not(self.FP.needsWrapper(orgFunc, castType)){
        return 
    }
    self.FP.Write(Lns_getVM().String_format("static %s %s( %s _pEnv", []LnsAny{convCC_getCRetType_1192_(castType.FP.Get_retTypeInfoList()), self.moduleCtrl.FP.GetFuncCastWrapName(orgFunc, castType), convCC_cTypeEnvP}))
    ...
    for _index, _typeInfo := range( orgFunc.FP.Get_argTypeInfoList().Items ) {
        index := _index + 1
        typeInfo := _typeInfo.(Ast_TypeInfoDownCast).ToAst_TypeInfo()
        self.FP.Write(Lns_getVM().String_format("%s var%d = ", []LnsAny{convCC_getCType_1185_(typeInfo), index}))
        var dstType *Ast_TypeInfo
        ...
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( index == castType.FP.Get_argTypeInfoList().Len()) &&
            Lns_setStackVal( (Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( orgFunc.FP.Get_argTypeInfoList().Len() != castType.FP.Get_argTypeInfoList().Len()) ||
                Lns_setStackVal( Lns_op_not(dstType.FP.Equals(self.processInfo, srcType, nil, nil))) ).(bool))) ).(bool)){
            if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
                Lns_setStackVal( srcType.FP.Get_kind() == Ast_TypeInfoKind__DDD) &&
                ...
                self.FP.Writeln(";")
                {
                    var _from39271 LnsInt = index + 1
                    var _to39271 LnsInt = orgFunc.FP.Get_argTypeInfoList().Len()
                    for _work39271 := _from39271; _work39271 <= _to39271; _work39271++ {
                        subIndex := _work39271
                        var dstTypeSub *Ast_TypeInfo
                        dstTypeSub = orgFunc.FP.Get_argTypeInfoList().GetAt(subIndex).(Ast_TypeInfoDownCast).ToAst_TypeInfo()
                        self.FP.Write(Lns_getVM().String_format("%s var%d = ", []LnsAny{convCC_getCType_1185_(typeInfo), subIndex}))
    ...
    if orgFunc.FP.Get_retTypeInfoList().Len() > 0{
        self.FP.Write(Lns_getVM().String_format("%s ret = ", []LnsAny{convCC_getCRetType_1192_(orgFunc.FP.Get_retTypeInfoList())}))
    }
        ...
        if orgFunc.FP.Get_retTypeInfoList().Len() == 0{
            ...
            if castType.FP.Get_retTypeInfoList().Len() > 1{
                if orgFunc.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo().FP.Get_kind() == Ast_TypeInfoKind__DDD{
                    ...
                    convCC_process2stem_2050_(self.stream.FP, self.moduleCtrl, self.scopeMgr, convCC_getValKind_1164_(orgFunc.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()), orgFunc.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), &node.Nodes_Node, convCC_process2stemCallback_2047_(func() {
                        self.FP.Write("ret")
                    }))
                    self.FP.Write(")")
                }
            } else { 
                if convCC_getValKind_1164_(castType.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()) == convCC_ValKind__Stem{
                    convCC_process2stem_2050_(self.stream.FP, self.moduleCtrl, self.scopeMgr, convCC_getValKind_1164_(orgFunc.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()), orgFunc.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), &node.Nodes_Node, convCC_process2stemCallback_2047_(func() {
                        self.FP.Write("ret")
                    }))
                } else { 
...
// 9302: decl @lune.@base.@convCC.convFilter.processExpCast
func (self *convCC_convFilter) ProcessExpCast(node *Nodes_ExpCastNode,_opt LnsAny) {
    if _switch39715 := self.processMode; _switch39715 == convCC_ProcessMode__Prototype || _switch39715 == convCC_ProcessMode__Intermediate {
    ...
    var castType *Ast_TypeInfo
    castType = node.FP.Get_castType()
    if _switch40537 := node.FP.Get_castKind(); _switch40537 == Nodes_CastKind__Implicit {
        if _switch39850 := castType.FP.Get_kind(); _switch39850 == Ast_TypeInfoKind__IF {
        ...
        } else if _switch39850 == Ast_TypeInfoKind__FormFunc {
            self.FP.processFuncCast2Form(castType, expType)
        } else if _switch39850 == Ast_TypeInfoKind__Form {
            self.FP.processFuncCast2Form(castType, expType)
        } else {
            convCC_filter_1636_(exp, self, &node.Nodes_Node)
        }
    } else if _switch40537 == Nodes_CastKind__Force {
        if _switch40049 := convCC_getValKind_1164_(castType); _switch40049 == convCC_ValKind__Stem {
            self.FP.ProcessVal2stem(exp, &node.Nodes_Node)
        } else if _switch40049 == convCC_ValKind__Any {
            self.FP.ProcessVal2any(exp, &node.Nodes_Node)
        } else if _switch40049 == convCC_ValKind__Prim {
            if convCC_isStemType_1168_(expType){
                if _switch40030 := castType.FP.Get_srcTypeInfo(); _switch40030 == Ast_builtinTypeInt || _switch40030 == Ast_builtinTypeChar {
                    self.FP.Write("lns_stem2int( ")
                    convCC_filter_1636_(exp, self, &node.Nodes_Node)
                    self.FP.Write(")")
                } else if _switch40030 == Ast_builtinTypeReal {
                    self.FP.Write("lns_stem2real( ")
                    convCC_filter_1636_(exp, self, &node.Nodes_Node)
                    self.FP.Write(")")
                } else if _switch40030 == Ast_builtinTypeBool {
                    self.FP.Write("lns_stem2bool( ")
                    convCC_filter_1636_(exp, self, &node.Nodes_Node)
                    self.FP.Write(")")
                } else {
    ...
    } else if _switch40537 == Nodes_CastKind__Normal {
        var nonNilCastType *Ast_TypeInfo
        nonNilCastType = castType.FP.Get_nonnilableType()
        if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
            Lns_setStackVal( nonNilCastType.FP.Get_kind() == Ast_TypeInfoKind__Class) &&
            Lns_setStackVal( Lns_op_not(nonNilCastType.FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil))) ).(bool)){
            ...
            if convCC_getValKind_1164_(nonNilCastType) == convCC_ValKind__Any{
                var kindTxt string
                ...
                if _switch40374 := workType.FP.Get_kind(); _switch40374 == Ast_TypeInfoKind__List {
                    kindTxt = "lns_value_type_List"
                    
                } else if _switch40374 == Ast_TypeInfoKind__Array {
                    kindTxt = "lns_value_type_Array"
                    
                } else if _switch40374 == Ast_TypeInfoKind__Map {
                    kindTxt = "lns_value_type_Map"
                    
                } else if _switch40374 == Ast_TypeInfoKind__Class {
                ...
                } else if _switch40374 == Ast_TypeInfoKind__IF {
                    Util_err("not support")
                } else if _switch40374 == Ast_TypeInfoKind__Func {
                    kindTxt = "lns_value_type_form"
                    
                } else if _switch40374 == Ast_TypeInfoKind__Alge {
                    kindTxt = "lns_value_type_alge"
                    
                } else if _switch40374 == Ast_TypeInfoKind__DDD {
                    kindTxt = "lns_value_type_ddd"
                    
                } else if _switch40374 == Ast_TypeInfoKind__Set {
                    kindTxt = "lns_value_type_Set"
                    
                } else if _switch40374 == Ast_TypeInfoKind__Form {
                    kindTxt = "lns_value_type_form"
                    
                } else if _switch40374 == Ast_TypeInfoKind__FormFunc {
                    kindTxt = "lns_value_type_form"
                ...
                if nonNilCastType.FP.Get_kind() != Ast_TypeInfoKind__Stem{
                    var kindTxt string
                    if _switch40480 := nonNilCastType.FP.Get_srcTypeInfo(); _switch40480 == Ast_builtinTypeInt || _switch40480 == Ast_builtinTypeChar {
                        kindTxt = "lns_stem_type_int"
                        
                    } else if _switch40480 == Ast_builtinTypeReal {
                        kindTxt = "lns_stem_type_real"
                        
                    } else if _switch40480 == Ast_builtinTypeBool {
...
// 9484: decl @lune.@base.@convCC.convFilter.processExpParen
func (self *convCC_convFilter) ProcessExpParen(node *Nodes_ExpParenNode,_opt LnsAny) {
    if node.FP.Get_exp().FP.Get_expTypeList().Len() == 1{
        ...
        convCC_processToIF_2301_(self.stream.FP, self.moduleCtrl, node.FP.Get_expType(), convCC_processExp_1872_(func() {
            self.FP.AccessPrimVal(node.FP.Get_exp(), &node.Nodes_Node)
        }))
    }
}

// 9504: decl @lune.@base.@convCC.convFilter.processWrapForm2Func
...
// 9521: decl @lune.@base.@convCC.convFilter.processAndOr
func (self *convCC_convFilter) processAndOr(node *Nodes_ExpOp2Node,opTxt string,parent *Nodes_Node) {
    var firstFlag bool
    firstFlag = Lns_op_not(convFilter_processAndOr__isAndOr_2777_(parent))
    if firstFlag{
    ...
    if convFilter_processAndOr__isAndOr_2777_(node.FP.Get_exp1()){
        convCC_filter_1636_(node.FP.Get_exp1(), self, &node.Nodes_Node)
    } else { 
    ...
    if convFilter_processAndOr__isAndOr_2777_(node.FP.Get_exp2()){
        convCC_filter_1636_(node.FP.Get_exp2(), self, &node.Nodes_Node)
    } else { 
        self.FP.Write("lns_setStackVal( _pEnv, ")
    ...
    if firstFlag{
        self.FP.Write(")")
        if Lns_op_not(convCC_isStemType_1168_(node.FP.Get_expType())){
            self.FP.Write(convCC_getAccessPrimValFromStem_1842_(false, node.FP.Get_expType(), 0))
        }
        self.FP.PopIndent()
    }
}

// 9578: decl @lune.@base.@convCC.convFilter.processConcat
...
// 9588: decl @lune.@base.@convCC.convFilter.processExpSetVal
...
func (self *convCC_convFilter) ProcessExpOp2(node *Nodes_ExpOp2Node,_opt LnsAny) {
    ...
    if _switch41480 := opTxt; _switch41480 == "and" || _switch41480 == "or" {
    ...
    } else {
        {
            ...
            if __exp != nil {
                _exp := __exp.(LnsInt)
                if _switch41180 := _exp; _switch41180 == Ast_BitOpKind__LShift {
                    opTxt = "<<"
                    
                } else if _switch41180 == Ast_BitOpKind__RShift {
                    opTxt = ">>"
                ...
                if Ast_compOpSet.Has(opTxt){
                    self.FP.processEquals(opTxt == "==", node.FP.Get_exp1().FP.Get_expType(), node.FP.Get_exp2().FP.Get_expType(), convCC_ProcessToValForm_2532_(func(valKind LnsInt) {
                        if _switch41308 := valKind; _switch41308 == convCC_ValKind__Stem {
                            self.FP.ProcessVal2stem(node.FP.Get_exp1(), &node.Nodes_Node)
                        } else if _switch41308 == convCC_ValKind__Any {
                            self.FP.ProcessVal2any(node.FP.Get_exp1(), &node.Nodes_Node)
                        } else if _switch41308 == convCC_ValKind__Prim {
                            self.FP.AccessPrimVal(node.FP.Get_exp1(), &node.Nodes_Node)
                        }
                    }), convCC_ProcessToValForm_2532_(func(valKind LnsInt) {
                        if _switch41369 := valKind; _switch41369 == convCC_ValKind__Stem {
                            self.FP.ProcessVal2stem(node.FP.Get_exp2(), &node.Nodes_Node)
                        } else if _switch41369 == convCC_ValKind__Any {
                            self.FP.ProcessVal2any(node.FP.Get_exp2(), &node.Nodes_Node)
                        } else if _switch41369 == convCC_ValKind__Prim {
...
// 9720: decl @lune.@base.@convCC.convFilter.processExpRef
    ...
    } else { 
        {
            ...
            if _cFuncName != nil {
                ...
                if valKind == convCC_ValKind__Var{
                    ...
                    self.FP.Write(convCC_getAccessValFromStem_1845_(symbolInfo.FP.Get_typeInfo()))
                } else { 
                    if Lns_popVal( Lns_incStack() ||
                        Lns_setStackVal( symbolInfo.FP.Get_kind() == Ast_SymbolKind__Fun) ||
                        Lns_setStackVal( symbolInfo.FP.Get_typeInfo().FP.Get_kind() == Ast_TypeInfoKind__Func) ).(bool){
...
// 9774: decl @lune.@base.@convCC.convFilter.processExpRefItem
func (self *convCC_convFilter) ProcessExpRefItem(node *Nodes_ExpRefItemNode,_opt LnsAny) {
    ...
    process = func() {
        ...
        self.FP.Write(", ")
        {
            ...
            if _index != nil {
                ...
                self.FP.Write(convCC_getLiteralStrStem_1494_(Lns_getVM().String_format("\"%s\"", []LnsAny{Lns_unwrap( node.FP.Get_symbol()).(string)})))
            }
        }
        self.FP.Write(")")
    }
    if node.FP.Get_nilAccess(){
        convCC_processToIF_2301_(self.stream.FP, self.moduleCtrl, node.FP.Get_expType(), convCC_processExp_1872_(process))
        return 
    }
    var val *Nodes_Node
    val = node.FP.Get_val()
    ...
    if valType.FP.Equals(self.processInfo, Ast_builtinTypeString, nil, nil){
        ...
        self.FP.Write("->val.str.pStr[")
        {
            ...
            if _indexNode != nil {
                indexNode := _indexNode.(*Nodes_Node)
                convCC_filter_1636_(indexNode, self, &node.Nodes_Node)
            } else {
                panic("index is nil")
            }
        }
        ...
        convCC_processToIF_2301_(self.stream.FP, self.moduleCtrl, node.FP.Get_expType(), convCC_processExp_1872_(func() {
            if _switch42160 := valType.FP.Get_kind(); _switch42160 == Ast_TypeInfoKind__List {
                ...
                self.FP.Write(")")
                self.FP.Write(convCC_getAccessValFromStem_1845_(valType.FP.Get_itemTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo()))
            } else if _switch42160 == Ast_TypeInfoKind__Map {
                ...
                self.FP.Write(")")
            } else if _switch42160 == Ast_TypeInfoKind__Stem {
                process()
            } else {
                Util_err(Lns_getVM().String_format("not support:%s -- %d:%d", []LnsAny{Ast_TypeInfoKind_getTxt( valType.FP.Get_kind()), 9848, node.FP.Get_pos().LineNo}))
            }
        }))
    }
}

// 9855: decl @lune.@base.@convCC.convFilter.processRefField
func (self *convCC_convFilter) ProcessRefField(node *Nodes_RefFieldNode,_opt LnsAny) {
    if node.FP.Get_nilAccess(){
        {
            ...
            if _symbolInfo != nil {
                symbolInfo := _symbolInfo.(*Ast_SymbolInfo)
                if _switch42299 := symbolInfo.FP.Get_kind(); _switch42299 == Ast_SymbolKind__Mbr {
                    var prefixType *Ast_TypeInfo
                    prefixType = convCC_getOrgTypeInfo_1424_(node.FP.Get_prefix().FP.Get_expType())
                    if prefixType.FP.Get_kind() == Ast_TypeInfoKind__Class{
                        ...
                        self.FP.Write(Lns_getVM().String_format(", offsetof( %s, %s ), %s )", []LnsAny{self.moduleCtrl.FP.GetClassCName(prefixType), symbolInfo.FP.Get_name(), convCC_getStemTypeId_1878_(symbolInfo.FP.Get_typeInfo().FP.Get_srcTypeInfo())}))
                    } else { 
    ...
    }
    {
        ...
        if _symbolInfo != nil {
            ...
            if _switch42688 := symbolInfo.FP.Get_kind(); _switch42688 == Ast_SymbolKind__Mbr {
            ...
            } else if _switch42688 == Ast_SymbolKind__Var {
            ...
            } else if _switch42688 == Ast_SymbolKind__Mtd {
                if Lns_op_not(symbolInfo.FP.Get_staticFlag()){
...
// 9974: decl @lune.@base.@convCC.convFilter.processExpOmitEnum
...
// 9993: decl @lune.@base.@convCC.convFilter.processGetField
func (self *convCC_convFilter) ProcessGetField(node *Nodes_GetFieldNode,_opt LnsAny) {
    ...
    if _switch43299 := prefixType.FP.Get_kind(); _switch43299 == Ast_TypeInfoKind__Enum {
        if node.FP.Get_nilAccess(){
            Util_err(Lns_getVM().String_format("not support -- %d:%d:%s", []LnsAny{10004, node.FP.Get_pos().LineNo, fieldTxt}))
        }
        var enumFullName string
        enumFullName = self.moduleCtrl.FP.GetEnumTypeName(prefixType)
        if _switch42877 := fieldTxt; _switch42877 == "_allList" {
            self.FP.Write(Lns_getVM().String_format("%s_get__allList( _pEnv )", []LnsAny{enumFullName}))
        } else if _switch42877 == "_txt" {
            self.FP.Write(Lns_getVM().String_format("%s_get__txt( _pEnv, ", []LnsAny{enumFullName}))
            convCC_filter_1636_(prefixNode, self, &node.Nodes_Node)
            self.FP.Write(")")
        } else {
            Util_err(Lns_getVM().String_format("not support -- %d:%d:%s", []LnsAny{10018, node.FP.Get_pos().LineNo, fieldTxt}))
        }
    } else if _switch43299 == Ast_TypeInfoKind__Alge {
        if node.FP.Get_nilAccess(){
            Util_err(Lns_getVM().String_format("not support -- %d:%d:%s", []LnsAny{10025, node.FP.Get_pos().LineNo, fieldTxt}))
        }
        var algeName string
        algeName = self.moduleCtrl.FP.GetAlgeCName(prefixType)
        if _switch42978 := fieldTxt; _switch42978 == "_txt" {
            self.FP.Write(Lns_getVM().String_format("%s_get__txt( _pEnv, ", []LnsAny{algeName}))
            self.FP.ProcessVal2any(prefixNode, &node.Nodes_Node)
            self.FP.Write(")")
        } else {
            Util_err(Lns_getVM().String_format("not support -- %d:%d:%s", []LnsAny{10036, node.FP.Get_pos().LineNo, fieldTxt}))
        }
    } else if _switch43299 == Ast_TypeInfoKind__Class || _switch43299 == Ast_TypeInfoKind__IF {
        var getterType *Ast_TypeInfo
        getterType = Lns_unwrap( Lns_NilAccFin(Lns_NilAccPush(prefixType.FP.Get_scope()) && 
        Lns_NilAccCall1( func () LnsAny { return Lns_NilAccPop().(*Ast_Scope).FP.GetTypeInfoField(Lns_getVM().String_format("get_%s", []LnsAny{fieldTxt}), true, Lns_unwrap( prefixType.FP.Get_scope()).(*Ast_Scope), convCC_scopeAccess)})/* 10041:34 */)).(*Ast_TypeInfo)
        var process func()
        process = func() {
            if node.FP.Get_nilAccess(){
                var typeInfo string
                typeInfo = convCC_getCType_1185_(getterType.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo())
                if _switch43111 := typeInfo; _switch43111 == convCC_cTypeInt {
                    self.FP.Write("l_nil_mtd_getter_int( _pEnv, ")
                } else if _switch43111 == convCC_cTypeReal {
                    self.FP.Write("l_nil_mtd_getter_real( _pEnv, ")
                } else if _switch43111 == convCC_cTypeBool {
                    self.FP.Write("l_nil_mtd_getter_bool( _pEnv, ")
                } else if _switch43111 == convCC_cTypeAnyP {
                    self.FP.Write("l_nil_mtd_getter_any( _pEnv, ")
                } else if _switch43111 == convCC_cTypeStem {
                    self.FP.Write("l_nil_mtd_getter( _pEnv, ")
                } else {
                    Util_err(Lns_getVM().String_format("not support -- %d:%d:%s", []LnsAny{10065, node.FP.Get_pos().LineNo, fieldTxt}))
                }
                ...
                self.FP.Write(")")
                convCC_processAlterAccessVal_2347_(self.stream.FP, getterType.FP.Get_retTypeInfoList(), node.FP.Get_expTypeList())
            }
        }
        if node.FP.Get_expTypeList().Len() == 1{
            convCC_processAlterToActualType_2350_(self.stream.FP, self.moduleCtrl, getterType.FP.Get_retTypeInfoList().GetAt(1).(Ast_TypeInfoDownCast).ToAst_TypeInfo(), node.FP.Get_expType(), convCC_processExp_1872_(process))
        } else { 
            process()
        }
    } else {
        Util_err(Lns_getVM().String_format("not support -- %d:%d:%s", []LnsAny{10098, node.FP.Get_pos().LineNo, Ast_TypeInfoKind_getTxt( prefixType.FP.Get_kind())}))
    }
}

// 10127: decl @lune.@base.@convCC.convFilter.processReturn
func (self *convCC_convFilter) ProcessReturn(node *Nodes_ReturnNode,_opt LnsAny) {
    ...
    var blockStart bool
    {
        ...
        if _expListNode != nil {
            ...
            var retKind LnsInt
            retKind = convCC_getRetKind_1175_(retTypeInfoList)
            var needSetRet bool
            needSetRet = true
            self.FP.Writeln("{")
            blockStart = true
            ...
            self.FP.PushIndent(nil)
            self.FP.Write(Lns_getVM().String_format("%s _ret = ", []LnsAny{convCC_getCRetType_1192_(retTypeInfoList)}))
            if retTypeInfoList.Len() >= 2{
                self.FP.processCreateMRet(retTypeInfoList, expList, &node.Nodes_Node)
            } else if retTypeInfoList.Len() == 1{
                if _switch43492 := retKind; _switch43492 == convCC_ValKind__Stem {
                    self.FP.ProcessVal2stem(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node(), &node.Nodes_Node)
                } else if _switch43492 == convCC_ValKind__Any {
                    self.FP.ProcessVal2any(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node(), &node.Nodes_Node)
                } else if _switch43492 == convCC_ValKind__Prim {
                    convCC_filter_1636_(expList.GetAt(1).(Nodes_NodeDownCast).ToNodes_Node(), self, &node.Nodes_Node)
                } else {
                    Util_err(Lns_getVM().String_format("no support -- %d", []LnsAny{10156}))
                }
            } else { 
            }
            self.FP.Writeln(";")
            if needSetRet{
                if _switch43607 := retKind; _switch43607 == convCC_ValKind__Stem {
                ...
                } else if _switch43607 == convCC_ValKind__Any {
                    if self.routineInfoStack.FP.Get_blockDepth() == 1{
                ...
                } else if _switch43607 == convCC_ValKind__Prim {
                } else {
                    Util_err(Lns_getVM().String_format("no support -- %d", []LnsAny{10189}))
                }
            }
        } else {
            blockStart = false
...
// 10220: decl @lune.@base.@convCC.convFilter.processTestCase
func (self *convCC_convFilter) ProcessTestCase(node *Nodes_TestCaseNode,_opt LnsAny) {
    ...
    if _switch43859 := self.processMode; _switch43859 == convCC_ProcessMode__Prototype {
        processDecl()
        self.FP.Writeln(";")
    } else {
        processDecl()
...
func (self *convCC_convFilter) processLiteralVal(exp *Nodes_Node,parent *Nodes_Node) {
    ...
    if _switch44300 := valType; _switch44300 == Ast_builtinTypeInt || _switch44300 == Ast_builtinTypeChar {
        self.FP.Write("lns_imdInt( ")
        convCC_filter_1636_(exp, self, parent)
        self.FP.Write(")")
    } else if _switch44300 == Ast_builtinTypeReal {
        self.FP.Write("lns_imdReal( ")
        convCC_filter_1636_(exp, self, parent)
        self.FP.Write(")")
    } else if _switch44300 == Ast_builtinTypeBool {
        self.FP.Write("lns_imdBool( ")
        convCC_filter_1636_(exp, self, parent)
        self.FP.Write(")")
    } else if _switch44300 == Ast_builtinTypeString {
        {
            ...
            if _strNode != nil {
                ...
                if Lns_op_not(strNode.FP.Get_orgParam()){
                    self.FP.Write(Lns_getVM().String_format("lns_imdStr( %s )", []LnsAny{convCC_str2cstr_1216_(strNode.FP.Get_token().Txt)}))
                    return 
                }
            }
        }
        ...
        if _switch44298 := valType.FP.Get_kind(); _switch44298 == Ast_TypeInfoKind__List || _switch44298 == Ast_TypeInfoKind__Set || _switch44298 == Ast_TypeInfoKind__Map || _switch44298 == Ast_TypeInfoKind__Array || _switch44298 == Ast_TypeInfoKind__Class {
            self.FP.Write("lns_imdAny( ")
            convCC_filter_1636_(exp, self, parent)
            self.FP.Write(")")
        } else if _switch44298 == Ast_TypeInfoKind__DDD {
            self.FP.Write("lns_imdAny( ")
            self.FP.ProcessVal2any(exp, parent)
            self.FP.Write(")")
        } else if _switch44298 == Ast_TypeInfoKind__Alternate || _switch44298 == Ast_TypeInfoKind__Stem || _switch44298 == Ast_TypeInfoKind__Alge {
...
// 10364: decl @lune.@base.@convCC.convFilter.processLiteralNode
func (self *convCC_convFilter) processLiteralNode(exp *Nodes_Node,parent *Nodes_Node) {
    if _switch44397 := exp.FP.Get_kind(); _switch44397 == Nodes_NodeKind_get_LiteralList() || _switch44397 == Nodes_NodeKind_get_LiteralMap() || _switch44397 == Nodes_NodeKind_get_LiteralArray() || _switch44397 == Nodes_NodeKind_get_LiteralSet() {
...
// 10382: decl @lune.@base.@convCC.convFilter.processLiteralListSub
func (self *convCC_convFilter) processLiteralListSub(collectionType string,node *Nodes_Node,expListNodeOrg LnsAny,literalFuncName string) {
    ...
    for _, _symbol := range( self.accessSymbolSet.FP.Get_list().Items ) {
        symbol := _symbol.(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
        var ctype string
        ctype = convCC_convExp44546(Lns_2DDD(self.scopeMgr.FP.GetCTypeForSym(symbol.FP)))
...
// 10439: decl @lune.@base.@convCC.convFilter.processLiteralList
func (self *convCC_convFilter) ProcessLiteralList(node *Nodes_LiteralListNode,_opt LnsAny) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.processMode == convCC_ProcessMode__Immediate) &&
        Lns_setStackVal( self.processingNode == &node.Nodes_Node) ).(bool)){
        self.FP.processLiteralListSub("List", &node.Nodes_Node, node.FP.Get_expList(), convCC_getLiteralListFuncName_2845_(node))
    } else { 
        if Lns_isCondTrue( node.FP.Get_expList()){
            self.FP.Write(Lns_getVM().String_format("%s( _pEnv", []LnsAny{convCC_getLiteralListFuncName_2845_(node)}))
...
// 10468: decl @lune.@base.@convCC.convFilter.processLiteralSet
func (self *convCC_convFilter) ProcessLiteralSet(node *Nodes_LiteralSetNode,_opt LnsAny) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.processMode == convCC_ProcessMode__Immediate) &&
        Lns_setStackVal( self.processingNode == &node.Nodes_Node) ).(bool)){
        self.FP.processLiteralListSub("Set", &node.Nodes_Node, node.FP.Get_expList(), convCC_getLiteralSetFuncName_2873_(node))
    } else { 
        if Lns_isCondTrue( node.FP.Get_expList()){
            self.FP.Write(Lns_getVM().String_format("%s( _pEnv", []LnsAny{convCC_getLiteralSetFuncName_2873_(node)}))
            var symbolSet *Util_OrderedSet
...
// 10497: decl @lune.@base.@convCC.convFilter.processLiteralMapSub
func (self *convCC_convFilter) processLiteralMapSub(node *Nodes_LiteralMapNode) {
    ...
    self.FP.Write(Lns_getVM().String_format("static %s %s( %s _pEnv", []LnsAny{convCC_cTypeAnyP, convCC_getLiteralMapFuncName_2883_(node), convCC_cTypeEnvP}))
    for _, _symbol := range( self.accessSymbolSet.FP.Get_list().Items ) {
        symbol := _symbol.(Ast_SymbolInfoDownCast).ToAst_SymbolInfo()
...
// 10549: decl @lune.@base.@convCC.convFilter.processLiteralMap
func (self *convCC_convFilter) ProcessLiteralMap(node *Nodes_LiteralMapNode,_opt LnsAny) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        ...
        if node.FP.Get_pairList().Len() > 0{
            self.FP.Write(Lns_getVM().String_format("%s( _pEnv", []LnsAny{convCC_getLiteralMapFuncName_2883_(node)}))
            var symbolSet *Util_OrderedSet
...
// 10576: decl @lune.@base.@convCC.convFilter.processLiteralArray
func (self *convCC_convFilter) ProcessLiteralArray(node *Nodes_LiteralArrayNode,_opt LnsAny) {
    if Lns_isCondTrue( Lns_popVal( Lns_incStack() ||
        Lns_setStackVal( self.processMode == convCC_ProcessMode__Immediate) &&
        Lns_setStackVal( self.processingNode == &node.Nodes_Node) ).(bool)){
        self.FP.processLiteralListSub("List", &node.Nodes_Node, node.FP.Get_expList(), convCC_getLiteralArrayFuncName_2907_(node))
    } else { 
        if Lns_isCondTrue( node.FP.Get_expList()){
            self.FP.Write(Lns_getVM().String_format("%s( _pEnv", []LnsAny{convCC_getLiteralArrayFuncName_2907_(node)}))
            var symbolSet *Util_OrderedSet
...
// 10601: decl @lune.@base.@convCC.convFilter.processLiteralChar
...
// 10607: decl @lune.@base.@convCC.convFilter.processLiteralInt
func (self *convCC_convFilter) ProcessLiteralInt(node *Nodes_LiteralIntNode,_opt LnsAny) {
    self.FP.Write(node.FP.Get_token().Txt)
}

// 10613: decl @lune.@base.@convCC.convFilter.processLiteralReal
func (self *convCC_convFilter) ProcessLiteralReal(node *Nodes_LiteralRealNode,_opt LnsAny) {
    self.FP.Write(node.FP.Get_token().Txt)
}

// 10619: decl @lune.@base.@convCC.convFilter.processLiteralString
func (self *convCC_convFilter) ProcessLiteralString(node *Nodes_LiteralStringNode,_opt LnsAny) {
    var txt string
    txt = convCC_str2cstr_1216_(node.FP.Get_token().Txt)
    if _switch46037 := self.processMode; _switch46037 == convCC_ProcessMode__Prototype {
        {
            _expListNode := node.FP.Get_orgParam()
            if _expListNode != nil {
                expListNode := _expListNode.(*Nodes_ExpListNode)
                if Lns_isCondTrue( expListNode.FP.Get_mRetExp()){
                    self.FP.ProcessCallWithMRet(&node.Nodes_Node, convCC_getMRetFuncName_2686_(&node.Nodes_Node), convCC_cTypeAnyP, &convCC_MRetInfo__Format{txt, expListNode}, expListNode)
                } else { 
        ...
        return 
    } else if _switch46037 == convCC_ProcessMode__StringFormat {
        {
            _expListNode := node.FP.Get_orgParam()
            if _expListNode != nil {
                expListNode := _expListNode.(*Nodes_ExpListNode)
                if Lns_isCondTrue( expListNode.FP.Get_mRetExp()){
                    ...
                    self.FP.Write(convCC_getLiteralStrAny_1491_(txt))
                    self.FP.Write(", ")
                    var expList *LnsList
                    expList = expListNode.FP.Get_expList()
                    self.FP.Write("lns_createDDD")
                    ...
                    self.FP.Write(Lns_getVM().String_format("( _pEnv, %s, %d", []LnsAny{Nodes_hasMultiValNode(lastExp), expList.Len()}))
                    {
                        var _from46007 LnsInt = 1
                        var _to46007 LnsInt = expList.Len()
                        for _work46007 := _from46007; _work46007 <= _to46007; _work46007++ {
                            index := _work46007
                            self.FP.Write(Lns_getVM().String_format(", arg%d", []LnsAny{index}))
                        }
                    }
...
// 10719: decl @lune.@base.@convCC.convFilter.processLiteralBool
...
// 10730: decl @lune.@base.@convCC.convFilter.processLiteralNil
func (self *convCC_convFilter) ProcessLiteralNil(node *Nodes_LiteralNilNode,_opt LnsAny) {
    self.FP.Write(convCC_cValNil)
}

// 10736: decl @lune.@base.@convCC.convFilter.processBreak
...
// 10751: decl @lune.@base.@convCC.convFilter.processLiteralSymbol
func (self *convCC_convFilter) ProcessLiteralSymbol(node *Nodes_LiteralSymbolNode,_opt LnsAny) {
}

// 10757: decl @lune.@base.@convCC.convFilter.processAbbr
