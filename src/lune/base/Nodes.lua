...
function LiteralMapNode:setupLiteralTokenList( list )
   ...
   local lit2valNode = {}
   for key, _10617 in pairs( self.map ) do
   ...
   do
      ...
      table.sort( __sorted )
      for __index, _10631 in ipairs( __sorted ) do
         local key = __map[ _10631 ]
         do
...
nodeKindEnum.Env = 8
nodeKindEnum._val2NameMap[8] = 'Env'
nodeKindEnum.__allList[9] = nodeKindEnum.Env
