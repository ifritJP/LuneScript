...
// for 2724
func Nodes_convExp0_35248(arg1 string, arg2 []LnsAny) (string, []LnsAny) {
...
// for 2546
func Nodes_convExp0_34484(arg1 []LnsAny) (LnsAny, LnsAny) {
...
// for 2613
func Nodes_convExp0_34758(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2645
func Nodes_convExp0_34892(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2646
func Nodes_convExp0_34900(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2668
func Nodes_convExp0_34990(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2716
func Nodes_convExp0_35201(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2794
func Nodes_convExp0_35524(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2825
func Nodes_convExp0_35644(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2885
func Nodes_convExp0_35875(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2935
func Nodes_convExp0_35999(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2961
...
// for 2962
func Nodes_convExp0_36113(arg1 []LnsAny) (bool, LnsInt, LnsReal, string, *Ast_TypeInfo) {
    return Lns_getFromMulti( arg1, 0 ).(bool), Lns_getFromMulti( arg1, 1 ).(LnsInt), Lns_getFromMulti( arg1, 2 ).(LnsReal), Lns_getFromMulti( arg1, 3 ).(string), Lns_getFromMulti( arg1, 4 ).(*Ast_TypeInfo)
}
...
// 401: decl @lune.@base.@Nodes.cloneNodeList
...
// 436: decl @lune.@base.@Nodes.regKind
...
// 2393: decl @lune.@base.@Nodes.Node.getSymbolInfo.processExpNode
...
// 2769: decl @lune.@base.@Nodes.enumLiteral2Literal
...
// 3096: decl @lune.@base.@Nodes.hasMultiValNode
...
// 3117: decl @lune.@base.@Nodes.getUnwraped
...
// 3127: decl @lune.@base.@Nodes.getCastUnwraped
...
// 447: decl @lune.@base.@Nodes.Filter.defaultProcess
...
// 3079: decl @lune.@base.@Nodes.Filter.processBlockSub
func (self *Nodes_Filter) ProcessBlockSub(_env *LnsEnv, node *Nodes_BlockNode,_opt LnsAny) {
}
// 3082: decl @lune.@base.@Nodes.Filter.processBlock
...
// 239: decl @lune.@base.@Nodes.Node.isIntermediate
func (self *Nodes_Node) IsIntermediate(_env *LnsEnv) bool {
    return false
}
// 242: decl @lune.@base.@Nodes.Node.setTailExp
func (self *Nodes_Node) SetTailExp(_env *LnsEnv) {
}
// 245: decl @lune.@base.@Nodes.Node.comp
...
// 261: decl @lune.@base.@Nodes.Node.compUsingPos
...
// 317: decl @lune.@base.@Nodes.Node.get_expType
...
// 324: decl @lune.@base.@Nodes.Node.addTokenList
...
// 530: decl @lune.@base.@Nodes.NodeManager.addNode
...
// 537: decl @lune.@base.@Nodes.NodeManager.delNode
...
// 553: decl @lune.@base.@Nodes.NodeManager.addFrom
...
// 3065: decl @lune.@base.@Nodes.NodeManager.MultiTo1
...
// 780: decl @lune.@base.@Nodes.NoneNode.create
...
// 791: decl @lune.@base.@Nodes.NoneNode.visit
...
// 796: decl @lune.@base.@Nodes.NoneNode.sortList
...
// 780: decl @lune.@base.@Nodes.ShebangNode.create
...
// 780: decl @lune.@base.@Nodes.ConvStatNode.create
...
// 780: decl @lune.@base.@Nodes.BlankLineNode.create
...
// 780: decl @lune.@base.@Nodes.SubfileNode.create
...
// 780: decl @lune.@base.@Nodes.ImportNode.create
...
// 780: decl @lune.@base.@Nodes.RootNode.create
...
// 791: decl @lune.@base.@Nodes.RootNode.visit
...
// 796: decl @lune.@base.@Nodes.RootNode.sortList
...
// 932: decl @lune.@base.@Nodes.RootNode.set_provide
...
// 780: decl @lune.@base.@Nodes.RefTypeNode.create
...
// 791: decl @lune.@base.@Nodes.RefTypeNode.visit
...
// 796: decl @lune.@base.@Nodes.RefTypeNode.sortList
...
// 947: decl @lune.@base.@Nodes.RefTypeNode.checkValidGenerics
...
// 780: decl @lune.@base.@Nodes.DeclTupleNode.create
...
// 780: decl @lune.@base.@Nodes.BlockNode.create
...
// 791: decl @lune.@base.@Nodes.BlockNode.visit
...
// 796: decl @lune.@base.@Nodes.BlockNode.sortList
...
// 1084: decl @lune.@base.@Nodes.BlockNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ScopeNode.create
...
// 791: decl @lune.@base.@Nodes.ScopeNode.visit
...
// 796: decl @lune.@base.@Nodes.ScopeNode.sortList
...
// 780: decl @lune.@base.@Nodes.CondRetNode.create
...
// 791: decl @lune.@base.@Nodes.CondRetNode.visit
...
// 796: decl @lune.@base.@Nodes.CondRetNode.sortList
...
// 780: decl @lune.@base.@Nodes.CondRetListNode.create
...
// 791: decl @lune.@base.@Nodes.CondRetListNode.visit
...
// 796: decl @lune.@base.@Nodes.CondRetListNode.sortList
...
// 780: decl @lune.@base.@Nodes.IfNode.create
...
// 1131: decl @lune.@base.@Nodes.IfNode.getBreakKind
...
// 1148: decl @lune.@base.@Nodes.IfNode.visitSub
...
// 780: decl @lune.@base.@Nodes.ExpListNode.create
...
// 791: decl @lune.@base.@Nodes.ExpListNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpListNode.sortList
...
// 1173: decl @lune.@base.@Nodes.ExpListNode.canBeLeft
...
// 1181: decl @lune.@base.@Nodes.ExpListNode.canBeRight
...
// 1189: decl @lune.@base.@Nodes.ExpListNode.setLValue
...
// 1206: decl @lune.@base.@Nodes.ExpListNode.getExpTypeAt
...
// 1226: decl @lune.@base.@Nodes.ExpListNode.getExpTypeNoDDDAt
...
// 780: decl @lune.@base.@Nodes.SwitchNode.create
...
// 791: decl @lune.@base.@Nodes.SwitchNode.visit
...
// 796: decl @lune.@base.@Nodes.SwitchNode.sortList
...
// 1266: decl @lune.@base.@Nodes.SwitchNode.getBreakKind
...
// 1295: decl @lune.@base.@Nodes.SwitchNode.visitSub
...
// 780: decl @lune.@base.@Nodes.WhileNode.create
...
// 791: decl @lune.@base.@Nodes.WhileNode.visit
...
// 796: decl @lune.@base.@Nodes.WhileNode.sortList
...
// 2449: decl @lune.@base.@Nodes.WhileNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.RepeatNode.create
...
// 791: decl @lune.@base.@Nodes.RepeatNode.visit
...
// 796: decl @lune.@base.@Nodes.RepeatNode.sortList
...
// 1308: decl @lune.@base.@Nodes.RepeatNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ForNode.create
...
// 791: decl @lune.@base.@Nodes.ForNode.visit
...
// 796: decl @lune.@base.@Nodes.ForNode.sortList
...
// 1308: decl @lune.@base.@Nodes.ForNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ApplyNode.create
...
// 791: decl @lune.@base.@Nodes.ApplyNode.visit
...
// 796: decl @lune.@base.@Nodes.ApplyNode.sortList
...
// 1308: decl @lune.@base.@Nodes.ApplyNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ForeachNode.create
...
// 791: decl @lune.@base.@Nodes.ForeachNode.visit
...
// 796: decl @lune.@base.@Nodes.ForeachNode.sortList
...
// 1308: decl @lune.@base.@Nodes.ForeachNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ForsortNode.create
...
// 791: decl @lune.@base.@Nodes.ForsortNode.visit
...
// 796: decl @lune.@base.@Nodes.ForsortNode.sortList
...
// 1308: decl @lune.@base.@Nodes.ForsortNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ReturnNode.create
...
// 791: decl @lune.@base.@Nodes.ReturnNode.visit
...
// 796: decl @lune.@base.@Nodes.ReturnNode.sortList
...
// 1379: decl @lune.@base.@Nodes.ReturnNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.BreakNode.create
...
// 1385: decl @lune.@base.@Nodes.BreakNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ProvideNode.create
...
// 780: decl @lune.@base.@Nodes.ExpNewNode.create
...
// 791: decl @lune.@base.@Nodes.ExpNewNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpNewNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpUnwrapNode.create
...
// 791: decl @lune.@base.@Nodes.ExpUnwrapNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpUnwrapNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpRefNode.create
...
// 2846: decl @lune.@base.@Nodes.ExpRefNode.getLiteral
...
// 780: decl @lune.@base.@Nodes.ExpSetValNode.create
...
// 791: decl @lune.@base.@Nodes.ExpSetValNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpSetValNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpSetItemNode.create
...
// 791: decl @lune.@base.@Nodes.ExpSetItemNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpSetItemNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpOp2Node.create
...
// 791: decl @lune.@base.@Nodes.ExpOp2Node.visit
...
// 796: decl @lune.@base.@Nodes.ExpOp2Node.sortList
...
// 2884: decl @lune.@base.@Nodes.ExpOp2Node.getValType
func (self *Nodes_ExpOp2Node) getValType(_env *LnsEnv, node *Nodes_Node)(bool, LnsInt, LnsReal, string, *Ast_TypeInfo) {
    var literal LnsAny
    
    {
        _literal := Nodes_convExp0_35875(Lns_2DDD(node.FP.GetLiteral(_env)))
        if _literal == nil{
...
func (self *Nodes_ExpOp2Node) SetupLiteralTokenList(_env *LnsEnv, list *LnsList) bool {
    var literal LnsAny
    literal = Nodes_convExp0_35999(Lns_2DDD(self.FP.GetLiteral(_env)))
    if literal != nil{
        literal_8225 := literal
        switch _matchExp0 := literal_8225.(type) {
        case *Nodes_Literal__Int:
            val := _matchExp0.Val1
...
// 2959: decl @lune.@base.@Nodes.ExpOp2Node.getLiteral
...
// 780: decl @lune.@base.@Nodes.UnwrapSetNode.create
...
// 791: decl @lune.@base.@Nodes.UnwrapSetNode.visit
...
// 796: decl @lune.@base.@Nodes.UnwrapSetNode.sortList
...
// 780: decl @lune.@base.@Nodes.IfUnwrapNode.create
...
// 791: decl @lune.@base.@Nodes.IfUnwrapNode.visit
...
// 796: decl @lune.@base.@Nodes.IfUnwrapNode.sortList
...
// 1472: decl @lune.@base.@Nodes.IfUnwrapNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.WhenNode.create
...
// 791: decl @lune.@base.@Nodes.WhenNode.visit
...
// 796: decl @lune.@base.@Nodes.WhenNode.sortList
...
// 1498: decl @lune.@base.@Nodes.WhenNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ExpCastNode.create
...
// 791: decl @lune.@base.@Nodes.ExpCastNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpCastNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpToDDDNode.create
...
// 791: decl @lune.@base.@Nodes.ExpToDDDNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpToDDDNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpSubDDDNode.create
...
// 791: decl @lune.@base.@Nodes.ExpSubDDDNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpSubDDDNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpOp1Node.create
...
// 791: decl @lune.@base.@Nodes.ExpOp1Node.visit
...
// 796: decl @lune.@base.@Nodes.ExpOp1Node.sortList
...
// 780: decl @lune.@base.@Nodes.ExpRefItemNode.create
...
// 791: decl @lune.@base.@Nodes.ExpRefItemNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpRefItemNode.sortList
...
// 1581: decl @lune.@base.@Nodes.ExpRefItemNode.getPrefix
func (self *Nodes_ExpRefItemNode) GetPrefix(_env *LnsEnv) LnsAny {
    return self.val
}
// 1584: decl @lune.@base.@Nodes.ExpRefItemNode.canBeLeft
...
// 780: decl @lune.@base.@Nodes.ExpCallNode.create
...
// 791: decl @lune.@base.@Nodes.ExpCallNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpCallNode.sortList
...
// 1616: decl @lune.@base.@Nodes.ExpCallNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ExpMRetNode.create
...
// 791: decl @lune.@base.@Nodes.ExpMRetNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpMRetNode.sortList
...
// 1627: decl @lune.@base.@Nodes.ExpMRetNode.getPrefix
...
// 780: decl @lune.@base.@Nodes.ExpAccessMRetNode.create
...
// 791: decl @lune.@base.@Nodes.ExpAccessMRetNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpAccessMRetNode.sortList
...
// 1636: decl @lune.@base.@Nodes.ExpAccessMRetNode.getPrefix
...
// 780: decl @lune.@base.@Nodes.ExpMultiTo1Node.create
...
// 791: decl @lune.@base.@Nodes.ExpMultiTo1Node.visit
...
// 796: decl @lune.@base.@Nodes.ExpMultiTo1Node.sortList
...
// 1643: decl @lune.@base.@Nodes.ExpMultiTo1Node.getPrefix
...
// 780: decl @lune.@base.@Nodes.ExpParenNode.create
...
// 791: decl @lune.@base.@Nodes.ExpParenNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpParenNode.sortList
...
// 1650: decl @lune.@base.@Nodes.ExpParenNode.getPrefix
func (self *Nodes_ExpParenNode) GetPrefix(_env *LnsEnv) LnsAny {
    return self.exp.FP.GetPrefix(_env)
}
// 1654: decl @lune.@base.@Nodes.ExpParenNode.getSymbolInfo
...
// 780: decl @lune.@base.@Nodes.ExpMacroExpNode.create
...
// 791: decl @lune.@base.@Nodes.ExpMacroExpNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpMacroExpNode.sortList
...
// 1667: decl @lune.@base.@Nodes.ExpMacroExpNode.canBeRight
...
// 1671: decl @lune.@base.@Nodes.ExpMacroExpNode.getBreakKind
...
// 780: decl @lune.@base.@Nodes.ExpMacroStatNode.create
...
// 791: decl @lune.@base.@Nodes.ExpMacroStatNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpMacroStatNode.sortList
...
// 2821: decl @lune.@base.@Nodes.ExpMacroStatNode.getLiteral
func (self *Nodes_ExpMacroStatNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    ...
    for _, _token := range( self.expStrList.Items ) {
        ...
        var literal LnsAny
        literal = Nodes_convExp0_35644(Lns_2DDD(token.FP.GetLiteral(_env)))
        if literal != nil{
            literal_8187 := literal
            switch _matchExp0 := literal_8187.(type) {
            case *Nodes_Literal__Str:
...
// 780: decl @lune.@base.@Nodes.ExpMacroArgExpNode.create
...
// 791: decl @lune.@base.@Nodes.ExpMacroArgExpNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpMacroArgExpNode.sortList
...
// 2840: decl @lune.@base.@Nodes.ExpMacroArgExpNode.getLiteral
...
// 780: decl @lune.@base.@Nodes.StmtExpNode.create
...
// 791: decl @lune.@base.@Nodes.StmtExpNode.visit
...
// 796: decl @lune.@base.@Nodes.StmtExpNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpMacroStatListNode.create
...
// 791: decl @lune.@base.@Nodes.ExpMacroStatListNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpMacroStatListNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpOmitEnumNode.create
...
// 2865: decl @lune.@base.@Nodes.ExpOmitEnumNode.getLiteral
func (self *Nodes_ExpOmitEnumNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    var enumval *Ast_EnumValInfo
    enumval = self.valInfo
    return Nodes_enumLiteral2Literal_153_(_env, enumval.FP.Get_val(_env))
}
// 2873: decl @lune.@base.@Nodes.ExpOmitEnumNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.RefFieldNode.create
...
// 791: decl @lune.@base.@Nodes.RefFieldNode.visit
...
// 796: decl @lune.@base.@Nodes.RefFieldNode.sortList
...
// 1720: decl @lune.@base.@Nodes.RefFieldNode.get_effectivePos
func (self *Nodes_RefFieldNode) Get_effectivePos(_env *LnsEnv) Types_Position {
    return self.field.Pos
}
// 1723: decl @lune.@base.@Nodes.RefFieldNode.getPrefix
func (self *Nodes_RefFieldNode) GetPrefix(_env *LnsEnv) LnsAny {
    return self.prefix
}
// 1726: decl @lune.@base.@Nodes.RefFieldNode.canBeLeft
...
// 1741: decl @lune.@base.@Nodes.RefFieldNode.canBeRight
...
// 2784: decl @lune.@base.@Nodes.RefFieldNode.getLiteral
func (self *Nodes_RefFieldNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    ...
    if literal != nil{
        literal_8170 := literal
        switch _matchExp0 := literal_8170.(type) {
        case *Nodes_Literal__Symbol:
        ...
        default:
            return nil, _env.GetVM().String_format("not support -- %s", []LnsAny{literal_8170.(LnsAlgeVal).GetTxt()})
        }
        if self.nilAccess{
            tokenList.Insert("$.")
        } else { 
...
// 780: decl @lune.@base.@Nodes.GetFieldNode.create
...
// 791: decl @lune.@base.@Nodes.GetFieldNode.visit
...
// 796: decl @lune.@base.@Nodes.GetFieldNode.sortList
...
// 1765: decl @lune.@base.@Nodes.GetFieldNode.get_effectivePos
func (self *Nodes_GetFieldNode) Get_effectivePos(_env *LnsEnv) Types_Position {
    return self.field.Pos
}
// 1768: decl @lune.@base.@Nodes.GetFieldNode.getPrefix
...
// 780: decl @lune.@base.@Nodes.AliasNode.create
...
// 791: decl @lune.@base.@Nodes.AliasNode.visit
...
// 796: decl @lune.@base.@Nodes.AliasNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpandTupleNode.create
...
// 791: decl @lune.@base.@Nodes.ExpandTupleNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpandTupleNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclVarNode.create
...
// 791: decl @lune.@base.@Nodes.DeclVarNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclVarNode.sortList
...
// 1818: decl @lune.@base.@Nodes.DeclVarNode.getBreakKind
...
// 1841: decl @lune.@base.@Nodes.DeclVarNode.visitSub
...
// 1892: decl @lune.@base.@Nodes.DeclFuncInfo.createFrom
...
// 780: decl @lune.@base.@Nodes.DeclFormNode.create
...
// 791: decl @lune.@base.@Nodes.DeclFormNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclFormNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclFuncNode.create
...
// 791: decl @lune.@base.@Nodes.DeclFuncNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclFuncNode.sortList
...
// 1909: decl @lune.@base.@Nodes.DeclFuncNode.canBeRight
...
// 1913: decl @lune.@base.@Nodes.DeclFuncNode.canBeStatement
...
// 780: decl @lune.@base.@Nodes.DeclMethodNode.create
...
// 791: decl @lune.@base.@Nodes.DeclMethodNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclMethodNode.sortList
...
// 780: decl @lune.@base.@Nodes.ProtoMethodNode.create
...
// 791: decl @lune.@base.@Nodes.ProtoMethodNode.visit
...
// 796: decl @lune.@base.@Nodes.ProtoMethodNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclConstrNode.create
...
// 791: decl @lune.@base.@Nodes.DeclConstrNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclConstrNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclDestrNode.create
...
// 791: decl @lune.@base.@Nodes.DeclDestrNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclDestrNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpCallSuperCtorNode.create
...
// 791: decl @lune.@base.@Nodes.ExpCallSuperCtorNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpCallSuperCtorNode.sortList
...
// 780: decl @lune.@base.@Nodes.ExpCallSuperNode.create
...
// 791: decl @lune.@base.@Nodes.ExpCallSuperNode.visit
...
// 796: decl @lune.@base.@Nodes.ExpCallSuperNode.sortList
...
// 1947: decl @lune.@base.@Nodes.ExpCallSuperNode.canBeRight
...
// 780: decl @lune.@base.@Nodes.AsyncLockNode.create
...
// 791: decl @lune.@base.@Nodes.AsyncLockNode.visit
...
// 796: decl @lune.@base.@Nodes.AsyncLockNode.sortList
...
// 780: decl @lune.@base.@Nodes.RequestNode.create
...
// 791: decl @lune.@base.@Nodes.RequestNode.visit
...
// 796: decl @lune.@base.@Nodes.RequestNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclMemberNode.create
...
// 791: decl @lune.@base.@Nodes.DeclMemberNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclMemberNode.sortList
...
// 1986: decl @lune.@base.@Nodes.DeclMemberNode.getGetterSym
func (self *Nodes_DeclMemberNode) GetGetterSym(_env *LnsEnv) LnsAny {
    if self.getterMode != Ast_AccessMode__None{
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, _env.GetVM().String_format("get_%s", []LnsAny{self.name.Txt}))})/* 1988:14 */)
    }
    return nil
}
// 1993: decl @lune.@base.@Nodes.DeclMemberNode.getSetterSym
func (self *Nodes_DeclMemberNode) GetSetterSym(_env *LnsEnv) LnsAny {
    if self.setterMode != Ast_AccessMode__None{
        return _env.NilAccFin(_env.NilAccPush(self.classType.FP.Get_scope(_env)) && 
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, _env.GetVM().String_format("set_%s", []LnsAny{self.name.Txt}))})/* 1995:14 */)
    }
    return nil
}
...
// 780: decl @lune.@base.@Nodes.DeclArgNode.create
...
// 791: decl @lune.@base.@Nodes.DeclArgNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclArgNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclArgDDDNode.create
...
// 780: decl @lune.@base.@Nodes.DeclAdvertiseNode.create
...
// 2021: decl @lune.@base.@Nodes.ClassInheritInfo.visit
...
// 780: decl @lune.@base.@Nodes.ProtoClassNode.create
...
// 2038: decl @lune.@base.@Nodes.ProtoClassNode.visitSub
...
// 780: decl @lune.@base.@Nodes.DeclClassNode.create
...
// 791: decl @lune.@base.@Nodes.DeclClassNode.visit
...
// 796: decl @lune.@base.@Nodes.DeclClassNode.sortList
...
// 2130: decl @lune.@base.@Nodes.DeclClassNode.setHasOldCtor
func (self *Nodes_DeclClassNode) SetHasOldCtor(_env *LnsEnv) {
    self.hasOldCtor = true
}
// 2134: decl @lune.@base.@Nodes.DeclClassNode.hasUserInit
...
// 780: decl @lune.@base.@Nodes.DeclEnumNode.create
...
// 780: decl @lune.@base.@Nodes.DeclAlgeNode.create
...
// 2164: decl @lune.@base.@Nodes.DeclAlgeNode.visitSub
...
// 780: decl @lune.@base.@Nodes.NewAlgeValNode.create
...
// 791: decl @lune.@base.@Nodes.NewAlgeValNode.visit
...
// 796: decl @lune.@base.@Nodes.NewAlgeValNode.sortList
...
// 2185: decl @lune.@base.@Nodes.NewAlgeValNode.get_algeTypeInfo
...
// 780: decl @lune.@base.@Nodes.LuneControlNode.create
...
// 780: decl @lune.@base.@Nodes.MatchNode.create
...
// 791: decl @lune.@base.@Nodes.MatchNode.visit
...
// 796: decl @lune.@base.@Nodes.MatchNode.sortList
...
// 2227: decl @lune.@base.@Nodes.MatchNode.get_algeTypeInfo
...
// 2241: decl @lune.@base.@Nodes.MatchNode.getBreakKind
...
// 2262: decl @lune.@base.@Nodes.MatchNode.visitSub
...
// 780: decl @lune.@base.@Nodes.LuneKindNode.create
...
// 791: decl @lune.@base.@Nodes.LuneKindNode.visit
...
// 796: decl @lune.@base.@Nodes.LuneKindNode.sortList
...
// 780: decl @lune.@base.@Nodes.DeclMacroNode.create
...
// 780: decl @lune.@base.@Nodes.TestCaseNode.create
...
// 791: decl @lune.@base.@Nodes.TestCaseNode.visit
...
// 796: decl @lune.@base.@Nodes.TestCaseNode.sortList
...
// 780: decl @lune.@base.@Nodes.TestBlockNode.create
...
// 791: decl @lune.@base.@Nodes.TestBlockNode.visit
...
// 796: decl @lune.@base.@Nodes.TestBlockNode.sortList
...
// 2311: decl @lune.@base.@Nodes.TestBlockNode.isInnerPos
...
// 780: decl @lune.@base.@Nodes.AbbrNode.create
...
// 780: decl @lune.@base.@Nodes.BoxingNode.create
...
// 791: decl @lune.@base.@Nodes.BoxingNode.visit
...
// 796: decl @lune.@base.@Nodes.BoxingNode.sortList
...
// 780: decl @lune.@base.@Nodes.UnboxingNode.create
...
// 791: decl @lune.@base.@Nodes.UnboxingNode.visit
...
// 796: decl @lune.@base.@Nodes.UnboxingNode.sortList
...
// 780: decl @lune.@base.@Nodes.LiteralNilNode.create
...
// 2509: decl @lune.@base.@Nodes.LiteralNilNode.getLiteral
func (self *Nodes_LiteralNilNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return Nodes_Literal__Nil_Obj, nil
}
// 2512: decl @lune.@base.@Nodes.LiteralNilNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralCharNode.create
...
// 2518: decl @lune.@base.@Nodes.LiteralCharNode.getLiteral
func (self *Nodes_LiteralCharNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Int{self.num}, nil
}
// 2521: decl @lune.@base.@Nodes.LiteralCharNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralIntNode.create
...
// 2526: decl @lune.@base.@Nodes.LiteralIntNode.getLiteral
func (self *Nodes_LiteralIntNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Int{self.num}, nil
}
// 2529: decl @lune.@base.@Nodes.LiteralIntNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralRealNode.create
...
// 2534: decl @lune.@base.@Nodes.LiteralRealNode.getLiteral
func (self *Nodes_LiteralRealNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Real{self.num}, nil
}
// 2537: decl @lune.@base.@Nodes.LiteralRealNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralArrayNode.create
...
// 791: decl @lune.@base.@Nodes.LiteralArrayNode.visit
...
// 796: decl @lune.@base.@Nodes.LiteralArrayNode.sortList
...
// 2542: decl @lune.@base.@Nodes.LiteralArrayNode.getLiteral
    ...
    literalList = NewLnsList([]LnsAny{})
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            for _, _node := range( _exp.FP.Get_expList(_env).Items ) {
                ...
                if literal != nil{
                    literal_8029 := literal
                    literalList.Insert(literal_8029)
                } else {
                    return nil, mess
                }
            }
...
// 2558: decl @lune.@base.@Nodes.LiteralArrayNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralListNode.create
...
// 791: decl @lune.@base.@Nodes.LiteralListNode.visit
...
// 796: decl @lune.@base.@Nodes.LiteralListNode.sortList
...
// 2575: decl @lune.@base.@Nodes.LiteralListNode.getLiteral
    ...
    literalList = NewLnsList([]LnsAny{})
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            for _, _node := range( _exp.FP.Get_expList(_env).Items ) {
                ...
                literal,mess = node.FP.GetLiteral(_env)
                if literal != nil{
                    literal_8050 := literal
                    literalList.Insert(literal_8050)
                } else {
                    return nil, mess
                }
            }
...
// 2591: decl @lune.@base.@Nodes.LiteralListNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralSetNode.create
...
// 791: decl @lune.@base.@Nodes.LiteralSetNode.visit
...
// 796: decl @lune.@base.@Nodes.LiteralSetNode.sortList
...
// 2609: decl @lune.@base.@Nodes.LiteralSetNode.getLiteral
    ...
    literalList = NewLnsList([]LnsAny{})
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            for _, _node := range( _exp.FP.Get_expList(_env).Items ) {
                ...
                literal,mess = node.FP.GetLiteral(_env)
                if literal != nil{
                    literal_8071 := literal
                    literalList.Insert(literal_8071)
                } else {
                    return nil, mess
                }
            }
...
// 2625: decl @lune.@base.@Nodes.LiteralSetNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralMapNode.create
...
// 791: decl @lune.@base.@Nodes.LiteralMapNode.visit
...
// 796: decl @lune.@base.@Nodes.LiteralMapNode.sortList
...
// 2642: decl @lune.@base.@Nodes.LiteralMapNode.getLiteral
func (self *Nodes_LiteralMapNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    ...
    for _key, _val := range( self._map.Items ) {
        ...
        if keyLiteral != nil && valLiteral != nil{
            keyLiteral_8093 := keyLiteral
            valLiteral_8094 := valLiteral
            litMap.Set(keyLiteral_8093,valLiteral_8094)
        } else {
...
// 2662: decl @lune.@base.@Nodes.LiteralMapNode.setupLiteralTokenList
func (self *Nodes_LiteralMapNode) SetupLiteralTokenList(_env *LnsEnv, list *LnsList) bool {
    ...
    for _key, _ := range( self._map.Items ) {
        key := _key.(Nodes_NodeDownCast).ToNodes_Node()
        var literal LnsAny
        literal = Nodes_convExp0_34990(Lns_2DDD(key.FP.GetLiteral(_env)))
        if literal != nil{
            literal_8106 := literal
            switch _matchExp0 := literal_8106.(type) {
            case *Nodes_Literal__Int:
    ...
    }
    {
        ...
        for _, __ := range( __forsortSorted0.Items ) {
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Nodes_Node).FP.SetupLiteralTokenList(_env, list)})/* 2692:14 */)){
                return false
            }
            self.FP.AddTokenList(_env, list, Types_TokenKind__Dlmt, ",")
        }
...
// 780: decl @lune.@base.@Nodes.LiteralStringNode.create
...
// 791: decl @lune.@base.@Nodes.LiteralStringNode.visit
...
// 796: decl @lune.@base.@Nodes.LiteralStringNode.sortList
...
// 2702: decl @lune.@base.@Nodes.LiteralStringNode.getLiteral
    ...
    }
    {
        ...
        if !Lns_IsNil( _param ) {
            ...
            for _, _argNode := range( argList.Items ) {
                ...
                if arg != nil{
                    arg_8133 := arg
                    paramList.Set(paramList.Len() + 1,Nodes_getLiteralObj(_env, arg_8133))
                } else {
                    return nil, mess
                }
            }
            txt = _env.GetVM().String_format(Nodes_convExp0_35248(txt, Lns_2DDD(paramList.Unpack())))
        }
    }
    return &Nodes_Literal__Str{txt}, nil
}
// 2729: decl @lune.@base.@Nodes.LiteralStringNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.LiteralBoolNode.create
...
// 780: decl @lune.@base.@Nodes.LiteralSymbolNode.create
...
// 2758: decl @lune.@base.@Nodes.LiteralSymbolNode.getLiteral
func (self *Nodes_LiteralSymbolNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Symbol{self.token.Txt}, nil
}
// 2762: decl @lune.@base.@Nodes.LiteralSymbolNode.setupLiteralTokenList
...
// 780: decl @lune.@base.@Nodes.TupleConstNode.create
...
// 791: decl @lune.@base.@Nodes.TupleConstNode.visit
...
// 796: decl @lune.@base.@Nodes.TupleConstNode.sortList
