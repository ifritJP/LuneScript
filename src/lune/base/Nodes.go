...
// for 2712
func Nodes_convExp0_34969(arg1 string, arg2 []LnsAny) (string, []LnsAny) {
...
// for 2534
func Nodes_convExp0_34205(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2567
func Nodes_convExp0_34342(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2601
func Nodes_convExp0_34479(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2633
func Nodes_convExp0_34613(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2634
func Nodes_convExp0_34621(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2656
func Nodes_convExp0_34711(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2704
func Nodes_convExp0_34922(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2782
func Nodes_convExp0_35245(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// for 2813
func Nodes_convExp0_35365(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2873
func Nodes_convExp0_35596(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2923
func Nodes_convExp0_35720(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 2949
func Nodes_convExp0_35818(arg1 []LnsAny) (bool, LnsInt, LnsReal, string, *Ast_TypeInfo) {
...
// for 2950
func Nodes_convExp0_35834(arg1 []LnsAny) (bool, LnsInt, LnsReal, string, *Ast_TypeInfo) {
    return Lns_getFromMulti( arg1, 0 ).(bool), Lns_getFromMulti( arg1, 1 ).(LnsInt), Lns_getFromMulti( arg1, 2 ).(LnsReal), Lns_getFromMulti( arg1, 3 ).(string), Lns_getFromMulti( arg1, 4 ).(*Ast_TypeInfo)
}
...
// 389: decl @lune.@base.@Nodes.cloneNodeList
...
// 424: decl @lune.@base.@Nodes.regKind
...
// 2381: decl @lune.@base.@Nodes.Node.getSymbolInfo.processExpNode
...
// 2757: decl @lune.@base.@Nodes.enumLiteral2Literal
...
// 3084: decl @lune.@base.@Nodes.hasMultiValNode
...
// 3105: decl @lune.@base.@Nodes.getUnwraped
...
// 3115: decl @lune.@base.@Nodes.getCastUnwraped
...
// 435: decl @lune.@base.@Nodes.Filter.defaultProcess
...
// 3067: decl @lune.@base.@Nodes.Filter.processBlockSub
func (self *Nodes_Filter) ProcessBlockSub(_env *LnsEnv, node *Nodes_BlockNode,_opt LnsAny) {
}
// 3070: decl @lune.@base.@Nodes.Filter.processBlock
...
// 518: decl @lune.@base.@Nodes.NodeManager.addNode
...
// 525: decl @lune.@base.@Nodes.NodeManager.delNode
...
// 541: decl @lune.@base.@Nodes.NodeManager.addFrom
...
// 3053: decl @lune.@base.@Nodes.NodeManager.MultiTo1
...
// 768: decl @lune.@base.@Nodes.NoneNode.create
...
// 779: decl @lune.@base.@Nodes.NoneNode.visit
...
// 784: decl @lune.@base.@Nodes.NoneNode.sortList
...
// 768: decl @lune.@base.@Nodes.ShebangNode.create
...
// 768: decl @lune.@base.@Nodes.ConvStatNode.create
...
// 768: decl @lune.@base.@Nodes.BlankLineNode.create
...
// 768: decl @lune.@base.@Nodes.SubfileNode.create
...
// 768: decl @lune.@base.@Nodes.ImportNode.create
...
// 768: decl @lune.@base.@Nodes.RootNode.create
...
// 779: decl @lune.@base.@Nodes.RootNode.visit
...
// 784: decl @lune.@base.@Nodes.RootNode.sortList
...
// 920: decl @lune.@base.@Nodes.RootNode.set_provide
...
// 768: decl @lune.@base.@Nodes.RefTypeNode.create
...
// 779: decl @lune.@base.@Nodes.RefTypeNode.visit
...
// 784: decl @lune.@base.@Nodes.RefTypeNode.sortList
...
// 935: decl @lune.@base.@Nodes.RefTypeNode.checkValidGenerics
...
// 768: decl @lune.@base.@Nodes.DeclTupleNode.create
...
// 768: decl @lune.@base.@Nodes.BlockNode.create
...
// 779: decl @lune.@base.@Nodes.BlockNode.visit
...
// 784: decl @lune.@base.@Nodes.BlockNode.sortList
...
// 1072: decl @lune.@base.@Nodes.BlockNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ScopeNode.create
...
// 779: decl @lune.@base.@Nodes.ScopeNode.visit
...
// 784: decl @lune.@base.@Nodes.ScopeNode.sortList
...
// 768: decl @lune.@base.@Nodes.CondRetNode.create
...
// 779: decl @lune.@base.@Nodes.CondRetNode.visit
...
// 784: decl @lune.@base.@Nodes.CondRetNode.sortList
...
// 768: decl @lune.@base.@Nodes.CondRetListNode.create
...
// 779: decl @lune.@base.@Nodes.CondRetListNode.visit
...
// 784: decl @lune.@base.@Nodes.CondRetListNode.sortList
...
// 768: decl @lune.@base.@Nodes.IfNode.create
...
// 1119: decl @lune.@base.@Nodes.IfNode.getBreakKind
...
// 1136: decl @lune.@base.@Nodes.IfNode.visitSub
...
// 768: decl @lune.@base.@Nodes.ExpListNode.create
...
// 779: decl @lune.@base.@Nodes.ExpListNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpListNode.sortList
...
// 1161: decl @lune.@base.@Nodes.ExpListNode.canBeLeft
...
// 1169: decl @lune.@base.@Nodes.ExpListNode.canBeRight
...
// 1177: decl @lune.@base.@Nodes.ExpListNode.setLValue
...
// 1194: decl @lune.@base.@Nodes.ExpListNode.getExpTypeAt
...
// 1214: decl @lune.@base.@Nodes.ExpListNode.getExpTypeNoDDDAt
...
// 768: decl @lune.@base.@Nodes.SwitchNode.create
...
// 779: decl @lune.@base.@Nodes.SwitchNode.visit
...
// 784: decl @lune.@base.@Nodes.SwitchNode.sortList
...
// 1254: decl @lune.@base.@Nodes.SwitchNode.getBreakKind
...
// 1283: decl @lune.@base.@Nodes.SwitchNode.visitSub
...
// 768: decl @lune.@base.@Nodes.WhileNode.create
...
// 779: decl @lune.@base.@Nodes.WhileNode.visit
...
// 784: decl @lune.@base.@Nodes.WhileNode.sortList
...
// 2437: decl @lune.@base.@Nodes.WhileNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.RepeatNode.create
...
// 779: decl @lune.@base.@Nodes.RepeatNode.visit
...
// 784: decl @lune.@base.@Nodes.RepeatNode.sortList
...
// 1296: decl @lune.@base.@Nodes.RepeatNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ForNode.create
...
// 779: decl @lune.@base.@Nodes.ForNode.visit
...
// 784: decl @lune.@base.@Nodes.ForNode.sortList
...
// 1296: decl @lune.@base.@Nodes.ForNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ApplyNode.create
...
// 779: decl @lune.@base.@Nodes.ApplyNode.visit
...
// 784: decl @lune.@base.@Nodes.ApplyNode.sortList
...
// 1296: decl @lune.@base.@Nodes.ApplyNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ForeachNode.create
...
// 779: decl @lune.@base.@Nodes.ForeachNode.visit
...
// 784: decl @lune.@base.@Nodes.ForeachNode.sortList
...
// 1296: decl @lune.@base.@Nodes.ForeachNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ForsortNode.create
...
// 779: decl @lune.@base.@Nodes.ForsortNode.visit
...
// 784: decl @lune.@base.@Nodes.ForsortNode.sortList
...
// 1296: decl @lune.@base.@Nodes.ForsortNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ReturnNode.create
...
// 779: decl @lune.@base.@Nodes.ReturnNode.visit
...
// 784: decl @lune.@base.@Nodes.ReturnNode.sortList
...
// 1367: decl @lune.@base.@Nodes.ReturnNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.BreakNode.create
...
// 1373: decl @lune.@base.@Nodes.BreakNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ProvideNode.create
...
// 768: decl @lune.@base.@Nodes.ExpNewNode.create
...
// 779: decl @lune.@base.@Nodes.ExpNewNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpNewNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpUnwrapNode.create
...
// 779: decl @lune.@base.@Nodes.ExpUnwrapNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpUnwrapNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpRefNode.create
...
// 2834: decl @lune.@base.@Nodes.ExpRefNode.getLiteral
...
// 768: decl @lune.@base.@Nodes.ExpSetValNode.create
...
// 779: decl @lune.@base.@Nodes.ExpSetValNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpSetValNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpSetItemNode.create
...
// 779: decl @lune.@base.@Nodes.ExpSetItemNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpSetItemNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpOp2Node.create
...
// 779: decl @lune.@base.@Nodes.ExpOp2Node.visit
...
// 784: decl @lune.@base.@Nodes.ExpOp2Node.sortList
...
// 2872: decl @lune.@base.@Nodes.ExpOp2Node.getValType
func (self *Nodes_ExpOp2Node) getValType(_env *LnsEnv, node *Nodes_Node)(bool, LnsInt, LnsReal, string, *Ast_TypeInfo) {
    var literal LnsAny
    
    {
        _literal := Nodes_convExp0_35596(Lns_2DDD(node.FP.GetLiteral(_env)))
        if _literal == nil{
...
// 2922: decl @lune.@base.@Nodes.ExpOp2Node.setupLiteralTokenList
func (self *Nodes_ExpOp2Node) SetupLiteralTokenList(_env *LnsEnv, list *LnsList) bool {
    var literal LnsAny
    literal = Nodes_convExp0_35720(Lns_2DDD(self.FP.GetLiteral(_env)))
    if literal != nil{
        literal_8185 := literal
        switch _matchExp0 := literal_8185.(type) {
        case *Nodes_Literal__Int:
            val := _matchExp0.Val1
...
// 2947: decl @lune.@base.@Nodes.ExpOp2Node.getLiteral
...
// 768: decl @lune.@base.@Nodes.UnwrapSetNode.create
...
// 779: decl @lune.@base.@Nodes.UnwrapSetNode.visit
...
// 784: decl @lune.@base.@Nodes.UnwrapSetNode.sortList
...
// 768: decl @lune.@base.@Nodes.IfUnwrapNode.create
...
// 779: decl @lune.@base.@Nodes.IfUnwrapNode.visit
...
// 784: decl @lune.@base.@Nodes.IfUnwrapNode.sortList
...
// 1460: decl @lune.@base.@Nodes.IfUnwrapNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.WhenNode.create
...
// 779: decl @lune.@base.@Nodes.WhenNode.visit
...
// 784: decl @lune.@base.@Nodes.WhenNode.sortList
...
// 1486: decl @lune.@base.@Nodes.WhenNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ExpCastNode.create
...
// 779: decl @lune.@base.@Nodes.ExpCastNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpCastNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpToDDDNode.create
...
// 779: decl @lune.@base.@Nodes.ExpToDDDNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpToDDDNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpSubDDDNode.create
...
// 779: decl @lune.@base.@Nodes.ExpSubDDDNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpSubDDDNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpOp1Node.create
...
// 779: decl @lune.@base.@Nodes.ExpOp1Node.visit
...
// 784: decl @lune.@base.@Nodes.ExpOp1Node.sortList
...
// 768: decl @lune.@base.@Nodes.ExpRefItemNode.create
...
// 779: decl @lune.@base.@Nodes.ExpRefItemNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpRefItemNode.sortList
...
// 1569: decl @lune.@base.@Nodes.ExpRefItemNode.getPrefix
func (self *Nodes_ExpRefItemNode) GetPrefix(_env *LnsEnv) LnsAny {
    return self.val
}
// 1572: decl @lune.@base.@Nodes.ExpRefItemNode.canBeLeft
...
// 768: decl @lune.@base.@Nodes.ExpCallNode.create
...
// 779: decl @lune.@base.@Nodes.ExpCallNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpCallNode.sortList
...
// 1604: decl @lune.@base.@Nodes.ExpCallNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ExpMRetNode.create
...
// 779: decl @lune.@base.@Nodes.ExpMRetNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpMRetNode.sortList
...
// 1615: decl @lune.@base.@Nodes.ExpMRetNode.getPrefix
...
// 768: decl @lune.@base.@Nodes.ExpAccessMRetNode.create
...
// 779: decl @lune.@base.@Nodes.ExpAccessMRetNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpAccessMRetNode.sortList
...
// 1624: decl @lune.@base.@Nodes.ExpAccessMRetNode.getPrefix
...
// 768: decl @lune.@base.@Nodes.ExpMultiTo1Node.create
...
// 779: decl @lune.@base.@Nodes.ExpMultiTo1Node.visit
...
// 784: decl @lune.@base.@Nodes.ExpMultiTo1Node.sortList
...
// 1631: decl @lune.@base.@Nodes.ExpMultiTo1Node.getPrefix
...
// 768: decl @lune.@base.@Nodes.ExpParenNode.create
...
// 779: decl @lune.@base.@Nodes.ExpParenNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpParenNode.sortList
...
// 1638: decl @lune.@base.@Nodes.ExpParenNode.getPrefix
func (self *Nodes_ExpParenNode) GetPrefix(_env *LnsEnv) LnsAny {
    return self.exp.FP.GetPrefix(_env)
}
// 1642: decl @lune.@base.@Nodes.ExpParenNode.getSymbolInfo
...
// 768: decl @lune.@base.@Nodes.ExpMacroExpNode.create
...
// 779: decl @lune.@base.@Nodes.ExpMacroExpNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpMacroExpNode.sortList
...
// 1655: decl @lune.@base.@Nodes.ExpMacroExpNode.canBeRight
...
// 1659: decl @lune.@base.@Nodes.ExpMacroExpNode.getBreakKind
...
// 768: decl @lune.@base.@Nodes.ExpMacroStatNode.create
...
// 779: decl @lune.@base.@Nodes.ExpMacroStatNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpMacroStatNode.sortList
...
// 2809: decl @lune.@base.@Nodes.ExpMacroStatNode.getLiteral
func (self *Nodes_ExpMacroStatNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    ...
    for _, _token := range( self.expStrList.Items ) {
        ...
        var literal LnsAny
        literal = Nodes_convExp0_35365(Lns_2DDD(token.FP.GetLiteral(_env)))
        if literal != nil{
            literal_8147 := literal
            switch _matchExp0 := literal_8147.(type) {
            case *Nodes_Literal__Str:
...
// 768: decl @lune.@base.@Nodes.ExpMacroArgExpNode.create
...
// 779: decl @lune.@base.@Nodes.ExpMacroArgExpNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpMacroArgExpNode.sortList
...
// 2828: decl @lune.@base.@Nodes.ExpMacroArgExpNode.getLiteral
...
// 768: decl @lune.@base.@Nodes.StmtExpNode.create
...
// 779: decl @lune.@base.@Nodes.StmtExpNode.visit
...
// 784: decl @lune.@base.@Nodes.StmtExpNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpMacroStatListNode.create
...
// 779: decl @lune.@base.@Nodes.ExpMacroStatListNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpMacroStatListNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpOmitEnumNode.create
...
// 2853: decl @lune.@base.@Nodes.ExpOmitEnumNode.getLiteral
func (self *Nodes_ExpOmitEnumNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    var enumval *Ast_EnumValInfo
    enumval = self.valInfo
    return Nodes_enumLiteral2Literal_153_(_env, enumval.FP.Get_val(_env))
}
// 2861: decl @lune.@base.@Nodes.ExpOmitEnumNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.RefFieldNode.create
...
// 779: decl @lune.@base.@Nodes.RefFieldNode.visit
...
// 784: decl @lune.@base.@Nodes.RefFieldNode.sortList
...
// 1708: decl @lune.@base.@Nodes.RefFieldNode.get_effectivePos
func (self *Nodes_RefFieldNode) Get_effectivePos(_env *LnsEnv) Types_Position {
    return self.field.Pos
}
// 1711: decl @lune.@base.@Nodes.RefFieldNode.getPrefix
func (self *Nodes_RefFieldNode) GetPrefix(_env *LnsEnv) LnsAny {
    return self.prefix
}
// 1714: decl @lune.@base.@Nodes.RefFieldNode.canBeLeft
...
// 1729: decl @lune.@base.@Nodes.RefFieldNode.canBeRight
...
// 2772: decl @lune.@base.@Nodes.RefFieldNode.getLiteral
func (self *Nodes_RefFieldNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    ...
    if literal != nil{
        ...
        switch _matchExp0 := literal_8130.(type) {
        case *Nodes_Literal__Symbol:
        ...
        default:
            return nil, _env.GetVM().String_format("not support -- %s", []LnsAny{literal_8130.(LnsAlgeVal).GetTxt()})
        }
        if self.nilAccess{
            tokenList.Insert("$.")
        } else { 
...
// 768: decl @lune.@base.@Nodes.GetFieldNode.create
...
// 779: decl @lune.@base.@Nodes.GetFieldNode.visit
...
// 784: decl @lune.@base.@Nodes.GetFieldNode.sortList
...
// 1753: decl @lune.@base.@Nodes.GetFieldNode.get_effectivePos
func (self *Nodes_GetFieldNode) Get_effectivePos(_env *LnsEnv) Types_Position {
    return self.field.Pos
}
// 1756: decl @lune.@base.@Nodes.GetFieldNode.getPrefix
...
// 768: decl @lune.@base.@Nodes.AliasNode.create
...
// 779: decl @lune.@base.@Nodes.AliasNode.visit
...
// 784: decl @lune.@base.@Nodes.AliasNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpandTupleNode.create
...
// 779: decl @lune.@base.@Nodes.ExpandTupleNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpandTupleNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclVarNode.create
...
// 779: decl @lune.@base.@Nodes.DeclVarNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclVarNode.sortList
...
// 1806: decl @lune.@base.@Nodes.DeclVarNode.getBreakKind
...
// 1829: decl @lune.@base.@Nodes.DeclVarNode.visitSub
...
// 1880: decl @lune.@base.@Nodes.DeclFuncInfo.createFrom
...
// 768: decl @lune.@base.@Nodes.DeclFormNode.create
...
// 779: decl @lune.@base.@Nodes.DeclFormNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclFormNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclFuncNode.create
...
// 779: decl @lune.@base.@Nodes.DeclFuncNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclFuncNode.sortList
...
// 1897: decl @lune.@base.@Nodes.DeclFuncNode.canBeRight
...
// 1901: decl @lune.@base.@Nodes.DeclFuncNode.canBeStatement
...
// 768: decl @lune.@base.@Nodes.DeclMethodNode.create
...
// 779: decl @lune.@base.@Nodes.DeclMethodNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclMethodNode.sortList
...
// 768: decl @lune.@base.@Nodes.ProtoMethodNode.create
...
// 779: decl @lune.@base.@Nodes.ProtoMethodNode.visit
...
// 784: decl @lune.@base.@Nodes.ProtoMethodNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclConstrNode.create
...
// 779: decl @lune.@base.@Nodes.DeclConstrNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclConstrNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclDestrNode.create
...
// 779: decl @lune.@base.@Nodes.DeclDestrNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclDestrNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpCallSuperCtorNode.create
...
// 779: decl @lune.@base.@Nodes.ExpCallSuperCtorNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpCallSuperCtorNode.sortList
...
// 768: decl @lune.@base.@Nodes.ExpCallSuperNode.create
...
// 779: decl @lune.@base.@Nodes.ExpCallSuperNode.visit
...
// 784: decl @lune.@base.@Nodes.ExpCallSuperNode.sortList
...
// 1935: decl @lune.@base.@Nodes.ExpCallSuperNode.canBeRight
...
// 768: decl @lune.@base.@Nodes.AsyncLockNode.create
...
// 779: decl @lune.@base.@Nodes.AsyncLockNode.visit
...
// 784: decl @lune.@base.@Nodes.AsyncLockNode.sortList
...
// 768: decl @lune.@base.@Nodes.RequestNode.create
...
// 779: decl @lune.@base.@Nodes.RequestNode.visit
...
// 784: decl @lune.@base.@Nodes.RequestNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclMemberNode.create
...
// 779: decl @lune.@base.@Nodes.DeclMemberNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclMemberNode.sortList
...
// 1974: decl @lune.@base.@Nodes.DeclMemberNode.getGetterSym
func (self *Nodes_DeclMemberNode) GetGetterSym(_env *LnsEnv) LnsAny {
    if self.getterMode != Ast_AccessMode__None{
        ...
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, _env.GetVM().String_format("get_%s", []LnsAny{self.name.Txt}))})/* 1976:14 */)
    }
    return nil
}
// 1981: decl @lune.@base.@Nodes.DeclMemberNode.getSetterSym
func (self *Nodes_DeclMemberNode) GetSetterSym(_env *LnsEnv) LnsAny {
    if self.setterMode != Ast_AccessMode__None{
        return _env.NilAccFin(_env.NilAccPush(self.classType.FP.Get_scope(_env)) && 
        Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Ast_Scope).FP.GetSymbolInfoChild(_env, _env.GetVM().String_format("set_%s", []LnsAny{self.name.Txt}))})/* 1983:14 */)
    }
    return nil
}
...
// 768: decl @lune.@base.@Nodes.DeclArgNode.create
...
// 779: decl @lune.@base.@Nodes.DeclArgNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclArgNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclArgDDDNode.create
...
// 768: decl @lune.@base.@Nodes.DeclAdvertiseNode.create
...
// 2009: decl @lune.@base.@Nodes.ClassInheritInfo.visit
...
// 768: decl @lune.@base.@Nodes.ProtoClassNode.create
...
// 2026: decl @lune.@base.@Nodes.ProtoClassNode.visitSub
...
// 768: decl @lune.@base.@Nodes.DeclClassNode.create
...
// 779: decl @lune.@base.@Nodes.DeclClassNode.visit
...
// 784: decl @lune.@base.@Nodes.DeclClassNode.sortList
...
// 2118: decl @lune.@base.@Nodes.DeclClassNode.setHasOldCtor
func (self *Nodes_DeclClassNode) SetHasOldCtor(_env *LnsEnv) {
    self.hasOldCtor = true
}
// 2122: decl @lune.@base.@Nodes.DeclClassNode.hasUserInit
...
// 768: decl @lune.@base.@Nodes.DeclEnumNode.create
...
// 768: decl @lune.@base.@Nodes.DeclAlgeNode.create
...
// 2152: decl @lune.@base.@Nodes.DeclAlgeNode.visitSub
...
// 768: decl @lune.@base.@Nodes.NewAlgeValNode.create
...
// 779: decl @lune.@base.@Nodes.NewAlgeValNode.visit
...
// 784: decl @lune.@base.@Nodes.NewAlgeValNode.sortList
...
// 2173: decl @lune.@base.@Nodes.NewAlgeValNode.get_algeTypeInfo
...
// 768: decl @lune.@base.@Nodes.LuneControlNode.create
...
// 768: decl @lune.@base.@Nodes.MatchNode.create
...
// 779: decl @lune.@base.@Nodes.MatchNode.visit
...
// 784: decl @lune.@base.@Nodes.MatchNode.sortList
...
// 2215: decl @lune.@base.@Nodes.MatchNode.get_algeTypeInfo
...
// 2229: decl @lune.@base.@Nodes.MatchNode.getBreakKind
...
// 2250: decl @lune.@base.@Nodes.MatchNode.visitSub
...
// 768: decl @lune.@base.@Nodes.LuneKindNode.create
...
// 779: decl @lune.@base.@Nodes.LuneKindNode.visit
...
// 784: decl @lune.@base.@Nodes.LuneKindNode.sortList
...
// 768: decl @lune.@base.@Nodes.DeclMacroNode.create
...
// 768: decl @lune.@base.@Nodes.TestCaseNode.create
...
// 779: decl @lune.@base.@Nodes.TestCaseNode.visit
...
// 784: decl @lune.@base.@Nodes.TestCaseNode.sortList
...
// 768: decl @lune.@base.@Nodes.TestBlockNode.create
...
// 779: decl @lune.@base.@Nodes.TestBlockNode.visit
...
// 784: decl @lune.@base.@Nodes.TestBlockNode.sortList
...
// 2299: decl @lune.@base.@Nodes.TestBlockNode.isInnerPos
...
// 768: decl @lune.@base.@Nodes.AbbrNode.create
...
// 768: decl @lune.@base.@Nodes.BoxingNode.create
...
// 779: decl @lune.@base.@Nodes.BoxingNode.visit
...
// 784: decl @lune.@base.@Nodes.BoxingNode.sortList
...
// 768: decl @lune.@base.@Nodes.UnboxingNode.create
...
// 779: decl @lune.@base.@Nodes.UnboxingNode.visit
...
// 784: decl @lune.@base.@Nodes.UnboxingNode.sortList
...
// 768: decl @lune.@base.@Nodes.LiteralNilNode.create
...
// 2497: decl @lune.@base.@Nodes.LiteralNilNode.getLiteral
func (self *Nodes_LiteralNilNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return Nodes_Literal__Nil_Obj, nil
}
// 2500: decl @lune.@base.@Nodes.LiteralNilNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralCharNode.create
...
// 2506: decl @lune.@base.@Nodes.LiteralCharNode.getLiteral
func (self *Nodes_LiteralCharNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Int{self.num}, nil
}
// 2509: decl @lune.@base.@Nodes.LiteralCharNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralIntNode.create
...
// 2514: decl @lune.@base.@Nodes.LiteralIntNode.getLiteral
func (self *Nodes_LiteralIntNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Int{self.num}, nil
}
// 2517: decl @lune.@base.@Nodes.LiteralIntNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralRealNode.create
...
// 2522: decl @lune.@base.@Nodes.LiteralRealNode.getLiteral
func (self *Nodes_LiteralRealNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Real{self.num}, nil
}
// 2525: decl @lune.@base.@Nodes.LiteralRealNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralArrayNode.create
...
// 779: decl @lune.@base.@Nodes.LiteralArrayNode.visit
...
// 784: decl @lune.@base.@Nodes.LiteralArrayNode.sortList
...
// 2530: decl @lune.@base.@Nodes.LiteralArrayNode.getLiteral
...
// 2546: decl @lune.@base.@Nodes.LiteralArrayNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralListNode.create
...
// 779: decl @lune.@base.@Nodes.LiteralListNode.visit
...
// 784: decl @lune.@base.@Nodes.LiteralListNode.sortList
...
// 2563: decl @lune.@base.@Nodes.LiteralListNode.getLiteral
    ...
    literalList = NewLnsList([]LnsAny{})
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            for _, _node := range( _exp.FP.Get_expList(_env).Items ) {
                ...
                literal,mess = node.FP.GetLiteral(_env)
                if literal != nil{
                    literal_8010 := literal
                    literalList.Insert(literal_8010)
                } else {
                    return nil, mess
                }
            }
...
// 2579: decl @lune.@base.@Nodes.LiteralListNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralSetNode.create
...
// 779: decl @lune.@base.@Nodes.LiteralSetNode.visit
...
// 784: decl @lune.@base.@Nodes.LiteralSetNode.sortList
...
// 2597: decl @lune.@base.@Nodes.LiteralSetNode.getLiteral
    ...
    literalList = NewLnsList([]LnsAny{})
    {
        ...
        if !Lns_IsNil( __exp ) {
            ...
            for _, _node := range( _exp.FP.Get_expList(_env).Items ) {
                ...
                literal,mess = node.FP.GetLiteral(_env)
                if literal != nil{
                    literal_8031 := literal
                    literalList.Insert(literal_8031)
                } else {
                    return nil, mess
                }
            }
...
// 2613: decl @lune.@base.@Nodes.LiteralSetNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralMapNode.create
...
// 779: decl @lune.@base.@Nodes.LiteralMapNode.visit
...
// 784: decl @lune.@base.@Nodes.LiteralMapNode.sortList
...
// 2630: decl @lune.@base.@Nodes.LiteralMapNode.getLiteral
func (self *Nodes_LiteralMapNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    ...
    for _key, _val := range( self._map.Items ) {
        ...
        if keyLiteral != nil && valLiteral != nil{
            keyLiteral_8053 := keyLiteral
            valLiteral_8054 := valLiteral
            litMap.Set(keyLiteral_8053,valLiteral_8054)
        } else {
...
// 2650: decl @lune.@base.@Nodes.LiteralMapNode.setupLiteralTokenList
func (self *Nodes_LiteralMapNode) SetupLiteralTokenList(_env *LnsEnv, list *LnsList) bool {
    ...
    for _key, _ := range( self._map.Items ) {
        key := _key.(Nodes_NodeDownCast).ToNodes_Node()
        var literal LnsAny
        literal = Nodes_convExp0_34711(Lns_2DDD(key.FP.GetLiteral(_env)))
        if literal != nil{
            literal_8066 := literal
            switch _matchExp0 := literal_8066.(type) {
            case *Nodes_Literal__Int:
    ...
    }
    {
        ...
        for _, __ := range( __forsortSorted0.Items ) {
            ...
            Lns_NilAccCall1( _env, func () LnsAny { return _env.NilAccPop().(*Nodes_Node).FP.SetupLiteralTokenList(_env, list)})/* 2680:14 */)){
                return false
            }
            self.FP.AddTokenList(_env, list, Types_TokenKind__Dlmt, ",")
        }
...
// 768: decl @lune.@base.@Nodes.LiteralStringNode.create
...
// 779: decl @lune.@base.@Nodes.LiteralStringNode.visit
...
// 784: decl @lune.@base.@Nodes.LiteralStringNode.sortList
...
// 2690: decl @lune.@base.@Nodes.LiteralStringNode.getLiteral
    ...
    }
    {
        ...
        if !Lns_IsNil( _param ) {
            ...
            for _, _argNode := range( argList.Items ) {
                ...
                if arg != nil{
                    arg_8093 := arg
                    paramList.Set(paramList.Len() + 1,Nodes_getLiteralObj(_env, arg_8093))
                } else {
                    return nil, mess
                }
            }
            txt = _env.GetVM().String_format(Nodes_convExp0_34969(txt, Lns_2DDD(paramList.Unpack())))
        }
    }
    return &Nodes_Literal__Str{txt}, nil
}
// 2717: decl @lune.@base.@Nodes.LiteralStringNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.LiteralBoolNode.create
...
// 768: decl @lune.@base.@Nodes.LiteralSymbolNode.create
...
// 2746: decl @lune.@base.@Nodes.LiteralSymbolNode.getLiteral
func (self *Nodes_LiteralSymbolNode) GetLiteral(_env *LnsEnv)(LnsAny, LnsAny) {
    return &Nodes_Literal__Symbol{self.token.Txt}, nil
}
// 2750: decl @lune.@base.@Nodes.LiteralSymbolNode.setupLiteralTokenList
...
// 768: decl @lune.@base.@Nodes.TupleConstNode.create
...
// 779: decl @lune.@base.@Nodes.TupleConstNode.visit
...
// 784: decl @lune.@base.@Nodes.TupleConstNode.sortList
