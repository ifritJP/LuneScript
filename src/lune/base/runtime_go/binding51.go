...
//go:embed legacy/lua51/lune/base/SimpleTransUnit.lua
var lune_base_SimpleTransUnit []byte
...
AddlnsSrcInfo( "lune.base.SimpleTransUnit", lune_base_SimpleTransUnit )
