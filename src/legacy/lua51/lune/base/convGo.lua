...
function convFilter:outputConstructor( node )
   ...
   for index, _5811 in ipairs( initFuncType:get_argTypeInfoList() ) do
      if index ~= 1 then
         self:write( ", " )
      end
   ...
   if not node:hasUserInit(  ) then
      ...
      for index, _5819 in ipairs( initFuncType:get_argTypeInfoList() ) do
