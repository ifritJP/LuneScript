...
build = {
   ...
   modules = {
      ...
      [ "lune.base.runtime3" ] = "src/lune/base/runtime_go/legacy/lua51/lune/base/runtime3.lua",
      ...
      [ "lune.base.convCC" ] = "src/lune/base/runtime_go/legacy/lua51/lune/base/convCC.lua",
